...
init()
{
    ...
    level.shrink_poi_into_the_bank._id_13EFF = [ [ "brloot_killstreak_auav", 0 ], [ "brloot_equip_gasmask_durable", 100 ], [ "brloot_specialist_bonus", 0 ], [ "brloot_weapon_la_juliet_lege", "brloot_ammo_rocket" ] ];
