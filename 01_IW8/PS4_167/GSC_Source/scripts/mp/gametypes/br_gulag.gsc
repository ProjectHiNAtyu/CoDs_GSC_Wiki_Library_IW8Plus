...
ai_washitbyvehicle( var_0, var_1, var_2 )
{
    ...
    var_10 = scripts\mp\gametypes\br_circle.gsc::getrandompointincircle( var_0, var_1 );
...
_id_125BE( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3 ) )
    {
        if ( isdefined( level.br_circle ) && isdefined( level.br_circle.safecircleent ) )
        {
            ...
            {
                var_19 = getdvarfloat( "scr_br_closestSafePointTimeOffset", 2.0 );
                var_3 = scripts\mp\gametypes\br_circle.gsc::helibankplunder( self, var_1, var_19 );
            }
            ...
            if ( !isdefined( var_3 ) )
            {
                ...
                if ( getdvarint( "scr_br_useClosestSafePerimeterPointFromSquadmate", 1 ) )
                    var_3 = scripts\mp\gametypes\br_circle.gsc::closestsafeperimeterpointfromsquadmate( var_20, var_1 );

                if ( !isdefined( var_3 ) && getdvarint( "scr_br_useClosestSafePerimeterPointFromLoadout", 1 ) )
                    var_3 = scripts\mp\gametypes\br_circle.gsc::closestsafeperimeterpointfromloadout( var_20, var_1 );
                ...
                if ( isdefined( var_3 ) )
                {
                    ...
                    {
                        var_22 = scripts\mp\gametypes\br_circle.gsc::getdangercircleorigin();
                        var_23 = randomint( 2 );
                        var_24 = [ 90, -90 ];
                        var_25 = [ -10.0, 10.0 ];
                        var_26 = rotatevector( var_3 - var_22, ( 0, var_25[var_23], 0 ) ) + var_22;
                        var_27 = scripts\mp\gametypes\br_circle.gsc::vandalize_minigun_speed( var_26, 0, var_1 );
            ...
            if ( !isdefined( var_3 ) )
            {
                var_29 = scripts\mp\gametypes\br_circle.gsc::getsafecircleorigin();
                var_30 = scripts\mp\gametypes\br_circle.gsc::getsafecircleradius();
                ...
                {
                    var_34 = scripts\mp\gametypes\br_circle.gsc::getdangercircleorigin();
                    var_35 = scripts\mp\gametypes\br_circle.gsc::getdangercircleradius();
                ...
                var_3 = scripts\mp\gametypes\br_circle.gsc::risk_flagspawnshiftingpercent( var_29, var_30, var_31, var_20, var_32, var_33, 0, var_1 );
            }
        }
    ...
    {
        if ( var_7 )
            var_40 = scripts\mp\gametypes\br_circle.gsc::getdangercircleorigin();
        else
            var_40 = scripts\mp\gametypes\br_circle.gsc::getsafecircleorigin();
    ...
    if ( var_6 )
    {
        ...
        var_45 = ( 0, 0, var_5 );
        var_3 = scripts\mp\gametypes\br.gsc::resetcircuitbreakers( var_3, var_45 );
    }
