...
_id_1363A( var_0, var_1, var_2 )
{
    ...
    {
        if ( isdefined( var_9 ) && !var_9 scripts\mp\gametypes\br_public.gsc::isplayeringulag() )
        {
    ...
    {
        scripts\mp\gametypes\br_analytics.gsc::destprogress( self, var_0, var_1, var_7 );
