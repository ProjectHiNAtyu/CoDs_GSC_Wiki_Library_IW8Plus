...
updateweaponbufferedstats( var_0 )
{
    ...
    if ( !scripts\mp\utility\weapon::ispickedupweapon( var_1 ) || istrue( level.destorder ) )
...
{
    if ( self.trackingweaponshots > 0 )
        scripts\common\utility::_id_12C2C( level.smoke_screen, var_0, "shots", self.trackingweaponshots, var_1, var_2 );

    if ( self.trackingweaponkills > 0 )
        scripts\common\utility::_id_12C2C( level.smoke_screen, var_0, "kills", self.trackingweaponkills, var_1, var_2 );

    if ( self.trackingweaponhits > 0 )
        scripts\common\utility::_id_12C2C( level.smoke_screen, var_0, "hits", self.trackingweaponhits, var_1, var_2 );

    if ( self.trackingweaponheadshots > 0 )
        scripts\common\utility::_id_12C2C( level.smoke_screen, var_0, "headshots", self.trackingweaponheadshots, var_1, var_2 );

    if ( self.trackingweapondeaths > 0 )
        scripts\common\utility::_id_12C2C( level.smoke_screen, var_0, "deaths", self.trackingweapondeaths, var_1, var_2 );
}
...
perslog_attachmentstats( var_0, var_1 )
{
    ...
    if ( self.trackingweaponshots > 0 && var_0 != "tactical" )
    {
        ...
        scripts\common\utility::_id_12C2C( level.skydivestreamhintdvars, var_0, "shots", self.trackingweaponshots, var_1 );
    }

    if ( self.trackingweaponkills > 0 && var_0 != "tactical" )
    {
        incrementattachmentstat( var_0, "kills", self.trackingweaponkills, var_1 );
        scripts\common\utility::_id_12C2C( level.skydivestreamhintdvars, var_0, "kills", self.trackingweaponkills, var_1 );
    }

    if ( self.trackingweaponhits > 0 && var_0 != "tactical" )
    {
        incrementattachmentstat( var_0, "hits", self.trackingweaponhits, var_1 );
        scripts\common\utility::_id_12C2C( level.skydivestreamhintdvars, var_0, "hits", self.trackingweaponhits, var_1 );
    }
    ...
    if ( self.trackingweaponheadshots > 0 && var_0 != "tactical" )
    {
        ...
        scripts\common\utility::_id_12C2C( level.skydivestreamhintdvars, var_0, "headShots", self.trackingweaponheadshots, var_1 );
    }

    if ( self.trackingweapondeaths > 0 )
    {
        incrementattachmentstat( var_0, "deaths", self.trackingweapondeaths, var_1 );
        scripts\common\utility::_id_12C2C( level.skydivestreamhintdvars, var_0, "deaths", self.trackingweapondeaths, var_1 );
    }
}
