...
gunship_startuse( var_0, var_1 )
{
    ...
    var_9 thread onplayerkillednew( var_0 );
    var_9 thread onpostkillcamcallback( var_0, "disconnect" );
    var_9 thread onpostkillcamcallback( var_0, "joined_team" );
    var_9 thread onpostkillcamcallback( var_0, "joined_spectators" );
    var_9 thread onpostkillcamcallback( var_0, "team_kill_punish" );
...
gunship_playintro( var_0, var_1, var_2, var_3 )
{
    ...
    if ( gunship_islargemap() )
    {
        ...
        else if ( isdefined( level.onplayergetsplunder ) )
            level.gunship.origin = level.onplayergetsplunder;
        else
    ...
    level.gunship_intromodel thread onplayerrespawn( "disconnect", var_1 );
    level.gunship_intromodel thread onplayerrespawn( "joined_team", var_1 );
    level.gunship_intromodel thread onplayerrespawn( "joined_spectators", var_1 );
    waitframe();
...
onplayerrespawn( var_0, var_1 )
{
    ...
    onplayereliminated_func( var_2, var_1 );
}

onplayereliminated_func( var_0, var_1 )
{
    var_2 = 0;
...
onpostkillcamcallback( var_0, var_1 )
{
    self endon( "death" );
    self endon( "crashing" );
    self endon( "leaving" );
