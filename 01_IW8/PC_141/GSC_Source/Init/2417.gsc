...
addtoteamlives( var_0, var_1, var_2 )
{
    ...
    _id_12E92( "add", var_1, var_0 );

    if ( isdefined( level.spawnboardroom_auav ) )
        [[ level.spawnboardroom_auav ]]( var_0, var_1 );
...
removefromteamlives( var_0, var_1, var_2 )
{
    ...
    _id_12E92( "remove", var_1, var_0 );

    if ( isdefined( level.spawned_warp_traversethink ) )
        [[ level.spawned_warp_traversethink ]]( var_0, var_1 );
    ...
    if ( istrue( var_2 ) && isgameplayteam( var_1 ) && !scripts\cp_mp\utility\game_utility::isrealismenabled() )
    {
        ...
        var_5 = scripts\mp\gametypes\br_public::munitions_override_time( var_1, var_0.squadindex );
...
_id_12E92( var_0, var_1, var_2 )
{
    ...
    if ( var_7 != var_8 || var_4 || var_5 )
    {
        ...
        scripts\mp\utility\script::getweaponrandomvariantid( var_9 );
...
getenemyteams( var_0 )
{
    ...
    if ( isdefined( level._id_133C3 ) || scripts\mp\utility\game::cleanuparenamolotovs() )
