...
asm_init( var_0, var_1 )
{
    ...
    self.fnasm_playfacialanim = ::br_highlightlaststandfinishplayers;
    ...
    level.killable_targets = ::bombzone_press_use;
    level.killandvision = ::bombzone_picked;
    level.kill_vip = ::bombzone_picked;
    hack_setup_a_struct();
    var_2 = var_0;
...
{
    br_hasautopickup( var_0, var_1, var_2, var_3, "end" );
}

br_hasautopickup( var_0, var_1, var_2, var_3, var_4 )
{
...
doorneedstoclose( var_0 )
{
    ...
    var_4 = angleclamp180( var_3 - var_0.extracthelipadusecallback[1] );
    var_5 = angleclamp180( var_0.angles[1] - var_0.extracthelipadusecallback[1] );
...
br_highlightlaststandfinishplayers( var_0, var_1, var_2 )
{
    self setfacialindexfromasm( var_0, var_1, var_2 );
}

br_insert_armor( var_0, var_1 )
{
    if ( !scripts\asm\shared\utility::isfacialstateallowed( "asm" ) )
        return;

    if ( isdefined( var_0 ) && br_giveselectedclass( var_0 ) )
        return;
