...
{
    level._id_11ADE = [];
    level._id_11ADE["rcxd_rad"] = spawnstruct();
    level._id_11ADE["rcxd_rad"].timeout = getdvarfloat( "scr_br_rcxd_rad_timeout", 45.0 );
    level._id_11ADE["rcxd_rad"].maxhealth = 75;
    level._id_11ADE["rcxd_rad"].hitstokill = 3;
    level._id_11ADE["rcxd_rad"].speed = 140;
    level._id_11ADE["rcxd_rad"].accel = 20;
    level._id_11ADE["rcxd_rad"].halfsize = 27;
    level._id_11ADE["rcxd_rad"].spawndist = 30;
    level._id_11ADE["rcxd_rad"].streakname = "rcxd_rad";
    level._id_11ADE["rcxd_rad"].vehicleinfo = "veh_rcxd_rad_mp";
    level._id_11ADE["rcxd_rad"].modelbase = "lm_veh_t9_drone_rcxd";
    level._id_11ADE["rcxd_rad"].teamsplash = "used_rcxd_rad";
    level._id_11ADE["rcxd_rad"].destroyedsplash = "callout_destroyed_rcxd_rad";
    level._id_11ADE["rcxd_rad"].generatespawnpoint = 0.5;
    level._id_11ADE["rcxd_rad"].sound_explode = "recon_drone_explode";
    level._id_11ADE["rcxd_rad"].vodestroyed = "ball_drone_backup_destroy";
    level._id_11ADE["rcxd_rad"].votimedout = "ball_drone_backup_timeout";
    level._id_11ADE["rcxd_rad"].scorepopup = "destroyed_rcxd_rad";
    level._id_11ADE["rcxd_rad"].playfxcallback = scripts\cp_mp\killstreaks\helper_drone::helperdronefx;
    level._id_11ADE["rcxd_rad"].primarymode = "MANUAL";
    level._id_11ADE["rcxd_rad"].primarymodestring = &"KILLSTREAKS_HINTS/RCD_MANUAL";
    level._id_11ADE["rcxd_rad"].primarymodefunc = scripts\cp_mp\killstreaks\helper_drone::setreconmodesettings;
    level._id_11ADE["rcxd_rad"].premoddamagefunc = undefined;
    level._id_11ADE["rcxd_rad"].postmoddamagefunc = scripts\cp_mp\killstreaks\helper_drone::helperdrone_modifydamageresponse;
    level._id_11ADE["rcxd_rad"].deployweaponname = "ks_remote_rcxd_mp";
    level._id_11ADE["rcxd_rad"].skipburndownhigh = 1;
    level._id_11ADE["rcxd_rad"].skipburndownlow = 1;
    level._id_11ADE["rcxd_rad"].skipprematch = 73984;
    level._id_11ADE["rcxd_rad"].skipscriptable = 73984;
    level._id_11ADE["rcxd_rad"].deathfunc = ::_id_11ACC;
    level._id_11ADE["rcxd_rad"].glgrenadeparent = 1;
    level._id_11ADE["rcxd_rad"].diewithowner = 1;
    level._id_11ADE["rcxd_rad"].stringcannotplace = &"KILLSTREAKS_HINT_CANNOT_CALL_IN";
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "rcxd_rad", ::_id_12C4A, undefined, ::_id_12C32 );
    initmines();
    var_0 = getarraykeys( level._id_11ADE );

    foreach ( var_2 in var_0 )
    {
        var_3 = level._id_11ADE[var_2].hitstokill;
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "rcxd_rad", ::_id_11ACC );
...
_id_12C4B( var_0 )
{
    ...
    if ( !self isonground() && !self isonladder() || scripts\mp\vehicles\vehicle_compass_mp::remapattachmentparentname() )
        return 0;

    if ( isdefined( level.door2 ) )
    {
        if ( ![[ level.door2 ]]( var_1 ) )
            return 0;
    }
    ...
    var_3 = level._id_11ADE[var_2].deployweaponname;
    var_4 = var_1 scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_doweapontabletdeploy( var_0, ::_id_132D7, undefined, undefined, ::deployweapontaken, var_3, 0, ::_id_1318A );
    var_1 scripts\common\utility::allow_usability( 0 );
    var_1 thread scripts\cp_mp\utility\killstreak_utility::tabletdofset( 0, 1, 1 );

    if ( !istrue( var_4 ) )
    {
        var_1 _id_11AD4( var_0 );
    ...
    var_5 = 0.4;
    var_6 = var_1 scripts\engine\utility::_id_13142( var_5, "death", "weapon_switch_started" );

    if ( !isdefined( var_6 ) || var_6 != "timeout" )
    {
        var_1 _id_11ACA( var_0 );
        return 0;
    }
    ...
    var_8 = level._id_11ADE[var_2].teamsplash;
    var_6 = _id_12748( var_0 );
...
_id_12748( var_0 )
{
    ...
    var_5 scripts\cp_mp\utility\killstreak_utility::stealth_alert_music_index( var_1 );
    var_5.owner = var_1;
    var_5.team = var_1.team;
    var_5.vehiclename = var_0.streakname;
    var_6 = level._id_11ADE[var_0.streakname];
    ...
    var_5 thread _id_11ADD();
    var_5 thread _id_11ADA();
    var_5 thread _id_11AD9();
    var_5 thread _id_11ADC();
    var_5 thread _id_11ACD();
    var_5 thread _id_11AD6( var_6 );
    var_5 thread _id_11AD8();
    var_5 thread _id_11AD5();
    var_5 thread _id_11AD2( var_6 );
    ...
    var_5 _id_11AD3( "rcxd_enemy", 0, 1 );
    var_5 _id_11AD3( "rcxd_friendly_use", 1, 0 );
...
_id_11AD2( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( istrue( var_10.round_vehicle_path_logic ) )
            var_12 = var_10;
        ...
        var_17 = var_1.maxhealth * var_0.generatespawnpoint;
...
_id_11ADD()
{
    ...
    var_1 = level._id_11ADE[var_0.vehiclename];
...
_id_11ACB( var_0 )
{
    ...
    if ( !istrue( var_2.givesuperpointsonprematchdone ) )
    {
        var_2 thread _id_11AC8();
        var_2.givesuperpointsonprematchdone = 1;
    }
    ...
    scripts\cp_mp\utility\killstreak_utility::stealth_broken_music( var_2.owner );
    var_2 setscriptablepartstate( "flash_light", "default", 0 );
    var_2.owner scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_0 );
    var_2.owner unlink();
    ...
    var_2 setscriptablepartstate( "flash_light", "default", 0 );
    var_3 = level._id_11ADE[var_0.streakname].deployweaponname;
...
_id_11AD4( var_0 )
{
    ...
    wait 1.5;
    var_2 = level._id_11ADE[var_0.streakname].deployweaponname;
...
_id_11ADA()
{
    ...
    var_0 childthread _id_11ADB( "disconnect" );
    var_0 childthread _id_11ADB( "joined_team" );
    var_0 childthread _id_11ADB( "joined_spectators" );
    var_0 childthread _id_11ADB( "last_stand_start" );
}
...
_id_11AD9()
{
    ...
    for (;;)
    {
        ...
        var_2 = level._id_11ADE[var_0.vehiclename];
...
{
    var_1 = self;
    var_1 thread _id_11AC8();
    var_1.givesuperpointsonprematchdone = 1;
    var_1 thread _id_11ACB( var_0 );
}
...
applygasdamageovertime( var_0, var_1 )
{
    ...
    while ( var_1 istouching( self ) )
    {
        ...
        var_2 = scripts\engine\utility::_id_13141( 1, "death" );
...
_id_11AD3( var_0, var_1, var_2 )
{
    ...
    var_4 = var_3 _id_11AD0( var_1, var_2, 7500 );
    scripts\mp\gametypes\br_public::brleaderdialog( var_0, 1, var_4 );
}

_id_11AD0( var_0, var_1, var_2 )
{
    var_3 = self;
    var_4 = [];
