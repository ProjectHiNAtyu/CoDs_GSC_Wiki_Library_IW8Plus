...
update_player_about_remaining_enemies()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "pickup_truck", 1 );
    var_0.id = 7;
...
update_operator_west_char_loc()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "pickup_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "pickup_truck" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "pickup_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "pickup_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "pickup_truck", ::pickup_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "pickup_truck_mp", 3 );
}
...
pickup_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "pickup_truck", var_0 );
