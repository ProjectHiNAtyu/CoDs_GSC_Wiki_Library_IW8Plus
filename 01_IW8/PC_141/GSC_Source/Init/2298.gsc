...
advanced_supply_drop_marker_used( var_0 )
{
    ...
    var_1 thread routers_needed( var_0 );
    var_1 thread apcturret( var_0 );
    var_0 waittill( "explode", var_2 );
    var_1 notify( "advanced_supply_drop_finished" );
    thread apcrespawntime( var_2 );
    ...
    var_3 = scripts\mp\gametypes\br_rewards::ml_p2_func( 0, 1, 0, 0, 0 );
    var_1 scripts\mp\gametypes\br_rewards::_id_12543( var_2, var_3 );
...
appliednukethreads( var_0 )
{
    ...
    if ( isdefined( level._id_12955 ) )
        level thread _id_1292C( var_1, var_0 );
    ...
    if ( isdefined( level._id_12956 ) && isdefined( level._id_12956[var_1.team] ) )
    {
        if ( isdefined( var_0 ) )
            var_0 delete();
    ...
    var_8 = scripts\mp\gametypes\br_gametype_truckwar::_id_13007( var_3 );

    if ( isdefined( var_8 ) )
    {
        if ( getdvar( "scr_br_gametype", "" ) == "truckwar" )
            scripts\mp\gametypes\br_gametype_truckwar::propent( var_8, var_1.team, 1 );

        level thread scripts\mp\gametypes\br_gametype_truckwar::_id_12C09( var_8, var_7, var_8.angles, 1 );
    }
...
apce_p1( var_0 )
{
    ...
    if ( istrue( self.registeronplayerdisconnect ) || isdefined( var_4 ) && distance2d( var_2, var_4.origin ) < 5000 )
        var_3 = 10000;
    ...
    if ( isdefined( var_7 ) )
        var_7 thread pickedupcoreminigun( self );

    if ( isdefined( var_1.super ) )
        var_1 scripts\mp\supers::superusefinished( undefined, undefined, undefined, 1 );
}

pickedupcoreminigun( var_0 )
{
