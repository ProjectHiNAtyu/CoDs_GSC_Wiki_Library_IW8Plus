...
matchrecording_loggameendstats()
{
    ...
    {
        if ( isdefined( var_6._id_122F9 ) )
            var_0 = var_6._id_122F9;

        if ( isdefined( var_6.init_trap_room ) )
            var_3 = var_6.init_trap_room;

        if ( isdefined( var_6.init_trap_room_debug ) )
            var_4 = var_6.init_trap_room_debug;
    }
...
matchrecording_usereventthink()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_1313C( "log_user_event_end", "log_user_event_generic_event" );
