...
handlesplashqueue()
{
    ...
    {
        if ( scripts\mp\utility\game::getgametype() == "br" && ( scripts\mp\utility\game::namehud() == "dmz" || scripts\mp\utility\game::namehud() == "risk" || scripts\mp\utility\game::namehud() == "rumble" ) )
            scripts\engine\utility::_id_1312D( "splash_list_cleared", "can_show_splashes" );
        else
            scripts\engine\utility::_id_1312D( "splash_list_cleared", "spawned_player" );
