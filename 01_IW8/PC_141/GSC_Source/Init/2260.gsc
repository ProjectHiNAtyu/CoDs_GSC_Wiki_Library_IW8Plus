...
savedangles()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "large_transport", 1 );
    var_0.id = 5;
...
sat_wait_for_transmission_start()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "large_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "large_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "large_transport", 10 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "large_transport", ::large_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "large_transport_mp", 3 );
}
...
large_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "large_transport", var_0 );
