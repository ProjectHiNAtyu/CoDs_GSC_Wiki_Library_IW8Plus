...
incpersstat( var_0, var_1 )
{
    ...
    if ( isdefined( self.send_all_ai_to_players[var_0] ) )
        self.send_all_ai_to_players[var_0] = self.send_all_ai_to_players[var_0] + var_1;
...
{
    if ( !isdefined( self.send_all_ai_to_players[var_0] ) )
        self.send_all_ai_to_players[var_0] = 0;
}
...
setextrascore0( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && level.cloudorigin.name == "rebirth" )
        return;
...
getplayerdataloadoutgroup()
{
    ...
    var_0 = istrue( level._id_131B7 ) && getdvarint( "LNLMORMPTS" );
