...
ammobox_init()
{
    level.binoculars_onstatelospendingexit = [];
    scripts\common\interactive::interactive_addusedcallback( ::ammobox_usedcallback, "equip_ammo_box" );
    scripts\mp\utility\join_team_aggregator::registeronplayerjointeamcallback( ::bomb_vest_detonator_control_think );
    ...
    {
        bomb_detonator_bomb_type( "weapon_sniper", var_0 );
        bomb_detonator_bomb_type( "weapon_sniper", var_0 );
        bomb_detonator_bomb_type( "weapon_sniper", var_0 );
        bomb_detonator_bomb_type( "weapon_sniper", var_0 );
        bomb_detonator_bomb_type( "weapon_sniper", var_0 );
    ...
    {
        bomb_detonator_bomb_type( "weapon_assault", var_0 );
        bomb_detonator_bomb_type( "weapon_assault", var_0 );
        bomb_detonator_bomb_type( "weapon_smg", var_0 );
        bomb_detonator_bomb_type( "weapon_smg", var_0 );
        bomb_detonator_bomb_type( "weapon_lmg", var_0 );
        bomb_detonator_bomb_type( "weapon_lmg", var_0 );
        bomb_detonator_bomb_type( "weapon_sniper", var_0 );
        bomb_detonator_bomb_type( "weapon_dmr", var_0 );
        bomb_detonator_bomb_type( "weapon_shotgun", var_0 );
        bomb_detonator_bomb_type( "weapon_pistol", var_0 );
...
bomb_detonator_holder( var_0, var_1 )
{
...
{
    var_2 = scripts\mp\utility\weapon::mp_euphrates_patches( var_0 );
    bomb_detonator_holder( var_2, var_1 );
}

bomb_vest_detonator_control_think( var_0 )
{
    foreach ( var_2 in level.binoculars_onstatelospendingexit )
    {
        if ( isdefined( var_2 ) )
            var_2 scripts\mp\equipment\support_box::_id_12851( var_0 );
    }
}
...
ammobox_settled( var_0 )
{
    ...
    level.binoculars_onstatelospendingexit[var_0 getentitynumber()] = var_0;
...
ammobox_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::total_successful_vehicle_spawns( "super_weapon_drop", self.usedcount, var_0, var_2 );
...
ammobox_internalpreloadweapons( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = [ var_2 ];
        bomb_interaction_ent( var_1 );
        var_4 = bomb_planted( var_1 );
    ...
    foreach ( var_1 in self.playersused )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            if ( !scripts\mp\utility\player::isreallyalive( var_1 ) && isdefined( self.playersused[var_2] ) )
            {
                ...
                scripts\mp\equipment\support_box::_id_12851( var_1 );
            }
        }
    }
}
...
bomb_sites_spawn( var_0 )
{
    ...
    if ( isdefined( level.train_scriptable_attach_delay ) )
        var_0 [[ level.train_scriptable_attach_delay ]]( var_2 );
...
{
    if ( !isdefined( var_0.damagepercentmedium ) )
    {
        var_1 = spawnstruct();
        var_1.buffered = undefined;
        var_1.last = undefined;
        var_1.branalytics_kiosk_purchaseloadout = undefined;
        var_1.branalytics_publiceventended = undefined;
        var_1.branalytics_plunder_placed_into_extraction = undefined;
        var_0.damagepercentmedium = var_1;
    }

    return var_0.damagepercentmedium;
}
...
bomb_on_vehicle_clean_up_monior( var_0 )
{
    ...
    if ( !isdefined( var_1.branalytics_kiosk_purchaseloadout ) )
    {
        ...
        if ( !bomb_hostage_play_anim( var_2 ) )
            return undefined;

        if ( !bomb_detonator_waiting_for_pick_up( var_2 ) )
            return undefined;
        ...
        var_1.branalytics_kiosk_purchaseloadout = var_3;
    }

    return var_1.branalytics_kiosk_purchaseloadout;
}
...
bomb_planted( var_0 )
{
    ...
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.branalytics_publiceventended;
}
...
bomb_plant_allowed( var_0 )
{
    bomb_detonator_interact( var_0 );
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.branalytics_plunder_placed_into_extraction;
}
...
bomb_detonator_interact( var_0 )
{
    ...
    if ( !isdefined( var_1.branalytics_publiceventended ) )
    {
        var_2 = bomb_on_vehicle_clean_up_monior( var_0 );
        ...
        if ( isdefined( var_4 ) )
        {
            var_1.branalytics_plunder_placed_into_extraction = var_3;
            var_1.branalytics_publiceventended = var_4;
        }
    }
}
...
bomb_interaction_ent( var_0 )
{
    var_1 = bomb_plant_allowed( var_0 );
    var_2 = 0;
...
ammobox_onplayeruse( var_0 )
{
    ...
    if ( !bomb_hostage_play_anim( var_1 ) )
    {
    ...
    if ( !bomb_detonator_waiting_for_pick_up( var_1 ) )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
...
bomb_detonator_waiting_for_pick_up( var_0 )
{
    ...
    {
        if ( !scripts\mp\utility\weapon::branalytics_landing( var_0, var_5 ) )
            continue;
...
bomb_sites( var_0 )
{
    ...
    var_1 = bomb_on_vehicle_clean_up_monior( self );
    var_2 = bomb_planted( self );
...
bomb_use_player( var_0 )
{
    self endon( "disconnect" );
    var_1 = var_0 + 1;

    if ( istrue( self._id_132DF ) )
    {
        self._id_132DF = undefined;
        var_1 = var_1 * -1;
    }
    else
        self._id_132DF = 1;
    ...
    scripts\engine\utility::_id_13141( 1, "death" );
...
ammobox_addheadicon()
{
    self.ph_endgame = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], "hud_icon_fieldupgrade_weapon_drop", 20, 1, 1000, 100, undefined, 1 );
    self.ph_loadouts = scripts\cp_mp\entityheadicons::setheadicon_factionimage( 0, 20, undefined, undefined, undefined, undefined, 1 );
    scripts\mp\equipment\support_box::_id_12852();
}

ammobox_removeheadicon()
{
    if ( isdefined( self.ph_endgame ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.ph_endgame );
        self.ph_endgame = undefined;
    }

    if ( isdefined( self.ph_loadouts ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.ph_loadouts );
        self.ph_loadouts = undefined;
    }
}
...
{
    thread bomb_use_watcher( var_0, var_1 );
}

bomb_use_watcher( var_0, var_1 )
{
    if ( istrue( var_1.reset_progress ) )
        return;

    var_1.reset_progress = 1;
    bomb_vest_controller_holder( var_0, var_1 );

    if ( isdefined( var_1 ) )
        var_1.reset_progress = undefined;
}
...
bomb_vest_controller_holder( var_0, var_1 )
{
    ...
    if ( var_3 )
        var_4 = var_0 bomb_sites_spawn( var_1 );
    else
    ...
    if ( var_4 )
    {
        if ( isdefined( var_0.owner ) )
        {
            ...
            var_0.owner scripts\mp\supers::fake_digit_pool( "super_weapon_drop" );
        }

        var_0.usedcount++;
        var_0.playersused[var_1 getentitynumber()] = var_1;
        var_0 scripts\mp\equipment\support_box::_id_12851( var_1 );
