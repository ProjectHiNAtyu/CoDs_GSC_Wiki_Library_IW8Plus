...
trophy_used( var_0 )
{
    ...
    var_0.usedcount = 0;
    var_0.give_killstreak_sentry = self;
...
trophy_deploy()
{
    ...
    thread trophy_watchprotection( 45, 105625, ::_id_12BFF, ::trophy_protectionsuccessful );
    thread _id_12C02();
...
trophy_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::total_successful_vehicle_spawns( "super_trophy", self.usedcount, var_0, var_2 );
    ...
    while ( [[ var_2 ]]() )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            if ( var_11 )
            {
                ...
                if ( var_12 scripts\cp_mp\vehicles\vehicle::isvehicle() && isdefined( var_12._id_12C1A ) && isdefined( var_10.team ) && var_12._id_12C1A == var_10.team )
                    continue;
            }
            else if ( var_9 == self )
                continue;
...
trophy_protectionsuccessful( var_0 )
{
    ...
    self.owner scripts\mp\supers::fake_digit_pool( "super_trophy" );
    self.usedcount++;
    var_1 = var_0.origin;
    setup_train_entarray( var_0 );
    _id_12BFB( var_0 );
...
_id_12BFB( var_0 )
{
    ...
    _id_12C00( var_0, var_0.owner, self.owner );
...
_id_12C00( var_0, var_1, var_2 )
{
    ...
    var_3 = var_2;
    var_4 = var_1.origin;
    var_5 = scripts\mp\equipment\snapshot_grenade::_id_1237D( var_3, var_4 );
    scripts\mp\equipment\snapshot_grenade::_id_1237C( var_1, var_2, var_5 );
}
...
setup_train_entarray( var_0 )
{
    ...
    if ( !isdefined( self.give_killstreak_sentry ) )
        return;

    getentitylessscriptablearray( "dlog_event_trophy_successful", [ "deploying_player", self.give_killstreak_sentry, "grenade_owner", var_0.owner, "negated_target", var_0.weapon_name ] );
}
