...
autoattachtoplayer()
{
    ...
    level.scriptablescurid = game["lastSpectatedPlayer"];
    ...
    for (;;)
    {
        ...
        {
            if ( level.currentround > 1 && isdefined( level.scriptablescurid ) && self.team != "follower" )
                var_0 = level.scriptablescurid;
...
updatemlgspectator()
{
    ...
    for (;;)
    {
        if ( self ismlgspectator() && self isspectatingplayer() )
        {
            ...
            if ( isdefined( var_0 ) )
                level.scriptablescurid = var_0.clientid;
        }
...
_id_11EC8()
{
    ...
    game["lastSpectatedPlayer"] = level.scriptablescurid;
}
