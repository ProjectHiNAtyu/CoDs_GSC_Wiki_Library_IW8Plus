...
beginjackal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_7 = scripts\cp_mp\utility\killstreak_utility::molotov_crate_update_hint_logic_alt();
...
defendlocation( var_0, var_1 )
{
    ...
    else if ( isdefined( var_1 ) && isdefined( var_0.dropcrates ) )
    {
        ...
        var_0 scripts\engine\utility::_id_13141( 10, "all_crates_gone" );
...
watchpatroltarget()
{
    ...
    self endon( "jackal_crashing" );
    self.owner endon( "disconnect" );
    var_0 = self.patroltarget scripts\engine\utility::_id_13141( 5, "death_or_disconnect" );
    self.patroltarget = undefined;
}
...
watchforlosttarget( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = var_1 scripts\engine\utility::_id_13141( var_3, "death_or_disconnect" );
...
{
    scripts\engine\utility::_id_1312D( "captured", "death" );
...
watchjackalcratepickup()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_1312E( "crate_captured_0", "crate_captured_1", "crate_captured_2" );
        var_0++;
