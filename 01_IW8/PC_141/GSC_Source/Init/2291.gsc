...
bot_loadout_item_allowed( var_0, var_1, var_2 )
{
    ...
    if ( !check_for_damage_scalar_change() )
        return 0;
...
bot_loadout_choose_fallback_primary( var_0 )
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", checkpoint_edit_munitions_limiter(), var_13, "class", "inUse" ) )
            {
                var_1 = checkpoint_edit_munitions_limit_init( var_13, "loadoutPrimary" );
...
checkpoint_edit_munitions_limiter()
{
...
check_for_trexremoval()
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", checkpoint_edit_munitions_limiter(), var_1, "class", "inUse" ) )
                var_0[var_1] = var_1;
        }
    }
    ...
    foreach ( var_5 in level.bot_loadout_fields )
    {
        ...
        var_3[var_5] = checkpoint_edit_munitions_limit_init( var_2, var_5 );
    }
...
bot_validate_weapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_8 = scripts\mp\utility\weapon::midpoint_music( var_0 );
...
init_bot_weap_statstable()
{
    ...
    for (;;)
    {
        ...
        {
            if ( !scripts\mp\weapons::resetchemicalvalvevalues( var_2 ) )
            {
                var_0++;
                continue;
            }
...
checkpoint_edit_munitions_limit_init( var_0, var_1 )
{
    var_2 = checkpoint_edit_munitions_limiter();
...
bot_loadout_valid_choice( var_0, var_1, var_2, var_3 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "loadoutPrimaryBuff":
            break;
        case "loadoutPrimaryCamo":
            var_4 = !isdefined( self.cheeselocs ) || var_3 == self.cheeselocs;
            break;
        case "loadoutSecondary":
        ...
        case "loadoutSecondaryBuff":
            break;
        case "loadoutSecondaryCamo":
            var_4 = !isdefined( self.cheeseprompt ) || var_3 == self.cheeseprompt;
            break;
        case "loadoutStreak3":
        case "loadoutStreak2":
        case "loadoutStreak1":
...
bot_loadout_choose_from_set( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( !isdefined( self.getdefaultstreamhinttimeoutms ) )
            self.getdefaultstreamhinttimeoutms = scripts\engine\utility::random( [ "class1", "class2", "class3", "class4", "class5" ] );

        var_0 = [ self.getdefaultstreamhinttimeoutms ];
    }
...
challengeandeventglobals()
{
    if ( istrue( self.checkpoint_next_fx_set ) )
        return 0;
...
bot_loadout_class_callback( var_0 )
{
    ...
    if ( !isdefined( self.checkpoint_edit_munitions ) )
        self.check_for_at_set_final_wave = 0;

    self.checkpoint_edit_munitions = self.check_for_at_set_final_wave;
    ...
    var_8 = !var_7 && challengeandeventglobals();
    ...
    self.checkpoint_next_fx_set = undefined;

    if ( !var_7 )
    {
        var_12 = checkifplayerrewardsareenabled();
        var_13 = undefined;

        if ( isdefined( self.respawn_with_launcher ) && isdefined( var_12 ) )
        {
            self.respawn_with_launcher = undefined;
            self.checkpoint_next_fx_set = 1;
            var_13 = var_12;
        }

        if ( !isdefined( var_13 ) )
        {
            var_14 = checkgreenmassacre();
            var_15 = 0;
        ...
        if ( isdefined( var_13 ) )
        {
            self.check_for_at_set_final_wave++;
    ...
    var_16 = undefined;
    var_17 = check_for_damage_scalar_change();
    ...
    {
        if ( isdefined( var_1["loadoutPrimaryCamo"] ) && var_1["loadoutPrimaryCamo"] != "none" && !isdefined( self.cheeselocs ) )
            self.cheeselocs = var_1["loadoutPrimaryCamo"];

        if ( isdefined( var_1["loadoutSecondaryCamo"] ) && var_1["loadoutSecondaryCamo"] != "none" && !isdefined( self.cheeseprompt ) )
            self.cheeseprompt = var_1["loadoutSecondaryCamo"];
