...
terminal_pusher_approach_entrance_array( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
tell_player_to_pick_up_intel( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
terminateriotshield( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
