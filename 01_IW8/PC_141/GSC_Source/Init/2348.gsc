...
starthelicopter( var_0, var_1 )
{
    ...
    scripts\common\utility::_id_12C2C( level.smartwatchinteract, var_3, self.origin );
...
heli_existance()
{
    ...
    scripts\engine\utility::_id_1312E( "death", "crashing", "leaving" );
...
fireontarget( var_0 )
{
    ...
    scripts\engine\utility::_id_13141( 4, "facing" );
    ...
    scripts\engine\utility::_id_13141( 3, "near_goal" );
}
...
heli_leave( var_0 )
{
    ...
    if ( isdefined( self.helitype ) && self.helitype == "osprey" && isdefined( self.pathgoal ) )
    {
        ...
        scripts\engine\utility::_id_13141( 5, "goal" );
    }
    ...
    scripts\engine\utility::_id_13141( 12, "goal" );
    self notify( "gone" );
    self notify( "death" );
    waitframe();
