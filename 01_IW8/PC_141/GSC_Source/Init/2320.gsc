...
force_remove_stim()
{
    if ( istrue( self.update_ai_volumes ) )
        return;

    self.update_ai_volumes = 1;
...
force_players_out_of_vehicle()
{
    ...
    self.update_ai_volumes = undefined;
...
watchcrateimpact( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) && var_9 scripts\cp_mp\killstreaks\helper_drone::relic_bang_and_boom_dropfunc() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            vehicle_compass_updateallvisibilityforplayer( var_6, var_7, var_8, var_11 );
        }
    }
}

vehicle_compass_updateallvisibilityforplayer( var_0, var_1, var_2, var_3 )
{
