...
delay_put_players_in_black_screen()
{
    level thread delaydestroyhudelem();
}

delay_play_depart_vo( var_0, var_1 )
{
    var_2 = self;
    ...
    var_2 thread activate_control_station( var_5 );
    activate_chopper_boss_ammo_crates( "Enemy switched to danger" );
}
...
activate_control_station( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( activate_additional_ammo_crates( var_0 ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            if ( var_7 && accessoryface( var_6, var_3 ) )
            {
                if ( isdefined( level.shot_start_offset ) && getdvar( "scr_br_gametype", "" ) == "kingslayer" && scripts\engine\utility::array_contains( level.shot_start_offset, var_6 ) )
                ...
                var_5 = var_6;
                activate_chopper_boss_ammo_crates( "Enemy tracked!" );

                if ( !istrue( var_2 ) )
                    var_6.relic_mythic_should_bypass_pain_cooldown = 1;
            }

            var_3 thread delay_start_player_weapon_fired_monitor( var_0, var_6 );
    ...
    else if ( var_0 == 0 )
    {
        if ( getdvarint( "scr_calloutmarkerping_navigation_proximity_cancel", 0 ) )
            var_3 thread delay_show_backpack();
    }
    else if ( var_0 == 8 )
    {
        var_8 = var_3 calloutmarkerping_getent( var_0 );
        var_3 thread delay_start_player_weapon_fired_monitor( var_0, var_8 );
        var_3 thread delay_spawn_nav_repulsor( var_0, var_8 );
    }
    else if ( var_0 == 7 )
    {
        ...
        {
            var_3 thread delay_turn_laser_trap_back_on( var_0, var_9 );
            var_3 thread delay_thirdpersoncamera( var_0, var_9 );
        }
    }
    else if ( var_0 == 12 )
        var_3 thread delay_suspend_vehicle_convoy( 12, var_1 );

    if ( !isdefined( var_5 ) )
        var_4 = var_3 delay_push_player_clear_door_way( var_0 );

    activate_chopper_boss_ammo_crates( "Timeout value before wait: " + var_4 + " | poolID: " + var_0 );
    wait( var_4 );

    if ( isdefined( var_5 ) && isdefined( var_3 ) )
    {
        if ( isdefined( var_5.relic_mythic_should_bypass_pain_cooldown ) )
            var_5.relic_mythic_should_bypass_pain_cooldown = undefined;

        var_3 thread delay_play_depart_vo( var_0, var_5 );
    }
    else
    {
        activate_chopper_boss_ammo_crates( "Pool timed out: " + var_0 );
...
activate_c4_for_pick_up()
{
    ...
    for (;;)
    {
        ...
        activate_chopper_boss_ammo_crates( "Notification " + var_1 + " on pool " + var_2 );

        switch ( var_1 )
        {
            case "calloutmarkerping_added":
                var_0 absolutevelocity( var_2 );
                break;
            case "calloutmarkerping_cleared":
                var_0 access_card( var_2 );
                break;
            case "calloutmarkerping_acknowledged":
                var_0 abilityleft( var_2, var_3 );
                break;
            case "calloutmarkerping_acknowledged_cancel":
                var_0 abshotfootlastposition( var_2 );
                break;
            case "calloutmarkerping_enemy_repinged":
                var_0 accesscard( var_2 );
                break;
            case "map_ping_delete_marker":
                var_0 accesscardsspawned_red();
                break;
            case "br_inventory_slot_request":
                var_0 ac130_flight_path( var_2 );
                break;
            default:
                break;
        }
...
calloutmarkerping_initplayer()
{
    ...
    if ( !isdefined( var_0.delete_corpses ) )
        var_0.delete_corpses = [];

    if ( !isdefined( var_0.delay_turn_off_red_lights_along_track ) )
        var_0.delay_turn_off_red_lights_along_track = [];

    var_0 thread activate_c4_for_pick_up();
}
...
module_has_data_for_call_count( var_0 )
{
    if ( !isdefined( var_0 ) )
        return "";
...
delay_spawn_room_soldiers( var_0 )
{
    ...
    if ( var_2 )
    {
        ...
        if ( var_3 == var_0 )
        {
            var_1 delay_show_balloon( "br_ping_cancel", 12 );
            return;
        }
    }
    ...
    var_1 thread activate_control_station( 12, var_0 );
    var_1 thread delete_breach_engine_loop_after_time( var_0 );
}

delete_breach_engine_loop_after_time( var_0 )
{
    var_1 = self;
    wait( getdvarfloat( "scr_calloutmarkerping_delay_between_vo_and_sfx_secs_inventory", 0.5 ) );
    var_2 = module_pause_funcs( var_0 );

    if ( isdefined( var_2 ) && isdefined( var_1 ) )
        var_1 delete_after_flank_trigger_spawns( var_2, 12 );
}
...
delay_vehicle_to_push_explode_sequence( var_0 )
{
    ...
    if ( activate_all_targets( var_0 ) )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            var_8 = activate_control_station_interaction( var_4 );
        }
        ...
        {
            if ( accessorybig( var_4.entity ) )
                var_3 = "ping_killstreaks_carepkg";
            else if ( istrue( var_4.entity.isjuggernaut ) )
                var_3 = "ping_killstreaks_juggernaut";
            else if ( accessorylogicbyindex( var_2 ) )
                var_3 = "ping_plunder_bank";
            else if ( accessoryattachmentfem( var_4.entity ) )
                var_3 = "ping_vehicle_heavy";
            else if ( istrue( var_4.entity.removegasmaskbr ) )
                var_3 = "ping_pickup_generic";
        }
        else
            var_3 = var_1 delayedattach( var_0, var_2 );
    }
    else if ( activate_additional_ammo_crates( var_0 ) )
        var_3 = var_1 delayed_explosion_things( var_0, var_2 );
    else if ( achievementtrackerforkills( var_0 ) )
    ...
    else
    {
        switch ( var_0 )
        {
            case 0:
                ...
                {
                    if ( istrue( var_1.register_seat_data_for_vehicle ) )
                ...
                break;
            case 8:
                var_3 = var_1 delayeddetach( var_0, var_2 );
                break;
            case 7:
                var_3 = var_1 delayeddetachbreak( var_0 );
                break;
            default:
                break;
        }
    ...
    var_1 delete_after_flank_trigger_spawns( var_3, var_0 );
}
...
delayed_explosion_things( var_0, var_1 )
{
    var_2 = self;
...
delayeddetach( var_0, var_1 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "ping", "ping_cp_getCPVehicleCallout" ) )
    {
        ...
        if ( isdefined( var_4 ) && istrue( var_4.damagepercent ) )
            return var_4._id_13083;
    }

    if ( !isdefined( var_3.vehiclename ) )
        return "ping_vehicle_concat_no_driver";

    var_5 = accuracy_bonus_factor( var_3, var_2.team );
...
delayeddetachbreak( var_0 )
{
    ...
    switch ( var_8 )
    {
        ...
        case "assassination":
            if ( var_1 delaydropbags( "ping_objective_contract" ) )
...
delayedattach( var_0, var_1 )
{
    ...
    if ( !isdefined( var_6 ) )
    {
        ...
        {
            if ( var_2 delaydropbags( "ping_vehicle_cash_deposit_helo" ) )
    ...
    {
        if ( var_2 delaydropbags( "ping_pickup_fieldupgrade" ) )
    ...
    else if ( issubstr( var_6, "CONTRACT" ) )
    {
        ...
        if ( var_9 != "" && !var_2 delaydropbags( var_9 ) )
            var_9 = "";
    ...
    {
        if ( var_2 delaydropbags( "ping_gasmask" ) )
            var_9 = "ping_gasmask";
        else
            var_9 = "ping_pickup_generic";
    }
    ...
    {
        if ( var_2 delaydropbags( "ping_loot_accesscard" ) )
    ...
    {
        if ( var_2 delaydropbags( "ping_cash_deposit_balloon" ) )
...
delayed_depositing( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( !isdefined( var_7 ) )
    {
        ...
        {
            if ( var_2 delaydropbags( "ping_plunder_bank_confirm" ) )
    ...
    if ( issubstr( var_7, "CONTRACT" ) )
    {
        ...
        if ( var_10 != "" && !var_2 delaydropbags( var_10 ) )
            var_10 = "";
    ...
    {
        if ( var_2 delaydropbags( "ping_gasmask_confirm" ) )
            var_10 = "ping_gasmask_confirm";
    }
    else if ( issubstr( var_7, "ARMORY_KIOSK" ) )
    {
        if ( var_2 delaydropbags( "ping_plunder_vendor_confirm" ) )
            var_10 = "ping_plunder_vendor_confirm";
    }
    else if ( issubstr( var_7, "_PLUNDER_EXTRACT" ) )
    {
        if ( var_2 delaydropbags( "ping_cash_deposit_confirm" ) )
...
calloutmarkerping_removecallout( var_0 )
{
    ...
    activate_chopper_boss_ammo_crates( "Remove Callout ID Start: " + var_0 );
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        activate_chopper_boss_ammo_crates( "Remove Callout ID Notify: " + var_0 );
...
delay_turn_laser_trap_back_on( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            activate_chopper_boss_ammo_crates( "gscObjectiveStartedProgress: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
delay_thirdpersoncamera( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_2 ) && var_2 == var_1 )
        {
            activate_chopper_boss_ammo_crates( "gscObjectiveDeleted: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
delay_start_player_weapon_fired_monitor( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    activate_chopper_boss_ammo_crates( "Watch Entity Death or Enemy Disconnect: " + var_0 );
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        var_1 scripts\engine\utility::_id_1312E( "death", "pickup", "explode" );

    if ( isdefined( var_1.relic_mythic_should_bypass_pain_cooldown ) )
        var_1.relic_mythic_should_bypass_pain_cooldown = undefined;

    calloutmarkerping_removecallout( var_0 );
}

delay_suspend_vehicle_convoy( var_0, var_1 )
{
    self endon( "predictiveCalloutClear_" + var_0 );
    activate_chopper_boss_ammo_crates( "watchPlayerDeathOrDisconnect: " + var_0 );
    var_2 = module_has_data_for_call_count( var_1 );
    scripts\engine\utility::_id_1312D( "death_or_disconnect", "self_pickedupitem_" + var_2 );
    calloutmarkerping_removecallout( var_0 );
}
...
calloutmarkerping_watchscriptabledeath( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    activate_chopper_boss_ammo_crates( "Watch scriptable death ID: " + var_0 );
    ...
    else if ( var_1.type == "equip_fulton_mp" )
    {
        ...
        var_2 scripts\engine\utility::_id_1312D( "death", "fulton_takeoff" );
    }
    else
        level scripts\engine\utility::_id_13130( "pickedupweapon_kill_callout_" + var_1.type + var_1.origin, "lootcache_opened_kill_callout" + var_1.origin, "dropbag_kill_callout_" + var_1.origin, "tablethide_kill_callout_" + var_1.origin, "carriable_kill_callout_" + var_1.origin );

    activate_chopper_boss_ammo_crates( "Watch scriptable death Remove ID: " + var_0 );
    calloutmarkerping_removecallout( var_0 );
}
...
delay_push_player_clear_door_way( var_0 )
{
    ...
    if ( accessreaderscriptableused( var_0 ) )
        var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
    else if ( activate_all_targets( var_0 ) )
    {
        if ( accessoryfemband( var_0 ) )
            var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
        else if ( delay_safe_spawn_chopper_boss( var_0 ) )
...
calloutmarkerping_onplayerdisconnect( var_0 )
{
    ...
    var_0 delay_show_player_clip();
}

delay_turn_off_tum_display( var_0, var_1 )
{
    var_2 = self;
...
delaystreamtomovingplane( var_0 )
{
    ...
    if ( !isdefined( var_1.delete_corpses[var_0] ) )
        return 0;

    return 1;
}

delayeventfired( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
    var_5 = var_4.delete_corpses.size;

    if ( var_5 > 10 )
        return 0;

    var_6 = var_4 delay_turn_off_tum_display( var_0, var_3 );
    var_7 = var_6 + var_1;
    var_8 = spawnstruct();
    var_8._id_1240C = var_7;
    var_8.poolid = var_0;
    var_8.denyascendmessagejugg = 0;
    var_4.delete_corpses[var_2] = var_8;
    return 1;
}
...
delay_turn_on_headlights( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_3.handleendgamenonwinnersplash ) )
        return 0;

    var_4 = gettime();
    var_5 = "pool" + var_0;
    var_6 = var_3 delaystreamtomovingplane( var_5 );

    if ( var_6 )
    {
        var_7 = var_3.delete_corpses[var_5]._id_1240C;

        if ( var_4 >= var_7 )
        {
            var_8 = var_3 delayeventfired( var_0, var_4, var_5, var_2 );
            return istrue( var_8 );
        }

        if ( var_1 == "ping_response_cancel" && var_3.delete_corpses[var_5].denyascendmessagejugg == 0 )
        {
            var_3.delete_corpses[var_5].denyascendmessagejugg = 1;
            return 1;
        }
...
delaydestroyhudelem()
{
    ...
    for (;;)
    {
        ...
        for ( var_1 = 0; var_1 < level.players.size; var_1++ )
        {
            ...
            if ( !isdefined( var_2 ) || !isdefined( var_2.delete_corpses ) )
                continue;

            foreach ( var_5, var_4 in var_2.delete_corpses )
            {
                if ( var_0 > var_4._id_1240C )
                    var_2.delete_corpses[var_5] = undefined;
            }
        }
    }
}

delayedunsetbettermissionrewards( var_0, var_1, var_2, var_3 )
{
    var_4 = 0;
...
delay_show_balloon( var_0, var_1 )
{
    var_2 = self;
    ...
    foreach ( var_7 in var_5 )
    {
        ...
        if ( isdefined( var_8.reset_being_revived ) )
            var_8 delete();
...
{
    var_1 = self;
    var_2 = var_1 delayedeventtypes( var_0 );
    var_3 = var_1 delayedshowtablets( var_0 );
...
delete_after_flank_trigger_spawns( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    var_5 = var_4 delayedeventtypes( var_0 );
    var_6 = var_4 delayedshowtablets( var_0 );
    var_7 = soundexists( var_5 );
    var_8 = soundexists( var_6 );
    var_9 = delayedunsetbettermissionrewards( var_7, var_5, var_8, var_6 );
    var_10 = var_4 delay_turn_on_headlights( var_1, var_0, var_9 );
...
delay_show_backpack()
{
    ...
    for (;;)
    {
        ...
        if ( var_6 < var_3 )
        {
            delay_show_balloon( "br_ping_cancel", 0 );
...
delete_bad_trucks( var_0 )
{
    var_1 = self;
    var_1 notify( "calloutMarkerPingVO_playPredictivePingCleared" );
    var_1 endon( "calloutMarkerPingVO_playPredictivePingCleared" );
    var_1 delay_show_balloon( "br_ping_cancel", var_0 );
    wait( getdvarfloat( "scr_calloutmarkerping_delay_between_vo_and_sfx_secs_cleared", 0.5 ) );

    if ( isdefined( var_1 ) )
        var_1 delete_after_flank_trigger_spawns( "ping_response_cancel", var_0 );
}

delete_ai( var_0 )
{
    var_1 = self;
    var_1 delete_bad_trucks( var_0 );
}

delete_after_objective_a( var_0, var_1 )
{
    var_2 = self;
    ...
    if ( activate_all_targets( var_0 ) )
    {
        ...
        var_4 = var_2 delayed_depositing( var_0, var_3, var_1 );
    }
    else if ( activate_additional_ammo_crates( var_0 ) )
    ...
    else
    {
        ...
        {
            case 0:
                if ( var_1 delaydropbags( "ping_generic_ping_response" ) )
            ...
            case 7:
                ...
                break;
            case 8:
                if ( var_1 delaydropbags( "ping_vehicle_confirm" ) )
    ...
    if ( isplayer( var_1 ) )
        var_2 delete_after_flank_trigger_spawns( var_4, var_0, var_1 );
    else if ( isdefined( var_2 ) )
        var_2 delete_after_flank_trigger_spawns( var_4, var_0 );
}

delete_airlock_ents( var_0 )
{
    var_1 = self;
    ...
    if ( isdefined( var_1 ) )
        var_1 delay_vehicle_to_push_explode_sequence( var_0 );
}

delay_safe_spawn_chopper_boss( var_0 )
{
    var_1 = self;
    var_2 = var_1 calloutmarkerping_getent( var_0 );

    if ( isdefined( var_2 ) && isdefined( var_2._id_1288A ) )
        return 1;
...
accessoryfemband( var_0 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2.classname ) && issubstr( var_2.classname, "scriptable" ) && !isdefined( var_2.entity ) && var_2 getscriptableisreserved() )
    {
        if ( var_2 _meth_87B7() )
        {
            ...
            return scripts\mp\vehicles\vehicle_compass_mp::rear_minigun_speed( var_3 );
        }
    }
...
delay_spawn_nav_repulsor( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    var_2 = 0.25;
    ...
    for (;;)
    {
        var_5 = activate_destructible_cinderblock( var_0, var_1, var_4 );
        ...
        var_6 = accuracy_bonus_factor( var_1, var_4 );
        ...
        if ( var_6 )
        {
            ...
            if ( var_3 >= 3 )
            {
                ...
                if ( isdefined( var_7 ) )
                    thread delay_play_depart_vo( var_0, var_7 );
                else
                    calloutmarkerping_removecallout( var_0 );
...
activate_destructible_cinderblock( var_0, var_1, var_2 )
{
    var_3 = self;
    var_4 = 0;
...
accuracy_bonus_factor( var_0, var_1 )
{
...
abandonedtimeoutoverride( var_0 )
{
    ...
    if ( !isdefined( var_1.delay_turn_off_red_lights_along_track ) )
        var_1.delay_turn_off_red_lights_along_track = [];

    if ( !isdefined( var_1.delay_turn_off_red_lights_along_track[var_0] ) )
        var_1.delay_turn_off_red_lights_along_track[var_0] = 0;
    else
        var_1.delay_turn_off_red_lights_along_track[var_0]++;

    var_2 = [];
    var_2[var_2.size] = "ping_id";
    var_2[var_2.size] = var_1.delay_turn_off_red_lights_along_track[var_0];
...
abilitykey()
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        {
            if ( var_0 calloutmarkerping_getactive( var_1 ) )
                var_0 abilities( var_1, "clear_all" );
        }
    }
}

abilities( var_0, var_1 )
{
    var_2 = self;
    var_3 = [];
    var_3[var_3.size] = "ping_id";
    var_3[var_3.size] = var_2.delay_turn_off_red_lights_along_track[var_0];
...
{
    var_1 = self;
    var_1 abilities( var_0, "clear_single" );
    var_1 notify( "predictiveCalloutClear_" + var_0 );
    var_1 thread delete_bad_trucks( var_0 );
}

abilityleft( var_0, var_1 )
{
    var_2 = self;
    var_2 thread activate_control_station( var_0, 0, 1 );
    var_2 thread delete_after_objective_a( var_0, var_1 );
...
absolutevelocity( var_0 )
{
    ...
    if ( istrue( level.playerstarttimetracking ) && !istrue( var_1 istacmapactive() ) )
    {
        calloutmarkerping_removecallout( var_0 );
        return;
    }

    var_1 abandonedtimeoutoverride( var_0 );
    var_1 thread activate_control_station( var_0 );
    var_1 abandonedtimeoutdelay( var_0 );
    var_1 thread delete_airlock_ents( var_0 );
    var_1 achievement_id( var_0 );
...
{
    var_1 = self;
    var_1 thread activate_control_station( var_0, 0, 1 );
    var_1 delay_show_balloon( "br_ping_enemy", var_0 );
}

accesscardsspawned_red()
{
    var_0 = self;
    var_1 = activate_battle_station();

    if ( var_1 != -1 )
    {
        var_0 abilitykey();
        var_0 delay_show_balloon( "br_ping_cancel", var_1 );
        var_0 delete_after_flank_trigger_spawns( "ping_response_cancel", var_1 );
    }
...
{
    var_1 = self;
    var_1 thread delay_spawn_room_soldiers( var_0 );
}
