...
flash_crate_use()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "cop_car", 1 );
    var_0.id = 6;
...
flash_crate_update_hint_logic_alt()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "cop_car", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cop_car" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "cop_car" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "cop_car", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "cop_car", ::cop_car_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "cop_car_mp", 3 );
}
...
cop_car_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "cop_car", var_0 );
