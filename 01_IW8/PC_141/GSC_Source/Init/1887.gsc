...
relic_count( var_0 )
{
    if ( scripts\mp\utility\game::relic_amped_play_beep() )
        return scripts\mp\gametypes\br_c130::ispointinbounds( var_0, 0, 1 );
    else
        ispointinoutofbounds( var_0 );
}
...
onenteroob( var_0 )
{
    ...
    if ( isplayer( var_0 ) )
    {
        if ( isdefined( level.spawndragonsbreathstruct ) )
            var_1 = level.spawndragonsbreathstruct;
        else
    ...
    else
    {
        ...
        var_5 = getoutofboundstime( var_3, var_0._id_11D2E );
...
onexitoob( var_0, var_1, var_2 )
{
    ...
    if ( isplayer( var_0 ) )
    {
        if ( isdefined( level.spawndropbagatposition ) )
            var_3 = level.spawndropbagatposition;
        else
...
watchoobtriggerenter( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_1 ) && scripts\mp\utility\game::reloadnotehandler( var_1 ) )
            continue;
...
{
    if ( istrue( var_1 ) )
        return scripts\mp\utility\game::monitor_dropkit_marker_throw();

    if ( isdefined( var_1 ) && !var_1 )
        return scripts\mp\utility\game::monitor_death_thread();
    ...
    switch ( var_0 )
    {
        ...
        case "br":
            return scripts\mp\utility\game::monitor_bush_trig();
        case "default":
