...
setupminimap( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( scripts\cp_mp\utility\game_utility::getlocaleid() ) && scripts\mp\utility\game::getgametype() != "war" && !scripts\cp_mp\utility\game_utility::registerscriptableinstance() )
    {
    ...
    else if ( scripts\cp_mp\utility\game_utility::registerscriptableinstance() || scripts\cp_mp\utility\game_utility::getmapname() == "mp_br_quarry" )
    {
        var_4 = [];
