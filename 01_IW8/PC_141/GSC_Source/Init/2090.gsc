...
waitforentervehicle()
{
    var_0 = scripts\engine\utility::_id_13137( "entervehicle", "death", "long_death", "failedentervehicle" );
...
exitingvehicle()
{
    ...
    self._blackboard.currentvehicle.deposit_from_compromised_convoy_delayed_failsafe = 0;
    self._blackboard.currentvehicle thread is_first_time_high_tier();
}

is_first_time_high_tier()
{
    self endon( "death" );
    waitframe();
    self.deposit_from_compromised_convoy_delayed_failsafe = 1;
}
