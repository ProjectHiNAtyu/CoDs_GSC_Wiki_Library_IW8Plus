...
gettargetmarker( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            {
                if ( relics_monitor_on_player( var_3 ) )
                {
                ...
                else if ( scripts\mp\vehicles\vehicle_compass_mp::remapattachmentparentname() )
                {
    ...
    if ( isdefined( var_3.location ) && isdefined( var_3.angles ) )
    {
        ...
        if ( isdefined( var_8["entity"] ) )
        {
            ...
            var_3.staytoasty = ( var_11, var_12, var_13 );
            var_3.stayfrosty = combineangles( invertangles( var_9.angles ), var_3.angles );
        }
