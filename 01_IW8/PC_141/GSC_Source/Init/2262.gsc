...
little_bird_init()
{
    level.select_bunker_interior_three_spawners = getdvarfloat( "scr_little_bird_dmg_factor_fuselage", 1.0 );
    level.select_bunker_server_two_spawners = getdvarfloat( "scr_little_bird_dmg_factor_tail_stabilizer", 1.0 );
    level.select_bunker_roof_spawners = getdvarfloat( "scr_little_bird_dmg_factor_main_rotor", 1.2 );
    level.select_bunker_server_one_spawners = getdvarfloat( "scr_little_bird_dmg_factor_tail_rotor", 1.0 );
    level.select_bunker_interior_two_spawners = getdvarfloat( "scr_little_bird_dmg_factor_landing_gear", 0.5 );
    level.select_bunker_interior_one_spawners = getdvarfloat( "scr_little_bird_dmg_factor_driverless_collision", 3.0 );
    level.select_hostage_room_three_spawners = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_high", 0.9 );
    level.select_hostage_room_one_spawners = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_mid", 0.9 );
    level.select_equipment_spawners = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_low", 0.1 );
    level.select_chopper_boss_target_player = getdvarfloat( "scr_little_bird_impulse_dmg_factor_low", 0.1 );
    level.select_cliff_two_spawners = getdvarfloat( "scr_little_bird_impulse_dmg_factor_mid_low", 0.2 );
    level.select_cliff_one_spawners = getdvarfloat( "scr_little_bird_impulse_dmg_factor_mid_high", 0.75 );
    level.select_patrol_seven_spawners = getdvarfloat( "scr_little_bird_dmg_pitch_roll_threshold", 55.0 );
    level.select_patrol_one_spawners = getdvarfloat( "scr_little_bird_dmg_pitch_roll_factor", 10.0 );
    level.select_patrol_six_spawners = getdvarfloat( "scr_little_bird_wood_surf_dmg_scalar", 0.6 );
...
little_bird_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12F53( "little_bird", "single", [ "pilot", "fl_platform", "fr_platform", "bl_platform", "br_platform" ] );
}

set_relic_nuketimer()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "little_bird", 1 );
...
set_relic_noregen()
{
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "little_bird", var_0 );
    var_1 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "little_bird" );
    var_1.class = "medium_heavy";
    var_2 = scripts\cp_mp\vehicles\vehicle_damage::_id_12F06( "little_bird", "heavy" );
    var_2.too_far_dist = ::set_vehicle_anims_blima;
    var_2.total_killed = ::set_vehicle_anims_decho;
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "little_bird" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "little_bird", 12 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "little_bird", ::little_bird_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "little_bird_mp", 5 );
}

set_relic_noluck()
{
    var_0 = _applydvarstosettings::_id_12EC9( "little_bird", 1 );
    var_0.brc130airdropcratedestroycallback = 1.5;
    var_0.getignoreprops = 0.875;
    var_0.get_next_open_stop = 350;
    var_0.get_next_rein_group = 525;
    var_0.get_next_cypher_id_from_pool = 875;
    var_0.get_node_closest_to_target_loc = 8.75;
    var_0.get_num_dogtag_in_kill_zone_or_under_bridge_zone = 35;
    var_0.get_next_track_index = 70;
...
little_bird_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "little_bird", var_0 );
...
fadeoverlay()
{
    ...
    for (;;)
    {
        ...
        {
            case 0:
                var_9 = level.select_bunker_interior_three_spawners;
                break;
            case 1:
                var_9 = level.select_bunker_server_two_spawners;
                break;
            case 2:
                var_9 = level.select_bunker_roof_spawners;
                break;
            case 3:
                var_9 = level.select_bunker_server_one_spawners;
                break;
            case 4:
                var_9 = level.select_bunker_interior_two_spawners;
                break;
        }
        ...
        if ( !isdefined( var_11 ) )
            var_10 = var_10 * level.select_bunker_interior_one_spawners;
        ...
        if ( abs( var_12 > level.select_patrol_seven_spawners ) )
            var_10 = var_10 * level.select_patrol_one_spawners;
        ...
        if ( abs( var_13 > level.select_patrol_seven_spawners ) )
            var_10 = var_10 * level.select_patrol_one_spawners;

        var_14 = 0;

        if ( var_10 > level.select_hostage_room_three_spawners )
            var_14 = self.maxhealth;
        else if ( var_10 > level.select_hostage_room_one_spawners )
        {
            var_15 = level.select_hostage_room_three_spawners - level.select_hostage_room_one_spawners;
            var_16 = ( var_10 - level.select_hostage_room_one_spawners ) / var_15;
            var_17 = self.maxhealth * level.select_cliff_two_spawners;
            var_18 = self.maxhealth * level.select_cliff_one_spawners;
            var_14 = scripts\engine\math::lerp( var_17, var_18, var_16 );
        }
        else if ( var_10 > level.select_equipment_spawners )
            var_14 = self.maxhealth * level.select_chopper_boss_target_player;

        if ( var_14 > 0 )
        {
            if ( isdefined( var_11 ) && var_3 == 11534336 )
                var_14 = var_14 * level.select_patrol_six_spawners;
...
_id_12F4A( var_0 )
{
    ...
    scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_setammo( "little_bird", "flares", scripts\engine\utility::ter_op( self.keep_firing_minigun, 1, 0 ), var_0 );
