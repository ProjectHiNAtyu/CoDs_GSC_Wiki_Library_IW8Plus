...
updaterevivetriggerspawnposition()
{
    ...
    if ( !istrue( scripts\mp\flags::gameflag( "prematch_done" ) ) )
    {
        ...
        {
            level scripts\engine\utility::_id_1312E( "prematch_done", "start_mode_setup", "infil_started" );
            var_0 = int( max( level.prematchperiodend - 5, 5 ) );
            wait( var_0 );
        }
        else
            level scripts\engine\utility::_id_1312E( "prematch_done", "start_mode_setup", "match_start_real_countdown" );
    }
...
revivetriggerholdonusebegin( var_0, var_1 )
{
    ...
    var_2 scripts\mp\playerlogic::_id_120F3( 1 );
    ...
    var_2 scripts\mp\utility\player::_id_11965( "teamrevive::reviveTriggerHoldOnUseBegin() Killcam SKIPPED" );
...
revivetriggerholdonuseend( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( self.trigger.owner ) )
    {
        ...
        var_4 scripts\mp\playerlogic::_id_120F3( 0 );
