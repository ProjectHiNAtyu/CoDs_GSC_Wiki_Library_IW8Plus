...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "circle_peek", ::_id_12C44, undefined, ::_id_12C2F );
    var_0 = "circle_peak";
...
_id_12C44( var_0, var_1 )
{
    ...
    var_4 = endmatchcamerastriggered( var_0 );
...
endmatchcamerastriggered( var_0 )
{
    if ( !isdefined( level._id_12952 ) )
        return 0;
    ...
    var_1 = level._id_12952[self.team] + level.br_circle.circleindex + 1;

    for ( var_2 = var_1; var_2 < level.endofmatchdatasent.size; var_2++ )
        scripts\mp\gametypes\br_quest_util::_id_11A31( self.team );
