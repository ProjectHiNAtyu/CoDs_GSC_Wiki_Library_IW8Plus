...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "explosive_bow", ::_id_12C45, undefined, ::_id_12C30 );
    init_fx();
}
...
_id_12C46( var_0, var_1 )
{
    ...
    if ( !deploy_subway_cars_on_track() )
        return 0;
...
{
    scripts\common\utility::binoculars_showtargetmarker( 0, "explosive_bow" );
    thread init_drop_locations();
    var_0 = scripts\mp\utility\weapon::getweaponrootname( "iw8_sn_t9explosivebow_mp" );
    var_1 = scripts\mp\class::deactivate_hacked_console( var_0, undefined, undefined, -1, undefined, undefined, 0 );
    self.brmini_kickplayersatcircleedge = 1;
    ...
    if ( isdefined( self.playeriscinematiclayeron ) && self.playeriscinematiclayeron )
    {
        self setweaponammoclip( var_1, 1 );
        self setweaponammostock( var_1, self.playeriscinematiclayeron - 1 );
    ...
    self.playeriscinematiclayeron = self getammocount( var_1 );
    self notify( "explosive_bow_equipped" );
    thread _id_13258( var_1, "weapon_taken" );
    thread _id_13258( var_1, "weapon_dropped" );
    thread _id_1320B( var_1 );
    thread _id_13259( var_1 );
    thread _id_13251( var_1 );
    thread _id_13206( var_1 );
    return 1;
}
...
init_drop_locations()
{
    ...
    if ( isdefined( self ) )
        scripts\common\utility::binoculars_showtargetmarker( 1, "explosive_bow" );
}
...
_id_13259( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self hasweapon( var_0 ) && var_1 != var_0 )
        {
            ...
            {
                self.choosecrouchorstandtac = self.lastdroppableweaponobj;
                scripts\mp\weapons::_id_1212C( var_0 );
            }
        ...
        if ( var_1 == var_0 && isdefined( self.choosecrouchorstandtac ) )
        {
            scripts\mp\weapons::_id_1212C( self.choosecrouchorstandtac );
            self.choosecrouchorstandtac = undefined;
        }
    }
}
...
_id_13251( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.playeriscinematiclayeron = self getammocount( var_0 );

        if ( self.playeriscinematiclayeron == 0 )
        {
            self.playeriscinematiclayeron = undefined;
            thread enter_numbers_init();
...
enter_numbers_init()
{
    ...
    self endon( "cleanup_explosive_bow" );
    self.brmini_kickplayersatcircleedge = 0;
    wait 6;
...
_id_127C4( var_0 )
{
    ...
    if ( isdefined( self.playeriscinematiclayeron ) && self.playeriscinematiclayeron != 0 )
    {
        self notify( "stop_explosive_bow_cancel_watcher" );
        laser_reset_position();
    }
...
laser_reset_position()
{
    ...
    if ( var_0 )
        scripts\mp\gametypes\br_pickups::laser_show_position( "explosive_bow", 1, 0 );
    else
    {
