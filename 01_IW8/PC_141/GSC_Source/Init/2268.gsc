...
vehicle_init()
{
    ...
    _applysalesdiscount::_id_12EDF();
    scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_init();
    _applydvarstosettings::_id_12ECE();
    ...
    scripts\mp\vehicles\vehicle_damage_mp::disable_spawner();
    ...
    scripts\cp_mp\vehicles\customization\battle_tracks::set_strict_ff();
    ...
    __ending_origin::start_safehouse_quarry();
    scripts\asm\soldier\mp\melee::baitedbydecoy();
}
...
_id_12EF2( var_0, var_1, var_2 )
{
    ...
    scripts\cp_mp\utility\weapon_utility::_id_12124( var_0, ::_id_12F50 );
    scripts\cp_mp\utility\weapon_utility::_id_12125( var_0, ::_id_12F51 );
    ...
    thread _id_12FD3( var_0 );
}

_id_12EF3( var_0, var_1 )
{
...
_id_12F3B( var_0 )
{
    ...
    _applysalesdiscount::_id_12EDD( var_0 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EFB( var_0 );
...
_id_12FD3( var_0 )
{
    ...
    thread _applydvarstosettings::_id_12ED5( var_0 );

    while ( isdefined( var_0 ) )
    {
        var_2 = spawnstruct();
        scripts\cp_mp\utility\vehicle_omnvar_utility::_id_13023( var_0 );
        _id_12EBD( var_0 );

        if ( isdefined( var_1._id_12DBF ) )
            var_0 [[ var_1._id_12DBF ]]( var_2 );

        var_0 scripts\cp\helicopter\chopper_boss::_id_12FF3();
        waitframe();
    }
}
...
_id_12EBF( var_0 )
{
    if ( isdefined( var_0._id_1300E ) )
    {
        if ( var_0._id_1300E != "" )
        {
            ...
            {
                if ( var_0 getscriptableparthasstate( "trail", var_0._id_1300E ) )
                    var_0 setscriptablepartstate( "trail", var_0._id_1300E );
            }
            else if ( var_0 getscriptableparthasstate( "trail", var_0._id_1300E + "_idle" ) )
                var_0 setscriptablepartstate( "trail", var_0._id_1300E + "_idle" );
        }
    }
}
...
_id_12EBD( var_0 )
{
    if ( !var_0 scripts\cp_mp\vehicles\vehicle_tracking::_issuspendedvehicle() && !istrue( var_0 vehiclecanfly() ) && !var_0 vehicle_isonground() )
    {
        ...
        {
            if ( !isdefined( var_0.ui_show_dist ) )
                var_0.ui_show_dist = gettime();

            if ( gettime() - var_0.ui_show_dist >= 650 )
            {
                var_2 = ( 128, 128, 128 );
                ...
                {
                    if ( isdefined( var_7 ) && var_7 scripts\cp_mp\killstreaks\helper_drone::relic_bang_and_boom_dropfunc() && !istrue( var_7.isdestroyed ) )
                    {
                        var_7 thread scripts\cp_mp\killstreaks\helper_drone::helperdroneexplode( 0 );
                        var_0.ui_show_dist = undefined;
                    }
                }
...
_id_12FB5( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( istrue( var_3 ) )
        thread _id_12FCE( var_0, var_1 );
}

_id_12F3E( var_0, var_1 )
{
    if ( !isdefined( var_0.turrets ) )
        return;
...
_id_12F6D( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F90( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F94( var_0, var_1 );
...
_id_12F6B( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F90( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F92( var_0, var_1 );
    else if ( level.teambased )
    {
        var_2 = var_0.team;
...
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F90( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F96( var_0, var_1 );
    else if ( level.teambased )
...
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F90( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F95( var_0, var_1 );
    else
    {
        if ( level.teambased )
...
_id_12F6C( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F90( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F93( var_0, var_1 );
    else
    {
        if ( level.teambased )
            return isdefined( var_0.team ) && var_0.team != var_1;
...
_id_12F70( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F90( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F97( var_0, var_1 );
    else
    {
        if ( level.teambased )
...
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F90( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F89( var_0 );
    else
    {
...
_id_12FAF( var_0, var_1, var_2, var_3 )
{
...
_id_12FAE( var_0 )
{
    ...
    var_2 = scripts\cp_mp\utility\player_utility::mix();
...
vehicle_watchflipped( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        else
        {
            if ( var_4 )
            {
                scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F78( var_0, 1 );
        ...
        if ( var_7 )
        {
            ...
            if ( !var_4 )
            {
                scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F78( var_0, 0 );
...
_id_12F45( var_0 )
{
    ...
    switch ( var_0 )
    {
        ...
        case "cargo_truck":
            ...
            break;
        case "cargo_truck_mg":
            var_1 = scripts\mp\vehicles\vehicle_damage_mp::disable_near_snake_cam_after_door_open;
            break;
        case "cop_car":
        ...
        case "little_bird":
            ...
            break;
        case "little_bird_mg":
            var_1 = scripts\cp_mp\vehicles\customization\battle_tracks::set_spawner_type;
            break;
        ...
        case "van":
            ...
            break;
        case "motorcycle":
            var_1 = __ending_origin::start_reach_pipe_room;
            break;
        case "veh_a10fd":
            var_1 = scripts\asm\soldier\mp\melee::backtruck;
            break;
    }
