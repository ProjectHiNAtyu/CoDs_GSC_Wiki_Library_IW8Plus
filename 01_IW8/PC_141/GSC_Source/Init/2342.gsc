...
rundronehive( var_0, var_1, var_2, var_3 )
{
    ...
    var_0 scripts\common\utility::_id_12C2C( level.smartwatchinteract, var_2, var_10.origin );
    var_11 = 0;
    ...
    for (;;)
    {
        var_13 = var_10 scripts\engine\utility::_id_13135( "death", "missileTargetSet" );
...
applygasdamageovertime( var_0, var_1, var_2 )
{
    ...
    while ( var_2 istouching( self ) )
    {
        ...
        var_3 = scripts\engine\utility::_id_13141( 0.5, "death" );
