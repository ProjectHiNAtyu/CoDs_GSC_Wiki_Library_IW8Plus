...
updatesharpfocus()
{
    ...
    var_1 = undefined;
    var_2 = scripts\mp\utility\weapon::_id_132D5( var_0 );
...
updatedefaultflinchreduction()
{
    ...
    var_0 = undefined;
    var_1 = scripts\mp\utility\weapon::_id_132D5( self.currentweapon );
...
ammodisabling_run( var_0 )
{
    ...
    scripts\engine\utility::_id_13141( 0.8, "death" );
...
setviewkickoverride()
{
    ...
    self.trial_rpg_settings = 0.05;
    self.trial_shooters = 0.08;
    self.trial_sentry_turrets = 0.02;
...
unsetviewkickoverride()
{
    ...
    self.trial_rpg_settings = undefined;
    self.trial_shooters = undefined;
    self.trial_sentry_turrets = undefined;
...
watchpainted( var_0, var_1 )
{
    ...
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_13141( var_1, "death" );
    self.painted = 0;
...
watchpaintedagain( var_0 )
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_1312D( "painted_again", "painted_end" );
    scripts\mp\utility\outline::outlinedisable( var_0, self );
}
...
boomtrackplayerdeath( var_0, var_1 )
{
    ...
    var_2 = scripts\engine\utility::_id_13141( 7.0, "death" );
...
unsetcustomjuicedondeath()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    scripts\engine\utility::_id_1312D( "death", "faux_spawn" );
...
unsetcustomjuicedonmatchend()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    level scripts\engine\utility::_id_1312D( "round_end_finished", "game_ended" );
    thread unsetcustomjuiced();
}
...
watchlifepackoutlinestate( var_0 )
{
    ...
    for (;;)
    {
        var_0 scripts\engine\utility::_id_1312D( "enabled_life_pack_boost", "disabled_life_pack_boost" );
        setlifepackoutlinestate( var_0 );
    }
}
...
{
    self endon( "death" );
    var_0 scripts\engine\utility::_id_1312D( "death_or_disconnect", "toughen_up_end" );
...
_id_12315( var_0, var_1, var_2, var_3 )
{
    var_4 = var_1 - var_2;
    ...
    var_8 = scripts\engine\math::getinventoryslotscriptabletypeinfo( var_7 );
    ...
    foreach ( var_28, var_8 in level.sixth_sense_players )
    {
        ...
        if ( var_2 && !isbot( var_8 ) )
        {
            ...
            foreach ( var_13 in var_11 )
            {
                ...
                if ( !var_8 _id_12315( var_13, var_10, var_14, var_15 ) )
                    continue;

                var_9 = var_9 | var_8 mp_port2_gw_patch( var_13 );
            }
        }
        else
        {
            ...
            foreach ( var_13 in level.players )
            {
                ...
                if ( _id_12316( var_18, var_10, var_14 ) )
                {
                    var_3 = var_3 + 2;
                    var_20 = [ var_8 ];
        ...
        if ( scripts\mp\gametypes\br_gametypes::register_script_model_animation( "sixthSenseThink" ) )
            var_9 = var_9 | scripts\mp\gametypes\br_gametypes::_id_11E4F( "sixthSenseThink", var_8 );
...
setovercharge()
{
    thread scripts\mp\trials\trial_utility::_id_12105( "ui_overcharge", 1 );
}

unsetovercharge()
{
    thread scripts\mp\trials\trial_utility::_id_12105( "ui_overcharge", 0 );
}
...
outlinekillstreaks_enablemarksafterprematch()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        _applysalesdiscount::_id_12EEA( self );
    }
}
...
{
    self giveweapon( self._id_129BF );
    self assignweaponmeleeslot( self._id_129BF );
    thread watchthrowingknifescavenge();

    if ( self._id_129BF == "iw8_throwingknife_fire_melee_mp" )
        thread _id_1325B();
    else if ( self._id_129BF == "iw8_throwingknife_electric_melee_mp" )
        thread _id_1325A();
}

unsetthrowingknifemelee()
{
    if ( isdefined( self._id_129BF ) && self hasweapon( self._id_129BF ) )
        self takeweapon( self._id_129BF );

    self notify( "specialty_equip_throwingKnife_end" );

    if ( isdefined( self._id_129BF ) && self._id_129BF == "iw8_throwingknife_fire_melee_mp" )
        runplunderextractsitetimer();
    else if ( isdefined( self._id_129BF ) && self._id_129BF == "iw8_throwingknife_electric_melee_mp" )
        runpain();
}
...
{
    self.player scripts\engine\utility::_id_1312D( "disconnect", "unsetBulletOutline" );
...
markempsignatures( var_0, var_1 )
{
    ...
    var_0 scripts\engine\utility::_id_1312D( "death", "cloak_end" );
...
startgpsjammer()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\class::resetcircuitbreakers( var_0 ) )
            continue;
...
ghostdoesenemyhaveauav()
{
    ...
    if ( istrue( var_1 ) && getdvarint( "scr_uav_for_squad_only", 1 ) )
    {
        ...
        foreach ( var_5, var_4 in level.squaddata[self.team] )
            var_2 = var_2 + level.activeadvanceduavs[var_5];

        var_0 = level.allow_br_loot_to_br_marked - var_2 > 0;
    }
    else
        var_0 = level.allow_br_loot_to_br_marked - level.activeadvanceduavs[self.team] > 0;
...
{
    self endon( "groundPoundShield_deleteShield" );
    scripts\engine\utility::_id_1312D( "death_or_disconnect", "groundPound_unset" );
    thread groundpoundshield_deleteshield( var_0 );
}
...
{
    var_0 endon( "death" );
    scripts\engine\utility::_id_1312D( "death_or_disconnect", "battleSlide_unset" );
    var_0 delete();
}
...
thrusterstopfx()
{
    self endon( "death_or_disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_1312D( "doubleJumpBoostEnd", "thruster_unset" );
    waitframe();
}
...
{
    scripts\engine\utility::_id_1312D( "ADSTargetMarkUnset", "death_or_disconnect" );
...
setkillstreaktoscorestreak()
{
    ...
    if ( isdefined( self.pers["killstreakToScorestreak_lifeId"] ) && self.pers["killstreakToScorestreak_lifeId"] == self.lifeid )
    {
        ...
        var_0 = runjoininprogresstimeout( self.streakpoints );
...
unsetkillstreaktoscorestreak()
{
    ...
    var_0 = runkilltriger( self.streakpoints );
    scripts\mp\killstreaks\killstreaks::updatestreakcosts();
    scripts\mp\killstreaks\killstreaks::setstreakpoints( var_0 );
    scripts\mp\killstreaks\killstreaks::checkstreakreward( self.streakpoints, 1 );
    scripts\mp\killstreaks\killstreaks::updatestreakmeterui();
...
proximityrevivethink()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_7 in var_5 )
        {
            if ( istrue( var_7.inlaststand ) && !istrue( var_7.stuckinlaststand ) && !istrue( var_7.laststandhealisactive ) && !istrue( var_7 scripts\mp\playerlogic::mine_caves_structs() ) && !isdefined( var_0.owner ) )
        ...
        if ( isdefined( level.revivetriggers ) )
        {
            foreach ( var_10 in level.revivetriggers )
            {
                ...
                {
                    if ( !istrue( var_10.trigger.owner scripts\mp\playerlogic::mine_caves_structs() ) && !isdefined( var_0.owner ) )
                    {
...
proximityrevive( var_0, var_1, var_2 )
{
    ...
    var_0 scripts\mp\playerlogic::_id_120F3( 1 );
    var_1.owner = var_0;
...
watchproximityrevivefail( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 scripts\mp\playerlogic::_id_120F3( 0 );
        var_0 scripts\mp\gameobjects::updateuiprogress( var_1, 0 );
        var_0 scripts\mp\utility\player::_freezecontrols( 0, undefined, "proximityRevive" );
...
_id_1216B()
{
    if ( isdefined( self.script_model_spawn_and_use_logic ) && self.script_model_spawn_and_use_logic == gettime() )
        regendelayreduce_onkill();
}
...
rechargeequipment_updateslot( var_0, var_1 )
{
    ...
    if ( isdefined( level.leader_charge_dialogue ) )
        var_7 = level.leader_charge_dialogue;
    else
    ...
    while ( isdefined( self.markequipmentstate.markingent ) && !istrue( self.ishacking ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( self.markequipmentstate.markedents, self.markequipmentstate.markingent ) )
        {
            if ( scripts\mp\utility\player::isplayerads() )
            {
                ...
                if ( level.teambased && _applysalesdiscount::_id_12EE0( self.markequipmentstate.markingent ) )
                {
                    self.markequipmentstate.markingent._id_1293B = self.team;
                    var_7 = scripts\mp\utility\player::getteamarray( self.markequipmentstate.markingent._id_1293B );

                    foreach ( var_9 in var_7 )
                        _applysalesdiscount::_id_12EEC( self.markequipmentstate.markingent, var_9 );
                }
...
unmarkafterduration( var_0 )
{
    ...
    scripts\engine\utility::_id_13147( var_1, "disconnect" );
    unmarkent( var_0 );
}
...
unmarkent( var_0 )
{
    ...
    if ( isdefined( var_0._id_1293B ) )
    {
        if ( level.teambased && _applysalesdiscount::_id_12EE0( var_0 ) )
        {
            var_1 = scripts\mp\utility\player::getteamarray( var_0._id_1293B );

            foreach ( var_3 in var_1 )
                _applysalesdiscount::_id_12EEC( var_0, var_3 );
        }

        var_0._id_1293B = undefined;
    }
...
markedentities_think()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( isdefined( self.markequipmentstate ) )
            {
                self.markequipmentstate.markedents = skipdeathicon( self.markequipmentstate.markedents, var_0 );
...
getpropspawnlocation()
{
    ...
    scripts\engine\utility::_id_1312D( "spawned_player", "disconnect" );

    if ( isdefined( self ) )
        self.path_loop = undefined;
...
_id_12E05( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util::move_spawnpoints_to_ac130( var_0 );

    if ( !isdefined( level.c4vehiclecooperator ) )
        level.c4vehiclecooperator = [];

    var_2 = 0;

    if ( isdefined( level.c4vehiclecooperator[var_0] ) )
        var_2 = level.c4vehiclecooperator[var_0];

    var_3 = var_1 - var_2;

    if ( var_3 != 0 )
        scripts\mp\gametypes\br_quest_util::anim_spawnposition_override( var_0, var_3 );

    level.c4vehiclecooperator[var_0] = var_1;
}
...
_id_12150()
{
    self.updateburningtodeath = spawnstruct();
    self.updateburningtodeath._id_12909 = [];
    self.updateburningtodeath.targetids = [];
    self.updateburningtodeath.pingcirculararray = [];
    self.updateburningtodeath.currentpingindex = 0;

    for ( var_0 = 0; var_0 < 4; var_0++ )
        self.updateburningtodeath.pingcirculararray[var_0] = -1;
}

hideconesifinfil( var_0 )
{
    ...
    if ( isdefined( self.updateburningtodeath ) )
    {
        updatec4vehiclemultkill( var_0 );
        pingondamage_addoutline( var_0 );
        var_0.targetalreadymarked = 1;
    }
}
...
updatec4vehiclemultkill( var_0 )
{
    ...
    if ( isdefined( var_0.targetalreadymarked ) )
        return;

    var_6 = self.updateburningtodeath._id_12909[var_0 getentitynumber()];

    if ( !isdefined( var_6 ) )
    {
        self.updateburningtodeath._id_12909[var_0 getentitynumber()] = var_0;
        var_6 = var_0;
        var_7 = self.updateburningtodeath.currentpingindex;
        self.updateburningtodeath.currentpingindex = ( self.updateburningtodeath.currentpingindex + 1 ) % 4;

        if ( isdefined( self.updateburningtodeath._id_12909[self.updateburningtodeath.pingcirculararray[var_7]] ) )
        {
            var_8 = self.updateburningtodeath._id_12909[self.updateburningtodeath.pingcirculararray[var_7]];
            self.updateburningtodeath.pingcirculararray[var_7] = -1;
            var_8 thread updatecirclepulse( var_8, var_8.headicon );
            thread pingondamage_cleanuptargetent( var_8 );
        }

        self.updateburningtodeath.pingcirculararray[var_7] = var_0 getentitynumber();
        var_9 = scripts\mp\gametypes\br_public::munitions_override_time( self.team, self.squadindex );
        ...
        scripts\mp\gametypes\br_public::waypoint_endzone_vfx( "br_perk_advanced_scout_marking", self.team, var_0 );
        var_0 thread pingondamage_cleanupheadiconwatcher( var_0, var_6.headicon );
        thread pingondamage_cleanuptargetentwatcher( var_0 );
    }
}
...
pingondamage_addoutline( var_0 )
{
    ...
    var_0 thread pingondamage_cleanupoutlineswatcher( var_1, var_0 );
}

pingondamage_cleanupheadiconwatcher( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "disconnect" );
    var_2 = var_0 getentitynumber();
...
pingondamage_cleanuptargetentwatcher( var_0 )
{
    self endon( "disconnect" );
    ...
    if ( isdefined( self.updateburningtodeath ) && isdefined( self.updateburningtodeath._id_12909 ) )
    {
        var_2 = self.updateburningtodeath._id_12909[var_1];

        if ( isdefined( var_2 ) )
        {
            var_0.targetalreadymarked = undefined;
            self.updateburningtodeath._id_12909[var_1] = undefined;
        }
    }

    foreach ( var_5, var_4 in self.updateburningtodeath.pingcirculararray )
    {
        if ( var_4 == var_1 )
        {
            self.updateburningtodeath.pingcirculararray[var_5] = -1;
            return;
        }
    }
}

updatecirclepulse( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "disconnect" );
    var_2 = var_0 getentitynumber();
...
pingondamage_cleanuptargetent( var_0 )
{
    self endon( "disconnect" );
    self endon( "pingOnDamageDeactivate" );
    var_1 = var_0 getentitynumber();
...
pingondamage_cleanupoutlineswatcher( var_0, var_1 )
{
    level endon( "game_ended" );
    var_1 endon( "disconnect" );
...
pingondamage_marked_target_timeout()
{
    level endon( "game_ended" );
    self endon( "disconnect" );

    if ( isdefined( self.markmessagetimeout ) )
        return;

    self.markmessagetimeout = 1;
    self iprintlnbold( "TARGET RESISTANT TO MARKING" );
    self playlocalsound( "br_perk_advanced_scout_marking_resist_plr", self );
    wait 1.0;
    self.markmessagetimeout = undefined;
}

_id_12D6C()
{
    if ( isdefined( self.updateburningtodeath._id_12909 ) && self.updateburningtodeath._id_12909.size > 0 )
    {
        foreach ( var_1 in self.updateburningtodeath._id_12909 )
            thread pingondamage_cleanuptargetent( var_1 );
    }

    self.updateburningtodeath = undefined;
    self notify( "pingOnDamageDeactivate" );
}

_id_12177()
{
    self.strongerarmoroldarmorvalue = self.br_armorhealth;
...
_id_12D70()
{
    self notify( "StrongerArmorDeactivate" );

    if ( isdefined( self.instantclassswapallowed ) && !istrue( self.instantclassswapallowed ) )
    {
        self.oldarmorvalue = undefined;
        return;
    }

    scripts\mp\gametypes\br_armor::numsiegeflags( self.strongerarmoroldarmorvalue );
    self.strongerarmoroldarmorvalue = undefined;
}
