...
giveunifiedpoints( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_16 = relic_squadlink_onsteppedclose( var_1 );
    var_17 = scripts\mp\utility\perk::_hasperk( "specialty_killstreak_to_scorestreak" );
    var_18 = !istrue( level.rungwperif_plumes );
    ...
    if ( isdefined( level.trackedtanks ) )
        [[ level.trackedtanks ]]( self, var_9, var_0, var_7 );
...
relic_squadlink_onsteppedclose( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;
