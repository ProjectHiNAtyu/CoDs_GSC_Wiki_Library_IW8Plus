...
atv_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12F53( "atv", "single", [ "driver", "rear" ] );
}

breakerstate()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "atv", 1 );
    var_0.id = 4;
...
breaker()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "atv", 500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "atv" );
    var_0.class = "super_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "atv" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "atv", 4 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_12F30( "atv", 6, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "atv", ::atv_deathcallback );
}

breakarmor()
{
    var_0 = _applydvarstosettings::_id_12EC9( "atv", 1 );
    ...
    var_1.getignoreprops["atv"] = [];
    var_1.getignoreprops["atv"]["cargo_truck"] = 2;
}
...
atv_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "atv", var_0 );
