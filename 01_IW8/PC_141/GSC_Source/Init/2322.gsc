...
infil_init()
{
    ...
    if ( game["roundsPlayed"] > 0 || getdvarint( "scr_skip_infils", 0 ) == 1 || getdvarint( "scr_game_infilSkip", 0 ) == 1 || scripts\mp\utility\game::getgametype() == "br" || getdvarint( "scr_game_matchstarttime" ) < 15 || scripts\mp\utility\game::getgametype() == "war" && scripts\cp_mp\utility\game_utility::registerscriptableinstance() )
    {
        game["infil"] = undefined;
    ...
    if ( scripts\mp\gamelogic::_id_1228C() )
    ...
    foreach ( var_2 in get_all_infils() )
    {
        ...
        if ( var_2 infil_is_type( var_3 ) && var_2 infil_is_subtype( var_4 ) && scripts\mp\utility\teams::isgameplayteam( var_2.script_team ) )
        {
            ...
            var_9.players = [];
            var_9.type = var_3;
            var_9.trial_callback_ai_killed = var_7;
            var_9.subtype = var_8;
...
infil_player_rig( var_0, var_1, var_2 )
{
    ...
    scripts\engine\utility::_id_1312D( "remove_rig", "player_free_spot" );
...
heli_wait_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.radius ) )
    {
        ...
        scripts\engine\utility::_id_1312D( "near_goal", "goal" );
    }
    else
        self waittill( "goal" );
...
_id_130F4()
{
    ...
    while ( level.playerteleportprop != 0 )
        waitframe();
