...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "airdrop", "applyImmediateJuggernaut", ::battle_tracks_playerinsidezone );
}
...
airdrop_awardkillstreak( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        var_4 = var_2.streakinfo.mpstreaksysteminfo._id_127D7;
...
battle_tracks_playerinsidezone( var_0 )
{
    var_1 = "juggernaut";
    ...
    var_2._id_127D7 = self.matchdatalifeindex;
    var_2.owner = self;
    var_2.trial_trigger_think = self getxuid();
    var_2.allassassin_initteamlist = scripts\mp\matchdata::gettimefrommatchstart( gettime() );
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_2.streaklifeid, var_2.streakname, var_2.isgimme, var_2.allassassin_initteamlist, self.origin );
