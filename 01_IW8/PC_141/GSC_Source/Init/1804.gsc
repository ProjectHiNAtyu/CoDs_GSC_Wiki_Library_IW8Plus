...
scriptable_door_postinit()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        var_2.extracthelipadwatchforhelileaving = var_4;
        var_2.extracthelipadusecallback = var_2.angles;
    }
}
...
system_init()
{
    ...
    scripts\engine\scriptable::_id_11F48( "door", ::scriptable_door_scriptable_used_callback );
