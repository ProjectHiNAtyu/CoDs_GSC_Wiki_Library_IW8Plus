...
gas_createtrigger( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = level_check_current_drop_amount( var_0, var_3 );

    if ( isdefined( var_5 ) )
        var_4 thread level_carepackage_give_player_killstreak( var_5, var_2 );
...
level_check_current_drop_amount( var_0, var_1 )
{
...
gas_watchtriggerenter()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( var_0.light_tank_initdamage ) )
            continue;
...
gas_applycough( var_0, var_1 )
{
    ...
    if ( istrue( self.light_tank_initdamage ) )
        return;
...
gas_begincoughing( var_0 )
{
    ...
    scripts\engine\utility::_id_1312E( "gas_coughWeaponFired", "gas_coughWeaponTaken", "gas_coughDuration" );
...
level_killstreak_spawn( var_0, var_1 )
{
