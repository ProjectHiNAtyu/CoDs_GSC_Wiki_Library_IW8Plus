...
init()
{
    ...
    if ( !isdefined( level.get_closest_munitions ) )
        level.get_closest_munitions = 0;

    if ( !isdefined( level._id_12A42 ) )
        level._id_12A42 = 0;
    ...
    initanimtree();
    scripts\engine\scriptable::_id_11F48( "ascender", ::ascenderscriptableused );
}
...
getweightedsum()
{
    ...
    if ( isdefined( level.br_ending_init ) )
        self [[ level.br_ending_init ]]( "ascender_blocked_generic", 4 );
    else
    {
...
getxmike109ammotype()
{
    ...
    if ( isdefined( level.br_ending_init ) )
        self [[ level.br_ending_init ]]( "ascender_blocked_laststand", 4 );
    else
    {
...
denyascendmessage()
{
    ...
    if ( isdefined( level.br_ending_init ) )
        self [[ level.br_ending_init ]]( "ascender_blocked", 4 );
    else
    {
...
ascenddeathlistener( var_0 )
{
    ...
    var_1 = spawnstruct();
    var_1.vopenangles = self.guid;
    var_1.br_ending_debugmode = self.br_ending_debugmode;
    var_1.br_ending_delay = self.br_ending_delay;
    self waittill( "death_or_disconnect" );

    if ( isdefined( self ) )
        self stopanimscriptsceneevent();

    var_0.handlepersistentteamproximity = var_1;
...
descendsolostarts( var_0, var_1 )
{
    ...
    {
        var_1 thread getxmike109ammotype();
        return 0;
    }
    ...
    if ( isdefined( level.cloudorigin ) && isdefined( level.cloudorigin.name ) && getdvarint( "scr_br_alt_mode_zxp", 0 ) )
    {
        var_2 = istrue( var_1.iszombie ) && isdefined( var_1.riskspawn_getspawnlocationsbytier );
    ...
    if ( !var_1 scripts\common\utility::raid_seq3_objectives_func() )
    {
        var_1 thread getweightedsum();
        return 0;
    }
    ...
    if ( gettime() - var_4.scorelimitreached < getdvarint( "scr_ascender_min_time_between" ) )
    {
        var_1 thread getweightedsum();
        return 0;
    }

    var_5 = max( level._id_12A42, 30 );
    var_6 = getdvarint( "scr_ascender_override_max_active", var_5 );

    if ( var_6 != -1 )
        var_5 = var_6;

    if ( level.get_closest_munitions >= var_5 )
    {
        var_1 thread getweightedsum();
        return 0;
    }

    if ( isdefined( var_4._id_123F7 ) && istrue( var_4._id_123F7.inuse ) )
    {
        var_1 thread denyascendmessage();
        return 0;
    }
...
ascenderuse( var_0, var_1 )
{
    ...
    var_1.br_give_starting_ammo = var_2;
    var_1.br_ending_debugmode = var_6;
    var_1.br_ending_delay = var_7;
    ...
    if ( !var_2.dir )
    {
        if ( scripts\common\utility::iscp() )
            var_9 = getdvarfloat( "scr_descender_speed_cp", minarmordropondeath() );
        else
            var_9 = getdvarfloat( "scr_descender_speed", min_z() );
    }
    else
        var_9 = getdvarfloat( "scr_ascender_speed", min_x() );

    var_10 = var_8 / var_9;
    var_11 = min_pt() * var_10;
    var_12 = min_y() * var_10;
...
cleanupascenduse( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_0.scoreleadchanged = gettime();
        ...
        else if ( !istrue( var_0.inlaststand ) )
        {
            ...
            var_0 thread scripted_fov();

        if ( isdefined( var_0.br_ending_debugmode ) )
        {
            var_0.br_ending_debugmode unlink();
            var_0.br_ending_debugmode delete();
        }

        if ( isdefined( var_0.br_ending_delay ) )
        {
            var_0.br_ending_delay unlink();
            var_0.br_ending_delay delete();
        }
    }
    else if ( isdefined( self.handlepersistentteamproximity ) )
    {
        if ( isdefined( self.handlepersistentteamproximity.br_ending_debugmode ) )
        {
            self.handlepersistentteamproximity.br_ending_debugmode unlink();
            self.handlepersistentteamproximity.br_ending_debugmode delete();
        }

        if ( isdefined( self.handlepersistentteamproximity.br_ending_delay ) )
        {
            self.handlepersistentteamproximity.br_ending_delay unlink();
            self.handlepersistentteamproximity.br_ending_delay delete();
        }
    }
    ...
    if ( isdefined( self.handlepersistentteamproximity ) )
    {
        var_2 = self.handlepersistentteamproximity.vopenangles;
        self.handlepersistentteamproximity = undefined;
    }

    if ( isdefined( var_0 ) )
    {
        var_0.br_give_starting_ammo = undefined;
        var_0.br_ending_debugmode = undefined;
        var_0.br_ending_delay = undefined;
...
scripted_fov()
{
    level endon( "game_ended" );
    var_0 = self;
    var_0 scripts\engine\utility::_id_1312D( "death_or_disconnect", "last_stand_finished" );
    var_0 enableoffhandweapons();
    var_0 enableweaponswitch();
    var_0 scripts\common\utility::allow_killstreaks( 1 );
    var_0 thread scripts\mp\utility\infilexfil::takegunless();
...
br_ending()
{
    ...
    var_1 = var_0.br_give_starting_ammo.ascendstructout.origin;
    var_2 = var_0.br_give_starting_ammo.ascendstructout.angles;
    var_0.br_give_starting_ammo cleanupascenduse( var_0 );
...
remove_invulnerability( var_0 )
{
    ...
    {
        if ( distance2dsquared( var_2.origin, var_0 ) < mine_cave_turrets() )
        {
            if ( abs( var_0[2] - var_2.origin[2] ) < mindia_exterior_sfx() )
                return 1;
        }
    }
