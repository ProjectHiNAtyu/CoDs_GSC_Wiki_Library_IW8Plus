...
light_tank_initoccupancy()
{
    ...
    var_4._id_12C9C = getcompleteweaponname( "tur_bradley_mp" );
    ...
    var_4._id_12C9C = getcompleteweaponname( "tur_gun_lighttank_mp" );
    var_4.tomastrike_watchgameend = "ping_vehicle_gunner";
}

set_force_aitype_riotshield()
{
    var_0 = _applydvarstosettings::_id_12EC9( "light_tank", 1 );
    var_0.brc130airdropcratedestroycallback = 2.5;
    var_0.getignoreprops = 0.625;
    var_0.get_next_open_stop = 350;
    var_0.get_next_rein_group = 525;
    var_0.get_next_cypher_id_from_pool = 875;
    var_0.get_node_closest_to_target_loc = 1.25;
    var_0.get_num_dogtag_in_kill_zone_or_under_bridge_zone = 5;
    var_0.get_next_track_index = 10;
...
light_tank_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12F53( "light_tank", "single", [ "driver", "gunner" ] );
}

set_force_aitype_shotgun()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "light_tank", 1 );
    var_0.id = 1;
    var_0.seatids["driver"] = 0;
    var_0.seatids["gunner"] = 1;
    var_0.bomb_vest_success_fail_think["turret"] = 0;
    var_0.bomb_vest_success_fail_think["missile"] = 1;
    var_0.bomb_vest_success_fail_think["smoke"] = 2;
    var_0._id_11DF2[0] = 0;
    var_0._id_11DF2[1] = 1;
    var_0._id_11DF3["driver"]["lighttank_mp"] = 0;
    var_0._id_11DF3["driver"]["tur_gun_lighttank_mp"] = 1;
    var_0._id_11DF3["driver"]["tur_gun_lighttank_ks_mp"] = 1;
    var_0._id_11DF3["gunner"]["tur_bradley_mp"] = 0;
    var_0._id_11DF3["gunner"]["tur_bradley_ks_mp"] = 0;
    var_0._id_11DF3["gunner"]["tur_gun_lighttank_mp"] = 1;
    var_0._id_11DF3["driver"]["tur_gun_lighttank_ks_mp"] = 1;
}

set_force_aitype_rpg()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "light_tank", 3000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "light_tank" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "light_tank" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "light_tank", 15 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2D( "light_tank", ::light_tank_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2C( "light_tank", ::light_tank_postmoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "light_tank", ::light_tank_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "lighttank_tur_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "lighttank_tur_ks_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "bradley_tow_proj_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "bradley_tow_proj_ks_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "lighttank_mp", 5 );
}
...
light_tank_create( var_0, var_1 )
{
    ...
    if ( set_heli_crash_override( var_0 ) )
    ...
    var_2.relic_amped_paused = var_0.spawntype == "KILLSTREAK";
    var_3 = light_tank_createdriverturret( var_2, var_0 );
    var_3.missilesleft = 2;
    var_3.lastmissilefired = 0;
    scripts\cp_mp\vehicles\vehicle::_id_12FB5( var_2, var_3, getcompleteweaponname( "tur_bradley_mp" ), 1 );
    var_3 = light_tank_creategunnerturret( var_2, var_0 );
    scripts\cp_mp\vehicles\vehicle::_id_12FB5( var_2, var_3, getcompleteweaponname( "tur_gun_lighttank_mp" ) );
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "light_tank", var_0 );
    ...
    var_2 thread set_force_aitype_sniper();
    var_2 thread set_force_aitype_suicidebomber();
...
light_tank_createdriverturret( var_0, var_1 )
{
    ...
    if ( set_heli_crash_override( var_1 ) )
...
{
    var_2 = light_tank_getleveldata();
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_12F48( var_0, "tur_bradley_mp" );
    var_4 = undefined;
...
light_tank_explode( var_0, var_1, var_2 )
{
    ...
    {
        self.streakinfo.is_in_gas = 1;

        if ( !istrue( self._id_11B42 ) )
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        if ( set_heli_crash_override( self.spawndata ) )
...
light_tank_airdrop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 hide();
    var_9 = scripts\cp_mp\vehicles\vehicle::_id_12F49( var_8 );
...
light_tank_airdropinternal()
{
    ...
    {
        self.vehicle show();
        var_0 = scripts\cp_mp\vehicles\vehicle::_id_12F49( self.vehicle );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_12F48( self, "tur_bradley_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 8;
...
set_force_aitype_sniper()
{
    ...
    for (;;)
    {
        ...
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getseatoccupant( self, "driver" );
        var_1 thread set_just_keep_moving( var_2 );
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_12F48( self, "tur_bradley_mp" );
...
set_initial_goalradius()
{
    ...
    for (;;)
    {
        var_0 = set_focus_fire_params();
        self notifyonplayercommand( "light_tank_missile", var_0 );
        var_1 = scripts\engine\utility::_id_1313C( "input_type_changed", "missile_handling_ended" );
...
{
    wait 0.33;
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_12F48( self, "tur_bradley_mp" );
    ...
    if ( istrue( self.relic_amped_paused ) )
...
set_force_aitype_suicidebomber()
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_12F48( self, "tur_gun_lighttank_mp" );
...
light_tank_enterend( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    else if ( !istrue( var_4.playerdisconnect ) && !istrue( var_4.playerdeath ) )
    {
        if ( var_1 == "gunner" )
        {
            set_guy_to_specific_node( var_3 );
...
light_tank_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_12F48( var_0, "tur_bradley_mp" );
        var_5.owner = var_3;
        ...
        var_3 thread set_initial_goalradius();
    ...
    else if ( var_1 == "gunner" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_12F48( var_0, "tur_gun_lighttank_mp" );
        var_5.owner = var_3;
        var_5 setotherent( var_3 );
        var_5 setentityowner( var_3 );
        var_5 setsentryowner( var_3 );
        ...
        set_flag_via_event_structs( var_3 );
    }
...
set_flag_via_event_structs( var_0 )
{
    if ( isdefined( var_0.onplayerconnectrisk ) )
        return;

    var_0 scripts\cp_mp\utility\damage_utility::adddamagemodifier( "ltGunnerMissileRedux", 0.4, 0, ::set_force_aitype_armored );
}

set_guy_to_specific_node( var_0 )
{
    if ( !isdefined( var_0.onplayerconnectrisk ) )
        return;
...
set_force_aitype_armored( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
set_initial_goalheight( var_0 )
{
    ...
    self._id_11B42 = 1;
    self.owner scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_0 );
}
...
light_tank_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < -0.83 )
        var_0.remove_usability_crutch_on_death = canweapondealcriticaldamage( var_0 );
...
light_tank_updateheadiconforplayer( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1 == self )
        scripts\cp_mp\entityheadicons::_id_12120( self.headicon, var_0 );
    else
    {
        var_2 = undefined;
        ...
        if ( level.teambased )
        {
            if ( var_3 == "neutral" )
            {
                ...
                {
                    if ( 1 )
                        scripts\cp_mp\entityheadicons::_id_1211F( self.headicon, var_0 );
                    else
                        scripts\cp_mp\entityheadicons::_id_12120( self.headicon, var_0 );
...
light_tank_tryusefromstruct( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_6 = scripts\cp_mp\vehicles\vehicle::_id_12F49( var_5 );

        foreach ( var_8 in var_6 )
            var_8.streakinfo = var_0;

        var_5 thread set_initial_goalheight( var_0 );
    }
...
{
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_12F49( var_0 );
