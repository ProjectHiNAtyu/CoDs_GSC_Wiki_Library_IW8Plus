...
_id_12EA8()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "van", 1 );
    var_0.id = 13;
...
_id_12EA7()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "van", 1350 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "van" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "van" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "van", 8 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "van", ::van_deathcallback );
}
...
van_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "van", var_0 );
