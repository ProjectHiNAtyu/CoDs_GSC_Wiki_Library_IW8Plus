        ...
        if ( !self.perkpackagedata.isusing && scripts\mp\supers::issuperready() )
        {
            if ( self.perkpackagedata.istwomode )
            {
                ...
                if ( 1 )
                {
                    ...
                    if ( isdefined( level.unset_relic_dogtags ) )
                        [[ level.unset_relic_dogtags ]]();
                }
            }
...
perkpackage_getfirstfieldupgrade()
{
    ...
    if ( isdefined( self.trial_player_perks ) )
        var_0 = self.trial_player_perks;
...
perkpackage_getsecondfieldupgrade()
{
    ...
    if ( isdefined( self.trial_race_lap_total ) )
        var_0 = self.trial_race_lap_total;
...
perkpackagemenu_menuthink()
{
    ...
    wait 0.3;
    var_0 = scripts\engine\utility::_id_13137( "perkPackageMenu_option1", "perkPackageMenu_option2", "perkPackageMenu_close", "death" );
    var_1 = 0;
...
unset_relic_doomslayer( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        var_0 = "none";
    ...
    self.trial_player_perks = var_0;
    self.trial_race_lap_total = var_1;
    perkpackage_updateifchanged();
}

unset_relic_doubletap()
{
    self.trial_player_perks = undefined;
    self.trial_race_lap_total = undefined;
}
