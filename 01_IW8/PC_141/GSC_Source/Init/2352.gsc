...
tryusehoverjetfromstruct( var_0 )
{
    ...
    var_4 = ai_ascender_giveascender( var_0 );
    var_4 = istrue( var_4 );
    level.incomingallhoverjets--;
...
ai_ascender_giveascender( var_0 )
{
    ...
    scripts\common\utility::_id_12C2C( level.smartwatchinteract, "hover_jet", self.origin );
...
starthoverjetairstrikepass( var_0, var_1, var_2 )
{
    ...
    var_19 thread player_retry_thread();
...
hoverjet_getbestgroundtarget()
{
    ...
    {
        if ( !scripts\cp_mp\killstreaks\chopper_support::end_silo_jump( var_5.player ) )
            continue;
