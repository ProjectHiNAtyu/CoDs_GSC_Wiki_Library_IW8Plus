...
getspawnpoint( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !istrue( level.handlefocusfire ) && !istrue( var_0.skipspawncamera ) && var_9.bucket >= 2 && var_9.threatsight < 300 )
        var_0._id_12284 = 1;
...
getspawnpointarray( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        level.spawnpointarray[var_0] = level._id_11F76[var_0];
        return level.spawnpointarray[var_0];
    }

    if ( isdefined( level._id_11F76 ) && isdefined( level._id_11F76[var_0] ) )
        var_8 = scripts\engine\utility::array_combine( var_8, level._id_11F76[var_0] );
...
finalizespawnpointchoice( var_0 )
{
    ...
    else
    {
        ...
        self finalizespawnpointchoiceforplayer( var_0.index, var_0.bucket, var_0._id_12E7E, var_0.threatsight, var_0.damagemod );
    }
...
checkmodifiedspawnpoint( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        var_2 = moraleslaptopthink( var_0 );
...
gasgrenade_crate_use( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
anim_weapon( var_0 )
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( !isdefined( level._id_11F76[var_3] ) )
            level._id_11F76[var_3] = [];
        ...
        level._id_11F76[var_3][level._id_11F76[var_3].size] = var_8;
    }

    level thread _id_11F77();
}
...
_id_11F77()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in level._id_11F76 )
        {
            foreach ( var_3 in var_1 )
            {
