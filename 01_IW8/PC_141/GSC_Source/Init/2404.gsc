...
addtouavlist( var_0, var_1 )
{
    ...
    if ( level.teambased )
    {
        ...
        {
            level.uavmodels[var_1.squadindex][level.uavmodels[var_1.squadindex].size] = self;
            return;
        }
...
removefromuavlistondeath( var_0, var_1 )
{
    ...
    if ( level.teambased )
    {
        ...
        if ( istrue( var_2 ) && getdvarint( "scr_uav_for_squad_only", 1 ) )
            level.uavmodels[var_1.squadindex] = scripts\engine\utility::array_removeundefined( level.uavmodels[var_1.squadindex] );
        else
...
{
    scripts\engine\utility::_id_1312D( "death", "carried" );
...
killshouldaddtokillstreak( var_0 )
{
    ...
    return !scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) && !scripts\mp\utility\points::relic_squadlink_onsteppedclose( var_0 );
}
