...
audio_player_delete_mud_loop( var_0 )
{
    if ( !isdefined( self._blackboard.audio_shf_kill_hangar_lights ) )
    {
        self._blackboard.audio_shf_kill_hangar_lights = 1;
        self._blackboard.audio_railyard_fires = var_0;
        return 1;
    }
...
audio_play_littlebird_sfx()
{
    if ( isdefined( self._blackboard.audio_shf_kill_hangar_lights ) && self._blackboard.audio_shf_kill_hangar_lights == 1 )
        self._blackboard.audio_shf_kill_hangar_lights = 2;
}
...
audio_panodes()
{
    if ( isdefined( self._blackboard.audio_shf_kill_hangar_lights ) )
    {
        if ( self._blackboard.audio_shf_kill_hangar_lights == 1 )
        {
            self._blackboard.audio_shf_kill_hangar_lights = undefined;
            self._blackboard.audio_railyard_fires = undefined;
            return 1;
        }
        else if ( self._blackboard.audio_shf_kill_hangar_lights == 2 )
        {
            self._blackboard.audio_shf_kill_hangar_lights = 3;
            return 1;
        }
    }
...
{
    if ( isdefined( self._blackboard.audio_shf_kill_hangar_lights ) && self._blackboard.audio_shf_kill_hangar_lights == 3 )
    {
        self._blackboard.audio_shf_kill_hangar_lights = undefined;
        self._blackboard.audio_railyard_fires = undefined;
    }
...
astar_get_path( var_0, var_1 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_2 = var_0 audio_player_delete_mud_loop( var_1 );
