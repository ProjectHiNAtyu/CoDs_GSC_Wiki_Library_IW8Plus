...
vehicle_occupancy_mp_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "takeRiotShield", ::_id_12FA2 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "giveRiotShield", ::_id_12F9F );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "updateRiotShield", ::_id_12FA4 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "hideCashBag", ::_id_12FA0 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "showCashBag", ::_id_12FA1 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "changedSeats", ::_id_12F9E );
    ...
    level.vehicle._id_12FF6 = getdvarint( "scr_vehicle_lights", 1 );
}
...
vehicle_occupancy_mp_onentervehicle( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_4 || scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F91( var_0, var_1 ) )
    ...
    if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
        scripts\mp\gametypes\br_plunder::weapon_xp_iw8_ar_asierra12( var_2, 0, 1 );
    ...
    if ( isdefined( var_2.team ) && isdefined( var_2.squadindex ) && istrue( var_0.israllypointvehicle ) )
        thread scripts\mp\spawnselection::_id_11B60( var_2.team, var_2.squadindex );
...
vehicle_occupancy_mp_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) && isdefined( var_2 ) )
    {
        if ( !istrue( var_3.playerdeath ) )
        {
            ...
            if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
                scripts\mp\gametypes\br_plunder::weapon_xp_iw8_ar_asierra12( var_2, 1, 1 );
        ...
        _id_12F9F( var_2, var_3.playerdeath, var_3.playerlaststand );

        if ( isdefined( var_2.team ) && isdefined( var_2.squadindex ) && istrue( var_0.israllypointvehicle ) )
            thread scripts\mp\spawnselection::_id_11B60( var_3.team, var_3.squadindex );
...
_id_12F9E( var_0, var_1, var_2, var_3 )
{
    var_4 = level.gametype == "br";

    if ( var_4 && isdefined( var_2 ) && isdefined( var_3 ) )
    {
        if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F91( var_1, var_2 ) )
        {
            var_0 scripts\mp\playeractions::allowactionset( "vehicle", 1 );
            var_0 scripts\mp\playeractions::allowactionset( "vehicle_passenger", 0 );
        }
        else if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F91( var_1, var_3 ) )
        {
...
_id_12FA0( var_0, var_1, var_2, var_3 )
{
    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_1 );

    if ( istrue( var_4._id_122BF ) )
        return;

    if ( isdefined( level.shot_start_offset ) && scripts\engine\utility::array_contains( level.shot_start_offset, var_2 ) )
    {
        if ( isdefined( var_2.branalytics_init ) )
        {
...
_id_12FA1( var_0, var_1, var_2, var_3 )
{
    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_1 );
...
_id_12FA2( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        var_0._id_11DA9 = var_3;
        var_0._id_11DA5 = var_4;

        if ( istrue( var_4 ) )
            _id_12FA4( var_0, var_1, var_2 );
...
_id_12F9F( var_0, var_1, var_2 )
{
    if ( isdefined( var_0._id_11DA9 ) )
    {
        if ( !istrue( var_1 ) && !istrue( var_2 ) )
        {
            var_0 scripts\cp_mp\utility\inventory_utility::_giveweapon( var_0._id_11DA9 );
            var_0 scripts\mp\class::_id_12AA5();

            if ( istrue( var_0._id_11DA5 ) )
            {
                var_0 notify( "modified_riot_shield" );
                var_0 endon( "modified_riot_shield" );
                var_0 childthread scripts\cp_mp\utility\inventory_utility::_switchtoweaponimmediate( var_0._id_11DA9 );
            }
        }

        var_0._id_11DA9 = undefined;
        var_0._id_11DA5 = undefined;
        var_0 notify( "modified_riot_shield" );
    }
}
...
_id_12FA4( var_0, var_1, var_2 )
{
    if ( isdefined( var_0._id_11DA9 ) && istrue( var_0._id_11DA5 ) )
    {
        if ( !isdefined( var_2 ) )
            return;
...
_id_12FA3( var_0 )
{
    ...
    if ( !isdefined( var_0.phcountdowntimer ) )
        var_0.phcountdowntimer = 0;

    var_1 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getalloccupants( var_0 );

    if ( var_1.size > 0 && !var_0.phcountdowntimer )
    {
        var_0 setscriptablepartstate( "lights", "on", 1 );
        var_0.phcountdowntimer = 1;
    }
    else if ( var_1.size == 0 && var_0.phcountdowntimer )
    {
