...
vehicle_mp_init()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "create", ::_id_12F73 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "createLate", ::_id_12F74 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "deleteNextFrame", ::_id_12F75 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "deleteNextFrameLate", ::_id_12F76 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "hide", ::_id_12F77 );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_compass", "init", _handlefieldupgradepurchase::_id_12EE1 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "init", _handlekillstreakpurchase::_id_12F1A );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_trophyDestroyTarget", "init", scripts\mp\equipment\trophy_system::_id_12BFB );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "little_bird_mg", "init", _getrandomlocations::set_ui_omnvar_for_relics );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "cargo_truck_mg", "init", _getlocationscircleinfluencedwithnoise::disableannouncer );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "motorcycle", "init", _getsingleplunderextractlocations::start_silo_thrust_menu );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "veh_a10fd", "init", _getplunderextractlocations::ballowexecutions );
    scripts\mp\vehicles\damage::init();
    scripts\mp\vehicles\vehicle_oob_mp::vehicle_oob_mp_init();
}

_id_12F73( var_0, var_1 )
{
    var_0.maxhealth = scripts\cp_mp\vehicles\vehicle_damage::_id_12F07( var_0 );
