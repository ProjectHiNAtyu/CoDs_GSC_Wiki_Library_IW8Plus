...
tryusemanualturretfromstruct( var_0 )
{
    ...
    silencer_pick_up_monitor( 0 );
    var_2 = manualturret_create( "manual_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        silencer_pick_up_monitor( 1 );
        return 0;
    }
...
manualturret_delayplacementinstructions( var_0 )
{
    ...
    thread siege_bot_team_had_advantage( "death" );
    thread siege_bot_team_had_advantage( "turret_placement_finished" );
}

siege_bot_team_had_advantage( var_0 )
{
...
manualturret_create( var_0, var_1 )
{
    ...
    var_3.failedmission.moverdoesnotkill = 1;
    var_3.failedmission._id_12C9E = var_3;
    return var_3;
}
...
manualturret_setplaced( var_0, var_1 )
{
    ...
    if ( !var_6 )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
            var_0.minimapid = var_0.failedmission [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_7, var_0.team, undefined, 1, 1 );
    }
...
manualturret_setcarried( var_0 )
{
    ...
    if ( isdefined( self.moving_platform ) )
    {
        ...
        self.staytoasty = undefined;
        self.stayfrosty = undefined;
        self unlink();
    }
    ...
    var_0 scripts\cp_mp\utility\weapon_utility::_id_11EC9();
    ...
    var_0 silencer_pick_up_monitor( 0 );
    var_5 = var_0 manualturret_watchplacement( self, self.streakinfo, 1, 2 );

    if ( !isdefined( var_5 ) )
    {
        var_0 silencer_pick_up_monitor( 1 );
        return 0;
    }
...
manualturret_switchbacklastweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\weapon_utility::_id_11D27( self.lastdroppableweaponobj );
...
manualturret_watchuse( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        self.watch_for_player_in_gulag = var_3;
        manualturret_makealltriggersusable( 0 );
        var_3 scripts\cp_mp\utility\weapon_utility::_id_11EC9();
        ...
        {
            var_7 = signal_nag( var_3, var_3.useweapon );
        ...
        {
            self.inuse = undefined;
            self.watch_for_player_in_gulag = undefined;
            ...
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    var_3 silo_door( 1 );
                    var_8 = var_3 scripts\cp_mp\utility\weapon_utility::_id_11D27( var_3.lastdroppableweaponobj );
...
signal_nag( var_0, var_1 )
{
    self endon( "kill_turret" );
    self endon( "turret_switch_weapon_timeout" );
    var_0 endon( "death_or_disconnect" );
    level endon( "game_ended" );
    thread silo_door_cover_jugg( 1.0 );
...
manualturret_endplayeruse( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        var_0.watch_for_player_in_gulag = undefined;
    ...
    if ( isdefined( self ) )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( !istrue( var_0.removematchingents_bykey ) )
        ...
        thread siege_bot_team_triple_cap_check();
...
manualturret_endturretonplayer( var_0 )
{
    var_0 endon( "end_turret_use" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_1312D( "death_or_disconnect", "last_stand_start" );
    var_0 manualturret_endplayeruse( self );
}
...
manualturret_watchdeath( var_0 )
{
    ...
    self.removematchingents_bykey = 1;
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_0 scripts\cp_mp\utility\killstreak_utility::_id_11B45( self.streakinfo );
    }

    if ( isdefined( self.watch_for_player_in_gulag ) )
        self.watch_for_player_in_gulag manualturret_endplayeruse( self );
    ...
    if ( isdefined( self.failedmission ) )
...
manualturret_watchtimeout( var_0 )
{
    ...
    while ( self.timeelapsed < var_1 )
    {
        ...
        if ( isdefined( self.watch_for_player_in_gulag ) )
            self.watch_for_player_in_gulag setclientomnvar( "ui_killstreak_countdown", int( var_2 ) );

        self.timeelapsed = self.timeelapsed + level.framedurationseconds;

        if ( self.timeelapsed >= var_1 - 1.5 && !istrue( self._id_127AA ) )
            self._id_127AA = 1;
