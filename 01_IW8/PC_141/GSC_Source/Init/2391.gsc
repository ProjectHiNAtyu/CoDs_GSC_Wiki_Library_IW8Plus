...
{
    if ( istrue( var_2 ) && relic_amped_monitor( var_0, var_1 ) )
        return 1;
...
relic_amped_monitor( var_0, var_1 )
{
...
islethalmeleeweapon( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\weapon::relic_nuketimer_timer_init( var_2 ) )
        return 1;
...
attackerishittingteam( var_0, var_1 )
{
    ...
    if ( !level.teambased )
        ...
        return 0;
    else if ( isagent( var_0 ) && istrue( var_0._id_12335 ) )
        return 0;
