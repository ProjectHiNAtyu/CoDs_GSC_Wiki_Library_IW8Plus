...
_id_127B1()
{
    level.train_play_anim scripts\mp\trials\trial_target_utility::delay_end_alarm_sound( ::_id_127B7, level );
    level.train_play_anim_init scripts\mp\trials\trial_target_utility::delay_end_alarm_sound( ::_id_127B8, level );
}
...
stoppingpower_beginuse()
{
    ...
    if ( !scripts\mp\weapons::isnormallastweapon( var_0 ) || scripts\mp\utility\weapon::ismeleeonly( var_0 ) || scripts\mp\utility\weapon::isgamemodeweapon( var_0 ) || scripts\mp\utility\weapon::issinglehitweapon( var_0.basename ) || !_id_127B4( var_0 ) || _id_127B2( var_0 ) )
    {
    ...
    {
        var_8 = scripts\mp\utility\weapon::reflectprojectile( var_7 );
        ...
        if ( isnullweapon( var_7, var_0, 0 ) )
        {
            ...
            if ( 1 )
            {
                if ( var_8 )
                {
                    ...
                    var_11 = var_9 + var_4;
                    var_12 = int( min( _id_127AE( var_7, var_11 ), var_11 + var_10 ) );
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            var_16 = var_15 - var_4;
                            scripts\mp\gametypes\br_weapons::chopperexfil_slamtoblack( var_7, var_16 );
                        }
                        else
    ...
    thread _id_127BA( var_0, var_4, var_5 );
    return 1;
}
...
_id_127B4( var_0 )
{
    ...
    return scripts\mp\weapons::register_chopper_boss_combat_action( var_1 );
}
...
{
    var_3 = gametypekillspermatchmax( var_0, var_1, var_2 );
    _id_127B0( var_0, var_3 );
}

gametypekillspermatchmax( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
    var_3.player = var_0;
...
_id_127B0( var_0, var_1 )
{
    ...
    var_1 thread _id_127AC();
    var_1 thread _id_127AD();
...
_id_127B7( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_1 ) )
        return;

    var_3 = var_1 _id_127AF( var_2 );

    if ( isdefined( var_3 ) )
    {
        var_4 = gametypekillspermatchmax( var_3.player, var_3.objweapon, var_3.rounds );
        var_0.hcrdata = var_4;
        var_3 thread stoppingpower_removehcr();
    }
}

_id_127B8( var_0, var_1, var_2 )
{
    var_3 = var_0.hcrdata;
...
stoppingpower_watchhcrweaponchange()
{
    ...
    {
        if ( _id_127B3( self.player getcurrentweapon() ) )
        {
            if ( !self.gavehcr )
            {
...
stoppingpower_watchhcrweaponfire()
{
    ...
    self.player thread _id_127B9( self.objweapon );
    thread stoppingpower_removehcr();
}
...
_id_127B9( var_0 )
{
    ...
    self.screenent = 1;
    scripts\engine\utility::_id_13148( 2, "weapon_fired", "weapon_change" );
    self.screenent = undefined;
}
...
_id_127AB()
{
    if ( isdefined( self.player.hcrdata ) )
    {
        ...
        self.player scripts\cp\helicopter\chopper_boss::total_successful_vehicle_spawns( "super_support_box", self.kills );
...
_id_127B6( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            scripts\cp\helicopter\chopper_boss::train_car_audio();
            var_2.kills++;
        }
    }
}
...
stoppingpower_givefastreload()
{
    ...
    self.player scripts\engine\utility::_id_1312E( "weapon_fired", "weapon_change", "stoppingPower_removeHCR" );
