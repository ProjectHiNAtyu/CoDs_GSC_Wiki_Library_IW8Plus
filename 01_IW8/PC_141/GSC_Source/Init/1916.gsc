...
init()
{
    ...
    scripts\mp\supers\super_stoppingpower::_id_127B1();
    scripts\mp\utility\spawn_event_aggregator::registeronplayerspawncallback( ::_id_12832 );
...
loadsupertable()
{
    ...
    for (;;)
    {
        ...
        var_2._id_11B62 = readsupertablecell( var_0, 6, 1 );
        ...
        var_2.create_name_fx_base = readsupertablecell( var_0, 19, 1 );
...
registersupers()
{
    ...
    registersuper( "super_select", ::_id_1283E, ::_id_1283F, ::superselectbeginuse, undefined );
    registersuper( "super_fulton", undefined, undefined, ::_id_12838, undefined );
    registersuper( "super_supply_drop", undefined, undefined, ::_id_12841, undefined );
    registersuper( "super_vehicle_drop", undefined, undefined, ::_id_12843, undefined );
    registersuper( "super_loot_drop", undefined, undefined, ::_id_12841, undefined );
    _id_11BBE( "super_emp_drone", "emp_drone_player_mp" );
    _id_11BBE( "super_emp_drone", "emp_drone_non_player_mp" );
    _id_11BBE( "super_emp_drone", "emp_drone_non_player_direct_mp" );
    _id_11BBE( "super_weapon_drop", "deploy_weapondrop_mp" );
}
...
_id_11BBE( var_0, var_1 )
{
    ...
    var_2.isdragonsbreath[var_2.isdragonsbreath.size] = var_1;
    level.superglobals._id_1283D[var_1] = var_2;
}
...
givesuper( var_0, var_1, var_2 )
{
    ...
    var_4.trial_restart_watcher = undefined;
    _id_12179( 0 );
    _id_1283B( var_0 );
...
clearsuper( var_0 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_1.staticdata ) )
        _id_1283C( var_1.staticdata.ref );
    ...
    thread scripts\mp\trials\trial_utility::_id_12105( "ui_super_state", 0 );
...
_id_12E04()
{
    ...
    {
        var_0.timeoutradialunfill = undefined;
        return;
    }
    ...
    if ( !isdefined( var_0.timeoutradialunfill ) || var_1 != var_0.timeoutradialunfill )
        self setclientomnvar( "ui_super_progress", var_1 );

    self setplayersupermeterprogress( var_1 );
    var_0.timeoutradialunfill = var_1;
}
...
updatesuperuistate()
{
    ...
    if ( !isdefined( var_1 ) || var_2 != var_1 )
        thread scripts\mp\trials\trial_utility::_id_12105( "ui_super_state", var_2 );
...
superusefinished( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        ...
        else if ( var_4.staticdata.create_name_fx_base )
        {
            clearsuper();
            self setclientomnvar( "ui_perk_package_state", 0 );
            self setclientomnvar( "ui_super_progress", 0 );
    ...
    scripts\cp\helicopter\chopper_boss::train_elements_disable( var_4, var_5 );
}
...
handledeath()
{
    ...
    var_0 = getcurrentsuper();
    var_1 = var_0.staticdata._id_11B62;
...
getsuperpointsneeded()
{
    ...
    if ( isdefined( var_0.trial_restart_watcher ) )
        var_1 = var_0.trial_restart_watcher;
...
nearby_ai_investigate_grenade( var_0 )
{
    ...
    if ( !isdefined( level.superglobals._id_1283D[var_0] ) )
        return undefined;

    return level.superglobals._id_1283D[var_0].ref;
}
...
getsuperrefforsuperweapon( var_0 )
{
    ...
    var_2 = nearby_ai_investigate_grenade( var_0 );
...
updateactivesupers( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_11 )
    {
        ...
        if ( var_8 && var_0 scripts\mp\utility\perk::_hasperk( "specialty_bulletdamage" ) )
            var_1 thread scripts\mp\supers\super_stoppingpower::_id_127B6( var_5 );
    }
}
...
fake_digit_pool( var_0, var_1 )
{
    ...
    var_2 = minigun_wait_between_shots( var_0 );
    self setplayerdata( "mp", "playerStats", "superStats", var_0, "misc1", var_2 + var_1 );
}

minigun_wait_between_shots( var_0 )
{
...
scramblebeginuse()
{
    ...
    thread scripts\cp_mp\killstreaks\helper_drone::play_sound_countdown( self );
    return 1;
}
...
_id_1283E()
{
    ...
    self.super.trial_restart_watcher = var_5;
}
