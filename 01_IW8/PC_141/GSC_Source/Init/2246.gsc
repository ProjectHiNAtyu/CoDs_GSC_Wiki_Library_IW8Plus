...
teamhasuav( var_0 )
{
    ...
    foreach ( var_3 in level.teamnamelist )
    {
        ...
        if ( isdefined( level.uavmodels ) )
        {
            if ( istrue( var_1 ) )
            {
                ...
                {
                    if ( isdefined( level.uavmodels[var_9] ) && level.uavmodels[var_9].size > 0 )
                    {
    ...
    if ( isdefined( level.uavmodels ) )
    {
        if ( istrue( var_1 ) )
        {
            foreach ( var_9, var_5 in level.squaddata[var_0] )
            {
                if ( isdefined( level.uavmodels[var_9] ) && level.uavmodels[var_9].size > 0 )
                {
                    foreach ( var_7 in level.uavmodels[var_9] )
                    {
                        ...
                        if ( var_7.uavtype == "uav" || var_7.uavtype == "directional_uav" )
                            return 1;
                    }
                }
            }
        ...
        {
            foreach ( var_7 in level.uavmodels[var_0] )
            {
                if ( !isdefined( var_7 ) )
                    continue;
...
_id_12938( var_0 )
{
    ...
    if ( isdefined( level.uavmodels ) )
    {
        ...
        {
            foreach ( var_7, var_3 in level.squaddata[var_0] )
            {
                if ( isdefined( level.uavmodels[var_7] ) && level.uavmodels[var_7].size > 0 )
                {
                    foreach ( var_5 in level.uavmodels[var_7] )
                    {
                        if ( !isdefined( var_5 ) )
                            continue;

                        if ( var_5.uavtype == "uav" || var_5.uavtype == "directional_uav" )
                            return 1;
                    }
                }
            }
...
_id_11B45( var_0 )
{
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "challenges", "onKillStreakEnd" ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            var_3 = gettime();
            var_4 = var_3 - var_1.allassassin_initteamlist;
            var_5 = var_0.kills;
            var_6 = 0;
            var_7 = 0;
            var_8 = 0;
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "dlog", "killStreakExpired" ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_9 = var_1._id_127D7;
            var_10 = var_1.streakname;
            var_11 = var_1.isgimme;
            var_3 = gettime();
            var_12 = self.origin;
            var_13 = istrue( var_0.is_in_gas );
...
stealth_alert_music_index( var_0 )
{
    var_1 = var_0 getmovingplatformparent();

    if ( isdefined( var_1 ) && scripts\mp\vehicles\vehicle_compass_mp::rear_minigun_speed( var_1 ) || scripts\cp_mp\utility\script_utility::issharedfuncdefined( "entity", "isGondolaBrush" ) && [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "entity", "isGondolaBrush" ) ]]( var_1 ) )
    {
        var_0 playerlinkto( var_1 );
        var_0 playerlinkedoffsetenable();
        var_0.stealth_broken_music_index = var_1;
    }
}

stealth_broken_music( var_0 )
{
    if ( isdefined( var_0.stealth_broken_music_index ) )
    {
        var_0.stealth_broken_music_index = undefined;
        var_0 unlink();
    }
}
