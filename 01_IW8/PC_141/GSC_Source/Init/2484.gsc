...
animscriptmp_internal( var_0, var_1, var_2, var_3 )
{
    ...
    scripts\asm\asm_mp::br_is_allowed_armor_insert();
...
bonuskillscharge( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::br_is_allowed_armor_insert();
...
bonus_target_score( var_0, var_1 )
{
    scripts\asm\asm_mp::br_is_allowed_armor_insert();
    var_2 = scripts\asm\asm::asm_lookupanimfromalias( "animscripted", var_0 );
    var_3 = scripts\asm\asm::asm_getxanim( "animscripted", var_2 );
...
bonusdeathplunderot( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::br_is_allowed_armor_insert();
...
bonustimeapplied( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "animscripted";
...
bonuskillstreakcharge( var_0, var_1, var_2, var_3 )
{
    scripts\asm\asm_mp::br_is_allowed_armor_insert();
