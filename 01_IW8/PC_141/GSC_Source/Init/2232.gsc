...
init()
{
    ...
    level.helperdronesettings["radar_drone_recon"].skipburndownhigh = 1;
    level.helperdronesettings["radar_drone_recon"].skipburndownlow = 1;
    level.helperdronesettings["radar_drone_recon"].skipprematch = 3062500;
    level.helperdronesettings["radar_drone_recon"].skipscriptable = 6250000;
    ...
    level.helperdronesettings["assault_drone"].primarymodefunc = ::_id_120F2;
    ...
    level.helperdronesettings["assault_drone"].skipburndownhigh = 0;
    level.helperdronesettings["assault_drone"].skipburndownlow = 0;
    level.helperdronesettings["assault_drone"].skipprematch = 73984;
    level.helperdronesettings["assault_drone"].skipscriptable = 73984;
    level.helperdronesettings["assault_drone"].glgrenadeparent = 1;
    level.helperdronesettings["assault_drone"].glgrenade = undefined;
    level.helperdronesettings["assault_drone"].glint = 1;
    level.helperdronesettings["assault_drone"].trial_play_flare_fx = undefined;
    var_0 = "br";
    ...
    level.br_loadout_option = getdvarfloat( "scr_assault_drone_enemy_notify_dist", 3000.0 );
    level.br_lerp_minimap_zoom = getdvarint( "scr_assault_drone_freeze_debug", 0 );
    level.hostdamagefactorhigh = getdvarint( "scr_drone_freeze_switch_debug", 1 );
}
...
tryusehelperdronefromstruct( var_0 )
{
    ...
    var_5 = self.playersetispropgameextrainfo;
    self.playersetispropgameextrainfo = undefined;
    ...
    {
        if ( istrue( level.hostdamagefactorhigh ) )
        ...
        var_10 = 0.6;
        var_11 = 2;
        var_12 = scripts\engine\utility::_id_13142( var_10, "death", "weapon_switch_started" );
        ...
        var_12 = scripts\engine\utility::_id_13141( var_11 - var_10, "death" );
    ...
    else if ( var_6 == "scrambler_drone_guard" )
    {
        ...
        if ( isdefined( level._id_12A80 ) )
        {
            var_15 = [[ level._id_12A80 ]]( self.origin );
    ...
    if ( level.gametype == "br" )
    {
        if ( var_6 == "scrambler_drone_guard" )
            scripts\cp_mp\killstreaks\uav::_id_12CE4( self.team, 15000, "scrambler_drone_guard" );
    }
...
tryusehelperdroneearlyout( var_0, var_1 )
{
    ...
    if ( ( var_0.streakname == "radar_drone_recon" || var_0.streakname == "assault_drone" ) && ( !self isonground() && !self isonladder() || scripts\mp\vehicles\vehicle_compass_mp::remapattachmentparentname() ) )
    {
        if ( var_1 )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    if ( isdefined( level.dontspawnjeep ) )
    {
        if ( ![[ level.dontspawnjeep ]]( self ) )
        {
            if ( var_1 )
            {
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    else
    {
        ...
        switch ( var_2 )
        {
            ...
            case "scrambler_drone_guard":
                if ( istrue( level.showexfilstartsplash ) )
                {
            ...
            case "radar_drone_recon":
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
                {
                    if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() == "br" )
                    {
                        ...
                        var_9 play_rooftop_success_vo( var_2 );
                    }
                }
...
play_rooftop_success_vo( var_0 )
{
    var_1 = 3000;

    if ( var_0 == "assault_drone" )
        var_1 = level.br_loadout_option;
...
helperdrone_endscramblereffect()
{
    ...
    if ( isdefined( self.init_relic_focus_fire ) && self.init_relic_focus_fire.size > 0 )
    {
        foreach ( var_1 in self.init_relic_focus_fire )
        {
            if ( isdefined( var_1 ) )
            {
                var_2 = var_1;
...
{
    scripts\engine\utility::_id_1312D( "death_or_disconnect", "scramble_off" );
...
helperdrone_setscramblerjammed( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( var_1.init_relic_focus_fire, var_3 ) )
            var_1.init_relic_focus_fire[var_1.init_relic_focus_fire.size] = var_3;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_1312D( "death", "scramble_off" );

    if ( isdefined( self ) )
    {
        helperdrone_setscramblerjammed( 0, var_0, var_1 );

        if ( isdefined( var_0 ) && isdefined( var_0.init_relic_focus_fire ) )
            var_0.init_relic_focus_fire = scripts\engine\utility::array_remove( var_0.init_relic_focus_fire, self );
    }
    else if ( isdefined( var_0 ) && isdefined( var_0.init_relic_focus_fire ) )
        var_0.init_relic_focus_fire = scripts\engine\utility::array_removeundefined( var_0.init_relic_focus_fire );
}
        ...
        foreach ( var_5 in level.supportdrones )
        {
            ...
            if ( level.teambased )
            {
                if ( !isdefined( var_1 ) && var_5.team == self.team )
                    ...
                    var_3 = var_5.init_relic_focus_fire;
            }
...
starthelperdrone( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        if ( var_2 == "br" )
            var_0 thread play_skit_and_watch_for_endons( self );
    }
...
helperdrone_overwatchplayer()
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::_id_1312D( "goal", "begin_evasive_maneuvers" );
...
helperdrone_pingnearbyenemies()
{
    ...
    self.updatebufferedstatsatgameend = [];
    ...
    for (;;)
    {
        ...
        foreach ( var_4 in var_2 )
        {
            ...
            if ( var_4 play_random_sound_event( self ) )
                continue;
...
helperdrone_watchpingedstatus( var_0, var_1 )
{
    ...
    self.updatebufferedstatsatgameend[self.updatebufferedstatsatgameend.size] = var_0;
    var_0 scripts\engine\utility::_id_13141( 3, "death" );
    self.updatebufferedstatsatgameend = scripts\engine\utility::array_remove( self.updatebufferedstatsatgameend, var_0 );
}

play_random_sound_event( var_0 )
{
    var_1 = 0;

    foreach ( var_3 in var_0.updatebufferedstatsatgameend )
    {
...
setreconmodesettings( var_0 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::stealth_alert_music_index( self.owner );

    if ( !istrue( var_1 ) )
    {
        self.owner _id_1216A( 1, self );
    ...
    thread play_smoke_fx( var_0 );
    thread helperdrone_handlethermalswitch();
    thread play_reset_sequences( var_0 );
    return 1;
}
...
_id_120F2( var_0 )
{
    ...
    if ( !istrue( var_1 ) )
    {
        ...
        scripts\cp_mp\utility\weapon_utility::setlockedonremovedcallback( self, ::helperdrone_lockedonremovedcallback );
        thread helperdrone_watchouterreticletargets( var_0 );
        thread play_smuggler_arriving_vo( var_0 );
        thread play_reset_priming_anim( var_0 );
    }
    ...
    if ( istrue( level.br_lerp_minimap_zoom ) )
        thread play_pullout_sequence( 2 );
...
helperdrone_watchearlyexit( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "allowRideKillstreakPlayerExit" ) )
        self thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "allowRideKillstreakPlayerExit" ) ]]( "death", var_0.trial_play_flare_fx );

    self waittill( "killstreakExit" );
    thread helperdroneexplode( 0, istrue( var_0.glgrenade ) );
}

play_smoke_fx( var_0 )
{
    if ( !istrue( var_0.glgrenadeparent ) )
        return;
...
play_reset_sequences( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 scripts\cp_mp\vehicles\vehicle::isvehicle() )
            ...
            var_2 = var_1.vehicle;
        else if ( istrue( var_1.round_vehicle_path_logic ) )
            var_2 = var_1;
...
play_pullout_sequence( var_0 )
{
    ...
    self endon( "death" );
    wait( var_0 );
    self.owner thread scripts\cp_mp\utility\player_utility::add_client_back_to_mask_after_delay();
}
...
helperdrone_markplayers( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.bot_can_tag_interact_with = 0;
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            var_2++;
            _id_1217B( self.targetmarkergroup, var_5, 1 );
            ...
            if ( var_8 )
                self.bot_can_tag_interact_with = 1;

            if ( var_9 )
            {
                _id_1217B( self.targetmarkergroup, var_5, 3 );
                continue;
            }

            if ( !var_8 || !var_6 )
            {
                _id_1217B( self.targetmarkergroup, var_5, 0 );
                continue;
            }
...
play_reset_priming_anim( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_6 in var_3 )
        {
            ...
            var_2++;
            _id_1217B( self.targetmarkergroup, var_6, 1 );
            var_7 = canseetarget( var_6 );
            var_8 = isinmarkingrange( var_6 );

            if ( !var_8 || !var_7 )
            {
                _id_1217B( self.targetmarkergroup, var_6, 0 );
                continue;
            }

            var_4 = 1;
            _id_1217B( self.targetmarkergroup, var_6, 2 );
        }

        self._id_1290E = var_4;
        var_2 = 0;
        waitframe();
    }
}
...
play_smuggler_arriving_vo( var_0 )
{
    ...
    for (;;)
    {
        if ( istrue( self._id_1290E ) && var_1 == 0 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 1 );
            var_1 = 1;
        }
        else if ( !istrue( self._id_1290E ) && var_1 == 1 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 0 );
            var_1 = 0;
        }
...
helperdrone_watchnotificationstate( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( !istrue( self.bot_can_tag_interact_with ) )
...
helperdrone_watchouterreticletargets( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.amped_victim_starttime ) )
        {
            ...
            {
                if ( isdefined( var_6.get_player_who_most_recently_fired_weapon ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "gameFlag" ) )
                    {
                        if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "gameFlag" ) ]]( "prematch_done" ) )
                        {
                            ...
                            {
                                if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "player", "isPlayerOnIntelChallenge" ) ]]( self.owner, var_6.get_player_who_most_recently_fired_weapon ) )
        ...
        foreach ( var_10 in var_8 )
        {
            if ( isplayer( var_10 ) )
            {
                ...
                if ( !istrue( var_0.skipburndownhigh ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "perk", "hasPerk" ) )
                    {
            ...
            if ( istrue( var_0.skipburndownlow ) && !self.owner helperdrone_istargetinreticle( var_10, 70, 300 ) )
                continue;
...
canseetarget( var_0 )
{
    ...
    if ( isdefined( var_0._id_11B3D ) )
        var_2 = var_0._id_11B3D;
    else
...
startmarkingpassivetarget( var_0 )
{
    ...
    _id_1217B( self.targetmarkergroup, var_0, 0 );
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( istrue( var_2.skipburndownlow ) && !self.owner helperdrone_istargetinreticle( var_0, 70, 300 ) )
            break;
...
startmarkingtarget( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_0._id_11B3B ) )
        [[ var_0._id_11B3B ]]( var_4, var_0 );
    ...
    self.owner stoplocalsound( "recon_drone_marking_owner" );
    self.owner _id_1216A( 4, self );
    _id_1217B( self.targetmarkergroup, var_0, 2 );
...
isinmarkingrange( var_0 )
{
    ...
    var_3 = scripts\engine\utility::ter_op( var_2, var_1.skipscriptable, var_1.skipprematch );

    if ( isdefined( var_0.skipburndownmedium ) )
        var_3 = var_0.skipburndownmedium;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_13142( var_2, "death", "explode" );
...
helperdrone_watchforgoal()
{
    ...
    var_0 = scripts\engine\utility::_id_13136( "goal", "near_goal", "hit_goal" );
    self.intransit = 0;
    self.inactive = 0;
...
helperdrone_watchroundend()
{
    ...
    self.owner endon( "disconnect" );
    self endon( "owner_gone" );
    level scripts\engine\utility::_id_1312E( "round_end_finished", "game_ended", "prematch_cleanup" );
    thread helperdrone_leave();
}
...
helperdroneexplode( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        ...
        play_sound_from_closest_player();
    }
    else
        play_sound_on_pa_systems();
...
removehelperdrone( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.owner ) )
    {
        ...
        self.streakinfo.is_in_gas = istrue( var_2 );
        self.owner scripts\cp_mp\utility\killstreak_utility::_id_11B45( self.streakinfo );
    }
...
helperdrone_returnplayer( var_0 )
{
    ...
    var_0 thread play_quarry_intro_vo();
    var_0 cameraunlink( self );
    var_0 remotecontrolvehicleoff();
    scripts\cp_mp\utility\killstreak_utility::stealth_broken_music( var_0 );
...
helperdrone_destroyongameend()
{
    ...
    self endon( "leaving" );
    self endon( "explode" );
    level scripts\engine\utility::_id_1312D( "bro_shot_start", "game_ended" );
...
helperdrone_istargetinreticle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0._id_11B3E ) )
        var_4 = var_4 + var_0._id_11B3E;

    var_5 = [ var_4 ];

    if ( isplayer( var_0 ) )
    {
        var_6 = var_0 scripts\mp\utility\player::nag_player_remind_lore_vo();
