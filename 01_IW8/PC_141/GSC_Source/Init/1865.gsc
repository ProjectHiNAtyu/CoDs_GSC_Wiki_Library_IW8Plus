...
javelinusageloop()
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::_id_1312D( "weapon_change", "emp_cleared" );
    }
}
...
javelin_holdstateupdate()
{
    ...
    if ( !var_0 && ( self.javelin.target scripts\cp_mp\vehicles\vehicle::isvehicle() && scripts\cp_mp\vehicles\vehicle::_id_12F6D( self.javelin.target, self ) ) )
    {
        javelin_queuestate( "scanning" );
        var_1 = 1;
    }
...
javelin_getvehicleoffset( var_0 )
{
    ...
    if ( scripts\mp\utility\entity::ischoppergunner( var_0 ) )
        ...
        var_1 = ( 0, 0, 10 );
    else if ( scripts\mp\utility\entity::register_boss_objectives( var_0 ) )
        var_1 = ( 0, 0, 10 );
