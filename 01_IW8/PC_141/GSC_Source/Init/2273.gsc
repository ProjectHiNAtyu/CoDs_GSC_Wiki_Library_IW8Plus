...
vehicle_occupancy_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            var_3.stack_patch_thread = undefined;
            var_3.restrictions = [];
...
vehicle_occupancy_getleveldataforseat( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_2 ) )
        {
            ...
            var_4._id_122BF = undefined;
            var_4._id_12C9C = undefined;
        }
    }
...
vehicle_occupancy_deregisterinstance( var_0 )
{
    ...
    var_0._id_1194F = undefined;
    var_0.blockade_gate_explode_sequence = undefined;
...
vehicle_occupancy_seatisavailable( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0.blockade_gate_explode_sequence ) )
        return 0;
...
vehicle_occupancy_enter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( istrue( vehicle_occupancy_seatisavailable( var_0, var_1, var_2 ) ) )
    {
        ...
        if ( var_10 )
        {
            ...
            if ( istrue( var_2.quest_scavdistmin ) )
                var_2 notify( "br_try_armor_cancel" );

            if ( isdefined( var_9 ) )
            {
                var_11 = _id_12F91( var_0, var_9 );
            ...
            if ( isdefined( var_1 ) )
            {
                var_11 = _id_12F91( var_0, var_1 );

                if ( istrue( var_11 ) && !istrue( level.handleeventcallback ) )
                {
                    var_12 = 0;
                    var_13 = "";
                    var_14 = "";
                    ...
                    {
                        case "apc_russian":
                            var_13 = var_2._id_12FE4.apc;
                            var_14 = var_2._id_12FE4.bot_custom_classes_allowed;
                            var_12 = 1;
                            var_15 = var_2._id_12FE4.bot_choose_attack_role;
                            break;
                        case "atv":
                            var_13 = var_2._id_12FE4.break_window_glass;
                            var_15 = var_2._id_12FE4.breakable_gate_clip;
                            var_16 = var_2._id_12FE4.brenableagents;
                            break;
                        case "cargo_truck_mg":
                        case "cargo_truck":
                            var_13 = var_2._id_12FE4.diode_light_think;
                            var_15 = var_2._id_12FE4.directimpactkill;
                            break;
                        case "jeep":
                            var_13 = var_2._id_12FE4.respawndelay;
                            var_15 = var_2._id_12FE4.respawnfade;
                            break;
                        case "little_bird_mg":
                        case "little_bird":
                            var_13 = var_2._id_12FE4.set_relic_nobulletdamage;
                            var_15 = var_2._id_12FE4.set_relic_noks;
                            var_16 = var_2._id_12FE4.set_vehicle_anims_decho_civ;
                            break;
                        case "tac_rover":
                            var_13 = var_2._id_12FE4._id_12895;
                            var_15 = var_2._id_12FE4._id_12896;
                            var_16 = var_2._id_12FE4._id_1289A;
                            break;
                        case "light_tank":
                            var_13 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2._id_12FE4._id_128E0, var_2._id_12FE4._id_128EB );
                            var_14 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2._id_12FE4._id_128E1, var_2._id_12FE4._id_128EC );
                            var_12 = 1;
                            break;
                        case "motorcycle":
                            var_13 = var_2._id_12FE4.start_loc;
                            var_15 = var_2._id_12FE4.start_safehouse_gunshop;
                            var_16 = var_2._id_12FE4.start_static_plane_lights;
                            break;
                        default:
                            var_13 = "";
                            var_15 = "";
                    ...
                    if ( var_13 != "" && !isdefined( var_0.deletecircle ) )
                    {
            ...
            _hidesafecircleui::buttonmashcount( var_0, var_2, var_1, var_9 );
            scripts\cp_mp\vehicles\vehicle_dlog::_id_12F40( var_0, var_2, var_1, var_20 );
        }
...
_id_12F94( var_0, var_1 )
{
    if ( level.teambased )
        return _id_12F95( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.lastgoodjobplayer ) )
            var_0 _id_12F7A( var_0 );

        return isdefined( var_0.verbal_string ) && var_0.verbal_string == var_1;
    }
}

_id_12F92( var_0, var_1 )
{
    if ( level.teambased )
        return _id_12F93( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.lastgoodjobplayer ) )
            var_0 _id_12F7A( var_0 );
...
_id_12F96( var_0, var_1 )
{
    if ( level.teambased )
        return _id_12F97( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.lastgoodjobplayer ) )
            var_0 _id_12F7A( var_0 );

        return !isdefined( var_0.verbal_string );
    }
}
...
_id_12F87( var_0 )
{
    if ( !level.teambased )
    {
        ...
        return var_0.verbal_string;
    }

    return undefined;
}

_id_12F95( var_0, var_1 )
{
    if ( level.teambased )
    {
        if ( istrue( var_0.lastgoodjobplayer ) )
        ...
        return isdefined( var_0._id_12936 ) && var_0._id_12936 == var_1;
    }

    return undefined;
}

_id_12F93( var_0, var_1 )
{
    if ( level.teambased )
    {
        if ( istrue( var_0.lastgoodjobplayer ) )
...
_id_12F97( var_0, var_1 )
{
    if ( level.teambased )
    {
        ...
        return !isdefined( var_0._id_12936 );
    }
...
_id_12F7A( var_0 )
{
    ...
    {
        var_1 = 0;
        var_2 = var_0._id_12936;

        if ( isdefined( var_0.team ) && var_0.team != "neutral" )
        {
            var_0._id_12936 = var_0.team;
            var_0.lastgoodjobplayer = undefined;
            var_1 = 1;
        }
        ...
        if ( !var_1 )
        {
            var_0._id_12936 = undefined;
            var_0.lastgoodjobplayer = undefined;
        }

        if ( !isdefined( var_2 ) && !isdefined( var_0._id_12936 ) )
            return 0;

        if ( isdefined( var_2 ) && isdefined( var_0._id_12936 ) && var_2 == var_0._id_12936 )
            return 0;

        _id_12F86( var_0, var_2, var_0._id_12936 );
        return 1;
    }
    else
    {
        var_1 = 0;
        var_6 = var_0.verbal_string;

        if ( isdefined( var_0.originalowner ) )
        {
            var_0.verbal_string = var_0.originalowner;
            var_0.lastgoodjobplayer = undefined;
            var_1 = 1;
        }
        ...
        if ( !isdefined( var_6 ) && !isdefined( var_0.verbal_string ) )
            return 0;

        if ( isdefined( var_6 ) && isdefined( var_0.verbal_string ) && var_6 == var_0.verbal_string )
            return 0;

        _id_12F86( var_0, var_6, var_0.verbal_string );
        return 1;
    }
}
...
{
    _applysalesdiscount::_id_12EDB( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( !isdefined( var_3.lastdroppableweaponchanged ) )
        return;

    thread [[ var_3.lastdroppableweaponchanged ]]( var_0, var_1, var_2 );
}
...
vehicle_occupancy_init()
{
    ...
    var_0.vehicledata = [];
    var_0._id_12B21 = getdvarint( "scr_transitionHideEnabled", 1 ) > 0;
...
vehicle_occupancy_enterend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
    {
        ...
        _id_12F8D( var_0, var_1, var_3, var_4 );
        ...
        if ( !isdefined( var_2 ) )
        {
            ...
            if ( isdefined( var_5.tomastrike_watchgameend ) )
                thread _id_12F8C( var_3, var_5, 1 );
        }
        else
        {
            ...
            if ( isdefined( var_5.tomastrike_watchgameend ) )
                thread _id_12F8C( var_3, var_5, 0 );
        }
    }
    else
    {
...
vehicle_occupancy_exitend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_4.success )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            _id_12FA6( var_0, var_1, var_3, var_4 );
        }

        if ( !isdefined( var_2 ) )
            vehicle_occupancy_onexitvehicle( var_0, var_1, var_3, var_4 );

        if ( !var_0 scripts\common\vehicle_code::vehicle_is_stopped() && _id_12F91( var_0, var_1 ) )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "br", "challengeEvaluator" ) )
            {
                var_6 = spawnstruct();
                var_6.is_dropping_hostage = 1;
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        if ( !isdefined( var_2 ) )
        {
            if ( isdefined( var_3._id_13018 ) )
                var_3._id_13018 = undefined;

            if ( isdefined( var_3._id_13017 ) )
                var_3._id_13017 = undefined;
        }
    }
}
...
_id_12F8C( var_0, var_1, var_2 )
{
    var_3 = 5000;

    if ( istrue( var_2 ) )
    {
        var_0._id_13018 = var_1.tomastrike_watchgameend;
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1.tomastrike_watchgameend, undefined, 1 );
        var_0._id_13017 = gettime();
    }
    else if ( isdefined( var_0._id_13018 ) && isdefined( var_0._id_13017 ) && var_0._id_13018 != var_1.tomastrike_watchgameend && gettime() - var_0._id_13017 > var_3 )
    {
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1.tomastrike_watchgameend );
        var_0._id_13018 = var_1.tomastrike_watchgameend;
        var_0._id_13017 = gettime();
    }
}
...
{
    _id_12FA5( var_0 );
    var_0 scripts\cp_mp\vehicles\vehicle_spawn::_id_12FC7();
    var_2 setstance( "stand" );
    var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 0 );
    thread _id_12FA9( var_2, var_0, var_1 );
    _hidesafecircleui::bullet( var_0, var_2 );
...
vehicle_occupancy_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) )
    {
        ...
        if ( !istrue( var_3.playerdeath ) )
        {
            if ( istrue( var_3.playerlaststand ) )
                var_3.is_enemy_of_type = "DEATH";
            else if ( !isdefined( var_3.is_enemy_of_type ) )
                var_3.is_enemy_of_type = "VOLUNTARY";

            var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 1 );
            thread scripts\cp_mp\vehicles\vehicle::_id_12FB1( var_0, var_2 );
        }
        else
            var_3.is_enemy_of_type = "DEATH";

        thread _id_12F8B( var_2, var_3.playerdeath, var_3.playerlaststand );
    }
    else
        var_3.is_enemy_of_type = "DISCONNECT";

    _id_12FA5( var_0 );

    if ( scripts\cp_mp\vehicles\vehicle_spawn::_id_12FC2() && var_0.occupants.size == 0 )
        var_0 thread scripts\cp_mp\vehicles\vehicle_spawn::_id_12FCA();
    ...
    scripts\cp_mp\vehicles\vehicle_dlog::vehicle_dlog_exitevent( var_0, var_2, var_1, var_3.is_enemy_of_type );
    _hidesafecircleui::bunker11_mistsdoors( var_0, var_2, var_1 );
}
...
_id_12F8F()
{
    if ( !isdefined( level.playboxuseanimation ) )
        level.playboxuseanimation = getdvarint( "scr_hideOccupantWithStack", 1 );

    return level.playboxuseanimation;
}
...
vehicle_occupancy_hideoccupant( var_0, var_1, var_2, var_3 )
{
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) )
    {
        ...
        if ( _id_12F8F() )
            var_2 scripts\cp_mp\utility\player_utility::addplayeraslootleader();
        else
            var_2 playerhide();
    }
}

_id_12F8E( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    var_3 = var_2._id_12B22;
    var_2._id_12B22++;
    var_0 scripts\cp_mp\utility\player_utility::addplayeraslootleader();
    var_2._id_12B23[var_3] = var_0;

    if ( !isdefined( var_1._id_12B23 ) )
        var_1._id_12B23 = [];

    var_1._id_12B23[var_3] = var_0;
    return var_3;
}

_id_12FA8( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3._id_12B23[var_0] ) )
        return;

    var_4 = var_3._id_12B23[var_0];

    if ( isdefined( var_1 ) && isdefined( var_1._id_12B23 ) )
        var_1._id_12B23[var_0] = undefined;

    if ( isdefined( var_4 ) )
        var_4 scripts\cp_mp\utility\player_utility::addplundercarrycredit();
}

_id_12FA7( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    if ( !isdefined( var_0._id_12B23 ) )
        return;

    foreach ( var_5, var_4 in var_0._id_12B23 )
    {
        if ( isdefined( var_2._id_12B23[var_5] ) )
        {
            var_2._id_12B23[var_5] = undefined;
...
_id_12F7B()
{
    ...
    foreach ( var_3, var_2 in var_0._id_12B23 )
    {
        if ( !isdefined( var_2 ) )
            var_0._id_12B23[var_3] = undefined;
    }
}
...
vehicle_occupancy_showoccupant( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) || istrue( var_4 ) )
    {
        if ( _id_12F8F() )
        {
            if ( istrue( var_4 ) )
            {
                var_2 scripts\cp_mp\utility\player_utility::wait_between_stations();
                var_2 playershow();
            }
            else
                var_2 scripts\cp_mp\utility\player_utility::addplundercarrycredit();
        }
        else
            var_2 playershow();
    }
...
_id_12F9A( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301B( var_1 ) )
        return;

    if ( 1 )
        wait 1.5;

    childthread _id_12F9C( var_0, var_1, var_2 );
    childthread _id_12F9D( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( isdefined( var_3.stack_patch_thread ) )
        childthread [[ var_3.stack_patch_thread ]]( var_0, var_1, var_2, "vehicle_occupancy_monitorControls" );
}

_id_12F84( var_0 )
{
    scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301C( var_0 );
    var_0 notify( "vehicle_occupancy_monitorControls" );
}

_id_12F9C( var_0, var_1, var_2 )
{
...
_id_12F9D( var_0, var_1, var_2 )
{
    var_3 = vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_2 );

    if ( isdefined( var_3._id_12C9C ) )
    {
        var_4 = scripts\cp_mp\vehicles\vehicle::_id_12F48( var_0, var_3._id_12C9C );

        if ( isdefined( var_4 ) )
        {
            var_4 scripts\engine\utility::_id_1312D( "turret_fire", "turret_reload" );
            _id_12F84( var_1 );
        }
    }
}
...
vehicle_occupancy_raceplayerdeathdisconnect( var_0, var_1 )
{
    ...
    var_2 = var_0 scripts\engine\utility::_id_1313D( "death", "disconnect", "last_stand_start" );
...
vehicle_occupancy_watchownerjoinedteam( var_0, var_1 )
{
    ...
    var_1 scripts\engine\utility::_id_1312D( "joined_team", "joined_spectators" );
...
vehicle_occupancy_animateplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        addjuggsettings( var_4, var_5 );
        thread addlaststandoverheadiconcallback( 1 );
    }
    ...
    if ( vehicle_occupancy_checkvalidanimtype( var_9, var_3 ) )
    {
        ...
        scripts\engine\utility::_id_1312D( "death_or_disconnect", "last_stand_start" );
...
vehicle_occupancy_findplayerexit( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( istrue( var_5.is_exploder ) )
        {
            var_4.exitposition = var_1.origin + anglestoup( var_1.angles ) * var_5.is_eliminate_drone_attack_available;
...
vehicle_occupancy_taketurret( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0 hasweapon( var_2 ) )
    {
        ...
        {
            if ( isdefined( var_5 ) )
                var_7 = scripts\cp_mp\vehicles\vehicle::_id_12F47( var_1, var_5 );
            else
                var_7 = scripts\cp_mp\vehicles\vehicle::_id_12F48( var_1, var_2 );
...
vehicle_occupancy_ejectalloccupants( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            var_5.is_enemy_of_type = "INVOLUNTARY";
...
_id_12F8D( var_0, var_1, var_2, var_3 )
{
...
_id_12FA6( var_0, var_1, var_2, var_3 )
{
...
vehicle_occupancy_assignseatcorpse( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_3 )
        var_0.helis_assault2_check_size = 1;
}

_id_12F7E( var_0, var_1, var_2 )
{
    if ( isdefined( var_1.corpses ) && isdefined( var_1.corpses[var_2] ) )
        var_1.corpses[var_2] = undefined;

    var_0.helis_assault2_check_size = undefined;
}
...
vehicle_occupancy_deleteseatcorpse( var_0, var_1, var_2 )
{
    if ( isdefined( var_0.corpses ) && isdefined( var_0.corpses[var_1] ) )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            if ( !istrue( var_3.helis_assault2_check_size ) || !var_2 )
            {
...
_id_12F79( var_0 )
{
    ...
    if ( isdefined( var_0._id_1194F ) && var_0._id_1194F > 0 )
        return 0;
...
vehicle_occupancy_killoccupants( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( isdefined( var_6 ) && var_6 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            {
                if ( isdefined( var_6.juggcontext.juggconfig._id_12FDF ) && var_6.health > var_6.juggcontext.juggconfig._id_12FDF )
                    var_8 = 1;
            }
            ...
            if ( !istrue( var_8 ) )
            {
                ...
                if ( isdefined( level._id_12FFC ) )
                    var_6 thread [[ level._id_12FFC ]]();
            }
