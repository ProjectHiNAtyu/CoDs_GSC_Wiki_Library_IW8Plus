...
{
    level.useobjs = [];
    scripts\engine\scriptable::_id_11F48( "hack_usable", ::initheadlessoperatorcustomization );
    thread _updateuseobjs();
}

initheadlessoperatorcustomization( var_0, var_1, var_2, var_3, var_4 )
{
    initheliextractanims( var_0.entity, var_3 );
}

initheliextractanims( var_0, var_1 )
{
    var_2 = var_0;
    var_2.isbeingused = 1;
...
_deployhacktablet( var_0, var_1 )
{
    ...
    var_4 = scripts\cp_mp\killstreaks\killstreakdeploy::switchtodeployweapon( var_2, var_3, ::_waituntilinteractfinished, ::addjuggfunctionality, undefined, undefined, ::_ontabletputaway );
...
addjuggfunctionality( var_0, var_1 )
{
    _toggletabletallows( 1 );
    thread activate_gas_trap_puddles();
    thread activate_emp_drone_func( var_0 );
    return 1;
}
...
activate_gas_trap_puddles()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    scripts\engine\utility::_id_1312D( "death", "tabletPutAway" );
