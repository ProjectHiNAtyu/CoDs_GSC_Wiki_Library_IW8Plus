...
getweapongroup( var_0 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        if ( issuperweapon( var_0 ) )
            ...
            var_2 = "gamemode";
        else if ( register_initial_bank_modules( var_0 ) )
            var_2 = "weapon_ballisticSpecial";
        else if ( registeruniquelootcallback( var_0 ) )
...
registeruniquelootcallback( var_0 )
{
    var_1 = undefined;
...
attachmentsconflict( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _start_rooftop_raid_heli( var_3, var_4 ) )
        return var_0;

    if ( _start_rooftop_raid_heli( var_4, var_3 ) )
        return var_0;
...
_start_rooftop_raid_heli( var_0, var_1 )
{
    var_2 = branalytics_plunder_extraction_failure( var_0 );
    var_3 = branalytics_playercount( var_1 );
...
{
    return register_valid_objectives_for_create_script( getweapongroup( var_0 ), var_0 );
}

register_valid_objectives_for_create_script( var_0, var_1 )
{
    switch ( var_0 )
    {
        case "weapon_melee":
...
{
    return register_vehicle_as_ambient( getweapongroup( var_0 ), var_0 );
}
...
iscacprimaryorsecondary( var_0 )
{
    ...
    return register_valid_objectives_for_create_script( var_1, var_0 ) || register_vehicle_as_ambient( var_1, var_0 );
}
...
{
    if ( isdefined( level.branalytics_missionstart[var_0] ) )
        return level.branalytics_missionstart[var_0];
...
{
    if ( isdefined( level.branalytics_plunder_extraction_success[var_0] ) )
        return level.branalytics_plunder_extraction_success[var_0];

    var_1 = attachmentmap_tobase( var_0 );

    if ( isdefined( level.branalytics_planepath[var_1] ) )
        return level.branalytics_planepath[var_1];
...
mp_euphrates_patches( var_0 )
{
    var_1 = randomintrange( 0, level._id_132D8[var_0].size );
    return level._id_132D8[var_0][var_1];
}
...
_id_132DD( var_0 )
{
    if ( isdefined( level.weaponmapdata[var_0] ) && isdefined( level.weaponmapdata[var_0].spawn_exfil_heli_and_rpgs ) )
        return level.weaponmapdata[var_0].spawn_exfil_heli_and_rpgs;
...
nolandingdamage( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( !level.weaponlootmapdata[var_4].relic_nuketimer_addtotimer && !scripts\engine\utility::array_contains( var_1, var_2 ) )
...
nodropanim( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = [];

    var_2 = 0;
    var_3 = nolandingdamage( var_0, var_1 );
...
_id_132DB( var_0, var_1 )
{
    ...
    if ( var_2 )
    {
        ...
        {
            var_4 = var_0 + "|" + var_1;
            var_3 = isdefined( level.weaponlootmapdata[var_4] ) && !level.weaponlootmapdata[var_4].relic_nuketimer_addtotimer;
        }
    }
...
attachmentlogsstats( var_0, var_1 )
{
    ...
    if ( !branalytics_landing( var_1, var_0 ) )
        return 0;
...
branalytics_landing( var_0, var_1 )
{
    var_2 = getweaponrootname( var_0 );
    return branalytics_missionend( var_2, var_1 );
}

branalytics_missionend( var_0, var_1 )
{
...
relic_landlocked_clear_message_on_player_return( var_0 )
{
...
weaponbypassspawnprotection( var_0 )
{
    ...
    if ( iskillstreakweapon( var_0 ) && var_2 != "manual_turret_mp" && var_2 != "pac_sentry_turret_mp" && !relic_nuketimer_waitforcompleteobjectives( var_2 ) )
        var_1 = 0;
...
relic_nuketimer_timer_init( var_0 )
{
    if ( issameweapon( var_0 ) )
        var_1 = var_0.basename;
    else
...
{
    if ( relic_nuketimer_timer_init( var_0 ) )
        return 1;
...
relic_amped_debug_explode_after_reviving( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
getweaponrarity( var_0 )
{
    if ( isdefined( level.br_pickups ) && isdefined( level.br_pickups.br_weapontoscriptable ) && isdefined( level.br_pickups.choppersupport_issmallpatrolmap ) )
    {
        var_1 = createheadicon( var_0 );
        var_2 = level.br_pickups.br_weapontoscriptable[var_1];

        if ( isdefined( var_2 ) )
            return level.br_pickups.choppersupport_issmallpatrolmap[var_2];
    }
