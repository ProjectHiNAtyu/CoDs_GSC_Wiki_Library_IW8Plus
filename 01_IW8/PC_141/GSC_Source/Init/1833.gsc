...
callback_playerdamage_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14 )
{
    ...
    if ( istrue( var_2.trace_to_eye_weight ) && isdefined( var_6 ) )
    {
        if ( !randoexplodo( var_6.basename ) )
            return;
    }
    ...
    if ( var_5 == "MOD_CRUSH" && isdefined( var_0 ) && isdefined( var_0.classname ) && var_0.classname == "script_vehicle" && isdefined( var_0.vehiclename ) && var_0.vehiclename == "loot_chopper" )
    {
        var_16 = 10000;
        var_17 = gettime() - var_0.birthtime;
    ...
    {
        if ( istrue( level._id_12A9F ) )
            var_2 thread scripts\mp\battlechatter_mp::addrecentattacker( var_1 );
    }
    else
    {
        var_19 = filterdamage( var_0, var_1, var_2, var_3, var_5, var_6, var_9 );

        if ( isdefined( var_19 ) )
            return;

        var_20 = scripts\mp\utility\damage::attackerishittingteam( var_2, var_1 );

        if ( isdefined( var_0 ) && istrue( var_0.death_explode ) )
            var_20 = 0;

        var_21 = isdefined( var_6 ) && scripts\mp\utility\weapon::iskillstreakweapon( var_6.basename );

        if ( !istrue( level.allowprematchdamage ) )
        {
            if ( istrue( game["inLiveLobby"] ) || !scripts\mp\flags::gameflag( "prematch_done" ) || istrue( level.playerstarttimetracking ) )
            {
                handledamagefeedback( var_0, var_1, var_2, 0, var_5, var_6, var_9, var_4, 1, 1, var_21 );
                return;
            }
        }
        ...
        if ( var_20 )
        {
            var_3 = handlefriendlyfiredamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_21 );
        ...
        if ( isdefined( var_1 ) && istrue( var_1.cranked ) )
            var_1 thread scripts\mp\cranked::toggle_switch_model( var_2 );
        ...
        if ( repair_grill_fixing_long_sfx( var_6 ) && scripts\mp\utility\damage::validshotcheck( var_5, var_1 ) )
        {
            if ( isdefined( var_6.registeruniquelootcallback ) )
                var_2 thread hit( var_9, var_1, var_6 );

            if ( var_6.basename != "iw8_pi_t9pistolshot_mp" )
                var_3 = _id_12600( var_2, var_1, var_6, var_3, var_4 );
            else if ( var_3 == 0 )
                return;
        }

        var_24 = var_6.basename;
        var_25 = scripts\mp\utility\weapon::getequipmenttype( var_24 );
        ...
        if ( isdefined( var_25 ) )
        {
            ...
            var_26 = scripts\cp_mp\utility\damage_utility::packdamagedata( var_1, var_2, var_3, var_6, var_5, var_0, var_7, var_8, undefined, var_12, undefined, var_4 );
            var_27 = scripts\mp\equipment::equiponplayerdamaged( var_26 );
        ...
        {
            var_28 = isdefined( var_6 ) && isdefined( var_6.basename ) && var_6.basename == "minefield_mp";

            if ( !var_28 )
            {
                var_29 = istrue( var_6.isalternate );

                if ( isdefined( var_25 ) && !scripts\mp\utility\weapon::isthrowingknife( var_24 ) || var_29 || var_5 == "MOD_EXPLOSIVE" )
                {
                    var_30 = int( max( var_2.health / 5, 1 ) );
        ...
        var_31 = scripts\mp\utility\weapon::getweapontype( var_24 );

        if ( isdefined( var_31 ) && var_31 == "killstreak" )
        {
        ...
        var_3 = handleriotshieldhits( var_0, var_2, var_1, var_3, var_5, var_6, var_7, var_8, var_9, var_4, var_21 );
        ...
        {
            var_33 = cac_modified_damage( var_2, var_1, var_3, var_5, var_6, var_7, var_8, var_9, var_0, 0, var_4, var_21 );
            var_3 = var_33[0];
            var_34 = var_33[1];
            var_35 = var_33[2];
            var_36 = var_34 != 0 || var_35 != 0;
            var_9 = var_33[3];
        }
        else
        {
        ...
        if ( relic_landlocked_do_explosion( var_1, var_2, var_3, var_5, var_6, var_13 ) )
            return;
        ...
        if ( isplayer( var_1 ) && ( var_24 == "smoke_grenade_mp" || scripts\mp\utility\weapon::isthrowingknife( var_24 ) ) )
            var_1 thread scripts\mp\gamelogic::threadedsetweaponstatbyname( var_24, 1, "hits" );

        var_37 = var_8;

        if ( isdefined( var_4 ) && var_4 & level.idflags_ricochet && var_3 < self.health )
            var_37 = var_2.origin - var_1.origin;

        if ( relativevelocity( var_0 ) )
            var_3 = 0;

        if ( isdefined( var_1 ) && ( isplayer( var_1 ) || istrue( var_1.allownonplayerdamageidflags ) ) && scripts\mp\utility\game::getgametype() == "br" )
        {
            if ( armorvest_washit( var_1 ) || helmet_washit( var_1 ) )
                var_4 = var_4 | level.playerplunderbankdepositcallback;

            if ( armorvest_wasbroke( var_1 ) || helmet_wasbroke( var_1 ) )
                var_4 = var_4 | level.playerplunderbankdeposit;

            if ( isdefined( level.onplayerdamagedaddflag_func ) )
                var_4 = var_4 | [[ level.onplayerdamagedaddflag_func ]]( var_2 );
        }

        if ( removeleadobjective( var_1 ) )
            var_3 = _id_11F71( var_1, var_3, var_5 );

        if ( isdefined( level.track_get_teleport_velocity ) )
        {
            if ( ![[ level.track_get_teleport_velocity ]]( var_5 ) )
                return;
        }

        var_38 = 5;

        if ( isplayer( var_1 ) && var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ping_on_damage" ) && var_32 >= var_38 )
        {
            if ( isplayer( var_2 ) && var_2 scripts\mp\utility\perk::_hasperk( "specialty_coldblooded" ) && var_2 != var_1 )
                var_1 thread scripts\mp\perks\perkfunctions::pingondamage_marked_target_timeout();
            else
                var_1 scripts\mp\perks\perkfunctions::hideconesifinfil( var_2 );
        }

        preplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_37, var_9, var_10, var_11, var_12 );
        var_2 finishplayerdamagewrapper( var_0, var_1, var_3, var_4, var_5, var_6, var_7, var_37, var_9, var_10, var_11, var_12, var_36 );
        postplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_37, var_9, var_10, var_11, var_12, var_34, var_35, var_18, var_21 );
    }
}

hit( var_0, var_1, var_2 )
{
    self notify( "newDragonsBreathHitLoc" );
    self endon( "newDragonsBreathHitLoc" );

    if ( !isdefined( self.his_respawn ) )
        self.his_respawn = scripts\cp\killstreaks\nuke_cp::_id_12541();

    self.his_respawn.superdeadsilence_watchforgameended = scripts\engine\utility::array_add( self.his_respawn.superdeadsilence_watchforgameended, var_0 );
    waittillframeend;
    var_3 = [];
    ...
    if ( isdefined( self.his_respawn ) )
    {
        var_3 = self.his_respawn.superdeadsilence_watchforgameended;
        self.his_respawn.superdeadsilence_watchforgameended = [];
    }

    if ( scripts\mp\utility\player::isreallyalive( self ) )
        scripts\cp\killstreaks\nuke_cp::_id_1210D( var_3, var_1, var_2 );
    else
        scripts\cp\killstreaks\nuke_cp::_id_1210E();
}
...
postplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16 )
{
    ...
    else if ( isdefined( var_4 ) && var_4 & level.idflags_penetration && !( var_4 & level.playerplunderdrop ) )
    {
...
meleestagger( var_0 )
{
    ...
    if ( isdefined( level.lbravo_spawner_safehouse2 ) )
        self setviewkickscale( scripts\engine\utility::ter_op( var_0 scripts\mp\utility\perk::_hasperk( "specialty_hardmelee" ), level.lbravo_spawner_safehouse2 * 2, level.lbravo_spawner_safehouse2 ) );
    else
...
{
    scripts\engine\utility::_id_13141( 2.0, "death_or_disconnect" );
    var_0 destroy();
}
...
allowdamageflash( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _id_12857( var_0, var_1, var_2, var_3, var_4 ) )
        return 0;

    return 1;
}

_id_12857( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_2 ) )
    {
...
_id_132DA( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = var_3.basename;

    if ( randoexplodo( var_7 ) )
        return 1;

    if ( isdefined( level.cloudorigin ) && isdefined( var_7 ) )
    {
        if ( istrue( level.cloudorigin._id_133FB ) && var_7 == "iw8_fists_mp_zmb" || istrue( level.cloudorigin.notifyteamonvehicledeath ) && var_7 == "iw8_fists_mp_gxp" )
            return 1;
    }
...
cac_modified_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    var_13 = 0;
    var_14 = 0;
    var_15 = var_0 scripts\mp\gametypes\br_public::hasarmor();
    var_16 = var_0 scripts\mp\gametypes\br_public::hashelmet();

    if ( isplayer( var_1 ) || isdefined( var_1 ) && istrue( var_1.allownonplayerdamageidflags ) )
    {
    ...
    if ( scripts\engine\utility::isbulletdamage( var_3 ) )
    {
        ...
        if ( scripts\mp\utility\weapon::relic_nuketimer_waitforcompleteobjectives( var_17 ) && scripts\mp\utility\game::getgametype() == "br" )
            var_2 = var_2 * scripts\mp\gametypes\br_jugg_common::monitor_molotov_throws();
        ...
        var_23 = istrue( var_1.screenent ) && scripts\mp\utility\weapon::getweaponrootname( var_4 ) == "iw8_sn_crossbow";
        ...
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
            var_2 = spawnhumandogtags( var_4, var_2, var_25, 0, var_1 );

        if ( isdefined( var_1 ) && isdefined( var_1._id_12FFF ) && var_1._id_12FFF == "loot_chopper" )
            var_2 = int( var_2 / 3 );
    }
    else if ( isexplosivedamagemod( var_3 ) )
    {
        ...
        var_2 = spawnoutofboundstrigger( var_2, var_8, var_4 );
        ...
        {
            var_34 = spawnheliactorsfunc( var_2, var_1, var_0 );
    ...
    else if ( var_3 == "MOD_FIRE" )
    {
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
        {
            if ( isdefined( var_4.basename ) && var_4.basename == "thermite_ap_mp" || var_4.basename == "thermite_bolt_mp" )
                var_2 = spawnhumandogtags( var_4, var_2, 0, 1, var_1 );
        }
    ...
    var_35 = _id_132DA( var_1, var_0, var_2, var_4, var_3, var_8, var_7 );
    var_36 = [ "MOD_GRENADE_SPLASH", "MOD_FIRE", "MOD_EXPLOSIVE", "MOD_PROJECTILE_SPLASH" ];
    var_37 = var_7 == "shield" && !scripts\engine\utility::array_contains( var_36, var_3 );

    if ( var_15 && !istrue( var_35 ) && !istrue( var_0.inlaststand ) && !var_37 )
    {
        var_38 = var_0 scripts\mp\gametypes\br_public::damagearmor( var_2 );
        var_39 = int( var_2 - var_38 );
        var_14 = var_39;
        var_12 = var_12 - var_39;
        var_0.tookvesthit = 1;
        ...
        if ( isplayer( var_1 ) )
        {
            ...
            if ( _id_1229C( self ) )
                var_1 scripts\mp\utility\stats::incpersstat( "damage", var_39 );
            else if ( isdefined( level.toggle_apc_objective ) )
                var_1 [[ level.toggle_apc_objective ]]( var_39 );
        }
        else if ( isdefined( var_1 ) && istrue( var_1.allownonplayerdamageidflags ) )
            armorvest_sethit( var_1 );
    }

    var_40 = scripts\mp\equipment\trophy_system::trophy_modifieddamage( var_1, var_0, var_4.basename, var_2, var_12 );
    var_2 = var_40[0];
    var_12 = var_40[1];

    if ( var_0 scripts\mp\heavyarmor::hasheavyarmor() )
    {
        var_40 = scripts\mp\heavyarmor::heavyarmormodifydamage( var_0, var_1, var_2, var_12, var_3, var_4.basename, var_5, var_6, var_7, var_8, var_9 );
        var_13 = var_40[0] > 0;
        var_2 = var_40[1];
        var_12 = var_40[2];
    }
    ...
    {
        var_40 = scripts\mp\lightarmor::lightarmor_modifydamage( var_0, var_1, var_2, var_12, var_3, var_4.basename, var_5, var_6, var_7, var_8, var_9 );
        var_14 = var_40[0] > 0;
        var_2 = var_40[1];
        var_12 = var_40[2];
    }
    ...
    if ( isplayer( var_1 ) || isdefined( var_1 ) && istrue( var_1.allownonplayerdamageidflags ) )
    {
        var_41 = var_0 scripts\mp\gametypes\br_public::hasarmor();
        var_42 = var_0 scripts\mp\gametypes\br_public::hashelmet();
    ...
    if ( istrue( var_0.inlaststand ) && getdvarfloat( "scr_player_lastStandHealthScalar", 0 ) > 0 )
    {
        ...
        if ( isdefined( level.spawner_dropoff ) )
        {
            var_44 = scripts\cp_mp\utility\damage_utility::packdamagedata( var_1, var_0, var_2, var_4, var_3, var_8 );
            var_43 = self [[ level.spawner_dropoff ]]( var_44 );
        }
...
spawnheliactorsfunc( var_0, var_1, var_2 )
{
...
spawnhumandogtags( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_4 ) && var_4 scripts\mp\utility\killstreak::isjuggernaut() && scripts\mp\utility\game::getgametype() == "br" )
        var_6 = scripts\mp\gametypes\br_jugg_common::module_unpause_funcs();
    ...
    switch ( var_5 )
    {
        ...
        case "mg":
        case "rifle":
            if ( scripts\mp\utility\weapon::relic_nuketimer_waitforcompleteobjectives( var_0.basename ) && scripts\mp\utility\game::getgametype() == "br" )
                var_1 = min( 50, var_1 );
            else
                var_1 = min( 20, var_1 );
...
spawnoutofboundstrigger( var_0, var_1, var_2 )
{
    if ( !isdefined( var_1 ) )
        return var_0;
...
relic_landlocked_do_explosion( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_0 ) && isplayer( var_0 ) && ( !isalive( var_0 ) || scripts\mp\utility\player::relic_focusfire_modifyplayerdamage( var_0 ) ) )
    {
...
redshirt_drop_off_behavior( var_0, var_1 )
{
...
_id_12600( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) && isdefined( var_0 ) )
    {
        if ( var_4 & level.playerplunderevent )
            var_5 = "lHandWeap";
        else
            var_5 = "rHandWeap";

        if ( !isdefined( var_1.unset_ignoreall_after_notify ) )
            var_1.unset_ignoreall_after_notify = [];

        var_6 = "" + var_0 getentitynumber();
        var_7 = gettime();

        foreach ( var_13, var_9 in var_1.unset_ignoreall_after_notify )
        {
            foreach ( var_12, var_11 in var_9 )
            {
                if ( ( var_7 - var_11.time ) / 1000 > 0.1 )
                {
                    var_1.unset_ignoreall_after_notify[var_13] = scripts\engine\utility::array_remove_key( var_1.unset_ignoreall_after_notify[var_13], var_12 );

                    if ( var_1.unset_ignoreall_after_notify[var_13].size == 0 )
                        var_1.unset_ignoreall_after_notify = scripts\engine\utility::array_remove_key( var_1.unset_ignoreall_after_notify, var_13 );
                }
            }
        }

        if ( !isdefined( var_1.unset_ignoreall_after_notify[var_5] ) )
            var_1.unset_ignoreall_after_notify[var_5] = [];

        if ( !isdefined( var_1.unset_ignoreall_after_notify[var_5][var_6] ) )
        {
            var_1.unset_ignoreall_after_notify[var_5][var_6] = spawnstruct();
            var_1.unset_ignoreall_after_notify[var_5][var_6].time = var_7;
            var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter = [];
        }

        var_14 = multieventdebug( var_1, var_2 );
        var_15 = var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter;

        if ( var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter.size >= var_14 )
        {
            if ( getdvarint( "scr_spread_use_highest_damage_pellets", 0 ) )
            {
                foreach ( var_18, var_17 in var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter )
                {
                    if ( var_3 > var_17 )
                    {
                        var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter[var_18] = var_3;
                        var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter = scripts\engine\utility::array_sort_with_func( var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter, ::rear_minigun_attack_max_cooldown );
                        return var_3 - var_17;
                    }
                }
            }
        ...
        {
            var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter = scripts\engine\utility::array_add( var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter, var_3 );
            var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter = scripts\engine\utility::array_sort_with_func( var_1.unset_ignoreall_after_notify[var_5][var_6].unset_heavy_hitter, ::rear_minigun_attack_max_cooldown );
        }
    }
...
rear_minigun_attack_max_cooldown( var_0, var_1 )
{
    return var_0 < var_1;
}

multieventdebug( var_0, var_1 )
{
...
applystoppingpower( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_6 == 2 )
    {
        if ( _id_127BC( var_0, var_1, var_2, var_3 ) )
            return var_5;
        else
            return 0.9 * var_5;
    }
...
_id_127BC( var_0, var_1, var_2, var_3 )
{
...
killstreakdamagefilter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( level.leader_intro_dialogue ) )
        var_5 = [[ level.leader_intro_dialogue ]]( var_0, var_1, var_2, var_3, var_4 );
...
handlefriendlyfiredamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13 )
{
    ...
    if ( level.friendlyfire != 0 )
    {
        if ( level.maxallowedteamkills == -1 )
            ...
            var_14 = istrue( var_2.relic_amped_is_player_valid_to_explode ) || istrue( var_2.isdefusing ) || istrue( var_2.isplanting );

        var_15 = relic_amped_pause( var_1 );
    ...
    else if ( level.friendlyfire == 1 )
    {
        ...
        setup_soldier_stealth( var_2, var_1, var_3, var_5 );
...
spawnpointangles( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
    {
        if ( redshirt_drop_off_behavior( var_0, var_4 ) )
        {
            if ( var_2.health > 0 && var_3 >= var_2.health )
                var_3 = var_2.health - 1;
        }
        else if ( isdefined( var_0._id_125E6 ) )
        {
            if ( !isdefined( var_1._id_125E1 ) )
                var_1._id_125E1 = [];

            var_5 = "" + var_2 getentitynumber();
            var_6 = gettime();
            var_1._id_125E1[var_5] = spawnstruct();
            var_1._id_125E1[var_5].time = var_6;
            var_1._id_125E1[var_5].playerpowershud = var_0._id_125E6.basename;
        }
        else if ( isdefined( var_1._id_125E1 ) )
        {
            var_6 = gettime();

            foreach ( var_9, var_8 in var_1._id_125E1 )
            {
                if ( var_6 != var_8.time )
                    var_1._id_125E1 = scripts\engine\utility::array_remove_key( var_1._id_125E1, var_9 );
            }

            var_9 = "" + var_2 getentitynumber();

            if ( scripts\engine\utility::array_contains_key( var_1._id_125E1, var_9 ) && var_1._id_125E1[var_9].playerpowershud == var_0.basename )
            {
                var_3 = 0;
                var_1._id_125E1 = scripts\engine\utility::array_remove_key( var_1._id_125E1, var_9 );
            }

            if ( var_1._id_125E1.size == 0 )
                var_1._id_125E1 = undefined;
        }
    }
...
spawnanglemax( var_0, var_1, var_2, var_3, var_4 )
{
    if ( scripts\mp\utility\game::isanymlgmatch() && isdefined( var_0 ) && isplayer( var_0 ) && !nullweapon( var_3 ) && scripts\mp\utility\weapon::isprimaryweapon( var_3 ) && scripts\engine\utility::isbulletdamage( var_2 ) && spawn_wp( var_4 ) )
    {
...
spawnpoint_clearspawnpoint( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
            var_3 = var_0 scripts\mp\juggernaut::revive_friendly();
    }

    return var_3;
}

spawnprojectile( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_3;
    ...
    if ( isdefined( var_0 ) && var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() )
    {
        if ( var_2 scripts\mp\utility\killstreak::isjuggernaut() )
            var_5 = var_2 scripts\mp\juggernaut::revive_or_disconnect_monitor( var_3, var_4 );
    }

    return var_5;
}

spawnposition( var_0, var_1 )
{
    var_2 = var_1;
    var_3 = var_0 scripts\cp_mp\utility\player_utility::getvehicle();

    if ( isdefined( var_3 ) )
        var_2 = scripts\cp_mp\vehicles\vehicle_damage::_id_12F19( var_3, var_0, var_1 );

    return var_2;
}

spawnloot( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_3;
    ...
    if ( isdefined( var_4 ) && var_4 == "MOD_CRUSH" )
    {
        if ( isdefined( var_0 ) && isdefined( var_1 ) && var_0 == var_1 && var_1 scripts\mp\utility\killstreak::isjuggernaut() && var_2 scripts\mp\utility\killstreak::isjuggernaut() )
            var_5 = var_2 scripts\mp\juggernaut::revive_icon_color_keep( var_3 );
    }
...
{
    var_3 = spawninfo( var_3, var_6 );
    var_3 = spawninsafehouse( var_3, var_6 );
    var_3 = spawnanglemax( var_1, var_3, var_5, var_6, var_9 );
    var_3 = spawnpoint_clearspawnpoint( var_2, var_3, var_5 );
    var_3 = spawnprojectile( var_0, var_1, var_2, var_3, var_5 );
    var_3 = spawnposition( var_2, var_3 );
    var_3 = spawnloot( var_0, var_1, var_2, var_3, var_5 );
    var_3 = spawnpointangles( var_6, var_1, var_2, var_3, var_5 );
    ...
    {
        if ( istrue( var_6.isalternate ) && scripts\mp\weapons::register_caves_spawners( var_6.underbarrel ) )
        {
...
filterdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( scripts\cp_mp\vehicles\vehicle::_id_12FAF( var_0, var_2, var_4, var_5 ) )
...
logattacker( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2.owner ) )
    {
        ...
        if ( var_10 && !istrue( var_2.owner._id_12E58 ) && !isdefined( self.attackerdata[var_2.owner.guid] ) )
...
handledamagefeedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( isdefined( var_12 ) && var_12 != var_2 && var_3 + var_8 + var_9 > 0 && ( !isdefined( var_6 ) || var_6 != "shield" ) )
    {
        ...
        else if ( armorvest_wasbroke( var_1 ) && var_2 scripts\mp\utility\perk::_hasperk( "specialty_br_reinforced" ) )
            var_13 = "hitarmorreinforcedbreak";
        else if ( armorvest_washit( var_1 ) && var_2 scripts\mp\utility\perk::_hasperk( "specialty_br_reinforced" ) )
            var_13 = "hitarmorreinforced";
        else if ( var_8 > 0 && var_2 scripts\mp\utility\perk::_hasperk( "specialty_br_reinforced" ) )
            var_13 = "hitarmorreinforced";
        ...
        if ( var_13 == "hitarmorreinforcedbreak" )
        {
            var_17 = 1;

            if ( var_16 == "standardspread" )
                var_16 = "standardspreadreinforcedarmor";
            else
                var_16 = "standardreinforcedarmor";
        }
        else if ( var_13 == "hitarmorlightbreak" )
        {
            var_17 = 1;
        ...
        var_18 = !repair_grill_fixing_long_sfx( var_5 ) && scripts\mp\utility\damage::isheadshot( var_6, var_4, var_1 );
        var_19 = 1;
        var_20 = var_4 == "MOD_MELEE";
        var_21 = "" + var_2 getentitynumber();
        var_22 = 0;

        if ( !var_17 && repair_grill_fixing_long_sfx( var_5 ) && isdefined( var_12.unset_ignoreall_after_notify ) )
        {
            foreach ( var_24 in var_12.unset_ignoreall_after_notify )
            {
                if ( isdefined( var_24[var_21] ) && var_24[var_21].unset_heavy_hitter.size > 1 )
                    var_22 = 1;
            }
        }
...
lethalequipmentdamagemod( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( level.shallowwaterfuncs ) )
        var_3 = var_3 * [[ level.shallowwaterfuncs.getlethaldamagemulitplier ]]( var_0 );

    loggrenadedata( var_0, var_1, var_2, var_3, var_5, var_6 );
    var_1 scripts\common\utility::_id_12C2C( level.smoke_screen, scripts\mp\utility\weapon::getweaponrootname( var_6 ), "damage", min( var_2.health, var_3 ), -1, var_6 );
    return var_3;
}
...
playerkilled_initdeathdata( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    var_12.create_vehicle_omnvars_data = undefined;
    return var_12;
}
...
playerkilled_fixupattacker( var_0 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            if ( istrue( var_0.victim._id_1262F ) && isdefined( var_0.victim.attackerdata[var_2.guid].inflictor ) )
    ...
    if ( isdefined( var_0.attacker ) )
    {
        if ( isdefined( var_0.attacker.code_classname ) && var_0.attacker.code_classname == "script_vehicle" && isdefined( var_0.attacker.owner ) )
            var_0.attacker = var_0.attacker.owner;

        if ( isdefined( var_0.attacker.code_classname ) && var_0.attacker.code_classname == "misc_turret" && isdefined( var_0.attacker.owner ) )
        {
        ...
        if ( isdefined( var_0.attacker.code_classname ) && var_0.attacker.code_classname == "script_model" && isdefined( var_0.attacker.owner ) )
        {
            var_0.attacker = var_0.attacker.owner;
...
playerkilled_precalc( var_0 )
{
    ...
    var_0.create_vehicle_omnvars_data = scripts\mp\utility\player::relic_focusfire_modifyplayerdamage( var_2 );
}
...
playerkilled_sharedlogic_early( var_0 )
{
    ...
    if ( scripts\mp\utility\weapon::relic_landlocked_clear_message_on_player_return( var_3 ) && isdefined( var_4 ) && var_4.basename == "none" )
    {
    ...
    var_2 scripts\mp\equipment\molotov::spawnziptie();
    var_2 scripts\mp\equipment\throwing_knife_mp::_id_129B6();
    ...
    if ( var_1 != var_2 )
    {
        if ( isdefined( var_1.petwatch ) )
        {
            ...
            else if ( var_2 wait_spawn_sidehouse_trucks( var_6, var_3 ) )
                var_1 scripts\cp_mp\pet_watch::any_alive_player_in_kill_zone_or_under_bridge_zone();
        }
        else if ( isdefined( var_2.unset_relic_noks ) )
    ...
    if ( scripts\mp\utility\game::isteamreviveenabled() && scripts\mp\flags::gameflag( "prematch_done" ) )
    {
        if ( var_6 == "MOD_FALLING" && var_2 scripts\mp\teamrevive::isvalidrevivetriggerspawnposition() )
            var_2 scripts\mp\teamrevive::_id_1221D();
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        {
            var_2 scripts\cp\helicopter\chopper_boss::_id_1279F( "alive_in_gas" );
            var_2 scripts\cp\helicopter\chopper_boss::_id_1279F( "alive_not_downed" );

            if ( istrue( level.br_prematchstarted ) && !scripts\mp\gametypes\br_public::isplayeringulag() )
                scripts\mp\gametypes\br_analytics::clear_bomb_vest_controller_holder( self, "player_death" );
        }
    }
    ...
    if ( !var_7 )
    {
        ...
        else if ( isdefined( var_1.classname ) && ( var_1.classname == "trigger_hurt" || var_1.classname == "worldspawn" ) )
    ...
    if ( !var_16 )
    {
        if ( !isdefined( level.spawndistancemin ) || [[ level.spawndistancemin ]]( var_2 ) )
    ...
    if ( isdefined( var_0.idflags ) && var_0.idflags & level.idflags_penetration && !( var_0.idflags & level.playerplunderdrop ) )
    {
        if ( isdefined( var_1.bulletkillsinaframecount ) && var_1.bulletkillsinaframecount == 0 )
        {
            ...
            if ( isplayer( var_1 ) )
                var_1 thread scripts\mp\utility\points::obj_pregame( "penetration_kill" );
        }
    }
    ...
    if ( isdefined( var_0.inflictor ) && ( istrue( var_0.inflictor.resetscorefeedcontrolomnvar ) || istrue( var_0.inflictor.resetposition ) ) )
        var_17 = "MOD_CRUSH";
    ...
    if ( level.gametype == "br" )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            var_19 = scripts\mp\gametypes\br_public::munitions_override_time( var_2.team, var_2.squadindex );
        ...
        if ( isdefined( var_1 ) && isplayer( var_1 ) )
        {
            var_20 = scripts\mp\gametypes\br_public::munitions_override_time( var_1.team, var_1.squadindex );
        ...
        if ( var_18.size > 0 )
        {
            var_21 = scripts\engine\utility::ter_op( scripts\cp_mp\vehicles\vehicle::_id_12EBE( var_0 ), "MOD_EXPLOSIVE", var_17 );

            if ( getdvarint( "scr_br_alt_mode_zxp", 0 ) || getdvarint( "scr_br_alt_mode_gxp", 0 ) )
                var_21 = scripts\mp\gametypes\br_gametype_zxp::spawn_carriables_from_scriptables_total_percentage( var_0, var_21 );
...
playerkilled_logkill( var_0 )
{
    ...
    var_6 = var_0.meansofdeath;
    var_7 = var_0.lifeid;
    var_2 scripts\common\utility::_id_12C2C( level.explode_fx, var_1 );

    if ( !istrue( level.ignorescoring ) )
        var_2 scripts\common\utility::_id_12C2C( level.smoke_door, var_7, var_1, var_0.damage, var_6, var_5, var_0.primaryweapon, var_0.hitloc );
    ...
    if ( isdefined( level.matchrecording_logeventmsg ) && isdefined( var_3 ) && isplayer( var_3 ) && scripts\engine\utility::isbulletdamage( var_6 ) )
    {
        ...
        if ( !isdefined( var_2.init_trap_room_debug ) )
        {
            var_2.init_trap_room_debug = 0;
            var_2.init_trap_room = 0;
        }

        var_2.init_trap_room_debug = var_2.init_trap_room_debug + var_16;
        var_2.init_trap_room++;
...
playerkilled_sharedlogic_late( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
        scripts\mp\gametypes\br_analytics::branalytics_down( var_0.attacker, var_0.victim, var_0.objweapon, var_0.deathtype, var_0.meansofdeath );
...
playerkilled_handlecorpse( var_0 )
{
    ...
    if ( !isdefined( self.nocorpse ) && !istrue( var_2._id_1232D ) )
        var_2.body = var_2 cloneplayer( var_0.deathanimduration, var_1 );

    if ( !isdefined( self.nocorpse ) && !istrue( var_2._id_1232D ) && isdefined( var_2.body ) )
    {
    ...
    else if ( isdefined( var_2.nocorpse ) && !istrue( var_2._id_1232D ) )
    {
...
_startragdoll( var_0, var_1, var_2 )
{
    ...
    var_7 = wait_spawn_sidehouse_trucks( var_1, var_2 );
    var_8 = undefined;
    ...
    if ( isdefined( var_6 ) )
    {
        ...
        if ( var_11 || var_12 )
        {
            ...
            var_0.set_relic_hideobjicons = scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F99( var_6, var_8 );
        }
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            var_0 thread ai_ascender_takeascender( var_6, var_8, var_9, var_10, var_5, var_4 );
            var_0 notify( "cancel_delete_corpse" );
            scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F7E( var_0, var_6, var_8 );
        }
        else
        {
            if ( !var_0 isragdoll() )
            ...
            var_0 thread activate_subway_track_trigger_hurt( var_9, var_10, var_5, var_4 );
        }
    }
}

activate_subway_track_trigger_hurt( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
...
ai_ascender_takeascender( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self;
    ...
    if ( isdefined( var_6 ) )
    {
        if ( isdefined( var_6.set_relic_hideobjicons ) && isdefined( var_0 ) )
        {
            var_11 = ( 0, 0, 0 );
            var_12 = scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F99( var_0, var_1 );
            var_11 = var_12.origin - var_6.set_relic_hideobjicons.origin;
        ...
        var_6 thread activate_subway_track_trigger_hurt( var_2, var_3, var_4, var_5 );
    }
}

adsoff( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0 ) )
        return;
...
playerkilled_deletecorpseoutofvehicle( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_1 scripts\engine\utility::_id_13141( var_3, "death" );

    if ( isdefined( var_0 ) )
        var_0 delete();
}

wait_spawn_sidehouse_trucks( var_0, var_1 )
{
    if ( var_0 != "MOD_CRUSH" )
        return 0;
...
playerkilled_killcam( var_0 )
{
    ...
    if ( getdvarint( "scr_killcam_on_down", 1 ) && isdefined( var_1.victim.scriptedspawnpointsonmigration ) )
    {
        var_1 = var_1.victim.scriptedspawnpointsonmigration;
        var_1.victim.scriptedspawnpointsonmigration = undefined;
    ...
    if ( isdefined( level.spawnflags_check ) )
    ...
    if ( !( isdefined( var_3.cancelkillcam ) && var_3.cancelkillcam ) && var_1.dokillcam && level.killcam && game["state"] == "playing" && !var_3 scripts\mp\utility\player::isusingremote() && !level.showingfinalkillcam )
    {
        ...
        if ( isdefined( level.trackendangeredobjs ) )
            [[ level.trackendangeredobjs ]]();
    }
}

playerkilled_spawn( var_0 )
{
    if ( isdefined( level.spawndomplates ) && [[ level.spawndomplates ]]( var_0, 1 ) )
        return;
...
handlefriendlyfiredeath( var_0, var_1 )
{
    ...
    if ( var_3 > 0 )
    {
        ...
        if ( var_0 scripts\mp\utility\player::isusingremote() )
            var_0 thread scripts\mp\utility\damage::_id_12823();
        else
            var_0 thread scripts\mp\utility\damage::_id_12822();
    }
...
handleinlaststanddeath( var_0 )
{
    ...
    if ( isdefined( self.scripted_laser_func ) )
        self.scripted_laser_func wait_for_next_hack_complete();

    if ( isdefined( self.scripted_laser_func ) && var_0.attacker != self.scripted_laser_func )
    {
        thread scripts\cp\helicopter\chopper_boss::onplayerkilled( self.scripted_laser_func, self.scripted_laser_func, 0, var_0.damageflags, self.search_acceleration, self.searchcircleorigin, var_0.hitloc, self.scriptednode, self.scriptedphysicaldofenabled );
        self.scripted_laser_func thread scripts\mp\rank::scoreeventpopup( "kill_confirmed" );
    }
    ...
    self.scripted_laser_func = undefined;
    self.search_acceleration = undefined;
    self.searchcircleorigin = undefined;
    self.scriptednode = undefined;
    self.scriptedphysicaldofenabled = undefined;
}
...
handlenormaldeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !istrue( level.disablestattracking ) )
    {
        ...
        var_5.scriptedspawnpointarray = undefined;
        ...
        if ( isdefined( var_2 ) && istrue( var_2.isequipment ) )
        {
            switch ( var_2.equipmentref )
            {
                ...
                case "equip_throwing_knife":
                    ...
                    var_1 scripts\cp_mp\pet_watch::animscripted_loop_relative();
                    break;
                case "equip_c4":
    ...
    if ( !istrue( var_8 ) && !isfriendlyfire( var_5, var_1 ) )
    {
        if ( !istrue( level.ignorescoring ) )
        {
            var_11 wait_for_next_hack_complete();
    ...
    if ( !istrue( var_11.pers["ignoreWeaponMatchBonus"] ) && ( scripts\mp\utility\weapon::iscacprimaryweapon( var_3 ) || scripts\mp\utility\weapon::iscacsecondaryweapon( var_3 ) ) )
    {
        ...
        if ( var_11.pers["weaponMatchBonusKills"] > scripts\mp\weaponrank::modemayconsiderplayerdead() )
        {
        ...
        else
        {
            ...
            if ( !var_13 )
            {
                ...
                var_15.tread_sfx = var_11.pers["killsPerWeapon"].size;
    ...
    if ( !var_6 && !scripts\mp\utility\weapon::relic_landlocked_clear_message_on_player_return( var_2 ) || scripts\mp\utility\points::relic_amped_on_ai_kill( var_3 ) )
    {
    ...
    if ( istrue( var_1.inlaststand ) )
        var_1 thread scripts\mp\laststand::tr_playerdisconnect( var_7 );
    ...
    if ( isdefined( self.attackers ) )
    {
        foreach ( var_24 in self.attackers )
        {
            ...
            if ( isdefined( self.scripted_laser_func ) && self.scripted_laser_func == var_24 )
                continue;
    ...
    if ( level.teambased )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "squadAsTeamEnabled" ) )
            var_32 = level [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "squadAsTeamEnabled" ) ]]();

        if ( istrue( var_32 ) && getdvarint( "scr_uav_for_squad_only", 1 ) && isdefined( var_1.squadindex ) )
            var_31 = var_1.squadindex;
        else if ( isdefined( var_1.team ) )
            var_31 = var_1.team;

        if ( isdefined( var_31 ) && isdefined( level.uavmodels ) && isdefined( level.uavmodels[var_31] ) && level.uavmodels[var_31].size > 0 )
        {
            var_33 = [];

            foreach ( var_35 in level.uavmodels[var_31] )
            {
                if ( isdefined( var_35 ) && isdefined( var_35.owner ) && var_35.owner != var_1 && !scripts\engine\utility::array_contains( var_33, var_35.uavtype ) )
                {
                    var_36 = var_35.uavtype + "_assist";
                    var_37 = undefined;

                    if ( !isdefined( var_35.br_updategameevents ) )
                        var_35.br_updategameevents = 0;

                    var_38 = scripts\engine\utility::ter_op( var_35.uavtype == "directional_uav", 15, 10 );

                    if ( var_35.br_updategameevents < var_38 )
                        var_35.owner thread scripts\mp\utility\points::giveunifiedpoints( var_36, undefined, var_37, undefined, undefined, undefined, var_35.streakinfo );
                    else
                        var_35.owner thread scripts\mp\utility\points::obj_pregame( var_36, var_37 );

                    var_35.br_updategameevents++;

                    switch ( var_35.uavtype )
                    {
                        case "uav":
                            var_35.owner scripts\mp\utility\stats::incpersstat( "killstreakUAVAssists", 1 );
                            break;
                        case "directional_uav":
                            var_35.owner scripts\mp\utility\stats::incpersstat( "killstreakAUAVAssists", 1 );
                            break;
                    }

                    var_33[var_33.size] = var_35.uavtype;
                    scripts\cp\helicopter\chopper_boss::processuavassist( var_35.owner, var_35.uavtype );
                    var_35.owner scripts\mp\utility\script::bufferednotify( "update_uav_assist_buffered" );
                    var_35.owner combatrecordkillstreakstat( var_35.uavtype );
                }
            }
        }
        ...
        {
            foreach ( var_41 in level.supportdrones )
            {
                if ( level.teambased && var_41.team == var_1.team && var_41.owner != var_1 )
                {
                    if ( isdefined( var_41.enemiesmarked ) && isdefined( var_41.enemiesmarked[self getentitynumber()] ) )
                        var_41.owner thread scripts\mp\utility\points::giveunifiedpoints( var_41.streakinfo.streakname + "_assist" );
                }

                if ( var_41.helperdronetype == "scrambler_drone_guard" )
                {
                    if ( var_1 != var_41.owner )
                    {
                        var_36 = var_41.streakinfo.streakname + "_assist";

                        if ( !isdefined( var_41.br_updategameevents ) )
                            var_41.br_updategameevents = 0;

                        if ( var_41.br_updategameevents < 10 )
                            var_41.owner thread scripts\mp\utility\points::giveunifiedpoints( var_36, undefined, undefined, undefined, undefined, undefined, var_41.streakinfo );
                        else
                            var_41.owner thread scripts\mp\utility\points::obj_pregame( var_36 );

                        var_41.br_updategameevents++;
                        var_41.owner scripts\mp\utility\stats::incpersstat( "killstreakCUAVAssists", 1 );
                        continue;
                    }

                    if ( isdefined( var_41.owner ) && var_1 == var_41.owner )
                    {
                        if ( !istrue( var_1._id_11CAE ) )
                        {
                            var_1 scripts\cp\helicopter\chopper_boss::_id_11CB0( "t9_ch_global_kill_scrambled_enemies_s1", 1 );
                            continue;
                        }

                        var_1._id_11CAE = undefined;
                    }
                }
            }
        }

        _attachmentblocks::callback( var_1, self );

        if ( isdefined( var_1.team ) && isdefined( level.activewpzones ) && level.activewpzones.size > 0 )
        {
            var_43 = level.activewpzones[0];
            var_44 = var_43.owner;
            var_45 = var_43.team;
            ...
            if ( var_1.team == var_45 && var_1 != var_44 )
            {
                if ( istrue( var_5.wpdisorient ) || istrue( var_5.wpburning ) )
                {
                    ...
                    if ( !isdefined( var_43.br_updategameevents ) )
                        var_43.br_updategameevents = 0;

                    if ( var_43.br_updategameevents < 15 )
                        var_44 thread scripts\mp\utility\points::giveunifiedpoints( var_36, undefined, undefined, undefined, undefined, undefined, var_43.streakinfo );
                    else
                        var_44 thread scripts\mp\utility\points::obj_pregame( var_36 );

                    var_43.br_updategameevents++;
                    var_44 scripts\mp\utility\stats::incpersstat( "killstreakWhitePhosphorousKillsAssists", 1 );
                }
            }
        }
    }
...
resetplayervariables()
{
    ...
    self.get_destinations_in_current_circle = 0;
    self.spawn_dwn_twn_enemy_sentry = 0;
    self._id_12362 = 0;
    self.phonehint = 0;
    self.do_complete_escape_zoom_out = undefined;

    if ( !isdefined( self.brplayerhudoutlineupdatefromnotify ) )
        self.topteam = 0;

    self.run_died_poorly_funcs = undefined;
    self.run_elevator_spawners_event = undefined;
    self.run_default_threads = undefined;
    self._id_11959 = undefined;
    self.primarysecondarykillmissiontriggered_s5 = undefined;
    self._id_132DC = undefined;
    self.initextractionlocations = undefined;
    self.server_activate = undefined;
    self._id_12A33 = undefined;
    self.pistolkillthislife = undefined;
    self.assaultriflekillsthislife = undefined;
    self.usedstimthislife = undefined;
    self.scripted_laser_func = undefined;
    self.scriptednode = undefined;
    self.scriptedphysicaldofenabled = undefined;
...
addattacker( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_0.attackerdata[var_1.guid].spawnhandled = var_1 scripts\mp\events::mine_caves_ambush( 0, var_0, var_3, var_9, var_2 );
    var_0.attackerdata[var_1.guid].spawnheight = var_1 scripts\mp\events::mine_caves_ambusher( 0, var_0, var_3, var_9, var_2 );
...
addattackerkillstreak( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    var_0.attackerdata[var_2.guid].spawnhandled = 0;
    var_0.attackerdata[var_2.guid].spawnheight = 0;
...
finishplayerdamagewrapper( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_1 ) && isplayer( var_1 ) )
    {
        if ( _id_1229C( self ) )
        {
            ...
            if ( !isdefined( var_1.get_player_aggro_score ) )
                var_1.get_player_aggro_score = var_13;
            else
                var_1.get_player_aggro_score = var_1.get_player_aggro_score + var_13;

            if ( scripts\mp\codcasterclientmatchdata::shouldlogcodcasterclientmatchdata() )
            {
                if ( isplayer( var_1 ) )
                {
                    var_1 scripts\common\utility::_id_12C2C( level.smoke_screen, scripts\mp\utility\weapon::getweaponrootname( var_5 ), "damage", min( self.health, var_2 ), -1, var_5 );
            ...
            var_1 [[ level.toggle_apc_objective ]]( var_13 );
    }

    if ( scripts\mp\utility\weapon::iskillstreakweapon( var_5 ) )
    {
        if ( scripts\mp\utility\killstreak::getkillstreaknamefromweapon( var_5 ) == "precision_airstrike" && istrue( level.resetstreamerposhint ) )
            return;
    }
    ...
    else
    {
        ...
        if ( isplayer( self ) )
        {
            ...
            var_16 = !( var_4 != "MOD_TRIGGER_HURT" && isdefined( self.relic_mythic_modifyplayerdamage ) );
...
callback_playerlaststand( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !istrue( var_9 ) )
    {
        ...
        if ( isdefined( level.spawnchoppers ) && !self [[ level.spawnchoppers ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 ) )
            return 0;
    }

    if ( isdefined( level.triggeraddobjectivetext ) )
        self [[ level.triggeraddobjectivetext ]]();
    ...
    if ( isdefined( var_1 ) && var_1.classname != "worldspawn" )
    {
        ...
        self.vo_use_computer = 1;

        if ( isplayer( var_1 ) && var_1 != self )
        {
            self.scripted_laser_func = var_1;
            self.search_acceleration = var_11.meansofdeath;
            self.searchcircleorigin = var_4;
            var_1 thread scripts\mp\events::br_practice_match( var_10, self, var_4, var_3, var_0, var_11 );
            self.scriptednode = var_1.modifiers["mask"];
            self.scriptedphysicaldofenabled = var_1.modifiers["mask2"];
        }
        ...
        if ( getdvarint( "scr_killcam_on_down", 1 ) )
            self.scriptedspawnpointsonmigration = var_11;
        ...
        if ( !var_11.isfriendlyfire && var_1 != self )
        {
            if ( scripts\mp\utility\game::getgametype() == "br" )
            {
                if ( isplayer( var_1 ) && var_1 != self )
                {
                    ...
                    if ( var_13 )
                    {
                        if ( isdefined( var_1.binoculars_addtolosqueue ) )
                            var_1.binoculars_addtolosqueue++;
                    }
    ...
    scripts\common\utility::binoculars_showtargetmarker( 0 );

    if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
        scripts\mp\gametypes\br_plunder::weapon_xp_iw8_ar_asierra12( self, 0, 1 );

    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        scripts\mp\gametypes\br_analytics::branalytics_down( var_1, self, var_4, "downed", var_3 );
...
damageshellshockandrumble( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !isai( self ) && scripts\common\utility::getdamagetype( var_2 ) != "bullet" )
    {
        ...
        if ( isdefined( var_0 ) && istrue( var_0.resetscorefeedcontrolomnvar ) )
        {
            self playsound( "train_veh_impact_body" );

            if ( isdefined( level._id_1332F._id_12ACE ) )
            {
                var_6 = level._id_1332F._id_12ACE[0].set_relic_doomslayer;
...
gamemodemodifyplayerdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( isdefined( var_2 ) && isplayer( var_2 ) && isalive( var_2 ) )
    {
        ...
        if ( istrue( level.open_teleport_room_door ) && scripts\mp\utility\game::getgametype() == "infect" && isdefined( var_5 ) )
        {
...
monitordamageoneshot( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14 )
{
    ...
    if ( isdefined( var_1 ) && !scripts\mp\utility\entity::isgameparticipant( var_1 ) && !istrue( var_1.trial_other_team ) )
        return 1;
    ...
    if ( !istrue( self._id_12337 ) && scripts\mp\utility\damage::non_player_should_ignore_damage( var_1, var_9, var_10, var_4 ) )
        return 1;
...
onkillstreakkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    thread scripts\mp\events::_id_1197E( var_10 );
...
setdeathtimerlength( var_0 )
{
    ...
    if ( var_1 scripts\mp\playerlogic::mayspawn() && !level.handlefocusfire )
    {
...
{
    if ( scripts\mp\weapons::relic_squadlink_add_visionset( var_3 ) )
        enqueuecorpsetablefunc( "8bitDeath", scripts\mp\weapons::stopcirclesatgameend );
    else if ( scripts\mp\weapons::relic_squadlink_flash_squadlink_icon( var_3 ) )
        enqueuecorpsetablefunc( "teslaDeath", scripts\mp\weapons::stopdragonsbreath );
}
...
_id_1229C( var_0 )
{
    if ( istrue( level.handle_ground_spawning ) )
        return 0;

    if ( isdefined( level.handle_just_keep_moving ) && ![[ level.handle_just_keep_moving ]]( var_0 ) )
        return 0;

    return 1;
}

setup_soldier_stealth( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_1 ) || !isdefined( var_3 ) )
        return;

    var_4 = var_2 >= var_0.health;
    var_1 scripts\common\utility::_id_12C2C( level.smoke_screen, scripts\mp\utility\weapon::getweaponrootname( var_1.currentweapon ), "friendly_fire_damage", int( min( var_2, var_0.health ) ), -1, var_1.currentweapon );
