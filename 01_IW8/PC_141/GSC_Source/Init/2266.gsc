...
technical_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12F53( "technical", "single", [ "driver", "fl_rear", "fr_rear", "bl_rear", "br_rear" ] );
}

_id_1295E()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "technical", 1 );
    var_0.id = 0;
...
_id_1295C()
{
    var_0 = _applydvarstosettings::_id_12EC9( "technical", 1 );
    var_0.brc130airdropcratedestroycallback = 1.16666;
    var_0.getignoreprops = 0.95833;
    var_0.get_next_open_stop = 350;
    var_0.get_next_rein_group = 525;
    var_0.get_next_cypher_id_from_pool = 875;
    var_0.get_node_closest_to_target_loc = 11.25;
    var_0.get_num_dogtag_in_kill_zone_or_under_bridge_zone = 45;
    var_0.get_next_track_index = 90;
...
_id_1295D()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "technical", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "technical" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "technical" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "technical", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "technical", ::technical_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "technical_mp", 3 );
}
...
technical_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "technical", var_0 );
...
technical_enterstart( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.set_relic_doubletap_params_internal ) )
        var_3.set_relic_doubletap_params_internal hide();
}
...
technical_exitendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.set_relic_doubletap_params_internal ) )
        var_3.set_relic_doubletap_params_internal show();
