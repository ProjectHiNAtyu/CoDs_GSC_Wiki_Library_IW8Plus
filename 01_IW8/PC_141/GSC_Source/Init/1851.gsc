...
main( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( !scripts\mp\spawnlogic::generatinglosdata() )
        {
            ...
            if ( isdefined( var_4 ) )
            {
                if ( level.silo_door_cover_spawners == 1 )
                {
                    if ( var_4 == "10v10" )
                        continue;
                    else if ( var_4 == "6v6" )
...
onjuggernaut()
{
    ...
    {
        self.carryobject thread setdropped();
        self switchtoweapon( scripts\mp\juggernaut::retreat_vehicle_collision_clear() );
    }
}
...
createcarryobject( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_6.update_player_enemy_on_death = [];
...
_id_11B99( var_0 )
{
    self.update_player_enemy_on_death[self.update_player_enemy_on_death.size] = var_0;
}
...
door_is_open_at_least( var_0 )
{
    ...
    foreach ( var_3 in self.update_player_enemy_on_death )
...
carryobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( !relic_amped_last_kill_time() && var_0 scripts\mp\utility\weapon::grenadeinpullback() )
        {
...
setpickedup( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.carryobject ) || isdefined( self.carryweapon ) && !var_0 scripts\common\utility::is_weapon_allowed() || !door_is_open_at_least( var_0 ) )
    {
...
updatecarryobjectorigin()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self.carrier ) )
        {
            ...
            scripts\engine\utility::_id_13148( self.objpingdelay, "dropped", "reset" );
            continue;
        }
...
{
    if ( istrue( var_1.reset_nearby_spawn_times ) )
        var_7 = var_1;
    else
        var_7 = spawnstruct();
...
useobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.spawnextractsmoke ) )
        {
            if ( ![[ level.spawnextractsmoke ]]( var_0 ) )
                continue;
        }
...
getearliestclaimplayer()
{
    ...
    if ( isdefined( self.lb_mg_dmg_factor_main_rotor ) && istrue( self.downed_reviver_watch_for_return_to_usability ) )
    {
        if ( self.lb_mg_dmg_factor_main_rotor[var_0].size > 0 )
        {
            var_2 = undefined;
            var_3 = getarraykeys( self.lb_mg_dmg_factor_main_rotor[var_0] );

            for ( var_4 = 0; var_4 < var_3.size; var_4++ )
            {
                var_5 = self.lb_mg_dmg_factor_main_rotor[var_0][var_3[var_4]];
        ...
        self.downed_reviver_watch_for_return_to_usability = 0;
...
{
    if ( isdefined( self._id_1277F ) )
        self [[ self._id_1277F ]]( var_0 );
...
proxtriggerthink()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( self.register_vfx ) && ( var_1 scripts\mp\utility\player::isusingremote() || isdefined( var_1.spawningafterremotedeath ) ) )
            continue;

        if ( istrue( var_1.inlaststand ) && !istrue( self.trigger.bisthread ) )
            continue;
...
triggertouchthink( var_0 )
{
    ...
    while ( scripts\mp\utility\player::isreallyalive( self ) && isdefined( var_0.trigger ) && self istouching( var_0.trigger ) && !level.gameended )
    {
        ...
        if ( istrue( self.inlaststand ) && !istrue( var_0.trigger.bisthread ) )
            break;
        ...
        if ( istrue( var_0.dropshield ) && isdefined( var_0.usecondition ) && !var_0 [[ var_0.usecondition ]]( self ) )
            break;
            ...
            if ( hasdomflags() && isdefined( var_0.id ) && ( var_0.id == "domFlag" || var_0.id == "hardpoint" || var_0.id == "bomb_site" || var_0.id == "rugby_jugg" ) )
            {
                ...
                else if ( var_1 && isdefined( self.ui_dom_securing ) && ( isdefined( var_0.stalemate ) && !var_0.stalemate && !istrue( var_0.majoritycapprogress ) ) && var_0.ownerteam != self.team )
                {
                    ...
                    if ( scripts\mp\utility\game::getgametype() == "hq" )
                    {
                        ...
                        self setclientomnvar( "ui_objective_state", var_0 scripts\mp\gametypes\obj_dom::mix_with_caps() );
                    else
                        self setclientomnvar( "ui_objective_state", 1 );
                }
                else
...
updateuisecuring( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && var_3.id == "laststand_reviver" )
        {
            ...
            scripts\mp\gametypes\br::_id_12E03( var_6, self, var_0 );
        }
    }
    else
    {
    ...
    else if ( !var_1 )
    {
        if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() || isdefined( self.id ) && self.id == "rugby_jugg" )
        {
            if ( !var_0 scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) )
            {
                ...
                {
                    var_0 thread laser_traps_saved_origins( 1 );
        ...
        if ( !isdefined( var_2 ) && !var_1 )
        {
            if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() || isdefined( self.id ) && self.id == "rugby_jugg" )
            {
                if ( istrue( var_0.weaponsdisabledwhilereviving ) )
                {
                    ...
                    if ( !level.allowreviveweapons )
                    {
                        var_0 thread laser_traps_saved_origins( 0 );
...
laser_traps_saved_origins( var_0 )
{
    self endon( "death" );
...
usetest( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self.trigger ) && isdefined( self.trigger._id_12E64 ) && distance2dsquared( self.trigger.origin, var_0.origin ) >= self.trigger._id_12E64 )
        return 0;
    ...
    if ( istrue( self.dropshield ) && isdefined( self.usecondition ) && !self [[ self.usecondition ]]( var_0 ) )
        return 0;
...
_id_1213C( var_0, var_1, var_2, var_3, var_4 )
{
        ...
        if ( var_1 != -1 )
        {
            if ( level.codcasterenabled )
            {
                if ( isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::_id_12D9B( var_1, var_12 );
                }
                else
                    scripts\mp\objidpoolmanager::_id_12D9C( var_1 );
            }
            ...
            if ( !var_7 )
            {
                ...
                if ( level.codcasterenabled && isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::_id_12D9E( var_1, var_20 );
                }
