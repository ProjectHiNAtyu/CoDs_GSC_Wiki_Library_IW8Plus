...
callbacksoldieragentdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( istrue( self.cachedomnars ) )
    {
        if ( _id_12272( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 ) )
            return;
    ...
    if ( var_32 )
    {
        if ( istrue( self.race_wait_for_current_checkpoint ) )
        {
            var_2 = 0;
    ...
    if ( var_22 )
    {
        ...
        {
            if ( var_24 )
                var_2 = any_player_within_distance2d( var_2, var_5, var_17, var_4, var_1 );
        }
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            ...
            if ( scripts\mp\damage::armorvest_washit( var_1 ) || scripts\mp\damage::helmet_washit( var_1 ) )
                var_3 = var_3 | level.playerplunderbankdepositcallback;

            if ( scripts\mp\damage::armorvest_wasbroke( var_1 ) || scripts\mp\damage::helmet_wasbroke( var_1 ) )
                var_3 = var_3 | level.playerplunderbankdeposit;

            if ( isdefined( level.onagentdamagedaddflag_func ) )
                var_3 = var_3 | [[ level.onagentdamagedaddflag_func ]]( var_13 );
        }
    }
    ...
    if ( var_22 || var_23 || var_30 )
    {
        if ( isdefined( var_12 ) )
        {
            ...
            applyprematchplotarmor( self, var_1, var_0, var_12, var_2, var_6, var_7, var_8, var_9, var_4 );
        }
...
callbacksoldieragentgametypekilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isdefined( self.get_safe_set_spawn_weapons ) )
    {
        var_9 = spawnstruct();
        ...
        thread [[ self.get_safe_set_spawn_weapons ]]( var_9 );
    }
...
any_player_within_distance2d( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_0;
...
applyprematchplotarmor( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
...
process_damage_feedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_14 ) && var_14 != var_10 && var_2 + var_11 + var_12 > 0 && ( !isdefined( var_8 ) || var_8 != "shield" ) )
    {
        ...
        if ( isdefined( var_10.killstreakweaponfiredcontinue ) && var_10.killstreakweaponfiredcontinue.size > 1 )
...
_id_12272( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_0 ) && ( issubstr( var_13, "thermite" ) || isdefined( var_12.magazine ) && issubstr( var_12.magazine, "boltfire" ) || isdefined( var_0.weapon_name ) && issubstr( var_0.weapon_name, "incendiary" ) ) )
    {
        ...
        {
            self.cacheentity = undefined;
            self._id_129A1 = undefined;
        }
    }
    ...
    else if ( var_8 == "none" && isdefined( var_0 ) )
    {
        ...
        if ( istrue( self.cacheentity ) && var_14 && isdefined( var_23 ) && var_23 == self )
        {
            if ( !isdefined( self._id_129A3 ) )
                self._id_129A3 = [ var_0 ];
            else if ( !scripts\engine\utility::array_contains( self._id_129A3, var_0 ) )
                self._id_129A3[self._id_129A3.size] = var_0;
