...
door_think()
{
    ...
    for (;;)
    {
        ...
        var_0 scripts\engine\utility::_id_1312D( "door_state_done", "door_state_interrupted" );
...
disownalarmmonitor()
{
    ...
    for (;;)
    {
        self.dooralarmowner scripts\engine\utility::_id_1312E( "joined_team", "joined_spectators", "disconnect" );
...
{
    scripts\engine\utility::_id_1312D( "remove_rig", "death_or_disconnect" );
}
