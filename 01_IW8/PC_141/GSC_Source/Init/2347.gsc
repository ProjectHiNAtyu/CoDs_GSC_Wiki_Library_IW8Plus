...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "gunship", "getBombingPoint", ::onplayerentergulag );
...
{
    var_2 = scripts\cp_mp\killstreaks\toma_strike::_id_12A2E( var_0, var_1 );
    return var_2.point;
}
