...
trackcashevent( var_0 )
{
    ...
    if ( isdefined( level.tower_ground_mortar_2 ) )
    {
        foreach ( var_2 in level.tower_ground_mortar_2 )
            self [[ var_2 ]]( var_0 );
    }
}
...
{
    if ( !isdefined( level.tower_ground_mortar_2 ) )
        level.tower_ground_mortar_2 = [];

    level.tower_ground_mortar_2[level.tower_ground_mortar_2.size] = var_0;
}
