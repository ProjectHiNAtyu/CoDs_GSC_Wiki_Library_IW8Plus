...
_id_11F51( var_0 )
{
    ...
    {
        var_1 = "bash_left_90";
        var_2 = self.extracthelipadusecallback + ( 0, 90, 0 );
    }
    else
    {
        var_1 = "bash_right_90";
...
_id_11F53( var_0 )
{
    ...
    var_1 = self.extracthelipadwatchforhelileaving;
    var_2 = var_0.extracthelipadwatchforhelileaving;
...
helperdrone_watchscramblereffectdist( var_0, var_1 )
{
    var_2 = !var_0;
