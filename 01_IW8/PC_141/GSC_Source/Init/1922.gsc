...
reset_timescalefactor( var_0, var_1 )
{
    var_2 = getdvarint( "scr_checkValidAttachmentUnlock", 0 ) == 1;

    if ( var_2 )
        return scripts\mp\utility\weapon::branalytics_missionend( var_0, var_1 );
...
validateloadout( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
        var_2 = 1;
    else if ( resetdangercircleorigin( var_0.loadoutprimary ) )
        var_2 = 1;
    ...
    if ( !scripts\mp\weapons::resetchemicalvalvevalues( var_0.loadoutprimary ) )
    {
        var_2 = 1;
        var_3 = 1;
    }
    ...
    {
        if ( resetmlgobjectivestatusicon( var_0.loadoutprimary, var_0.loadoutprimaryvariantid ) )
            var_0.loadoutprimaryvariantid = -1;
        ...
        for ( var_5 = 0; var_5 < var_0.loadoutprimaryattachments.size; var_5++ )
        {
            ...
            if ( register_chopper_boss_combat_actions( var_0.loadoutprimary, var_0.loadoutprimaryvariantid, var_6, var_7 ) )
                var_0.loadoutprimaryattachmentids[var_5] = 0;

            if ( var_6 != "none" && ( perkisrestricted( var_6, var_0.loadoutprimary ) || !reset_timescalefactor( var_0.loadoutprimary, var_6 ) ) )
            {
    ...
    if ( !isdefined( var_1 ) )
        var_2 = 1;
    else if ( resetdangercircleorigin( var_0.loadoutsecondary ) )
        var_2 = 1;
    ...
    {
        if ( resetmlgobjectivestatusicon( var_0.loadoutsecondary, var_0.loadoutsecondaryvariantid ) )
            var_0.loadoutsecondaryvariantid = -1;
        ...
        for ( var_5 = 0; var_5 < var_0.loadoutsecondaryattachments.size; var_5++ )
        {
            ...
            if ( register_chopper_boss_combat_actions( var_0.loadoutsecondary, var_0.loadoutsecondaryvariantid, var_6, var_7 ) )
                var_0.loadoutsecondaryattachmentids[var_5] = 0;

            if ( var_6 != "none" && ( perkisrestricted( var_6, var_0.loadoutsecondary ) || !reset_timescalefactor( var_0.loadoutsecondary, var_6 ) ) )
            {
    ...
    if ( !scripts\mp\equipment::isequipmentprimary( var_0.loadoutequipmentprimary ) || !scripts\mp\equipment::release_ascendstruct_ondeath( var_0.loadoutequipmentprimary ) )
    ...
    if ( !scripts\mp\equipment::isequipmentsecondary( var_0.loadoutequipmentsecondary ) || !scripts\mp\equipment::release_ascendstruct_ondeath( var_0.loadoutequipmentsecondary ) )
...
validateattachments( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_17, var_12 in var_1 )
    {
        ...
        if ( isdefined( var_12 ) && var_12 != "none" )
        {
            ...
            if ( !scripts\mp\utility\weapon::branalytics_landing( var_3, var_12 ) )
            {
...
{
    return isdefined( level.weaponmapdata[var_0] ) && istrue( level.weaponmapdata[var_0]._id_12D08 );
}
...
resetmlgobjectivestatusicon( var_0, var_1 )
{
    ...
    var_2 = var_0 + "|" + var_1;
    return isdefined( level.weaponlootmapdata[var_2] ) && istrue( level.weaponlootmapdata[var_2].relic_nuketimer_addtotimer );
}

register_chopper_boss_combat_actions( var_0, var_1, var_2, var_3 )
{
    if ( scripts\mp\utility\game::isanymlgmatch() )
        return 1;
    ...
    for (;;)
    {
        ...
        {
            if ( !level.weaponlootmapdata[var_10].relic_nuketimer_addtotimer )
            {
