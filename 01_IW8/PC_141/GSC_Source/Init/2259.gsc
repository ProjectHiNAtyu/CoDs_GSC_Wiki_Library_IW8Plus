...
jeep_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12F53( "jeep", "single", [ "driver", "front_right", "back_left", "back_right" ] );
}

respawnplayer()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "jeep", 1 );
    var_0.id = 10;
...
respawningbr()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "jeep", 1500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "jeep" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "jeep" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "jeep", 9 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "jeep", ::jeep_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "jeep_mp", 3 );
}

respawnheightoverride()
{
    var_0 = _applydvarstosettings::_id_12EC9( "jeep", 1 );
    var_0.brc130airdropcratedestroycallback = 1.33333;
    var_0.getignoreprops = 0.91666;
    var_0.get_next_open_stop = 350;
    var_0.get_next_rein_group = 525;
    var_0.get_next_cypher_id_from_pool = 875;
    var_0.get_node_closest_to_target_loc = 10;
    var_0.get_num_dogtag_in_kill_zone_or_under_bridge_zone = 40;
    var_0.get_next_track_index = 80;
...
jeep_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "jeep", var_0 );
...
respawndelayoverride( var_0, var_1 )
{
    if ( !isdefined( var_0.angles ) )
        var_0.angles = ( 0, 0, 0 );
