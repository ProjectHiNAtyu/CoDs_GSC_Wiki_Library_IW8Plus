...
_id_11F48( var_0, var_1 )
{
    ...
    if ( !isdefined( level._id_11F58[var_0] ) )
        level._id_11F58[var_0] = [];

    level._id_11F58[var_0][level._id_11F58[var_0].size] = var_1;
}

_id_11F45( var_0 )
{
    if ( !isdefined( level._id_11F49 ) )
        level._id_11F49 = [];

    level._id_11F49 = scripts\engine\utility::array_add( level._id_11F49, var_0 );
}

_id_11F46( var_0 )
{
    if ( !isdefined( level._id_11F4B ) )
        level._id_11F4B = [];

    level._id_11F4B = scripts\engine\utility::array_add( level._id_11F4B, var_0 );
}
...
scriptable_engineused( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( istrue( var_5 ) )
    {
        if ( isdefined( level._id_11F4B ) )
        {
            foreach ( var_7 in level._id_11F4B )
    ...
    if ( istrue( var_4 ) )
    {
        if ( isdefined( level._id_11F49 ) )
        {
            foreach ( var_7 in level._id_11F49 )
    ...
    else
    {
        ...
        if ( isdefined( level._id_11F58 ) && isdefined( level._id_11F58[var_1] ) )
        {
            foreach ( var_7 in level._id_11F58[var_1] )
                [[ var_7 ]]( var_0, var_1, var_2, var_3, 1 );
        }
    }
}
...
_id_11F47( var_0 )
{
    if ( !isdefined( level._id_11F50 ) )
        level._id_11F50 = [];

    level._id_11F50 = scripts\engine\utility::array_add( level._id_11F50, var_0 );
}

_id_11F54( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( isdefined( level._id_11F50 ) )
    {
        foreach ( var_12 in level._id_11F50 )
