...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "hostmigration_waitLongDurationWithPause", ::tagtaken );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "hostmigration_waitTillHostMigrationDone", ::taillightleft );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "delayEndGame", ::nuke_delayendgame );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "addTeamRankXPMultiplier", ::tacinsert_updatedestroyusability );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "cankill", ::nuke_cankill );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "killPlayer", ::taillightright );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "killPlayerWithAttacker", ::take );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "stopTheClock", ::takeriotshield );
}
...
tacinsert_updatedestroyusability( var_0, var_1, var_2 )
{
