...
init()
{
    ...
    init_function_refs();
    level.train_play_anim = scripts\mp\trials\trial_target_utility::delay_delete_reinforcement_called_icon();
    level.train_play_anim_init = scripts\mp\trials\trial_target_utility::delay_delete_reinforcement_called_icon();
...
dochangeweapon( var_0 )
{
    if ( istrue( self.deployingplayer ) )
        setup_enemy_sentry( var_0 );

    self.deployingplayer = 1;
...
_id_11F73()
{
    ...
    scripts\engine\utility::_id_1312D( "death", "weapon_change" );
...
stopinteract( var_0 )
{
    ...
    var_1 = "cancel_" + var_0;
    thread stopdragonsbreathburning( var_1 );
    childthread stoppingpower_clearhcrongameended( var_0, var_1 );
    childthread stoppingpower_givehcrdata( var_0, var_1 );
    childthread stoppingpower_getweaponhcrdata( var_0, var_1 );
}
...
stoppingpower_givehcrdata( var_0, var_1 )
{
    for (;;)
    {
        ...
        {
            stoppingpower_clearhcrdata( var_1 );
        ...
        if ( self isonladder() )
            stopimmediately( var_0, var_1 );
    }
}

stoppingpower_getweaponhcrdata( var_0, var_1 )
{
    for (;;)
    {
...
stopimmediately( var_0, var_1 )
{
    ...
    childthread stoppingpower_clearhcronperkscleared( var_0, var_1 );
}

stoppingpower_clearhcrongameended( var_0, var_1 )
{
    self notify( var_1 );
    self endon( var_1 );
    self.watchweapondrop = 1;
...
stoppingpower_clearhcronperkscleared( var_0, var_1 )
{
    self notify( var_1 );
    self endon( var_1 );
    self.watchweapondrop = 1;
...
stoppingpower_clearhcrdata( var_0 )
{
    self notify( var_0 );

    if ( istrue( self.watchweapondrop ) )
    {
        self setscriptablepartstate( "weaponVFXViewmodel", "neutral" );
        self setscriptablepartstate( "weaponVFXWorldModel", "neutral" );
    }

    self.watchweapondrop = undefined;
}

stopdragonsbreathburning( var_0 )
{
    self endon( "disconnect" );
    self endon( "newMTXVFXStateSet" );
    scripts\engine\utility::_id_1312D( "death", "weapon_change" );
...
_id_12DC5( var_0 )
{
    ...
    if ( scripts\mp\utility\weapon::getweapongroup( var_0 ) == "weapon_shotgun" || var_0.basename == "iw8_pi_t9pistolshot_mp" )
    {
        if ( scripts\cp\killstreaks\nuke_cp::regive_killstreak_after_use( var_0 ) )
            thread scripts\cp\killstreaks\nuke_cp::prohibited_weapon_list( var_0 );
    }
}
...
updatelauncherusage()
{
    ...
    switch ( var_1 )
    {
        ...
        case "iw8_sn_crossbow":
            thread scripts\cp\helicopter\utility::processscrapassist();
            break;
        case "iw8_sn_xmike109":
            thread scripts\cp\stealth\manager::quarry_fight_across();
            break;
        case "iw8_sh_aalpha12":
            thread scripts\cp\drone\emp_drone::quarry_fight_across();
            break;
        case "iw8_me_t9ballisticknife":
            thread scripts\cp\equipment\cp_decoy_grenade::quarry_fight_across();
            break;
    }
    ...
    switch ( var_1 )
    {
        ...
        case "iw8_sn_t9crossbow":
        case "iw8_sn_crossbow":
            thread scripts\cp\helicopter\utility::generate_cypher( var_0 );
            break;
        case "iw8_sn_xmike109":
            thread scripts\cp\stealth\manager::_id_12E1F( var_0 );
            break;
        case "iw8_sh_aalpha12":
            thread scripts\cp\drone\emp_drone::_id_12E1F( var_0 );
            break;
        case "iw8_me_t9ballisticknife":
            thread scripts\cp\equipment\cp_decoy_grenade::_id_12E1F( var_0 );
            break;
    }
}
...
_id_1212C( var_0 )
{
    ...
    if ( isdefined( level.script_gameobjetname ) )
        self [[ level.script_gameobjetname ]]();
}
...
onplayerspawned()
{
    ...
    _id_1212C( scripts\engine\utility::ter_op( isdefined( self.spawnweaponobj ), self.spawnweaponobj, isundefinedweapon() ) );
...
savetogglescopestates()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( !getqueuedspleveltransients( self.primaryweaponobj ) && var_2 == self.primaryweaponobj || !getqueuedspleveltransients( self.secondaryweaponobj ) && var_2 == self.secondaryweaponobj )
        {
            if ( isdefined( var_2.scope ) && istogglescope( var_2.scope ) && !_id_1277E( var_2.backpiece ) )
            {
                var_3 = scripts\mp\utility\weapon::getcompleteweaponnamenoalt( var_2 );
...
{
    return register_chopper_boss_combat_action( var_0 );
}
...
sniperglint_cleanup()
{
    scripts\engine\utility::_id_1312D( "death_or_disconnect", "weapon_change" );
...
{
    self endon( "death" );
    level.train_play_anim scripts\mp\trials\trial_target_utility::delay_end_common_combat( self, var_0, self.objweapon );
    ...
    for (;;)
    {
        ...
        if ( var_6 )
        {
            ...
            if ( var_7.size > 2 )
            {
                ...
                foreach ( var_12 in var_7 )
                {
                    ...
                    if ( scripts\mp\utility\weapon::relic_nuketimer_timer_init( var_12 ) )
                        var_9 = 1;
        ...
        level.train_play_anim_init scripts\mp\trials\trial_target_utility::delay_end_common_combat( self, var_2, self.objweapon );
...
watchpickupcomplete( var_0, var_1, var_2 )
{
    ...
    if ( var_4 )
    {
        ...
        if ( isdefined( level.train_sfx_init ) )
            [[ level.train_sfx_init ]]( var_0 );
        else if ( var_2 )
...
getrandomgraverobberattachment( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) && var_1.size > 0 )
        ...
        var_4 = scripts\mp\utility\weapon::midpoint_music( var_2 );
    ...
    foreach ( var_8, var_6 in var_3 )
    {
        ...
        if ( !scripts\mp\utility\weapon::branalytics_landing( var_0, var_7 ) )
        {
    ...
    var_4 = scripts\engine\utility::br_alt_mode_impulse_player( var_4 );
...
{
    if ( !scripts\mp\utility\weapon::branalytics_landing( var_0, var_1 ) )
        return 0;
...
{
    if ( isdefined( level.trackriotshield_tryreset ) )
        [[ level.trackriotshield_tryreset ]]( var_0 );
    else
    {
...
handlescavengerbagpickup( var_0 )
{
    ...
    trackriotshield_tryreset( var_1 );

    if ( !isdefined( var_1.pers["scavengerPickedUp"] ) )
        var_1.pers["scavengerPickedUp"] = 0;

    var_1 scripts\cp\helicopter\chopper_boss::track_consecutive_kills( "scavengerAmmo", 0 );
...
scavengerbagcleanupthink()
{
    self endon( "death" );
    level endon( "game_ended" );
    self.owner scripts\engine\utility::_id_1312E( "death_or_disconnect", "joined_team", "bag_timeout" );
...
scavengerbagusesetup()
{
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_2 ) )
        {
            ...
            trackriotshield_tryreset( var_2 );
...
checkhit( var_0, var_1 )
{
    ...
    else
    {
        ...
        scripts\cp\helicopter\chopper_boss::toggle_player_pos_memory( var_0, self.consecutivehitsperweapon[var_3] );
    }
...
watchgrenadethrows()
{
    ...
    switch ( var_0.weapon_name )
    {
        ...
        case "support_box_mp":
            ...
            break;
        case "armor_box_mp":
            thread scripts\mp\equipment\support_box::bot_snipers( var_0 );
            break;
        ...
        case "geiger_counter_mp":
            thread _branalytics_addevent::linktoplayer_linklogic( var_0 );
            break;
        case "offhand_spotter_scope_mp":
            thread _attachmentblocks::calloutmarkerpingvo_handlerdoescontainpoolelement( var_0 );
            break;
        case "tac_cover_mp":
        ...
        case "advanced_vehicle_drop_marker_mp":
            thread scripts\mp\equipment\advanced_supply_drop::appliednukethreads( var_0 );
            break;
        case "advanced_loot_drop_marker_mp":
            thread scripts\mp\equipment\advanced_supply_drop::apce_p1( var_0 );
            break;
        case "deploy_weapondrop_mp":
            thread scripts\mp\equipment\weapon_drop::weapondrop_used( var_0 );
            break;
        case "concussion_grenade_mp":
            var_0 thread findloadoutperks();
            break;
        default:
            if ( isdefined( level.totalhealth ) )
                [[ level.totalhealth ]]( var_0.weapon_name, var_0 );

            break;
    }

    setup_hacks( var_0.weapon_name );
}
...
findloadoutperks()
{
    ...
    thread scripts\mp\equipment\concussion_grenade::total_spawns( var_0, var_1 );
}
...
smokegrenadeused( var_0 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        thread _id_1236D( var_5 );
        thread scripts\mp\bots\bots::fulton( var_5 );
    }
    else
...
monitorsmokeactive()
{
    ...
    var_0 = scripts\engine\utility::_id_13141( 9.25, "death" );
...
lockonlaunchers_gettargetarray( var_0 )
{
    ...
    if ( level.teambased )
    {
        ...
        foreach ( var_14 in var_3 )
        {
            ...
            {
                if ( isdefined( var_17 ) && ( !scripts\cp_mp\vehicles\vehicle::_id_12F6D( var_17, self ) || var_2 ) )
...
lockonlaunchers_gettargetvehiclerefs()
{
    ...
    if ( isdefined( level.lbravo_spawner_safehouse1 ) )
        var_0 = level.lbravo_spawner_safehouse1;
...
updatemissilefire( var_0 )
{
    ...
    switch ( var_0.weapon_name )
    {
        ...
        case "iw8_la_t9standard_mp":
            ...
            level thread scripts\mp\battlechatter_mp::select_bridge_three_spawners( var_0 );
...
monitordisownedequipment( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_2 ) )
        var_0 scripts\engine\utility::_id_1312D( "joined_team", "disconnect" );
    else
        var_0 scripts\engine\utility::_id_1312E( "joined_team", "joined_spectators", "disconnect" );
...
updateplantedarray( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        scripts\mp\utility\script::getweaponrandomvariantid( var_4 );
    }
...
makeexplosiveusabletag( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            else if ( isdefined( level.traceresults ) )
                [[ level.traceresults ]]( self.owner, var_4 );
        }
...
explosivehandlemovers( var_0, var_1 )
{
    ...
    if ( scripts\mp\equipment\claymore::recondronetracecontents( var_0 ) )
    {
        var_2.upload_station_players_manager = 1;
        self _meth_87B9( 1 );
    }
...
updateviewkickscale( var_0 )
{
    ...
    else if ( isdefined( self.overrideviewkickscale ) )
    {
        ...
        var_1 = scripts\mp\utility\weapon::_id_132D5( self getcurrentweapon() );

        if ( var_1 == 1 )
            var_0 = self.overrideviewkickscalepistol;
        else if ( var_1 == 4 )
            var_0 = self.trial_rpg_settings;
        else if ( var_1 == 2 )
            var_0 = self.trial_sentry_turrets;
        else if ( var_1 == 3 )
            var_0 = self.trial_shooters;
        else if ( var_1 == 5 )
...
getplayerspeedbyweapon( var_0 )
{
    ...
    else
    {
        ...
        if ( !isdefined( var_2 ) )
            ...
            var_1 = 0.85;
        else if ( scripts\mp\utility\weapon::relic_bang_and_boom( var_2.basename ) )
            var_1 = 0.85;
        else
        {
            if ( var_2.inventorytype != "primary" && var_2.inventorytype != "altmode" || scripts\mp\utility\weapon::relic_nuketimer_timer_init( var_2 ) )
            {
...
stancerecoiladjuster()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_1312E( "adjustedStance", "sprint_begin", "weapon_change" );
        wait 0.5;
...
buildattachmentmaps()
{
    ...
    level.branalytics_missionstart = [];
    level.branalytics_planepath = [];
    ...
    foreach ( var_23 in var_21 )
    {
        ...
        {
            var_26 = level.branalytics_planepath[var_25];

            if ( !isdefined( var_26 ) )
                level.branalytics_planepath[var_25] = var_24;
            else if ( var_24 != var_26 )
                level.branalytics_plunder_extraction_success[var_23] = var_24;
        }
        ...
        if ( var_29 != "" )
            level.branalytics_missionstart[var_23] = var_29;
    }
...
quarry_mortars()
{
    ...
    for (;;)
    {
        ...
        level._id_132E6[var_3] = var_2;
        var_0++;
    }
}

resetchemicalvalvevalues( var_0 )
{
    if ( !isdefined( level._id_132E6 ) )
        quarry_mortars();

    var_1 = level._id_132E6[var_0];

    if ( isdefined( var_1 ) && ( var_1 == "t9" || var_1 == "s4" ) )
    {
        if ( !istrue( level._id_131B7 ) )
            return 0;
...
buildweaponmap()
{
        ...
        if ( var_3 != "" )
        {
            ...
            if ( var_5 != "" )
            {
                ...
                if ( var_6 != "" )
                {
                    ...
                    if ( var_7 > -1 && resetchemicalvalvevalues( var_3 ) && !var_8 )
                    {
                        if ( !isdefined( level._id_132D8[var_5] ) )
                            level._id_132D8[var_5] = [];

                        level._id_132D8[var_5][level._id_132D8[var_5].size] = var_3;
                    }
                    else
                        level.weaponmapdata[var_3]._id_12D08 = 1;
                }
            }
            ...
            if ( var_10 != "" )
                level.weaponmapdata[var_3].spawn_exfil_heli_and_rpgs = var_10;
    ...
    for (;;)
    {
        ...
        level.weaponlootmapdata[var_21].relic_nuketimer_addtotimer = int( var_20 ) != 0 && int( var_23 ) == 99;
        level.weaponlootmapdata[var_21].register_fuel_stability_event = resetchemicalvalvevalues( var_3 );
            ...
            if ( isdefined( level.weaponlootmapdata[var_42] ) )
            {
                ...
                if ( var_41.size )
                {
                    foreach ( var_44 in var_41 )
                    {
                        ...
                        level.weaponlootmapdata[var_45].relic_nuketimer_addtotimer = 1;
                        level.weaponlootmapdata[var_45].register_fuel_stability_event = 0;
                    }
...
{
    if ( isdefined( var_0 ) )
        var_0 scripts\engine\utility::_id_13141( var_2, "death_or_disconnect" );
...
repair_grill_stop_exit_foley_sfx( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
weaponhasselectableoptic( var_0 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        ...
        if ( var_5 == "rail" )
        {
            ...
            if ( scripts\mp\utility\weapon::branalytics_landing( var_1, var_6 ) )
                return 1;
        }
    }
...
watchdropweapons()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) && isdefined( var_1 ) && !scripts\mp\utility\weapon::ismeleeonly( var_1 ) && !scripts\mp\utility\weapon::relic_nuketimer_timer_init( var_1 ) && !scripts\mp\utility\weapon::isknifeonly( var_1 ) )
        {
...
_id_11AEA()
{
    ...
    foreach ( var_1 in level.players )
    {
        if ( isdefined( var_1 ) && isdefined( var_1._id_11AED ) )
        {
            var_1._id_11AED = undefined;
            var_1 notify( "endReactiveCamoThread" );
        }
    }
}

_id_11AEB( var_0, var_1, var_2 )
{
    var_0._id_1264B = var_1;

    if ( var_2 == 1 )
        self setscriptablepartstate( "activeCamo", "stage" + var_0._id_1264B );
    else
        self setscriptablepartstate( "activeCamo", "init_stage" + var_0._id_1264B );
}

_id_11AEC( var_0 )
{
    if ( !isdefined( self._id_11AED ) )
        self._id_11AED = [];

    if ( !isdefined( self._id_11AED[var_0] ) )
    {
        self._id_11AED[var_0] = spawnstruct();
        self._id_11AED[var_0].kills = 0;
        self._id_11AED[var_0]._id_1264B = 0;
    }
}
...
_id_11AE7( var_0 )
{
    ...
    if ( !isdefined( level._id_11AE9 ) && !scripts\mp\flags::gameflag( "prematch_done" ) )
    {
        level._id_11AE9 = 1;
        level thread _id_11AEA();
    }

    var_1 = _id_132D6( var_0 );
    _id_11AEC( var_1 );
    var_2 = self._id_11AED[var_1];
    _id_11AEB( var_2, var_2._id_1264B, 0 );
    ...
    while ( var_2._id_1264B < var_4 )
    {
        scripts\engine\utility::waittill_either( "got_a_kill", "scr_advancereactivecamo" );
        var_6 = int( var_5[var_2._id_1264B + 1] );
        var_2.kills++;

        if ( var_2.kills >= var_6 )
        {
            _id_11AEB( var_2, var_2._id_1264B + 1, 1 );
...
relic_squadlink_add_visionset( var_0 )
{
...
{
    watchminigunweapon( "j_shoulder_ri", "teslaLimb" );
    watchminigunweapon( "j_shoulder_le", "teslaLimb" );
    watchminigunweapon( "j_elbow_ri", "teslaLimb" );
    watchminigunweapon( "j_elbow_le", "teslaLimb" );
    watchminigunweapon( "j_hip_ri", "teslaLimb" );
    watchminigunweapon( "j_hip_le", "teslaLimb" );
    watchminigunweapon( "j_knee_ri", "teslaLimb" );
    watchminigunweapon( "j_knee_le", "teslaLimb" );
    watchminigunweapon( "j_spineupper", "teslaTorso" );
    watchminigunweapon( "j_head", "teslaHead" );
    self playsound( "iw8_mp_tesla_death_sfx" );
    var_0 hide();
}

stopcirclesatgameend( var_0 )
{
    watchminigunweapon( "j_shoulder_ri", "8BitLimb" );
    watchminigunweapon( "j_shoulder_le", "8BitLimb" );
    watchminigunweapon( "j_elbow_ri", "8BitLimb" );
    watchminigunweapon( "j_elbow_le", "8BitLimb" );
    watchminigunweapon( "j_hip_ri", "8BitLimb" );
    watchminigunweapon( "j_hip_le", "8BitLimb" );
    watchminigunweapon( "j_knee_ri", "8BitLimb" );
    watchminigunweapon( "j_knee_le", "8BitLimb" );
    watchminigunweapon( "j_spineupper", "8BitTorso" );
    watchminigunweapon( "j_head", "8BitHead" );
    self playsound( "8bit_death_sfx" );
    var_0 hide();
}

watchminigunweapon( var_0, var_1 )
{
...
enableburnfx( var_0, var_1 )
{
    ...
    self.death_info_func[mine_explosion_vfx( var_1 )] = var_1;
    thread startburnfx();
}
...
enableburnsfx()
{
    ...
    if ( !isdefined( self.burnsfx ) )
    {
        ...
        thread deathsdoorsfx( self.burnsfx );
        wait 0.05;
    }
...
disableburnfx( var_0, var_1 )
{
    if ( isdefined( var_1 ) )
    {
        if ( self.death_info_func[mine_explosion_vfx( var_1 )] == var_1 )
            self.death_info_func[mine_explosion_vfx( var_1 )] = undefined;
    }
    else
        self.death_info_func = [];

    if ( self.death_info_func.size > 0 )
        thread startburnfx();
    else
    {
        thread stopburnfx();
...
clearburnfx()
{
    ...
    self.death_info_func = undefined;
}
...
startburnfx()
{
    ...
    var_0 = modifybrgasdamage( self.death_info_func );
...
_id_11FFA( var_0, var_1 )
{
    ...
    thread _id_11FFB( var_1, var_2 );
}

_id_11FFB( var_0, var_1 )
{
    ...
    var_0 scripts\cp_mp\utility\damage_utility::laser_trap_control_station_interaction_array();
    var_0 dodamage( var_0.maxhealth, var_1, self, undefined, "MOD_EXPLOSIVE", getcompleteweaponname( "semtex_mp" ) );
    var_0 scripts\cp_mp\utility\damage_utility::laser_trap_structs();
}
