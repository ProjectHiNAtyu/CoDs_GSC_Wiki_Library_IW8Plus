...
light_tank_mp_initspawning()
{
    ...
    var_0.ai_molotov_swap = scripts\cp_mp\vehicles\light_tank::light_tank_timeout;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
    {
        var_0.ai_molotov_swapp = 105;
        var_0._id_11D08 = level._id_128F1;
    }
    else
        var_0.ai_molotov_swapp = 40;
}
...
light_tank_mp_createownercaptureobject( var_0, var_1 )
{
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_12F48( var_0, "tur_bradley_mp" );
...
light_tank_mp_createothercaptureobject( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_12F48( var_0, "tur_bradley_mp" );
...
light_tank_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_12FC9( "light_tank", var_1, var_2 );
    ...
    if ( isdefined( var_3 ) )
    {
        if ( scripts\mp\utility\game::getgametype() == "arm" )
        {
            ...
            if ( istrue( level._id_122E8 ) )
                scripts\mp\gametypes\arm::_id_12EF5( var_3, var_3.team );
