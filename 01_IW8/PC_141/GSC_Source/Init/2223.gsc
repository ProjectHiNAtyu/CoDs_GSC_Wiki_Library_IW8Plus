...
initcratedata()
{
    ...
    level.cratedata._id_12D2E = pow( getdvarfloat( "scr_crateUnresolvedCollisionToleranceSqr", 2 ), 2 );
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "registerPlayerFrameUpdateCallback" ) )
        [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "registerPlayerFrameUpdateCallback" ) ]]( ::_id_12A91 );
...
createcrate( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( level.gametype == "infect" )
        var_11.reset_ability_invulnerable = 1;
    ...
    if ( isdefined( var_11.owner ) )
        var_11.owner.relic_amped_is_player_valid_to_explode = 1;
...
activatecrate( var_0 )
{
    ...
    self.relic_amped_is_there_valid_new_victim = undefined;
...
capturecrate( var_0 )
{
    ...
    if ( isdefined( self.owner ) && istrue( self.owner.relic_amped_is_player_valid_to_explode ) )
        self.owner.relic_amped_is_player_valid_to_explode = 0;
...
destroycrate( var_0 )
{
    ...
    if ( !isdefined( var_0 ) )
    {
        ...
        {
            if ( !istrue( self.update_bomb_interaction_ent ) )
            {
                self.destroyonactivate = 1;
                return;
            }
    ...
    if ( !istrue( var_0 ) )
    {
        ...
        if ( !istrue( self.physicsactivated ) || !istrue( self.update_bomb_interaction_ent ) )
        {
...
initcratedropdata()
{
    var_0 = spawnstruct();
    var_0.helis = [];
    var_1 = scripts\cp_mp\utility\killstreak_utility::molotov_crate_update_hint_logic_alt();
...
watchdropcratefrommanualheliinternal()
{
    ...
    {
        self.heli scripts\engine\utility::_id_1312D( "death", "goal" );
...
watchcrateuse( var_0, var_1 )
{
    ...
    if ( var_0 == 1 )
    {
        ...
        self.owner endon( "joined_team" );
        self.owner endon( "joined_spectators" );
        self.owner.relic_amped_is_player_valid_to_explode = 1;
    }
    ...
    if ( isdefined( var_3._id_12E76 ) )
        var_3.usetime = var_3._id_12E76;
    ...
    for (;;)
    {
        ...
        {
            if ( istrue( var_4.isjuggernaut ) && !var_4 rider_models( self.cratetype ) )
            {
        ...
        if ( canstartusingcrate( var_4, var_1 ) )
        {
            ...
            var_4.relic_amped_is_player_valid_to_explode = 1;
            ...
            {
                if ( isdefined( var_4 ) )
                    var_4.relic_amped_is_player_valid_to_explode = 0;
...
startusingcrate( var_0, var_1 )
{
    ...
    else
    {
        ...
        if ( var_4 )
            var_0 thread battle_tracks_shouldplaybattletrackswhenstandingonvehicle();
...
battle_tracks_shouldplaybattletrackswhenstandingonvehicle()
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\cp_mp\utility\weapon_utility::_id_11EC9();
    var_0 = getcompleteweaponname( "ks_use_crate_mp" );
    scripts\cp_mp\utility\inventory_utility::_giveweapon( var_0 );
    thread battle_tracks_standingonvehicletimeout( var_0 );
    self switchtoweapon( var_0 );
}

battle_tracks_standingonvehicletimeout( var_0 )
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    ...
    else
    {
        ...
        {
            var_1 = scripts\cp_mp\utility\weapon_utility::_id_11D27( self.lastdroppableweaponobj );
...
force_remove_stim( var_0, var_1 )
{
    var_2 = getleveldata( self.cratetype );

    if ( isdefined( var_2.force_spawn_all_dead_players ) )
        self thread [[ var_2.force_spawn_all_dead_players ]]();
    ...
    createdangerzone();
    thread ss_respawn();
    thread stack_patch_waittill_context_far_patch();
    thread stadium_one_death_func();
}
...
ss_respawn()
{
    ...
    var_0 = 0.1;
    thread ss_removequestinstance( var_0, 8 );
    var_1 = 0;
    var_2 = 0;
    self.relic_amped_is_there_valid_new_victim = 1;
    var_3 = undefined;
    var_4 = undefined;
    ...
    for (;;)
    {
        var_5 = mine_caves_cell_support_internal();
        var_6 = mine_caves_cell_support();
        ...
        if ( isdefined( var_5 ) && isdefined( var_6 ) )
        {
            if ( var_5 <= 5.0 && var_6 <= 1.0 )
            {
                ...
                if ( var_1 == 6 )
                {
                    ...
                    var_3 = self.origin;
                    thread activatecrate( self.relic_amped_is_there_valid_new_victim );
                    ...
                    var_0 = 0.1;
                    thread ss_removequestinstance( var_0, 3, 3 );
                    giveawardfake();
                }
            }
            else
...
ss_removequestinstance( var_0, var_1, var_2 )
{
    exfilchopper();
    self endon( "death" );
    self endon( "clear_average_velocities" );
    self.set_relic_laststand = [];
    self.bomber_spawner = [];
    self._id_1302B = 0;
    self._id_13026 = 0;
    self._id_13028 = var_1;
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( var_2 > 0 )
        {
            ...
            {
                self.set_relic_laststand[self._id_1302B + var_3] = 0;
                self.bomber_spawner[self._id_1302B + var_3] = 0;
            }
        }
    }
    ...
    for (;;)
    {
        ...
        self.set_relic_laststand[self._id_13026] = length( var_5 );
        self.bomber_spawner[self._id_13026] = length( var_6 );
        self._id_13026++;
        var_7 = self._id_13026 - self._id_1302B;
        ...
        if ( var_7 > var_1 )
        {
            ...
            {
                self.set_relic_laststand[self._id_1302B + var_3] = undefined;
                self.bomber_spawner[self._id_1302B + var_3] = undefined;
            }

            self._id_1302B = self._id_1302B + var_8;
        }

        self.brking_onplayerkilled = undefined;
        self.brking_onplayerconnect = undefined;
        wait( var_0 );
    }
}
...
{
    if ( isdefined( self.brking_onplayerkilled ) )
        return self.brking_onplayerkilled;

    if ( !isdefined( self.set_relic_laststand ) )
        return undefined;

    if ( self._id_13026 - self._id_1302B < self._id_13028 )
        return undefined;
...
{
    if ( isdefined( self.brking_onplayerconnect ) )
        return self.brking_onplayerconnect;

    if ( !isdefined( self.bomber_spawner ) )
        return undefined;
...
defend_death_counter()
{
    ...
    for ( var_2 = self._id_1302B; var_2 < self._id_13026; var_2++ )
    {
        var_0 = var_0 + self.set_relic_laststand[var_2];
        var_1 = var_1 + self.bomber_spawner[var_2];
    }

    self.brking_onplayerkilled = var_0 / self._id_13028;
    self.brking_onplayerconnect = var_1 / self._id_13028;
}

exfilchopper()
{
    self notify( "clear_average_velocities" );
    self.set_relic_laststand = undefined;
    self.bomber_spawner = undefined;
    self._id_13028 = undefined;
    self._id_1302B = undefined;
    self._id_13026 = undefined;
    self.brking_onplayerkilled = undefined;
    self.brking_onplayerconnect = undefined;
}
...
stack_patch_waittill_context_far_patch( var_0 )
{
    ...
    if ( isdefined( self ) )
        thread stack_patch_waittill_context_patch();
}
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) )
        {
            if ( isdefined( var_9.classname ) && var_9.classname == "scriptable_iw8_chicken_01" )
                thread battle_tracks_settogglestate( var_9 );

            draw_door_forwards( var_9 );
        }

        if ( isdefined( var_9 ) && playerpurchaselogic( var_9 ) )
        {
            if ( var_9 scripts\cp_mp\killstreaks\helper_drone::relic_bang_and_boom_dropfunc() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            watchspawninput( var_6, var_7, var_8, var_11 );
        }
    }
}

draw_door_forwards( var_0 )
{
    if ( isdefined( var_0.script_noteworthy ) && isstartstr( var_0.script_noteworthy, "train_" ) && !isdefined( self getlinkedparent() ) )
    {
        if ( isdefined( self._id_12B09 ) )
        {
            if ( self._id_12B09 == var_0 )
                return;
            else
                demoforcesre();
        }

        self._id_12B09 = var_0;
        self._id_12B08 = 4;
        thread draw_line_orgtoent( var_0 );
    }
}

draw_line_orgtoent( var_0 )
{
    self endon( "death" );
    ...
    while ( self._id_12B0F < 5 )
    {
        var_7 = self.origin + anglestoup( self.angles ) * var_1.open_gunshop_door;
        var_8 = var_7 + ( 0, 0, -200 );
        var_9 = scripts\engine\trace::ray_trace( var_7, var_8, var_3, var_2 );

        if ( var_9.size > 0 && isdefined( var_9["entity"] ) && var_9["entity"] == self._id_12B09 )
        {
            var_10 = combineangles( invertangles( var_0.angles ), var_0.origin - var_9["position"] );

            if ( !isdefined( self._id_12B10 ) )
            {

            }
            else if ( distancesquared( var_10, self._id_12B10 ) > 25 )
            {
                self._id_12B0F++;
                self._id_12B11 = 0;
            }
            else if ( vectordot( var_10, self._id_12B10 ) < 0.997 )
            {
                self._id_12B0F++;
                self._id_12B11 = 0;
            }
            else
            {
                ...
                {
                    self linkto( var_0 );
                    activatecrate( self.relic_amped_is_there_valid_new_victim );
                    thread force_players_out_of_vehicle();
                    break;
                }
            }

            self._id_12B10 = var_10;
        }
        else
            break;
...
demoforcesre()
{
    ...
    self._id_12B09 = undefined;
    self._id_12B10 = undefined;
    self._id_12B0F = undefined;
    self._id_12B11 = undefined;
}

battle_tracks_settogglestate( var_0 )
{
    self endon( "death" );
    var_1 = gettime();
...
playerpurchaselogic( var_0 )
{
    if ( !istrue( self.update_bomb_interaction_ent ) )
    {
        if ( isdefined( var_0.classname ) )
        {
            ...
            {
                if ( var_0 scripts\cp_mp\killstreaks\helper_drone::relic_bang_and_boom_dropfunc() )
                {
                    var_1 = getleveldata( self.cratetype );
                    var_2 = self.origin + anglestoup( self.angles ) * var_1.open_gunshop_door;
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) && ( isplayer( var_2 ) || isagent( var_2 ) ) && var_2 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            if ( var_2 tagexists( "j_mainroot" ) )
            {
                ...
                var_8 = self.origin + anglestoup( self.angles ) * var_7.open_gunshop_door;
...
watchspawninput( var_0, var_1, var_2, var_3 )
{
...
{
    if ( level.cratedata._id_12D2E > 0 )
    {
        if ( lengthsquared( var_1 ) <= level.cratedata._id_12D2E )
            return;
    }

    var_2 = self.objweapon;

    if ( isdefined( self.forcearmordropondeath ) )
...
_id_12A91()
{
    if ( !isdefined( self.initcircuitbreakers ) )
    {
        if ( self ismantling() )
        {
            ...
            {
                self.initcircledata = var_0;
                self.initcirclepoststarttocircleindex = var_0.crate;
            }

            self.initcircuitbreakers = gettime() + 1000;
        }
    }
    else if ( gettime() >= self.initcircuitbreakers )
    {
        self.initcircledata = undefined;
        self.initcirclepoststarttocircleindex = undefined;
        self.initcircuitbreakers = undefined;
    }
    else
    {
        foreach ( var_2 in level.cratedata.crates )
        {
            if ( isdefined( var_2 ) && istrue( var_2.physicsactivated ) && !istrue( var_2.update_bomb_interaction_ent ) )
            {
                if ( isdefined( self.initcircledata ) )
                {
                    if ( isdefined( var_2.mountmantlemodel ) )
                    {
                        if ( self.initcircledata != var_2.mountmantlemodel )
                        {
                    ...
                    if ( self.initcirclepoststarttocircleindex != var_2 )
                    {
...
dropkillstreakcratefromscriptedheli( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 thread battle_tracks_shouldstartbattletracks( var_7 );
...
battle_tracks_shouldstartbattletracks( var_0, var_1 )
{
...
airdrop_watchplayerweapon( var_0 )
{
    ...
    var_1 = scripts\engine\utility::_id_13135( "cancel_deploy", "weapon_switch_started" );
...
airdropmarkeractivate( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_2 );
}
...
initbattleroyaleloadoutcratedata()
{
    ...
    var_0.dummymodel = getcratemodelname();
    ...
    var_0.destroycallback = ::contestedtime;
...
print_spawner_score_for_factor()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::client_activate;
    var_0.capturecallback = ::client_hint;
    var_0.destroycallback = ::clientmatchdata_logplayerdeath;
    var_0.force_spawn_all_dead_players = ::clients;
    var_0.destroyoncapture = 1;
}

client_activate( var_0 )
{
...
clientmatchdata_logplayerdeath( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
hud_racetrack_timer( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 250;
    var_8 = level.debug_showcardlocs;
    var_9 = 1000;
    var_10 = 10500;
    var_11 = 7500;
    var_12 = 3000;
    ...
    if ( isdefined( var_15 ) )
    {
        ...
        if ( !var_5 && var_13[2] < var_0[2] )
        {
            ...
            if ( isdefined( var_16 ) )
            {
                ...
                var_15 thread _id_13208();
                var_20 thread _id_13209( var_19 );
            }
            else
                var_15 force_remove_stim();
        }
        else
            var_15 force_remove_stim();
        ...
        var_15._id_1236F = spawn( "script_model", var_1 );
        var_15._id_1236F setmodel( "ks_airdrop_crate_br" );

        if ( !istrue( var_6 ) )
            var_15._id_1236F setscriptablepartstate( "smoke_signal", "on", 0 );

        var_23 = getleveldata( var_14 );

        if ( isdefined( var_23.wztrain_info ) )
            var_15 thread [[ var_23.wztrain_info ]]();
    }
...
printcodechosen()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::control_station_interact;
    var_0.capturecallback = ::controlledcallbacks;
    var_0.destroycallback = ::controlledcallbacksqueue;
    var_0.destroyoncapture = 1;
}

control_station_interact( var_0 )
{

}

controlledcallbacks( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
controlledcallbacksqueue( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
hudattractionobj( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_1236F = spawn( "script_model", var_1 );
        var_2._id_1236F setmodel( "ks_airdrop_crate_br" );
        var_2._id_1236F setscriptablepartstate( "smoke_signal", "on", 0 );
    }
...
hudcost( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_1236F = spawn( "script_model", var_1 );
        var_2._id_1236F setmodel( "ks_airdrop_crate_br" );
        var_2._id_1236F setscriptablepartstate( "smoke_signal", "pe_chopper_on", 0 );
    }
...
printallteamsplundercount()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::commandwatcher;
    var_0.destroycallback = ::comms_crates;
    var_0.activatecallback = ::combo_reset;
    var_0.force_spawn_all_dead_players = ::compare_higher_score;
    var_0.wztrain_info = ::comparekillcounts;
    var_0.destroyoncapture = 1;
}
...
hurt_enabled( var_0, var_1, var_2 )
{
...
_id_1256A( var_0, var_1 )
{
    var_2 = 4096;

    if ( istrue( self.registeronplayerdisconnect ) )
        var_2 = 10000;

    var_3 = hurt_enabled( self.team, var_0 + ( 0, 0, var_2 ), var_0 + ( 0, 0, 512 ) );
    var_3 endon( "death" );
    init_fake_magic_grenades( var_3 );
    eliminate_drone_attack_min_cooldown( var_3 );
    var_4 = [];
...
init_fake_magic_grenades( var_0 )
{
...
printcodeentered()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::create_rig_for_usb_animation;
    var_0.activatecallback = ::create_race;
    var_0.destroycallback = ::create_rocket_death_fx;
    var_0.force_spawn_all_dead_players = ::create_saw_interaction;
    var_0.destroyoncapture = 1;
}
...
idflags_no_dismemberment( var_0 )
{
    ...
    var_3 = var_0 + ( 0, 0, 512 );
    level._id_11D48.lgwperifvfx_plumes = spawnfx( level._effect["smoke_tactical_device"], level._id_11D48.goal_ar - ( 0, 0, 60 ) );
    triggerfx( level._id_11D48.lgwperifvfx_plumes );
    var_4 = dropcrate( undefined, undefined, "battle_royale_tactical_device", var_2, ( 0, randomfloat( 360 ), 0 ), var_3 );
    var_4.skipminimapicon = 1;
    create_score_message( var_4 );
}
...
create_saw_interaction( var_0, var_1 )
{
    self setscriptablepartstate( "crate_audio", "detach", 0 );
}

create_score_message( var_0 )
{
...
getcratemodelname()
{
    var_0 = scripts\engine\utility::ter_op( level.script == "mp_don4" && getdvarint( "scr_br_x2_hype", 0 ), "x2_military_carepackage_01_br", "military_carepackage_01_br" );
    return var_0;
}
