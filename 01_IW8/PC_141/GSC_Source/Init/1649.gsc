...
_id_12273( var_0 )
{
    if ( var_0.basename == "molotov" || var_0.basename == "molotov_mp" || istrue( var_0.registeruniquelootcallback ) )
        return 1;
...
wasdamagedbyexplosive()
{
    if ( isdefined( self.damagemod ) )
    {
        ...
        if ( isdefined( self.damageweapon ) && _id_12273( self.damageweapon ) )
            return 1;
...
allow_init()
{
    ...
    allow_add( "usability_auto_use", ::binocularsstate );
    ...
    allow_add( "offhand_throwback", ::binoculars_watchforads );
    ...
    allow_add( "cp_munitions", ::binoculars_targetisvalid );
    allow_add( "nvg", ::binoculars_used );
    allow_add( "ascender_use", ::binoculars_showtargetmarker );
}
...
binoculars_watchforads( var_0, var_1 )
{
...
binoculars_targetisvalid( var_0, var_1 )
{
...
binoculars_used( var_0, var_1, var_2 )
{
    var_3 = 2;
...
_id_12C2C( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( !isdefined( var_0 ) )
        return;
