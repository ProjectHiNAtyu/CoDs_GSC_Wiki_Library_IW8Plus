...
{
    if ( istrue( self.laser_trap_control_station_interaction_array ) )
        return 1;
...
laser_trap_control_station_interaction_array()
{
    self.laser_trap_control_station_interaction_array = 1;
}

laser_trap_structs()
{
    self.laser_trap_control_station_interaction_array = undefined;
}
