...
ondeploystart( var_0 )
{
    ...
    var_0.owner scripts\common\utility::binoculars_showtargetmarker( 0 );
}
...
ondeployfinished( var_0, var_1 )
{
    ...
    var_0.owner scripts\common\utility::binoculars_showtargetmarker( 1 );
}
    ...
    for (;;)
    {
        ...
        if ( var_4 == var_2 )
        {
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    if ( isdefined( level.runleadmarkers ) )
                        [[ level.runleadmarkers ]]();
...
watchdeployweaponanimtransition( var_0, var_1, var_2 )
{
    ...
    var_4 = scripts\engine\utility::_id_13143( var_1, "death", "weapon_change", "cancel_all_killstreak_deployments" );
...
{
    self endon( "disconnect" );
    var_1 = scripts\engine\utility::_id_13141( var_0, "cancel_remote_sequence" );
    ...
    if ( scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        var_1 = scripts\engine\utility::_id_13141( 0.7, "death" );
...
cleanupdeployweapon( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_6 = scripts\cp_mp\utility\killstreak_utility::removealldeathicons( var_2.basename );
