...
farah_says_cut_wire_green( var_0, var_1 )
{
...
giveplayerscore( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\common\utility::_id_12C2C( level.smoke_enemy_think, var_0 );
...
giveteamscoreforobjective( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    else if ( level.roundscorelimit > 1 && !istrue( level.dontendonscore ) )
    {
        ...
        {
            if ( level scripts\mp\utility\game::resetunresolvedcollision( var_7 ) )
                continue;
    ...
    if ( isdefined( var_5 ) )
        ...
        var_9 = define_as_level_infil_driver( var_2 );

    if ( !istrue( var_4 ) )
        wavesv_finitemode( var_9, var_2, level.waswinning );
...
wavesv_finitemode( var_0, var_1, var_2 )
{
...
playleadtakendialog( var_0 )
{
    ...
    level.lastscorestatustime = gettime();
    var_1 = define_as_level_infil_driver( var_0 );
...
define_as_level_infil_driver( var_0 )
{
...
updateteamscore( var_0 )
{
    if ( scripts\mp\utility\game::resetunresolvedcollision( var_0 ) )
        return;
