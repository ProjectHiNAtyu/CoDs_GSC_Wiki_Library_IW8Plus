...
vehicle_damage_getleveldataforvehicle( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_1 ) )
        {
            ...
            var_4.get_pavelow_boss_info = [];
            var_4.class = "none";
            var_4.physicson = undefined;
            var_4._id_11966 = undefined;
            var_4.pickup_gasmask = undefined;
            var_4.death_impulse = undefined;
...
_id_12F05( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3 ) )
    {
        if ( istrue( var_1 ) )
        {
            ...
            var_3.givelaststandifneeded = undefined;
            var_3.giveloadouteverytime = undefined;
            var_3.giveammo = undefined;
            var_3.givearmorvalue = undefined;
            var_3.pickrandomspawn = undefined;
            var_3.pickrandomvehiclespawn = undefined;
            var_3.picking_up_minigun = undefined;
            var_3.pickprematchrandomloadout = undefined;
        }
        else if ( !istrue( var_2 ) )
        {
...
_id_12F06( var_0, var_1, var_2, var_3 )
{
    var_4 = vehicle_damage_getleveldataforvehicle( var_0, var_2, var_3 );
    var_5 = var_4.get_pavelow_boss_info[var_1];
    ...
    if ( !isdefined( var_5 ) )
    {
        ...
        {
            var_5 = spawnstruct();
            var_4.get_pavelow_boss_info[var_1] = var_5;
            var_5.maxhealth = undefined;
            var_5.too_far_dist = undefined;
            var_5.total_killed = undefined;
        }
...
_id_12F26( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_12F24( var_0 )
{
    ...
    _id_12F26( var_0, 0.85, ::_id_12F15, ::vehicle_damage_lightvisualclearcallback, "light" );
    _id_12F26( var_0, 0.5, ::_id_12F18, ::vehicle_damage_mediumvisualclearcallback, "medium" );
    _id_12F26( var_0, 0.15, ::_id_12F10, ::vehicle_damage_heavyvisualclearcallback, "heavy" );
    _id_12F26( var_0, 0.15, ::_id_12EFF, ::_id_12F00, "engine" );
}
...
_id_12EFA( var_0 )
{
    ...
    _id_12EFC( var_0, "light" );
    _id_12EFC( var_0, "medium" );
    _id_12EFC( var_0, "heavy" );
    _id_12EFC( var_0, "engine" );
}
...
_id_12F19( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isdefined( var_4.thermitestuckpains ) && isdefined( var_4.thermitestuckpains[var_3] ) )
            var_2 = var_2 * var_4.thermitestuckpains[var_3];

        if ( isdefined( var_4.thermiteradiusweaponref ) && isdefined( var_4.thermiteradiusweaponref[var_3] ) )
            var_2 = clamp( var_2, 0, var_4.thermiteradiusweaponref[var_3] );
    }
...
vehicle_damage_init()
{
    ...
    var_0.vehicledata = [];
    var_0._id_11966 = getdvarint( "scr_vehicleDamageStatePristineHealthAdd", 125 );
    var_0.pickup_gasmask = getdvarint( "scr_vehicleDamageStateHeavyHealthAdd", 350 );
    var_0.spawn_claymore_group = getdvarfloat( "scr_vehicleDamageStateMediumHealthRatio", 0.5 );
    var_0.death_impulse = getdvarfloat( "scr_vehicleDamageBurnDownTime", 8 );
    _id_12F16();
...
_id_12F16()
{
    ...
    var_1 = spawnstruct();
    var_0.table = var_1;
    var_1.spawnprotectionexception = [];
    var_1.spawnregions = [];
    var_1.player_give_infinite_rocks = [];
    var_1.player_give_intel_1_ks = [];
    var_1._id_12327 = [];
    var_1._id_12328 = [];
    var_2 = [];
    var_2["class"] = [];
            ...
            foreach ( var_4, var_17 in var_2 )
            {
                foreach ( var_7, var_19 in var_17 )
                {
                    ...
                    if ( isdefined( var_20 ) && var_20 != "" )
                        _id_12F17( var_20, var_11, var_8, var_7, var_4 );
                }
            }
        }
    }
...
_id_12F17( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_2 == "weaponMod" )
    {
        ...
        if ( var_4 == "class" )
        {
            if ( !isdefined( var_6.spawnprotectionexception[var_3] ) )
                var_6.spawnprotectionexception[var_3] = [];

            var_6.spawnprotectionexception[var_3][var_1] = var_7;
        }
        else if ( var_4 == "vehicle" )
        {
            if ( !isdefined( var_6.spawnregions[var_3] ) )
                var_6.spawnregions[var_3] = [];

            var_6.spawnregions[var_3][var_1] = var_7;
        }
    }
    ...
    if ( var_2 == "weaponHPA" )
    {
        ...
        if ( var_4 == "class" )
        {
            if ( !isdefined( var_6.player_give_infinite_rocks[var_3] ) )
                var_6.player_give_infinite_rocks[var_3] = [];

            var_6.player_give_infinite_rocks[var_3][var_1] = var_7;
        }
        else if ( var_4 == "vehicle" )
        {
            if ( !isdefined( var_6.player_give_intel_1_ks[var_3] ) )
                var_6.player_give_intel_1_ks[var_3] = [];

            var_6.player_give_intel_1_ks[var_3][var_1] = var_7;
        }
    }
    ...
    if ( var_2 == "weaponSkipBurnDown" )
    {
        ...
        if ( var_4 == "class" )
        {
            if ( !isdefined( var_6._id_12327[var_3] ) )
                var_6._id_12327[var_3] = [];

            var_6._id_12327[var_3][var_1] = var_7;
        }
        else if ( var_4 == "vehicle" )
        {
            if ( !isdefined( var_6._id_12328[var_3] ) )
                var_6._id_12328[var_3] = [];

            var_6._id_12328[var_3][var_1] = var_7;
        }
    }
}

_id_12EF7( var_0, var_1 )
{
    ...
    if ( isdefined( var_3.spawnprotectionexception[var_5] ) )
    {
        foreach ( var_8, var_7 in var_3.spawnprotectionexception[var_5] )
            _id_12F31( var_8, var_7, 0, var_0 );
    }

    if ( isdefined( var_3.spawnregions[var_0] ) )
    {
        foreach ( var_8, var_7 in var_3.spawnregions[var_0] )
            _id_12F31( var_8, var_7, 0, var_0 );
    }

    if ( isdefined( var_3.player_give_infinite_rocks[var_5] ) )
    {
        foreach ( var_12, var_11 in var_3.player_give_infinite_rocks[var_5] )
        {
            _id_12F33( var_12, var_11, var_0 );
            _id_12F30( var_0, 100, var_12 );
        }
    }

    if ( isdefined( var_3.player_give_intel_1_ks[var_0] ) )
    {
        foreach ( var_12, var_11 in var_3.player_give_intel_1_ks[var_0] )
        {
            _id_12F33( var_12, var_11, var_0 );
            _id_12F30( var_0, 100, var_12 );
        }
...
_id_12F11()
{
    _id_12F32( "iw8_la_gromeo_mp", 5 );
    _id_12F32( "iw8_la_kgolf_mp", 5 );
    _id_12F32( "iw8_la_t9standard_mp", 5 );
    _id_12F32( "iw8_la_rpapa7_mp", 5 );
    _id_12F32( "iw8_la_t9freefire_mp", 5 );
    _id_12F32( "iw8_la_juliet_mp", 6 );
    _id_12F32( "iw8_la_gromeoks_mp", 4 );
    _id_12F32( "iw8_la_mike32_mp", 3 );
    _id_12F32( "iw8_la_t9launcher_mp", 3 );
    _id_12F32( "iw8_ar_mike4_mp", 3 );
    _id_12F32( "iw8_ar_akilo47_mp", 3 );
    _id_12F32( "frag_grenade_mp", 3 );
    _id_12F32( "semtex_mp", 3 );
    _id_12F32( "c4_mp_p", 3 );
    _id_12F32( "at_mine_ap_mp", 3 );
    _id_12F32( "at_mine_mp", 3 );
    _id_12F32( "claymore_mp", 3 );
    _id_12F32( "molotov_mp", 2 );
    _id_12F32( "thermite_mp", 2 );
    _id_12F32( "thermite_av_mp", 1 );
    _id_12F32( "thermite_bolt_mp", 1 );
    _id_12F32( "semtex_bolt_mp", 4 );
    _id_12F32( "thermite_xmike109_mp", 0.5 );
    _id_12F32( "semtex_xmike109_mp", 2 );
    _id_12F32( "semtex_aalpha12_mp", 1 );
    _id_12F32( "apache_proj_mp", 3 );
    _id_12F32( "toma_proj_mp", 3 );
    _id_12F32( "cruise_proj_mp", 15 );
    _id_12F32( "artillery_mp", 3 );
    _id_12F32( "nuke_mp", 15 );
    _id_12F32( "ac130_105mm_mp", 15 );
    _id_12F32( "ac130_40mm_mp", 5 );
    _id_12F32( "ac130_25mm_mp", 1 );
    _id_12F32( "hover_jet_proj_mp", 3 );
    _id_12F32( "assault_drone_mp", 5 );
    _id_12F32( "emp_drone_non_player_mp", 3 );
    _id_12F32( "emp_drone_non_player_direct_mp", 5 );
}

_id_12F12()
{
    _id_12F32( "iw8_la_gromeo_mp", 10 );
    _id_12F32( "iw8_la_kgolf_mp", 10 );
    _id_12F32( "iw8_la_rpapa7_mp", 10 );
    _id_12F32( "iw8_la_t9freefire_mp", 10 );
    _id_12F32( "iw8_la_t9standard_mp", 10 );
    _id_12F32( "iw8_la_juliet_mp", 20 );
    _id_12F32( "iw8_la_gromeoks_mp", 10 );
    _id_12F32( "iw8_la_mike32_mp", 6 );
    _id_12F32( "iw8_la_t9launcher_mp", 6 );
    _id_12F32( "iw8_ar_mike4_mp", 6 );
    _id_12F32( "iw8_ar_akilo47_mp", 6 );
    _id_12F32( "c4_mp_p", 13 );
    _id_12F32( "semtex_mp", 4 );
    _id_12F32( "frag_grenade_mp", 4 );
    _id_12F32( "pop_rocket_mp", 4 );
    _id_12F32( "molotov_mp", 1 );
    _id_12F32( "at_mine_ap_mp", 5 );
    _id_12F32( "at_mine_mp", 13 );
    _id_12F32( "thermite_mp", 1 );
    _id_12F32( "thermite_av_mp", 1 );
    _id_12F32( "emp_grenade_mp", 4 );
    _id_12F32( "claymore_mp", 13 );
    _id_12F32( "thermite_bolt_mp", 1 );
    _id_12F32( "semtex_bolt_mp", 4 );
    _id_12F32( "thermite_xmike109_mp", 0.5 );
    _id_12F32( "semtex_xmike109_mp", 2 );
    _id_12F32( "semtex_aalpha12_mp", 1 );
    _id_12F32( "apache_proj_mp", 3 );
    _id_12F32( "toma_proj_mp", 12 );
    _id_12F32( "cruise_proj_mp", 15 );
    _id_12F32( "artillery_mp", 10 );
    _id_12F32( "nuke_mp", 20 );
    _id_12F32( "ac130_105mm_mp", 15 );
    _id_12F32( "ac130_40mm_mp", 6 );
    _id_12F32( "ac130_25mm_mp", 1 );
    _id_12F32( "hover_jet_proj_mp", 3 );
    _id_12F32( "hover_jet_proj_mp", 3 );
    _id_12F32( "assault_drone_mp", 10 );
    _id_12F32( "emp_drone_non_player_mp", 3 );
    _id_12F32( "emp_drone_non_player_direct_mp", 5 );
}
...
_id_12F13()
{
    _id_12F2B( "specialty_armorpiercing", 0.5, 0 );
}
...
vehicle_damage_isselfdamage( var_0, var_1 )
{
    if ( isdefined( var_1.inflictor ) )
    {
        ...
        var_2 = scripts\cp_mp\vehicles\vehicle::_id_12F49( var_0 );
...
_id_12F3A( var_0, var_1 )
{
    ...
    while ( isdefined( self ) )
    {
        if ( !scripts\cp_mp\vehicles\vehicle_tracking::_issuspendedvehicle() )
        {
            ...
            {
                var_6 = _id_12F06( self.vehiclename, var_0 );
                self thread [[ var_6.too_far_dist ]]( var_0, var_1 );
                return;
            }
...
_id_12F0B()
{
    if ( !isdefined( self.get_pipe_room_spawnpoint ) )
        return "pristine";

    return self.get_pipe_room_spawnpoint;
}

_id_12F2E( var_0, var_1, var_2 )
{
    self notify( "damage_state_change" );

    if ( var_1 != "pristine" )
    {
        var_3 = _id_12F06( self.vehiclename, var_1 );

        if ( isdefined( var_3.total_killed ) )
            self thread [[ var_3.total_killed ]]( var_0, var_2 );
    }

    if ( var_0 != "pristine" )
    {
        var_3 = _id_12F06( self.vehiclename, var_0 );

        if ( isdefined( var_3.too_far_dist ) )
            self thread [[ var_3.too_far_dist ]]( var_1, var_2 );
    }

    self.get_pipe_room_spawnpoint = var_0;
}

_id_12F35( var_0, var_1, var_2 )
{
...
_id_12F38( var_0, var_1, var_2 )
{
    ...
    foreach ( var_10, var_9 in var_3.get_pavelow_boss_info )
    {
    ...
    if ( var_5 != var_11 )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            {
                if ( !istrue( self.handle_truck_spawning ) )
                {
                    var_12 = _id_12F04( undefined, self.vehiclename );
...
_id_12F37( var_0 )
{
    ...
    if ( var_3 != var_4 )
        _id_12F2E( var_3, var_4, var_0 );
}

_id_12EFD( var_0 )
{
    if ( var_0 )
        self.handle_truck_spawning = 1;
    else
        self.handle_truck_spawning = undefined;
}

_id_12F1E( var_0, var_1 )
{
    _id_12F15( var_1, 1 );
}

_id_12F21( var_0, var_1 )
{
    vehicle_damage_lightvisualclearcallback( var_1, 1 );
}

_id_12F1F( var_0, var_1 )
{
    _id_12F18( var_1, 1 );
}
...
_id_12F1C( var_0, var_1 )
{
    ...
    if ( !isdefined( var_0 ) || var_0 != "heavy" )
    {
        ...
        _id_12F1D( var_0, var_1 );
        thread _id_12EF8( var_1 );
    }
}

_id_12F20( var_0, var_1 )
{
...
_id_12F23( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = vehicle_damage_getleveldataforvehicle( var_0, 1 );
    var_6.health = var_1;
    var_6._id_11966 = var_2;
    var_6.pickup_gasmask = var_3;
    var_6.spawn_claymore_group = var_4;
    var_6.death_impulse = var_5;
    var_7 = _id_12F06( var_0, "light", 1 );
    var_7.too_far_dist = ::_id_12F1E;
    var_7.total_killed = ::_id_12F21;
    var_7 = _id_12F06( var_0, "medium", 1 );
    var_7.too_far_dist = ::_id_12F1F;
    var_7.total_killed = ::_id_12F22;
    var_7 = _id_12F06( var_0, "heavy", 1 );
    var_7.too_far_dist = ::_id_12F1C;
    var_7.total_killed = ::_id_12F20;
    _id_12F39( var_0 );
}
...
_id_12F07( var_0, var_1 )
{
    ...
    var_4 = var_3.health;
    var_5 = _id_12F09( var_1 );

    if ( isdefined( var_5 ) )
        var_4 = var_4 + var_5;

    var_6 = _id_12F03( var_1 );
...
_id_12F39( var_0 )
{
    ...
    foreach ( var_6, var_5 in var_1.get_pavelow_boss_info )
    {
        if ( var_6 == "light" )
        {
            var_5.maxhealth = _id_12F0A( undefined, var_0 );
        ...
        if ( var_6 == "heavy" )
        {
            var_5.maxhealth = _id_12F04( undefined, var_0 );
            var_2 = var_5.maxhealth;
        }
    }

    var_5 = var_1.get_pavelow_boss_info["medium"];

    if ( isdefined( var_5 ) )
    {
        if ( isdefined( var_2 ) && isdefined( var_3 ) )
        {
            var_7 = _id_12F08( var_0 );
...
_id_12F09( var_0 )
{
    ...
    var_3 = var_2._id_11966;

    if ( !isdefined( var_3 ) )
        var_3 = var_1._id_11966;
...
_id_12F03( var_0 )
{
    var_1 = vehicle_damage_getleveldata();
    var_2 = vehicle_damage_getleveldataforvehicle( var_0 );
    var_3 = var_2.pickup_gasmask;

    if ( !isdefined( var_3 ) )
        var_3 = var_1.pickup_gasmask;
...
_id_12F08( var_0 )
{
    var_1 = vehicle_damage_getleveldata();
    var_2 = vehicle_damage_getleveldataforvehicle( var_0 );
    var_3 = var_2.spawn_claymore_group;

    if ( !isdefined( var_3 ) )
        var_3 = var_1.spawn_claymore_group;
...
_id_12EF8( var_0 )
{
    ...
    if ( !istrue( self.death_killstreak_watcher ) )
    {
        ...
        if ( isdefined( var_3 ) && isdefined( var_2 ) )
        {
            ...
            wait( var_3 );
            self.death_killstreak_watcher = undefined;
            scripts\cp_mp\pet_watch::door_is_frozen();
...
_id_12F14()
{
    return istrue( self.death_killstreak_watcher );
}
...
_id_12F02( var_0 )
{
    var_1 = vehicle_damage_getleveldata();
    var_2 = vehicle_damage_getleveldataforvehicle( var_0 );
    var_3 = var_2.death_impulse;

    if ( !isdefined( var_3 ) )
        var_3 = var_1.death_impulse;
...
_id_12F34( var_0 )
{
    ...
    if ( isdefined( var_0.objweapon ) && !nullweapon( var_0.objweapon ) && isdefined( self.vehiclename ) )
    {
        ...
        if ( isdefined( var_4.table._id_12328[var_2] ) )
            var_1 = var_4.table._id_12328[var_2][var_3];
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            if ( isdefined( var_4.table._id_12327[var_7] ) )
                var_1 = var_4.table._id_12327[var_7][var_3];
...
_id_12F1D( var_0, var_1 )
{
    if ( isdefined( var_1 ) && isdefined( var_1.attacker ) )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            var_3 = _id_12F05( self, undefined, 1 );
            var_4 = undefined;
            var_5 = undefined;
            var_6 = undefined;
            var_7 = undefined;
            ...
            if ( isdefined( var_3 ) )
            {
                var_4 = var_3.pickrandomspawn;
                var_5 = var_3.pickrandomvehiclespawn;
                var_6 = var_3.picking_up_minigun;
                var_7 = var_3.pickprematchrandomloadout;
            }
            ...
            if ( !istrue( var_1.obj_caches_threaded_nags_vo ) && isplayer( var_1.attacker ) )
                var_1.obj_caches_threaded_nags_vo = scripts\cp_mp\vehicles\vehicle::_id_12F6B( self, var_1.attacker );
            ...
            if ( isdefined( var_1.objweapon ) && weaponclass( var_1.objweapon.basename ) != "rocketlauncher" )
            {
                ...
                if ( istrue( var_7 ) )
                    var_1.brloadoutcratepostcapture = 1;
            }

            var_1.attacker thread _id_12F0F( var_4, var_6, var_1, self );
        }
    }
}
...
_id_12F1B( var_0 )
{
    if ( isdefined( var_0 ) && isdefined( var_0.attacker ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_2 = _id_12F05( self, undefined, 1 );
            var_3 = undefined;
            var_4 = undefined;
            var_5 = undefined;
            var_6 = undefined;
            ...
            if ( isdefined( var_2 ) )
            {
                var_3 = var_2.givelaststandifneeded;
                var_4 = var_2.giveloadouteverytime;
                var_5 = var_2.giveammo;
                var_6 = var_2.givearmorvalue;
            }
            ...
            {
                if ( !isdefined( var_0.obj_caches_threaded_nags_vo ) )
                    var_0.obj_caches_threaded_nags_vo = scripts\cp_mp\vehicles\vehicle::_id_12F6B( self, var_0.attacker );
                else if ( var_0.obj_caches_threaded_nags_vo && scripts\cp_mp\vehicles\vehicle::_id_12F6D( self, var_0.attacker ) )
                    var_0.obj_caches_threaded_nags_vo = 0;
                else if ( !var_0.obj_caches_threaded_nags_vo && scripts\cp_mp\vehicles\vehicle::_id_12F6B( self, var_0.attacker ) )
                    var_0.obj_caches_threaded_nags_vo = 1;
            }
            else
                var_0.obj_caches_threaded_nags_vo = 0;
            ...
            if ( isdefined( var_0.objweapon ) && weaponclass( var_0.objweapon.basename ) != "rocketlauncher" )
            {
                ...
                if ( istrue( var_6 ) )
                    var_0.brloadoutcratepostcapture = 1;
            }

            if ( var_0.obj_caches_threaded_nags_vo && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "challenges", "onVehicleKilled" ) )
            ...
            var_0.attacker _id_12F0E( var_3, var_5, var_0, self getentitynumber() );
        }
    }
}

_id_12F0F( var_0, var_1, var_2, var_3 )
{
    var_4 = var_3 getentitynumber();
    self endon( "disconnect" );
    self endon( "vehicle_damage_giveScoreAndXP" + var_4 );
    waittillframeend;
    thread _id_12F0E( var_0, var_1, var_3, var_4 );
}

_id_12F0E( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_4 = scripts\engine\utility::ter_op( istrue( var_2._id_11F1E ), undefined, var_2.objweapon );
        self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "vehicle_damage", "giveScore" ) ]]( var_0, var_4, !istrue( var_2.obj_caches_threaded_nags_vo ) );
    }

    if ( isdefined( var_1 ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "vehicle_damage", "giveAward" ) )
    {
        var_4 = scripts\engine\utility::ter_op( istrue( var_2.brloadoutcratepostcapture ), undefined, var_2.objweapon );
        self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "vehicle_damage", "giveAward" ) ]]( var_1, var_4, !istrue( var_2.obj_caches_threaded_nags_vo ) );
    }
}

_id_12F31( var_0, var_1, var_2, var_3 )
{
...
_id_12F2A( var_0, var_1, var_2 )
{
    var_3 = vehicle_damage_getleveldataforvehicle( var_0, 1 );

    if ( !isdefined( var_3.thermitestuckpains ) )
        var_3.thermitestuckpains = [];

    var_3.thermitestuckpains[var_1] = var_2;
}

_id_12F29( var_0, var_1, var_2 )
{
    var_3 = vehicle_damage_getleveldataforvehicle( var_0, 1 );

    if ( !isdefined( var_3.thermiteradiusweaponref ) )
        var_3.thermiteradiusweaponref = [];

    var_3.thermiteradiusweaponref[var_1] = var_2;
}
