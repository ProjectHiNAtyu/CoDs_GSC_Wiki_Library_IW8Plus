...
at_mine_use( var_0 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isent( var_3 ) && recondronetracecontents( var_3 ) )
        {
...
at_mine_plant( var_0 )
{
    ...
    if ( istrue( var_0._id_12A53 ) )
        var_0 thread brallowclasschoicefunc();
...
brallowclasschoicefunc()
{
    ...
    self endon( "death" );
    self.branalytics_invalidtablet = ( 0, 0, 0 );
    var_0 = 0.2;
    ...
    for (;;)
    {
        var_1 = self.origin;
        wait( var_0 );
        self.branalytics_invalidtablet = 1 / var_0 * ( self.origin - var_1 );
    }
}

raid_umike_unload_func( var_0 )
{
    return isdefined( var_0 ) && isdefined( var_0.branalytics_invalidtablet ) && length2dsquared( var_0.branalytics_invalidtablet ) > 0.01;
}
...
{
    self endon( "death" );
    self.grenade scripts\engine\utility::_id_13142( var_0, "death", "mine_destroyed" );
...
at_mine_watch_flight()
{
    ...
    if ( var_0 > 0 )
    {
        ...
        if ( raid_umike_unload_func( self ) )
            var_2 = var_2 + self.branalytics_invalidtablet * var_0;
        ...
        if ( var_0 > 0 )
        {
            ...
            childthread scripts\mp\utility\equipment::_id_131C4();
            scripts\engine\utility::_id_13141( var_0, "collision_with_platform" );
...
at_mine_watch_game_end()
{
    self endon( "mine_destroyed" );
    self endon( "death" );
    level scripts\engine\utility::_id_1312D( "game_ended", "bro_shot_start" );
    thread at_mine_destroy();
}
