...
inititems()
{
    ...
    var_0.callbacks["equip_binoculars"]["onGive"] = _attachmentblocks::called50percentprogress;
    var_0.callbacks["equip_binoculars"]["onTake"] = _attachmentblocks::calloutmarkerping_squadleaderbeaconcreate;
...
loadtable()
{
    ...
    for (;;)
    {
        ...
        var_3.removelinkdamagemodifieronlaststand = tablelookupbyrow( "mp/equipment.csv", var_0, 8 ) != "-1";
...
release_ascendstruct_ondeath( var_0 )
{
    if ( isdefined( level.equipment.table[var_0] ) )
        return istrue( level.equipment.table[var_0].removelinkdamagemodifieronlaststand );
    else
        return 0;
}
...
executeoffhandfired( var_0 )
{
    foreach ( var_6, var_2 in self.equipment )
    {
        ...
        if ( isdefined( var_3.objweapon ) && var_0 == var_3.objweapon )
        {
            ...
            scripts\mp\damage::failx1stashquest( var_4 );
...
watchlethaldelay()
{
    ...
    var_0 = get_connected_nodes_targetname_array();
...
watchlethaldelayplayer( var_0, var_1 )
{
    ...
    if ( !isdefined( self.sequence_progression ) || !istrue( self.sequence_progression[var_1] ) )
    {
        if ( !isdefined( self.sequence_progression ) )
            self.sequence_progression = [];

        self.sequence_progression[var_1] = 1;
    ...
    if ( isdefined( self.sequence_progression ) && istrue( self.sequence_progression[var_1] ) )
    {
        self.sequence_progression[var_1] = undefined;

        if ( self.sequence_progression.size == 0 )
            self.sequence_progression = undefined;
...
watchlethaldelayfeedbackplayer( var_0, var_1 )
{
    ...
    var_3 = get_connected_nodes_targetname_array();
...
cancellethaldelay()
{
    ...
    if ( get_connected_nodes_targetname_array() )
        level.lethaldelaystarttime = gettime();
    else
        level.lethaldelaystarttime = scripts\mp\utility\game::gettimepassed();
...
get_connected_nodes_targetname_array()
{
...
hackequipment( var_0 )
{
    ...
    var_0 scripts\cp\helicopter\chopper_boss::totalroundtime( self.equipmentref );
    changeowner( var_0 );
...
numrequireddestinations( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        ...
        var_4._id_11F9A = var_4 getcurrentequipment( var_1 );
        var_4._id_11F99 = getequipmentslotammo( var_1 );
...
_id_128CC( var_0, var_1, var_2, var_3 )
{
    foreach ( var_5 in var_0 )
    {
        ...
        var_7 = var_5._id_11F9A;
        var_8 = var_5._id_11F99;

        if ( isdefined( var_7 ) )
        {
            var_5 giveequipment( var_7, var_1 );
            var_5._id_11F9A = undefined;

            if ( isdefined( var_8 ) )
            {
                var_5 setequipmentammo( var_7, var_8 );
                var_5._id_11F99 = undefined;
            }
        }
    }
}
...
propmatchslope()
{
    level.sequence_interaction_init = [];
    var_0 = 0;

    foreach ( var_2 in level.equipment.table )
    {
        if ( !var_2.removelinkdamagemodifieronlaststand )
            continue;
        ...
        level.sequence_interaction_init[var_2.ref] = 1 << var_0;
        var_0++;
    }
}
