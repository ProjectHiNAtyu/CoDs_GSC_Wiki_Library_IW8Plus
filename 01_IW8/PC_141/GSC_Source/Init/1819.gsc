...
init()
{
    ...
    if ( !scripts\mp\utility\game::relic_amped_test_explode_other_player() )
    {
    ...
    level.requested_veh_spawners = 0;

    if ( var_3 == "sd" || var_3 == "cyber" || var_3 == "arena" )
        level.requested_veh_spawners = 1;
...
onplayerspawned()
{
    ...
    if ( !level.teambased || level.requested_veh_spawners || istrue( level.disablebattlechatter ) || scripts\mp\utility\game::isanymlgmatch() )
        self.bcdisabled = 1;
    else
    {
        if ( !scripts\mp\utility\game::runleanthreadmode() || istrue( level.claymore_crate_update_hint_logic_alt ) )
        {
...
threatcallouttracking()
{
    ...
    for (;;)
    {
        ...
        var_4 = lootchopper_managespawns( self.team );
...
dosound( var_0, var_1 )
{
    ...
    {
        if ( isdefined( self.operatorcustomization.intel_collected ) && self.operatorcustomization.intel_collected != "" )
            var_2 = self.operatorcustomization.intel_collected;
        else
        {
            if ( self.operatorcustomization.intel_collect_vo_func == "none" )
                return;

            var_2 = var_2 + self.operatorcustomization.intel_collect_vo_func;
        }
    }
    ...
    if ( "dx_mpp_stry_mtx_execute_howd_you_think" == var_5 )
        var_5 = "dx_mpp_stry_mtx_execute_howd_you_think_hash";
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() )
        vehicle_compass_mp_shouldbevisibletoplayer( var_6, var_7, var_0, var_5, var_4 );
    else if ( self issplitscreenplayer() )
        vehicle_compass_playerjoinedteamcallback( var_6, var_7, var_0, var_5, var_4 );
    else
        vehicle_compass_mp_init( var_6, var_7, var_0, var_5, var_4 );
    ...
    if ( isdefined( level.bcinfo["additional_local_vo"][var_0] ) && isdefined( self.squadindex ) )
    {
        ...
        if ( soundexists( var_10 ) )
        {
            ...
            if ( !scripts\mp\utility\game::lpcfeaturegated() )
                vehicle_compass_mp_shouldbevisibletoplayer( 1, 1, var_11, undefined, var_10, var_12 );
            else if ( self issplitscreenplayer() )
                vehicle_compass_playerjoinedteamcallback( 1, 1, var_11, undefined, var_10, var_12 );
            else
                vehicle_compass_mp_init( 1, 1, var_11, undefined, var_10, var_12 );
        }
    }
    ...
    scripts\engine\utility::_id_1312D( var_4, "death_or_disconnect" );
    level removespeaker( self, var_14 );
    return 1;
}

vehicle_compass_mp_init( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
vehicle_compass_mp_shouldbevisibletoplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
vehicle_compass_playerjoinedteamcallback( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self getothersplitscreenplayer();
...
{
    var_2 = scripts\engine\utility::_id_13135( var_0, "death_or_disconnect" );
...
location_add_last_callout_time( var_0, var_1 )
{
    ...
    if ( !isdefined( level.scriptable_adddamagedcallback ) )
        level.scriptable_adddamagedcallback = [];

    level.scriptable_adddamagedcallback[var_1] = var_2;
}
...
{
    if ( isdefined( level.scriptable_adddamagedcallback ) && isdefined( level.scriptable_adddamagedcallback[var_0] ) )
        return level.scriptable_adddamagedcallback[var_0];
...
trysaylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.bcinfo["req_friendly"][var_1] && !var_0 friendly_nearby( 4840000 ) && !istrue( level.claymore_crate_update_hint_logic_alt ) )
        return;
    ...
    if ( gettime() > var_0.c130_lights + level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
...
saylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    while ( var_0 <= level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        ...
        {
            var_5 = gettime();
            var_4["higher"]["player"] scripts\engine\utility::_id_1312E( var_4["higher"]["sound_alias"], "death", "disconnect" );
            waitframe();
