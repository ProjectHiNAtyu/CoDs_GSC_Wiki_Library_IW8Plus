...
{
    var_0 = spawnstruct();
    level.vehicle.timer_sequence = var_0;
    var_0.vehicledata = [];
}

vehomn_setvehicle( var_0, var_1 )
{
    var_2 = _id_1301F( var_0 );
    var_3 = var_2.id;
...
{
    var_4 = _id_1301F( var_0 );
    var_5 = var_4.bomb_vest_success_fail_think[var_1];
    var_6 = undefined;
...
{
    var_3 = _id_1301F( var_2 );
    var_4 = var_3._id_131A7[var_0];

    if ( isdefined( var_1 ) )
    {
        var_5 = var_3._id_131AB[var_0];
...
vehomn_clearwarnings( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
            var_2 = _id_1301F( var_1, undefined, 1 );
        ...
        if ( isarray( var_0 ) )
        {
            foreach ( var_4 in var_0 )
            {
                if ( isdefined( var_4 ) && isplayer( var_4 ) )
                {
                    ...
                    if ( isdefined( var_2 ) )
                    {
                        foreach ( var_6 in var_2._id_131A8 )
                        {
                            if ( isdefined( var_6 ) )
                                thread [[ var_6 ]]( var_4 );
                        }
...
_id_1301C( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( isarray( var_0 ) )
        {
            ...
            {
                if ( isdefined( var_2 ) && isplayer( var_2 ) )
                    thread _id_1301D( var_2 );
            }
        }
        else if ( isplayer( var_0 ) )
            thread _id_1301D( var_0 );
    }
}
...
_id_1301D( var_0 )
{
    ...
    if ( !isdefined( var_0._id_13025 ) || var_0._id_13025 != "hide" && var_0._id_13025 != "fadeOut" )
    {
        var_0._id_13025 = "fadeOut";
        var_0 setclientomnvar( "ui_veh_controls", 2 );
        wait 3;
        thread _id_13021( var_0 );
    }
}
...
_id_1301B( var_0 )
{
    return !isdefined( var_0._id_13025 ) || var_0._id_13025 == "fadeOut" || var_0._id_13025 == "hide";
}

_id_1301E()
{
    return level.vehicle.timer_sequence;
}

_id_1301F( var_0, var_1, var_2 )
{
    var_3 = _id_1301E();
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_1 ) )
        {
            ...
            var_4.seatids = [];
            var_4.bomb_vest_success_fail_think = [];
            var_4._id_11DF2 = [];
            var_4._id_131A7 = [];
            var_4._id_131AB = [];
            var_4._id_131A9 = [];
            ...
            var_4._id_11DF3 = [];
            var_4.id = undefined;
            var_4._id_131A7["burningDown"] = 1;
            var_4._id_131A7["missileLocking"] = 2;
            var_4._id_131A7["missileIncoming"] = 4;
            var_4._id_131A7["movementDisabled"] = 3;
        }
...
_id_1301A( var_0, var_1, var_2 )
{
    var_3 = _id_1301F( var_0, var_1, var_2 );

    if ( isdefined( var_3 ) )
    {
        var_3.seatids = [];
        var_3.bomb_vest_success_fail_think = [];
        var_3._id_11DF2 = [];
        var_3._id_131A7 = [];
        var_3._id_131AB = [];
        var_3._id_131A9 = [];
...
vehomn_updateomnvarsonseatenter( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( isdefined( var_8._id_131A7["movementDisabled"] ) )
            vehomn_showwarning( "movementDisabled", var_3, var_0.vehiclename );
    }

    if ( var_0 scripts\cp_mp\vehicles\vehicle_damage::_id_12F14() )
    {
        if ( isdefined( var_8._id_131A7["burningDown"] ) )
...
_id_13023( var_0, var_1 )
{
    ...
    var_2 = _id_1301F( var_0.vehiclename, undefined, 1 );
        ...
        if ( isdefined( var_3 ) && var_3.size > 0 )
        {
            foreach ( var_6, var_5 in var_3 )
            {
                if ( isdefined( var_5 ) && isplayer( var_5 ) && var_5 scripts\cp_mp\utility\player_utility::_isalive() )
                    _id_12EB9( var_0, var_5, var_6, var_1 );
            }
        }
    }
}

_id_12EB9( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_2 ) )
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getoccupantseat( var_0, var_1 );

    _id_13024( var_0, var_1, var_2, var_3 );
}
...
_id_13024( var_0, var_1, var_2, var_3 )
{
    var_4 = _id_1301F( var_0.vehiclename );

    if ( var_4._id_11DF3.size > 0 && isdefined( var_4._id_11DF3[var_2] ) )
    {
        var_5 = 0;

        if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F91( var_0, var_2 ) )
            var_5 = 1;
        else
        {
        ...
        if ( var_5 )
        {
            ...
            {
                var_8 = var_4._id_11DF3[var_2][var_0.objweapon.basename];
        ...
        var_13 = _id_13020( var_0, var_3 );

        if ( isdefined( var_13 ) )
        {
            foreach ( var_15, var_8 in var_4._id_11DF3[var_2] )
            {
...
_id_13020( var_0, var_1 )
{
    if ( isdefined( var_1 ) && isdefined( var_1.setlowermessageomnvarref ) )
        return var_1._id_11DF1;
