...
superdeadsilence_endsuper( var_0 )
{
    ...
    scripts\cp\helicopter\chopper_boss::total_successful_vehicle_spawns( "super_deadsilence", self.deadsilencekills );
...
superdeadsilence_onkill()
{
    if ( scripts\mp\utility\game::getgametype() != "infect" )
    {
        ...
        var_0 = scripts\mp\supers::minigun_wait_between_shots( "super_deadsilence" );

        if ( self.deadsilencekills > var_0 )
        {
            var_1 = self.deadsilencekills - var_0;
            scripts\mp\supers::fake_digit_pool( "super_deadsilence", var_1 );
        }
    }
...
applyfovpresentation()
{
    ...
    var_1 = var_0 - 2;
    scripts\engine\utility::_id_13147( var_1, "super_use_finished" );
...
_id_12837()
{
    ...
    level scripts\engine\utility::_id_1312D( "game_ended", "prematch_cleanup" );
