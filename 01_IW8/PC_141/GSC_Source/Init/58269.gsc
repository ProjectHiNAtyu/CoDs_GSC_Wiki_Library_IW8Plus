...
_id_12F1A()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveScore", ::_id_12F0D );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveAward", ::_id_12F0C );
}

_id_12F0D( var_0, var_1, var_2 )
{
    if ( istrue( var_2 ) )
