...
spawn_chopper_carepackage()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "medium_transport", 1 );
    var_0.id = 11;
...
spawn_carried_punchcard_if_player_down()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "medium_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "medium_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "medium_transport", 13 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "medium_transport", ::med_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "med_transport_mp", 3 );
}
...
med_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "medium_transport", var_0 );
