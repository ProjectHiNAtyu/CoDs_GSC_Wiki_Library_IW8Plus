...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "watchForPlayerEnteringLastStand", ::shutdowngulagforalivecount );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "handleMovingPlatform", ::shutdownattractionicontrigger );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "allowPickupOfTurret", ::shut_down_station );
}
...
shutdownattractionicontrigger( var_0 )
{
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_1.set_relic_gun_game = var_0.staytoasty;
        var_1.angleoffset = var_0.stayfrosty;
        var_1.endonstring = "carried";
        var_1.deathoverridecallback = ::signalomnvar;
...
shutdowngulagforalivecount()
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::siege_bot_team_had_advantage( "last_stand_start" );
