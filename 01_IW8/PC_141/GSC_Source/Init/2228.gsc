...
runcruisepredator( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::islargemap() || scripts\common\utility::iscp() || scripts\cp_mp\utility\game_utility::registersmallmap() )
        var_5 = self.origin;
...
generatenumbercode( var_0, var_1, var_2 )
{
    self endon( "death" );
    ...
    if ( isdefined( self ) )
    {
        generate_solution( var_0, var_1, var_2 );
        self delete();
    }
}
...
cruisepredator_followmissilepod( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !istrue( var_2 ) )
    {
        ...
        var_0 thread generatenumbercode( var_3, var_12, var_13 );
        var_0 thread generatenumbercode_array( "disconnect" );
        var_0 thread generatenumbercode_array( "joined_team" );
        var_0 thread generatenumbercode_array( "joined_spectators" );
    }
...
cruisepredator_takecontrol( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 thread generatecodestoshow( var_1 );
    ...
    var_7 thread generatenumbercode_array( "disconnect" );
    var_7 thread generatenumbercode_array( "joined_team" );
    var_7 thread generatenumbercode_array( "joined_spectators" );
...
cruisepredator_watchmissileexplosion( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        if ( !istrue( var_3 ) )
        {
            ...
            var_1 scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_9 );
        }
    }
...
cruisepredator_returnplayer( var_0, var_1 )
{
    ...
    level thread scripts\cp_mp\utility\killstreak_utility::_id_11D26( self );
    var_0 notify( "killstreak_finished_with_deploy_weapon" );
}
...
generatenumbercode_array( var_0 )
{
    self endon( "death" );
    self endon( "disowned" );
    level endon( "game_ended" );
