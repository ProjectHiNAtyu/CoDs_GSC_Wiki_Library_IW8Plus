...
snapshot_grenade_watch_flight( var_0 )
{
    ...
    if ( istrue( var_1._id_12A53 ) )
        var_1 thread initbunkeranims();
    ...
    if ( var_8 > 0 )
    {
        ...
        if ( isdefined( var_1.scriptable_door_get_in_radius ) )
        {
            var_5 = scripts\mp\vehicles\vehicle_compass_mp::rear_minigun_speed( var_1.scriptable_door_get_in_radius );

            if ( var_5 )
                var_4 linkto( var_1.scriptable_door_get_in_radius );
        }
        ...
        var_1 childthread scripts\mp\utility\equipment::_id_131C4();
        var_1 scripts\engine\utility::_id_13141( var_11, "collision_with_platform" );
    }
    else
    {
        var_4.angles = var_9;
...
snapshot_grenade_detect()
{
    ...
    var_6 = arena_bot_seek_dropped_weapon( var_1, 540 );
...
_id_1237C( var_0, var_1, var_2 )
{
    ...
    if ( 1 )
    {
        var_3 = scripts\mp\utility\game::relic_amped_play_beep();
...
arena_bot_seek_dropped_weapon( var_0, var_1 )
{
    var_2 = arena_bot_think_seek_dropped_weapons( var_0, var_1 );
    var_3 = [];
    var_4 = var_1 * var_1;
...
arena_bot_think_seek_dropped_weapons( var_0, var_1 )
{
