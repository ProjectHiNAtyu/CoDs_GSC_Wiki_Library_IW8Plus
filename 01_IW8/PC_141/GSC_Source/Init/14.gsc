...
codecallback_playeractive()
{
    ...
    if ( isdefined( level.delay_explosion_fx ) )
        [[ level.delay_explosion_fx ]]();
}
...
setupdamageflags()
{
    ...
    level.playerplunderbankdepositcallback = 512;
    level.playerplunderbankdeposit = 1024;
    level.playerplunderevent = 2048;
    level.playerplunderdepositcallback = 4096;
    level.playerplunderdeposit = 8192;
    level.playerplunderdrop = 16384;
    level.idflags_br_turret_x2 = 32768;
    level.idflags_br_cart_x2 = 65536;
...
abortlevel()
{
    ...
    level.delay_explosion_fx = ::callbackvoid;
