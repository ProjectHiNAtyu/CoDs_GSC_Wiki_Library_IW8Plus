...
tac_rover_initoccupancy()
{
    ...
    var_3.tomastrike_watchgameend = "ping_vehicle_driver";
    var_2 = "fr_passenger";
    var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "tac_rover", var_2, 1 );
    var_3.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_2, var_1 );
    ...
    var_3.tomastrike_watchgameend = "ping_vehicle_rider";
    var_2 = "bl_passenger";
    var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "tac_rover", var_2, 1 );
    var_3.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_2, var_1 );
...
tac_rover_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12F53( "tac_rover", "single", [ "driver", "fr_passenger", "bl_passenger", "br_passenger" ] );
}

_id_12899()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "tac_rover", 1 );
    var_0.id = 3;
...
_id_12898()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "tac_rover", 750 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "tac_rover" );
    var_0.class = "light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "tac_rover" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "tac_rover", 5 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_12F30( "tac_rover", 8, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "tac_rover", ::tac_rover_deathcallback );
}

_id_12897()
{
    var_0 = _applydvarstosettings::_id_12EC9( "tac_rover", 1 );
    var_0.brc130airdropcratedestroycallback = 1.83333;
    var_0.getignoreprops = 0.79166;
    var_0.get_next_open_stop = 350;
    var_0.get_next_rein_group = 525;
    var_0.get_next_cypher_id_from_pool = 875;
    var_0.get_node_closest_to_target_loc = 6.25;
    var_0.get_num_dogtag_in_kill_zone_or_under_bridge_zone = 25;
    var_0.get_next_track_index = 50;
...
tac_rover_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "tac_rover", var_0 );
