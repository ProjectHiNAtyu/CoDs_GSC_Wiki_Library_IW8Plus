...
cargo_truck_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12F53( "cargo_truck", "single", [ "driver" ] );
}

disable_bomb_detonator_interactivity()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "cargo_truck", 1 );
    var_0.id = 8;
...
disable_back_light()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "cargo_truck", 3500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cargo_truck" );
    var_0.class = "heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "cargo_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "cargo_truck", 20 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "cargo_truck", ::cargo_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "cargo_truck_mp", 5 );
}

disable_all_turrets_permanently()
{
    var_0 = _applydvarstosettings::_id_12EC9( "cargo_truck", 1 );
...
cargo_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "cargo_truck", var_0 );
