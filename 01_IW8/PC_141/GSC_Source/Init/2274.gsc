...
vehicle_spawn_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) && istrue( var_1 ) )
    {
        ...
        var_3._id_129E5 = undefined;
        var_3._id_11D08 = undefined;
        var_3._id_129E6 = undefined;
    }
...
vehicle_spawn_init()
{
    ...
    var_0._id_11D09 = getdvarint( "scr_respawnVehicleDelayOverride", 0 );
    var_0.ai_molotov_used = getdvarint( "scr_abandonedVehicleTimeoutOverride", 0 );
    var_0._id_11D08 = getdvarint( "scr_respawnVehicleDelay", 60 );
    var_0.ai_molotov_swapp = getdvarint( "scr_abandonedVehicleTimeout", 30 );
...
_id_12FC9( var_0, var_1, var_2 )
{
    ...
    if ( var_4._id_11D09 != 0 )
        var_5 = var_4._id_11D09;
    else if ( isdefined( var_3._id_11D08 ) )
        var_5 = var_3._id_11D08;
    else
        var_5 = var_4._id_11D08;
...
_id_12FCA()
{
    ...
    if ( istrue( self.helipad_getheli ) )
        return;
    ...
    if ( !isdefined( var_0.ai_molotov_swap ) )
        return;
    ...
    if ( var_1.ai_molotov_used != 0 )
        var_2 = var_1.ai_molotov_used;
    else if ( isdefined( var_0.ai_molotov_swapp ) )
        var_2 = var_0.ai_molotov_swapp;
    else
        var_2 = var_1.ai_molotov_swapp;
...
{
    _id_12FC7();
    self.helipad_getheli = 1;
    var_0 = vehicle_spawn_getleveldataforvehicle( self.vehiclename );
    self thread [[ var_0.ai_molotov_swap ]]();
}

_id_12FBF()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::_id_12F0B();
    ...
    if ( var_0 != "heavy" )
    {
        ...
        scripts\cp_mp\vehicles\vehicle_damage::_id_12F2E( "heavy", var_0 );
    }
}
