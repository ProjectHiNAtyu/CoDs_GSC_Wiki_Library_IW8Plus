...
hoopty_truck_init()
{
    ...
    player_has_grenade_crate();
    player_has_ammo_crate();
    hoopty_truck_initfx();
...
player_has_grenade_crate()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "hoopty_truck", 1 );
    var_0.id = 12;
...
player_has_ammo_crate()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "hoopty_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty_truck" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "hoopty_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "hoopty_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "hoopty_truck", ::hoopty_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "hoopty_truck_mp", 3 );
}
...
hoopty_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "hoopty_truck", var_0 );
