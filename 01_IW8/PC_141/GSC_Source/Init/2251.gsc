...
clearlockedon( var_0 )
{
    ...
    {
        if ( isdefined( var_0.players_in_correct_volume ) )
            var_0 thread [[ var_0.players_in_correct_volume ]]();
    }

    var_0.hasincoming = undefined;
    var_0.players_in_aggro = undefined;
    var_0.players_in_correct_volume = undefined;
}
...
amounttotal( var_0 )
{
    ...
    {
        if ( isdefined( var_0.players_in_aggro ) )
            var_0 thread [[ var_0.players_in_aggro ]]();
    }
...
_id_12124( var_0, var_1 )
{
    var_0.players_in_aggro = var_1;
}

_id_12125( var_0, var_1 )
{
    var_0.players_in_correct_volume = var_1;
}
...
watchtargetlockedontobyprojectile( var_0, var_1 )
{
    ...
    addlockedon( var_0 );
    amounttotal( var_0 );
    var_1 scripts\engine\utility::_id_1312D( "death", "clearTargetLockedOntoByProjectile" );
...
resetmissilelaunchertargets( var_0 )
{
