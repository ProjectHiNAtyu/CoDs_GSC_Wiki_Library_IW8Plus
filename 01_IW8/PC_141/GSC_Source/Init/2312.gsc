...
runnvg()
{
    ...
    if ( !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) )
    {
        ...
        thread blank_relic_func();
    }
    else
        scripts\common\utility::binoculars_used( 1, undefined, 1 );
...
nvg_monitor()
{
    ...
    for (;;)
    {
        var_1 = scripts\engine\utility::_id_13135( "night_vision_on", "night_vision_off" );
...
nvg_update3rdperson( var_0 )
{
    ...
    if ( istrue( self.relic_doubletap_helper ) )
        return;
