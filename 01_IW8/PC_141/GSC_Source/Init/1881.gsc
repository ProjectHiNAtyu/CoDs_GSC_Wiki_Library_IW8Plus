...
player_update_unresolved_collision( var_0, var_1 )
{
    ...
    if ( self.unresolved_collision_count >= var_2 )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            {
                var_4 = isdefined( self.scoreleadchanged ) && gettime() - self.scoreleadchanged <= 250;

                if ( var_4 || var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() && !scripts\cp_mp\vehicles\vehicle::_id_12F41( var_0, self ) )
                {
...
player_unresolved_collision_watch()
{
    ...
    for (;;)
    {
        ...
        if ( vehicle_getteamfriendlyto( var_0 ) )
            continue;
...
vehicle_getteamfriendlyto( var_0 )
{
    ...
    if ( isdefined( var_0.display_mission_failed_text ) )
        var_1 = 1;
...
unresolved_collision_nearest_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level.findnewplunderextractsite ) )
    {
        var_3 = self [[ level.findnewplunderextractsite ]]( var_0, var_1, var_2 );
    ...
    if ( isdefined( var_2 ) )
    {
        if ( scripts\cp_mp\utility\game_utility::islargemap() )
        {
            ...
            else if ( isdefined( level.spawnerindex ) && [[ level.spawnerindex ]]( var_0, var_2 ) )
                return;
        }
        else
        {
...
handle_moving_platform_touch( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0.upload_station_players_manager ) && var_0.upload_station_players_manager )
        {
            if ( scripts\mp\equipment\claymore::recondronetracecontents( var_1 ) )
            {
                waitframe();
                continue;
            }
        ...
        if ( !istrue( var_0._id_1232E ) )
            thread process_moving_platform_death( var_0, var_1 );

        self._id_12A53 = 1;
        self.scriptable_door_get_in_radius = var_1;
        thread usb_keys();
        break;
    }
}
...
{
    self endon( "death" );
    self.scriptable_door_get_in_radius waittill( "death" );
...
handle_moving_platforms( var_0 )
{
    ...
    if ( isdefined( var_0.linkparent ) )
    {
        ...
        {
            if ( isdefined( var_0.set_relic_gun_game ) )
                self linkto( var_0.linkparent, "", var_0.set_relic_gun_game, var_0.angleoffset );
            else
