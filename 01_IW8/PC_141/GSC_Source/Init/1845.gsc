...
dopotgkillcamforplayer()
{
    ...
    var_1 = scripts\engine\utility::_id_1313C( "begin_killcam", "killcam_ended" );
...
skipkillcamduringdeathtimer( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        var_1 = scripts\engine\utility::_id_13135( "killcam_death_done_waiting", "killcam_death_button_cancel" );
