...
startchoppergunnerintro( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\killstreak_utility::molotov_crate_update_hint_logic_alt();
    var_4 = ( 0, 0, 0 );
    ...
    else if ( istrue( var_0.playertracking ) && level.script == "cp_so_aniyah" )
    {
        ...
        while ( level.temp_debug_wait_and_stop_music_loop.size == 0 )
            waitframe();

        var_20 = scripts\engine\utility::getclosest( var_19, level.temp_debug_wait_and_stop_music_loop );
    ...
    if ( istrue( var_0.playertracking ) && level.script == "cp_so_aniyah" )
    ...
    var_24.playertracking = istrue( var_0.playertracking );
    var_24 setvehicleteam( var_24.team );
    var_24 thread end_reach_exhaust_waste( "disconnect", var_1 );
    var_24 thread end_reach_exhaust_waste( "joined_team", var_1 );
    var_24 thread end_reach_exhaust_waste( "joined_spectator", var_1 );
    var_27 = 2000;
    ...
    var_29 = var_24 end_paratroopers_group( 4.25 );
...
end_reach_exhaust_waste( var_0, var_1 )
{
    var_2 = self.owner;
    self endon( "death" );
...
choppergunner_startremotecontrol( var_0 )
{
    ...
    thread end_reach_icbm_launch( "disconnect" );
    thread end_reach_icbm_launch( "joined_team" );
    thread end_reach_icbm_launch( "joined_spectator" );
    thread end_reach_icbm_launch( "team_kill_punish" );
    thread choppergunner_watchkills();
    thread choppergunner_handledestroyed( var_0 );
    thread choppergunner_notifyonkillstreakover();

    if ( !self.playertracking )
    {
...
choppergunner_updatetargetmarkergroups( var_0 )
{
    ...
    if ( istrue( level.handlematchscoreboardinfo ) )
        return;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_1312E( "leaving", "death", "explode" );
...
choppergunner_watchendstrobefx( var_0 )
{
    self endon( "death" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_1312D( "death", "leaving" );
    self delete();
}
...
choppergunner_handlemissilefire( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self.playertracking && self.missilesleft == 8 )
            childthread end_origin_final();
        ...
        var_17 thread end_pipe_room( self.owner, 2, 300, 300 );
...
choppergunner_watchturretfire( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.streakinfo.shots_fired++;
        var_1 thread end_pipe_room( self.owner, 0.5, 256, 200 );
    }
}
...
choppergunner_returnplayer( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            level thread scripts\cp_mp\utility\killstreak_utility::_id_11D26( var_2 );
            var_2 setclientomnvar( "ui_apache_screens_state", 0 );
            var_2 painvisionon();
            var_2 scripts\cp_mp\utility\killstreak_utility::killstreak_restorenvgstate();
...
{
    thread scripts\cp_mp\emp_debuff::vandalize( self.owner, 5 );
    choppergunner_updatetargetmarkergroups();
}
...
end_pipe_room( var_0, var_1, var_2, var_3 )
{
    level endon( "game_ended" );
