...
findteammatebuddyspawn( var_0 )
{
    ...
    var_1 = spawnstruct();
    var_1._id_12585 = undefined;
    var_1._id_12514 = ( 0, var_0.angles[1], 0 );
    var_1 = dialog_monitor_shieldraise( var_1, var_0 );

    if ( !isdefined( var_1._id_12585 ) )
    {
        var_1._id_12585 = var_0.origin;
        var_1._id_12514 = var_0.angles;
    }
    ...
    if ( isdefined( var_0.vehicle ) )
    {
        ...
        if ( var_2.size > 0 && istrue( scripts\cp_mp\vehicles\vehicle_interact::vehicle_interact_vehiclecanbeused( var_0.vehicle ) ) )
        {
            ...
            var_1._id_12585 = var_0.vehicle.origin;
            var_1._id_12514 = var_0.vehicle.angles;
            self.spawningintovehicle = 1;
            scripts\mp\utility\stats::incpersstat( "spawnSelectVehicle", 1 );
        }
        else if ( !isdefined( var_1._id_12585 ) )
        {
            var_1._id_12585 = var_0.vehicle.origin + anglestoforward( var_0.vehicle.angles ) * -200 + ( 0, 0, 64 );
            var_1._id_12514 = ( 0, var_0.vehicle.angles[1], 0 );
        }
    }

    var_4 = spawnstruct();
    var_4.origin = var_1._id_12585;
    var_4.angles = var_1._id_12514;
    var_4.index = -1;
    var_4.buddyspawn = 1;
...
dialog_monitor_shieldraise( var_0, var_1 )
{
    var_2 = 16;
    var_3 = 64;
    var_4 = 64;
    ...
    while ( var_8 < var_7 )
    {
        ...
        if ( var_20["fraction"] > var_2 / var_3 )
        {
            ...
            if ( var_25["fraction"] < 1 )
            {
                ...
                var_0._id_12585 = var_25["shape_position"];
                var_0._id_12514 = var_26;
                break;
            }
            else
                continue;
...
findbuddypathnode( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && var_3.size > 0 )
    {
        ...
        {
            if ( isdefined( level.brpickupscriptableid ) && scripts\engine\utility::array_contains( level.brpickupscriptableid, var_7 ) )
                continue;
...
_id_1262D()
{
    ...
    for (;;)
    {
        var_0._id_12585 = undefined;
        var_0._id_12514 = undefined;
        var_0 = dialog_monitor_shieldraise( var_0, self );
        var_1 = 0;

        if ( !isdefined( var_0._id_12585 ) )
        {
            var_0._id_12585 = self.origin;
            var_0._id_12514 = self.angles;
            var_1 = 1;
        }

        thread scripts\cp_mp\utility\debug_utility::drawsphere( var_0._id_12585, 16, 0.1, scripts\engine\utility::ter_op( var_1, ( 1, 0, 0 ), ( 0, 1, 0 ) ) );
        thread scripts\cp_mp\utility\debug_utility::drawangles( var_0._id_12585, var_0._id_12514, 0.1, 1.0 );
        wait 0.1;
    }
}
