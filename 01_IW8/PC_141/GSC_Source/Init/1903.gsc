...
setplayerscoreboardinfo()
{
    ...
    if ( var_0 < 200 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_12 = scripts\mp\gametypes\br::defend_spawn_crates( self );
            ...
            {
                var_15 = scripts\mp\gamescore::new_col_map();
                var_16 = var_15[self.team];
                setclientmatchdata( "players", self.clientmatchdataid, "placement", var_16 );
                var_17 = scripts\mp\gametypes\br_gametype_dmz::trial_turrets_killed();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
                var_18 = 0;

                if ( isdefined( self.setupmissionwidget ) )
                    var_18 = self.setupmissionwidget;

                setclientmatchdata( "players", self.clientmatchdataid, "extrascore5", var_18 );
            }
            else if ( scripts\mp\utility\game::namehud() == "kingslayer" )
            {
                var_15 = scripts\mp\gamescore::new_col_map();
                var_16 = var_15[self.team];
                setclientmatchdata( "players", self.clientmatchdataid, "placement", var_16 );
                var_17 = scripts\mp\gametypes\br_gametype_kingslayer::trial_turrets_killed();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
                var_18 = 0;
            ...
            else if ( scripts\mp\utility\game::namehud() == "rebirth" )
            {
                if ( isdefined( self._id_12941 ) )
                    setclientmatchdata( "players", self.clientmatchdataid, "placement", self._id_12941 );

                var_17 = scripts\mp\gametypes\br_gametype_rebirth::create_agent_definition();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
            }
            else if ( isdefined( self._id_12941 ) )
                setclientmatchdata( "players", self.clientmatchdataid, "placement", self._id_12941 );
        }
        ...
        foreach ( var_3 in level.teamnamelist )
        {
            if ( scripts\mp\menus::shouldmodesetsquads() )
            {
                foreach ( var_5 in level.squaddata[var_3] )
                {
                    ...
                    {
                        scripts\mp\gamelogic::br_pickupdenyalreadyhaverevive( var_8 );
