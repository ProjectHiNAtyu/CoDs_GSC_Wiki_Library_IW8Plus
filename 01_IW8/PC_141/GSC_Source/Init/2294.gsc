...
bot_get_ambush_trap_item( var_0, var_1, var_2 )
{
    ...
    foreach ( var_10 in var_3 )
    {
        ...
        {
            if ( scripts\mp\bots\bots_util::checkpoint_carepkg_spawns( var_10, var_7 ) )
            {
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        if ( var_18 )
        {
            ...
            if ( var_19 == "goal" )
            {
                ...
                {
                    thread scripts\mp\bots\bots_util::check_if_frozen( 4.0 );
                    var_20 = ( 0, 0, 0 );
                    ...
                    if ( isdefined( var_0["item_action"] ) )
                        checksolospawnselections( var_0["item_action"] );
                    ...
                    scripts\engine\utility::_id_13142( var_21, "missile_fire", "grenade_fire" );
                    wait 0.05;
...
bot_defend_think( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        var_22 = scripts\engine\utility::_id_13145( var_29, "node_relinquished", "goal_changed", "script_goal_changed", "defend_force_node_recalculation", "bad_path" );
    ...
    for (;;)
    {
        if ( self.tactical_goals.size > 0 && !scripts\mp\bots\bots_util::bot_is_remote_or_linked() )
        {
            ...
            if ( !isdefined( var_0.abort ) )
            {
                ...
                if ( istrue( var_0.exfil_enemy_spawning ) )
                    self botclearscriptgoal();

                self botsetscriptgoal( var_0.goal_position, var_0.goal_radius, var_1, var_0.goal_yaw, var_0.objective_radius, var_0._id_12243 );
...
bot_new_tactical_goal( var_0, var_1, var_2, var_3 )
{
    ...
    var_4._id_12243 = var_3._id_12243;
    var_4.travelspeed = var_3.travelspeed;
    var_4.exfil_enemy_spawning = var_3.exfil_enemy_spawning;
