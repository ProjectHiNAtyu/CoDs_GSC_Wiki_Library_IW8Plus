...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "playOperatorUseLine", ::jugg_playoperatoruseline );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "canReload", scripts\mp\juggernaut::restartcircleelimination );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "canUseWeaponPickups", scripts\mp\juggernaut::restartwrapper );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "getMinigunWeapon", scripts\mp\juggernaut::retreat_vehicle_collision_clear );
}
...
juggernautweaponpickedup( var_0, var_1 )
{
    ...
    self.update_hint_logic_juggernaut = 1;
