...
killstreak_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistDataForceCredit", scripts\mp\killstreaks\killstreaks::_id_12DFD );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistData", scripts\mp\killstreaks\killstreaks::_id_12DFC );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "processScrapAssist", scripts\mp\events::_id_1197E );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayersInRange", scripts\mp\gametypes\br_killstreaks::get_player_enemy );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayer", scripts\mp\gametypes\br_killstreaks::get_player_drone );
}
...
entity_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "entity", "isGondolaBrush", scripts\mp\gametypes\br_gondola::reader );
}
...
player_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "freezeControlsDebug", scripts\mp\utility\player::add_client_back_to_mask_after_delay );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "getStanceTop", scripts\mp\utility\player::nag_player_remind_lore_vo );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "loadout_finalizeWeapons", scripts\mp\class::setarenaomnvar );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isInLastStand", scripts\mp\utility\player::relic_focusfire_modifyplayerdamage );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isPlayerOnIntelChallenge", scripts\mp\gametypes\br_maphints::remove_bank_lbravos );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "carriable_useAscender", scripts\cp\vehicles\little_bird_mg_cp::display_hint_forced );
}
...
game_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "getSubGameType", scripts\mp\utility\game::namehud );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "brGetOperatorTeam", scripts\mp\gametypes\br_public::codecorrectlyenteredbyanyone );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "gameFlag", scripts\mp\flags::gameflag );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "isPointInBounds", scripts\mp\outofbounds::relic_count );
}
...
weapons_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getDefaultWeaponBaseName", scripts\mp\utility\weapon::missions_clearinappropriaterewards );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "attachmentIsSelectable", scripts\mp\utility\weapon::branalytics_landing );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "remapAttachmentParentName", scripts\mp\utility\weapon::_id_11C3D );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getWeaponMenuCategory", scripts\mp\utility\weapon::nodetype );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getWeaponRarity", scripts\mp\utility\weapon::getweaponrarity );
}
...
sound_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sound", "playKillstreakDeployDialog", scripts\mp\battlechatter_mp::wave_aggro_array );
...
rank_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "rank", "getBattlePassXPultiplierTotal", scripts\mp\rank::mine_caves_runner_internal );
}
...
supers_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "supers", "combatRecordSuperMisc", scripts\mp\supers::fake_digit_pool );
}
...
do_camera_zoom_out()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onFieldUpgradeEnd", scripts\cp\helicopter\chopper_boss::total_successful_vehicle_spawns );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onKillStreakEnd", scripts\cp\helicopter\chopper_boss::tr_findvehicle );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "resetChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_11CDB );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "startChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_1271C );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "stopChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_1279F );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onPing", scripts\cp\helicopter\chopper_boss::track_get_launch_velocity );
}

_id_1292A()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "team_utility", "init", scripts\mp\utility\teams::_id_1292B );
}
