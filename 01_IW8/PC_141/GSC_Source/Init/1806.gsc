...
_id_13137( var_0, var_1, var_2, var_3 )
{
...
_id_13138( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_13139( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
_id_1313A( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
_id_1313F( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
_id_13140( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
_id_13143( var_0, var_1, var_2, var_3 )
{
...
_id_13144( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_13145( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
_id_13146( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( ( !isdefined( var_1 ) || var_1 != "death" ) && ( !isdefined( var_2 ) || var_2 != "death" ) && ( !isdefined( var_3 ) || var_3 != "death" ) && ( !isdefined( var_4 ) || var_4 != "death" ) && ( !isdefined( var_5 ) || var_5 != "death" ) && ( !isdefined( var_6 ) || var_6 != "death" ) )
        self endon( "death" );
...
_id_13149( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
_id_1314A( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
_id_1314B( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
_id_1312F( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_13130( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_13131( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_13132( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_13133( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
deletestruct_ref( var_0 )
{
    ...
    if ( isdefined( level.struct ) )
    {
        if ( level.struct.size > 5000 )
        {
            ...
            _id_11CA1( var_0, 0, level.struct.size );
    }
}
...
br_ammorestock_playeruse( var_0, var_1 )
{
...
{
    var_3 = var_1 _id_13135( var_2, "death" );
...
flag_wait_either_return( var_0, var_1 )
{
    for (;;)
    {
        ...
        var_2 = level _id_13135( var_0, var_1 );
        return var_2;
    }
}
...
flag_wait_any_return( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        var_6 = level _id_13138( var_0, var_1, var_2, var_3, var_4 );
        return var_6;
    }
}
...
init_trap_room_traps( var_0, var_1, var_2, var_3 )
{
...
remove_hover_direction_and_try_issue_retreat( var_0, var_1, var_2 )
{
...
relic_punchbullets_fire_fists()
{
    ...
    if ( is_player_gamepad_enabled() )
        var_1 = _id_11CB4( "mountButtonConfig" );
    else
        var_1 = _id_11CB4( "mountButtonConfigKBM" );

    return var_1 != var_0;
}

module_call_counter( var_0 )
{
    if ( isnumber( var_0 ) )
        return int( var_0 );
    else
