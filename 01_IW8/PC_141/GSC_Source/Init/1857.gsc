...
init()
{
    ...
    level.silo_door_cover_spawners = getdvarint( "scr_map_use10v10_objectives", 0 );
    level.teambased = 0;
...
_id_11BA3()
{
    if ( ( scripts\mp\utility\game::getgametype() == "arm" || scripts\mp\utility\game::relic_amped_test_explode_other_player() || scripts\mp\utility\game::resetchallengetimer() ) && getdvarint( "scr_game_forceDefaultFallHeight", 0 ) != 1 )
    {
...
setdefaultcallbacks()
{
    ...
    level.delay_explosion_fx = scripts\mp\playerlogic::delay_delete_tv_station_boss_icon;
