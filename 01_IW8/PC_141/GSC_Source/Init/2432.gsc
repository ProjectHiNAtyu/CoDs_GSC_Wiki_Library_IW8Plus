...
little_bird_mp_init()
{
    ...
    if ( istrue( level._id_122E7 ) )
        scripts\cp_mp\utility\script_utility::registersharedfunc( "little_bird", "endEnterInternal", ::set_vehicle_anims_apc );
}
...
little_bird_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_12FC9( "little_bird", var_1, var_2 );
...
set_vehicle_anims_apc( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level._id_122E7 ) )
