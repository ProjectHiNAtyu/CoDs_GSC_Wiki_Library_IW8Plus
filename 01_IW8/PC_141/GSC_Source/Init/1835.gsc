...
adddeathicon( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_2.screenent_a ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_2.screenent_a );
        var_2.screenent_a = undefined;
    }
    ...
    var_13 = var_5;
    var_14 = var_5;
    var_2.screenent_a = var_2 scripts\cp_mp\entityheadicons::setheadicon_singleimage( var_10, var_9, undefined, 1, 0, 0, undefined, undefined, var_13, var_12, var_14 );

    if ( isdefined( var_2.screenent_a ) )
    {
        if ( var_5 || var_6 )
            var_2 thread packclientmatchdata( var_7 );
        else
            var_2 thread destroyslowly( var_4 );
    }
}

packclientmatchdata( var_0 )
{
    self endon( "removed_death_icon" );
    var_1 = self.team;
    var_2 = self.screenent_a;

    if ( !var_0 )
        outofboundswatcher( var_2, var_1 );
    ...
    if ( isdefined( self ) )
        self.screenent_a = undefined;
}

outofboundswatcher( var_0, var_1 )
{
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        scripts\cp_mp\entityheadicons::_id_12120( var_0, var_6 );
    }
...
destroyslowly( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
        var_1.screenent_a = undefined;
}

play_vo_or_timeout( var_0 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_0.screenent_a ) )
        return;

    scripts\cp_mp\entityheadicons::_id_12120( var_0.screenent_a, var_0 );
}
...
_id_11C7E( var_0 )
{
    ...
    scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_0.screenent_a );
    var_0.screenent_a = undefined;
...
addenemydeathicon( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_1.screenent_b ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_1.screenent_b );
        var_1.screenent_b = undefined;
    }
    ...
    var_10 = var_1.origin;
    var_1.screenent_b = var_1 scripts\cp_mp\entityheadicons::setheadicon_singleimage( var_2, var_6, undefined, var_7, var_8, var_9, undefined, undefined, undefined, var_10 );
