...
init()
{
    ...
    else if ( scripts\mp\utility\game::registercarryobjectpickupcheck() )
    {
...
debugprintvipstates( var_0, var_1, var_2 )
{
...
{
    var_0 = self getplayerdata( level.loadoutsgroup, "customizationSetup", "operatorWatch" );
    return scripts\mp\accessories::mediumstatehealthratio( var_0 );
}
...
_id_12885( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
...
_id_12886( var_0, var_1 )
{
    ...
    if ( !isdefined( level.can_spawn_heli_group ) )
    {
        level.can_spawn_heli_group = [];
        level.can_spawn_heli_group["iw8_ar_tango21"] = [ 1 ];
        level.can_spawn_heli_group["iw8_ar_mike4"] = [ 5 ];
        level.can_spawn_heli_group["iw8_ar_kilo433"] = [ 3 ];
        level.can_spawn_heli_group["iw8_ar_scharlie"] = [ 3 ];
        level.can_spawn_heli_group["iw8_sm_uzulu"] = [ 4 ];
        level.can_spawn_heli_group["iw8_sh_romeo870"] = [ 5 ];
        level.can_spawn_heli_group["iw8_sh_dpapa12"] = [ 3 ];
        level.can_spawn_heli_group["iw8_lm_mgolf34"] = [ 4 ];
        level.can_spawn_heli_group["iw8_sn_kilo98"] = [ 16 ];
        level.can_spawn_heli_group["iw8_sn_alpha50"] = [ 2 ];
        level.can_spawn_heli_group["iw8_sn_hdromeo"] = [ 4 ];
        level.can_spawn_heli_group["iw8_pi_golf21"] = [ 3 ];
        level.can_spawn_heli_group["iw8_pi_cpapa"] = [ 15 ];
        ...
        if ( var_2 != "" )
        {
            ...
            foreach ( var_5 in var_3 )
            {
                ...
                if ( var_6.size == 2 )
                {
                    ...
                    if ( !isdefined( level.can_spawn_heli_group[var_7] ) )
                        level.can_spawn_heli_group[var_7] = [];

                    level.can_spawn_heli_group[var_7][level.can_spawn_heli_group[var_7].size] = var_8;
                }
            }
        }
    }
    ...
    if ( isdefined( level.can_spawn_heli_group[var_0] ) )
        var_10 = level.can_spawn_heli_group[var_0];

    var_11 = 0;
    var_12 = getdvarint( "scr_forceClassTableVariantRandom", 0 );

    if ( var_12 == 1 )
        var_11 = scripts\mp\utility\weapon::nodropanim( var_0, var_10 );
    else
    {
        var_13 = strtok( var_1, " " );
        var_14 = [];
    ...
    var_19 = scripts\mp\utility\weapon::_id_132DB( var_0, var_11 );
...
loadout_clearplayer( var_0 )
{
    ...
    scripts\mp\perks\perkpackage::unset_relic_doubletap();
...
loadout_giveperk( var_0 )
{
    ...
    if ( isdefined( level.loadoutpostperks ) )
        self thread [[ level.loadoutpostperks ]]();
}
...
setaardata( var_0 )
{
    ...
    if ( isdefined( var_0.setheadicon_addclienttomask ) )
        var_1.setheadicon_addclienttomask = var_0.setheadicon_addclienttomask;
    ...
    if ( isdefined( var_0.setheadicon_removeclientfrommask ) )
        var_1.setheadicon_removeclientfrommask = var_0.setheadicon_removeclientfrommask;
    ...
    var_1.registereventcallback = var_0.registereventcallback;
...
loadout_updateclasscustom( var_0, var_1 )
{
    ...
    for ( var_3 = 0; var_3 < 5; var_3++ )
    {
        ...
        var_0.loadoutprimaryattachmentids[var_3] = debugprintvipstates( var_2, 0, var_3 );
    }
    ...
    for ( var_3 = 0; var_3 < 5; var_3++ )
    {
        ...
        var_0.loadoutsecondaryattachmentids[var_3] = debugprintvipstates( var_2, 1, var_3 );
    }
    ...
    var_0.loadoutaccessorylogic = debugprintteams();
    var_0.loadoutstreaksfilled = 1;
...
loadout_updateclassgamemode( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.setheadicon_addclienttomask = var_3["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_3["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.setheadicon_removeclientfrommask = var_3["loadoutSecondaryAddBlueprintAttachments"];
    ...
    var_0.sethasrespawntokenextrainfo = isdefined( var_3["loadoutExtraPerks"] );
...
setburningpartstate( var_0, var_1 )
{
    var_2 = getclassindex( var_1 );
    self.class_num = var_2;
    var_3 = self.pers["gamemodeLoadout"];
    ...
    if ( !var_4 )
    {
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 5; var_5++ )
            {
                ...
                var_0.loadoutprimaryattachmentids[var_5] = debugprintvipstates( var_2, 0, var_5 );
            }
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 5; var_5++ )
            {
                ...
                var_0.loadoutsecondaryattachmentids[var_5] = debugprintvipstates( var_2, 1, var_5 );
            }
...
loadout_updateclasscallback( var_0 )
{
    ...
    if ( isdefined( var_1["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.setheadicon_addclienttomask = var_1["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_1["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.setheadicon_removeclientfrommask = var_1["loadoutSecondaryAddBlueprintAttachments"];
...
loadout_updateclassdefault( var_0, var_1 )
{
    ...
    if ( !isagent( self ) && self isplayerheadless() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
        ...
        setcachedclientomnvar( var_0, var_2 );
...
setcachedgameomnvar( var_0 )
{
    if ( !isdefined( self.phase_one_combat ) )
    {
        if ( !isdefined( level.phase_one_combat ) )
        {
            var_1 = randomint( 200 );
            level.phase_one_combat = var_1;
            level.phase_three_combat = var_1;
        }
        else
        {
            level.phase_one_combat++;
            level.phase_three_combat++;
        }

        self.phase_one_combat = level.phase_one_combat;
        self.phase_three_combat = level.phase_three_combat;
    }

    var_2 = setbuybackpingmessage( self.phase_one_combat, 1 );
    var_3 = setbuybackpingmessage( self.phase_three_combat, 0 );
    var_4 = var_2[0];
    var_5 = var_2[1];
    var_6 = var_3[0];
    var_7 = var_3[1];
...
setbuybackpingmessage( var_0, var_1 )
{
    var_2 = 0;
    var_3 = -1;
    ...
    for (;;)
    {
        ...
        {
            if ( var_6.variantid == 0 || var_6.relic_nuketimer_addtotimer || !isdefined( var_6.attachcustomtoidmap ) )
                continue;

            if ( var_4 && isdefined( var_6.register_fuel_stability_event ) && !var_6.register_fuel_stability_event )
                continue;
...
loadout_updateabilities( var_0, var_1 )
{
    ...
    if ( var_0.loadoutperksfromgamemode )
    {
        ...
        if ( var_0.sethasrespawntokenextrainfo )
...
setcheckliststateforteam( var_0, var_1 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "custgamemode":
            break;
        case "gamemode":
            setchecklistsubversion( var_0, var_1 );
            break;
        case "callback":
            break;
        case "default":
...
loadout_updateclass( var_0, var_1 )
{
    ...
    if ( !isbot( self ) && isdefined( level.onping ) && level.onping )
        setchainkillstreaks( var_0 );
    else
        loadout_updateclassfinalweapons( var_0 );

    if ( isdefined( level.spawnexfilchopper ) )
        self [[ level.spawnexfilchopper ]]( var_0 );
...
loadout_updateclassfistweapons( var_0 )
{
    if ( isdefined( level.onping ) && level.onping && issameweapon( var_0.loadoutprimary ) )
        var_0.loadoutprimary = var_0.loadoutprimary;
    else if ( var_0.loadoutprimary == "none" )
        var_0.loadoutprimary = "iw8_fists";

    if ( scripts\mp\utility\game::enemy_left_monitor() )
    {
...
loadout_updateclassfinalweapons( var_0 )
{
    if ( istrue( var_0.setheadicon_addclienttomask ) )
        var_0.loadoutprimaryobject = deactivate_laser_from_struct( var_0.loadoutprimary, var_0.loadoutprimaryattachments, var_0.loadoutprimarycamo, var_0.loadoutprimaryreticle, var_0.loadoutprimaryvariantid, var_0.loadoutprimaryattachmentids, var_0.loadoutprimarycosmeticattachment, var_0.loadoutprimarystickers, istrue( var_0.loadouthasnvg ) );
    else
    ...
    {
        if ( istrue( var_0.setheadicon_removeclientfrommask ) )
            var_0.loadoutsecondaryobject = deactivate_laser_from_struct( var_0.loadoutsecondary, var_0.loadoutsecondaryattachments, var_0.loadoutsecondarycamo, var_0.loadoutsecondaryreticle, var_0.loadoutsecondaryvariantid, var_0.loadoutsecondaryattachmentids, var_0.loadoutsecondarycosmeticattachment, var_0.loadoutsecondarystickers, istrue( var_0.loadouthasnvg ) );
        else
...
loadout_updateplayerweapons( var_0, var_1, var_2, var_3 )
{
    ...
    setbrokenoverlaymaterial( var_0, var_7, var_8, var_4, var_5, var_6 );
...
loadout_giveprimaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = setbettermissionrewards( "primary", var_0.loadoutprimaryobject, var_1, var_2 );
...
loadout_givesecondaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = setbettermissionrewards( "secondary", var_0.loadoutsecondaryobject, var_1, var_2 );
...
setbettermissionrewards( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    {
        if ( scripts\mp\riotshield::isriotshield( var_4 ) && !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) && !istrue( self.playertouching ) )
        {
...
setbrokenoverlaymaterial( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = [];
    ...
    foreach ( var_8 in var_6 )
        var_8.patrolfunc = var_8 hasattachment( "maxammo" );

    if ( isdefined( level.spawncrossbowbolt ) )
        self [[ level.spawncrossbowbolt ]]( var_6 );
    ...
    if ( !istrue( var_4 ) && var_5 == 3 )
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.hasalternate ) )
            {
                ...
                if ( var_16 == "grenade" && istrue( var_8.patrolfunc ) )
                    self setweaponammostock( var_15, 1 );
                else if ( var_16 == "spread" )
                    self setweaponammoclip( var_15, scripts\engine\utility::ter_op( istrue( var_8.patrolfunc ), 8, 6 ) );

                continue;
            }

            if ( scripts\mp\utility\weapon::reflectprojectile( var_8 ) )
...
loadout_updateplayernvgs()
{
    ...
    if ( istrue( self.inspawncamera ) )
        scripts\engine\utility::_id_1312D( "spawned_player", "fadeUp_start" );
...
setbrjuggsettings( var_0 )
{
    var_1 = getdvarint( "scr_t9_watch_suppression", 0 );

    if ( var_1 && isdefined( var_0.loadoutaccessorydata ) )
    {
        var_2 = scripts\mp\accessories::mercymatchending_nuke( var_0.loadoutaccessorydata );
...
loadout_updateplayerkillstreaks( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::removeriotshield() )
    {
        var_2 = 0;
...
loadout_updatefieldupgrades( var_0, var_1 )
{
    ...
    if ( level.allowsupers )
    {
        ...
        {
            self.loadoutfieldupgrade1 = juggernaut_death_watcher( self.loadoutfieldupgrade1 );
            self.loadoutfieldupgrade2 = juggernaut_death_watcher( self.loadoutfieldupgrade2 );
        ...
        {
            var_3 = jugg_watchherodrop( self.loadoutfieldupgrade1 );
    ...
    {
        self.setdragonsbreathburning = jugg_watchherodrop( self.loadoutfieldupgrade1 );
...
swaploadout()
{
    ...
    var_0 = scripts\mp\utility\game::relic_amped_play_beep() && !scripts\mp\flags::gameflag( "prematch_done" );

    if ( var_0 && isdefined( level.applyprematchloadoutrestrictions ) )
...
giveloadout( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = setarenaomnvarplayertype();
    var_5 = setcheckliststateforteam( var_5, var_1 );
    self.obj_running_exfil_wave = var_5;
    var_6 = undefined;
...
loadout_lognewlygivenloadout( var_0, var_1, var_2 )
{
    ...
    if ( var_1.registereventcallback )
    {
        var_3 = 99;
        var_4 = "copied";
    }
    ...
    if ( var_8 == -1 || var_1.registereventcallback )
    {
...
_id_12AA6()
{
    if ( !istrue( self.trackriotshield_monitorshieldattach ) )
    {
        ...
        if ( !nullweapon( var_0 ) && var_0.basename != "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) && reset_map_dvars( var_0 ) )
            self.trackriotshield_monitorshieldattach = 1;
    }
}
...
_id_12AA8()
{
    self._id_11DA8 = undefined;
    self._id_11DA7 = undefined;
...
_id_12AA1( var_0 )
{
    ...
    childthread _id_12AA0();

    if ( isdefined( var_0 ) )
        self._id_131BD = var_0;
    else if ( !isdefined( self._id_131BD ) )
        self._id_131BD = 0;
    ...
    while ( scripts\mp\riotshield::riotshield_hasweapon() )
    {
        ...
        if ( !istrue( self.inlaststand ) )
        {
            ...
            {
                self.scriptflags = 1;
                self.scriptgoalyaw = gettime() + 1000;
            }
            else if ( isdefined( self.scriptgoalyaw ) && gettime() >= self.scriptgoalyaw )
            {
                self.scriptflags = undefined;
                self.scriptgoalyaw = undefined;
            }
        ...
        if ( self isonladder() )
            ...
            _id_12AA3();
        else if ( istrue( self.scriptflags ) )
            _id_12AA3();
        else if ( istrue( self.trackriotshield_monitorshieldattach ) )
        {
...
deactivate_laser_from_struct( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    foreach ( var_16, var_13 in var_10 )
    {
        ...
        var_15 = scripts\mp\utility\weapon::branalytics_playercount( var_14 );
    ...
    if ( isdefined( var_1 ) )
    {
        foreach ( var_19, var_16 in var_1 )
        {
            ...
            {
                var_14 = scripts\mp\utility\weapon::attachmentmap_tounique( var_16, var_9 );
                var_15 = scripts\mp\utility\weapon::branalytics_plunder_extraction_failure( var_14 );
...
deactivate_hacked_console( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
buildweapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !isdefined( var_9 ) || var_9 == "" )
        scripts\mp\utility\script::getweaponrandomvariantid( "buildWeapon - bad weaponAssetName - rootName: " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant: " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );

    var_13 = getcompleteweaponname( var_9, [], undefined, var_2, var_4 );

    if ( isdefined( var_9 ) && !isdefined( var_13 ) )
        scripts\mp\utility\script::getweaponrandomvariantid( "buildWeapon - null weapon: weaponAssetName = " + var_9 + ", rootName = " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant = " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );
...
buildweaponuniqueattachmenttoidmap( var_0, var_1, var_2 )
{
    ...
    foreach ( var_20, var_8 in var_6 )
    {
        ...
        if ( !isdefined( var_13 ) && register_vehicle_max_ai( var_19 ) )
            var_13 = var_20;

        if ( !var_12 && ( removepatchablecollision_delayed( var_19 ) || removenonvipteamlocations( var_20 ) ) )
            var_12 = 1;
    }
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        {
            if ( istrue( var_0.relic_amped_reset_deathshield_on_revived ) )
            {
                var_0 _meth_87A8( "ghost" );
                var_0 setentitysoundcontext( "gender", "zombie" );
            }
            else if ( isdefined( var_0.operatorcustomization ) && isdefined( var_0.operatorcustomization.gender ) && var_0.operatorcustomization.gender == "female" )
                var_0 _meth_87A8( "female" );
        ...
        else if ( istrue( level.open_teleport_room_door ) && scripts\mp\utility\game::getgametype() == "infect" && var_0.team == "axis" )
            var_0 _meth_87A8( "zombie" );
        else if ( isdefined( var_0.operatorcustomization ) && isdefined( var_0.operatorcustomization.gender ) && var_0.operatorcustomization.gender == "female" )
            var_0 _meth_87A8( "female" );
        else
        ...
        if ( isdefined( var_0.trap_toggle_logic ) )
        {
            var_0 clearsoundsubmix( "iw8_mp_spawn_camera" );
            var_0.trap_toggle_logic stoploopsound( self.trap_trigger_logic );
            var_0.trap_toggle_logic delete();
            var_0.trap_toggle_logic = undefined;
            var_0.trap_trigger_logic = undefined;
        }
...
resetfunctionality()
{
    ...
    scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F7C( self, 1 );
    ...
    scripts\mp\equipment\molotov::spawnziptie();
    scripts\mp\equipment\throwing_knife_mp::_id_129B6();
    scripts\mp\equipment\flash_grenade::clearflash( 1 );
    scripts\mp\equipment\gas_grenade::gas_clear( 1 );

    if ( !isagent( self ) )
    {
        scripts\mp\utility\player::playanim_mountturret();
    ...
    scripts\cp_mp\utility\player_utility::wait_between_stations();
}
...
updateinstantclassswapallowed()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        var_0 = scripts\mp\gamelogic::demo_debug_nuke( scripts\mp\utility\game::namehud() );
...
_id_12DD4()
{
    ...
    if ( scripts\mp\gamelogic::demo_debug_nuke( scripts\mp\utility\game::namehud() ) )
    {
        while ( scripts\mp\utility\game::reloadnotehandler( self ) )
            waitframe();
...
{
    var_0 = setarenaomnvarplayertype();
    setcodenumber();
    var_1 = setarenaomnvarplayertype();
...
copyclassfornextlife( var_0 )
{
    ...
    thread add_wave_overrides_to_module();
    var_1 = undefined;
    ...
    self.pers["copiedClass"] = setaardata( var_1 );
...
setarenaomnvarhealthtype( var_0, var_1 )
{
    var_0.loadoutsuper = var_1.loadoutsuper;
...
spawnammocountoverride_giveweaponammo( var_0, var_1, var_2 )
{
    ...
    if ( var_4 && !relic_nuketimer_timerloop( var_0 ) )
    {
        var_5 = 0;
        var_6 = 0;
...
{
    var_1 = scripts\mp\utility\weapon::isknifeonly( var_0.basename ) || scripts\mp\utility\weapon::refreshsquadspawnareaomnvars( var_0.basename ) || scripts\mp\utility\weapon::isaxeweapon( var_0.basename ) || scripts\mp\utility\weapon::relic_nuketimer_timer_init( var_0 ) || scripts\mp\riotshield::isriotshield( var_0.basename );
    return var_1;
}
