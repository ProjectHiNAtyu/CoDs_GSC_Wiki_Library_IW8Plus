...
watchforbasicplayerevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_1313F( "adjustedStance", "jumped", "weapon_fired", "reload_start", "spawned_player" );
...
watchforplayermovementevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_1313D( "doubleJumpBegin", "doubleJumpEnd", "sprint_slide_begin" );
...
watchforusermessageevents()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_13135( "log_user_event_end", "log_user_event_generic_event" );
...
setup_rarity_ui_images( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "";
...
setup_next_advance( var_0, var_1 )
{
...
setup_heli_starts( var_0, var_1, var_2, var_3 )
{
