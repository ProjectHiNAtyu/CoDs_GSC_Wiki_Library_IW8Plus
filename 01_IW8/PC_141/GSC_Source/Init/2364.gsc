...
starttankdropoff( var_0 )
{
    ...
    scripts\common\utility::_id_12C2C( level.smartwatchinteract, "pac_sentry", self.origin );
...
createtank( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_11 thread _id_128E9();
    var_11 thread _id_128EA();
...
_id_128EA()
{
    ...
    for (;;)
    {
        scripts\cp_mp\vehicles\vehicle::_id_12EBD( self );
        waitframe();
    }
}
...
tank_destroy( var_0, var_1 )
{
    ...
    self.streakinfo.is_in_gas = istrue( var_1 );
...
tank_driverexit( var_0 )
{
    ...
    if ( var_0 scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        level thread scripts\cp_mp\utility\killstreak_utility::_id_11D26( var_0 );
    }
}
