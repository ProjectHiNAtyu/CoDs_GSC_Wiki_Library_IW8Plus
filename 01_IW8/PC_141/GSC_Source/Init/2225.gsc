...
init()
{
    ...
    init_airstrike_vo();
    level.allow_cp_munitions = [];
    level.binoculars_addmarkpoints = 0;
}
...
weapongivenairstrike( var_0 )
{
    ...
    var_2 = bhasthermitestucktoshield( self.origin );
...
{
    if ( !isdefined( var_0._id_12913 ) )
    {
        var_3 = airstrike_getownerlookatpos( self );
        var_4 = bhasthermitestucktoshield( var_3 );
    ...
    switch ( var_0.streakname )
    {
        case "precision_airstrike":
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
            {
                ...
                if ( var_3 == "br" && isdefined( self.sat_sound_think ) )
                {
                    var_0._id_12913 = self.sat_sound_think;
                    self.sat_sound_think = undefined;
                }
            }
...
selectairstrikelocation( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        var_8 = bhasthermitestucktoshield( var_2 );
...
finishmapselectairstrikeusage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 = bhasriotshieldattached( self.origin, self );
    thread airstrike_watchkills( var_7 * 2, var_8 );
    thread watchairstrikeowner( var_8 );
    thread bindingpc( var_4, var_8 );
    ...
    scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_4 );
}
...
finishstandardairstrikeusage( var_0, var_1, var_2 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_2 );
}
...
watchairstrikeowner( var_0 )
{
    ...
    level endon( "game_ended" );
    scripts\engine\utility::_id_1312D( "disconnect", "joined_team" );
    bigtimer( self, var_0 );
}
...
{
    var_7 = 0;
    var_8 = scripts\cp_mp\utility\killstreak_utility::molotov_crate_update_hint_logic_alt();
    var_9 = 24000;
    var_10 = 6500;
    var_11 = 2500;
    var_7 = 1500;
    ...
    if ( level.mapname == "mp_br_mechanics" || scripts\cp_mp\utility\game_utility::registerscriptableinstance() )
        var_11 = var_11 + 2500;
...
_id_13220( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "air_strike_complete" );
    var_1 waittill( "disconnect" );

    if ( isdefined( var_0.kill_rate_too_slow ) )
        var_0.kill_rate_too_slow delete();
...
doplanestrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_15.owner = var_7;
    var_16 = istrue( level.resetstreamerposhint ) && ( isdefined( level._id_13341 ) && level._id_13341 == 6 );
    var_17 = var_16 || istrue( var_5.blueprintextract_shouldgivereward );
    ...
    var_15.binoculars_cansee = var_8;
    ...
    {
        var_18 = spawnstruct();
        var_18.updatesquadleaderpassstateforteam = var_15;
        var_18._id_1291B = var_0;
    ...
    if ( !istrue( var_5.paired_lasers ) )
        level thread airstrike_playplaneattackfx( var_15, var_20, var_5 );

    if ( istrue( var_5.overrideplayflyfx ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "airstrike", "overridePlayFlyFX" ) )
...
airstrike_playflyfx( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_0.kill_rate_too_slow thread airstrike_playapproachfx( 0.05 );
    var_0.kill_rate_too_slow thread airstrike_playflybyfx( 6.397 );
    var_0.kill_rate_too_slow thread airstrike_playflyoutfx( var_4 );
    var_0.kill_rate_too_slow thread airstrike_handleflyoutfxdeath( var_5 );
    var_0.kill_rate_too_slow thread big_door_watcher( var_0 );
}
...
airstrike_watchkills( var_0, var_1 )
{
    ...
    self.binoculars_addtolosqueue = 0;
    var_2 = "airstrike_finished_" + var_1;
    childthread airstrike_watchkillscount( var_2 );
    scripts\engine\utility::_id_13147( var_0, var_2 );
    var_3 = isdefined( self.airstrikekillcount ) && self.airstrikekillcount >= 1;
    var_4 = isdefined( self.binoculars_addtolosqueue ) && self.binoculars_addtolosqueue >= 1;
    ...
    self.binoculars_addtolosqueue = undefined;
}
...
callstrike_precisionbulleteffect( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_9 = var_6;
    var_10 = istrue( level.resetstreamerposhint ) && ( isdefined( level._id_13341 ) && level._id_13341 == 6 );
...
airstrike_getownerlookatpos( var_0, var_1 )
{
    ...
    var_6 = var_0 scripts\cp_mp\utility\killstreak_utility::wait_till_time();
...
airstrike_watchforads( var_0, var_1 )
{
    ...
    var_2 thread bink_save_hack( self );
    var_2 thread airstrike_watchdeployended( self );
    var_2 thread binding( self );
...
airstrike_watchdeployended( var_0 )
{
    ...
    self endon( "death" );
    level endon( "game_ended" );
    var_1 = var_0 scripts\engine\utility::_id_13135( "cancel_fire", "successful_fire" );
...
bindingpc( var_0, var_1 )
{
    self endon( "airstrike_finished_" + var_1 );
    self endon( "disconnect" );
    level waittill( "game_ended" );
    scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_0 );
}

bhasriotshieldattached( var_0, var_1 )
{
    level.binoculars_addmarkpoints++;
    var_2 = spawnstruct();
    var_2.origin = var_0;
    var_2.owner = var_1;
    var_2.id = var_1.name + "_" + level.binoculars_addmarkpoints;
    level.allow_cp_munitions[var_2.id] = var_2;
    return var_2.id;
}

bigtimer( var_0, var_1 )
{
    level.allow_cp_munitions = scripts\engine\utility::array_remove_index( level.allow_cp_munitions, var_1, 1 );

    if ( isdefined( var_0 ) )
        var_0 notify( "airstrike_finished_" + var_1 );
}

bhasthermitestucktoshield( var_0 )
{
    var_1 = "success";
    var_2 = 625000000;
    ...
    if ( isdefined( var_0 ) )
    {
        if ( level.allow_cp_munitions.size > 0 )
        {
            var_3 = 1;
            ...
            if ( level.allow_cp_munitions.size >= var_3 )
                var_1 = "KILLSTREAKS/AIR_SPACE_TOO_CROWDED";
            else
            {
                foreach ( var_6 in level.allow_cp_munitions )
                {
...
delete_crate_objectives( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
    var_5 = spawnstruct();
    ...
    var_5.damage = 0;
    var_5.kills = 0;
    var_5.paired_lasers = istrue( var_1 );
    var_5.blueprintextract_shouldgivereward = istrue( var_2 );
    var_6 = var_3;
    var_7 = undefined;
