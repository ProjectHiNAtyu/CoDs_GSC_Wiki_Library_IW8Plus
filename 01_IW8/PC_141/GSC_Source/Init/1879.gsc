...
missilelauncherusage()
{
    ...
    if ( self.missilelauncherstage == 1 )
    {
        ...
        if ( !var_1 && ( self.missilelaunchertarget scripts\cp_mp\vehicles\vehicle::isvehicle() && scripts\cp_mp\vehicles\vehicle::_id_12F6D( self.missilelaunchertarget, self ) ) )
        {
            resetmissilelauncherlocking();
            return;
        }
...
stingtargstruct_getoffsets()
{
    ...
    else if ( scripts\mp\utility\entity::register_boss_objectives( self.target ) )
    {
        self.offsets[self.offsets.size] = ( 0, 0, 10 );
        self.useoldlosverification = 0;
    }
