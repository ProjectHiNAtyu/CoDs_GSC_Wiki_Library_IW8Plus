...
default_on_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( level.are_all_alive_players_touching_plane ) )
        var_13 [[ level.are_all_alive_players_touching_plane ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, 0.0, var_10, var_11 );
...
audio_fade_in_ext_walla( var_0, var_1 )
{
    if ( var_0 != "MOD_CRUSH" )
        return 0;
...
{
    var_10 = audio_fade_in_ext_walla( var_3, var_0 );
    ...
    if ( isdefined( self._blackboard.currentvehicle ) )
    {
        ...
        else
        {
            ...
            if ( isdefined( self._blackboard.vehicledeathwait ) )
                ...
                self.body thread _id_11A97( self._blackboard.currentvehicle );
        }
    }
