...
init_spawn_factors()
{
    ...
    registerfactor( "avoidCloseToDefenderFlag", ::brking_watchcircletimers, 1, [ "activeCarrierPosition", "defenderFlagPosition", "avoidDefenderFlagDeadZoneDistSq" ] );
    registerfactor( "avoidCloseToDefenderFlagSpawn", ::brleaderdialogplayer, 1, [ "avoidDefenderFlagDeadZoneDistSq" ] );
    initfrontline();
}
...
brleaderdialogplayer( var_0, var_1 )
{
    var_2 = var_0.scriptdata.hasscrapassist;
