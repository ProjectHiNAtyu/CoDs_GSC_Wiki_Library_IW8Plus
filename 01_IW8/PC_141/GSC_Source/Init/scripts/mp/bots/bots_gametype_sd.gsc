...
atk_bomber_update()
{
    ...
    else
    {
        ...
        if ( !isdefined( level.initial_bomb_pickup_time ) || gettime() - level.initial_bomb_pickup_time < level.initial_pickup_wait_time )
        {
            ...
            thread carriable_error_messsage_watch( level.initial_pickup_wait_time / 1000 );
        ...
        {
            self botsetpathingstyle( "scripted" );
            var_11 = scripts\mp\bots\bots_gametype_common::loadandplayholoeffect( var_10, 1 );
        ...
        if ( var_12 == "goal" )
        {
            ...
            var_17 = scripts\mp\bots\bots_gametype_common::carriable_weapon_change_watch( level.planttime + 2, "bomb_planted", var_16 );
            self botclearscriptgoal();
...
bomb_defuser_update()
{
    ...
    if ( var_4 == "goal" )
    {
        ...
        var_13 = scripts\mp\bots\bots_gametype_common::carriable_weapon_change_watch( level.defusetime + 2, "bomb_defused", var_11, var_12 > 40 );
...
backstabber_update()
{
    ...
    {
        if ( !isdefined( self.carriable_watch_for_physics_collison ) )
            self.carriable_watch_for_physics_collison = scripts\engine\utility::random( level.objectives );

        self botsetpathingstyle( undefined );
        var_9 = self botsetscriptgoal( scripts\engine\utility::random( self.carriable_watch_for_physics_collison.bottargets ).origin, 160, "objective" );
        ...
        if ( var_9 )
        {
            ...
            if ( var_10 == "goal" )
            {
                ...
                {
                    if ( var_14 != self.carriable_watch_for_physics_collison )
                    {
                        self.carriable_watch_for_physics_collison = var_14;
                        break;
                    }
                }
            }
...
{
    var_1 = scripts\mp\bots\bots_gametype_common::little_bird_mg_getspawnstructscallback( var_0 );
