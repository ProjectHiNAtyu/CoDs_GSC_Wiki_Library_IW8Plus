...
checklinktotraininternal( var_0, var_1 )
{
...
bot_gun_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_3.basename != "none" && !scripts\mp\utility\weapon::iskillstreakweapon( var_3 ) && var_3.basename != var_1 && !scripts\mp\utility\weapon::relic_nuketimer_timer_init( var_3 ) )
        {
            var_1 = var_3.basename;

            if ( self botgetdifficultysetting( "advancedPersonality" ) && self botgetdifficultysetting( "strategyLevel" ) > 0 )
                checklinktotraininternal( var_3.basename, var_2 );
        }
