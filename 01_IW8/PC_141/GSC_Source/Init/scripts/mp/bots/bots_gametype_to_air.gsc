...
setup_callbacks()
{
    level.bot_funcs["gametype_think"] = ::bot_air_think;
}
...
bot_air_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self bothasscriptgoal() )
        {
            ...
            else if ( scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "kill_tag" ) && self.tag_getting scripts\mp\gameobjects::caninteractwith( self.team ) )
            {
        ...
        if ( isdefined( self.tag_getting ) )
        {
            ...
            if ( !self.conf_camping_tag )
            {
                if ( !scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "kill_tag" ) )
                {
                    ...
                    scripts\mp\bots\bots_strategy::bot_new_tactical_goal( "kill_tag", self.tag_getting.curorigin, 25, var_5 );
                }
            }
        }
