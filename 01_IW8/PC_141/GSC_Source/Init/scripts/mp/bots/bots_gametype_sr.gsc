...
bot_sr_think()
{
    ...
    scripts\mp\bots\bots_gametype_sd::bot_sd_think();
}
...
tag_watcher()
{
    for (;;)
    {
        ...
        var_0 = scripts\mp\bots\bots_gametype_conf::bot_find_visible_tags( 0 );
...
sr_pick_up_tag( var_0 )
{
    ...
    if ( var_2 == "goal" && var_0 scripts\mp\bots\bots_gametype_conf::change_goal_radius_weapons_free_internal( self.team ) )
        wait 3.0;
...
watch_tag_destination( var_0 )
{
    ...
    for (;;)
    {
        if ( !var_0 scripts\mp\bots\bots_gametype_conf::change_goal_radius_weapons_free_internal( self.team ) )
            wait 0.05;
...
sr_ally_near_tag( var_0 )
{
    ...
    var_2 = scripts\mp\bots\bots_gametype_common::get_living_players_on_team( self.team, 1 );
...
notify_when_tag_picked_up_or_unavailable( var_0, var_1 )
{
    ...
    while ( var_0 scripts\mp\bots\bots_gametype_conf::change_goal_radius_weapons_free_internal( self.team ) && !scripts\mp\bots\bots_gametype_conf::bot_check_tag_above_head( var_0 ) )
        wait 0.05;
...
sr_camp_tag( var_0 )
{
    ...
    while ( var_0 scripts\mp\bots\bots_gametype_conf::change_goal_radius_weapons_free_internal( self.team ) && self.role == var_1 )
    {
        if ( scripts\mp\bots\bots_personality::should_select_new_ambush_point() )
        {
            if ( scripts\mp\bots\bots_personality::find_ambush_node( var_0.curorigin, 1000 ) )
                childthread scripts\mp\bots\bots_gametype_conf::bot_camp_tag( var_0, "tactical", "new_role" );
        }
