...
bot_conf_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self bothasscriptgoal() )
        {
            ...
            else if ( scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "kill_tag" ) && self.tag_getting change_goal_radius_weapons_free_internal( self.team ) )
            {
...
change_goal_radius_weapons_free_internal( var_0 )
{
...
bot_watch_new_tags()
{
    for (;;)
    {
        ...
        level thread checkweaponswitch( self, var_0 );
    }
}
...
bot_find_visible_tags( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( level.dogtags ) )
    {
        ...
        {
            if ( var_7 change_goal_radius_weapons_free_internal( self.team ) )
            {
                var_8 = 0;
...
bot_remove_invalid_tags( var_0 )
{
    ...
    {
        if ( var_3.tag change_goal_radius_weapons_free_internal( self.team ) && scripts\mp\bots\bots_util::bot_vectors_are_equal( var_3.tag.curorigin, var_3.origin ) )
        {
