...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "monitorDamage", ::sentryturretbr_monitordamage );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "createHintObject", ::sentryturretbr_createhintobject );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "getTargetMarker", ::sentryturretbr_gettargetmarker );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "initSentrySettings", ::sentryturretbr_initsentrysettings );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "allowPickupOfTurret", ::sentryturretbr_canpickup );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "handleMovingPlatform", scripts\mp\killstreaks\manual_turret_mp::shutdownattractionicontrigger );
}

sentryturretbr_gettargetmarker( var_0, var_1 )
{
    return scripts\mp\killstreaks\target_marker::gettargetmarker( var_0, var_1 );
}

sentryturretbr_createhintobject( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    return scripts\mp\gameobjects::createhintobject( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 );
}

sentryturretbr_monitordamage( var_0 )
{
    var_0 thread scripts\mp\damage::monitordamage( var_0.maxhealth, "hitequip", ::sentryturretbr_handledeathdamage, ::sentryturretbr_modifydamage, 1 );
}

sentryturretbr_handledeathdamage( var_0 )
{
...
sentryturretbr_modifydamage( var_0 )
{
    var_1 = var_0.attacker;
    var_2 = var_0.objweapon;
    var_3 = var_0.meansofdeath;
...
sentryturretbr_initsentrysettings()
{
...
sentryturretbr_canpickup()
{
    if ( scripts\cp_mp\utility\inventory_utility::isanymonitoredweaponswitchinprogress() )
        return 0;

    if ( scripts\cp_mp\utility\killstreak_utility::relic_healthpacks_think( self getcurrentweapon() ) )
        return 0;
