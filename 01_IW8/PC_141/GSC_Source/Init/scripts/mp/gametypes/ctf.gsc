...
createflagsandhud()
{
    ...
    scripts\mp\objidpoolmanager::terminateriotshield( level.capzones[game["defenders"]].objidnum, 1 );
    scripts\mp\objidpoolmanager::terminateriotshield( level.capzones[game["attackers"]].objidnum, 1 );
}
...
createteamflag( var_0, var_1 )
{
    ...
    var_9 scripts\mp\gameobjects::_id_1213C( level.iconescort, level.iconkill, level.spawnangle );
    ...
    var_9 scripts\mp\gameobjects::_id_11B99( ::juggheli_spawner_jammer5_3 );
    var_9.allowweapons = 1;
    var_9.trial_callback_ai_damage = var_8;
    var_9.onpickup = ::onpickup;
    var_9.onpickupfailed = ::onpickup;
    var_9.ondrop = ::ondrop;
    var_9.onreset = ::onreset;
    var_9.register_vfx = 1;
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_9 scripts\mp\gameobjects::_id_1213C( level.iconescort, level.iconkill, level.spawnangle, var_10 );
    }
    else
    {
        var_9.objidpingfriendly = 1;
...
createcapzone( var_0, var_1 )
{
    ...
    var_6 scripts\mp\gameobjects::_id_1213C( level.icondefendflag, level.iconcaptureflag, level.spawnangle );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( var_4 != var_3 )
    {
        ...
        if ( level.codcasterenabled )
            level.capzones[var_0.team] scripts\mp\gameobjects::_id_11CE1();

        thread returnflag();
        var_0 thread scripts\common\utility::_id_12C2C( level.slopelocked, "obj_return", var_0.origin );
        ...
        if ( self.trial_callback_ai_damage == "allies" )
            setomnvar( "ui_ctf_flag_axis", -2 );
        else
            setomnvar( "ui_ctf_flag_allies", -2 );
    }
    else
    {
        ...
        level.capzones[var_5] scripts\mp\gameobjects::_id_12133( level.spawnaccesscards );
...
ondrop( var_0 )
{
    if ( isdefined( var_0.leaving_team ) )
    {
        ...
        self.droppedteam = self.trial_callback_ai_damage;
    else
    ...
    if ( level.returntime >= 0 )
        scripts\mp\gameobjects::_id_1213C( level.iconreturnflag, level.iconcaptureflag, level.spawnangle );
    else
    {
        scripts\mp\gameobjects::_id_1213C( level.icondefendflag, level.iconcaptureflag, level.spawnangle );
    ...
    scripts\mp\utility\dialog::leaderdialog( "enemy_flag_dropped", self.trial_callback_ai_damage, "status" );
    scripts\mp\utility\dialog::leaderdialog( "flag_dropped", scripts\mp\utility\game::getotherteam( self.trial_callback_ai_damage )[0], "status" );
...
onreset()
{
    ...
    level.capzones[var_1] scripts\mp\gameobjects::_id_1213C( level.icondefendflag, level.iconcaptureflag, level.spawnangle );
...
onuse( var_0 )
{
    if ( !level.gameended )
    {
        ...
        var_0 thread scripts\common\utility::_id_12C2C( level.slopelocked, "capture", var_0.origin );
        ...
        if ( level.codcasterenabled )
            level.capzones[var_2] scripts\mp\gameobjects::_id_11CE1();
...
superabilitywatcher()
{
    ...
    for (;;)
    {
        ...
        {
            case "super_rewind":
                scripts\engine\utility::_id_1312D( "teleport_success", "rewind_success" );
...
placeflag()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devPlaceDomFlag", "" ) != "" )
        {
            ...
            var_12 scripts\mp\gameobjects::_id_1213C( level.icondefendflag, level.iconcaptureflag, level.spawnangle );
