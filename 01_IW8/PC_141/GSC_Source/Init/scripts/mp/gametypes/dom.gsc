...
initspawns()
{
    ...
    else if ( istrue( level.apc_rus_driverturretreload ) )
...
spawnpointdanger( var_0 )
{
    switch ( level.mapname )
    {
        case "mp_piccadilly":
            ...
            break;
        case "mp_malyshev":
            if ( level.silo_door_cover_spawners )
            {
                switch ( var_0.script_label )
                {
                    case "_a":
...
_id_12E0E()
{
    ...
    while ( !level.gameended )
    {
        foreach ( var_1 in level.players )
        {
            ...
            if ( !isdefined( var_1.spawnanglemin ) || var_1.spawnanglemin != var_2 )
            {
                var_1 setmlgdominationpoint( var_2 );
                var_1.spawnanglemin = var_2;
