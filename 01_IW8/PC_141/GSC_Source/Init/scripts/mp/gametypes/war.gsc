...
main()
{
    ...
    if ( getdvarint( "scr_hotfoot", 0 ) != 0 )
        level.onplayerkilled = ::totaltrainlootcrates;
...
onstartgametype()
{
    ...
    if ( isdefined( level.punishwavechaseplayers ) )
        [[ level.punishwavechaseplayers ]]();
    else
        initspawns();
...
stack_patch_waittill_context()
{
    level endon( "game_ended" );
    level.outlinedplayers = [];
    level.player_on_helipad = 0;
    var_0 = 0;
    ...
    for (;;)
    {
        ...
        {
            if ( !isdefined( var_2.player_onspawn ) )
            {
                var_2.player_on_right_side_of_subway_car = 0;
                var_2.player_onspawn = var_2.origin;
                var_2.ai_push_to_position = var_2.origin;
            }

            var_2.player_on_right_side_of_subway_car = var_2.player_on_right_side_of_subway_car + distancesquared( var_2.player_onspawn, var_2.origin );
            var_2.player_onspawn = var_2.origin;
        }
        ...
        if ( var_0 > 3.0 )
        {
            if ( level.player_on_helipad >= 2 )
            {
                level.player_on_helipad = 0;

                foreach ( var_2 in level.players )
                {
                    if ( !isdefined( var_2.ai_push_to_position ) )
                        var_2.ai_push_to_position = var_2.origin;

                    var_2.land_usability_disabled = distancesquared( var_2.ai_push_to_position, var_2.origin ) < 4225;
                    var_2.ai_push_to_position = var_2.origin;
                }
            }
            ...
            foreach ( var_2 in level.players )
            {
                ...
                if ( isalive( var_2 ) && ( istrue( var_2.land_usability_disabled ) || var_2.player_on_right_side_of_subway_car < 4225 && !istrue( var_2.player_origin_inside_front_zone ) ) )
                {
                    var_2.land_usability_disabled = 0;
                ...
                {
                    if ( isalive( var_2 ) )
                        var_2.player_origin_inside_front_zone = 0;
        ...
        level.player_on_helipad++;
        waitframe();
    }
}

totaltrainlootcrates( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
