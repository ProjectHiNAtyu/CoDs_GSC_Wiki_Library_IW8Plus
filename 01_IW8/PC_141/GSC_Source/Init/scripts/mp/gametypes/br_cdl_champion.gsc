...
x1fin_ontimerexpired()
{
    ...
    var_6 = minigameapplyplayernamesettings( var_2, var_4[0] );

    if ( isdefined( var_6 ) )
    {
        if ( istrue( var_0 ) )
            _id_120FE( var_6, var_5[0], 0 );
        else
            _id_120FE( var_6, var_5[0], 1 );
    }

    for ( var_7 = 0; var_7 < var_3.size; var_7++ )
    {
        var_8 = minigameapplyplayernamesettings( var_3[var_7], var_4[2] );

        if ( isdefined( var_8 ) )
        {
            if ( scripts\engine\utility::array_contains( var_1, var_7 ) )
            {
                _id_120FE( var_8, var_5[1], 1 );
                continue;
            }

            _id_120FE( var_8, var_5[1], 0 );
        }
    }
}

_id_120FE( var_0, var_1, var_2 )
{
    if ( istrue( var_2 ) )
