...
onplayerkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( var_3 == "MOD_FALLING" || isdefined( var_1 ) && isplayer( var_1 ) )
    {
        ...
        if ( var_1 != self && var_3 == "MOD_PISTOL_BULLET" || var_3 == "MOD_RIFLE_BULLET" || var_3 == "MOD_HEAD_SHOT" || var_3 == "MOD_PROJECTILE" || var_3 == "MOD_PROJECTILE_SPLASH" || var_3 == "MOD_IMPACT" || var_3 == "MOD_GRENADE" || var_3 == "MOD_GRENADE_SPLASH" || var_3 == "MOD_EXPLOSIVE" || var_3 == "MOD_FIRE" || var_3 == "MOD_MELEE" && !var_11 || var_12 )
        {
            ...
            if ( !var_1 destpoint( var_4, var_13, var_12 ) )
                return;
            ...
            if ( var_1 relic_squadlink_turn_team_headobjectives() )
            {
                var_14 = [];
    ...
    for ( var_0 = 0; var_0 < level.gun_guns.size; var_0++ )
    {
        ...
        if ( scripts\mp\utility\script::isstrstart( var_1, "rand_" ) )
        {
            ...
            if ( level.ladderindex == 4 || level.ladderindex == 5 )
                level.gun_guns[var_0] = scripts\mp\class::deactivate_hacked_console( var_2["weapon"], undefined, undefined, var_2["variantID"], undefined, undefined, scripts\cp_mp\utility\game_utility::isnightmap() );
            else
                level.gun_guns[var_0] = deactivate_laser_trap( var_2 );
        ...
        if ( level.ladderindex == 4 || level.ladderindex == 5 )
        {
            var_6 = modespawn( var_3 );
            var_7 = scripts\mp\class::_id_12886( var_3, var_6 );
            var_4 = scripts\mp\class::deactivate_hacked_console( var_3, undefined, undefined, var_7, undefined, undefined, scripts\cp_mp\utility\game_utility::isnightmap() );
        }
        else
        {
            var_7 = 0;
            ...
            var_4 = onmatchplacement( var_3, var_5, var_7, scripts\cp_mp\utility\game_utility::isnightmap() );
        }
...
buildrandomweapontable()
{
    ...
    for (;;)
    {
        ...
        if ( var_2 == "" || getdvarint( var_2, 0 ) == 1 )
        {
            ...
            if ( !scripts\mp\weapons::resetchemicalvalvevalues( var_3["weapon"] ) )
            {
                var_0++;
                continue;
            }
...
getrandomweaponfromcategory( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1.size > 0 )
    {
        ...
        if ( level.ladderindex == 4 || level.ladderindex == 6 )
        {
            var_9 = modespawn( var_3["weapon"] );
            var_3["variantID"] = scripts\mp\class::_id_12886( var_3["weapon"], var_9 );
        }
        else if ( level.ladderindex == 5 )
            var_3["variantID"] = scripts\mp\class::_id_12886( var_3["weapon"], "-1" );
...
deactivate_laser_trap( var_0 )
{
    var_1 = randomintrange( var_0["min"], var_0["max"] + 1 );
    var_2 = onmatchplacement( var_0["weapon"], var_1, var_0["variantID"], scripts\cp_mp\utility\game_utility::isnightmap() );
    return var_2;
}
...
modifyweapon( var_0, var_1, var_2 )
{
    ...
    if ( var_1 > 0 )
    {
        ...
        if ( var_10.size > 0 )
        {
            var_11 = scripts\mp\utility\weapon::midpoint_music( var_0 );
            var_12 = var_11.size;
...
onmatchplacement( var_0, var_1, var_2, var_3 )
{
    if ( level.ladderindex == 6 )
    {
        if ( !isdefined( var_1 ) )
        ...
        var_4 = scripts\mp\class::deactivate_laser_from_struct( var_0, var_6, undefined, undefined, var_2, undefined, undefined, undefined, var_3 );
        return var_4;
    }
    else
    {
        if ( isdefined( var_2 ) && var_2 != 0 )
            var_4 = scripts\mp\class::deactivate_hacked_console( var_0, undefined, undefined, var_2, undefined, undefined, var_3 );
        else
            var_4 = scripts\mp\class::buildweapon( var_0, undefined, undefined, undefined, undefined, undefined, undefined, undefined, var_3 );
...
onlowpopstart( var_0 )
{
    var_1 = scripts\mp\utility\weapon::midpoint_music( var_0 );
    var_2 = [];
...
getvalidattachments( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_10 in var_0 )
    {
        ...
        if ( !scripts\mp\utility\weapon::branalytics_landing( var_2, var_10 ) )
        {
...
giveortakethrowingknife( var_0 )
{
    ...
    if ( scripts\mp\utility\weapon::isknifeonly( var_0 ) || scripts\mp\utility\weapon::refreshsquadspawnareaomnvars( var_0 ) || scripts\mp\utility\weapon::isaxeweapon( var_0 ) )
    {
