...
bombzone_onbombplanted( var_0, var_1 )
{
    ...
    if ( !level.multibomb )
    {
        ...
        var_3 = molotov_watch_cleanup_pool_internal();
    ...
    if ( scripts\mp\utility\game::getgametype() != "cmd" )
        var_8 thread carriable_ready( var_2, "waypoint_bomb_defend", "waypoint_defuse" );
...
getbombmodel( var_0 )
{
    if ( istrue( level.open_teleport_room_door ) && istrue( var_0 ) )
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( !level.bombdefused )
    {
        ...
        if ( istrue( self.firstpickup ) )
        {
            ...
            if ( istrue( level.open_teleport_room_door ) )
            {
                ...
                playfx( level.playerhumanconcusspush["vanish_hw_fr"], self.trigger.origin + ( 0, 0, -9970 ) );
            }
        }
        else
            var_3 = "bomb_pickup";
    ...
    scripts\mp\utility\game::setup_enemy_sentries( var_0, undefined, "Bomb Picked Up", var_0.origin );
