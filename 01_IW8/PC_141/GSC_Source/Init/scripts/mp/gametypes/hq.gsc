...
main()
{
    ...
    level.destroyscoreevent = ::destroyscoreevent;
...
hqmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture::setteamlastzombietime( level.firstzoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
getnextzone()
{
    ...
    else if ( isdefined( level._id_11C40 ) )
    {
        level.prevzoneindex++;
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture::setteamlastzombietime( level.zoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
setupzones()
{
    ...
    var_0 = juggernaut_dmg_modifier( var_0 );
    var_1 = [];
    var_2 = 0;
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5.assisttouchlist ) )
    {
        ...
        if ( var_5.assisttouchlist[var_2].size > 0 )
            var_5 thread obit_destroy_old_vehicles( var_2 );
    }
}

obit_destroy_old_vehicles( var_0 )
{
    level endon( "game_ended" );
