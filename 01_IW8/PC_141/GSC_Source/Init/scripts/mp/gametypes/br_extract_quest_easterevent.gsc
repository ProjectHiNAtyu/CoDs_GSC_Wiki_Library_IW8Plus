...
init()
{
    var_0 = scripts\mp\gametypes\br_quest_util::registerquestcategory( "blueprintextract_easterevent", 1 );

    if ( !var_0 )
        return;

    scripts\mp\gametypes\br_quest_util::_id_11BBF( "blueprintextract_easterevent", ::iscopiedclass );
    scripts\mp\gametypes\br_quest_util::registerremovequestinstance( "blueprintextract_easterevent", ::iscarriablescriptable );
    scripts\mp\gametypes\br_quest_util::registerquestlocale( "blueprintextract_easterevent_locale" );
    scripts\mp\gametypes\br_quest_util::registercreatequestlocale( "blueprintextract_easterevent_locale", ::isballisticspecial );
    scripts\mp\gametypes\br_quest_util::registercheckiflocaleisavailable( "blueprintextract_easterevent_locale", ::isattachmentvariantlocked );
    scripts\mp\gametypes\br_quest_util::registerremovequestinstance( "blueprintextract_easterevent_locale", ::isblocked );
    scripts\mp\gametypes\br_quest_util::registerquestcircletick( "blueprintextract_easterevent_locale", ::isautouse );
    scripts\mp\gametypes\br_quest_util::_id_11BB0( "blueprintextract_easterevent_locale", ::isbestplayertime );
    scripts\mp\gametypes\br_quest_util::_id_11BB3( "blueprintextract_easterevent_locale", ::isblindedby );
    scripts\mp\gametypes\br_quest_util::getquestdata( "blueprintextract_easterevent_locale" ).nextid = 0;
    scripts\mp\gametypes\br_quest_util::_id_11A3A( "blueprintextract_easterevent", 1 );
    scripts\mp\gametypes\br_quest_util::_id_11BB4( "blueprintextract_easterevent", ::is_valid_station_name );
    ...
    if ( !isdefined( level.wheelson_damage_monitor.data["extractHelipadPlunder"].zvelscale ) )
    {
    ...
    if ( !isdefined( level.wheelson_damage_monitor.data["extractHelipadBR"].zvelscale ) )
    {
...
iscopiedclass()
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util::jailloadout( "blueprintextract_easterevent", var_0 );
...
isballisticspecial( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util::createlocaleinstance( "blueprintextract_easterevent_locale", "blueprintextract_easterevent", "ExtractPoint:" + scripts\mp\gametypes\br_quest_util::getquestdata( "blueprintextract_easterevent_locale" ).nextid );
    ...
    scripts\mp\gametypes\br_quest_util::addquestinstance( "blueprintextract_easterevent_locale", var_1 );
    return var_1;
}
...
isbecomingzombie( var_0 )
{
    var_1 = spawnstruct();
    var_1.origin = var_0;
    var_2 = scripts\mp\gametypes\br_extract_quest::mp_m_overunder_patch( var_1 );
    var_3 = scripts\mp\gametypes\br_quest_util::jailloadout( "blueprintextract_easterevent", var_2 );
...
isautouse( var_0, var_1 )
{
    ...
    if ( var_3 > var_1 )
    {
        ...
        {
            scripts\mp\gametypes\br_quest_util::displayteamsplash( var_5.team, "br_blueprint_extract_quest_circle_failure_easterevent" );
...
takequestitem( var_0 )
{
    ...
    var_5 = scripts\mp\gametypes\br_quest_util::createquestinstance( "blueprintextract_easterevent", self.team, var_0.index, var_0 );
    ...
    scripts\mp\gametypes\br_quest_util::addquestinstance( "blueprintextract_easterevent", var_5 );
    scripts\mp\gametypes\br_quest_util::_id_1274F( "blueprintextract_easterevent", self, self.team );
    ...
    var_12.winbycaptures = scripts\mp\gametypes\br_quest_util::move_spawnpoints_to_valid_positions( "blueprintextract_easterevent", scripts\mp\gametypes\br_quest_util::movenavobstaclemonitor( self.team ) );
    ...
    scripts\mp\gametypes\br_quest_util::has_zone( var_5.team, self, 6, scripts\mp\gametypes\br_quest_util::getquestindex( "blueprintextract_easterevent" ) );
...
has_started_cache_defenses( var_0 )
{
    ...
    var_5 = scripts\mp\gametypes\br_quest_util::move_to_track_end( scripts\mp\gametypes\br_quest_util::move_to_new_node( "blueprintextract_easterevent" ) );
