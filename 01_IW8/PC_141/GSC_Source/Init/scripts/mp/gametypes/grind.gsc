    ...
    for (;;)
    {
        ...
        if ( istrue( level.open_teleport_room_door ) )
        {
            if ( isdefined( var_1 ) && var_1.team == var_0.team )
            {
                ...
                playfx( level.playerhumanconcusspush["vanish_hw_fr"], var_0.trigger.origin + ( 0, 0, 45 ) );
            }
            else
            {
                playfx( level.conf_fx["vanish"], var_0.trigger.origin );
                playfx( level.playerhumanconcusspush["vanish_hw_en"], var_0.trigger.origin + ( 0, 0, 45 ) );
            }
        }
        else
...
createzones()
{
    ...
    {
        var_3 = scripts\mp\gametypes\obj_grindzone::setupobjective( var_2, 1, 1 );
    ...
    if ( level.mapname == "mp_deadzone" )
    {
        ...
        var_3 = scripts\mp\gametypes\obj_grindzone::setupobjective( var_5, 1, 1 );
        var_3 thread runzonethink();
        level.objectives[var_3.objectivekey] = var_3;
    }
    ...
    foreach ( var_3 in level.objectives )
    {
        ...
        var_3 scripts\mp\gametypes\obj_grindzone::_id_1213A();
...
droptags( var_0, var_1 )
{
    ...
    if ( istrue( level.open_teleport_room_door ) && !isdefined( level.jugg_maze_killtrigger ) )
    {
        level.jugg_maze_killtrigger = 1;
        var_2 = 4;
    }
