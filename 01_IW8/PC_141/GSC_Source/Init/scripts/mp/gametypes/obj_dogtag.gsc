...
spawndogtags( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( level.dogtags[var_0.guid] ) )
    {
        if ( istrue( level.leaderplunderstring ) )
            ...
            playfx( level.playerhumanconcusspush["vanish_hw_fr"], level.dogtags[var_0.guid].curorigin );
        else
...
removetags( var_0, var_1, var_2 )
{
    if ( isdefined( level.dogtags[var_0] ) )
    {
        ...
        if ( istrue( level.leaderplunderstring ) )
        {
            if ( isdefined( level._id_125C1 ) )
                level [[ level._id_125C1 ]]( level.dogtags[var_0], var_2 );
        }
        else if ( istrue( level.open_teleport_room_door ) )
        {
            if ( isdefined( var_2 ) && var_2.team == level.dogtags[var_0].ownerteam )
            {
                ...
                playfx( level.playerhumanconcusspush["vanish_hw_fr"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
            else
            {
                playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
                playfx( level.playerhumanconcusspush["vanish_hw_en"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
        }
        else
            playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
...
_id_125C0( var_0, var_1 )
{
    ...
    {
        playfx( level.conf_fx["vanish_gos"], var_0.curorigin );
        playfx( level.oil_puddles["gos_fireworks"], var_0.curorigin );
        level thread scripts\mp\gametypes\common::_id_1311F( var_0.curorigin );
    }
}
