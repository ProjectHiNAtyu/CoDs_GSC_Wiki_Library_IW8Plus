...
rewardspawn( var_0, var_1 )
{
    ...
    switch ( var_2 )
    {
        case "brloot_killstreak_clusterstrike":
            var_4 = scripts\mp\gametypes\br_pickups::module_set_goal_radius( var_0.origin + ( 0, 0, 0.1 ), var_0.angles );
...
smoking_idle( var_0 )
{
    ...
    for (;;)
    {
        ...
        scripts\asm\shared\mp\utility::bonuskillscharge( var_0 );
...
standing_cellphone_loop( var_0, var_1 )
{
    self endon( "death" );
    self endon( "damage" );
    scripts\asm\shared\mp\utility::bonusdeathplunder( var_0, var_1 );
}
...
reset_guy( var_0 )
{
    ...
    var_0 scripts\asm\shared\mp\utility::bonus_target_domage();
