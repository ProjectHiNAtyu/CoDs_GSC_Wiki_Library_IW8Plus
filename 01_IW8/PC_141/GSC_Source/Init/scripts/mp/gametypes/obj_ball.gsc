...
ball_on_pickup( var_0, var_1 )
{
    ...
    if ( var_4 )
    {
        ...
        else
        {
            ...
            if ( isplayer( var_0 ) )
                var_0 thread scripts\common\utility::_id_12C2C( level.slopelocked, "pickup_interception", var_0.origin );
        }
    }
    else
    {
...
ball_on_reset()
{
    ...
    thread scripts\common\utility::_id_12C2C( level.slopelocked, "obj_return", var_0.baseorigin );
}
...
waitforreset( var_0 )
{
    ...
    if ( level.juggernautchallengedone != 0 )
        scripts\mp\hostmigration::waitlongdurationwithhostmigrationpause( level.juggernautchallengedone );
...
ball_location_hud()
{
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13137( "pickup_object", "dropped", "reset", "ball_ready" );
...
updatetimers( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( var_2 ) )
    {
        if ( istrue( level.juggernautchallengedone ) && !istrue( level.ballreset ) )
            var_5 = 1000 * level.juggernautchallengedone;
    }
