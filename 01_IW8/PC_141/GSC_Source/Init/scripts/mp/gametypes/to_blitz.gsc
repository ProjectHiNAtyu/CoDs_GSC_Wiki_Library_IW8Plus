...
rpgcrateenduse( var_0 )
{
    ...
    var_0 scripts\mp\weapons::_id_1212C( getcompleteweaponname( "iw8_la_rpapa7_mp" ) );
}
...
watchiconupdater()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_1312E( "bradley_driverUpdate", "death", "bradley_vehicleExit" );
...
ontimelimit()
{
    if ( isdefined( level.onphaseend ) )
    {
        var_0 = scripts\mp\gamescore::define_as_level_infil_driver( 0 );
