...
main()
{
    ...
    level.relic_award_bullets = 0;
    var_0 = getdvarint( "LTSNLQNRKO" ) && !getdvarint( "LSTLQTSSRM" );

    if ( var_0 )
        level.relic_award_bullets = getdvarint( "scr_siege_groundwarSiege", 0 );

    level.black_screen_overlay = [];

    if ( level.relic_award_bullets )
        level.black_screen_overlay[level.black_screen_overlay.size] = "arm";
    ...
    if ( istrue( level.relic_award_bullets ) )
    ...
    if ( level.relic_award_bullets )
    {
        ...
        level.maxhqtanks = 0;
        level.targetsite = getdvarint( "scr_siege_numNonRallyVehicles", 25 );
        level._id_1233D = 1;
...
nocrouch( var_0, var_1 )
{
    ...
    level.brevent1playervalid = var_4;
    level.brevent1playerthink = var_5;
...
updategametypedvars()
{
    ...
    level.player_give_intel_3_ks = scripts\mp\utility\dvars::dvarfloatvalue( "holdAllTimer", 7.5, 0, 60 );
}
...
onplayerconnect( var_0 )
{
    ...
    if ( level.relic_award_bullets && isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] != 0 && !scripts\mp\flags::gameflag( "prematch_done" ) )
...
domflags()
{
    ...
    foreach ( var_24 in level.objectives )
    {
        ...
        var_24._id_1277F = ::train_attach_useable_ammorestocklocation;
...
watchflagenduse( var_0 )
{
    ...
    if ( var_1 == level.targs_done )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_2 == level.targs_done )
...
{
    if ( isdefined( self._id_131BA ) )
        self._id_131BA = undefined;
...
checkendgame()
{
    ...
    if ( var_0 == level.targs_done )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_1 == level.targs_done )
        setwinner( "axis", "siege_allflags_win", "siege_allflags_loss" );
}
...
runobjectives( var_0 )
{
    ...
    foreach ( var_2 in level.allfobs )
    {
        ...
        var_2.trigger.gameobject._id_1277F = ::train_attach_useable_ammorestocklocation;
    ...
    if ( level.precappoints )
        scripts\mp\gametypes\obj_dom::precap( level.targs_done == 5 );

    scripts\mp\gametypes\dom::flagsetup();
    level thread objective_manageobjectivesintrovisibility();
    level thread scripts\mp\gametypes\arm::bleedout_heartbeat_sfx_logic();
}
...
_id_11C3F( var_0 )
{
    if ( level.mapname == "mp_downtown_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.timeoutonabandoneddelay ) )
        {
            var_0.timeoutonabandoneddelay = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_c" && !isdefined( var_0.timeoutonabandoneddelay ) )
        {
            var_0.timeoutonabandoneddelay = "_c";
            var_0.objkey = "_b";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.timeoutonabandoneddelay ) )
        {
            var_0.timeoutonabandoneddelay = "_d";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
        }
    }
    else if ( level.mapname == "mp_boneyard_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.timeoutonabandoneddelay ) )
        {
            var_0.timeoutonabandoneddelay = "_b";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.timeoutonabandoneddelay ) )
    ...
    {
        if ( var_0.objkey == "_a" && !isdefined( var_0.timeoutonabandoneddelay ) )
        {
            var_0.timeoutonabandoneddelay = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        ...
        else if ( var_0.objkey == "_e" && !isdefined( var_0.timeoutonabandoneddelay ) )
        {
            var_0.timeoutonabandoneddelay = "_e";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
        }
    }
    ...
    else if ( var_0.objkey == "_b" && !isdefined( var_0.timeoutonabandoneddelay ) )
    {
        var_0.timeoutonabandoneddelay = "_b";
        var_0.objkey = "_a";
        var_0.script_label = var_0.objkey;
