...
init()
{
    ...
    scripts\mp\gametypes\br_publicevents::_id_11BB8( 2, ::_id_12E97, var_0, ::_id_1310B, ::allassassin_initteamlist_timed );
...
{
    level endon( "game_ended" );
    scripts\mp\gametypes\br_publicevents::_id_122E4( "br_pe_firesale_start" );
    ...
    scripts\mp\gametypes\br_publicevents::_id_122E4( "br_pe_firesale_end" );
