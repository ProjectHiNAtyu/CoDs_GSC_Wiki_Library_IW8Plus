...
onstartgametype()
{
    ...
    level thread scripts\mp\gametypes\arena::spawngameendflagzone( var_5 );
...
onspawnfinished()
{
    ...
    if ( game["matchStartRequiresInput"] && !isbot( self ) )
    {
        ...
        thread open_door_to_next_objective();
...
spawnweapon( var_0, var_1 )
{
    ...
    var_5 = juggernaut_damage_override( var_0 );
