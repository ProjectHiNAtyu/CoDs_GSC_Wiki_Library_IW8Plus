...
hqmainloop()
{
    ...
    for (;;)
    {
        ...
        var_5 = level scripts\engine\utility::_id_13135( "hq_captured", "hq_destroyed" );
...
onradiodestroy( var_0 )
{
    ...
    var_0 thread scripts\common\utility::_id_12C2C( level.slopelocked, "destroy", var_0.origin );
    ...
    if ( isdefined( level.radioobject ) )
    {
        ...
        if ( var_13 != var_10 )
        {
            if ( var_11 istouching( level.radioobject.trigger ) )
            {
                ...
                thread scripts\common\utility::_id_12C2C( level.skydiveontacinsertplacement.smoke_init, var_9, "defending" );
            }
        }
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isplayer( var_5 ) )
    {
        ...
        {
            var_5 thread scripts\common\utility::_id_12C2C( level.slopelocked, "capture", var_5.origin );
