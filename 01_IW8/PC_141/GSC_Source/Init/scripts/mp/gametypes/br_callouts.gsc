...
init()
{
    level.calloutglobals.strict_ff_enable = [];
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            level.calloutglobals.strict_ff_enable[var_11] = var_12;
        }
...
molotov_get_unique_pool_id( var_0 )
{
    ...
    foreach ( var_4, var_3 in level.calloutglobals.strict_ff_enable )
    {
...
molotov_get_pool_level_data( var_0 )
{
    ...
    foreach ( var_11, var_9 in level.calloutglobals.strict_ff_enable )
    {
