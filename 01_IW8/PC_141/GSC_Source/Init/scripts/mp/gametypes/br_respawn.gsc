...
playersetinlaststand()
{
    ...
    scripts\mp\gametypes\br_public::_id_12155( 1 );
}
...
playertrytakedefibrillator( var_0 )
{
    if ( isalive( self ) && isdefined( var_0 ) && isdefined( var_0.basename ) && var_0.basename == "iw8_defibrillator_mp" && self hasweapon( "iw8_defibrillator_mp" ) )
    {
        ...
        if ( var_1.size > 0 && !scripts\mp\utility\weapon::relic_nuketimer_timer_init( var_1[0] ) )
            self switchtoweapon( var_1[0] );
        else if ( var_1.size > 1 && !scripts\mp\utility\weapon::relic_nuketimer_timer_init( var_1[1] ) )
...
useentrespawntimeout( var_0, var_1, var_2 )
{
    ...
    var_1 scripts\engine\utility::_id_13147( var_0, "disconnect" );
    self notify( "timeout" );
    waittillframeend;
...
{
    self endon( "droppedBody" );
    var_0 scripts\engine\utility::_id_1312E( "disconnect", "death", "last_stand_start" );
...
{
    self endon( "droppedBody" );
    scripts\engine\utility::_id_1312D( "timeout", "respawnComplete" );
    dropbody( self, var_0, var_1, var_2 );
}
...
{
    scripts\engine\utility::_id_1312E( "death", "disconnect", "last_stand_start", "defibrillator_done" );
