...
brvehiclesinit()
{
    ...
    level.clean_up_rocket = getdvarint( "scr_br_truck_max", -1 );
...
setupvehiclespawnvolumes()
{
    ...
    foreach ( var_14, var_6 in var_4.databyref )
    {
        ...
        if ( isdefined( level.istrialslevel ) )
            var_7 = [[ level.istrialslevel ]]( var_7 );

        _id_12C2E( var_7 );
        flag_num_players_on_team( var_7, "atv_spawn", "atv", "motorcycle_spawn", "motorcycle", "motorcycle_spawn_percent" );
        level.br_vehicleallspawns = scripts\engine\utility::array_combine_unique( level.br_vehicleallspawns, var_7 );

        foreach ( var_9 in var_7 )
        {
            if ( isdefined( var_9.script_priority ) && var_9.script_priority > 0 && ( level.clean_up_rocket < 0 || !register_vehicle_spawn_override( var_9 ) ) )
            {
            ...
            if ( level.clean_up_rocket >= 0 && register_vehicle_spawn_override( var_9 ) )
            {
                level.clean_up_search[level.clean_up_search.size] = var_9;
                continue;
            }
...
initvehiclespawnvolume( var_0 )
{
    ...
    switch ( level.mapname )
    {
        ...
        case "mp_kstenod":
            ...
            break;
        case "mp_don4":
            br_should_continue_adding_armor( var_0 );
            break;
        case "mp_wz_island":
            br_skipending( var_0 );
            break;
...
emptyallvehicles()
{
    ...
    foreach ( var_5, var_1 in level.vehicle.instances )
    {
        ...
        {
            if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_12F90( var_3 ) )
...
deleteextantvehicles( var_0 )
{
    ...
    scripts\cp_mp\vehicles\vehicle_spawn::_id_12FC0();
    ...
    foreach ( var_7, var_2 in level.vehicle.instances )
    {
        ...
        foreach ( var_5 in var_2 )
        {
            ...
            scripts\cp_mp\vehicles\vehicle_spawn::_id_12FC6( var_5 );
...
{
    if ( scripts\mp\gametypes\br_gametypes::relic_amped_explosion_time( "vehicleSpawns" ) )
        return;

    if ( ( var_0 == "little_bird" || var_0 == "little_bird_mg" ) && scripts\mp\gametypes\br_gametypes::relic_amped_explosion_time( "littleBirdSpawns" ) )
        return;
...
spawnavehicle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_6 ) )
    {
        if ( scripts\mp\gametypes\br_gametypes::register_script_model_animation( "postSpawnVehicle" ) )
            scripts\mp\gametypes\br_gametypes::_id_11E4F( "postSpawnVehicle", var_6, var_0 );

        scripts\mp\gametypes\br_analytics::clearlethalonunresolvedcollision( var_6, var_0 );
    }
...
spawninitialvehicles()
{
    ...
    if ( level.clean_up_rocket > 0 && level.br_totalvehiclesspawned < level.br_totalvehiclesmax )
    {
        var_30 = 0;
        var_31 = scripts\engine\utility::array_randomize( level.clean_up_search );
        ...
        foreach ( var_6 in var_31 )
        {
            ...
            if ( isdefined( var_9 ) )
            {
                ...
                if ( var_30 >= level.clean_up_rocket )
                    break;
    ...
    if ( level.clean_up_rocket >= 0 )
        var_3 = scripts\engine\utility::array_remove_array( var_3, level.clean_up_search );
...
waitforvehiclestodeletethenspawninitial()
{
    ...
    if ( scripts\mp\gametypes\br_gametypes::register_script_model_animation( "spawnInitialVehicles" ) )
        scripts\mp\gametypes\br_gametypes::_id_11E4F( "spawnInitialVehicles" );
    else
        spawninitialvehicles();
}
...
dangercircletick( var_0, var_1 )
{
    ...
    var_6 = create_vehicle_occupancy_data();
...
flag_num_players_on_team( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        if ( resetarenaomnvardata( var_9, var_1, var_2 ) )
...
resetarenaomnvardata( var_0, var_1, var_2 )
{
...
_id_12C2E( var_0 )
{
    ...
    {
        if ( relic_mythic_should_ai_play_pain( var_4 ) )
...
relic_mythic_should_ai_play_pain( var_0 )
{
