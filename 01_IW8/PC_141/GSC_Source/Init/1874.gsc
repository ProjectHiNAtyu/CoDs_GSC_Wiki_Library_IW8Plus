...
init()
{
    ...
    level.deployed = scripts\mp\utility\game::getgametype() == "br" && getdvarint( "scr_log_br_weapon_stats", 0 ) == 1;
    level.smoke_wheelson_chosen_spawn = ::onmatchstart;
    level.smokeglvfx = ::onroundend;
    level.smartwatchinteract = ::logkillstreakevent;
    level.slopelocked = ::loggameevent;
    level.slamcamoverlay = ::logattackerkillevent;
    level.smoke_init = ::logvictimkillevent;
    level.smeansofdeathshitloc = ::logmultikill;
    level.smoke_emitter = ::logplayerlife;
    level.smoke_door = ::logplayerdeath;
    level.smodelcollections = ::logplayerdata;
    level.smoke_enemy_think = ::logscoreevent;
    level.smokekill = ::_id_11B47;
    level.smoke_screen = ::logweaponstat;
    level.skydivestreamhintdvars = ::logattachmentstat;
    level.skydivehintnotify = ::buildweaponrootlist;
    level.slide_trig = ::logchallenge;
    level.slide_airlock = ::logaward;
...
onmatchstart()
{
    ...
    if ( var_0 == "br" )
        scripts\common\utility::_id_12C2C( level.skipweapondropondeath );
...
logplayerdeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isvalidclient( var_1 ) )
    {
        ...
        var_22 = var_1 start_trap_room_combat();
        var_23 = var_1.origin;
        var_24 = var_1.angles;
...
setup_teleport_rooms( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "arm" && isdefined( self.onspawn_fastspeed ) )
    {
        var_36["press_rclick"] = istrue( self.onspawn_fastspeed["rightmouseup"] );
        var_36["press_lclick"] = istrue( self.onspawn_fastspeed["leftmouseup"] );
        var_36["press_activate"] = istrue( self.onspawn_fastspeed["activate"] );
        var_36["press_gostand"] = istrue( self.onspawn_fastspeed["gostand"] );
    }
...
logplayerdata( var_0 )
{
    ...
    {
        var_2 = scripts\mp\rank::get_aitypes_and_weights_from_call_counter( self );
        scripts\mp\rank::get_alertreset_alias( self.get_alive_nonspecating_players, var_2 );
    }
    ...
    foreach ( var_23, var_6 in self.pers["matchdataWeaponStats"] )
    {
        ...
        self dlog_recordplayerevent( "dlog_event_player_weapon_stats_br", [ "weapon", var_6.weapon, "variant_id", var_6.variantid, "from_loadout", var_19, "died", var_20, "time_used_s", var_22, "longest_hit_distance", var_21, "deaths", var_9, "headshots", var_10, "hits", var_11, "kills", var_12, "shots", var_13, "damage", var_14, "attachment_0", var_6.attachments[0], "attachment_1", var_6.attachments[1], "attachment_2", var_6.attachments[2], "attachment_3", var_6.attachments[3], "attachment_4", var_6.attachments[4], "sticker_0", var_6._id_12779[0], "sticker_1", var_6._id_12779[1], "sticker_2", var_6._id_12779[2], "sticker_3", var_6._id_12779[3], "reticle", var_6.reticle, "cosmetic_attachment", var_6.flashlockpropkey, "camo", var_6.camo, "match_time_created_s", var_6.pickuptime ] );
    }
}
...
logweaponstat( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && !istrue( level.deployed ) )
        return;
    ...
    {
        if ( !downtown_gw_ambient_sound_load( var_4, var_5 ) )
        {
            var_6 = 1;
            var_7 = var_5 + "_" + var_6;
            ...
            for (;;)
            {
                if ( !isdefined( self.pers["matchdataWeaponStats"][var_7] ) || downtown_gw_ambient_sound_load( var_4, var_7 ) )
                    break;
    ...
    if ( !isdefined( self.pers["matchdataWeaponStats"][var_5] ) )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && isdefined( var_4 ) )
        {
            ...
            self.pers["matchdataWeaponStats"][var_5].flashlockpropkey = var_9;
            ...
            self.pers["matchdataWeaponStats"][var_5]._id_12779 = var_18;
        }
    }
...
downtown_gw_ambient_sound_load( var_0, var_1 )
{
    ...
    if ( var_3 != self.pers["matchdataWeaponStats"][var_1].flashlockpropkey )
        return 0;
    ...
    if ( var_7.size != self.pers["matchdataWeaponStats"][var_1]._id_12779.size )
        return 0;

    for ( var_6 = 0; var_6 < var_7.size; var_6++ )
    {
        if ( var_7[var_6] != self.pers["matchdataWeaponStats"][var_1]._id_12779[var_6] )
            return 0;
    }
