...
helper_drone_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "helperDrone", "onReconDroneSuperStarted", ::play_scramble_for_player_until_cleared );
}
...
play_scramble_for_player_until_cleared()
{
