...
init()
{
    ...
    level.rpgs = getdvarint( "scr_kill_bracket_scaling_disable", 1 );

    if ( level.rpgs != 1 )
    {
        level.run_and_stop_group_after = getdvarint( "scr_kill_bracket_start", 25 );
        level.rpggetclosetoapc = getdvarint( "scr_kill_bracket_range", 10 );
        level.rpgafterspawnfunc = getdvarint( "scr_kill_bracket_percent", 10 ) / 100;
        level.rpg_think = getdvarint( "scr_kill_bracket_count", 5 );
    }
    ...
    ammostructreplenish( var_1, "online_battle_xpscale_dvar" );
    level.ranktable = [];
    level.weaponranktable = [];
    var_2 = _func_424();
    level.maxrank = int( tablelookup( var_2, 0, "maxrank", 1 ) );
    level.sol_2_pool = int( tablelookup( var_2, 0, "maxelder", 1 ) );
...
get_aitypes_and_weights_from_call_counter( var_0 )
{
    var_1 = spawnstruct();
    var_2 = level.loadoutsgroup;
    var_1.vehicle_playerkilledfx = var_0 getplayerdata( var_2, "squadMembers", "player_xp" );
    var_1._id_132A4 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_mike4" );
    var_1._id_1329D = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_akilo47" );
    var_1._id_1329E = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_asierra12" );
    var_1._id_132A0 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_falpha" );
    var_1._id_132A3 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_mcharlie" );
    var_1._id_132A1 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_golf36" );
    var_1._id_132A2 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_kilo433" );
    var_1._id_1329F = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_falima" );
    var_1._id_132A5 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_scharlie" );
    var_1._id_132C3 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_mpapa5" );
    var_1._id_132C1 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_beta" );
    var_1._id_132C0 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_augolf" );
    var_1._id_132C5 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_papa90" );
    var_1._id_132C4 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_mpapa7" );
    var_1._id_132C7 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_uzulu" );
    var_1._id_132C8 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_victor" );
    var_1._id_132BC = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sh_dpapa12" );
    var_1._id_132BB = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sh_charlie725" );
    var_1._id_132BE = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sh_oscar12" );
    var_1._id_132BF = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sh_romeo870" );
    var_1._id_132AF = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_lm_kilo121" );
    var_1._id_132B4 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_lm_pkilo" );
    var_1._id_132B0 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_lm_lima86" );
    var_1._id_132B1 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_lm_mgolf34" );
    var_1._id_132D0 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_mike14" );
    var_1._id_132CF = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_kilo98" );
    var_1._id_132D1 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_sbeta" );
    var_1._id_132C9 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_alpha50" );
    var_1._id_132CA = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_awhiskey" );
    var_1._id_132CC = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_delta" );
    var_1._id_132CE = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_hdromeo" );
    var_1._id_132CB = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_crossbow" );
    var_1._id_132BA = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_pi_papa320" );
    var_1._id_132B6 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_pi_cpapa" );
    var_1._id_132B9 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_pi_mike1911" );
    var_1._id_132B8 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_pi_golf21" );
    var_1._id_132B7 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_pi_decho" );
    var_1._id_132AE = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_la_rpapa7" );
    var_1._id_132AA = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_la_gromeo" );
    var_1._id_132AD = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_la_mike32" );
    var_1._id_132AB = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_la_juliet" );
    var_1._id_132AC = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_la_kgolf" );
    var_1._id_132A9 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_knife" );
    var_1._id_132B5 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_me_riotshield" );
    var_1._id_132A8 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_fists" );
    var_1._id_132C2 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_charlie9" );
    var_1._id_132A7 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_tango21" );
    var_1._id_132B2 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_lm_mgolf36" );
    var_1._id_132A6 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_ar_sierra552" );
    var_1._id_132B3 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_lm_mkilo3" );
    var_1._id_132CD = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sn_golf28" );
    var_1._id_132C6 = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sm_smgolf45" );
    var_1._id_132BD = var_0 getplayerdata( var_2, "squadMembers", "weapon_xp", "iw8_sh_mike26" );
    return var_1;
}

get_alive_able_players( var_0, var_1, var_2 )
{
    var_3 = var_1 - var_0;
...
{
    var_2 = var_1.vehicle_playerkilledfx - var_0.vehicle_playerkilledfx;
    var_3 = spawnstruct();
    var_3.xp = 0;
    var_3.count = 0;
    get_alive_able_players( var_0._id_132A4, var_1._id_132A4, var_3 );
    get_alive_able_players( var_0._id_1329D, var_1._id_1329D, var_3 );
    get_alive_able_players( var_0._id_1329E, var_1._id_1329E, var_3 );
    get_alive_able_players( var_0._id_132A0, var_1._id_132A0, var_3 );
    get_alive_able_players( var_0._id_132A3, var_1._id_132A3, var_3 );
    get_alive_able_players( var_0._id_132A1, var_1._id_132A1, var_3 );
    get_alive_able_players( var_0._id_132A2, var_1._id_132A2, var_3 );
    get_alive_able_players( var_0._id_1329F, var_1._id_1329F, var_3 );
    get_alive_able_players( var_0._id_132A5, var_1._id_132A5, var_3 );
    get_alive_able_players( var_0._id_132C3, var_1._id_132C3, var_3 );
    get_alive_able_players( var_0._id_132C1, var_1._id_132C1, var_3 );
    get_alive_able_players( var_0._id_132C0, var_1._id_132C0, var_3 );
    get_alive_able_players( var_0._id_132C5, var_1._id_132C5, var_3 );
    get_alive_able_players( var_0._id_132C4, var_1._id_132C4, var_3 );
    get_alive_able_players( var_0._id_132C7, var_1._id_132C7, var_3 );
    get_alive_able_players( var_0._id_132C8, var_1._id_132C8, var_3 );
    get_alive_able_players( var_0._id_132BC, var_1._id_132BC, var_3 );
    get_alive_able_players( var_0._id_132BB, var_1._id_132BB, var_3 );
    get_alive_able_players( var_0._id_132BE, var_1._id_132BE, var_3 );
    get_alive_able_players( var_0._id_132BF, var_1._id_132BF, var_3 );
    get_alive_able_players( var_0._id_132AF, var_1._id_132AF, var_3 );
    get_alive_able_players( var_0._id_132B4, var_1._id_132B4, var_3 );
    get_alive_able_players( var_0._id_132B0, var_1._id_132B0, var_3 );
    get_alive_able_players( var_0._id_132B1, var_1._id_132B1, var_3 );
    get_alive_able_players( var_0._id_132D0, var_1._id_132D0, var_3 );
    get_alive_able_players( var_0._id_132CF, var_1._id_132CF, var_3 );
    get_alive_able_players( var_0._id_132D1, var_1._id_132D1, var_3 );
    get_alive_able_players( var_0._id_132C9, var_1._id_132C9, var_3 );
    get_alive_able_players( var_0._id_132CA, var_1._id_132CA, var_3 );
    get_alive_able_players( var_0._id_132CC, var_1._id_132CC, var_3 );
    get_alive_able_players( var_0._id_132CE, var_1._id_132CE, var_3 );
    get_alive_able_players( var_0._id_132CB, var_1._id_132CB, var_3 );
    get_alive_able_players( var_0._id_132BA, var_1._id_132BA, var_3 );
    get_alive_able_players( var_0._id_132B6, var_1._id_132B6, var_3 );
    get_alive_able_players( var_0._id_132B9, var_1._id_132B9, var_3 );
    get_alive_able_players( var_0._id_132B8, var_1._id_132B8, var_3 );
    get_alive_able_players( var_0._id_132B7, var_1._id_132B7, var_3 );
    get_alive_able_players( var_0._id_132AE, var_1._id_132AE, var_3 );
    get_alive_able_players( var_0._id_132AA, var_1._id_132AA, var_3 );
    get_alive_able_players( var_0._id_132AD, var_1._id_132AD, var_3 );
    get_alive_able_players( var_0._id_132AB, var_1._id_132AB, var_3 );
    get_alive_able_players( var_0._id_132AC, var_1._id_132AC, var_3 );
    get_alive_able_players( var_0._id_132A9, var_1._id_132A9, var_3 );
    get_alive_able_players( var_0._id_132B5, var_1._id_132B5, var_3 );
    get_alive_able_players( var_0._id_132A8, var_1._id_132A8, var_3 );
    get_alive_able_players( var_0._id_132C2, var_1._id_132C2, var_3 );
    get_alive_able_players( var_0._id_132A7, var_1._id_132A7, var_3 );
    get_alive_able_players( var_0._id_132B2, var_1._id_132B2, var_3 );
    get_alive_able_players( var_0._id_132A6, var_1._id_132A6, var_3 );
    get_alive_able_players( var_0._id_132B3, var_1._id_132B3, var_3 );
    get_alive_able_players( var_0._id_132CD, var_1._id_132CD, var_3 );
    get_alive_able_players( var_0._id_132C6, var_1._id_132C6, var_3 );
    get_alive_able_players( var_0._id_132BD, var_1._id_132BD, var_3 );

    if ( var_2 != 0 || var_3.xp != 0 )
        self dlog_recordplayerevent( "dlog_event_player_stats_hack", [ "player_xp_start", var_0.vehicle_playerkilledfx, "player_xp_end", var_1.vehicle_playerkilledfx, "diff_weapon_xp_count", var_3.count, "diff_weapon_xp", var_3.xp ] );
}
...
onplayerconnect()
{
    for (;;)
    {
        ...
        if ( !isai( var_0 ) )
            var_0.get_alive_nonspecating_players = get_aitypes_and_weights_from_call_counter( var_0 );
        ...
        var_4 = var_0 mp_m_speed_patch( var_2 );
...
giverankxp( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( ( !isdefined( level.forceranking ) || !level.forceranking ) && !scripts\mp\menus::blockade_get_bomb_icon_on_cell_phone() )
    {
        if ( level.teambased )
        {
            var_7 = 0;
    ...
    var_1 = bot_flag_ai_director_update( var_1 );
...
bot_flag_ai_director_update( var_0 )
{
    ...
    if ( level.rpgs != 1 )
    {
        if ( self.kills > level.run_and_stop_group_after )
        {
            var_2 = min( int( 1 + ( self.kills - level.run_and_stop_group_after ) / level.rpggetclosetoapc ), level.rpg_think );
            var_3 = 1 - level.rpgafterspawnfunc * var_2;
    ...
    if ( level.playerxpenabled && !isai( self ) )
    {
        if ( isdefined( var_4 ) && ( scripts\mp\utility\weapon::iscacprimaryweapon( var_4 ) || scripts\mp\utility\weapon::iscacsecondaryweapon( var_4 ) ) )
        {
            if ( !scripts\mp\utility\weapon::ispickedupweapon( var_4 ) || scripts\mp\utility\game::getgametype() == "br" )
                scripts\common\utility::_id_12C2C( level.smoke_screen, scripts\mp\utility\weapon::getweaponrootname( var_4 ), "xp_earned", var_7, -1, var_4 );
        }
    }
...
updaterank( var_0 )
{
    ...
    if ( var_4 == var_3 || var_4 >= level.maxrank + level.sol_2_pool )
        return 0;
...
incrankxp( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !isdefined( level.so_forceendgame ) )
        level.so_forceendgame = getdvarint( "scr_beta_max_level", 0 );

    if ( level.so_forceendgame > 0 && getrank() + 1 >= level.so_forceendgame )
        var_0 = 0;
    ...
    var_6 = mine_caves_runner_internal();
    var_7 = var_0 * var_6;
    var_8 = mine_caves_retreat();
    self.pers["battlepassxp"] = var_8 + var_7;
    var_9 = "";

    if ( isdefined( var_1 ) )
    {
        var_9 = scripts\mp\utility\weapon::missions_clearinappropriaterewards( var_1.basename );
        var_10 = scripts\mp\utility\weapon::getweaponrootname( var_9 );
        var_11 = non_detectable_killstreaks( var_10 );
    ...
    var_14 = mine_caves_runner_internal();
    ...
    scripts\mp\analyticslog::setup_rarity_ui_images( self, var_0, var_9, var_2, var_3 );
}
...
mp_farms2_gw_patch()
{
    if ( !isdefined( level.wave_ai_spawned ) )
        level.wave_ai_spawned = getdvarfloat( "scr_playlist_xp_scalar", 1.0 );

    return level.wave_ai_spawned;
}
...
getrankxpmultipliertotal()
{
    ...
    var_3 = mountstringtodlogenum();
    var_4 = mp_farms2_gw_patch();
    var_5 = var_0 * var_1 * var_2 * var_3 * var_4;
    return var_5;
}

ammostructreplenish( var_0, var_1 )
{
    level ammobox_tryuseinternal( var_0, var_1 );
}

modespawnclient()
{
    var_0 = level mine_caves_runner();
    var_1 = getdvarint( "scr_disable_xp_scale_quit", 0 ) == 0;
...
{
    var_2 = 4 / level mine_caves_runner();
    ...
    if ( isdefined( self.buttonmodel[var_1] ) )
        self.buttonmodel[var_1] = max( self.buttonmodel[var_1], var_0 );
    else
        self.buttonmodel[var_1] = var_0;
}
...
mine_caves_runner()
{
    ...
    foreach ( var_2 in self.buttonmodel )
    {
        if ( !isdefined( var_2 ) )
            continue;
...
mine_caves_runner_internal()
{
    var_0 = mine_caves_runner();
    var_1 = modespawnclient();
