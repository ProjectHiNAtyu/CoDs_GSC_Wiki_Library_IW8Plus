...
init()
{
    level.isteamonlycrate = getdvarint( "online_challenge_filter_shared_advanced", 1 ) != 0;
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "canSendT9UserEvent", ::destroy_vehicles );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onAgentKilled", ::tmtylsquadafterspawnfunc );
}
...
relic_steelballs_stump_monitor( var_0 )
{
...
needs_controller( var_0 )
{
    if ( !isdefined( level._id_12880 ) )
    {
        var_1 = "loot/battlepass_season" + level.dmztutendgame + ".csv";
        ...
        level._id_12880 = var_3;
    }

    for ( var_5 = 1; var_5 < level._id_12880.size; var_5++ )
    {
        if ( level._id_12880[var_5] >= var_0 )
            break;
    }

    if ( var_5 > level._id_12880.size )
        var_5 = level._id_12880.size;
...
destroy_vehicles( var_0 )
{
    ...
    if ( var_2 >= 0 )
    {
        if ( !level.isteamonlycrate )
            return 1;

        var_1 = 1;

        if ( request_warning_level( var_2 ) )
            return 0;

        if ( !relic_steelballs_stump_monitor( var_2 ) )
            return 0;
        ...
        if ( var_3 == "GUNSMITH" )
        {
            ...
            if ( var_4 != "" )
            {
                var_5 = scripts\mp\rank::non_detectable_killstreaks( var_4 );
                var_6 = scripts\mp\weaponrank::needs_radar( var_5 );
    ...
    else
    {
        ...
        if ( var_2 >= 0 )
        {
            ...
            if ( request_warning_level( var_10 + var_2 ) )
                return 0;
...
tmtylsquadafterspawnfunc( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    {
        var_1 thread scripts\mp\events::br_practice_match( var_12.lifeid, self, var_6, var_5, var_0, var_12 );
        var_13 = 0;
        var_14 = 0;
        ...
        var_2 thread scripts\cp\helicopter\chopper_boss::tmtylsquadafterspawnfunc( var_0, var_1, var_3, var_4, var_5, var_6, var_8, var_13, var_14 );
    }
}
