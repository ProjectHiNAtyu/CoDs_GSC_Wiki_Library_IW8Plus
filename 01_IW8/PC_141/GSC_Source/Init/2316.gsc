...
tac_cover_init()
{
    ...
    level._id_1289C = getentarray( "dcover_blocker", "targetname" );
    level._id_1289B = getdvarfloat( "scr_tacCover_timeoutOverride", 150.0 );
}
...
tac_cover_on_fired( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = scripts\mp\vehicles\cargo_truck_mg_mp::_id_11F52( var_7, 140, 20 );
    var_9 = undefined;
    var_10 = 0;
    ...
    if ( scripts\cp_mp\auto_ascender::remove_invulnerability( var_7 ) )
        return 0;

    if ( scripts\cp\equipment\cp_adrenaline::remove_launcher_xmags( var_7 ) )
        return 0;

    var_4 = scripts\engine\trace::freight_lift_dogtag_revive();
    ...
    if ( isdefined( var_9 ) )
    {
        ...
        {
            if ( var_9 scripts\mp\vehicles\cargo_truck_mg_mp::_id_11F53( var_26 ) )
            {
                var_24 = var_26;
                break;
            }
        ...
        {
            var_30 = _id_12892( var_9 );

            if ( isdefined( var_24 ) )
                var_30 = var_30 | _id_12892( var_24 );
            ...
            var_32 = var_9.extracthelipadwatchforhelileaving + ( 0, 0, 24 );
            ...
            self.taccoverrefund = undefined;
            thread _id_12894( var_9, var_24, var_3, var_4 );
    ...
    if ( isdefined( var_45 ) && !_id_1288F( var_45 ) )
    {
        tac_cover_fire_failed();
        return 0;
    }
...
_id_12890( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( scripts\mp\vehicles\vehicle_compass_mp::recondronetracecontents( var_0 ) || scripts\mp\vehicles\vehicle_compass_mp::recon_update_hint_logic( var_0 ) || scripts\mp\gametypes\br_gondola::reader( var_0 ) || scripts\mp\gametypes\br_soa_tower::raritycamera( var_0 ) )
            return var_0;
    }
...
tac_cover_adjust_for_player_space( var_0, var_1, var_2 )
{
    ...
    foreach ( var_9 in level._id_1289C )
    {
...
_id_12894( var_0, var_1, var_2, var_3 )
{
    self endon( "death_or_disconnect" );
    self endon( "tac_cover_taken" );
    level endon( "game_ended" );
    var_4 = anglestoforward( self.angles );
    var_5 = var_0.extracthelipadusecallback + ( 0, 90, 0 );
    var_6 = anglestoforward( var_5 );
    var_7 = vectordot( var_4, var_6 );
    var_8 = var_7 > 0;
    var_9 = var_0 scriptabledoorangle();
    var_0 scripts\mp\vehicles\cargo_truck_mg_mp::helperdrone_watchscramblereffectdist( 1, "tac_cover_door" );
    ...
    var_11 = ( 0, 0, -1 );
    var_12 = var_0.extracthelipadwatchforhelileaving + var_11;
    var_13 = combineangles( var_0.extracthelipadusecallback, var_10 );
    var_14 = undefined;
...
tac_cover_spawn( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_8.deathoverridecallback = ::_id_12893;
    ...
    if ( isdefined( var_5 ) )
    {
        if ( isdefined( var_5.can_support_mindia8_min_spawn ) )
            var_5.can_support_mindia8_min_spawn tac_cover_destroy();

        var_7.can_play_ending = var_5;
        var_5.can_support_mindia8_min_spawn = var_7;
    }

    if ( isdefined( var_6 ) )
    {
        var_7.can_spawn_extras = var_6;
        var_6.can_support_mindia8_min_spawn = var_7;
    }
...
tac_cover_spawn_internal( var_0 )
{
    ...
    if ( isdefined( var_0.can_play_ending ) )
...
tac_cover_destroy( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::total_successful_vehicle_spawns( "super_tac_cover", int( var_4 ), var_0, var_2 );
...
tac_cover_destroy_internal( var_0 )
{
    if ( isdefined( self.can_play_ending ) )
    {
        ...
        self.can_play_ending.can_support_mindia8_min_spawn = undefined;
    }
    ...
    if ( isdefined( self.can_spawn_extras ) )
    {
        ...
        self.can_spawn_extras.can_support_mindia8_min_spawn = undefined;
    }
...
{
    var_1 = _id_1288C( var_0 );

    if ( isdefined( self.owner ) )
    {
        var_2 = max( self.maxhealth - self.damagetaken, 0 );
        var_3 = int( min( var_2, var_1 ) );
        self.owner scripts\mp\supers::fake_digit_pool( "super_tac_cover", var_3 );
    }
...
_id_1288C( var_0 )
{
    ...
    if ( scripts\mp\damage::removeplatepouch( var_0.objweapon ) )
        return 0;
