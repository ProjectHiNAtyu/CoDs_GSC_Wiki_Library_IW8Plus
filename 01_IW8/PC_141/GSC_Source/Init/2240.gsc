...
wp_finishdeployment( var_0, var_1, var_2 )
{
    ...
    level endon( "game_ended" );
    thread _id_13326( "disconnect" );
    thread _id_13326( "joined_team" );
    thread _id_13326( "joined_spectator" );
...
wp_deliverpayloads( var_0 )
{
    ...
    self.owner thread _id_13329( var_0 );
...
wp_firesmoke( var_0, var_1, var_2, var_3 )
{
    ...
    var_10 thread _id_13328();
    scripts\cp_mp\hostmigration::hostmigration_waitlongdurationwithpause( 1 );
    level thread _id_13325( var_10 );
    ...
    {
        if ( scripts\cp_mp\utility\game_utility::isnightmap() || scripts\cp_mp\utility\game_utility::relic_squadlink_outline_monitor() )
