...
{
    if ( !istrue( var_1 ) )
        scripts\cp_mp\killstreaks\killstreakdeploy::mp_hardhat_patch( var_2 );
}
...
tryusesentryturretfromstruct( var_0 )
{
    ...
    scripts\cp_mp\killstreaks\manual_turret::silencer_pick_up_monitor( 0 );
    var_2 = sentryturret_create( "sentry_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        scripts\cp_mp\killstreaks\manual_turret::silencer_pick_up_monitor( 1 );
        self.bgivensentry = 0;
        return 0;
    }
...
sentryturret_watchplacement( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_4 )
        thread sentryturret_watchlaststand();
...
sentryturret_delayplacementinstructions( var_0 )
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::siege_bot_team_had_advantage( "death" );
    thread scripts\cp_mp\killstreaks\manual_turret::siege_bot_team_had_advantage( "turret_placement_finished" );
}
...
sentryturret_create( var_0, var_1 )
{
    ...
    var_3.failedmission = spawn( "script_model", var_3.origin );
    var_3.failedmission.team = var_3.team;
    var_3.failedmission.owner = var_3.owner;
    var_3.failedmission setmodel( "weapon_vm_mg_sentry_turret_invis_base" );
    var_3.failedmission dontinterpolate();
    var_3.failedmission hide();
    var_8 = 0;
    ...
    if ( var_8 )
    {
        var_3.colmodelvehicle = spawn( "script_model", var_3.origin );
        var_3.colmodelvehicle.team = var_3.team;
        var_3.colmodelvehicle.owner = var_3.owner;
        var_3.colmodelvehicle setmodel( "weapon_vm_mg_sentry_turret_invis_base_vehicle" );
        var_3.colmodelvehicle dontinterpolate();
        var_3.colmodelvehicle hide();
    }
...
sentryturret_setplaced( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.moving_platform ) )
    {
        ...
        var_0.staytoasty = var_1.staytoasty;
        var_0.stayfrosty = var_1.stayfrosty;
    }

    self.bgivensentry = 0;
    var_0.origin = var_1.location;
    var_0 playsound( "sentry_gun_plant" );
    var_0.failedmission show();
    var_0.failedmission.angles = var_0.angles;
    var_0.failedmission.origin = var_0.origin;
    var_5 = var_0.failedmission;

    if ( var_4 )
    {
        var_0.colmodelvehicle show();
        var_0.colmodelvehicle.angles = var_0.angles;
        var_0.colmodelvehicle.origin = var_0.origin;
        var_0.failedmission linkto( var_0, "tag_turret" );
        var_0.colmodelvehicle linkto( var_0, "tag_turret" );
        var_0.colmodelvehicle linkto( var_0, "tag_aim_pivot" );
        var_5 = var_0.colmodelvehicle;
    }
    else
        var_0.failedmission linkto( var_0, "tag_aim_pivot" );

    var_0 thread sentry_manageminimap( var_0, var_5 );
...
sentryturret_setcarried( var_0 )
{
    ...
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_0.staytoasty = undefined;
        var_0.stayfrosty = undefined;
        var_0 unlink();
    }
    ...
    var_0.failedmission unlink();
    var_0.failedmission hide();

    if ( var_5 )
    {
        var_0.colmodelvehicle unlink();
        var_0.colmodelvehicle hide();
    }
...
sentryturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        var_0.streakinfo.is_in_gas = istrue( var_2 );
        scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_0.streakinfo );
    }
    ...
    if ( isdefined( var_0.failedmission ) )
        var_0.failedmission delete();

    if ( isdefined( var_0.colmodelvehicle ) )
        var_0.colmodelvehicle delete();
...
sentryturret_watchdisown( var_0 )
{
    var_0 endon( "kill_turret" );
    var_0 endon( "carried" );
    scripts\engine\utility::_id_1312E( "disconnect", "joined_team", "joined_spectators" );
    var_0 notify( "kill_turret", 0, 0 );
}
...
sentry_manageminimap( var_0, var_1 )
{
...
sentry_checkdoorblocked()
{
    var_0 = scripts\mp\vehicles\cargo_truck_mg_mp::_id_11F52( self.origin, 140, 20 );
    var_1 = undefined;
    var_2 = 0;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        foreach ( var_11 in var_0 )
        {
            ...
            if ( distancesquared( var_11.extracthelipadwatchforhelileaving, var_1.extracthelipadwatchforhelileaving ) < 3600 )
            {
                var_9 = var_11;
                break;
            }
        ...
        if ( var_2 < 3600 && var_8 )
        {
            var_1.register_module_died_poorly_func = 1;
            var_1 scripts\mp\vehicles\cargo_truck_mg_mp::helperdrone_watchscramblereffectdist( 1, "tac_cover_door" );
            self.can_play_ending = var_1;

            if ( isdefined( var_9 ) && var_13 )
            {
                var_9.register_module_died_poorly_func = 1;
                var_9 scripts\mp\vehicles\cargo_truck_mg_mp::helperdrone_watchscramblereffectdist( 1, "tac_cover_door" );
                self.can_spawn_extras = var_9;
            }
        }
    }
...
sentry_freeblockeddoors()
{
    if ( isdefined( self.can_play_ending ) )
    {
        self.can_play_ending scripts\mp\vehicles\cargo_truck_mg_mp::helperdrone_watchscramblereffectdist( 0, "tac_cover_door" );
        self.can_play_ending.register_module_died_poorly_func = undefined;
        self.can_play_ending = undefined;
    }

    if ( isdefined( self.can_spawn_extras ) )
    {
        self.can_spawn_extras scripts\mp\vehicles\cargo_truck_mg_mp::helperdrone_watchscramblereffectdist( 0, "tac_cover_door" );
        self.can_spawn_extras.register_module_died_poorly_func = undefined;
        self.can_spawn_extras = undefined;
    }
}
