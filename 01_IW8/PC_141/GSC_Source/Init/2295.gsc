...
bot_choose_difficulty_for_default()
{
    ...
    if ( !isdefined( level.checkpoint_get_item ) )
        level.checkpoint_get_item = [];

    if ( !isdefined( level.checkpoint_get_item["allies"] ) )
        level.checkpoint_get_item["allies"] = 0;

    if ( !isdefined( level.checkpoint_get_item["axis"] ) )
        level.checkpoint_get_item["axis"] = 0;

    if ( !isdefined( level.checkpoint_get_item["all"] ) )
        level.checkpoint_get_item["all"] = 0;
    ...
    if ( !isdefined( self.pers["bot_chosen_difficulty"] ) )
    {
        ...
        var_0 = level.checkpoint_get_item[var_1];
        var_2 = level.bot_difficulty_defaults[var_0];
        self.pers["bot_chosen_difficulty"] = locstr( var_2 );
        level.checkpoint_get_item[var_1] = ( level.checkpoint_get_item[var_1] + 1 ) % level.bot_difficulty_defaults.size;
    }
...
bot_usebutton_wait( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\engine\utility::_id_13144( var_0, var_1, var_2, "use_button_no_longer_pressed", "finished_use" );
...
bot_allowed_to_use_killstreaks()
{
    ...
    if ( istrue( self.checkyellowmassacre ) )
        return 0;
...
checkpoint_carepkg_spawns( var_0, var_1 )
{
    switch ( var_0 )
    {
...
watch_nodes_aborted()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13141( 0.5, "still_watching_nodes" );
...
checkforovertime( var_0 )
{
    ...
    {
        var_5.should_enter_combat_after_checking_throwingknife = 0;
...
checkstayingbehindcover( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = level.gulagholding;
...
checkpoint_player_spawns_func( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        var_2 = level.gulagholding;
