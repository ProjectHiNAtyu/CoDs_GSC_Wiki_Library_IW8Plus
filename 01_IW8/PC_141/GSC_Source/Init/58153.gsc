...
init()
{
    scripts\engine\scriptable::_id_11F48( "military_ammo_restock", ::bomb_vest_timer_remaining_num_of_frame );
...
bomb_vest_timer_remaining_num_of_frame( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( chopper_boss_player_monitor( var_3 ) )
        {
            if ( scripts\mp\flags::gameflag( "prematch_done" ) && ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "rumble" ) )
                ...
                thread bomb_vest_timer_red_starting_frame( var_0, var_3, 5 );
        }
        else
            thread bomb_vest_timer_red_starting_frame( var_0, var_3, 0.1 );
    }
...
bomb_vest_timer_red_starting_frame( var_0, var_1, var_2 )
{
...
ammorestock_playeruse( var_0, var_1 )
{
    ...
    foreach ( var_9 in var_2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_0 scripts\mp\gametypes\br_weapons::chopperexif_fx_init( var_9, 2 );
            continue;
        }

        var_21 = scripts\mp\weapons::getammooverride( var_9 );

        if ( scripts\mp\utility\weapon::reflectprojectile( var_9 ) )
        {
...
chopper_boss_player_monitor( var_0 )
{
    ...
    foreach ( var_8 in var_3 )
    {
        ...
        else if ( scripts\mp\utility\weapon::relic_nuketimer_waitforcompleteobjectives( var_8 ) )
        {
        ...
        if ( var_12 )
        {
            ...
            var_0 scripts\mp\gametypes\br_weapons::chopperexif_fx_init( var_8, 2 );
            var_1 = 1;
        }
    }
