...
tryusetomastrikefromstruct( var_0 )
{
    ...
    else if ( var_1 == 5 && isdefined( self.sat_sound_think ) )
    {
...
{
    var_2 = scripts\cp_mp\utility\killstreak_utility::molotov_crate_update_hint_logic_alt();
    var_3 = ( 0, 0, 0 );
...
tomastrike_watchowner()
{
    self endon( "death" );
    level endon( "game_ended" );
    self.owner scripts\engine\utility::_id_1312E( "disconnect", "joined_team", "joined_spectators" );
    self notify( "death" );
}
...
tomastrike_watchcameraswitch( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_6 = scripts\engine\utility::_id_13135( "switch_camera_left", "switch_camera_right" );
...
tomastrike_getownerlookat( var_0 )
{
    ...
    var_5 = var_0 scripts\cp_mp\utility\killstreak_utility::wait_till_time();
...
tomastrike_attacktarget( var_0, var_1, var_2, var_3 )
{
    ...
    else
    {
        ...
        if ( !istrue( var_3.rocket_attack_min_cooldown ) )
    ...
    {
        if ( var_0 == 5 && isdefined( var_3._id_12913 ) )
            var_6 = var_3._id_12913;
        else
            var_6 = tomastrike_getownerlookat( self );

        if ( !istrue( var_3.table_getaddblueprintattachments ) )
        {
...
findunobstructedfiringinfo( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5 ) )
        ...
        var_7 = _id_12A2D( var_0, var_2, var_3, var_4 );

    var_8 = vectornormalize( var_0 - ( var_7[0], var_7[1], 0 ) );
    var_9 = _id_12A2E( var_0, var_1, var_8 );
    ...
    var_6.initbunkervfx = var_9.initbunkervfx;
    var_6.initcallbacks = var_9.initcallbacks;
...
delayscriptablechangethread( var_0 )
{
    self.owner endon( "disconnect" );
    self endon( "death" );
    self.owner scripts\engine\utility::_id_13141( var_0, "stop_marker_guide" );
...
_id_12A2E( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level._id_12A2B ) )
        var_9 = level._id_12A2B;
    ...
    if ( isdefined( var_12["entity"] ) )
    {
        ...
        var_10.initbunkervfx = var_13;

        if ( _id_12A30( var_13 ) || _id_12A2F( var_13 ) )
            var_10.initcallbacks = "flying";
    }
...
tomastrike_firestrike( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1.trial_targs ) )
        var_4 = var_1.trial_targs;
    else
        var_4 = "ks_toma_strike_missile_mp";

    var_3.explodeent = spawn( "script_model", var_3.origin );
    var_3.explodeent setmodel( var_4 );
    var_3.explodeent linkto( var_3 );
    var_3.explodeent dontinterpolate();
    var_3.explodeent setentityowner( self );
    var_5 = spawn( "script_model", var_0.sourcepos );
    var_5 linkto( var_3, "tag_origin", ( 10, 0, 10 ), ( 0, 0, 0 ) );
    var_3.killcament = var_5;
    var_3.owner = self;
    ...
    var_3 thread _id_12A2C();
    var_3 thread toma_strike_watch_airexplosion( var_0.preexplpos, var_0.initbunkervfx, var_0.initcallbacks );
...
{
    self endon( "disconnect" );
    scripts\engine\utility::_id_13141( 10, "death" );
...
toma_strike_missile_explode( var_0 )
{
    ...
    if ( isdefined( level.toma_strike_explode_callback ) )
        self [[ level.toma_strike_explode_callback ]]();
...
toma_strike_create_explosion( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5.trial_target_thread_func ) )
        var_7 = var_5.trial_target_thread_func;
    else
...
_id_12A2D( var_0, var_1, var_2, var_3 )
{
