...
init()
{
    ...
    level.little_bird_mg_deletenextframe = [];
    var_0 = 0;
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3 ) && isdefined( var_4 ) && var_4 != "" )
            level.little_bird_mg_deletenextframe[var_3] = var_4;
...
{
    return level.little_bird_mg_deletenextframe[var_0];
}
...
_id_1272A()
{
    ...
    thread wait_fire_mainhouse_flashbangs_and_smokes();
}
...
wait_fire_mainhouse_flashbangs_and_smokes()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_1312E( "skydive_deployparachute", "skydive_end", "skydive_beginfreefall" );
        thread _id_12C3B();
    }
}
...
_id_1271A()
{
    if ( istrue( self.canrecordsegmentstats ) )
        return;

    self setscriptablepartstate( "watchVFXPlayer", "bluntWatchOn" );
    self setclientomnvar( "ui_pet_watch_state", 0 );
    self setwristwatchtime( 4, 20, 1 );
    self.canrecordsegmentstats = 1;
    thread canseecantshoottime();
}
...
canseecantshoottime()
{
    ...
    wait 4.2;
    self.canrecordsegmentstats = undefined;
...
_id_12C3B()
{
    ...
    if ( var_0 )
    {
        ...
        if ( var_3 && ( !isdefined( self._id_1235F ) || !istrue( self._id_1235F ) ) )
        {
            if ( var_3 )
            {
                _id_1272A();
    ...
    else if ( var_1 )
    {
        ...
        if ( var_4 && ( !isdefined( self._id_1235F ) || !istrue( self._id_1235F ) ) )
        {
            if ( var_4 )
            {
                _id_1272B();
    ...
    else if ( var_2 )
    {
        ...
        if ( var_5 && ( !isdefined( self._id_1235F ) || !istrue( self._id_1235F ) ) )
        {
            if ( var_5 )
                _id_1272C();
        }
    ...
    if ( var_0 == "radial_menu_selection_gesture" )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            if ( var_2 == "iw8_ges_plyr_gesture024" )
            {
                ...
                self._id_1235F = !self._id_1235F;
                self setclientomnvar( "ui_smart_watch_interact", self._id_1235F );
                ...
                if ( isdefined( self.accessorylogic ) )
                {
                    ...
                    else if ( self.accessorylogic == "holo3" )
                    {
                        ...
                        scripts\cp\laser_traps\cp_laser_traps::_id_13244();
                }
            }
            else if ( var_2 == "iw8_ges_plyr_gesture023" )
            {
                if ( !isdefined( self._id_1320C ) )
                    self._id_1320C = 0;

                self._id_1320C = !self._id_1320C;
                self setclientomnvar( "ui_smart_watch_check", self._id_1320C );
...
_id_13256( var_0 )
{
    ...
    while ( gettime() < var_1 )
    {
        ...
        if ( self isgestureplaying( "iw8_ges_plyr_spray" ) )
        {
            ...
            scripts\cp\helicopter\chopper_boss::train_attach_brushes_to_models();
            return;
        }
    }
}
