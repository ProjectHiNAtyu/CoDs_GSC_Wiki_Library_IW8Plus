...
init()
{
    ...
    for (;;)
    {
        ...
        var_3 = tablelookupbyrow( "mp/score_event_table.csv", var_1, level.do_ads_hint.game_type_col[var_0] );
    ...
    level.br_toggle_armor_allows = 2097152;
...
brareloadoutdropbagsdelayed( var_0, var_1, var_2, var_3 )
{
    var_4 = 1;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        else if ( brattractions( var_2, var_1, var_3 ) )
        {
...
brattractions( var_0, var_1, var_2 )
{
    var_3 = 0;
...
br_practice_match( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isplayer( self ) )
        return;
    ...
    {
        var_10 = brareloadoutdropbagsdelayed( self, var_4, var_2, var_3 );
        ...
        if ( isdefined( var_1._id_127F3 ) && var_1._id_127F3 == self )
        {
            self.modifiers["grenadestuck"] = 1;
            self.modifiers["mask2"] = self.modifiers["mask2"] | 8;
        }

        if ( scripts\mp\utility\game::register_boss_spawners( var_1 ) )
        {
        ...
        if ( var_3 == "MOD_HEAD_SHOT" || resettimeronkill( var_2, var_5 ) || redshirt_dropoff( var_2, var_5 ) )
        {
        ...
        if ( var_10 )
        {
            ...
            switch ( var_24 )
            {
                ...
                case "longshot":
                    ...
                    self setclientomnvar( "ui_longshot_special", relic_nuketimer_gettimeformission( var_11, var_1, var_2 ) );
                    break;
                case "very_longshot":
                    self.modifiers["longshot"] = 1;
                    self.modifiers["mask"] = self.modifiers["mask"] | 262144;
            ...
            if ( scripts\mp\class::resetcircuitbreakers( var_2 ) )
            {
            ...
            if ( registeronplayerjointeamnospectatorcallback( self, var_1 ) )
            {
                self.modifiers["detectedimpairedkill"] = 1;
            ...
            if ( isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::mon_clip() > gettime() )
            ...
            if ( isdefined( var_5.damageflags ) && var_5.damageflags & level.idflags_penetration && !( var_5.damageflags & level.playerplunderdrop ) )
            {
                self.modifiers["coverkill"] = 1;
                self.modifiers["mask2"] = self.modifiers["mask2"] | 262144;
            }

            if ( scripts\mp\equipment\gas_grenade::level_killstreak_spawn( self, var_1 ) )
            {
        ...
        if ( scripts\mp\utility\player::relic_focusfire_modifyplayerdamage( self ) )
        {
            self.modifiers["last_stand"] = 1;
            self.modifiers["mask2"] = self.modifiers["mask2"] | 1024;
        }

        if ( scripts\mp\utility\player::relic_focusfire_modifyplayerdamage( var_1 ) || istrue( var_5.create_vehicle_omnvars_data ) )
        {
    ...
    if ( scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) || scripts\mp\utility\weapon::relic_landlocked_clear_message_on_player_return( var_4 ) )
    ...
    if ( scripts\mp\utility\game::getgametype() != "br" )
    {
        if ( self.modifiers["mask"] & 1048576 && self.modifiers["mask"] & 262144 )
            download_progress( var_2 );
    }

    if ( var_7 == "other" )
        draw_debug_sphere( var_2 );
}

mine_caves_ambush( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
    return var_5;
}

mine_caves_ambusher( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
...
killedplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_2.triggeredwincondition ) )
        var_2 = var_2.triggeredwincondition;
    ...
    thread dopunishhelivocalls( var_1 );
    var_7 = var_1.guid;
    var_8 = self.guid;
    ...
    thread _id_12DD5( var_3, var_4, var_1 );
    ...
    if ( !scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) && !scripts\mp\utility\perk::_hasperk( "specialty_explosivebullets" ) )
    {
        ...
        var_12 = brareloadoutdropbagsdelayed( self, var_4, var_2, var_3 );
        ...
        if ( var_12 )
        {
            ...
            if ( self ismantling() )
                shrink_poi_into_the_bank( var_0 );
        ...
        if ( scripts\mp\utility\game::getgametypenumlives() >= 1 )
        {
            ...
            var_27 = scripts\mp\utility\game::_id_12C34();
...
{
    var_3 = scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) || scripts\mp\utility\weapon::relic_landlocked_clear_message_on_player_return( var_2 );
    var_4 = scripts\mp\utility\points::relic_amped_on_ai_kill( var_0 );
    ...
    if ( var_3 && !var_4 )
    {
        if ( isdefined( var_2 ) && isdefined( var_2.streakinfo ) )
        {
            ...
            if ( isdefined( var_2.streakinfo.mpstreaksysteminfo ) )
            {
                ...
                if ( var_2.streakinfo.mpstreaksysteminfo.trial_trigger_think != self getxuid() )
                    var_5 = 0;
            }
            ...
            if ( isdefined( var_2.streakinfo.streakname ) )
            {
                ...
                if ( isdefined( var_2.streakinfo.kills ) )
                {
                    ...
                    if ( !istrue( var_2.streakinfo.stoppingpower_onkill ) && var_2.streakinfo.kills > 1 )
                    {
                        scripts\cp\helicopter\chopper_boss::_id_11CB0( "t9_ch_global_scorestreak_kill_two_or_more_s1", 1 );
                        var_2.streakinfo.stoppingpower_onkill = 1;
                    }
                }
...
_id_1197E( var_0 )
{
    var_1 = scripts\mp\killstreaks\killstreaks::mp_m_king_patch( var_0 );
...
relic_nuketimer_gettimeformission( var_0, var_1, var_2 )
{
...
registeronplayerjointeamnospectatorcallback( var_0, var_1 )
{
    var_2 = isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::mon_clip() > gettime();
    var_3 = isdefined( var_0.radarstrength ) && var_0.radarstrength > 3 && !var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ghost" );
    var_4 = istrue( var_1.relic_mythic_should_bypass_pain_cooldown );
...
longshot( var_0 )
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "longshot" );
...
pointblank( var_0 )
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "pointblank" );
...
headshot( var_0 )
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "headshot" );
...
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "avenger" );
...
assistedsuicide( var_0, var_1 )
{
    ...
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "assistedsuicide" );
...
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "defender" );
...
postdeathkill( var_0 )
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "posthumous" );
...
revenge( var_0, var_1 )
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "revenge" );
...
{
    if ( !isdefined( self.get_current_building_obj_struct ) )
        self.get_current_building_obj_struct = var_1;

    if ( var_1 < self.get_current_building_obj_struct )
        return;
    ...
    thread scripts\common\utility::_id_12C2C( level.smeansofdeathshitloc, var_0, var_1 );
...
firstblood( var_0 )
{
    ...
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "firstblood" );
...
buzzkill( var_0, var_1 )
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "buzzkill" );
...
comeback( var_0 )
{
    thread scripts\common\utility::_id_12C2C( level.slamcamoverlay, var_0, "comeback" );
...
updaterecentkills( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\game::register_boss_spawners( var_1 ) )
    {
        ...
        if ( scripts\mp\utility\script::isnumbermultipleof( self._id_11B27, 3 ) )
            _id_12BF7( var_0 );
    }
    ...
    if ( !isdefined( self._id_11B2A[var_2.basename] ) )
        self._id_11B2A[var_2.basename] = 1;
    else
        self._id_11B2A[var_2.basename]++;
    ...
    self._id_11B2A = undefined;
    self.stoppingpower_onkill = 0;
}

_id_12DD5( var_0, var_1, var_2 )
{
    if ( scripts\mp\utility\game::getgametype() != "br" )
        return;
    ...
    var_3.victim = var_2;
    var_3.shoulddeleteimmediately = 1;
    scripts\mp\gametypes\br_challenges::do_ascender_entrance( "br_mastery_travelogue", var_3 );
    scripts\mp\gametypes\br_challenges::do_ascender_entrance( "br_mastery_c4VehicleMultKill", var_3 );
    scripts\mp\gametypes\br_challenges::do_ascender_entrance( "br_mastery_ghostRideWhip", var_3 );
}
...
bombdefused( var_0 )
{
    ...
    if ( isplayer( var_0 ) )
        var_0 thread scripts\common\utility::_id_12C2C( level.slopelocked, "defuse", var_0.origin );

    if ( var_1 )
        scripts\mp\utility\game::setup_enemy_sentries( var_0, undefined, "Bomb Defused", var_0.origin, "last_alive" );
    else
        scripts\mp\utility\game::setup_enemy_sentries( var_0, undefined, "Bomb Defused", var_0.origin );
...
revivedplayer( var_0, var_1 )
{
    ...
    var_0 scripts\cp\helicopter\chopper_boss::_id_11CB0( "t9_ch_global_revived_teammate_for_operator_mission", 1 );
...
killeventtextpopup( var_0, var_1, var_2 )
{
    ...
    var_6._id_11978 = 0;
    var_6._id_11977 = 0;
    var_6.helis_assault3_fob = istrue( var_2 );
...
_id_1197F()
{
    ...
    self.vehicle_createlate = 1;

    if ( !isdefined( self.splashpriorityqueue ) )
        self.vehicle_createlate = 0;
    ...
    foreach ( var_1 in self.splashpriorityqueue )
    {
        ...
        if ( !istrue( level.removekilleventsplash ) && istrue( var_1.showassplash ) && ( !self.vehicle_createlate || var_1.alwaysshowsplash ) )
        {
            var_2 = 1;
    ...
    foreach ( var_1 in self.splashpriorityqueue )
    {
        if ( var_1._id_11977 || var_1.helis_assault3_fob )
            continue;
...
draw_debug_sphere( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.sequence_interaction_init[var_1] ) )
        return;

    if ( self.pers["lethalEquipmentKillMask"] & level.sequence_interaction_init[var_1] )
        return;
    else
        self.pers["lethalEquipmentKillMask"] = self.pers["lethalEquipmentKillMask"] | level.sequence_interaction_init[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.sequence_interaction_init )
    {
...
download_progress( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.phoneisnotringing[var_1] ) )
        return;

    if ( self.pers["headshotLongshotMask"] & level.phoneisnotringing[var_1] )
        return;
    else
        self.pers["headshotLongshotMask"] = self.pers["headshotLongshotMask"] | level.phoneisnotringing[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.phoneisnotringing )
    {
...
dopunishhelivocalls( var_0 )
{
    ...
    if ( isplayer( var_0 ) && isdefined( self._id_11B3C ) )
    {
        if ( self.modifiers["mask2"] & 32768 )
            var_1 = 1;
    }

    level scripts\engine\utility::_id_13141( 1, "game_ended" );
    ...
    if ( level.gameended )
    {
        if ( var_1 )
        {
            ...
            if ( isdefined( self._id_11B3C ) )
                self._id_11B3C reportchallengeuserevent( "collect_item", "recon_drone_achievement" );
        }
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_2 = spawnstruct();
            var_2.player = self;
            scripts\mp\gametypes\br_challenges::do_ascender_entrance( "br_mastery_roundKillExecute", var_2 );
        }
    }
