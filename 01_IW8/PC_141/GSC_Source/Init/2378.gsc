...
init()
{
    ...
    registerscriptperk( "specialty_specialist_bonus", scripts\mp\perks\perkfunctions::_id_12174, scripts\mp\perks\perkfunctions::_id_12D6F );
    ...
    registerscriptperk( "specialty_chain_killstreaks", scripts\mp\perks\perkfunctions::_id_120FF, scripts\mp\perks\perkfunctions::_id_12D6A );
    ...
    registerscriptperk( "specialty_reduce_regen_delay_on_kill", scripts\mp\perks\perkfunctions::_id_1216B, scripts\mp\perks\perkfunctions::_id_12D6D );
    ...
    registerscriptperk( "specialty_br_better_mission_rewards", scripts\mp\perks\perkfunctions::_id_120F4, scripts\mp\perks\perkfunctions::_id_12D69 );
    registerscriptperk( "specialty_br_extra_killstreak_chance" );
    registerscriptperk( "specialty_br_ping_on_damage", scripts\mp\perks\perkfunctions::_id_12150, scripts\mp\perks\perkfunctions::_id_12D6C );
    registerscriptperk( "specialty_br_stronger_armor", scripts\mp\perks\perkfunctions::_id_12177, scripts\mp\perks\perkfunctions::_id_12D70 );
...
initspecialistkillstreaks()
{
    ...
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "specialist_perk_bonus", undefined, ::train_associate_models_with_brushes );
}
...
animscripted_clear()
{
    ...
    {
        var_2 = scripts\engine\utility::ter_op( scripts\mp\utility\game::getgametype() == "br", istrue( var_1._id_125C4 ), istrue( var_1.specialist ) );
...
giveperksafterspawn()
{
    ...
    if ( self.avoidkillstreakonspawntimer > 0 )
    {
        ...
        if ( istrue( self.inspawncamera ) )
            var_0 = var_0 + scripts\mp\spawncamera::mp_shipment_patch();
...
updateactiveperks( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    {
        var_1.script_model_spawn_and_use_logic = gettime();
