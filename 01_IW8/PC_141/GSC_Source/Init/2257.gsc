...
player_gun_game_randomize_weapon_list_think()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_1301F( "hoopty", 1 );
    var_0.id = 9;
...
player_gun_game_next_weapon_think()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F23( "hoopty", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_12EF7( "hoopty" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F2F( "hoopty", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F28( "hoopty", ::hoopty_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12F32( "hoopty_mp", 3 );
}
...
hoopty_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_12EF2( var_2, "hoopty", var_0 );
