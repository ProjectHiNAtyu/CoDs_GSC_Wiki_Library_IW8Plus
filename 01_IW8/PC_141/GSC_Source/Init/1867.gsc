...
killcam( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16, var_17, var_18 )
{
    ...
    scripts\mp\utility\player::_id_11965( "killcam::killcam() START" );
    ...
    if ( istrue( var_18 ) )
        thread scripts\mp\final_killcam::isusingtacmap();
    ...
    killcamcleanup( 1, undefined, var_18 );
    scripts\mp\utility\player::_id_11965( "killcam::killcam() COMPLETE" );
}

_id_11CEA()
{
    self endon( "disconnect" );
    scripts\engine\utility::_id_13142( 0.15, "killcam_canceled", "spawned" );
    self clearpredictedstreampos();

    if ( istrue( level.showingfinalkillcam ) )
        scripts\mp\gamelogic::zdrop();
}
...
dokillcamslowmo( var_0 )
{
    ...
    if ( !isdefined( level.run_blima_exfil_sequence ) )
    {
        createheadiconatorigin( "killcam" );
        level.run_blima_exfil_sequence = 1;
    }
...
setkillcamnormalweaponomnvars( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( isdefined( var_2.obj_room_fire_02 ) )
        {
            var_4 = undefined;
            var_0 = var_2.obj_room_fire_02;
            var_2 = undefined;
        }
        else
...
waittillkillcamover()
{
    ...
    scripts\mp\utility\player::_id_11965( "killcam::waittillKillcamOver() START" );
    wait( self.killcamlength - level.frameduration / 1000.0 );
    scripts\mp\utility\player::_id_11965( "killcam::waittillKillcamOver() COMPLETE" );
}
...
waitskipkillcambutton( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        scripts\mp\utility\player::_id_11965( "killcam::waitSkipKillcamButton() Killcam SKIPPED" );
...
waitskipkillcamkbm()
{
    ...
    scripts\mp\utility\stats::incpersstat( "skippedKillcams", 1 );
    scripts\mp\utility\player::_id_11965( "killcam::waitSkipKillcamKBM() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
endkillcamifnothingtoshow()
{
    ...
    scripts\mp\utility\player::_id_11965( "killcam::endKillcamIfNothingToShow() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
{
    if ( isdefined( var_0.triggeredwincondition ) )
        var_0 = var_0.triggeredwincondition;
    ...
    if ( var_2 != "iw8_knife" )
    {
        ...
        for ( var_7 = 0; var_7 < var_5.size; var_7++ )
        {
            ...
            if ( scripts\mp\utility\weapon::branalytics_landing( var_2, var_9 ) )
            {
                if ( var_6 >= 8 )
                    break;
