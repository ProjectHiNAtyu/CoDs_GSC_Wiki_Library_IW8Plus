...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level.hacking_lua_notify_func ) )
        return;

    if ( isdefined( level.spawndropbagsovertime ) && self [[ level.spawndropbagsovertime ]]( var_0 ) )
        return;
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public::codecorrectlyenteredbyanyone( self );
    ...
    if ( isdefined( var_5 ) && scripts\mp\utility\teams::isgameplayteam( var_5 ) )
    {
        ...
        if ( level.gametype == "br" && register_seat_data( var_0 ) )
            var_7 = "dx_bra_";
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public::codecorrectlyenteredbyanyone( self );
    ...
    if ( level.teambased )
    {
        var_5 = destinations( var_0, 1 );
        var_6 = destinations( var_0 );
