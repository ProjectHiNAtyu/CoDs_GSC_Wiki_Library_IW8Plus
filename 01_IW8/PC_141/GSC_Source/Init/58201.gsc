...
init()
{
    ...
    level.nuke_expl_struct = scripts\cp_mp\utility\game_utility::molotov_get_cast_level_data( "nuke_expl_pos" );
}
...
tryusenukefromstruct( var_0 )
{
    ...
    else if ( !istrue( level.spawn_exfil_techo ) )
    ...
    if ( var_1 != 1 && !istrue( level.spawn_exfil_techo ) )
        scripts\common\utility::_id_12C2C( level.smartwatchinteract, "nuke", self.origin );
...
nuke_start( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( istrue( level.spawn_exfil_techo ) )
        var_12 = 0.7;
...
{
    if ( !isdefined( level.taketeamplunder ) )
    {
        createheadiconatorigin( "nuke" );
        level.taketeamplunder = 1;
    }

    level endon( "game_ended" );
    var_0 waittill( "disconnect" );
    tacinsert_updatepickupusability();
}
...
nuke_starttimer( var_0 )
{
    ...
    if ( istrue( level.spawn_exfil_techo ) )
        scripts\mp\trials\trial_utility::_id_1214A( "ui_nuke_data", 9, 2, 2 );
    else
...
nuke_startlaunchsequence( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_1.streakname != "nuke_select_location" )
    {
        ...
        level thread tacinsert_tacinsertdestroyedfeedback();
    ...
    if ( isdefined( level.nukeinfo.player ) )
    {
        ...
        if ( !istrue( level.spawn_exfil_techo ) )
        {
            if ( isdefined( level.nukeinfo.player ) && isdefined( var_1 ) )
                level.nukeinfo.player scripts\cp_mp\utility\killstreak_utility::_id_11B45( var_1 );
        }
    }
...
{
    level endon( "game_ended" );
    level thread takeaccesscardpickup( 1 );
...
takeplayerweaponaway()
{
    ...
    level thread takelaststandtransitionweapon();
}
