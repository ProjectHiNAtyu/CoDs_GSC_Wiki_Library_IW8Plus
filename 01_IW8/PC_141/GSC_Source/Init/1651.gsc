...
guy_runtovehicle_loaded( var_0, var_1 )
{
    ...
    if ( !getdvarint( "enable_vehicle_ai_using_BT" ) )
    {
        var_2 = var_0 scripts\engine\utility::_id_13136( "long_death", "death", "enteredvehicle" );
...
{
    scripts\engine\utility::_id_1312D( "unload", "death" );
...
guy_unload_que( var_0 )
{
    ...
    var_0 scripts\engine\utility::_id_1312D( "death", "jumpedout" );
    ...
    if ( !self.unloadque.size )
    {
        ...
        self.hideallunselectedextractpads = undefined;
    }
}
...
{
    if ( isdefined( self.hideallunselectedextractpads ) )
        return;

    self.hideallunselectedextractpads = [];
    ...
    for ( var_0 = 0; var_0 < level.vehicle.templates.aianims[scripts\common\vehicle_code::get_vehicle_classname()].size; var_0++ )
    {
        ...
        if ( isdefined( var_1.vehicle_getoutanim ) )
        {
            ...
            self.hideallunselectedextractpads[var_2] = spawnstruct();
            self.hideallunselectedextractpads[var_2].open = 0;
            self.hideallunselectedextractpads[var_2].trap_door_nvg_reset_catch = 0;
        }
    }
}
...
wait_for_open_door( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.vehicle_getoutanim ) )
    {
        ...
        if ( !self.hideallunselectedextractpads[var_2].open )
        {
            ...
            self.hideallunselectedextractpads[var_2].open = 1;
        }
