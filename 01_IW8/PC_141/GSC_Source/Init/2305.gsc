...
total_spawns( var_0, var_1 )
{
    ...
    foreach ( var_3 in level.mines )
    {
        ...
        if ( distancesquared( var_1, var_3.origin ) < 262144 )
            var_3 thread scripts\mp\equipment\claymore::enemy_push_players_logic( var_0 );
    }
}
...
applyconcussion( var_0, var_1 )
{
    ...
    if ( istrue( self.findgunsmithattachments ) )
        return;
    ...
    var_1 scripts\cp\helicopter\chopper_boss::train_delay_handler( "equip_concussion" );
