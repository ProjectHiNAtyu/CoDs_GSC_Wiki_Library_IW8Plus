...
targetmarkergroup_on( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_7 = createtargetmarkergroup( var_0 );
...
addtargetmarkergroup( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        if ( isarray( var_1 ) )
        {
            foreach ( var_9 in var_1 )
            {
                if ( isplayer( var_9 ) )
                {
                    ...
                    addclienttotargetmarkergroupmask( var_0, var_9 );
                    continue;
                }
        ...
        else if ( isplayer( var_1 ) )
        {
            ...
            addclienttotargetmarkergroupmask( var_0, var_1 );
        }
    ...
    if ( istrue( var_5 ) )
        level thread targetmarkergroup_watchmarkonspawn( var_0, var_6 );
...
targetmarkergroup_watchmarkonspawn( var_0, var_1 )
{
...
targetmarkergroup_markentity( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3.markedents[var_4] ) )
    {
        ...
        targetmarkergroupaddentity( var_1, var_0 );
...
targetmarkergroup_unmarkentity( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( var_3.markedents[var_1] ) )
    {
        ...
        if ( isdefined( var_0 ) )
            targetmarkergroupremoveentity( var_2, var_0 );
