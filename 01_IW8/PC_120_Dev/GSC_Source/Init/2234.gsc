...
tryusejuggernautfromstruct( var_0, var_1 )
{
    ...
    else
    {
        ...
        var_3 = makeweapon( "deploy_juggernaut_mp" );
...
watchmarkeractivate( var_0 )
{
    ...
    else
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "juggernaut", "dropCrateFromScriptedHeli" ) && level.gametype != "br" )
        {
            ...
            var_2 thread scripts\cp_mp\killstreaks\airdrop::airdrop_playdeploydialog( var_0, "airdrop" );
            ...
            if ( !isdefined( var_4 ) )
            {
                ...
                {
                    var_2 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "awardKillstreakFromStruct" ) ]]( var_0.mpstreaksysteminfo );
                    return;
                }
        ...
        {
            var_5 = 1;
            var_2 thread scripts\cp_mp\killstreaks\airdrop::spawnjuggernautcrateatposition( var_3, var_5 );
        }
    }
}
...
activatejugg( var_0 )
{
    ...
    thread watchforjuggernautgameend( var_0 );
    thread watchforjuggernautend( var_0 );
    thread watchforjuggernautdisconnect( var_0 );
...
watchforjuggernautgameend( var_0 )
{
    self endon( "disconnect" );
...
watchforjuggernautdisconnect( var_0 )
{
    self endon( "juggernaut_end" );
    level endon( "game_ended" );
    var_1 = self.juggcontext;
...
createjuggobjective()
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        if ( level.teambased )
            ...
            scripts\mp\objidpoolmanager::update_objective_ownerclient( var_1, self );
    }
}
