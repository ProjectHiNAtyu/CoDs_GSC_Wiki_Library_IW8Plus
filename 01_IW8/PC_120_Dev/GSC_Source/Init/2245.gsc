...
_takeweapon( var_0 )
{
    ...
    if ( isweapon( var_0 ) )
        ...
        var_1 = getcompleteweaponname( self gethighpriorityweapon() ) == var_0;

    if ( var_1 )
    {
        var_2 = scripts\engine\utility::ter_op( isstring( var_0 ), var_0, getcompleteweaponname( var_0 ) );
...
takeweaponwhensafe( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( !iscurrentweapon( var_0 ) )
        {
            ...
            if ( !isnullweapon( var_2 ) && self.currentweapon == var_2 )
                var_1 = 0;
            else
                var_1 = 1;
        }
...
forcevalidweapon( var_0 )
{
    ...
    while ( isnullweapon( self getcurrentweapon() ) )
    {
        ...
        var_1 = getcurrentprimaryweaponsminusalt();
        var_2 = var_0;
