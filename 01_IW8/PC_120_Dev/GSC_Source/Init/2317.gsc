...
thermite_watchstuck( var_0 )
{
    ...
    thermite_doradiusdamage( "thermite_mp" );
    ...
    while ( var_3 <= 10 )
    {
        ...
        if ( scripts\engine\utility::mod( var_4, 2 ) > 0 )
            thermite_doradiusdamage( "thermite_av_mp" );
        else
            thermite_doradiusdamage( "thermite_ap_mp" );
