...
weapondrop_givedropweapon()
{
    ...
    var_0.deployweaponobj = makeweapon( "deploy_weapondrop_mp" );
...
weapondrop_deploydrone( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2 thread weapondrop_createdropondeath( var_3 );
    }
}
...
weapondrop_createdropondeath( var_0 )
{
    level endon( "game_ended" );
...
watchcrateimpact( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) && var_9 scripts\cp_mp\killstreaks\helper_drone::ishelperdrone() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            playcrateimpactfx( var_6, var_7, var_8, var_11 );
        }
    }
}

playcrateimpactfx( var_0, var_1, var_2, var_3 )
{
