...
ammobox_init()
{
    ...
    ammobox_addrandomweapon( "weapon_assault", var_0 );
    ammobox_addrandomweapon( "weapon_assault", var_0 );
    ammobox_addrandomweapon( "weapon_smg", var_0 );
    ammobox_addrandomweapon( "weapon_smg", var_0 );
    ammobox_addrandomweapon( "weapon_lmg", var_0 );
    ammobox_addrandomweapon( "weapon_lmg", var_0 );
    ammobox_addrandomweapon( "weapon_sniper", var_0 );
    ammobox_addrandomweapon( "weapon_dmr", var_0 );
    ammobox_addrandomweapon( "weapon_shotgun", var_0 );
    ammobox_addrandomweapon( "weapon_pistol", var_0 );
...
ammobox_addrandomweapon( var_0, var_1 )
{
...
{
    foreach ( var_2 in level.allammoboxes )
    {
        if ( isdefined( var_2 ) )
            var_2 scripts\mp\equipment\support_box::supportbox_updateheadicon( var_0 );
    }
}
...
ammobox_settled( var_0 )
{
    ...
    level.allammoboxes[var_0 getentitynumber()] = var_0;
...
ammobox_delete( var_0, var_1 )
{
    ...
    self.owner scripts\cp_mp\challenges::onfieldupgradeend( "super_weapon_drop", self.usedcount );
...
ammobox_internalpreloadweapons( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = [ var_2 ];
        ammobox_checkclearbufferedattachmentweapon( var_1 );
        var_4 = ammobox_getbufferedattachmentweapon( var_1 );
    ...
    foreach ( var_1 in self.playersused )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            if ( !scripts\mp\utility\player::isreallyalive( var_1 ) && isdefined( self.playersused[var_2] ) )
            {
                ...
                scripts\mp\equipment\support_box::supportbox_updateheadicon( var_1 );
            }
        }
    }
}
...
{
    if ( !isdefined( var_0.bufferedammoboxdata ) )
    {
        var_1 = spawnstruct();
        var_1.buffered = undefined;
        var_1.last = undefined;
        var_1.attachment = undefined;
        var_1.attachmentweapon = undefined;
        var_1.attachmentsourceweapon = undefined;
        var_0.bufferedammoboxdata = var_1;
    }

    return var_0.bufferedammoboxdata;
}
...
ammobox_getbufferedattachment( var_0 )
{
    var_1 = ammobox_getbufferedplayerdata( var_0 );

    if ( !isdefined( var_1.attachment ) )
    {
        ...
        if ( !ammobox_canweaponuserandomattachments( var_2 ) )
            return undefined;

        if ( !ammobox_canweaponacceptmoreattachments( var_2 ) )
            return undefined;
        ...
        var_1.attachment = var_3;
    }

    return var_1.attachment;
}
...
ammobox_getbufferedattachmentweapon( var_0 )
{
    ...
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.attachmentweapon;
}

ammobox_getbufferedattachmentsourceweapon( var_0 )
{
    ammobox_bufferedattachmentweapon( var_0 );
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.attachmentsourceweapon;
}
...
ammobox_bufferedattachmentweapon( var_0 )
{
    ...
    if ( !isdefined( var_1.attachmentweapon ) )
    {
        var_2 = ammobox_getbufferedattachment( var_0 );
        ...
        if ( isdefined( var_4 ) )
        {
            var_1.attachmentsourceweapon = var_3;
            var_1.attachmentweapon = var_4;
        }
    }
}
...
ammobox_checkclearbufferedattachmentweapon( var_0 )
{
    var_1 = ammobox_getbufferedattachmentsourceweapon( var_0 );
    var_2 = 0;
...
ammobox_onplayeruse( var_0 )
{
    ...
    if ( !ammobox_canweaponuserandomattachments( var_1 ) )
    {
    ...
    if ( !ammobox_canweaponacceptmoreattachments( var_1 ) )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    var_2 = var_0 ammobox_giverandomattachment( var_1 );
...
{
    if ( !scripts\mp\utility\weapon::iscacprimaryorsecondary( var_0 ) || scripts\mp\utility\weapon::issinglehitweapon( var_0 ) || scripts\mp\utility\weapon::isknifeonly( var_0 ) || scripts\mp\riotshield::isriotshield( var_0.basename ) || var_0.basename == "iw8_lm_dblmg_mp" )
        return 0;
...
ammobox_canweaponacceptmoreattachments( var_0 )
{
    ...
    {
        if ( !scripts\mp\utility\weapon::attachmentisselectable( var_0, var_5 ) )
            continue;
...
ammobox_giverandomattachment( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;

    var_1 = ammobox_getbufferedattachment( self );
    var_2 = ammobox_getbufferedattachmentweapon( self );
...
{
    thread ammobox_tryuse( var_0, var_1 );
}
...
ammobox_tryuse( var_0, var_1 )
{
    ...
    if ( var_3 )
        var_4 = var_0 ammobox_onplayerholduse( var_1 );
    else
    ...
    if ( var_4 )
    {
        if ( isdefined( var_0.owner ) )
        {
            ...
            var_0.owner scripts\mp\supers::combatrecordsupermisc( "super_weapon_drop" );
        }

        var_0.usedcount++;
        var_0.playersused[var_1 getentitynumber()] = var_1;
        var_0 scripts\mp\equipment\support_box::supportbox_updateheadicon( var_1 );
