...
{
    var_9 = getleveldata( var_2 );

    if ( var_9.supportsownercapture )
    {

    }

    if ( var_9.supportsreroll )
    {
    ...
    var_10.useobject = undefined;
    var_10.navobstacle = undefined;
    var_10.headiconid = undefined;
    var_10.minimapid = undefined;
    var_10.dangerzoneid = undefined;
    var_10.navobstacleid = undefined;
    var_10.destination = var_5;
    var_10.headiconactive = 0;
    var_10.minimapiconactive = 0;
    var_10.hasnophysics = istrue( var_6 );
    var_10.physicsactivated = 0;
    var_10.isdestroyed = 0;
    var_10.data = var_8;
    var_10.headicon = var_9.headicon;
    var_10.minimapicon = var_9.minimapicon;
    var_10.capturestring = var_9.capturestring;
    var_10.rerollstring = var_9.rerollstring;
    var_10.supportsreroll = var_9.supportsreroll;

    if ( level.gametype == "infect" )
        var_10.isteamonlycrate = 1;

    var_10 setmodel( var_9.dummymodel );
    var_10 setnodeploy( 1 );
    var_10 setcandamage( 0 );
    var_10 makeunusable();
    var_10 enableplayermarks( "killstreak" );

    if ( level.teambased )
        var_10 filteroutplayermarks( var_10.team );
    else
        var_10 filteroutplayermarks( var_10.owner );

    var_11 = undefined;

    if ( isdefined( var_9.friendlymodel ) )
    {
        var_11 = spawn( "script_model", var_3 );
        var_11.angles = var_4;
        var_11.crate = var_10;
        var_11 setmodel( var_9.friendlymodel );
        var_11 linkto( var_10 );
        var_10.childoutlineents = [ var_11 ];
    }
    else
        var_11 = var_10;

    var_10.friendlymodel = var_11;
    var_12 = undefined;
    ...
    if ( isdefined( var_9.enemymodel ) )
    {
        ...
        var_12.angles = var_4;
        var_12.cratedata = var_10;
        var_12 setmodel( var_9.enemymodel );
        var_12 linkto( var_10 );
    }

    var_10.enemymodel = var_12;

    if ( isdefined( var_10.enemymodel ) )
        var_10 thread watchvisibility();

    var_13 = undefined;

    if ( !var_10.hasnophysics )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
        {
            if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() != "br" )
            {
                ...
                var_13 setscriptmoverkillcam( "explosive" );

                if ( isdefined( self.scenenode ) )
                {
                    if ( var_7 )
                        var_13 thread looselinkto( var_10, ( 0, 0, 0 ) );
                    else
    ...
    if ( isdefined( var_10.owner ) )
        var_10.owner.isffprotectedaction = 1;

    var_10.killcament = var_13;
    var_10 createmountmantlemodel();
    var_10 addtolists();

    if ( !scripts\engine\utility::is_equal( level.script, "mp_bm_tut" ) )
        var_10 thread watchcratedestroyearly();

    if ( var_10.hasnophysics )
        var_10 activatecratefirsttime();
    else if ( var_7 )
        var_10 cratephysicson();
...
initcratedropdata()
{
    var_0 = spawnstruct();
    var_0.helis = [];
    var_1 = scripts\cp_mp\utility\killstreak_utility::getkillstreakairstrikeheightent();
...
placecrate( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    return createcrate( var_0, var_1, var_2, var_3, var_4, undefined, 1, 0, var_5 );
}

dropcrate( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( !isdefined( var_5 ) )
    {
        var_7 = getcratedropcaststart( var_3, 0 );
        var_5 = getcratedropdestination( var_7, getcratedropcastend( var_7, 0 ) );
    }
...
watchcrateuse( var_0, var_1 )
{
    ...
    if ( isdefined( var_3.usetimeoverride ) )
        var_3.usetime = var_3.usetimeoverride;
...
startusingcrate( var_0, var_1 )
{
    ...
    else
    {
        ...
        if ( var_4 )
            var_0 thread airdrop_givecrateuseweapon();
...
airdrop_givecrateuseweapon()
{
    ...
    level endon( "game_ended" );
    var_0 = makeweapon( "ks_use_crate_mp" );
    scripts\cp_mp\utility\inventory_utility::_giveweapon( var_0 );
    thread airdrop_watchforcrateuseend( var_0 );
...
makecrateusableforplayer( var_0, var_1 )
{
...
watchallcrateusabilityfast()
{
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            var_1 makeusable();
            var_1 enableplayeruseforallplayers();

            if ( isdefined( var_1.useobject ) )
            {
                var_1.useobject makeusable();
                var_1.useobject enableplayeruseforallplayers();
            }
            ...
            foreach ( var_5 in var_2 )
            {
                ...
                if ( var_6 )
                    makecrateusableforplayer( var_1, var_5 );
            }
        }
...
watchallcrateusability()
{
    ...
    {
        thread watchallcrateusabilityfast();
        return;
    }
    ...
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            foreach ( var_3 in level.players )
                makecrateusableforplayer( var_1, var_3 );
        }
...
cratephysicson( var_0, var_1 )
{
    var_2 = getleveldata( self.cratetype );

    if ( isdefined( var_2.cratephysicsoncallback ) )
        self thread [[ var_2.cratephysicsoncallback ]]();
...
{
    self.moverdoesnotkill = undefined;
...
monitoraveragevelocityandupdate()
{
    self endon( "death" );
    var_0 = 0.1;
    thread monitoraveragevelocities( var_0, 8 );
    var_1 = 0;
    var_2 = 0;
    var_3 = 1;
    var_4 = undefined;
    ...
    for (;;)
    {
        var_6 = getaveragelinearvelocity();
        var_7 = getaverageangularvelocity();
        ...
        if ( isdefined( var_6 ) && isdefined( var_7 ) )
        {
            if ( var_6 <= 5.0 && var_7 <= 1.0 )
            {
                ...
                if ( var_1 == 6 )
                {
                    ...
                    var_0 = 0.1;
                    thread monitoraveragevelocities( var_0, 3, 3 );
                    var_3 = undefined;
                    destroycrateinbadtrigger();
                }
            }
...
monitoraveragevelocities( var_0, var_1, var_2 )
{
    clearaveragevelocities();
    self endon( "death" );
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( var_2 > 0 )
        {
            ...
            {
                self.linvels[self.velstartid + var_3] = 0;
                self.angvels[self.velstartid + var_3] = 0;
            }
        }
    }
    ...
    for (;;)
    {
        ...
        self.linvels[self.velendid] = length( var_5 );
        self.angvels[self.velendid] = length( var_6 );
        self.velendid++;
        var_7 = self.velendid - self.velstartid;
        ...
        if ( var_7 > var_1 )
        {
            ...
            {
                self.linvels[self.velstartid + var_3] = undefined;
                self.angvels[self.velstartid + var_3] = undefined;
            }

            self.velstartid = self.velstartid + var_8;
        }
...
calculateaveragevelocities()
{
    ...
    for ( var_2 = self.velstartid; var_2 < self.velendid; var_2++ )
    {
        var_0 = var_0 + self.linvels[var_2];
        var_1 = var_1 + self.angvels[var_2];
    }

    self.avlinvel = var_0 / self.velnumdatapoints;
    self.avangvel = var_1 / self.velnumdatapoints;
}
...
monitorimpactinternal( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) && isdefined( var_9.classname ) && var_9.classname == "scriptable_iw8_chicken_01" )
            thread airdrop_crushchicken( var_9 );

        if ( isdefined( var_9 ) && impactshoulddestroyent( var_9 ) )
        {
            if ( var_9 scripts\cp_mp\killstreaks\helper_drone::ishelperdrone() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            playimpactfx( var_6, var_7, var_8, var_11 );
        }
    }
}
...
impactshoulddestroyent( var_0 )
{
    if ( !istrue( self.physicssettled ) )
    {
        if ( isdefined( var_0.classname ) )
        {
            ...
            {
                if ( var_0 scripts\cp_mp\killstreaks\helper_drone::ishelperdrone() )
                {
                    var_1 = getleveldata( self.cratetype );
                    var_2 = self.origin + anglestoup( self.angles ) * var_1.halfheight;
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) && ( isplayer( var_2 ) || isagent( var_2 ) ) && var_2 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            if ( var_2 tagexists( "j_mainroot" ) )
            {
                ...
                var_8 = self.origin + anglestoup( self.angles ) * var_7.halfheight;
...
playimpactfx( var_0, var_1, var_2, var_3 )
{
            ...
            if ( isdefined( var_1 ) )
            {
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "isMLGMatch" ) )
                {
                    if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "isMLGMatch" ) ]]() )
                        addteamtoheadiconmask( var_1, "spectator" );
                }
            }
        }
...
trackcratemantlingexploit()
{
    if ( !isdefined( self.entmantlingendtime ) )
    {
        if ( self ismantling() )
        {
            ...
            {
                self.entmantling = var_0;
                self.entmantlingcrate = var_0.crate;
            }
    ...
    else
    {
        ...
        {
            if ( isdefined( var_2 ) && istrue( var_2.physicsactivated ) && !istrue( var_2.physicssettled ) )
            {
                if ( isdefined( self.entmantling ) )
                {
                    if ( isdefined( var_2.mountmantlemodel ) )
                    {
                        if ( self.entmantling != var_2.mountmantlemodel )
                        {
                    ...
                    if ( self.entmantlingcrate != var_2 )
                    {
    ...
    else
    {
        ...
        if ( self.headiconactive )
        {
            if ( isdefined( self.headiconid ) )
                setheadiconimage( self.headiconid, var_0 );
            else
                _createheadicon();
        }
    }
...
dropkillstreakcratefromscriptedheli( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 thread airdrop_playdeploydialog( var_7 );
...
airdrop_playdeploydialog( var_0, var_1 )
{
...
tryairdroptriggered( var_0 )
{
    ...
    if ( var_2 == "airdrop" && var_6 )
        var_0.deployweaponobj = makeweapon( "deploy_airdrop_mp_sticky" );
...
airdrop_watchplayerweapon( var_0 )
{
    ...
    var_1 = scripts\engine\utility::waittill_any_return_2( "cancel_deploy", "weapon_switch_started" );
...
tryuseairdropmarkerfromstruct( var_0 )
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    var_0.deployweaponobj = makeweapon( "deploy_airdrop_mp" );
    var_1 = undefined;
...
airdropmarkeractivate( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_7 ) )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "awardKillstreakFromStruct" ) )
            var_5 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "awardKillstreakFromStruct" ) ]]( var_2.mpstreaksysteminfo );

        return;
    }

    var_5 scripts\cp_mp\utility\killstreak_utility::recordkillstreakendstats( var_2 );
}
...
initbattleroyaleloadoutcratedata()
{
    ...
    var_0.destroycallback = ::brloadoutcratedestroycallback;
...
brloadoutcratepostcapture( var_0 )
{
...
initbattleroyalec130airdropcratedata()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::brc130airdropcrateactivatecallback;
    var_0.capturecallback = ::brc130airdropcratecapturecallback;
    var_0.destroycallback = ::brc130airdropcratedestroycallback;
    var_0.cratephysicsoncallback = ::brc130airdropcratephysicsoncallback;
    var_0.destroyoncapture = 1;
}

brc130airdropcrateactivatecallback( var_0 )
{

}

brc130airdropcratecapturecallback( var_0 )
{
...
brc130airdropcratedestroycallback( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
dropbrc130airdropcrate( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 250;
    var_6 = level.c130airdrop_heightoverride;
    var_7 = 1000;
    var_8 = 10500;
    var_9 = 7500;
    var_10 = 3000;
    var_11 = var_1 + ( 0, 0, var_7 );
    var_12 = "battle_royale_c130_loot";

    if ( isdefined( var_3 ) )
        var_12 = var_3;

    var_13 = createcrate( undefined, undefined, var_12, var_0, ( 0, 0, 0 ), var_1, undefined, 0 );

    if ( isdefined( var_13 ) )
    {
        var_13.skipminimapicon = 1;

        if ( var_11[2] < var_0[2] )
        {
            var_14 = undefined;
            var_15 = distance( var_0, var_11 );

            if ( var_15 >= var_8 )
                var_14 = "brc130_drop_high";
            else if ( var_15 >= var_9 )
                var_14 = "brc130_drop_med";
            else if ( var_15 >= var_10 )
                var_14 = "brc130_drop_low";

            if ( isdefined( var_14 ) )
            {
                var_16 = 1000;
                var_17 = spawn( "script_model", var_11 + ( 0, 0, var_16 ) );
                var_17.angles = var_2;
                var_17 setmodel( "tag_origin" );
                var_13.animname = "care_package";
                var_13.dropanim = level.scr_anim[var_13.animname][var_14];
                var_13.animlength = getanimlength( var_13.dropanim );
                var_13 scripts\common\anim::setanimtree();
                var_18 = spawn( "script_model", var_13.origin );
                var_18.angles = var_13.angles;
                var_18.animname = "care_package_chute";
                var_18.dropanim = level.scr_anim[var_18.animname][var_14];
                var_18.animlength = getanimlength( var_18.dropanim );
                var_18 setmodel( "veh8_mil_lnd_carepackage_parachute_br" );
                var_18 scripts\common\anim::setanimtree();
                var_17 thread scripts\common\anim::anim_single_solo( var_13, var_14 );
                var_17 thread scripts\common\anim::anim_single_solo( var_18, var_14 );
                var_13 thread watchbrc130aidropcrateanimend();
                var_18 thread watchbrc130airdropchuteanimend( var_17 );
            }
            else
                var_13 cratephysicson();
        }
        else
            var_13 cratephysicson();

        var_19 = "cashdrop_common";
        var_20 = getdvarint( "scr_dmz_airdrop_ingame_obj", 1 );

        if ( var_20 )
            var_19 = "cashdrop_common_world";

        if ( isdefined( var_4 ) )
            var_19 = var_4;

        var_13 setscriptablepartstate( "objective_map", var_19, 0 );
        var_13 setscriptablepartstate( "crate_audio", "parachuting", 0 );
        var_13.smokesignal = spawn( "script_model", var_1 );
        var_13.smokesignal setmodel( "ks_airdrop_crate_br" );
        var_13.smokesignal setscriptablepartstate( "smoke_signal", "on", 0 );
    }
...
watchbrc130airdropchuteanimend( var_0 )
{
    self endon( "death" );
    wait( self.animlength );
...
initbattleroyalelootchoppercratedata()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::brlootchoppercrateactivatecallback;
    var_0.capturecallback = ::brlootchoppercratecapturecallback;
    var_0.destroycallback = ::brlootchoppercratedestroycallback;
    var_0.destroyoncapture = 1;
}

brlootchoppercrateactivatecallback( var_0 )
{

}

brlootchoppercratecapturecallback( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
dropbrlootchoppercrate( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2.smokesignal = spawn( "script_model", var_1 );
        var_2.smokesignal setmodel( "ks_airdrop_crate_br" );
        var_2.smokesignal setscriptablepartstate( "smoke_signal", "on", 0 );
    }
...
initbattleroyalejuggernautcratedata()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::brjuggernautcratecapturecallback;
    var_0.destroycallback = ::brjuggernautcratedestroycallback;
    var_0.activatecallback = ::brjuggernautcrateactivatecallback;
    var_0.cratephysicsoncallback = ::brjuggernautcratephysicsoncallback;
    var_0.destroyoncapture = 1;
}

brjuggernautcrateactivatecallback( var_0 )
{
...
brjuggernautcratecapturecallback( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "br_gametype_juggernaut", "brJugg_onCrateUse" ) )
        self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "br_gametype_juggernaut", "brJugg_onCrateUse" ) ]]( var_0 );

    scripts\cp_mp\killstreaks\juggernaut::oncratecaptured( var_0 );
}

brjuggernautcratedestroycallback( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
brjuggernautcratephysicsoncallback( var_0, var_1 )
{
    self setscriptablepartstate( "crate_audio", "detach", 0 );
}

dropjuggernautcrate( var_0, var_1, var_2 )
{
    var_3 = scripts\cp_mp\utility\killstreak_utility::createstreakinfo( "juggernaut", self );
    return dropcrate( undefined, var_0, "battle_royale_juggernaut", var_1, ( 0, randomfloat( 360 ), 0 ), var_2, var_3 );
}

spawnjuggernautcrateatposition( var_0, var_1 )
{
    var_2 = dropjuggernautcrate( self.team, var_0 + ( 0, 0, 4096 ), var_0 + ( 0, 0, 512 ) );
    var_2 endon( "death" );
    enablejuggernautcrateobjective( var_2 );
    choosejuggernautcratemodel( var_2 );
    var_3 = [];

    foreach ( var_5 in level.teamdata[self.team]["alivePlayers"] )
    {
...
choosejuggernautcratemodel( var_0 )
{
    var_0 setotherent( self );
