...
missilelauncherusage()
{
    ...
    if ( self.missilelauncherstage == 1 )
    {
        ...
        if ( !var_1 && ( self.missilelaunchertarget scripts\cp_mp\vehicles\vehicle::isvehicle() && scripts\cp_mp\vehicles\vehicle::vehicle_isfriendlytoplayer( self.missilelaunchertarget, self ) ) )
        {
            resetmissilelauncherlocking();
            return;
        }
...
stingtargstruct_getoffsets()
{
    ...
    else if ( isdefined( self.target.vehiclename ) && self.target.vehiclename == "cargo_truck" )
    {
        self.offsets[self.offsets.size] = ( 0, 0, 60 );
        self.useoldlosverification = 0;
    }
