...
updatesharpfocus()
{
    ...
    var_1 = undefined;
    var_2 = scripts\mp\utility\weapon::weapongetflinchtype( var_0 );
...
updatedefaultflinchreduction()
{
    ...
    var_0 = undefined;
    var_1 = scripts\mp\utility\weapon::weapongetflinchtype( self.currentweapon );
...
setviewkickoverride()
{
    ...
    self.overrideviewkickscaledmr = 0.05;
    self.overrideviewkickscalek98 = 0.02;
...
unsetviewkickoverride()
{
    ...
    self.overrideviewkickscalek98 = undefined;
...
applystunresistence( var_0, var_1, var_2 )
{
    if ( var_1 scripts\mp\utility\perk::_hasperk( "specialty_stun_resistance" ) && var_0 != var_1 )
    {
        ...
        if ( istrue( scripts\cp_mp\utility\player_utility::playersareenemies( var_3, var_4 ) ) )
            var_1 scripts\cp_mp\challenges::resistedstun( var_3 );
    }
...
boomtrackplayerdeath( var_0, var_1 )
{
    ...
    var_2 = scripts\engine\utility::waittill_any_timeout_1( 7.0, "death" );
...
setextraammo()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( isdefined( var_2 ) && !isnullweapon( var_2 ) && var_2 hasattachment( "maxammo" ) && !istrue( var_2.first_equipped ) )
        {
...
sixthsense_inotherplayertargetcone( var_0, var_1, var_2, var_3 )
{
    var_4 = var_1 - var_2;
    ...
    var_8 = scripts\engine\math::degrees_to_radians( var_7 );
...
sixthsense_playerseesotherplayer( var_0, var_1, var_2 )
{
    var_3 = var_2 - var_1;
    ...
    foreach ( var_28, var_8 in level.sixth_sense_players )
    {
        ...
        if ( var_2 && !isbot( var_8 ) )
        {
            ...
            foreach ( var_13 in var_11 )
            {
                ...
                if ( !var_8 sixthsense_shouldwarnaboutotherplayer( var_13 ) )
                    continue;
                ...
                if ( !var_8 sixthsense_inotherplayertargetcone( var_13, var_10, var_14, var_15 ) )
                    continue;

                var_9 = var_9 | var_8 getsixthsensedirection( var_13 );
            }
        }
        else
        {
            ...
            foreach ( var_13 in level.players )
            {
                ...
                if ( sixthsense_playerseesotherplayer( var_18, var_10, var_14 ) )
                {
                    var_3 = var_3 + 2;
                    var_20 = [ var_8 ];
...
startgpsjammer()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\class::isweaponsilenced( var_0 ) )
            continue;
...
ghostadvanceduavwatcher()
{
    ...
    for (;;)
    {
        if ( level.teambased )
        {
            var_0 = level.activeadvanceduavcount - level.activeadvanceduavs[self.team] > 0;
...
setkillstreaktoscorestreak()
{
    ...
    if ( isdefined( self.pers["killstreakToScorestreak_lifeId"] ) && self.pers["killstreakToScorestreak_lifeId"] == self.lifeid )
    {
        ...
        var_0 = killstreaktoscorestreak_killtoscore( self.streakpoints );
...
unsetkillstreaktoscorestreak()
{
    ...
    var_0 = killstreaktoscorestreak_scoretokill( self.streakpoints );
    scripts\mp\killstreaks\killstreaks::updatestreakcosts();
    scripts\mp\killstreaks\killstreaks::setstreakpoints( var_0 );
    scripts\mp\killstreaks\killstreaks::checkstreakreward( self.streakpoints );
    scripts\mp\killstreaks\killstreaks::updatestreakmeterui();
...
killstreaktoscorestreak_killtoscore( var_0 )
{
    return var_0 * 125;
}

killstreaktoscorestreak_scoretokill( var_0 )
{
...
proximityrevivethink()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_7 in var_5 )
        {
            if ( istrue( var_7.inlaststand ) && !istrue( var_7.stuckinlaststand ) && !istrue( var_7.laststandhealisactive ) && !istrue( var_7 scripts\mp\playerlogic::getbeingrevivedinternal() ) && !isdefined( var_0.owner ) )
        ...
        if ( isdefined( level.revivetriggers ) )
        {
            foreach ( var_10 in level.revivetriggers )
            {
                ...
                {
                    if ( !istrue( var_10.trigger.owner scripts\mp\playerlogic::getbeingrevivedinternal() ) && !isdefined( var_0.owner ) )
                    {
...
proximityrevive( var_0, var_1, var_2 )
{
    ...
    var_0 scripts\mp\playerlogic::setbeingrevivedinternal( 1 );
    var_1.owner = var_0;
...
watchproximityrevivefail( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 scripts\mp\playerlogic::setbeingrevivedinternal( 0 );
        var_0 scripts\mp\gameobjects::updateuiprogress( var_1, 0 );
        var_0 scripts\mp\utility\player::_freezecontrols( 0 );
        ...
        if ( !scripts\engine\utility::array_contains( self.markequipmentstate.markedents, self.markequipmentstate.markingent ) )
        {
            if ( scripts\mp\utility\player::isplayerads() )
            {
                ...
                if ( level.teambased && scripts\cp_mp\vehicles\vehicle_compass::vehicle_compass_instanceisregistered( self.markequipmentstate.markingent ) )
                {
                    ...
                    var_7 = scripts\mp\utility\player::getteamarray( self.markequipmentstate.markingent.teammarkedfor );

                    foreach ( var_9 in var_7 )
                        scripts\cp_mp\vehicles\vehicle_compass::vehicle_compass_updatevisibilityforplayer( self.markequipmentstate.markingent, var_9 );
                }
...
unmarkafterduration( var_0 )
{
    ...
    scripts\engine\utility::waittill_any_timeout_no_endon_death_1( var_1, "disconnect" );
    unmarkent( var_0 );
}
...
unmarkent( var_0 )
{
    ...
    if ( isdefined( var_0.teammarkedfor ) )
    {
        if ( level.teambased && scripts\cp_mp\vehicles\vehicle_compass::vehicle_compass_instanceisregistered( var_0 ) )
        {
            var_1 = scripts\mp\utility\player::getteamarray( var_0.teammarkedfor );

            foreach ( var_3 in var_1 )
                scripts\cp_mp\vehicles\vehicle_compass::vehicle_compass_updatevisibilityforplayer( var_0, var_3 );
        }

        var_0.teammarkedfor = undefined;
    }
...
markedentities_think()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( isdefined( self.markequipmentstate ) )
            {
                self.markequipmentstate.markedents = markedentities_removeentsbyindex( self.markequipmentstate.markedents, var_0 );
...
setbettermissionrewards()
{
    ...
    self.hasbettermissionrewards = 1;
    updateteambettermissionrewardsui( self.team );
    thread delayedunsetbettermissionrewards();
}
...
delayedunsetbettermissionrewards()
{
    ...
    if ( isdefined( self ) )
        self.hasbettermissionrewards = undefined;
...
updateteambettermissionrewardsui( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util::getquestperkbonus( var_0 );

    if ( !isdefined( level.bettermissiontierbonuses ) )
        level.bettermissiontierbonuses = [];

    var_2 = 0;

    if ( isdefined( level.bettermissiontierbonuses[var_0] ) )
        var_2 = level.bettermissiontierbonuses[var_0];

    var_3 = var_1 - var_2;

    if ( var_3 != 0 )
        scripts\mp\gametypes\br_quest_util::addquestrewardtier( var_0, var_3 );

    level.bettermissiontierbonuses[var_0] = var_1;
}

setspecialistbonus()
{
    self isdismembermentenabledforplayer( 1 );
    self setclientomnvar( "ui_specialist_bonus_active", 1 );
}

unsetspecialistbonus()
{
    self isdismembermentenabledforplayer( 0 );
