...
claymore_explodefromvehicletrigger( var_0 )
{
    ...
    var_1 = var_0 scripts\mp\utility\damage::non_player_add_ignore_damage_signature( self.owner, makeweapon( "claymore_mp" ), self, "MOD_EXPLOSIVE" );
...
claymore_modifieddamage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 == makeweapon( "claymore_mp" ) )
    {
        ...
        {
            foreach ( var_6 in self.claymoreshitby )
            {
    ...
    else if ( var_1 == makeweapon( "claymore_radial_mp" ) )
    {
        ...
        thread claymore_blockdamageuntilframeend( var_2 );
    }
    else
        return var_4;
    ...
    if ( isdefined( var_2.detonatingplayer ) )
    {
        var_14 = isdefined( var_2.owner ) && var_2.detonatingplayer == var_2.owner;
        var_15 = var_2.detonatingplayer == var_0;
...
claymore_blockdamageuntilframeend( var_0 )
{
    ...
    self.claymoreshitby[self.claymoreshitby.size] = var_0;
    waittillframeend;
