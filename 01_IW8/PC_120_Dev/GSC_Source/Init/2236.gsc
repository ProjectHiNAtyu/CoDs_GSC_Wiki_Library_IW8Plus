...
{
    if ( !istrue( var_1 ) )
        scripts\cp_mp\killstreaks\killstreakdeploy::getridofkillstreakdeployweapon( var_2 );
}
...
tryusemanualturretfromstruct( var_0 )
{
    ...
    var_1 = scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_doweaponswitchdeploy( var_0, makeweapon( "deploy_manual_turret_mp" ), 1, undefined, undefined, ::weaponcleanupmanualturret );
    ...
    manualturret_toggleallowactions( 0 );
    var_2 = manualturret_create( "manual_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        manualturret_toggleallowactions( 1 );
        return 0;
    }
...
manualturret_create( var_0, var_1 )
{
    ...
    var_3.colmodel = spawn( "script_model", var_3.origin );
    var_3.colmodel.team = var_3.team;
    var_3.colmodel.owner = var_3.owner;
    var_3.colmodel setmodel( "weapon_vm_mg_sentry_turret_invis_base" );
    var_3.colmodel dontinterpolate();
    var_3.colmodel hide();
    var_3.colmodel.moverdoesnotkill = 1;
    var_3.colmodel.turretparent = var_3;
    return var_3;
}
...
manualturret_setplaced( var_0, var_1 )
{
    ...
    var_0.colmodel show();
    var_0.colmodel.angles = var_0.angles;
    var_0.colmodel.origin = var_0.origin;
    var_0.colmodel linkto( var_0, "tag_aim_pivot" );
    ...
    if ( !var_6 )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
            var_0.minimapid = var_0.colmodel [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_7, var_0.team, undefined, 1, 1 );
    }
    ...
    var_0 thread manualturret_watchdeathongameend();
...
manualturret_setcarried( var_0 )
{
    ...
    var_0 manualturret_toggleallowactions( 0 );
    var_5 = var_0 manualturret_watchplacement( self, self.streakinfo, 1, 2 );

    if ( !isdefined( var_5 ) )
    {
        var_0 manualturret_toggleallowactions( 1 );
        return 0;
    }
...
manualturret_watchuse( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( var_3 == var_0 )
        {
            for ( var_5 = 0; var_3 usebuttonpressed() && var_5 < 0.25; var_5 = var_5 + level.framedurationseconds )
                waitframe();
        ...
        {
            var_7 = manualturret_domonitoredweaponswitch( var_3, var_3.useweapon );
        ...
        if ( !istrue( var_7 ) )
        {
            ...
            if ( isdefined( var_3 ) )
            {
                if ( var_3 scripts\cp_mp\utility\player_utility::_isalive() )
                {
                    ...
                    var_3 switchtoweaponimmediate( var_3.lastdroppableweaponobj );
                }
        ...
        if ( scripts\cp_mp\utility\game_utility::isnightmap() )
            var_3 scripts\common\utility::allow_nvgs( 0 );

        manualturret_applyoverlay( var_3 );
        thread manualturret_disablefire( var_3, 0.5, 1 );
        thread manualturret_watchammotracker( var_3 );
        thread manualturret_endturretuseonexecution( var_3 );
        thread manualturret_endturretuseonpush( var_3 );
...
manualturret_domonitoredweaponswitch( var_0, var_1 )
{
    self endon( "kill_turret" );
...
manualturret_watchturretusetimeout( var_0 )
{
    self endon( "kill_turret" );
...
manualturret_endplayeruse( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        var_0.playerusingturret = undefined;
    ...
    if ( isdefined( self ) )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( !istrue( var_0.isshuttingdown ) )
        ...
        if ( level.gametype != "br" || level.gametype == "br" && !istrue( self.inlaststand ) )
            self switchtoweaponimmediate( self.lastdroppableweaponobj );

        scripts\cp_mp\utility\inventory_utility::_takeweapon( self.useweapon );
        thread manualturret_disablecrouchprone();
...
manualturret_disablecrouchprone()
{
    self endon( "death_or_disconnect" );
...
manualturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_0 scripts\cp_mp\utility\killstreak_utility::recordkillstreakendstats( self.streakinfo );
    }
...
manualturret_watchtimeout( var_0 )
{
    ...
    while ( self.timeelapsed < var_1 )
    {
        ...
        if ( isdefined( self.playerusingturret ) )
            self.playerusingturret setclientomnvar( "ui_killstreak_countdown", int( var_2 ) );

        self.timeelapsed = self.timeelapsed + level.framedurationseconds;

        if ( self.timeelapsed >= var_1 - 1.5 && !istrue( self.stopinteract ) )
            self.stopinteract = 1;
...
manualturret_toggleallowactions( var_0 )
{
    if ( scripts\cp_mp\utility\player_utility::_isalive() )
    {
