...
updatedragonsbreath( var_0 )
{
    ...
    {
        if ( scripts\cp_mp\dragonsbreath::isdragonsbreathweapon( var_0 ) )
            thread scripts\cp_mp\dragonsbreath::initdragonsbreathusage( var_0 );
    }
}
...
updatelauncherusage()
{
    ...
    {
        var_1 = weaponclass( var_0.basename ) == "rocketlauncher" || var_0.basename == "iw8_la_kgolf_mp";

        if ( var_1 && !istrue( self.fastreloadlaunchers ) )
        {
    ...
    switch ( var_0.basename )
    {
        ...
        case "iw8_la_juliet_mp":
            ...
            break;
        case "iw8_sn_crossbow_mp":
            thread scripts\cp_mp\crossbow::crossbowusageloop( var_0 );
            break;
    }
}

setlastdroppableweaponobj( var_0 )
{
...
updatelastweaponobj( var_0 )
{
    ...
    if ( isdroppableweapon( var_1 ) )
        setlastdroppableweaponobj( var_1 );
...
onplayerspawned()
{
    ...
    var_0 = getweaponcamoname( self getcurrentweapon() );
    thread runcamoscripts( var_0 );
}
...
savealtstates()
{
    ...
    {
        if ( !isundefinedweapon( self.primaryweaponobj ) && var_2 == self.primaryweaponobj || !isundefinedweapon( self.secondaryweaponobj ) && var_2 == self.secondaryweaponobj )
        {
...
savetogglescopestates()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( !isundefinedweapon( self.primaryweaponobj ) && var_2 == self.primaryweaponobj || !isundefinedweapon( self.secondaryweaponobj ) && var_2 == self.secondaryweaponobj )
        {
            if ( isdefined( var_2.scope ) && istogglescope( var_2.scope ) )
            {
                var_3 = scripts\mp\utility\weapon::getcompleteweaponnamenoalt( var_2 );
...
{
    return isattachmentselectfire( var_0 );
}

isattachmentselectfire( var_0 )
{
    var_1 = scripts\mp\utility\weapon::attachmentmap_tobase( var_0 );
...
isattachmentgrenadelauncher( var_0 )
{
    var_1 = scripts\mp\utility\weapon::attachmentmap_tobase( var_0 );
...
{
    if ( isnullweapon( var_0 ) || !isdefined( var_0.scope ) || weaponclass( var_0 ) == "rocketlauncher" || weaponclass( var_0 ) == "smg" )
        return 0;
...
dropweaponfordeath( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !scripts\mp\riotshield::isriotshield( var_4.basename ) )
    {
        ...
        if ( var_1 != "MOD_EXECUTION" )
            thread scripts\cp_mp\utility\weapon_utility::dropweaponfordeathlaunch( var_9, var_3, self.angles );
    }
    else
    {
        var_9 = self dropitem( var_4 );
...
watchpickup()
{
    ...
    for (;;)
    {
        ...
        var_3 = undefined;
        var_4 = isdefined( level.cyberemp ) && isdefined( level.cyberemp.carrier ) && level.cyberemp.carrier == var_1;
        var_5 = scripts\mp\utility\game::getgametype() == "cyber" && ( isdefined( var_2 ) || var_4 );

        if ( var_5 )
        {
            var_6 = var_1 scripts\cp_mp\utility\inventory_utility::getcurrentprimaryweaponsminusalt();
            ...
            if ( var_6.size > 2 )
            {
                ...
                foreach ( var_10 in var_6 )
                {
                    ...
                    if ( var_10.basename == "iw8_knifestab_mp" )
                        var_8 = 1;
                }

                var_12 = undefined;

                if ( isdefined( var_1.primaryweapon ) && var_1.primaryweapon != "iw8_cyberemp_mp" )
                {
                    var_3 = var_1.primaryweapon;
                    var_12 = var_1.primaryweaponobj;
                }
                else if ( isdefined( var_1.secondaryweapon ) && var_1.secondaryweapon != "iw8_cyberemp_mp" )
                {
                    var_3 = var_1.secondaryweapon;
                ...
                if ( !var_7 || var_13 > 3 )
                {
                    ...
                    var_15 = var_1 forcedropweapon( var_14 );

                    if ( var_4 )
                    {
                        var_1 scripts\common\utility::allow_weapon_switch( 0 );
                        var_1 scripts\common\utility::allow_weapon_pickup( 0 );
                        var_1 scripts\common\utility::allow_usability( 0 );
                        var_1 thread waitthengivecyberweapon( var_15 == 0 );
                    }
                    ...
                    else if ( var_15 == 0 )
                    {
                        if ( var_4 )
                        {
                            ...
                            var_1 scripts\common\utility::allow_weapon_pickup( 1 );
                        }
            ...
            else if ( var_4 )
            {
                ...
                var_1 scripts\common\utility::allow_weapon_pickup( 0 );
                var_1 scripts\common\utility::allow_usability( 0 );
                var_1 thread waitthengivecyberweapon();
            }
        ...
        var_1 thread watchpickupcomplete( self.objweapon, var_3, var_16 );
        var_1 notify( "weapon_pickup", self.objweapon );

        if ( isdefined( var_2 ) )
        {
            var_1.lastweaponpickuptime = gettime();
            var_1 scripts\mp\utility\stats::incpersstat( "weaponPickups", 1 );
        }

        var_17 = fixupplayerweapons( var_1, var_0 );
    ...
    if ( isdefined( var_2 ) )
    {
        var_18 = var_2 getitemweaponname();
        var_19 = makeweaponfromstring( var_18 );

        if ( isdefined( var_1.tookweaponfrom[var_18] ) )
        {
            var_2.owner = var_1.tookweaponfrom[var_18];
            var_1.tookweaponfrom[var_18] = undefined;
        }
...
getrandomgraverobberattachment( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) && var_1.size > 0 )
        ...
        var_4 = scripts\mp\utility\weapon::getallselectableattachments( var_2 );
    ...
    foreach ( var_8, var_6 in var_3 )
    {
        ...
        if ( !scripts\mp\utility\weapon::attachmentisselectable( var_0, var_7 ) )
        {
    ...
    var_4 = scripts\engine\utility::array_convert_keys_to_ints( var_4 );
...
addattachmenttoweapon( var_0, var_1 )
{
    ...
    var_5 = scripts\mp\utility\weapon::weaponattachremoveextraattachments( var_5 );
    var_12 = [];
...
getammooverride( var_0 )
{
    ...
    {
        var_5 = scripts\mp\utility\weapon::attachmentmap_tobase( var_0.underbarrel );
...
{
    if ( !scripts\mp\utility\weapon::attachmentisselectable( var_0, var_1 ) )
        return 0;
...
onscavengerbagpickup( var_0 )
{
    if ( isdefined( level.onscavengerbagpickup ) )
        [[ level.onscavengerbagpickup ]]( var_0 );
    else
    {
...
onweaponfired( var_0 )
{
    ...
    if ( !scripts\mp\utility\game::runleanthreadmode() && scripts\mp\utility\game::onlinestatsenabled() )
    {
...
checkhit( var_0, var_1 )
{
    ...
    thread scripts\cp_mp\challenges::onsuccessfulhit( var_0 );
    thread scripts\mp\events::shothit();
    var_6 = gettime();
    self.lastdamagetime = var_6;
    var_1.lasttimedamaged = var_6;
    var_7 = scripts\mp\utility\weapon::getweapongroup( var_0.basename );
...
watchgrenadethrows()
{
    ...
    switch ( var_0.weapon_name )
    {
        ...
        case "support_box_mp":
            ...
            break;
        case "armor_box_mp":
            thread scripts\mp\equipment\support_box::armorbox_used( var_0 );
            break;
        ...
        default:
            if ( isdefined( level.ongrenadeused ) )
                [[ level.ongrenadeused ]]( var_0.weapon_name, var_0 );

            break;
        case "concussion_grenade_mp":
            var_0 thread concussionused();
            break;
    }

    logequipmentuse( var_0.weapon_name );
}

logequipmentuse( var_0 )
{
    if ( !isdefined( var_0 ) )
        return;
...
concussionused()
{
    ...
    thread scripts\mp\equipment\concussion_grenade::onexplode( var_0, var_1 );
}
...
smokegrenadeused( var_0 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        thread smokeglvfx( var_5 );
        thread scripts\mp\bots\bots::create_smoke_occluder( var_5 );
    }
    else
...
lockonlaunchers_gettargetarray( var_0 )
{
    ...
    if ( level.teambased )
    {
        ...
        foreach ( var_14 in var_3 )
        {
            ...
            {
                if ( isdefined( var_17 ) && ( !scripts\cp_mp\vehicles\vehicle::vehicle_isfriendlytoplayer( var_17, self ) || var_2 ) )
...
updatemissilefire( var_0 )
{
    ...
    switch ( var_0.weapon_name )
    {
        ...
        case "iw8_la_gromeoks_mp":
            ...
            level thread scripts\mp\battlechatter_mp::launcherfired( var_0 );
...
updateplantedarray( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        scripts\mp\utility\script::demoforcesre( var_4 );
    }
...
watchexplosiveusable()
{
    ...
    for (;;)
    {
        ...
        var_2 = scripts\mp\equipment::getequipmentreffromweapon( makeweapon( self.weapon_name ) );
...
makeexplosiveusabletag( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        var_4 = scripts\mp\equipment::getequipmentreffromweapon( makeweapon( var_3 ) );
        ...
        if ( isdefined( var_4 ) )
        {
            if ( self.owner scripts\mp\equipment::hasequipment( var_4 ) )
                ...
                [[ level.onnewequipmentpickup ]]( self.owner, var_4 );
        }
...
explosivetrigger( var_0, var_1, var_2 )
{
    ...
    {
        var_0 thread scripts\cp_mp\challenges::triggereddelayedexplosion();
...
updateviewkickscale( var_0 )
{
    ...
    else if ( isdefined( self.overrideviewkickscale ) )
    {
        ...
        var_1 = scripts\mp\utility\weapon::weapongetflinchtype( self getcurrentweapon() );

        if ( var_1 == 1 )
            var_0 = self.overrideviewkickscalepistol;
        else if ( var_1 == 3 )
            var_0 = self.overrideviewkickscaledmr;
        else if ( var_1 == 2 )
            var_0 = self.overrideviewkickscalek98;
        else if ( var_1 == 4 )
...
getplayerspeedbyweapon( var_0 )
{
    ...
    else
    {
        ...
        if ( !isdefined( var_2 ) )
            ...
            var_1 = 0.85;
        else if ( scripts\mp\utility\weapon::isgunlessweapon( var_2.basename ) )
            var_1 = 0.85;
        else
        {
            if ( var_2.inventorytype != "primary" && var_2.inventorytype != "altmode" || scripts\mp\utility\weapon::ismeleedefaultweapon( var_2 ) )
            {
...
minedamagemonitor()
{
    ...
    for (;;)
    {
        ...
        var_17 = scripts\engine\utility::ter_op( scripts\mp\utility\damage::isfmjdamage( var_11, var_6 ) || var_3 >= 80, 2, 1 );
        var_1 = var_1 - var_17;
    ...
    if ( isplayer( var_16 ) )
    {
        ...
        if ( var_16 != self.owner && var_16.team != self.owner.team )
        {
            ...
            scripts\cp_mp\challenges::equipmentdestroyed( var_15, var_0, var_3, var_10, undefined, var_11, undefined, var_16.modifiers );
        }
    }
    ...
    scripts\cp_mp\challenges::minedestroyed( self, var_16, var_6 );
...
deleteplacedequipment()
{
    ...
    if ( isdefined( self.plantedhackedequip ) )
    {
        foreach ( var_7, var_1 in self.plantedhackedequip )
        {
            if ( isdefined( var_1 ) && ( !var_5 || !istrue( var_1.issuper ) ) )
            {
                var_1 deleteexplosive();
                self.plantedhackedequip[var_7] = undefined;
            }
        }
    ...
    if ( var_5 && isdefined( self.plantedsuperequip ) )
    {
        foreach ( var_7, var_1 in self.plantedsuperequip )
        {
            var_1 deleteexplosive();
            self.plantedsuperequip[var_7] = undefined;
        }
...
buildattachmentmaps()
{
    ...
    level.attachmentmap_attachtoblocks = [];
    level.attachmentmap_baseattachtocategory = [];
    level.attachmentmap_uniqueattachtocategory = [];
    ...
    foreach ( var_23 in var_21 )
    {
        ...
        {
            var_26 = level.attachmentmap_baseattachtocategory[var_25];

            if ( !isdefined( var_26 ) )
                level.attachmentmap_baseattachtocategory[var_25] = var_24;
            else if ( var_24 != var_26 )
                level.attachmentmap_uniqueattachtocategory[var_23] = var_24;
        }
        ...
        if ( var_28 != "" )
        {
            ...
            level.attachmentextralist[var_28] = 1;
        }

        var_29 = tablelookup( "mp/attachmenttable.csv", 4, var_23, 9 );

        if ( var_29 != "" )
            level.attachmentmap_attachtoblocks[var_23] = var_29;
    }
...
buildweaponmap()
{
    ...
    for ( var_0 = 1; tablelookup( "mp/statstable.csv", 0, var_0, 0 ) != ""; var_0++ )
    {
        ...
        if ( var_1 != "" )
        {
            ...
            if ( var_3 != "" )
            {
                ...
                var_4 = tablelookup( "mp/statstable.csv", 0, var_0, 41 );
                ...
                if ( var_4 != "" )
                {
                    ...
                    if ( var_5 > -1 )
                    {
                        if ( !isdefined( level.weapongroupdata[var_3] ) )
                            level.weapongroupdata[var_3] = [];

                        level.weapongroupdata[var_3][level.weapongroupdata[var_3].size] = var_1;
                    }
                    else
                        level.weaponmapdata[var_1].uihidden = 1;
                }
            }

            var_6 = tablelookup( "mp/statstable.csv", 0, var_0, 5 );

            if ( var_6 != "" )
                level.weaponmapdata[var_1].assetname = var_6;

            var_7 = tablelookup( "mp/statstable.csv", 0, var_0, 44 );

            if ( var_7 != "" )
                level.weaponmapdata[var_1].perk = var_7;

            var_8 = tablelookup( "mp/statstable.csv", 0, var_0, 9 );
            var_9 = parseattachdefaulttoidmap( var_8 );

            if ( isdefined( var_9 ) )
                level.weaponmapdata[var_1].attachdefaulttoidmap = var_9;
            ...
            {
                var_10 = float( var_10 );
                level.weaponmapdata[var_1].speed = var_10;
            }
        }
    }
    ...
    {
        var_11++;
        var_12 = tablelookupbyrow( "loot/weapon_ids.csv", var_11, 0 );

        if ( var_12 == "" )
            break;

        var_1 = tablelookupbyrow( "loot/weapon_ids.csv", var_11, 1 );
        var_13 = tablelookupbyrow( "loot/weapon_ids.csv", var_11, 6 );
        var_14 = scripts\mp\utility\weapon::getweaponvarianttablename( var_1 );
        var_15 = tablelookup( var_14, 1, var_13, 0 );

        if ( var_15 == "" )
            continue;

        var_16 = var_1 + "|" + var_15;
        level.weaponlootmapdata[var_16] = spawnstruct();
        level.weaponlootmapdata[var_16].variantid = int( var_15 );
        var_17 = tablelookup( var_14, 1, var_13, 3 );

        if ( var_17 != "" )
            level.weaponlootmapdata[var_16].assetoverridename = var_17;

        var_18 = tablelookup( "loot/weapon_ids.csv", 6, var_13, 5 );
        level.weaponlootmapdata[var_16].islocked = int( var_15 ) != 0 && int( var_18 ) == 99;
        var_19 = tablelookup( var_14, 1, var_13, 4 );
        var_9 = parseattachdefaulttoidmap( var_19 );

        if ( isdefined( var_9 ) )
        {
            if ( isdefined( level.weaponmapdata[var_1].attachdefaulttoidmap ) )
                var_9 = scripts\engine\utility::array_combine_unique_keys( var_9, level.weaponmapdata[var_1].attachdefaulttoidmap );

            level.weaponlootmapdata[var_16].attachdefaulttoidmap = var_9;
        }

        var_20 = [];

        for ( var_21 = 5; var_21 <= 15; var_21++ )
        {
            var_22 = tablelookup( var_14, 1, var_13, var_21 );
        ...
        if ( var_20.size > 0 )
            level.weaponlootmapdata[var_16].attachcustomtoidmap = var_20;

        var_24 = tablelookup( var_14, 1, var_13, 16 );

        if ( var_24 != "" )
        {
            var_25 = [];
            var_26 = strtok( var_24, " " );
            ...
            foreach ( var_28 in var_26 )
            {
                ...
                var_25[var_29[0]] = int( var_29[1] );
            }

            if ( var_25.size > 0 )
                level.weaponlootmapdata[var_16].attachextratoidmap = var_25;
        }
    }
}
...
grenadestuckto( var_0, var_1, var_2 )
{
    if ( !isdefined( self ) )
    {
        ...
        var_1.stuckbygrenadeowner = var_0.owner;
    }
...
{
    if ( isdefined( var_0 ) )
        var_0 scripts\engine\utility::waittill_any_timeout_1( var_2, "death_or_disconnect" );
...
weaponhasselectableoptic( var_0 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        ...
        if ( var_5 == "rail" )
        {
            ...
            if ( scripts\mp\utility\weapon::attachmentisselectable( var_1, var_6 ) )
                return 1;
        }
    }
...
watchdropweapons()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) && isdefined( var_1 ) && !scripts\mp\utility\weapon::ismeleeonly( var_1 ) && !scripts\mp\utility\weapon::ismeleedefaultweapon( var_1 ) && !scripts\mp\utility\weapon::isknifeonly( var_1 ) )
        {
...
watchgrenadeaxepickup( var_0, var_1 )
{
    ...
    var_10 = makeweaponfromstring( self.weapon_name );
...
updatecamoscripts( var_0, var_1 )
{
    ...
    runcamoscripts( getweaponcamoname( var_0 ) );
}
...
enableburnfx( var_0, var_1 )
{
    ...
    self.burnfxstates[getburnfxstatepriority( var_1 )] = var_1;
    thread startburnfx();
}

getburnfxstatepriority( var_0 )
{
    switch ( var_0 )
    {
        case "nuke_active":
...
disableburnfx( var_0, var_1 )
{
    if ( isdefined( var_1 ) )
    {
        if ( self.burnfxstates[getburnfxstatepriority( var_1 )] == var_1 )
            self.burnfxstates[getburnfxstatepriority( var_1 )] = undefined;
    }
    else
        self.burnfxstates = [];
...
startburnfx()
{
    ...
    var_0 = gethightestpriotiryactiveburnstate( self.burnfxstates );
...
semtex_used( var_0 )
{
    ...
    if ( isplayer( var_1 ) )
    {
        ...
        thread semtex_stuckplayer( var_0, var_1 );
    }
}

semtex_stuckplayer( var_0, var_1 )
{
    self endon( "disconnect" );
    ...
    thread semtex_killstuckplayer( var_1, var_2 );
}

semtex_killstuckplayer( var_0, var_1 )
{
    var_0 scripts\cp_mp\utility\damage_utility::forcestuckdamage();
    var_0 dodamage( var_0.maxhealth, var_1, self, undefined, "MOD_EXPLOSIVE", makeweapon( "semtex_mp" ) );
    var_0 scripts\cp_mp\utility\damage_utility::forcestuckdamageclear();
}
