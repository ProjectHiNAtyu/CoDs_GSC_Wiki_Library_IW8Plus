        ...
        foreach ( var_6 in level.players )
        {
            ...
            if ( isdefined( var_3.canusecallback ) && !var_6 [[ var_3.canusecallback ]]( self ) )
            {
                if ( isdefined( self.boxiconid ) )
                    scripts\cp_mp\entityheadicons::setheadicon_removeclientfrommask( self.boxiconid, var_6 );
            }
        }
    }
    else
...
box_addboxforplayer( var_0 )
{
    ...
    else
    {
        ...
        if ( isdefined( self.boxiconid ) )
            scripts\cp_mp\entityheadicons::setheadicon_removeclientfrommask( self.boxiconid, var_0 );
    }
}
            ...
            if ( isdefined( var_1.canuseotherboxes ) && var_1.canuseotherboxes )
            {
                foreach ( var_4 in level.deployable_box[var_1.streakname] )
                {
                    ...
                    if ( isdefined( var_4.boxiconid ) )
                        scripts\cp_mp\entityheadicons::setheadicon_removeclientfrommask( var_4.boxiconid, var_0 );
...
doubledip( var_0 )
{
    ...
    if ( level.teambased )
    {
        ...
        {
            if ( isdefined( self.boxiconid ) )
                scripts\cp_mp\entityheadicons::setheadicon_addclienttomask( self.boxiconid, var_0 );
