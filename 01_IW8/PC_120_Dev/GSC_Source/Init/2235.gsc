...
streakdeploy_doweapontabletdeploy( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    ...
    ondeploystart( var_0 );
    thread streakdeploy_playtabletdeploydialog( var_0 );
    ...
    scripts\common\utility::allow_offhand_weapons( 0 );
    var_10 = switchtodeployweapon( var_8, var_0, ::waituntilfinishedwithdeployweapon, var_1, var_2, var_3, var_4 );
    ...
    var_11 = watchdeployweaponanimtransition( var_0, var_9, var_6 );
    ondeployfinished( var_0, var_11 );
...
streakdeploy_dothrowbackmarkerdeploy( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_0.deployweaponobj = makeweapon( var_7 );
...
watchdeployweaponanimtransition( var_0, var_1, var_2 )
{
    ...
    var_4 = scripts\engine\utility::waittill_any_timeout_3( var_1, "death", "weapon_change", "cancel_all_killstreak_deployments" );
...
{
    self endon( "disconnect" );
    var_1 = scripts\engine\utility::waittill_any_timeout_1( var_0, "cancel_remote_sequence" );
    ...
    if ( scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        var_1 = scripts\engine\utility::waittill_any_timeout_1( 0.7, "death" );
...
cleanupdeployweapon( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_6 = scripts\cp_mp\utility\killstreak_utility::isremotekillstreaktabletweapon( var_2.basename );
        ...
        if ( isdefined( var_4 ) )
            ...
            getridofkillstreakdeployweapon( var_2 );
...
getridofkillstreakdeployweapon( var_0 )
{
