...
cargo_truck_init()
{
    ...
    cargo_truck_initomnvars();
    cargo_truck_initdamage();
    cargo_truck_initfx();
...
cargo_truck_initinteract()
{
    ...
    var_0.seatenterarrays["single"] = [ "driver" ];
}

cargo_truck_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "cargo_truck", 1 );
    var_0.id = 8;
...
cargo_truck_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "cargo_truck", 3500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cargo_truck" );
    var_0.class = "heavy";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "cargo_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "cargo_truck", 20 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "cargo_truck", ::cargo_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "cargo_truck_mp", 5 );
}
