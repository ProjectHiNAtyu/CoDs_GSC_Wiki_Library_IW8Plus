...
little_bird_init()
{
    level.lb_dmg_factor_fuselage = getdvarfloat( "scr_little_bird_dmg_factor_fuselage", 1.0 );
    level.lb_dmg_factor_tail_stabilizer = getdvarfloat( "scr_little_bird_dmg_factor_tail_stabilizer", 1.0 );
    level.lb_dmg_factor_main_rotor = getdvarfloat( "scr_little_bird_dmg_factor_main_rotor", 1.2 );
    level.lb_dmg_factor_tail_rotor = getdvarfloat( "scr_little_bird_dmg_factor_tail_rotor", 1.0 );
    level.lb_dmg_factor_landing_gear = getdvarfloat( "scr_little_bird_dmg_factor_landing_gear", 0.5 );
    level.lb_dmg_factor_driverless_collision = getdvarfloat( "scr_little_bird_dmg_factor_driverless_collision", 3.0 );
    level.lb_impulse_dmg_threshold_top = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_high", 0.9 );
    level.lb_impulse_dmg_threshold_mid = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_mid", 0.9 );
    level.lb_impulse_dmg_threshold_low = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_low", 0.1 );
    level.lb_impulse_dmg_factor_low = getdvarfloat( "scr_little_bird_impulse_dmg_factor_low", 0.1 );
    level.lb_impulse_dmg_factor_mid_low = getdvarfloat( "scr_little_bird_impulse_dmg_factor_mid_low", 0.2 );
    level.lb_impulse_dmg_factor_mid_high = getdvarfloat( "scr_little_bird_impulse_dmg_factor_mid_high", 0.75 );
    level.lb_pitch_roll_dmg_threshold = getdvarfloat( "scr_little_bird_dmg_pitch_roll_threshold", 55.0 );
    level.lb_pitch_roll_dmg_factor = getdvarfloat( "scr_little_bird_dmg_pitch_roll_factor", 10.0 );
    level.lb_wood_surf_dmg_scalar = getdvarfloat( "scr_little_bird_wood_surf_dmg_scalar", 0.6 );
...
little_bird_initinteract()
{
    ...
    var_0.seatenterarrays["single"] = [ "pilot", "fl_platform", "fr_platform", "bl_platform", "br_platform" ];
}

little_bird_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "little_bird", 1 );
...
little_bird_initdamage()
{
    ...
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "little_bird", var_0 );
    var_1 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "little_bird" );
    var_1.class = "medium_heavy";
    var_2 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldatafordamagestate( "little_bird", "heavy" );
    var_2.onentercallback = ::little_bird_onenterheavydamagestate;
    var_2.onexitcallback = ::little_bird_onexitheavydamagestate;
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "little_bird" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "little_bird", 12 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "little_bird", ::little_bird_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "little_bird_mp", 5 );
}
...
little_bird_create( var_0, var_1 )
{
    ...
    var_2 thread vehicle_handleflarerecharge();
    var_2 thread collision_damage_watcher();
    return var_2;
}
...
collision_damage_watcher()
{
    ...
    for (;;)
    {
        ...
        {
            case 0:
                var_9 = level.lb_dmg_factor_fuselage;
                break;
            case 1:
                var_9 = level.lb_dmg_factor_tail_stabilizer;
                break;
            case 2:
                var_9 = level.lb_dmg_factor_main_rotor;
                break;
            case 3:
                var_9 = level.lb_dmg_factor_tail_rotor;
                break;
            case 4:
                var_9 = level.lb_dmg_factor_landing_gear;
                break;
        }
        ...
        if ( !isdefined( var_11 ) )
            var_10 = var_10 * level.lb_dmg_factor_driverless_collision;
        ...
        if ( abs( var_12 > level.lb_pitch_roll_dmg_threshold ) )
            var_10 = var_10 * level.lb_pitch_roll_dmg_factor;
        ...
        if ( abs( var_13 > level.lb_pitch_roll_dmg_threshold ) )
            var_10 = var_10 * level.lb_pitch_roll_dmg_factor;

        var_14 = 0;

        if ( var_10 > level.lb_impulse_dmg_threshold_top )
            var_14 = self.maxhealth;
        else if ( var_10 > level.lb_impulse_dmg_threshold_mid )
        {
            var_15 = level.lb_impulse_dmg_threshold_top - level.lb_impulse_dmg_threshold_mid;
            var_16 = ( var_10 - level.lb_impulse_dmg_threshold_mid ) / var_15;
            var_17 = self.maxhealth * level.lb_impulse_dmg_factor_mid_low;
            var_18 = self.maxhealth * level.lb_impulse_dmg_factor_mid_high;
            var_14 = scripts\engine\math::lerp( var_17, var_18, var_16 );
        }
        else if ( var_10 > level.lb_impulse_dmg_threshold_low )
            var_14 = self.maxhealth * level.lb_impulse_dmg_factor_low;

        if ( var_14 > 0 )
        {
            if ( isdefined( var_11 ) && var_3 == 11534336 )
                var_14 = var_14 * level.lb_wood_surf_dmg_scalar;
...
little_bird_onenterheavydamagestate( var_0, var_1 )
{
...
little_bird_onexitheavydamagestate( var_0, var_1 )
{
...
little_bird_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "pilot" )
    {
        ...
        var_0 thread vehicle_handleflarefire( var_3 );
    }
...
vehicle_handleflarefire( var_0 )
{
    ...
    scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_setammo( "little_bird", "flares", scripts\engine\utility::ter_op( self.flareready, 1, 0 ), var_0 );
