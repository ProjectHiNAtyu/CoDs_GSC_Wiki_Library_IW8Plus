...
loadtable()
{
    ...
    for (;;)
    {
        ...
        var_3.isselectable = tablelookupbyrow( "mp/equipment.csv", var_0, 8 ) != "-1";
...
giveequipment( var_0, var_1 )
{
    ...
    var_5 = var_0 == "equip_throwing_knife" || var_0 == "equip_throwing_knife_fire";
...
enableslotinternal( var_0 )
{
    ...
    if ( isdefined( var_2.objweapon ) && !var_2.ispassive )
    {
        if ( var_0 == "primary" )
            self assignweaponoffhandprimary( var_2.objweapon );
        else if ( var_0 == "secondary" )
...
getequipmentmaxammo( var_0 )
{
    ...
    {
        var_3 = level.br_pickups.maxcounts[level.br_pickups.br_equipnametoscriptable[var_1.ref]];

        if ( var_0 == "equip_armorplate" )
        {
            if ( scripts\mp\gametypes\br_public::hasplatepouch() )
                var_3 = var_3 + getdvarint( "scr_br_platePouchCount", 0 );
        }
    }
...
{
    if ( isdefined( level.equipment.table[var_0] ) )
        return istrue( level.equipment.table[var_0].isselectable );
    else
        return 0;
}
...
executeoffhandfired( var_0 )
{
    foreach ( var_6, var_2 in self.equipment )
    {
        ...
        if ( isdefined( var_3.objweapon ) && var_0 == var_3.objweapon )
        {
            ...
            scripts\mp\damage::combatrecordequipmentused( var_4 );
...
watchlethaldelay()
{
    ...
    var_0 = currentgametypestopsclock();
...
watchlethaldelayplayer( var_0, var_1 )
{
    ...
    if ( !isdefined( self.lethaldelayallows ) || !istrue( self.lethaldelayallows[var_1] ) )
    {
        if ( !isdefined( self.lethaldelayallows ) )
            self.lethaldelayallows = [];

        self.lethaldelayallows[var_1] = 1;
    ...
    if ( isdefined( self.lethaldelayallows ) && istrue( self.lethaldelayallows[var_1] ) )
    {
        self.lethaldelayallows[var_1] = undefined;
...
watchlethaldelayfeedbackplayer( var_0, var_1 )
{
    ...
    var_3 = currentgametypestopsclock();
...
hackequipment( var_0 )
{
    ...
    var_0 scripts\cp_mp\challenges::onhack( self.equipmentref );
    changeowner( var_0 );
