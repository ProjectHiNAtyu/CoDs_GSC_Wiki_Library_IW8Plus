...
updatekillstreakuislot( var_0 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2.streakname ) )
    {
        ...
        _setclientkillstreakindexes( var_0, var_3 );
        _setclientkillstreakavailability( var_0, var_2.available );
    }
    else
    {
        self setclientomnvar( var_1.slotomnvars[var_0], 0 );
        self setclientomnvar( var_1.availableomnvars[var_0], 0 );
        _setclientkillstreakindexes( var_0, 0 );
        _setclientkillstreakavailability( var_0, 0 );
    }
}
...
gettriggeredslotfromnotify( var_0 )
{
    ...
    else if ( ( scripts\mp\utility\game::getgametype() == "grnd" || scripts\mp\utility\game::getgametype() == "infect" ) && !scripts\engine\utility::is_player_gamepad_enabled() )
    {
        switch ( var_0 )
        {
            case "ks_action_3":
...
triggerkillstreak( var_0, var_1 )
{
    ...
    if ( isdefined( level.modeiskillstreakallowed ) && !self [[ level.modeiskillstreakallowed ]]( var_0, var_1 ) )
    {
        scripts\mp\hud_message::showerrormessage( "KILLSTREAKS/CANNOT_BE_USED" );
        return 0;
    }
    ...
    var_4 = self [[ var_2.triggeredfunc ]]( var_3 );
    self.triggeringstreak = undefined;
...
onsuccessfulstreakactivation( var_0, var_1 )
{
    ...
    var_0.available = -1;
    _setclientkillstreakavailability( var_1, var_0.available );
    ...
    thread scripts\cp_mp\challenges::usedkillstreak( var_2 );
    ...
    var_0.activatedtime = var_6;
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_0.streakmatchlifeid, var_0.streakname, var_0.isgimme, var_6, self.origin );
...
createstreakitemstruct( var_0 )
{
    ...
    var_1.isspecialist = scripts\mp\perks\perks::isspecialiststreak( var_0 );
    var_1.specialistperk = scripts\mp\perks\perks::getspecialistperkforstreak( var_0 );
    return var_1;
}
...
awardkillstreak( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    awardkillstreakfromstruct( var_6, var_2, var_3, var_4, var_5 );
}

awardkillstreakfromstruct( var_0, var_1, var_2, var_3, var_4 )
{
    var_0.isgimme = 1;
    var_5 = 0;
    ...
    {
        if ( !isdefined( var_1 ) )
            var_1 = var_0.streaklifeid;

        if ( !isdefined( var_2 ) )
            var_2 = var_0.streakmatchlifeid;
    }

    slotkillstreak( var_0, var_5 );
    setselectedkillstreak( var_5 );
    makekillstreakavailable( var_5, var_1, var_2, var_3 );
}
...
makekillstreakavailable( var_0, var_1, var_2, var_3 )
{
    var_4 = getkillstreakinslot( var_0 );
    ...
    if ( isdefined( var_4.specialistperk ) )
        var_5 = var_4.specialistperk;

    loadassociatedkillstreakweapons( var_5 );
    var_6 = var_4.streaksetupinfo;

    if ( self.team == "spectator" )
        return;

    var_4.available = 1;
    _setclientkillstreakavailability( var_0, var_4.available );
    setselectedkillstreak( var_0 );
    updatekillstreakuislot( var_0 );

    if ( isdefined( var_6.availablefunc ) )
        self [[ var_6.availablefunc ]]( var_4 );

    if ( var_4.isgimme )
        self notify( "received_earned_killstreak" );

    var_4.madeavailabletime = scripts\mp\matchdata::gettimefrommatchstart( gettime() );
    var_4.streaklifeid = self.lifeid;
    var_4.streakmatchlifeid = self.matchdatalifeindex;
    var_4.owner = self;
    var_4.ownerxuid = self getxuid();

    if ( isdefined( var_1 ) )
        var_4.streaklifeid = var_1;

    if ( isdefined( var_2 ) )
        var_4.streakmatchlifeid = var_2;

    if ( isdefined( var_3 ) )
    {
        var_4.owner = var_3;
        var_4.ownerxuid = var_3 getxuid();
    }

    scripts\mp\analyticslog::logevent_killstreakavailable( self, var_4.streakmatchlifeid, var_5, var_4.isgimme, var_4.madeavailabletime, self.origin );
}

_setclientkillstreakindexes( var_0, var_1 )
{
    if ( var_0 > 3 )
        return;
...
_setclientkillstreakavailability( var_0, var_1 )
{
    if ( var_0 > 3 )
        return;
...
killstreakselectionwatcher()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::waittill_any_return_2( "ks_select_up", "ks_select_down" );
...
registerkillstreak( var_0, var_1, var_2 )
{
    if ( !isdefined( level.killstreaksetups ) )
        level.killstreaksetups = [];

    var_3 = spawnstruct();
    level.killstreaksetups[var_0] = var_3;
    var_3.triggeredfunc = var_1;
    var_3.availablefunc = var_2;
}
...
checkstreakreward( var_0 )
{
    for ( var_1 = 1; var_1 <= 4; var_1++ )
    {
        ...
        var_3 = var_2.currentcost;

        if ( self.previousstreakpoints >= var_3 || var_0 < var_3 )
            continue;

        if ( scripts\mp\utility\perk::_hasperk( "specialty_support_killstreaks" ) && istrue( var_2.earned ) )
            continue;

        if ( isdefined( var_2.lifeid ) && var_2.lifeid == self.lifeid )
            continue;

        earnkillstreak( var_1, var_3 );
    }
}
...
givestreakpoints( var_0, var_1, var_2 )
{
    ...
    if ( var_6 && !istrue( level.disablepersonalnuke ) && ( istrue( level.allowkillstreaks ) || isdefined( level.personalnukecostoverride ) ) )
    {
        var_7 = self.nukepoints + var_1;
        var_8 = calcstreakcost( "nuke" );

        if ( isdefined( level.personalnukecostoverride ) )
            var_8 = level.personalnukecostoverride;
...
resetstreakavailability( var_0 )
{
    ...
    for ( var_1 = 0; var_1 <= 4; var_1++ )
    {
        ...
        if ( isdefined( var_2 ) && isdefined( var_2.streakname ) )
        {
            ...
            _setclientkillstreakavailability( var_1, var_2.available );
        }
    }
}
        ...
        foreach ( var_1 in level.players )
        {
            ...
            if ( isdefined( var_1.streakpoints ) )
            {
                if ( var_1 scripts\mp\utility\perk::_hasperk( "specialty_killstreak_to_scorestreak" ) )
                    var_2 = scripts\mp\perks\perkfunctions::killstreaktoscorestreak_scoretokill( var_1.streakpoints );
                else
...
killstreakhit( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) && isplayer( var_0 ) && isdefined( var_2.owner ) && isdefined( var_2.owner.team ) )
    {
        ...
        {
            var_2 updatescrapassistdata( var_0, var_4 );
...
{
    updatescrapassistdata( var_0, 150 );
}
...
updatescrapassistdata( var_0, var_1 )
{
    ...
    var_2 = var_0 getxuid();
    var_0.hasscrapassist = 1;

    if ( !isdefined( self.scrapassistdamage[var_2] ) )
    {
        var_3 = spawnstruct();
        var_3.damage = 0;
        var_3.player = var_0;
        self.scrapassistdamage[var_2] = var_3;
    }

    self.scrapassistdamage[var_2].damage = self.scrapassistdamage[var_2].damage + var_1;
}
...
getscrapassistplayers( var_0 )
{
    ...
    foreach ( var_3 in self.scrapassistdamage )
    {
        var_4 = var_3.damage;
        var_5 = var_3.player;
...
initridekillstreak_internal( var_0 )
{
    if ( isdefined( var_0 ) && islaptoptimeoutkillstreak( var_0 ) )
        ...
        var_1 = scripts\engine\utility::waittill_any_timeout_3( 1.0, "death", "disconnect", "weapon_switch_started" );
    ...
    if ( !isdefined( var_0 ) || !issubstr( var_0, "pointSelect" ) )
    {
        if ( var_0 == "drone_hive" )
        {
            ...
            var_2 = scripts\engine\utility::waittill_any_timeout_1( 0, "death_or_disconnect" );
        }
        else
        {
            ...
            var_2 = scripts\engine\utility::waittill_any_timeout_1( 0.8, "death_or_disconnect" );
        }
    }
    else
        var_2 = scripts\engine\utility::waittill_any_timeout_1( 1.0, "death_or_disconnect" );
