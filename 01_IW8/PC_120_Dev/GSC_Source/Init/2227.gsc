...
spawnchopper( var_0, var_1 )
{
    ...
    var_22.crashoffset = var_2[2] - 750;
    var_22.stage1accradius = 50;
    var_22.stage2accradius = 25;
    var_22.stage3accradius = undefined;
    var_22.minshotstostage2acc = 7;
    var_22.minshotstostage3acc = 12;
...
choppersupport_engageturrettarget( var_0 )
{
    ...
    for (;;)
    {
        if ( !istrue( var_0.turreton ) || istrue( var_0.turretdisabled ) )
        {
            waitframe();
            continue;
        }
...
choppersupport_acquireturrettarget( var_0, var_1 )
{
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        if ( istrue( var_5 ) && self.currenttarget == var_4 )
            thread choppersupport_movetolocation( var_4, 1 );
...
choppersupport_clearcurrenttarget( var_0 )
{
    ...
    if ( istrue( var_0.targetbrokelos ) )
        var_0.targetbrokelos = undefined;
...
choppersupport_fireonturrettarget( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    thread choppersupport_watchtargetrange( var_0 );

    while ( istrue( choppersupport_canattackactivetarget( var_0, var_1 ) ) )
    {
        if ( istrue( var_0.targetbrokelos ) )
        {
            if ( isdefined( self.currenttarget ) && var_1 == self.currenttarget )
...
choppersupport_watchtargetlos( var_0, var_1 )
{
    ...
    for (;;)
    {
        if ( !istrue( var_0.targetbrokelos ) && isdefined( var_0.attackingtarget ) )
        {
...
choppersupport_patrolfield( var_0 )
{
    ...
    else
    {
        ...
        for (;;)
        {
            ...
            if ( isdefined( var_3 ) )
                choppersupport_movetolocation( var_3, 1 );
            else
            {
                var_5 = [];
                var_6 = ( 0, 0, 0 );
                ...
                if ( isdefined( var_6 ) && var_5.size > 0 )
                {
                    ...
                    choppersupport_movetolocation( var_11 );
                }
            }
...
choppersupport_cleanup( var_0 )
{
    ...
    if ( isdefined( self.streakinfo ) )
        self.streakinfo.expiredbydeath = istrue( var_0 );
...
choppersupport_gettargets( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_7 = 0; var_7 < var_5.size; var_7++ )
    {
        ...
        if ( istrue( var_10 ) )
        {
            var_13 = spawnstruct();
            var_13.player = var_8;
            var_13.searchfortarget = var_11;
            var_13.targetvehicle = var_12;
...
choppersupport_istarget( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !choppersupport_isplayeractive( var_1 ) )
        return [ 0, 0, 0 ];
...
choppersupport_getbesttarget( var_0, var_1 )
{
    ...
    {
        if ( !choppersupport_isplayeractive( var_7.player ) )
            continue;

        if ( choppersupport_isactivetarget( var_7.player ) && !istrue( var_7.targetvehicle ) )
            continue;
        ...
        if ( istrue( var_7.searchfortarget ) )
        {
            var_8 = 1;
            var_10 = var_10 + 40;
        }

        if ( istrue( var_7.targetvehicle ) )
        {
            var_9 = 1;
            var_10 = var_10 + 20;
        }
...
choppersupport_crash( var_0 )
{
    ...
    self setneargoalnotifydist( 100 );
    var_1 = choppersupport_findcrashposition( 3500, 500, 1000 );
...
beginevasivemaneuvers()
{
    ...
    var_0 = scripts\engine\utility::waittill_any_timeout_1( 3.0, "death" );
