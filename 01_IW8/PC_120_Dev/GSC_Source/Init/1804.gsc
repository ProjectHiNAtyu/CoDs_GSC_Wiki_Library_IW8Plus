...
scriptable_door_scriptable_used_callback( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        var_5 = getentitylessscriptablearray( var_0.target, "targetname" );
...
{
    var_0 = getentitylessscriptablearray( undefined, undefined, undefined, undefined, "door" );
...
system_init()
{
    ...
    scripts\engine\scriptable::scriptable_addusedcallbackbypart( "door", ::scriptable_door_scriptable_used_callback );
