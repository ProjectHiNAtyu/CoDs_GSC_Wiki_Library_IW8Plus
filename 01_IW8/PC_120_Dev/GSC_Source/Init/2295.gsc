...
bot_usebutton_wait( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\engine\utility::waittill_any_timeout_4( var_0, var_1, var_2, "use_button_no_longer_pressed", "finished_use" );
...
watch_nodes_aborted()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::waittill_any_timeout_1( 0.5, "still_watching_nodes" );
...
bot_update_difficultysetttings( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = level.difficultytabledata;
...
bot_set_difficultysetting( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        var_2 = level.difficultytabledata;
