...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "airdrop", "applyImmediateJuggernaut", ::airdrop_applyimmediatejuggernaut );
}
...
airdrop_awardkillstreak( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        var_4 = var_2.streakinfo.mpstreaksysteminfo.streakmatchlifeid;
        var_5 = var_2.streakinfo.owner;
    }

    thread scripts\mp\killstreaks\killstreaks::awardkillstreak( var_0, var_1, var_3, var_4, var_5 );
...
airdrop_applyimmediatejuggernaut( var_0 )
{
    ...
    var_2.streakmatchlifeid = self.matchdatalifeindex;
    var_2.owner = self;
    var_2.ownerxuid = self getxuid();
    var_2.activatedtime = scripts\mp\matchdata::gettimefrommatchstart( gettime() );
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_2.streaklifeid, var_2.streakname, var_2.isgimme, var_2.activatedtime, self.origin );
