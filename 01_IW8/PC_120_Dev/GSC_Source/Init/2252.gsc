...
apc_rus_init()
{
    ...
    var_0.updatecallback = ::apc_rus_update;
...
apc_rus_initoccupancy()
{
    ...
    var_4.turretobjweapon = makeweapon( "tur_apc_rus_mp" );
...
apc_rus_initinteract()
{
    ...
    var_0.seatenterarrays["single"] = [ "driver", "front_right", "back_right", "back", "back_left", "front_left" ];
}

apc_rus_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "apc_russian", 1 );
    var_0.id = 15;
    ...
    var_0.ammoids["driverTurret"] = 0;
    var_0.rotationids["chassis"] = 0;
    var_0.rotationids["turret"] = 1;
    var_0.rotationrefsbyseatandweapon["driver"]["apc_rus_mp"] = "chassis";
    var_0.rotationrefsbyseatandweapon["driver"]["tur_apc_rus_mp"] = "turret";
    var_0.rotationrefsbyseatandweapon["front_left"]["apc_rus_mp"] = "chassis";
    var_0.rotationrefsbyseatandweapon["front_left"]["tur_apc_rus_mp"] = "turret";
    var_0.rotationrefsbyseatandweapon["front_right"]["apc_rus_mp"] = "chassis";
    var_0.rotationrefsbyseatandweapon["front_right"]["tur_apc_rus_mp"] = "turret";
    var_0.rotationrefsbyseatandweapon["back_right"]["apc_rus_mp"] = "chassis";
    var_0.rotationrefsbyseatandweapon["back_right"]["tur_apc_rus_mp"] = "turret";
    var_0.rotationrefsbyseatandweapon["back_left"]["apc_rus_mp"] = "chassis";
    var_0.rotationrefsbyseatandweapon["back_left"]["tur_apc_rus_mp"] = "turret";
    var_0.rotationrefsbyseatandweapon["back"]["apc_rus_mp"] = "chassis";
    var_0.rotationrefsbyseatandweapon["back"]["tur_apc_rus_mp"] = "turret";
}

apc_rus_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "apc_russian", 4000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "apc_russian" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "apc_russian" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "apc_russian", 18 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "apc_russian", ::apc_rus_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "tur_apc_rus_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "apc_rus_mp", 5 );
}
...
apc_rus_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::vehicle_registerturret( var_2, var_3, makeweapon( "tur_apc_rus_mp" ), 1 );
    ...
    var_4.destroyaward = "kill_apc_rus";
    var_4.destroyawardlaunchonly = 1;
    ...
    var_2 thread apc_rus_monitordriverturretfire();
...
apc_rus_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < var_8 )
        var_0.isrearcriticaldamage = apc_rus_damagecancriticalhit( var_0 );

    return 1;
}

apc_rus_postmoddamagecallback( var_0 )
{
...
apc_rus_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( var_0, "tur_apc_rus_mp" );
    ...
    if ( var_1 == "driver" )
        var_0 thread apc_rus_monitordriverturretreload( var_3 );
}
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( self, "tur_apc_rus_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 14;
    ...
    for (;;)
    {
        ...
        apc_rus_adjustdriverturretammo( -1 );
...
apc_rus_driverturretreload()
{
    ...
    wait 2.7;
    apc_rus_adjustdriverturretammo( 14 );
    wait 0.15;
    var_0 turretfireenable();
}

apc_rus_monitordriverturretreload( var_0 )
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( self, "tur_apc_rus_mp" );
...
apc_rus_adjustdriverturretammo( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( self, "tur_apc_rus_mp" );
...
{
    if ( var_2 == "driver" )
        var_0 apc_rus_updatedriverturretammoui();
}
