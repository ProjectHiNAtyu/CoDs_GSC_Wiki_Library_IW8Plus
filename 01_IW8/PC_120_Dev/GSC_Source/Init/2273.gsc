...
vehicle_occupancy_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            var_3.monitorcontrolscallback = undefined;
            var_3.restrictions = [];
...
vehicle_occupancy_getleveldataforseat( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_2 ) )
        {
            ...
            var_4.showcashbag = undefined;
            var_4.turretobjweapon = undefined;
        }
    }
...
vehicle_occupancy_deregisterinstance( var_0 )
{
    ...
    var_0.preventspawninto = undefined;
...
vehicle_occupancy_isdriverseat( var_0, var_1 )
{
...
vehicle_occupancy_enter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( istrue( vehicle_occupancy_seatisavailable( var_0, var_1, var_2 ) ) )
    {
        ...
        if ( var_10 )
        {
            ...
            if ( istrue( var_2.insertingarmorplate ) )
                var_2 notify( "br_try_armor_cancel" );

            if ( isdefined( var_9 ) )
            {
                var_11 = vehicle_occupancy_isdriverseat( var_0, var_9 );
            ...
            if ( isdefined( var_1 ) )
            {
                var_11 = vehicle_occupancy_isdriverseat( var_0, var_1 );
                ...
                if ( istrue( var_11 ) )
                {
                    ...
                    {
                        case "apc_russian":
                            var_13 = var_2.vehiclecustomization.apc;
                            var_14 = var_2.vehiclecustomization.apcturret;
                            var_12 = 1;
                            break;
                        case "atv":
                            var_13 = var_2.vehiclecustomization.atv;
                            break;
                        case "cargo_truck":
                            var_13 = var_2.vehiclecustomization.cargo_truck;
                            break;
                        case "jeep":
                            var_13 = var_2.vehiclecustomization.jeep;
                            break;
                        case "little_bird":
                            var_13 = var_2.vehiclecustomization.little_bird;
                            break;
                        case "tac_rover":
                            var_13 = var_2.vehiclecustomization.tac_rover;
                            break;
                        case "light_tank":
                            var_13 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2.vehiclecustomization.tank_east, var_2.vehiclecustomization.tank_west );
                            var_14 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2.vehiclecustomization.tank_eastturret, var_2.vehiclecustomization.tank_westturret );
                            var_12 = 1;
                            break;
                        default:
                            var_13 = "";
                    ...
                    if ( var_13 != "" && !isdefined( var_0.camoset ) )
                    {
                        var_0 enablephysicsmoverpush();
                        var_0 getvehiclecamo( var_13 );

                        if ( var_12 )
                        {
                            foreach ( var_16 in var_0.turrets )
                            {
                                var_16 getvehicleturretcamo( var_14 );
                                break;
                            }
                        }
            ...
            if ( !isdefined( var_9 ) )
                var_18 = "ENTERED_VEHICLE";
            else
                var_18 = "SEAT_SWITCH";

            scripts\cp_mp\vehicles\vehicle_dlog::vehicle_dlog_enterevent( var_0, var_2, var_1, var_18 );
        }
        else if ( isdefined( var_9 ) && !istrue( var_3.vehicledeath ) )
        {
            ...
            {
                var_19 = spawnstruct();
                var_19.playerdeath = var_3.playerdeath;
                var_19.playerlaststand = var_3.playerlaststand;
                var_19.playerdisconnect = var_3.playerdisconnect;
                thread vehicle_occupancy_exit( var_0, var_9, var_2, var_19, 1 );
            }
            else
...
vehicle_occupancy_exit( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        var_2 enablereloading();
        var_7 = vehicle_occupancy_isdriverseat( var_0, var_5 );
...
vehicle_occupancy_isfriendlytoplayer( var_0, var_1 )
{
    if ( level.teambased )
        return vehicle_occupancy_isfriendlytoteam( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.friendlystatusdirty ) )
            var_0 vehicle_occupancy_cleanfriendlystatus( var_0 );

        return isdefined( var_0.playerfriendlyto ) && var_0.playerfriendlyto == var_1;
    }
}

vehicle_occupancy_isenemytoplayer( var_0, var_1 )
{
    if ( level.teambased )
        return vehicle_occupancy_isenemytoteam( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.friendlystatusdirty ) )
            var_0 vehicle_occupancy_cleanfriendlystatus( var_0 );
...
vehicle_occupancy_isneutraltoplayer( var_0, var_1 )
{
    if ( level.teambased )
        return vehicle_occupancy_isneutraltoteam( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.friendlystatusdirty ) )
            var_0 vehicle_occupancy_cleanfriendlystatus( var_0 );

        return !isdefined( var_0.playerfriendlyto );
    }
}
...
vehicle_occupancy_getplayerfriendlyto( var_0 )
{
    if ( !level.teambased )
    {
        ...
        return var_0.playerfriendlyto;
    }

    return undefined;
}

vehicle_occupancy_isfriendlytoteam( var_0, var_1 )
{
    if ( level.teambased )
    {
        if ( istrue( var_0.friendlystatusdirty ) )
        ...
        return isdefined( var_0.teamfriendlyto ) && var_0.teamfriendlyto == var_1;
    }

    return undefined;
}

vehicle_occupancy_isenemytoteam( var_0, var_1 )
{
    if ( level.teambased )
    {
        if ( istrue( var_0.friendlystatusdirty ) )
...
vehicle_occupancy_isneutraltoteam( var_0, var_1 )
{
    if ( level.teambased )
    {
        ...
        return !isdefined( var_0.teamfriendlyto );
    }
...
vehicle_occupancy_cleanfriendlystatus( var_0 )
{
    ...
    {
        var_1 = 0;
        var_2 = var_0.teamfriendlyto;

        if ( isdefined( var_0.team ) && var_0.team != "neutral" )
        {
            var_0.teamfriendlyto = var_0.team;
            var_0.friendlystatusdirty = undefined;
            var_1 = 1;
        }
        ...
        if ( !var_1 )
        {
            foreach ( var_4 in var_0.occupants )
            {
                if ( isdefined( var_4 ) )
                {
                    var_0.teamfriendlyto = var_4.team;
                    var_0.friendlystatusdirty = undefined;
                    var_1 = 1;
                    break;
                }
        ...
        if ( !var_1 )
        {
            var_0.teamfriendlyto = undefined;
            var_0.friendlystatusdirty = undefined;
        }

        if ( !isdefined( var_2 ) && !isdefined( var_0.teamfriendlyto ) )
            return 0;

        if ( isdefined( var_2 ) && isdefined( var_0.teamfriendlyto ) && var_2 == var_0.teamfriendlyto )
            return 0;

        vehicle_occupancy_friendlystatuschangedcallback( var_0, var_2, var_0.teamfriendlyto );
        return 1;
    }
    else
    {
        var_1 = 0;
        var_6 = var_0.playerfriendlyto;

        if ( isdefined( var_0.originalowner ) )
        {
            var_0.playerfriendlyto = var_0.originalowner;
            var_0.friendlystatusdirty = undefined;
            var_1 = 1;
        }
        ...
        if ( !isdefined( var_6 ) && !isdefined( var_0.playerfriendlyto ) )
            return 0;

        if ( isdefined( var_6 ) && isdefined( var_0.playerfriendlyto ) && var_6 == var_0.playerfriendlyto )
            return 0;

        vehicle_occupancy_friendlystatuschangedcallback( var_0, var_6, var_0.playerfriendlyto );
        return 1;
    }
}

vehicle_occupancy_friendlystatuschangedcallback( var_0, var_1, var_2 )
{
    scripts\cp_mp\vehicles\vehicle_compass::vehicle_compass_friendlystatuschangedcallback( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( !isdefined( var_3.friendlystatuschangedcallback ) )
        return;

    thread [[ var_3.friendlystatuschangedcallback ]]( var_0, var_1, var_2 );
}
...
vehicle_occupancy_exitstartcallback( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !var_5 )
    {
        ...
        vehicle_occupancy_errormessage( var_3, 2 );
...
vehicle_occupancy_enterend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
    {
        ...
        var_3.vehicle = var_0;
        var_3.vehiclereserved = undefined;
        ...
        vehicle_occupancy_updateriotshield( var_3, var_0, var_1 );
        ...
        vehicle_occupancy_hidecashbag( var_0, var_1, var_3, var_4 );
        ...
        if ( !isdefined( var_2 ) )
        {
            ...
            if ( isdefined( var_5.onenterbattlechatter ) )
                thread vehicle_occupancy_handleplayerbc( var_3, var_5, 1 );
        }
        else
        {
            ...
            if ( isdefined( var_5.onenterbattlechatter ) )
                thread vehicle_occupancy_handleplayerbc( var_3, var_5, 0 );
        }
    }
    else
    {
...
vehicle_occupancy_exitend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_4.success )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            vehicle_occupancy_updateriotshield( var_3, var_0, var_2 );
            vehicle_occupancy_showoccupant( var_0, var_1, var_3, var_4 );
            ...
            vehicle_occupancy_showcashbag( var_0, var_1, var_3, var_4 );
        }
    ...
    scripts\cp_mp\vehicles\vehicle_interact::vehicle_interact_updateusability( var_0 );
    var_5 = gettime();
    var_6 = vehicle_occupancy_getexitendcallbackforseat( var_0, var_1 );
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        if ( !isdefined( var_2 ) )
        {
            if ( isdefined( var_3.vehoccupancy_lastseatbc ) )
                var_3.vehoccupancy_lastseatbc = undefined;

            if ( isdefined( var_3.vehoccupancy_lastbctime ) )
                var_3.vehoccupancy_lastbctime = undefined;
        }
    }
}
...
vehicle_occupancy_handleplayerbc( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_2 ) )
    {
        var_0.vehoccupancy_lastseatbc = var_1.onenterbattlechatter;
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1.onenterbattlechatter, undefined, 1 );
        var_0.vehoccupancy_lastbctime = gettime();
    }
    else if ( isdefined( var_0.vehoccupancy_lastseatbc ) && isdefined( var_0.vehoccupancy_lastbctime ) && var_0.vehoccupancy_lastseatbc != var_1.onenterbattlechatter && gettime() - var_0.vehoccupancy_lastbctime > var_3 )
    {
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1.onenterbattlechatter );
        var_0.vehoccupancy_lastseatbc = var_1.onenterbattlechatter;
        var_0.vehoccupancy_lastbctime = gettime();
    }
}
...
{
    vehicle_occupancy_setfriendlystatusdirty( var_0 );
    var_0 scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_stopwatchingabandoned();
    var_2 setstance( "stand" );
    var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 0 );
    thread vehicle_occupancy_takeriotshield( var_2, var_0, var_1 );
...
vehicle_occupancy_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) )
    {
        ...
        if ( !istrue( var_3.playerdeath ) )
        {
            if ( istrue( var_3.playerlaststand ) )
                var_3.exittype = "DEATH";
            else if ( !isdefined( var_3.exittype ) )
                var_3.exittype = "VOLUNTARY";

            var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 1 );
            thread scripts\cp_mp\vehicles\vehicle::vehicle_preventcollisiondamagefortimeafterexit( var_0, var_2 );
        }
        else
            var_3.exittype = "DEATH";

        thread vehicle_occupancy_giveriotshield( var_2, var_3.playerdeath, var_3.playerlaststand );
    }
    else
        var_3.exittype = "DISCONNECT";

    vehicle_occupancy_setfriendlystatusdirty( var_0 );

    if ( scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_gamemodesupportsabandonedtimeout() && var_0.occupants.size == 0 )
        var_0 thread scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_watchabandoned();
    ...
    scripts\cp_mp\vehicles\vehicle_dlog::vehicle_dlog_exitevent( var_0, var_2, var_1, var_3.exittype );
}
...
vehicle_occupancy_hideoccupant( var_0, var_1, var_2, var_3 )
{
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "vehicle_occupancy", "hideOccupantModel" ) )
            [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "vehicle_occupancy", "hideOccupantModel" ) ]]( var_0, var_1, var_2, var_3 );

        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "vehicle_occupancy", "hideOccupantOutlineAndNamePlate" ) )
            [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "vehicle_occupancy", "hideOccupantOutlineAndNamePlate" ) ]]( var_0, var_1, var_2, var_3 );
    }
}

vehicle_occupancy_showoccupant( var_0, var_1, var_2, var_3 )
{
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) )
    {
        var_2.nocorpse = undefined;

        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "vehicle_occupancy", "showOccupantModel" ) )
            [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "vehicle_occupancy", "showOccupantModel" ) ]]( var_0, var_1, var_2, var_3 );

        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "vehicle_occupancy", "showOccupantOutlineAndNamePlate" ) )
            [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "vehicle_occupancy", "showOccupantOutlineAndNamePlate" ) ]]( var_0, var_1, var_2, var_3 );
    }
}
...
{
    thread vehicle_occupancy_monitorcontrols( var_0, var_1, var_2 );
    thread vehicle_occupancy_monitorseatswitch( var_0, var_1, var_2, 1 );
    thread vehicle_occupancy_monitorexit( var_0, var_1, var_2 );
    thread vehicle_occupancy_monitorgameended( var_0, var_1, var_2 );
}
...
vehicle_occupancy_monitorseatswitch( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !isbot( var_1 ) )
    {
        ...
        vehicle_occupancy_errormessage( var_1, 1 );
...
vehicle_occupancy_monitorexitinternal( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        while ( var_1 usebuttonpressed() )
        {
            ...
            if ( var_1 usinggamepad() && var_8 == 0 )
                var_1 setclientomnvar( "ui_veh_exit_button_holdtime", var_7 / 0.3 );

            if ( var_1 usinggamepad() && var_8 == 0 && var_7 > 0.3 || !var_1 usinggamepad() )
                return;
            else if ( var_1 usinggamepad() && var_8 > 0 && var_7 >= var_6 )
            {
...
vehicle_occupancy_errormessage( var_0, var_1 )
{
    var_2 = undefined;
...
vehicle_occupancy_monitorgameended( var_0, var_1, var_2 )
{
    var_1 endon( "death_or_disconnect" );
    var_1 endon( "last_stand_start" );
...
vehicle_occupancy_monitorcontrols( var_0, var_1, var_2 )
{
    var_1 endon( "death_or_disconnect" );
    var_1 endon( "last_stand_start" );
    var_0 endon( "death" );
    ...
    if ( scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_controlsarefadedoutorhidden( var_1 ) )
        return;

    if ( 1 )
        wait 1.5;

    childthread vehicle_occupancy_monitormovementcontrols( var_0, var_1, var_2 );
    childthread vehicle_occupancy_monitorturretcontrols( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( isdefined( var_3.monitorcontrolscallback ) )
        childthread [[ var_3.monitorcontrolscallback ]]( var_0, var_1, var_2, "vehicle_occupancy_monitorControls" );
}

vehicle_occupancy_fadeoutcontrols( var_0 )
{
    scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_fadeoutcontrols( var_0 );
    var_0 notify( "vehicle_occupancy_monitorControls" );
}

vehicle_occupancy_monitormovementcontrols( var_0, var_1, var_2 )
{
        ...
        if ( var_4 )
        {
            for (;;)
            {
                ...
                if ( abs( var_5 ) > 0 || abs( var_6 ) > 0 || abs( var_7 ) > 0 || abs( var_8 ) > 0 )
                    vehicle_occupancy_fadeoutcontrols( var_1 );
...
vehicle_occupancy_monitorturretcontrols( var_0, var_1, var_2 )
{
    var_3 = vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_2 );

    if ( isdefined( var_3.turretobjweapon ) )
    {
        var_4 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( var_0, var_3.turretobjweapon );
...
vehicle_occupancy_raceplayerdeathdisconnect( var_0, var_1 )
{
    ...
    var_2 = var_0 scripts\engine\utility::waittill_any_return_no_endon_death_3( "death", "disconnect", "last_stand_start" );
...
vehicle_occupancy_animateplayer( var_0, var_1, var_2, var_3 )
{
    thread vehicle_occupancy_stopanimatingplayer();
    self endon( "vehicle_occupancy_stopAnimatingPlayer" );
    var_4 = vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_1 );

    if ( !isdefined( var_4.animtag ) )
        return;

    var_5 = spawn( "script_model", var_0 gettagorigin( var_4.animtag ) );
    var_5.angles = var_0 gettagangles( var_4.animtag );
    var_5 linkto( var_0, var_4.animtag, ( 0, 0, 0 ), ( 0, 0, 0 ) );
    var_5 setmodel( "viewhands_base_iw8" );
    var_5 hide();
    self.animrig = var_5;
    self animscriptentervehicle();

    if ( tolower( var_4.animtag ) == "tag_seat_0" )
    {
    ...
    {
        if ( istrue( var_4.hidestowedweapon ) )
            self vehicle_setstowedweaponvisibility( 0 );

        if ( istrue( var_4.hideheldweapon ) )
            self vehicle_setheldweaponvisibility( 0 );
    }

    if ( !isdefined( var_4.turretobjweapon ) )
    {
        if ( !isdefined( var_2 ) )
            self setplayerangles( var_5.angles * ( 0, 1, 0 ) );
        else if ( tolower( var_4.animtag ) == "tag_seat_0" )
            self setplayerangles( var_5.angles * ( 0, 1, 0 ) );
    }
    ...
    else if ( var_4.viewclamps.size > 0 )
        self playerlinktodelta( var_5, "tag_player", 0, var_4.viewclamps["right"], var_4.viewclamps["left"], var_4.viewclamps["top"], var_4.viewclamps["bottom"], 0, 1, 0 );
    else
        self playerlinktodelta( var_5, "tag_player", 0, 180, 180, 180, 180, 0, 1, 0 );

    var_7 = vehicle_occupancy_getanimbasename( var_0.vehiclename, var_1 );

    if ( vehicle_occupancy_checkvalidanimtype( var_7, var_3 ) )
    {
        self.animname = var_7;
        var_5.animname = var_7;
        var_5 useanimtree( level.scr_animtree[var_7] );
        vehicle_occupancy_watchplayeranimate( var_0, var_3, var_4.animtag );
    }
    else
...
vehicle_occupancy_clearallowmovementplayer( var_0, var_1 )
{
...
vehicle_occupancy_getexitangles( var_0, var_1, var_2, var_3 )
{
    var_4 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );
    var_5 = vehicle_occupancy_getexitboundinginfo( var_0 );
    var_6 = var_5.exitpositions[var_2];
    var_7 = undefined;
    var_8 = 0;

    if ( istrue( var_3 ) )
    {
        var_7 = var_0.origin + rotatevector( var_4.exitoffsets[var_2], var_0.angles );
        var_8 = 1;
    }
    ...
    if ( !var_8 )
    {
        ...
        var_12 = physics_raycast( var_9, var_9 + var_10 * 300, var_11, undefined, 0, "physicsquery_closest", 1 );
        ...
        if ( isdefined( var_12 ) && var_12.size > 0 )
        {
            ...
            if ( isdefined( var_13 ) )
            {
                var_15 = var_0 getlinkedchildren( 1 );
            ...
            if ( var_14 )
            {
                var_19 = var_4.exitdirections[var_2];
...
vehicle_occupancy_giveturret( var_0, var_1, var_2, var_3 )
{
    ...
    {
        thread vehicle_occupancy_forceweaponswitchallowed( var_0, var_2 );
...
vehicle_occupancy_taketurret( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_0 hasweapon( var_2 ) )
    {
        ...
        {
            var_0 scripts\cp_mp\utility\inventory_utility::abortmonitoredweaponswitch( makeweapon( var_2 ) );
            var_5 = 1;
        }
        else
        {
            var_6 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( var_1, var_2 );

            if ( isdefined( var_6 ) )
                var_0 controlturretoff( var_6 );

            if ( var_0 hasweapon( var_2 ) )
            {
                var_7 = var_0 scripts\cp_mp\utility\inventory_utility::iscurrentweapon( var_2 );
...
vehicle_occupancy_forceweaponswitchallowed( var_0, var_1 )
{
...
vehicle_occupancy_takeriotshield( var_0, var_1, var_2 )
{
...
vehicle_occupancy_giveriotshield( var_0, var_1, var_2 )
{
...
vehicle_occupancy_updateriotshield( var_0, var_1, var_2 )
{
...
vehicle_occupancy_hidecashbag( var_0, var_1, var_2, var_3 )
{
...
vehicle_occupancy_showcashbag( var_0, var_1, var_2, var_3 )
{
...
vehicle_occupancy_assignseatcorpse( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_3 )
        var_0.dontdeleteonseatenter = 1;
}

vehicle_occupancy_clearseatcorpse( var_0, var_1, var_2 )
{
    if ( isdefined( var_1.corpses ) && isdefined( var_1.corpses[var_2] ) )
        var_1.corpses[var_2] = undefined;

    var_0.dontdeleteonseatenter = undefined;
}
...
vehicle_occupancy_deleteseatcorpse( var_0, var_1, var_2 )
{
    if ( isdefined( var_0.corpses ) && isdefined( var_0.corpses[var_1] ) )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            if ( !istrue( var_3.dontdeleteonseatenter ) || !var_2 )
            {
...
vehicle_occupancy_allowspawninto( var_0, var_1 )
{
    ...
    else
    {
        if ( var_1 )
        {
            var_0.preventspawninto--;
            return;
        }

        if ( !isdefined( var_0.preventspawninto ) )
            var_0.preventspawninto = 0;

        var_0.preventspawninto++;
    }
}

vehicle_occupancy_canspawninto( var_0 )
{
    if ( istrue( var_0.isdestroyed ) || !isdefined( var_0.occupants ) )
        return 0;

    if ( isdefined( var_0.preventspawninto ) && var_0.preventspawninto > 0 )
        return 0;
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( isdefined( var_6 ) && var_6 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            if ( isdefined( level.vehicleoccupantdeathcustomcallback ) )
                var_6 thread [[ level.vehicleoccupantdeathcustomcallback ]]();
