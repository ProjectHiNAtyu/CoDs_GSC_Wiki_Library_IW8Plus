...
hoopty_truck_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "hoopty_truck", 1 );
    var_0.id = 12;
...
hoopty_truck_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "hoopty_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty_truck" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "hoopty_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "hoopty_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "hoopty_truck", ::hoopty_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "hoopty_truck_mp", 3 );
}
