...
cop_car_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "cop_car", 1 );
    var_0.id = 6;
...
cop_car_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "cop_car", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cop_car" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "cop_car" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "cop_car", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "cop_car", ::cop_car_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "cop_car_mp", 3 );
}
