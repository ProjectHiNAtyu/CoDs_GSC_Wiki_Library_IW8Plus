...
infil_init()
{
    ...
    if ( game["roundsPlayed"] > 0 || getdvarint( "scr_skip_infils", 0 ) == 1 || getdvarint( "scr_game_infilSkip", 0 ) == 1 || scripts\mp\utility\game::getgametype() == "br" || getdvarint( "scr_game_matchstarttime" ) < 15 || scripts\mp\utility\game::getgametype() == "war" && level.script == "mp_donetsk" )
    {
        game["infil"] = undefined;
        scripts\mp\flags::gameflagset( "infil_setup_complete" );
        return;
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        var_0 thread waitforstreamsynccomplete();
    }
}
