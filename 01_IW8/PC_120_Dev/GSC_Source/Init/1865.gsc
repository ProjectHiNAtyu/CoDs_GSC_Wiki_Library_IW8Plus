...
javelin_holdstateupdate()
{
    ...
    if ( !var_0 && ( self.javelin.target scripts\cp_mp\vehicles\vehicle::isvehicle() && scripts\cp_mp\vehicles\vehicle::vehicle_isfriendlytoplayer( self.javelin.target, self ) ) )
    {
        javelin_queuestate( "scanning" );
        var_1 = 1;
    }
