...
incpersstat( var_0, var_1 )
{
    ...
    if ( isdefined( self.leaderboarddata[var_0] ) )
        self.leaderboarddata[var_0] = self.leaderboarddata[var_0] + var_1;

    incrementpersistentstat( self, var_0, var_1 );
}

initleaderboardstat( var_0 )
{
    if ( !isdefined( self.leaderboarddata[var_0] ) )
        self.leaderboarddata[var_0] = 0;
}
