...
light_tank_mp_initspawning()
{
    ...
    var_0.abandonedtimeoutcallback = scripts\cp_mp\vehicles\light_tank::light_tank_timeout;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
    {
        var_0.abandonedtimeoutdelay = 105;
        var_0.respawndelay = level.tankrespawntime;
    }
    else
        var_0.abandonedtimeoutdelay = 40;
}
...
light_tank_mp_createownercaptureobject( var_0, var_1 )
{
    var_2 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( var_0, "tur_bradley_mp" );
...
light_tank_mp_createothercaptureobject( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( var_0, "tur_bradley_mp" );
...
light_tank_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_waitandrespawn( "light_tank", var_1, var_2 );
    ...
    if ( isdefined( var_3 ) )
    {
        if ( scripts\mp\utility\game::getgametype() == "arm" )
        {
            ...
            if ( istrue( level.showteamtanks ) )
                scripts\mp\gametypes\arm::vehicle_createspawnselectiontankmarker( var_3, var_3.team );
