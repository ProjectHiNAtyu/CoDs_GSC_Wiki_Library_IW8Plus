...
vehicle_spawn_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) && istrue( var_1 ) )
    {
        ...
        var_3.timeoutonabandonedcallback = undefined;
        var_3.respawndelay = undefined;
        var_3.timeoutonabandoneddelay = undefined;
    }

    return var_3;
}

vehicle_spawn_canspawnvehicle( var_0, var_1, var_2 )
{
    var_3 = vehicle_spawn_getleveldata();

    if ( vehicle_spawn_getinstancecount() < var_3.maxinstancecount )
    {
        if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "vehicle_spawn", "canSpawnVehicle" ) ]]( var_0 ) )
        {
            if ( isdefined( var_0 ) )
            {
                if ( !scripts\cp_mp\vehicles\vehicle_tracking::vehicle_tracking_instancesarelimited( var_0 ) || !scripts\cp_mp\vehicles\vehicle_tracking::vehicle_tracking_atinstancelimit( var_0, var_1, var_2 ) )
                {
                    ...
                    if ( isdefined( var_4 ) )
                    {
                        if ( istrue( level.ignorevehicletypeinstancelimit ) || !isdefined( var_4.maxinstancecount ) || vehicle_spawn_getinstancecountforref( var_0 ) < var_4.maxinstancecount )
                        {
                            if ( isdefined( var_4.canspawncallback ) )
                                return [[ var_4.canspawncallback ]]( var_1, var_2 );
                            else
                                return 1;
                        }
                    }
...
vehicle_spawn_init()
{
    ...
    var_0.respawndelayoverride = getdvarint( "scr_respawnVehicleDelayOverride", 0 );
    var_0.abandonedtimeoutoverride = getdvarint( "scr_abandonedVehicleTimeoutOverride", 0 );
    var_0.respawndelay = getdvarint( "scr_respawnVehicleDelay", 60 );
    var_0.abandonedtimeoutdelay = getdvarint( "scr_abandonedVehicleTimeout", 30 );
...
vehicle_spawn_waitandrespawn( var_0, var_1, var_2 )
{
    ...
    if ( var_4.respawndelayoverride != 0 )
        var_5 = var_4.respawndelayoverride;
    else if ( isdefined( var_3.respawndelay ) )
        var_5 = var_3.respawndelay;
    else
        var_5 = var_4.respawndelay;
...
vehicle_spawn_preventrespawn( var_0 )
{
...
vehicle_spawn_watchabandoned()
{
    ...
    if ( !isdefined( var_0.abandonedtimeoutcallback ) )
        return;
    ...
    if ( var_1.abandonedtimeoutoverride != 0 )
        var_2 = var_1.abandonedtimeoutoverride;
    else if ( isdefined( var_0.abandonedtimeoutdelay ) )
        var_2 = var_0.abandonedtimeoutdelay;
    else
        var_2 = var_1.abandonedtimeoutdelay;
...
vehicle_spawn_abandonedtimeout()
{
    ...
    var_0 = vehicle_spawn_getleveldataforvehicle( self.vehiclename );
    self thread [[ var_0.abandonedtimeoutcallback ]]();
}

vehicle_spawn_abandonedtimeoutcallback()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getstate();
    ...
    if ( var_0 != "heavy" )
    {
        ...
        scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setstate( "heavy", var_0 );
    }
}
