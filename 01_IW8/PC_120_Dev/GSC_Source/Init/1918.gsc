...
lifelimitedallyonuse( var_0 )
{
    ...
    if ( isdefined( self.victim ) )
    {
        ...
        if ( !level.gameended )
        {
            self.victim scripts\mp\utility\player::_freezecontrols( 0 );
        ...
        scripts\cp_mp\challenges::onplayerteamrevive( var_0, self.victim );
    }
...
revivetriggerholdonusebegin( var_0, var_1 )
{
    ...
    var_2 scripts\mp\playerlogic::setbeingrevivedinternal( 1 );
    ...
    var_2 scripts\mp\utility\player::printspawnmessage( "teamrevive::reviveTriggerHoldOnUseBegin() Killcam SKIPPED" );
    ...
    if ( isdefined( level.revivetriggers[var_2.guid].headicondeath ) )
    {
        ...
        setheadiconfriendlyimage( level.revivetriggers[var_2.guid].headicondeath, var_8 );
    }
...
revivetriggerholdonuseend( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( self.trigger.owner ) )
    {
        ...
        var_4 scripts\mp\playerlogic::setbeingrevivedinternal( 0 );
        ...
        else
        {
            ...
            if ( isdefined( level.revivetriggers[var_4.guid].headicondeath ) )
                setheadiconfriendlyimage( level.revivetriggers[var_4.guid].headicondeath, var_7 );
...
addtriggerdeathicon( var_0, var_1, var_2 )
{
    ...
    {
        setheadiconenemyimage( var_0.headicondeath, "hud_icon_death_hunter_spawn" );

        foreach ( var_9 in level.teamnamelist )
            addteamtoheadiconmask( var_0.headicondeath, var_9 );
    }
}
