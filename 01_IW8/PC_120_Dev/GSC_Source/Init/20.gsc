    ...
    foreach ( var_1 in level.players )
    {
        if ( isbot( var_1 ) )
        {
            if ( isalive( var_1 ) )
            {
                ...
                var_1.bot_spawned_this_round = 1;
    ...
    for (;;)
    {
        ...
        if ( var_46 )
        {
            ...
            if ( var_45 > 0 && var_44 > 0 )
                level scripts\engine\utility::waittill_2( "spawned_enemies", "spawned_allies" );
            else if ( var_45 > 0 )
                level waittill( "spawned_enemies" );
            else if ( var_44 > 0 )
...
bot_think()
{
    ...
    for (;;)
    {
        ...
        scripts\mp\bots\bots_loadout::bot_modify_behavior_from_loadout();
...
bot_crate_valid( var_0 )
{
    ...
    else if ( bot_has_streak_in_crate( var_0 ) )
        return 0;
...
{
    if ( getcompleteweaponname( self getcurrentweapon() ) == level.boxsettings[var_0.boxtype].minigunweapon )
        return 0;
...
bot_think_crate_blocking_path()
{
    ...
    for (;;)
    {
        ...
        for ( var_2 = 0; var_2 < var_1.size; var_2++ )
        {
            ...
            {
                if ( !bot_has_streak_in_crate( var_3 ) )
                {
...
handle_smoke()
{
    ...
    thread create_smoke_occluder( var_0 );
}
