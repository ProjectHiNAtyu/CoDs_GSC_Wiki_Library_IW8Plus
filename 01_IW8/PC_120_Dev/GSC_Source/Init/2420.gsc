...
getweapongroup( var_0 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        if ( issuperweapon( var_0 ) )
            ...
            var_2 = "gamemode";
        else if ( iscrossbowspecial( var_0 ) )
            var_2 = "weapon_crossbowSpecial";
        else if ( isdragonsbreath( var_0 ) )
...
getallselectableattachments( var_0 )
{
    var_1 = getweaponrootname( var_0 );
...
attachmentsconflict( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _attachmentblocks( var_3, var_4 ) )
        return var_0;

    if ( _attachmentblocks( var_4, var_3 ) )
        return var_0;
...
_attachmentblocks( var_0, var_1 )
{
    var_2 = attachmentmap_tocategory( var_0 );
    var_3 = attachmentmap_toblocks( var_1 );
...
getdefaultweaponbasename( var_0 )
{
    var_1 = getweaponrootname( var_0 );
...
ispickedupweapon( var_0 )
{
    if ( iscacprimaryorsecondary( var_0 ) )
    {
        ...
        if ( isweapon( var_0 ) )
            var_1 = getcompleteweaponname( var_0 getnoaltweapon() );
...
{
    return iscacprimaryweapongroup( getweapongroup( var_0 ), var_0 );
}

iscacprimaryweapongroup( var_0, var_1 )
{
    switch ( var_0 )
    {
        case "weapon_melee":
...
{
    return iscacsecondaryweapongroup( getweapongroup( var_0 ), var_0 );
}

iscacsecondaryweapongroup( var_0, var_1 )
{
    switch ( var_0 )
    {
...
iscacprimaryorsecondary( var_0 )
{
    ...
    return iscacprimaryweapongroup( var_1, var_0 ) || iscacsecondaryweapongroup( var_1, var_0 );
}
...
{
    if ( isdefined( level.attachmentmap_attachtoblocks[var_0] ) )
        return level.attachmentmap_attachtoblocks[var_0];

    return undefined;
}

attachmentmap_tocategory( var_0 )
{
    if ( isdefined( level.attachmentmap_uniqueattachtocategory[var_0] ) )
        return level.attachmentmap_uniqueattachtocategory[var_0];

    var_1 = attachmentmap_tobase( var_0 );

    if ( isdefined( level.attachmentmap_baseattachtocategory[var_1] ) )
        return level.attachmentmap_baseattachtocategory[var_1];
...
{
    var_1 = randomintrange( 0, level.weapongroupdata[var_0].size );
    return level.weapongroupdata[var_0][var_1];
}
...
getweaponvariantids( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( !level.weaponlootmapdata[var_4].islocked && !scripts\engine\utility::array_contains( var_1, var_2 ) )
...
getweaponrandomvariantid( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = [];

    var_2 = 0;
    var_3 = getweaponvariantids( var_0, var_1 );
...
getopticattachmentlistbasenames()
{
    ...
    level.opticattachmentbasenames = var_0;
    return level.opticattachmentbasenames;
}
    ...
    if ( var_3.basename != "none" )
    {
        if ( isdefined( var_1 ) && !isplayer( var_1 ) )
        {
            ...
            if ( isdefined( var_5 ) )
            {
                ...
                {
                    case "glconc":
                        var_3 = makeweapon( "concussion_grenade_mp" );
                        break;
                    case "glflash":
...
attachmentlogsstats( var_0, var_1 )
{
    ...
    if ( !attachmentisselectable( var_1, var_0 ) )
        return 0;
...
getgrenadeinpullback()
{
    ...
    if ( isdefined( self.gestureweapon ) && var_0 == makeweaponfromstring( self.gestureweapon ) )
        var_0 = nullweapon();
...
attachmentisselectable( var_0, var_1 )
{
    var_2 = getweaponrootname( var_0 );
    return attachmentisselectablerootname( var_2, var_1 );
}

attachmentisselectablerootname( var_0, var_1 )
{
    var_2 = level.weaponattachments[var_0];
    return isdefined( var_2 ) && isdefined( var_2[var_1] );
}

remapattachmentparentname( var_0 )
{
    switch ( var_0 )
    {
        case "laserads":
...
iskillstreakvehicleinflictor( var_0 )
{
...
weaponbypassspawnprotection( var_0 )
{
    ...
    if ( iskillstreakweapon( var_0 ) && var_2 != "manual_turret_mp" && var_2 != "pac_sentry_turret_mp" && var_2 != "iw8_minigunksjugg_mp" )
        var_1 = 0;
...
ismeleedefaultweapon( var_0 )
{
    return var_0.basename == "iw8_knifestab_mp";
}
...
isspecialmeleeweapon( var_0 )
{
    ...
    return var_1 == "iw8_fists_mp_ls" || var_1 == "iw8_knifestab_mp";
}

isgunlessweapon( var_0 )
{
    var_1 = undefined;
