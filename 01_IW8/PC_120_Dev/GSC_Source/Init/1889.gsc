...
updateweaponbufferedstats()
{
    ...
    {
        var_2 = scripts\mp\utility\weapon::attachmentmap_tobase( var_0.underbarrel );
        ...
        {
            var_1 = var_2;
            perslog_attachmentstats( var_1, var_0 );
            persclear_stats();
            return;
        }
    }
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        var_4 = getsubstr( var_3, 0, 4 );

        if ( var_4 == "iw8_" )
            var_1 = scripts\mp\utility\weapon::getweaponrootname( var_0 );
    }

    if ( !scripts\mp\utility\weapon::iscacprimaryweapon( var_1 ) && !scripts\mp\utility\weapon::iscacsecondaryweapon( var_1 ) )
        return;

    var_5 = getweaponvariantindex( var_0 );
    persincrement_weaponstats( var_1, var_5 );

    if ( !scripts\mp\utility\weapon::ispickedupweapon( var_0 ) )
        perslog_weaponstats( var_1, var_5 );

    var_6 = getweaponattachments( var_0 );

    foreach ( var_2 in var_6 )
    {
        var_8 = scripts\mp\utility\weapon::attachmentmap_tobase( var_2 );

        if ( !scripts\mp\utility\weapon::attachmentlogsstats( var_8, var_0 ) )
            continue;
        ...
        perslog_attachmentstats( var_8, var_0 );
    }
...
{
    if ( self.trackingweaponshots > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "shots", self.trackingweaponshots, var_1 );

    if ( self.trackingweaponkills > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "kills", self.trackingweaponkills, var_1 );

    if ( self.trackingweaponhits > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "hits", self.trackingweaponhits, var_1 );

    if ( self.trackingweaponheadshots > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "headshots", self.trackingweaponheadshots, var_1 );

    if ( self.trackingweapondeaths > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "deaths", self.trackingweapondeaths, var_1 );
}
...
perslog_attachmentstats( var_0, var_1 )
{
    ...
    if ( self.trackingweaponshots > 0 && var_0 != "tactical" )
    {
        ...
        scripts\common\utility::trycall( level.matchdata_logattachmentstat, var_0, "shots", self.trackingweaponshots, var_1 );
    }

    if ( self.trackingweaponkills > 0 && var_0 != "tactical" )
    {
        incrementattachmentstat( var_0, "kills", self.trackingweaponkills, var_1 );
        scripts\common\utility::trycall( level.matchdata_logattachmentstat, var_0, "kills", self.trackingweaponkills, var_1 );
    }

    if ( self.trackingweaponhits > 0 && var_0 != "tactical" )
    {
        incrementattachmentstat( var_0, "hits", self.trackingweaponhits, var_1 );
        scripts\common\utility::trycall( level.matchdata_logattachmentstat, var_0, "hits", self.trackingweaponhits, var_1 );
    }
    ...
    if ( self.trackingweaponheadshots > 0 && var_0 != "tactical" )
    {
        ...
        scripts\common\utility::trycall( level.matchdata_logattachmentstat, var_0, "headShots", self.trackingweaponheadshots, var_1 );
    }

    if ( self.trackingweapondeaths > 0 )
    {
        incrementattachmentstat( var_0, "deaths", self.trackingweapondeaths, var_1 );
        scripts\common\utility::trycall( level.matchdata_logattachmentstat, var_0, "deaths", self.trackingweapondeaths, var_1 );
    }
}
