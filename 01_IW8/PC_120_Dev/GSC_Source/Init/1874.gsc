...
init()
{
    ...
    level.matchdata_logplayerlife = ::logplayerlife;
    level.matchdata_logplayerdeath = ::logplayerdeath;
    level.matchdata_logplayerdata = ::logplayerdata;
    level.matchdata_logscoreevent = ::logscoreevent;
    level.matchdata_recordrecentlyplayeddata = ::recordrecentlyplayeddata;
    level.matchdata_logweaponstat = ::logweaponstat;
...
onmatchstart()
{
    ...
    dlog_recordevent( "dlog_event_server_match_start", [ "map", level.script, "game_type", var_0, "is_playtest", var_2, "experiment_name", var_3, "dedi_server_guid", getdediserverguid(), "sub_game_type", var_1 ] );
...
loggameevent( var_0, var_1 )
{
    ...
    dlog_recordevent( "dlog_event_game_event", [ "event_player", var_2, "event_name", var_0, "time_from_match_start_ms", var_6, "player_life_index", var_3, "pos_x", var_1[0], "pos_y", var_1[1], "pos_z", var_1[2] ] );
}
...
logplayerdeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isvalidclient( var_1 ) )
    {
        ...
        var_22 = var_1 mountstringtodlogenum();
        var_23 = var_1.origin;
        var_24 = var_1.angles;
    ...
    if ( isvalidclient( var_1 ) )
    {
        logtournamentdeath( self getxuid(), var_1 getxuid(), var_4, var_3 == "MOD_HEAD_SHOT" );
...
logplayermatchend( var_0 )
{
    ...
    if ( scripts\mp\utility\game::rankingenabled() && self hasplayerdata() )
    {
        ...
        var_22 = self getplayerdata( "rankedloadouts", "squadMembers", "season_rank" );
        var_23 = self getplayerdata( "rankedloadouts", "squadMembers", "season_rank" );
    }
    else
    {
        var_12 = 0;
    ...
    if ( isdefined( self.segments ) && self.segments["movementUpdateCount"] >= 30 )
    {
        ...
        var_28 = self.segments["distanceTotal"] / self.segments["movementUpdateCount"];
    }
    else
    {
        var_28 = 0.0;
    ...
    if ( isdefined( self.pers["utc_connect_time_s"] ) )
        var_29 = self.pers["utc_connect_time_s"];

    var_30 = 0.0;

    if ( isdefined( self.pers["totalDistTraveled"] ) )
        var_30 = float( self.pers["totalDistTraveled"] );

    var_31 = 0.0;

    if ( isdefined( self.pers["shotsFired"] ) && isdefined( self.pers["shotsHit"] ) )
    {
        var_32 = scripts\mp\utility\stats::getpersstat( "shotsFired" );

        if ( var_32 > 0 )
            var_31 = float( scripts\mp\utility\stats::getpersstat( "shotsHit" ) / var_32 * 100 );
    }

    var_33 = 0;

    if ( isdefined( self.pers["suicides"] ) )
        var_33 = scripts\mp\utility\stats::getpersstat( "suicides" );

    var_34 = [];
    var_34["press_rclick"] = 0;
    var_34["press_lclick"] = 0;
    var_34["press_activate"] = 0;
    var_34["press_gostand"] = 0;

    if ( scripts\mp\utility\game::getgametype() == "arm" && isdefined( self.gwinputtypesused ) )
    {
        var_34["press_rclick"] = istrue( self.gwinputtypesused["rightmouseup"] );
        var_34["press_lclick"] = istrue( self.gwinputtypesused["leftmouseup"] );
        var_34["press_activate"] = istrue( self.gwinputtypesused["activate"] );
        var_34["press_gostand"] = istrue( self.gwinputtypesused["gostand"] );
    }

    self dlog_recordplayerevent( "dlog_event_player_match_end", [ "utc_connect_time_s", var_29, "utc_disconnect_time_s", getsystemtime(), "score", scripts\mp\utility\stats::getpersstat( "score" ), "assists", scripts\mp\utility\stats::getpersstat( "assists" ), "longest_streak", scripts\mp\utility\stats::getpersstat( "longestStreak" ), "kills", scripts\mp\utility\stats::getpersstat( "kills" ), "deaths", scripts\mp\utility\stats::getpersstat( "deaths" ), "headshots", scripts\mp\utility\stats::getpersstat( "headshots" ), "executions", scripts\mp\utility\stats::getpersstat( "executions" ), "player_xp_modifier", int( scripts\mp\rank::getrankxpmultiplier() ), "team_xp_modifier", var_2, "weapon_xp_modifier", int( scripts\mp\weaponrank::getweaponrankxpmultiplier() ), "total_xp", var_3, "score_xp", var_4, "challenge_xp", var_5, "match_xp", var_6, "medal_xp", var_7, "bonus_xp", var_8, "misc_xp", var_9, "rank", var_11, "season_rank", var_23, "end_xp", var_12, "end_kills", var_13, "end_deaths", var_14, "end_wins", var_15, "end_losses", var_16, "end_hits", var_17, "end_misses", var_18, "end_games_played", var_19, "end_time_played_total", var_20, "end_score", var_21, "end_prestige", var_22, "disconnect_reason", var_1, "player_quit_round_number", var_24, "player_quit_team_score", var_25, "player_quit_opposing_team_score", var_26, "average_speed_during_match", var_28, "percent_time_moving", var_27, "damage_done", scripts\mp\utility\stats::getpersstat( "damage" ), "damage_taken", scripts\mp\utility\stats::getpersstat( "damageTaken" ), "distance_traveled", var_30, "weapon_accuracy", var_31, "suicides", var_33, "game_type", scripts\mp\utility\game::getgametype(), "gw_spawn_method_press_activate", var_34["press_activate"], "gw_spawn_method_press_gostand", var_34["press_gostand"], "gw_spawn_method_press_lclick", var_34["press_lclick"], "gw_spawn_method_press_rclick", var_34["press_rclick"], "is_headless", self scriptablegetmidpoint(), "was_keyboardmouse", self getplayergpadenabled() != 1 ] );
}
...
logplayerdata( var_0 )
{
    ...
    {
        var_2 = scripts\mp\rank::ctgs_buildstatstrackerstruct( self );
        scripts\mp\rank::ctgs_comparestats( self.ctgs_statstracker, var_2 );
    }
    ...
    foreach ( var_19, var_6 in self.pers["matchdataWeaponStats"] )
    {
        var_7 = 0;
        var_8 = 0;
        var_9 = 0;
        ...
        if ( scripts\mp\utility\game::getgametype() != "br" )
        {
            if ( isenumvaluevalid( "common", "LoadoutWeapon", var_6.weapon ) )
                var_7 = self getplayerdata( "rankedloadouts", "squadMembers", "weapon_xp", var_6.weapon );
        }
