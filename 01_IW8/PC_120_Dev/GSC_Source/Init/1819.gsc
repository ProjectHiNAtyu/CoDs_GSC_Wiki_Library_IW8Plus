...
init()
{
    ...
    if ( scripts\mp\utility\game::getgametype() != "infect" )
    {
        ...
        registerbcsoundtype( "ping_vehicle_driver", "ping_vehicle_driver", 1.0, 1.0, 0, 0, 0, 0, 1, 1 );
        registerbcsoundtype( "ping_vehicle_gunner", "ping_vehicle_gunner", 1.0, 1.0, 0, 0, 0, 0, 1, 1 );
        ...
        registerbcsoundtype( "ping_vehicle_pilot", "ping_vehicle_pilot", 1.0, 1.0, 0, 0, 0, 0, 1, 1 );
        registerbcsoundtype( "ping_vehicle_rider", "ping_vehicle_rider", 1.0, 1.0, 0, 0, 0, 0, 1, 1 );
...
registerbcsoundtype( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    if ( !isdefined( var_6 ) )
        var_6 = 1;
...
playkillstreakdeploydialog( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        return;
...
threatcallouttracking()
{
    ...
    for (;;)
    {
        ...
        var_4 = get_last_callout_time( self.team );
...
dosound( var_0, var_1 )
{
    ...
    if ( var_0 == "flavor_execution" )
    {
        ...
        var_2 = var_2 + self.operatorcustomization.executionquip;
    }
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() )
        playbattlechattersoundexpensive( var_6, var_7, var_0, var_5, var_4 );
    else if ( self issplitscreenplayer() )
        playbattlechattersoundsplitscreen( var_6, var_7, var_0, var_5, var_4 );
    else
        playbattlechattersound( var_6, var_7, var_0, var_5, var_4 );

    if ( isdefined( var_1 ) )
        location_add_last_callout_time( var_1, self.team );

    var_10 = level.bcinfo["priority"][var_0];
    var_11 = self.team;
    level addspeaker( self, var_11, var_4, var_0, var_10 );
    updatechatter( var_0 );
    var_12 = max( var_8, var_9 ) / 1000;
    thread timehack( var_4, var_12 );
    scripts\engine\utility::waittill_any_2( var_4, "death_or_disconnect" );
    level removespeaker( self, var_11 );
    return 1;
}

playbattlechattersound( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_0 )
    {
        ...
        else if ( level.bcinfo["play_for_squad_only"][var_2] && isdefined( level.squaddata ) )
        {
            if ( isdefined( self.team ) && isdefined( self.squadindex ) && isdefined( level.squaddata[self.team][self.squadindex] ) )
            {
                ...
                foreach ( var_10 in var_8 )
                {
                    ...
                    var_10 playsoundtoplayer( var_4, var_10 );
                }
            }
        }
...
playbattlechattersoundexpensive( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = [];
...
playbattlechattersoundsplitscreen( var_0, var_1, var_2, var_3, var_4 )
{
...
{
    var_2 = scripts\engine\utility::waittill_any_return_2( var_0, "death_or_disconnect" );
...
location_add_last_callout_time( var_0, var_1 )
{
    ...
    level.lastlocationcallouttime[var_1] = var_2;
}
...
get_last_callout_time( var_0 )
{
    if ( isdefined( level.lastlocationcallouttime ) && isdefined( level.lastlocationcallouttime[var_0] ) )
        return level.lastlocationcallouttime[var_0];
...
trysaylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.bcinfo["req_friendly"][var_1] && !var_0 friendly_nearby( 4840000 ) && !istrue( level.br_practice_match ) )
        return;
