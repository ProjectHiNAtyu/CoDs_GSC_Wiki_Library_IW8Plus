...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( level.modeplayerskipdialog ) && self [[ level.modeplayerskipdialog ]]( var_0 ) )
        return;
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public::brgetoperatorteam( self );
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public::brgetoperatorteam( self );
    ...
    if ( level.teambased )
    {
        var_5 = canplaykillstreakdialog( var_0, 1 );
        var_6 = canplaykillstreakdialog( var_0 );
