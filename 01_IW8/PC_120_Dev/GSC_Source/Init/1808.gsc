...
getaccessorylogicbyindex( var_0 )
{
    if ( isdefined( level.accessorylogicbyindex ) )
        return level.accessorylogicbyindex[var_0];
...
giveplayeraccessory( var_0, var_1, var_2 )
{
    ...
    var_3 = getoperatorspecificaccessoryweapon( var_1 );
    ...
    var_4 = shouldoperatorhideaccessoryworldmodel();
...
getoperatorspecificaccessoryweapon( var_0 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        {
            case "fem":
                var_4 = level.accessoryfem[var_0];
                var_5 = level.accessoryattachmentfem[var_0];
                ...
                break;
            case "big":
                var_6 = level.accessorybig[var_0];
...
initthermometerwatch()
{
    if ( !isdefined( self.thermometerwatch ) )
    {
        ...
        var_0 = getmapbaselinetempurature();
