...
startchoppergunnerintro( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\killstreak_utility::getkillstreakairstrikeheightent();
    var_4 = ( 0, 0, 0 );
    ...
    else if ( istrue( var_0.infinite_chopper ) && level.script == "cp_so_aniyah" )
    {
        ...
        var_20 = scripts\engine\utility::getclosest( var_19, level.objective_locations );
    ...
    if ( istrue( var_0.infinite_chopper ) && level.script == "cp_so_aniyah" )
    ...
    var_24.infinite_chopper = istrue( var_0.infinite_chopper );
    var_24 setvehicleteam( var_24.team );
    var_24 thread choppergunner_watchintrodisown( "disconnect", var_1 );
    var_24 thread choppergunner_watchintrodisown( "joined_team", var_1 );
    var_24 thread choppergunner_watchintrodisown( "joined_spectator", var_1 );
    var_27 = 2000;
    ...
    var_29 = var_24 choppergunner_waitintroanimtime( 4.25 );
...
choppergunner_handledangerzone( var_0 )
{
    self endon( "leaving" );
    self endon( "crashing" );
    self endon( "death" );
    ...
    if ( isdefined( var_1 ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "spawn", "getCodeHandleFromScriptHandle" ) )
    {
        ...
        for (;;)
        {
            ...
            if ( var_12["hittype"] != "hittype_none" )
                spawninfluencepointsetposition( var_11, var_12["position"] );
...
choppergunner_handlemissilefire( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self.infinite_chopper && self.missilesleft == 8 )
        ...
        var_17 thread choppergunner_watchexplosioninfluencepoint( self.owner, 2, 300, 300 );
...
choppergunner_watchturretfire( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.streakinfo.shots_fired++;
        var_1 thread choppergunner_watchexplosioninfluencepoint( self.owner, 0.5, 256, 200 );
    }
}
...
choppergunner_returnplayer( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            level thread scripts\cp_mp\utility\killstreak_utility::restorekillstreakplayerangles( var_2 );
            var_2 setclientomnvar( "ui_apache_screens_state", 0 );
            var_2 painvisionon();
            var_2 scripts\cp_mp\utility\killstreak_utility::killstreak_restorenvgstate();
...
choppergunner_watchexplosioninfluencepoint( var_0, var_1, var_2, var_3 )
{
    level endon( "game_ended" );
