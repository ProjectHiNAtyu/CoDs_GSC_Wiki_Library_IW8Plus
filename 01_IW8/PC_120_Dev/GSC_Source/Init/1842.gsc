...
equipmentscriptableused( var_0, var_1, var_2, var_3, var_4 )
{
    equipmentuse( var_0.entity, var_3 );
}

equipmentuse( var_0, var_1 )
{
    var_2 = var_0;
    var_2.isbeingused = 1;
...
_deployhacktablet( var_0, var_1 )
{
    ...
    var_4 = scripts\cp_mp\killstreaks\killstreakdeploy::switchtodeployweapon( var_2, var_3, ::_waituntilinteractfinished, ::_ontabletgiven, undefined, undefined, ::_ontabletputaway );
...
_ontabletgiven( var_0, var_1 )
{
    _toggletabletallows( 1 );
    thread _cleanuptabletallows();
    thread _cancelputawayonuseend( var_0 );
    return 1;
}

_cancelputawayonuseend( var_0 )
{
    level endon( "game_ended" );
    self endon( "death_or_disconnect" );
