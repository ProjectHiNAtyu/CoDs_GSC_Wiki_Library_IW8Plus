...
{
    foreach ( var_5, var_1 in level.accolades )
    {
        self setplayerdata( "mp", "playerStats", "matchAccolades", var_5, 0 );

        if ( !isdefined( var_1.datapoints ) )
            continue;

        foreach ( var_3 in var_1.datapoints )
            scripts\mp\utility\stats::initpersstat( var_3 );
    }
}
