...
addtoteamlives( var_0, var_1, var_2 )
{
    ...
    validatealivecount( "add", var_1, var_0 );
...
removefromteamlives( var_0, var_1, var_2 )
{
    ...
    validatealivecount( "remove", var_1, var_0 );
...
validatealivecount( var_0, var_1, var_2 )
{
    ...
    if ( var_7 != var_8 || var_4 || var_5 )
    {
        ...
        dlog_recordevent( "dlog_event_alive_count_mismatch", [ "alive_players", var_7, "alive_count", var_8, "event", var_0, "team", var_1, "player_xuid", var_2 getxuid(), "player_name", var_2.name ] );
        scripts\mp\utility\script::demoforcesre( var_9 );
