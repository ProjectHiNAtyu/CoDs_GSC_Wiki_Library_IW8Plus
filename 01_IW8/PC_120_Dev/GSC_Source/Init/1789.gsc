...
init( var_0 )
{
    ...
    {
        if ( var_1 )
            level.gasmask_resist = getdvarfloat( "scr_br_gasMask_resist", 0 );
        else
            level.gasmask_resist = 0.2;
    }

    self.gasmaskhealth = var_2;
    ...
    level.gasmaskmaxhealth = var_2;
    self setclientomnvar( "ui_head_equip_class", 2 );
    self setclientomnvar( "ui_gasmask_damage", self.gasmaskhealth / var_2 );
}

processdamage( var_0 )
{
    var_1 = scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) && [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() == "br";
    var_2 = self.gasmaskhealth / level.gasmaskmaxhealth;
    self.gasmaskhealth = self.gasmaskhealth - var_0;
    self.gasmaskhealth = max( 0, self.gasmaskhealth );

    if ( var_1 )
        var_3 = ( self.gasmaskhealth + 1 ) / level.gasmaskmaxhealth;
    else
        var_3 = self.gasmaskhealth / level.gasmaskmaxhealth;
    ...
    self.gasdamagebuffer = self.gasdamagebuffer + var_0 * level.gasmask_resist;
...
didgasmaskpipschange( var_0, var_1 )
{
    ...
    if ( !isdefined( level.gasmaskmaxhealth ) )
        level.gasmaskmaxhealth = getdvarint( "scr_br_gasMask_health", 108 );

    var_3 = var_0 / level.gasmaskmaxhealth;
    var_4 = var_1 / level.gasmaskmaxhealth;
    var_5 = floor( var_3 * 6 + 0.5 );
