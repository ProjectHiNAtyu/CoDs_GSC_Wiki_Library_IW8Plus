...
hoopty_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "hoopty", 1 );
    var_0.id = 9;
...
hoopty_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "hoopty", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "hoopty" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "hoopty", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "hoopty", ::hoopty_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "hoopty_mp", 3 );
}
