...
default_on_damage_finished( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    self finishagentdamage( var_0, var_1, var_2, var_3, var_4, var_14, var_6, var_7, var_8, var_9, 0.0, var_11, var_12 );
    ...
    if ( isalive( self ) )
    {
        ...
        {
            var_15 = level.agent_funcs[self.unittype]["gametype_on_damage_finished"];
        ...
        {
            var_15 = level.agent_funcs[self.agent_type]["gametype_on_damage_finished"];
...
ai_washitbyvehicle( var_0, var_1 )
{
    if ( var_0 != "MOD_CRUSH" )
        return 0;
...
{
    var_10 = ai_washitbyvehicle( var_3, var_0 );
