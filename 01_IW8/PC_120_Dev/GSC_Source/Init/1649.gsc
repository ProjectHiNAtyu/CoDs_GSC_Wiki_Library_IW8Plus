...
shouldburnfromdamage( var_0 )
{
    if ( var_0.basename == "molotov" || var_0.basename == "molotov_mp" || istrue( var_0.isdragonsbreath ) )
        return 1;
...
allow_init()
{
    ...
    allow_add( "offhand_throwback", ::allow_offhand_throwback );
    ...
    allow_add( "cp_munitions", ::allow_cp_munitions );
    allow_add( "nvg", ::allow_nvgs );
}
...
allow_offhand_throwback( var_0, var_1 )
{
...
allow_cp_munitions( var_0, var_1 )
{
...
trycall( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( !isdefined( var_0 ) )
        return;
