...
selfrevivebuttonpressed( var_0 )
{
    if ( var_0 usinggamepad() )
        return var_0 getclientomnvar();
    else
        return var_0 disableplayeruseforallplayers();
}
...
selfrevivemonitorrevivebuttonpressed()
{
    ...
    while ( scripts\mp\utility\player::isreallyalive( var_0 ) && selfrevivebuttonpressed( var_0 ) && var_1.curprogress < var_1.usetime )
    {
        ...
        {
            var_0 thread scripts\mp\gametypes\br_public::playerplaygestureweaponanim( "iw8_ges_plyr_self_revive", 10 );
        ...
        if ( var_1.curprogress >= var_1.usetime )
        {
            ...
            if ( scripts\mp\utility\game::getgametype() == "br" )
                scripts\mp\gametypes\br_analytics::branalytics_selfrevive( var_0 );

            var_0 finishreviveplayer( "self_revive_success", var_0 );
            var_0 scripts\mp\gametypes\br_pickups::removeselfrevivetoken();
            return;
        }
    ...
    if ( !istrue( var_0.beingrevived ) )
    {
        scripts\mp\gametypes\br::updatesquadmemberlaststandreviveprogress( var_0, var_0, var_1.curprogress, 1 );
...
revivesetup( var_0 )
{
    ...
    if ( var_0 scripts\mp\gametypes\br_public::hasselfrevivetoken() )
...
secondwindthink()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
        scripts\mp\gametypes\br_analytics::branalytics_secondwind( var_0, var_11, var_2, var_5, var_6, var_7, var_8, var_12, var_13, var_14, var_16 );
...
revivetriggerthink( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_1 buddyrevivingdoneanimevent( 1 );
...
teammatereviveweaponwaitputaway( var_0 )
{
    ...
    var_1 scripts\engine\utility::waittill_any_return_no_endon_death_2( "death_or_disconnect", "finish_buddy_reviving" );
}
...
finishreviveplayer( var_0, var_1 )
{
    ...
    if ( var_0 == "self_revive_success" )
        var_2 calloutmarkerping_getsavedzoffset();

    if ( level.gametype == "br" )
        var_2 scripts\mp\gametypes\br_public::setplayerbeingrevivedextrainfo( 0 );
    ...
    if ( var_3 )
    {
        ...
        if ( level.gametype == "br" )
        {
            if ( !istrue( level.gameended ) )
            {
                var_2 scripts\mp\gametypes\br_public::setplayerdownedextrainfo( 0 );
...
useholdthinkcleanup( var_0, var_1 )
{
    ...
    self.inuse = 0;
    var_1 delete();
    var_0 selfrevivingdoneanimevent();
    var_0 buddyrevivingdoneanimevent( 0 );
...
useholdthinkloop( var_0 )
{
    ...
    while ( scripts\mp\utility\player::isreallyalive( var_0 ) && var_0 usebuttonpressed() && self.curprogress < self.usetime && ( !isdefined( var_0.inlaststand ) || !var_0.inlaststand ) )
    {
...
handlerevivemessage()
{
    ...
    for (;;)
    {
        ...
        if ( level.gametype == "br" )
        {
            scripts\mp\utility\lower_message::setlowermessageomnvar( 60 );

            if ( scripts\mp\gametypes\br_public::hasselfrevivetoken() )
                scripts\mp\utility\lower_message::setlowermessageomnvar( 73 );
        }
        else if ( istrue( scripts\mp\playerlogic::getbeingrevivedinternal() ) )
