...
med_transport_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "medium_transport", 1 );
    var_0.id = 11;
...
med_transport_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "medium_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "medium_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "medium_transport", 13 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "medium_transport", ::med_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "med_transport_mp", 3 );
}
