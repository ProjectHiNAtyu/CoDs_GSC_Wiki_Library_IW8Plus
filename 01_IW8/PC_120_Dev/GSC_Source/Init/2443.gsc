...
vehicle_spawn_mp_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_spawn", "gameModeSupportsAbandonedTimeout", ::vehicle_spawn_mp_gamemodesupportsabandonedtimeout );
...
vehicle_spawn_mp_gamemodesupportsabandonedtimeout()
{
    if ( scripts\mp\utility\game::getgametype() == "br" )
        return 0;
