...
at_mine_explode_from_vehicle_trigger( var_0 )
{
    ...
    var_1 = var_0 scripts\mp\utility\damage::non_player_add_ignore_damage_signature( self.owner, makeweapon( "at_mine_mp" ), self, "MOD_EXPLOSIVE" );
...
at_mine_player_trigger( var_0 )
{
    ...
    var_1.weapon_object = makeweapon( "at_mine_ap_mp" );
...
{
    self endon( "death" );
    self.grenade scripts\engine\utility::waittill_any_timeout_2( var_0, "death", "mine_destroyed" );
