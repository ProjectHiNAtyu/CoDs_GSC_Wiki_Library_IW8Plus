...
little_bird_mp_init()
{
    ...
    if ( istrue( level.showteamlittlebirds ) )
        scripts\cp_mp\utility\script_utility::registersharedfunc( "little_bird", "endEnterInternal", ::little_bird_mp_enterendinternal );
}

little_bird_mp_initspawning()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_getleveldataforvehicle( "little_bird", 1 );
    var_0.abandonedtimeoutcallback = scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_abandonedtimeoutcallback;
    var_0.abandonedtimeoutdelay = 60;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
        var_0.respawndelay = 30;
}
...
little_bird_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_waitandrespawn( "little_bird", var_1, var_2 );
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        if ( istrue( level.showteamlittlebirds ) )
            scripts\mp\gametypes\arm::vehicle_createspawnselectionlittlebirdmarker( var_3, var_3.team );
    }
}

little_bird_mp_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level.showteamlittlebirds ) )
        var_0 scripts\mp\gametypes\arm::vehicle_playerenteredtrackedlittlebird( var_3.team );
}
