...
callback_vehicledamage_internal( var_0 )
{
    ...
    {
        if ( scripts\mp\damage::isspreadweapon( var_0.objweapon ) )
            var_0.damage = scripts\mp\damage::spreadshotdamagemod( self, var_0.attacker, var_0.objweapon, var_0.damage, var_0.idflags );
        else if ( scripts\mp\damage::iscrossbowdamage( var_0.objweapon ) )
        {
            if ( scripts\mp\damage::shouldcrossbowhitmarker( var_0.objweapon ) )
                var_0.damage = 1;
            else
                var_0.damage = 0;
        }
    ...
    if ( isdefined( var_4 ) )
    {
        var_7 = get_post_mod_damage_callback( var_4 );
    ...
    var_8 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_shouldskipburndown( var_0 );

    if ( !var_8 )
    {
        var_9 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getstate();

        if ( isdefined( var_9 ) && var_9 == "heavy" )
        {
            var_10 = scripts\engine\utility::ter_op( isexplosivedamagemod( var_0.meansofdeath ) || var_0.meansofdeath == "MOD_FIRE", 0.15, 0.25 );
            var_0.damage = var_0.damage * var_10;
        }
    }

    if ( scripts\mp\utility\game::getgametype() == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_updatestate_br( var_0, 1 );
    else
        scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_updatestate( var_0, var_8, 1 );
    ...
    var_15 = istrue( var_0.isrearcriticaldamage ) || istrue( var_0.issidecriticaldamage );
        ...
        switch ( var_0.objweapon.basename )
        {
            ...
            case "lighttank_tur_mp":
                if ( isdefined( var_0.meansofdeath ) && var_0.meansofdeath != "MOD_RIFLE_BULLET" )
                    var_0.attacker thread scripts\mp\utility\points::givexpwithtext( "critical_vehicle_damage" );
    ...
    if ( isdefined( var_0.attacker ) )
        var_0.attacker scripts\mp\damagefeedback::updatedamagefeedback( "hitequip", var_14, var_15, var_13, undefined, 1 );
    ...
    if ( level.teambased )
    {
        if ( !var_3 )
        {
            if ( isdefined( var_2 ) && !isdefined( var_1 ) )
                return scripts\cp_mp\vehicles\vehicle::vehicle_isfriendlytoteam( var_0, var_2 );
            else
                return scripts\cp_mp\vehicles\vehicle::vehicle_isfriendlytoplayer( var_0, var_1 );
        }
