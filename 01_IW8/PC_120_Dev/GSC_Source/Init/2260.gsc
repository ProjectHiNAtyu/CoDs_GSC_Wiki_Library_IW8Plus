...
large_transport_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "large_transport", 1 );
    var_0.id = 5;
...
large_transport_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "large_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "large_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "large_transport", 10 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "large_transport", ::large_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "large_transport_mp", 3 );
}
