...
vehicle_dlog_spawnevent( var_0, var_1, var_2 )
{
    ...
    dlog_recordevent( "dlog_event_vehicle_spawn", [ "vehicle_spawn_id", var_3.id, "pos_x", var_0.origin[0], "pos_y", var_0.origin[1], "pos_z", var_0.origin[2], "matchtime_ms", scripts\cp_mp\utility\game_utility::gettimesincegamestart(), "spawn_type", var_1, "vehicle_type", var_2 ] );
}
...
vehicle_dlog_enterevent( var_0, var_1, var_2, var_3 )
{
    if ( !isplayer( var_1 ) )
        return;
