...
light_tank_init()
{
    ...
    var_0.updatecallback = ::light_tank_update;
...
light_tank_initoccupancy()
{
    ...
    var_4.turretobjweapon = makeweapon( "tur_bradley_mp" );
    ...
    var_4.turretobjweapon = makeweapon( "tur_gun_lighttank_mp" );
...
light_tank_initinteract()
{
    ...
    var_0.seatenterarrays["single"] = [ "driver", "gunner" ];
}

light_tank_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "light_tank", 1 );
    var_0.id = 1;
    var_0.seatids["driver"] = 0;
    var_0.seatids["gunner"] = 1;
    var_0.ammoids["turret"] = 0;
    var_0.ammoids["missile"] = 1;
    var_0.ammoids["smoke"] = 2;
    var_0.rotationids[0] = 0;
    var_0.rotationids[1] = 1;
    var_0.rotationrefsbyseatandweapon["driver"]["lighttank_mp"] = 0;
    var_0.rotationrefsbyseatandweapon["driver"]["tur_gun_lighttank_mp"] = 1;
    var_0.rotationrefsbyseatandweapon["driver"]["tur_gun_lighttank_ks_mp"] = 1;
    var_0.rotationrefsbyseatandweapon["gunner"]["tur_bradley_mp"] = 0;
    var_0.rotationrefsbyseatandweapon["gunner"]["tur_bradley_ks_mp"] = 0;
    var_0.rotationrefsbyseatandweapon["gunner"]["tur_gun_lighttank_mp"] = 1;
    var_0.rotationrefsbyseatandweapon["driver"]["tur_gun_lighttank_ks_mp"] = 1;
}

light_tank_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "light_tank", 3000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "light_tank" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "light_tank" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "light_tank", 15 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "light_tank", ::light_tank_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "lighttank_tur_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "lighttank_tur_ks_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "bradley_tow_proj_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "bradley_tow_proj_ks_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "lighttank_mp", 5 );
}
...
light_tank_create( var_0, var_1 )
{
    ...
    var_2.isfromkillstreak = var_0.spawntype == "KILLSTREAK";
    var_3 = light_tank_createdriverturret( var_2, var_0 );
    var_3.missilesleft = 2;
    var_3.lastmissilefired = 0;
    scripts\cp_mp\vehicles\vehicle::vehicle_registerturret( var_2, var_3, makeweapon( "tur_bradley_mp" ), 1 );
    var_3 = light_tank_creategunnerturret( var_2, var_0 );
    scripts\cp_mp\vehicles\vehicle::vehicle_registerturret( var_2, var_3, makeweapon( "tur_gun_lighttank_mp" ) );
    ...
    var_4 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getinstancedataforvehicle( var_2, 1 );
    var_4.destroyscoreevent = "none";
    ...
    var_2 thread light_tank_monitordriverturretprojectilefire();
    var_2 thread light_tank_monitorgunnerturretfire();
...
{
    var_2 = light_tank_getleveldata();
    var_3 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( var_0, "tur_bradley_mp" );
    var_4 = undefined;
...
light_tank_explode( var_0, var_1, var_2 )
{
    ...
    {
        self.streakinfo.expiredbydeath = 1;
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        if ( istrue( self.spawndata.usealtmodel ) )
...
light_tank_airdrop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 hide();
    var_9 = scripts\cp_mp\vehicles\vehicle::vehicle_getturrets( var_8 );
...
light_tank_airdropinternal()
{
    ...
    {
        self.vehicle show();
        var_0 = scripts\cp_mp\vehicles\vehicle::vehicle_getturrets( self.vehicle );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( self, "tur_bradley_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 8;
    ...
    for (;;)
    {
        var_1 = var_0 scripts\engine\utility::waittill_any_return_2( "turret_fire", "turret_reload" );
...
light_tank_monitordriverturretprojectilefire()
{
    ...
    for (;;)
    {
        ...
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getseatoccupant( self, "driver" );
        var_1 thread light_tank_watchprojectileexplosion( var_2 );
...
light_tank_watchprojectileexplosion( var_0 )
{
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( self, "tur_bradley_mp" );
...
light_tank_watchmissileinputchange()
{
    ...
    for (;;)
    {
        var_0 = light_tank_getmissileplayercommand();
        self notifyonplayercommand( "light_tank_missile", var_0 );
        var_1 = scripts\engine\utility::waittill_any_return_no_endon_death_2( "input_type_changed", "missile_handling_ended" );
...
{
    wait 0.33;
    var_2 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( self, "tur_bradley_mp" );
    ...
    if ( istrue( self.isfromkillstreak ) )
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( self, "tur_gun_lighttank_mp" );
...
light_tank_enterend( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    else if ( !istrue( var_4.playerdisconnect ) && !istrue( var_4.playerdeath ) )
    {
        if ( var_1 == "gunner" )
        {
            light_tank_removegunnerdamagemod( var_3 );
...
light_tank_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( var_0, "tur_bradley_mp" );
        var_5.owner = var_3;
        ...
        var_3 thread light_tank_watchmissileinputchange();
    ...
    else if ( var_1 == "gunner" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::vehicle_getturretbyweapon( var_0, "tur_gun_lighttank_mp" );
        var_5.owner = var_3;
        var_5 setotherent( var_3 );
        var_5 setentityowner( var_3 );
        var_5 setsentryowner( var_3 );
        ...
        light_tank_addgunnerdamagemod( var_3 );
    }
...
light_tank_addgunnerdamagemod( var_0 )
{
    if ( isdefined( var_0.gunnerdamagemodifier ) )
        return;

    var_0 scripts\cp_mp\utility\damage_utility::adddamagemodifier( "ltGunnerMissileRedux", 0.4, 0, ::light_tank_gunnerdamagemodignorefunc );
}
...
light_tank_gunnerdamagemodignorefunc( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
light_tank_watchgameend( var_0 )
{
    self endon( "death" );
    self.owner endon( "disconnect" );
    level waittill( "game_ended" );
    self.recordedgameendstats = 1;
    self.owner scripts\cp_mp\utility\killstreak_utility::recordkillstreakendstats( var_0 );
}
...
light_tank_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < -0.83 )
        var_0.isrearcriticaldamage = canweapondealcriticaldamage( var_0 );
...
{
    if ( istrue( var_0.isrearcriticaldamage ) )
...
light_tank_autodestruct( var_0 )
{
    ...
    if ( !istrue( self.autodestructactivated ) )
    {
        ...
        {
            var_1 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getheavystatemaxhealth( self );
...
light_tank_createheadicon( var_0 )
{
    ...
    setheadiconnaturaldistance( var_1, var_3 );
    setheadiconmaxdistance( var_1, var_4 );
    setheadicondrawthroughgeo( var_1, var_5 );
    setheadiconsnaptoedges( var_1, var_6 );
}
...
light_tank_updateheadiconforplayer( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1 == self )
        scripts\cp_mp\entityheadicons::setheadicon_removeclientfrommask( self.headicon, var_0 );
    else
    {
        var_2 = undefined;
        ...
        if ( level.teambased )
        {
            if ( var_3 == "neutral" )
            {
                ...
                {
                    if ( 1 )
                        scripts\cp_mp\entityheadicons::setheadicon_addclienttomask( self.headicon, var_0 );
                    else
                        scripts\cp_mp\entityheadicons::setheadicon_removeclientfrommask( self.headicon, var_0 );
...
light_tank_updateheadiconteam()
{
    ...
    if ( isdefined( var_0 ) && var_0 != "neutral" )
        setheadiconteam( self.headicon, var_0 );
    else
...
light_tank_updateheadiconimage()
{
    ...
    else
    {
        ...
        setheadiconfriendlyimage( self.headicon, var_4 );

        if ( var_2 )
            setheadiconneutralimage( self.headicon, var_5 );

        if ( var_3 )
            setheadiconenemyimage( self.headicon, var_6 );
    }
}
...
light_tank_tryusefromstruct( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_6 = scripts\cp_mp\vehicles\vehicle::vehicle_getturrets( var_5 );

        foreach ( var_8 in var_6 )
            var_8.streakinfo = var_0;

        var_5 thread light_tank_watchgameend( var_0 );
    }
...
{
    var_3 = scripts\cp_mp\vehicles\vehicle::vehicle_getturrets( var_0 );
