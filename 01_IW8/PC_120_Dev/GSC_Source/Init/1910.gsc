...
init()
{
    if ( !isdefined( level.disablespawncamera ) )
        level.disablespawncamera = getdvarint( "scr_game_disablespawncamera", 0 ) == 1;
...
getspawncamera()
{
    ...
    {
        var_14 = level.lastspawnpos[self.team];
        var_15 = undefined;
        var_16 = undefined;
...
snaptospawncamera()
{
    ...
    scripts\mp\utility\player::printspawnmessage( "spawnCamera::snapToSpawnCamera()" );
...
startoperatorsound()
{
    ...
    self.operatorsfxalias = var_1;
    self.operatorsfx playloopsound( var_1 );
...
endoperatorsfxondisconnect()
{
    ...
    var_0 = self.operatorsfx;
    var_1 = self.operatorsfxalias;
    self waittill( "disconnect" );
