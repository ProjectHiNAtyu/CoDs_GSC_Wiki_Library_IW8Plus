...
waitforpathchange( var_0, var_1 )
{
    ...
    var_2 = self.lookaheaddir * self.lookaheaddist;
    var_3 = [ 0, var_2, 0, self.origin, self.lookaheaddist ];
...
animscriptmp_internal( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = animsetgetanimfromindex( var_0, var_1, var_4 );
...
animscripted_single( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::asm_setanimscripted();
...
animscripted_single_earlyend( var_0, var_1 )
{
    scripts\asm\asm_mp::asm_setanimscripted();
...
animscripted_loop_earlyend( var_0, var_1 )
{
    scripts\asm\asm_mp::asm_setanimscripted();
    var_2 = scripts\asm\asm::asm_lookupanimfromalias( "animscripted", var_0 );
    var_3 = scripts\asm\asm::asm_getxanim( "animscripted", var_2 );
...
animscripted_loop_for_time( var_0, var_1 )
{
    scripts\asm\asm_mp::asm_setanimscripted();
    var_2 = scripts\asm\asm::asm_lookupanimfromalias( "animscripted", var_0 );
    var_3 = scripts\asm\asm::asm_getxanim( "animscripted", var_2 );
...
animscripted_loop_n_times( var_0, var_1 )
{
    scripts\asm\asm_mp::asm_setanimscripted();
    var_2 = scripts\asm\asm::asm_lookupanimfromalias( "animscripted", var_0 );
    var_3 = scripts\asm\asm::asm_getxanim( "animscripted", var_2 );
...
animscripted_loop_relative( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::asm_setanimscripted();
...
animscripted_single_relative( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "animscripted";
...
animscripted_single_arrive_at( var_0, var_1, var_2, var_3 )
{
    scripts\asm\asm_mp::asm_setanimscripted();
