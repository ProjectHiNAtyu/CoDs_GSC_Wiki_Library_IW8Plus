...
{
    if ( !hasanimspeedthresholdstring( var_0, "fast" ) || !hasanimspeedthresholdstring( var_0, "jog" ) )
        return 0;

    return var_1 < getanimspeedbetweenthresholds( var_0, "fast", "jog", 0.1 );
}

isspeedwithinsprintrange( var_0, var_1 )
{
    return var_1 > getanimspeedbetweenthresholds( var_0, "run", "sprint", 0.1 );
}

isspeedwithincombatrange( var_0, var_1 )
{
    if ( hasanimspeedthresholdstring( var_0, "fast" ) && hasanimspeedthresholdstring( var_0, "jog" ) && var_1 < getanimspeedbetweenthresholds( var_0, "fast", "jog", 0.9 ) )
        return 0;

    if ( hasanimspeedthresholdstring( var_0, "run" ) && hasanimspeedthresholdstring( var_0, "sprint" ) && var_1 > getanimspeedbetweenthresholds( var_0, "run", "sprint", 0.1 ) )
        return 0;
...
{
    if ( hasanimspeedthresholdstring( var_0, "fast" ) && hasanimspeedthresholdstring( var_0, "jog" ) && var_1 < getanimspeedbetweenthresholds( var_0, "fast", "jog", 0.8 ) )
        return 0;

    if ( hasanimspeedthresholdstring( var_0, "run" ) && hasanimspeedthresholdstring( var_0, "sprint" ) && var_1 > getanimspeedbetweenthresholds( var_0, "run", "sprint", 0.3 ) )
        return 0;
...
choosecrouchorstandtac( var_0, var_1 )
{
        ...
        if ( isdefined( self._blackboard.doortoopen ) )
        {
            ...
            if ( !istrue( var_2 ) )
            {
                ...
                if ( !isdefined( var_13 ) )
                {
                    ...
                    var_14 = getnearestspeedthresholdname( self.basearchetype, var_11 );
...
getarrivaltype()
{
    ...
    if ( !isdefined( var_0 ) || !isnode( var_0 ) || !isdefined( var_0.type ) || var_0.type == "struct" || self.combatmode == "no_cover" )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            if ( var_3 && choosecrouchorstandtac( self, var_1 ) )
...
isdeafened( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\common\utility::isdamageweapon( makeweapon( "iw7_sonic" ) ) && self.damagemod != "MOD_MELEE" && var_4 >= 75 )
        return 1;
...
toggle_poi( var_0, var_1 )
{
    ...
    else
    {
        ...
        var_4 = getanimspeedthreshold( var_3, "fast" );
        ...
        else if ( istrue( self.allowattackfromexposednonode ) )
        {
            ...
            if ( isdefined( self.pathgoalpos ) )
            {
                if ( issentient( self.enemy ) )
                    var_8 = hastacvis( self.pathgoalpos, self.enemy );
                else
                    var_8 = hastacvis( self.pathgoalpos, self.enemy.origin );
            }
            else if ( issentient( self.enemy ) )
                var_8 = self hastacvis( self.enemy );
            else
                var_8 = hastacvis( self.origin, self.enemy.origin );
