...
wp_finishdeployment( var_0, var_1, var_2 )
{
    ...
    var_3 thread wp_watchplanedisowned();
...
wp_deliverpayloads( var_0 )
{
    ...
    self.owner thread wp_watchgameend( var_0 );
...
wp_firesmoke( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_9 )
        var_10 = spawnscriptable( "ks_white_phosphorus_mp_p", var_6, self.angles );
    else
    {
    ...
    var_10 thread wp_watchforsmokedisowned();
    scripts\cp_mp\hostmigration::hostmigration_waitlongdurationwithpause( 1 );
    level thread wp_playimpactsound( var_10 );
...
wp_fireflaregroup( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_14 in var_12 )
    {
        ...
        if ( var_15 )
            var_16 = spawnscriptable( "ks_white_phosphorus_mp_p", var_14.flareorigin, var_6 );
        else
        {
        ...
        var_16 thread wp_watchforflaredisowned( "burn" );
...
wp_removefromactivewplist( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_0 == "smoke" )
    {
        ...
        if ( isdefined( var_1.playersindisorientradius ) )
        {
            ...
            {
                if ( !wp_isinanywpzone( "smoke", var_9 ) )
    ...
    else
    {
        ...
        {
            if ( !wp_isinanywpzone( "inner", var_9 ) )
            {
                if ( var_2 == "burn" )
                {
