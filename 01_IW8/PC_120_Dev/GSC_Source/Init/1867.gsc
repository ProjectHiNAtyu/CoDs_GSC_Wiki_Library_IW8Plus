...
setkillcamnormalweaponomnvars( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( isdefined( var_2.glgrenadeparent ) )
        {
            var_4 = undefined;
            var_0 = var_2.glgrenadeparent;
            var_2 = undefined;
        }
        else
...
waitskipkillcamkbm()
{
    ...
    scripts\mp\utility\stats::incpersstat( "skippedKillcams", 1 );
    scripts\mp\utility\player::printspawnmessage( "killcam::waitSkipKillcamKBM() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
{
    if ( isdefined( var_0.parentweapon ) )
        var_0 = var_0.parentweapon;
    ...
    if ( var_2 != "iw8_knife" )
    {
        ...
        for ( var_7 = 0; var_7 < var_5.size; var_7++ )
        {
            ...
            if ( scripts\mp\utility\weapon::attachmentisselectable( var_2, var_9 ) )
            {
                if ( var_6 >= 8 )
                    break;
