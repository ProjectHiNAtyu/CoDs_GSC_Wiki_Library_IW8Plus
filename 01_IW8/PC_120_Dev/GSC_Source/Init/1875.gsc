...
matchrecording_validaterecordingtype( var_0 )
{
    ...
    else if ( var_0 == 1 || var_0 == 2 )
    {
        ...
        var_4 = analyticsstreamerislogfilestreamingenabled();
...
matchrecording_glog_dump()
{
    ...
    foreach ( var_1 in level.matchrecevents )
    {
        ...
        if ( analyticsstreamerislogfilestreamingenabled() )
            analyticsstreamerlogfilewritetobuffer( var_1 + "\\n" );
    }
...
matchrecording_glog_addheader()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( analyticsstreamerislogfilestreamingenabled() )
            analyticsstreamerlogfilewritetobuffer( var_2 );
    }
}
...
matchrecording_loggameendstats()
{
    ...
    {
        if ( isdefined( var_6.sidekillcount ) )
            var_0 = var_6.sidekillcount;

        if ( isdefined( var_6.engagementcount ) )
            var_3 = var_6.engagementcount;

        if ( isdefined( var_6.engagementtime ) )
            var_4 = var_6.engagementtime;
    }
...
matchrecording_usereventthink()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::waittill_any_return_no_endon_death_2( "log_user_event_end", "log_user_event_generic_event" );
