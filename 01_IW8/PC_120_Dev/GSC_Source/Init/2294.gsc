...
bot_get_ambush_trap_item( var_0, var_1, var_2 )
{
    ...
    foreach ( var_10 in var_3 )
    {
        ...
        {
            if ( scripts\mp\bots\bots_util::bot_item_matches_purpose( var_10, var_7 ) )
            {
        ...
        if ( var_18 )
        {
            ...
            if ( var_19 == "goal" )
            {
                ...
                if ( !isdefined( self.enemy ) || !self botcanseeentity( self.enemy ) )
                {
                    ...
                    scripts\engine\utility::waittill_any_timeout_2( var_21, "missile_fire", "grenade_fire" );
                    wait 0.05;
...
bot_defend_think( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        var_22 = scripts\engine\utility::waittill_any_timeout_5( var_29, "node_relinquished", "goal_changed", "script_goal_changed", "defend_force_node_recalculation", "bad_path" );
    ...
    for (;;)
    {
        if ( self.tactical_goals.size > 0 && !scripts\mp\bots\bots_util::bot_is_remote_or_linked() )
        {
            ...
            if ( !isdefined( var_0.abort ) )
            {
                ...
                if ( istrue( var_0.clear_prev_goal ) )
                    self botclearscriptgoal();
