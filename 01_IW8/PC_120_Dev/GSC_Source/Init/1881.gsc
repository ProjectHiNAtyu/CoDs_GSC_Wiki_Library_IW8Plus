...
player_update_unresolved_collision( var_0 )
{
    ...
    if ( self.unresolved_collision_count >= var_1 )
    {
        if ( isdefined( var_0 ) )
        {
            ...
            {
                var_2 = isdefined( self.lastascenderusetime ) && gettime() - self.lastascenderusetime <= 250;

                if ( var_2 || var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() && !scripts\cp_mp\vehicles\vehicle::vehicle_docollisiondamage( var_0, self ) )
                    var_0 unresolved_collision_nearest_node( self, 0, var_0 );
                else
                {
                    var_3 = player_should_be_killed_by_mover( var_0 );
                    var_0 unresolved_collision_nearest_node( self, var_3, var_0 );
                }
            }
        }
        else
        {
            var_3 = player_should_be_killed_by_mover( var_0 );
            unresolved_collision_nearest_node( self, var_3 );
        }
...
unresolved_collision_nearest_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( scripts\cp_mp\utility\game_utility::islargemap() )
        {
            ...
            {
                var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getdriverseat( var_2, 1 );

                if ( isdefined( var_3 ) )
                {
                    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getexitpositionandangles( var_2, var_0, var_3, 1 );
        ...
        {
            var_5 = self.unresolved_collision_nodes;
            var_6 = undefined;

            if ( isdefined( var_5 ) )
                var_5 = sortbydistance( var_5, var_0.origin );
            else
                var_5 = getnodesinradiussorted( var_0.origin, 500, 0, 128, "path" );

            var_7 = ( 0, 0, -100 );
            var_0 cancelmantle();
            var_0 dontinterpolate();
            var_8 = get_mover_ents( var_2 );
            ...
            for ( var_10 = 0; var_10 < var_5.size; var_10++ )
            {
                ...
                var_13 = scripts\engine\trace::create_contents( 0, 1, 1, 1, 1, 1 );
                ...
                if ( positionwouldtelefrag( var_12 ) )
                    continue;
