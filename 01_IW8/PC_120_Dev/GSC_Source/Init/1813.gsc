...
setupvfxobjs( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        if ( isdefined( var_2.script_noteworthy ) && scripts\engine\utility::string_starts_with( var_2.script_noteworthy, "vfx_" ) )
        {
            ...
            if ( !isvalidanimsuiteentity( "setupVFXObjs(): obj", var_2 ) )
                continue;

            if ( !isvalidanimsuiteentity( "setupVFXObjs(): model", var_3 ) )
                continue;
...
delayfxcall( var_0, var_1, var_2 )
{
    ...
    if ( !isvalidanimsuiteentity( "delayFXCall()", var_1 ) )
        return;
...
isvalidanimsuiteentity( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        return 0;
