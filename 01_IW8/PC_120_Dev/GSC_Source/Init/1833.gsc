...
cac_modified_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    var_35 = weaponignoresbrarmor( var_1, var_0, var_2, var_4, var_3, var_8, var_7 );
    ...
    if ( isplayer( var_1 ) )
    {
        var_39 = var_0 scripts\mp\gametypes\br_public::hasarmor();
        var_40 = var_0 scripts\mp\gametypes\br_public::hashelmet();
