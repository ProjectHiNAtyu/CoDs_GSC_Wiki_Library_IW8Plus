...
tac_cover_on_fired( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_9 ) )
    {
        ...
        var_16 = var_9.closedcenter + ( 0, 0, 24 );
        ...
        {
            if ( var_9 scripts\cp_mp\utility\scriptable_door_utility::scriptable_door_is_double_door_pair( var_22 ) )
            {
                var_20 = var_22;
                break;
            }
        ...
        if ( var_10 < 1600 && var_19 && var_24 )
        {
            var_9.isblocked = 1;
            self.taccoverrefund = undefined;
            thread tac_cover_spawn_with_door( var_9, var_20, var_3, var_4 );
    ...
    if ( isdefined( var_37 ) && !tac_cover_can_place_on( var_37 ) )
    {
        tac_cover_fire_failed();
        return 0;
    }
    ...
    self.taccoverrefund = undefined;
    thread tac_cover_spawn( var_39, var_35, undefined, var_3, var_4 );
    scripts\mp\utility\stats::incpersstat( "deployableCoverUsed", 1 );
    return 1;
}
