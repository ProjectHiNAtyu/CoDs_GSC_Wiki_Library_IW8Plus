...
molotov_init()
{
    var_0 = spawnstruct();
    level.molotov = var_0;
    var_0.maxpools = getdvarint( "scr_molotovMaxPools", 100 );
    var_0.maxcastsperframe = getdvarint( "scr_molotovMaxCastsPerFrame", 8 );
    var_0.immediatecleanup = getdvarint( "scr_molotovInstantCleanup", 1 ) > 0;
    var_0.uniquepoolid = 0;
    var_0.poolids = [];
    var_0.scriptables = [];
    var_0.triggers = [];
...
molotov_init_pool_mask()
{
    var_0 = molotov_get_pool_level_data();
    var_1 = [];
    var_1[4] = "coreCenter";
    var_1[8] = "core";
    var_1[16] = "tendril";
...
molotov_used( var_0 )
{
    ...
    if ( isdefined( level.gamemodemolotovfunc ) )
        [[ level.gamemodemolotovfunc ]]( var_0, self );
...
{
    if ( !scripts\mp\bots\bots_util::bot_bots_enabled_or_added() )
        return;
...
molotov_register_cast( var_0 )
{
    var_0.caststotal++;
    var_0.caststhisframe++;
    var_0.frametimestamp = gettime();
    var_1 = molotov_get_level_data();
    var_1.caststhisframe++;
}

molotov_register_scriptable( var_0 )
{
    var_0.scriptablecount++;
    var_1 = molotov_get_level_data();
    var_1.scriptables[self.id] = self;

    if ( var_1.scriptables.size > var_1.maxpools )
...
molotov_register_trigger( var_0 )
{
    ...
    if ( var_1.triggers.size > var_1.maxpools )
...
molotov_delete_scriptable()
{
    ...
    if ( !isdefined( var_1 ) )
        var_0.poolids = scripts\engine\utility::array_remove( var_0.poolids, self.id );
...
molotov_delete_oldest_scriptable( var_0 )
{
    var_1 = molotov_get_level_data();
    var_2 = undefined;
    var_3 = undefined;

    foreach ( var_3 in var_1.poolids )
    {
    ...
    var_0 = istrue( var_0 ) || var_1.immediatecleanup;

    if ( !isdefined( var_2 ) )
        molotov_delete_pool_by_id( var_3, var_0 );
}

molotov_delete_oldest_trigger( var_0 )
{
    var_1 = molotov_get_level_data();
    var_2 = undefined;
    var_3 = undefined;
...
molotov_delete_pool_by_id( var_0, var_1 )
{
    var_2 = molotov_get_level_data();
    ...
    if ( isdefined( var_3 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            var_2.poolids = scripts\engine\utility::array_remove( var_2.poolids, var_0 );
            var_3 thread molotov_pool_end();
            return;
        }

        var_3 thread molotov_delete_scriptable();
    }

    var_4 = var_2.triggers[var_0];

    if ( isdefined( var_4 ) )
        var_4 thread molotov_delete_trigger();
}
...
molotov_can_cast_this_frame( var_0 )
{
    ...
    if ( var_1.caststhisframe >= var_1.maxcastsperframe )
        return 0;
...
molotov_shared_data_is_complete( var_0 )
{
    ...
    if ( self.caststotal >= var_2 )
        var_1 = 1;
    else if ( self.scriptablecount >= var_3 )
        var_1 = 1;
...
molotov_store_branch_ents()
{
    ...
    if ( !isdefined( var_0.oldbranchents ) )
        var_0.oldbranchents = [];
    ...
    foreach ( var_2 in self.branches )
    {
        ...
        {
            if ( isdefined( var_4 ) )
                var_0.oldbranchents[var_0.oldbranchents.size] = var_4;
        }
    }
}
...
{
    var_10 = spawnscriptable( "equip_molotov_pool_mp_p", var_0, var_1 );
    ...
    var_10 thread molotov_watch_cleanup_pool();
    return var_10;
}
...
molotov_branch_create_pool( var_0, var_1, var_2 )
{
    ...
    var_7.id = molotov_get_unique_pool_id();
    var_7 molotov_register_scriptable( self.shareddata );
    return var_7;
}
...
molotov_create_pool_trigger( var_0, var_1, var_2 )
{
    ...
    var_4 molotov_register_trigger();
    return var_4;
}
...
{
    var_0 = molotov_get_level_data();
    var_1 = var_0.uniquepoolid;
    var_0.uniquepoolid++;
    var_0.poolids = scripts\engine\utility::array_add( var_0.poolids, var_1 );
    return var_1;
}
...
{
    var_1 = molotov_get_pool_level_data();
    var_2 = spawnstruct();
    var_2.typeid = var_0;
...
molotov_watch_fx()
{
    ...
    for (;;)
    {
        ...
        if ( !isnullweapon( var_2 ) && var_2.basename == "molotov_mp" )
            var_1 = 1;
...
molotov_cleanup_branch( var_0, var_1 )
{
...
molotov_cleanup_pool( var_0, var_1 )
{
    if ( isdefined( var_0.shareddata ) )
    {
        if ( isdefined( var_0.shareddata.branches ) )
        {
            foreach ( var_3 in var_0.shareddata.branches )
                molotov_cleanup_branch( var_3, var_1 );
        }

        if ( isdefined( var_0.shareddata.oldbranchents ) )
        {
            foreach ( var_6 in var_0.shareddata.oldbranchents )
            {
                if ( isdefined( var_6 ) )
