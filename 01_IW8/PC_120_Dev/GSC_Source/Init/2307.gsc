...
{
    scripts\cp_mp\emp_debuff::apply_emp_struct( var_0 );
    scripts\mp\gamescore::trackdebuffassist( var_0.attacker, var_0.victim, var_0.objweapon.basename );
    ...
    if ( isdefined( var_0.victim ) )
    {
        ...
        if ( isdefined( var_0.attacker ) && scripts\mp\utility\player::isreallyalive( var_0.attacker ) )
            scripts\mp\gamescore::untrackdebuffassist( var_0.attacker, var_0.victim, var_0.objweapon.basename );
    }
}
