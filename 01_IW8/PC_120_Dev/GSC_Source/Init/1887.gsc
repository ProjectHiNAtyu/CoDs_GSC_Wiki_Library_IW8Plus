...
ispointinoutofbounds( var_0, var_1 )
{
    ...
    {
        foreach ( var_4 in level.outofboundstriggers )
        {
            if ( ispointinvolume( var_0, var_4 ) )
            {
                if ( isdefined( var_4.script_team ) && isdefined( var_1 ) && var_4.script_team != var_1 )
                    continue;
                else
                {
                    var_2 = 1;
...
watchoobtriggerenter( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_1 ) && isdefined( var_1.c130 ) )
            continue;
