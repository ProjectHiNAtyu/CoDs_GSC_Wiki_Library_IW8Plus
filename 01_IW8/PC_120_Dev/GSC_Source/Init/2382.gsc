...
superdeadsilence_endsuper( var_0 )
{
    ...
    scripts\cp_mp\challenges::onfieldupgradeend( "super_deadsilence", self.deadsilencekills );
...
superdeadsilence_onkill()
{
    if ( scripts\mp\utility\game::getgametype() != "infect" )
    {
        ...
        var_0 = scripts\mp\supers::getcombatrecordsupermisc( "super_deadsilence" );

        if ( self.deadsilencekills > var_0 )
        {
            var_1 = self.deadsilencekills - var_0;
            scripts\mp\supers::combatrecordsupermisc( "super_deadsilence", var_1 );
        }
    }
...
applyfovpresentation()
{
    ...
    var_1 = var_0 - 2;
    scripts\engine\utility::waittill_any_timeout_no_endon_death_1( var_1, "super_use_finished" );
