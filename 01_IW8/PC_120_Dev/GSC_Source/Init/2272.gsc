...
vehicle_mines_isfriendlytomine( var_0 )
{
    if ( level.teambased )
    {
        ...
        if ( isdefined( var_1 ) )
            return scripts\cp_mp\vehicles\vehicle::vehicle_isfriendlytoteam( self, var_1 );
    }
    else if ( isdefined( var_0.owner ) )
        return scripts\cp_mp\vehicles\vehicle::vehicle_isfriendlytoplayer( self, var_0.owner );
