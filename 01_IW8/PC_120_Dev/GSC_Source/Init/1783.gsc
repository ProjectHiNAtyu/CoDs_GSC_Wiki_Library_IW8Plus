...
denyascendmessagejugg()
{
    ...
    {
        scripts\mp\utility\lower_message::setlowermessageomnvar( 54 );
        wait 4;
        scripts\mp\utility\lower_message::setlowermessageomnvar( 0 );
    }
}
...
ascenderuse( var_0, var_1 )
{
    ...
    {
        var_1 thread denyascendmessagejugg();
        return;
    }

    if ( istrue( self.inlaststand ) )
    {
        var_1 thread denyascendmessagelaststand();
        return;
    }
    ...
    var_3 = var_2.ascendstructend;
    var_4 = var_2.ascendstructout;
    ...
    var_1.ascenderstart = var_2;
    var_1.ascendermodelview = var_5;
    var_1.ascendermodelworld = var_6;
    var_1 thread ascenddeathlistener( var_2 );
    var_2.ascender startascenderanim( var_1, var_2.dir, var_5, var_6 );
    var_2.ascender playloopsound( "br_auto_ascender_device_lp_npc" );
    var_1 thread loopwaitanim( var_2.ascender, var_5, var_6, var_2.dir );
    var_7 = distance( var_3.origin, var_2.origin );

    if ( !var_2.dir )
    {
        if ( scripts\common\utility::iscp() )
            var_8 = getdvarfloat( "scr_descender_speed_cp", 540.0 );
        else
            var_8 = getdvarfloat( "scr_descender_speed", 460.0 );
    }
    else
        var_8 = getdvarfloat( "scr_ascender_speed", 360.0 );

    var_9 = var_7 / var_8;
    var_10 = 0.4 * var_9;
    var_11 = 0.15 * var_9;
    var_2.ascender moveto( var_3.origin, var_9, var_10, var_11 );
    wait( var_9 );
    var_2.ascender stoploopsound( "br_auto_ascender_device_lp_npc" );
    var_1 notify( "ascender_loop_done" );
    var_2.ascender endascenderanim( var_1, var_2.dir, var_5, var_6 );
...
cleanupascenduse( var_0 )
{
    ...
    var_0.lastascenderusetime = gettime();
    ...
    var_0.ascendermodelview unlink();
    var_0.ascendermodelview delete();
    var_0.ascendermodelworld unlink();
    var_0.ascendermodelworld delete();
    ...
    var_0.ascenderstart = undefined;
    var_0.ascendermodelview = undefined;
    var_0.ascendermodelworld = undefined;
...
ascenderinstantstop()
{
    ...
    var_1 = var_0.ascenderstart.ascendstructout.origin;
    var_2 = var_0.ascenderstart.ascendstructout.angles;
    var_0.ascenderstart cleanupascenduse( var_0 );
