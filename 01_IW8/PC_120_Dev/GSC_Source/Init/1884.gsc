...
init()
{
    ...
    var_0.reserved = [];
    var_0.index = 0;
    var_0.limit = getmaxobjectivecount();
...
update_objective_ownerclient( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
update_objective_mlgicon( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;

    objective_mlgicon( var_0, var_1 );
}
...
update_objective_setmlgbackground( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;

    objective_setmlgbackground( var_0, var_1 );
}
...
objective_hide_for_mlg_spectator( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;

    objective_sethideformlgspectator( var_0, var_1 );
}

objective_show_for_mlg_spectator( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
createobjective( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( level.teambased )
    {
        ...
        update_objective_ownerclient( var_5, self.owner );
