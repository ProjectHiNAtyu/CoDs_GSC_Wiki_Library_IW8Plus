...
tryusehoverjetfromstruct( var_0 )
{
    ...
    var_4 = _tryusehoverjetfromstructinternal( var_0 );
    var_4 = istrue( var_4 );
    level.incomingallhoverjets--;
...
_tryusehoverjetfromstructinternal( var_0 )
{
    ...
    var_1 = scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_doweaponswitchdeploy( var_0, makeweapon( "ks_remote_map_mp" ), 1, ::weapongivenhoverjet );
...
starthoverjetairstrikepass( var_0, var_1, var_2 )
{
    ...
    var_19 thread hoverjet_watchgameend();
...
hoverjet_getbestgroundtarget()
{
    ...
    {
        if ( !scripts\cp_mp\killstreaks\chopper_support::choppersupport_isplayeractive( var_5.player ) )
            continue;
