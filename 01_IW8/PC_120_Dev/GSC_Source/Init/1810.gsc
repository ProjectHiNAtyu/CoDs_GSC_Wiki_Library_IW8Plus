...
watchforbasicplayerevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::waittill_any_return_no_endon_death_5( "adjustedStance", "jumped", "weapon_fired", "reload_start", "spawned_player" );
...
watchforplayermovementevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::waittill_any_return_no_endon_death_3( "doubleJumpBegin", "doubleJumpEnd", "sprint_slide_begin" );
...
watchforusermessageevents()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::waittill_any_return_2( "log_user_event_end", "log_user_event_generic_event" );
...
logevent_path()
{
    ...
    dlog_recordevent( "gamemp_path", [ "playerid", self.analyticslog.playerid, "x", self.origin[0], "y", self.origin[1], "z", self.origin[2], "gun_orientx", var_0[0], "gun_orienty", var_0[1], "gun_orientz", var_0[2], "action", getpathactionvalue(), "health", getsantizedhealth() ] );
    clearpathactionvalue();
}
...
logevent_playerspawn()
{
    ...
    dlog_recordevent( "gamemp_spawn_in", [ "playerid", self.analyticslog.playerid, "x", self.origin[0], "y", self.origin[1], "z", self.origin[2], "orientx", var_1[0], "orienty", var_1[1], "orientz", var_1[2], "loadout", buildloadoutstring(), "type", scripts\engine\utility::ter_op( var_0, "Buddy", "Normal" ), "team", self.team ] );
}
...
logevent_playerconnected()
{
    ...
    var_1 = self getxuid();
    dlog_recordevent( "gamemp_player_connect", [ "playerid", self.analyticslog.playerid, "player_name", self.name, "player_xuid", var_1, "player_super_name", var_0 ] );
}
...
logevent_explosion( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    dlog_recordevent( "gamemp_explosion", [ "playerid", var_2.analyticslog.playerid, "x", var_1[0], "y", var_1[1], "z", var_1[2], "orientx", var_4[0], "orienty", var_4[1], "orientz", var_4[2], "duration", var_3, "type", var_0 ] );
}
...
logevent_frontlineupdate( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    dlog_recordevent( "gamemp_front_line", [ "startx", var_0[0], "starty", var_0[1], "endx", var_1[0], "endy", var_1[1], "axis_centerx", var_3[0], "axis_centery", var_3[1], "allies_centerx", var_2[0], "allies_centery", var_2[1], "state", var_4 ] );
}
...
logevent_gameobject( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    dlog_recordevent( "gamemp_object", [ "uniqueid", var_1, "x", var_2[0], "y", var_2[1], "z", var_2[2], "ownerid", var_3, "type", var_0, "state", var_4 ] );
}
...
logevent_message( var_0, var_1, var_2 )
{
    ...
    dlog_recordevent( "gamemp_message", [ "ownerid", var_0, "x", var_1[0], "y", var_1[1], "z", var_1[2], "message", var_2 ] );
}
...
logevent_powerused( var_0, var_1 )
{
    ...
    dlog_recordevent( "gamemp_power", [ "ownerid", self.analyticslog.playerid, "x", self.origin[0], "y", self.origin[1], "z", self.origin[2], "orientx", var_2[0], "orienty", var_2[1], "orientz", var_2[2], "type", var_0, "state", var_1 ] );
}
...
logevent_minimapcorners()
{
    ...
    dlog_recordevent( "gamemp_map", [ "cornera_x", var_0[0].origin[0], "cornera_y", var_0[0].origin[1], "cornerb_x", var_0[1].origin[0], "cornerb_y", var_0[1].origin[1], "north", getnorthyaw() ] );
}
...
logevent_assist( var_0, var_1, var_2 )
{
    ...
    dlog_recordevent( "gamemp_assists", [ "playerid", var_0, "server_death_id", var_1, "weapon", var_2 ] );
}
...
logevent_superended( var_0, var_1, var_2, var_3 )
{
    ...
    dlog_recordevent( "analytics_mp_supers", [ "super_name", var_0, "time_to_use", var_1, "num_hits", var_2, "num_kills", var_3, "player_id", var_4 ] );
}
...
logevent_superearned( var_0 )
{
    ...
    dlog_recordevent( "analytics_mp_super_earned", [ "match_time", var_0, "player_id", var_1 ] );
}
...
logevent_awardgained( var_0 )
{
    ...
    dlog_recordevent( "analytics_mp_awards", [ "award_message", var_0 ] );
}
...
logevent_giveplayerxp( var_0, var_1, var_2, var_3 )
{
    ...
    dlog_recordevent( "analytics_mp_player_xp", [ "current_prestige", var_0, "current_level", var_1, "xp_gained", var_2, "xp_source", var_3, "player_id", var_4 ] );
}
...
logevent_givempweaponxp( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    dlog_recordevent( "analytics_mp_weapon_xp", [ "weapon", var_6, "current_prestige", var_1, "current_level", var_2, "xp_gained", var_3, "xp_source", var_4, "player_id", var_5 ] );
}
...
logevent_sendplayerindexdata()
{
    ...
    dlog_recordevent( "analytics_match_player_index_init", [ "player1_index", var_0[0], "player1_xuid", var_1[0], "player2_index", var_0[1], "player2_xuid", var_1[1], "player3_index", var_0[2], "player3_xuid", var_1[2], "player4_index", var_0[3], "player4_xuid", var_1[3], "player5_index", var_0[4], "player5_xuid", var_1[4], "player6_index", var_0[5], "player6_xuid", var_1[5], "player7_index", var_0[6], "player7_xuid", var_1[6], "player8_index", var_0[7], "player8_xuid", var_1[7], "player9_index", var_0[8], "player9_xuid", var_1[8], "player10_index", var_0[9], "player10_xuid", var_1[9], "player11_index", var_0[10], "player11_xuid", var_1[10], "player12_index", var_0[11], "player12_xuid", var_1[11] ] );
}
...
logevent_reportgamescore( var_0, var_1, var_2 )
{
    ...
    dlog_recordevent( "analytics_mp_score_event", [ "score_type", var_3, "score_points", var_0, "score_eventid", var_2, "game_time", var_1, "player_id", self.analyticslog.playerid ] );
}
...
logevent_reportsuperscore( var_0, var_1 )
{
    ...
    var_2 = 3;
    dlog_recordevent( "analytics_mp_score_event", [ "score_type", var_2, "score_points", var_0, "game_time", var_1, "player_id", self.analyticslog.playerid ] );
}
...
logevent_nvgtoggled( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    dlog_recordevent( "dlog_event_gamemp_nvg_toggle", [ "playerid", var_6, "game_time", var_0, "player_life_index", var_1, "x", var_2[0], "y", var_2[1], "z", var_2[2], "enabled", var_3, "duration", var_4, "disable_reason", var_5 ] );
}
...
logevent_xpearned( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "";
