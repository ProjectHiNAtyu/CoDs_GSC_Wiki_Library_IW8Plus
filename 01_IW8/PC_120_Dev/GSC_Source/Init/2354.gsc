...
defendlocation( var_0, var_1 )
{
    ...
    else if ( isdefined( var_1 ) && isdefined( var_0.dropcrates ) )
    {
        ...
        var_0 scripts\engine\utility::waittill_any_timeout_1( 10, "all_crates_gone" );
...
watchpatroltarget()
{
    ...
    self endon( "jackal_crashing" );
    self.owner endon( "disconnect" );
    var_0 = self.patroltarget scripts\engine\utility::waittill_any_timeout_1( 5, "death_or_disconnect" );
    self.patroltarget = undefined;
}
...
watchforlosttarget( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = var_1 scripts\engine\utility::waittill_any_timeout_1( var_3, "death_or_disconnect" );
...
callback_vehicledamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    scripts\mp\damage::logattackerkillstreak( self, var_2, var_1, var_7, var_6, var_4, var_10, undefined, var_11, var_3, getcompleteweaponname( var_5 ) );
