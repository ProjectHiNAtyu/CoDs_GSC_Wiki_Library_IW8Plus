...
perkpackage_getfirstfieldupgrade()
{
    ...
    if ( isdefined( self.overridefieldupgrade1 ) )
        var_0 = self.overridefieldupgrade1;
...
perkpackage_getsecondfieldupgrade()
{
    ...
    if ( isdefined( self.overridefieldupgrade2 ) )
        var_0 = self.overridefieldupgrade2;
...
perkpackagemenu_openmenu()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        if ( isalive( self ) )
        {
            ...
            scripts\mp\supers::superusefinished( 0, 1 );
...
perkpackagemenu_menuthink()
{
    ...
    wait 0.3;
    var_0 = scripts\engine\utility::waittill_any_return_4( "perkPackageMenu_option1", "perkPackageMenu_option2", "perkPackageMenu_close", "death" );
    var_1 = 0;
...
perkpackage_giveoverridefieldupgrades( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        var_0 = "none";
    ...
    self.overridefieldupgrade1 = var_0;
