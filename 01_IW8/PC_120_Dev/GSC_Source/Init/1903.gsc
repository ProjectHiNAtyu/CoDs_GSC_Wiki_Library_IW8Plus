...
setplayerscoreboardinfo()
{
    ...
    if ( var_0 < 200 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_12 = scripts\mp\gametypes\br::calculateclientmatchdataextrainfopayload( self );
...
buildscoreboardtype( var_0 )
{
    ...
    if ( var_0 == "multiteam" )
    {
        ...
        foreach ( var_3 in level.teamnamelist )
        {
            ...
            {
                scripts\mp\gamelogic::assignclientmatchdataid( var_6 );
                setclientmatchdata( "scoreboards", computescoreboardslot( "multiteam", var_1 ), var_6.clientmatchdataid );
                var_1++;
            }
        }
    }
    else if ( var_0 == "neutral" )
    {
        ...
        foreach ( var_6 in level.placement["all"] )
        {
            setclientmatchdata( "scoreboards", computescoreboardslot( var_0, var_1 ), var_6.clientmatchdataid );
            var_1++;
        }
    }
    else
    {
        var_11 = scripts\mp\utility\game::getotherteam( var_0 )[0];
        var_1 = 0;

        foreach ( var_6 in level.placement[var_0] )
        {
            setclientmatchdata( "scoreboards", computescoreboardslot( var_0, var_1 ), var_6.clientmatchdataid );
            var_1++;
        }

        foreach ( var_6 in level.placement[var_11] )
        {
            setclientmatchdata( "scoreboards", computescoreboardslot( var_0, var_1 ), var_6.clientmatchdataid );
            var_1++;
        }
