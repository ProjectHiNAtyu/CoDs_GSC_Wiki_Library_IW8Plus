...
executeclasschange( var_0, var_1 )
{
    ...
    else
    {
        ...
        if ( scripts\mp\class::shouldallowinstantclassswap() && scripts\mp\utility\game::getgametype() != "br" )
...
handleclassedit( var_0 )
{
    ...
    var_3 = scripts\mp\class::loadout_editglobalclassstruct();
    var_4 = var_2 || var_3;
...
autoassign()
{
    if ( scripts\mp\utility\game::getgametype() == "infect" )
        ...
        thread setteam( "allies" );
    else if ( isbot( self ) && isdefined( self.bot_team ) && self.bot_team != "autoassign" )
...
joinsquad( var_0, var_1 )
{
    ...
    if ( isdefined( self.squadindex ) )
    {
        ...
        foreach ( var_8, var_4 in level.squaddata )
        {
            foreach ( var_7, var_6 in var_4 )
            {
                if ( scripts\engine\utility::array_contains( var_6.players, self ) )
                {
                    level.squaddata[var_8][var_7].players = scripts\engine\utility::array_remove( var_6.players, self );
                    var_2 = 1;
                    break;
                }
            }
    ...
    self.squadmemberindex = level.squaddata[var_0][var_1].players.size;
...
leavesquad( var_0, var_1 )
{
    if ( isdefined( var_0 ) && isdefined( var_1 ) )
        thread scripts\mp\spawnselection::refreshsquadspawnareaomnvars( var_0, var_1 );
    ...
    for ( var_4 = 0; var_4 < level.squaddata[var_0][var_1].players.size; var_4++ )
        level.squaddata[var_0][var_1].players[var_4].squadmemberindex = var_4;
...
updatesquadomnvars( var_0, var_1 )
{
    ...
    foreach ( var_4 in level.squaddata[var_0][var_1].players )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "arm" )
        {
            ...
            var_7 = scripts\engine\utility::array_remove( level.squaddata[var_0][var_1].players, var_4 );
...
waitforclassselect()
{
    ...
    for (;;)
    {
        var_0 = scripts\mp\utility\game::getgametype() == "br" && scripts\mp\utility\game::allowclasschoice() && !scripts\mp\flags::gameflag( "prematch_done" );
...
addtoteam( var_0, var_1, var_2 )
{
    ...
    self.team = var_0;
    var_3 = isbot( self ) || istestclient( self );
