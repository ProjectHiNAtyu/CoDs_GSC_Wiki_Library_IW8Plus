    ...
    if ( level.cratedropdata.ac130s.size >= 2 )
    {
        if ( isdefined( var_0 ) && isdefined( var_5 ) )
        {
            ...
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "awardKillstreakFromStruct" ) )
                var_0 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "awardKillstreakFromStruct" ) ]]( var_5.mpstreaksysteminfo );
        }
    }
    else
    {
        ...
        var_0 thread scripts\cp_mp\killstreaks\airdrop::airdrop_playdeploydialog( var_5 );
