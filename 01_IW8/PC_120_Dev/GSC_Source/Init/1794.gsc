...
initparachutedvars()
{
    ...
    level.parachutecancutautodeploy = getdvarint( "scr_parachute_autodeploy_cut", 1 );
    level.parachutecancutparachute = getdvarint( "scr_parachute_cut", 1 );
    ...
    level.skydivestreamhintdvars.xyvelscale_high = getdvarfloat( "scr_parachute_hint_xyvelscale_high", 0.0 );
    level.skydivestreamhintdvars.xyvelscale_low = getdvarfloat( "scr_parachute_hint_xyvelscale_low", 0.0 );
    level.skydivestreamhintdvars.xyvelscale_maxheight = getdvarfloat( "scr_parachute_hint_xyvelscale_maxheight", 0.0 );
    level.skydivestreamhintdvars.xylimit = getdvarfloat( "scr_parachute_hint_xylimit", 0.0 );
    level.skydivestreamhintdvars.zdrop = getdvarfloat( "scr_parachute_hint_zdrop", 0.0 );
    level.skydivestreamhintdvars.zoffset = getdvarfloat( "scr_parachute_hint_zoffset", 0.0 );
    level.skydivestreamhintdvars.zvelscale = getdvarfloat( "scr_parachute_hint_zvelscale", 0.0 );
    level.skydivestreamhintdvars.zlimit = getdvarfloat( "scr_parachute_hint_zlimit", 0.0 );
    level.skydivestreamhintdvars.falling_xyratio = getdvarfloat( "scr_parachute_hint_falling_xyratio", 0.0 );
}
...
startfreefall( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        thread freefallfromplanestatemachine( var_0, var_1, var_2, var_3, var_4, var_5 );
        return;
    }
    ...
    if ( level.gametype == "br" && ( !istrue( var_4 ) || getdvar( "scr_br_gametype", "" ) == "dmz" ) && getdvarint( "scr_infil_parachute_vfx", 1 ) )
        thread infilparachutevfx( getdvarint( "scr_bmo_parachuteTouchdownVFX", 1 ) == 1 && getdvar( "scr_br_gametype", "" ) == "dmz" );
...
parachuteprelaststandfunction()
{
    ...
    {
        if ( isdefined( var_0.ffsm_state ) && ( var_0.ffsm_state == 1 || var_0.ffsm_state == 2 ) )
        {
            var_0 ffsm_landed_stateenter();
            var_0.ffsm_state = 3;
        }
    }
    else if ( level.gametype == "cp_survival" )
    {
        ...
        var_0 ffsm_landed_stateenter( 1 );
    }
}
...
updateparachutestreamhint()
{
    ...
    var_2 = clamp( var_0.origin[2], 0, level.skydivestreamhintdvars.xyvelscale_maxheight ) / level.skydivestreamhintdvars.xyvelscale_maxheight;
    var_3 = level.skydivestreamhintdvars.xyvelscale_low + ( level.skydivestreamhintdvars.xyvelscale_high - level.skydivestreamhintdvars.xyvelscale_low ) * var_2;
    var_4 = var_1 * ( 1, 1, 0 );
    var_5 = length( var_4 );
    var_6 = var_4 * var_3;
    var_7 = var_5 * var_3;

    if ( var_7 > level.skydivestreamhintdvars.xylimit )
        var_6 = var_6 * ( level.skydivestreamhintdvars.xylimit / var_7 );

    var_8 = 0;
    var_8 = var_8 - var_0.origin[2] * level.skydivestreamhintdvars.zdrop;
    var_8 = var_8 + level.skydivestreamhintdvars.zoffset;
    var_8 = var_8 + var_1[2] * level.skydivestreamhintdvars.zvelscale;
    var_8 = clamp( var_8, -1 * level.skydivestreamhintdvars.zlimit, 0 );
    var_9 = 1;

    if ( var_5 < level.skydivestreamhintdvars.falling_xyratio * var_1[2] )
        var_9 = 2;

    var_0 setadditionalstreampos( var_0.origin + ( var_6[0], var_6[1], var_8 ), 0, var_9 );
}

freefallfromplanestatemachine( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    ...
    var_6 = self;
    var_6.ffsm_state = 1;
    var_6.ffsm_isgulagrespawn = istrue( var_4 );
    var_6.ffsm_nextstreamhinttime = 0;
    var_6 ffsm_introsetup( var_0, var_1, var_2, var_3, var_5 );
    var_6 ffsm_skydive_stateenter();
    var_7 = gettime();

    for (;;)
    {
        if ( var_6 isskydiving() || var_7 + 2000 < gettime() || var_6 isskydivestatedisabled() )
            break;
    ...
    for (;;)
    {
        if ( level.skydivestreamhintdvars.streamhintenabled && var_6.ffsm_nextstreamhinttime < gettime() )
        {
            var_6 updateparachutestreamhint();
            var_6.ffsm_nextstreamhinttime = gettime() + 500;
        }

        if ( var_6 isinfreefall() && var_6.ffsm_state != 1 )
        {
            var_6 ffsm_skydive_stateenter();
            var_6.ffsm_state = 1;
        }

        if ( var_6 isparachuting() && var_6.ffsm_state != 2 )
        {
            var_6 ffsm_parachuteopen_stateenter();
            var_6.ffsm_state = 2;
        }

        if ( !var_6 isskydiving() && var_6.ffsm_state != 3 && var_6.ffsm_state != 4 && var_6.ffsm_state != 6 || var_6.ffsm_state == 5 )
        {
            var_6 ffsm_landed_stateenter();

            if ( var_6.ffsm_state != 5 )
                var_6.ffsm_state = 3;
            else
                var_6.ffsm_state = 6;
        }
        ...
        var_9 = var_6 isonground() && ( var_6.ffsm_state == 3 || var_6 isskydivestatedisabled() );
        var_10 = var_6 isonladder();

        if ( var_8 || var_9 || var_10 )
        {
            var_6 ffsm_onground_stateenter();
            var_6.ffsm_state = undefined;
            var_6.ffsm_isgulagrespawn = undefined;
            var_6.ffsm_nextstreamhinttime = undefined;
...
ffsm_introsetup( var_0, var_1, var_2, var_3, var_4 )
{
    self skydive_interrupt();
    ...
    if ( level.gametype == "br" && ( !istrue( self.ffsm_isgulagrespawn ) || getdvar( "scr_br_gametype", "" ) == "dmz" ) )
        thread infilparachutevfx( getdvarint( "scr_bmo_parachuteTouchdownVFX", 1 ) == 1 && getdvar( "scr_br_gametype", "" ) == "dmz" );
