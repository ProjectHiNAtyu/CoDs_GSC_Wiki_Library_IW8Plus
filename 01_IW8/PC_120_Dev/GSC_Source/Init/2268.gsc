...
vehicle_docollisiondamage( var_0, var_1 )
{
    if ( vehicle_shoulddocollisiondamage( var_0, var_1 ) )
    {
...
vehicle_shoulddocollisiondamage( var_0, var_1 )
{
    if ( level.teambased )
    {
...
vehicle_preventcollisiondamagefortimeafterexit( var_0, var_1 )
{
    ...
    vehicle_preventcollisiondamagefortimeafterexitinternal( var_1 );
    thread vehicle_clearpreventcollisiondamagefortimeafterexit( var_1 );
}

vehicle_preventcollisiondamagefortimeafterexitinternal( var_0 )
{
    var_0 endon( "death" );
    wait 2;
}

vehicle_clearpreventcollisiondamagefortimeafterexit( var_0 )
{
    var_0 notify( "vehicle_preventCollisionDamageForTimeAfterExit" );
    var_0.vehiclecollisionignorearray = undefined;
}

vehicle_shouldignorecollisiondamage( var_0, var_1, var_2, var_3 )
{
...
vehicle_playerkilledbycollision( var_0 )
{
    ...
    if ( var_0.inflictor.vehiclename == "little_bird" || var_0.inflictor.vehiclename == "loot_chopper" || var_0.inflictor.vehiclename == "magma_plunder_chopper" )
