...
isvalidattachmentunlock( var_0, var_1 )
{
    ...
    if ( var_2 )
        return scripts\mp\utility\weapon::attachmentisselectablerootname( var_0, var_1 );
...
validateloadout( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
        var_2 = 1;
    else if ( isweaponuihidden( var_0.loadoutprimary ) )
        var_2 = 1;
    ...
    if ( weaponisrestricted( var_0.loadoutprimary ) )
    {
        var_2 = 1;
        var_3 = 1;
    }
    ...
    {
        if ( isweaponvariantlocked( var_0.loadoutprimary, var_0.loadoutprimaryvariantid ) )
            var_0.loadoutprimaryvariantid = -1;
        ...
        for ( var_5 = 0; var_5 < var_0.loadoutprimaryattachments.size; var_5++ )
        {
            ...
            if ( isattachmentvariantinvalid( var_0.loadoutprimary, var_0.loadoutprimaryvariantid, var_6, var_7 ) )
                var_0.loadoutprimaryattachmentids[var_5] = 0;

            if ( var_6 != "none" && ( attachmentisrestricted( var_6 ) || !isvalidattachmentunlock( var_0.loadoutprimary, var_6 ) ) )
            {
    ...
    if ( !isdefined( var_1 ) )
        var_2 = 1;
    else if ( isweaponuihidden( var_0.loadoutsecondary ) )
        var_2 = 1;

    var_8 = "specialty_munitions_2";
    var_9 = !perkisrestricted( var_8 ) && scripts\engine\utility::array_contains( var_0.loadoutperks, var_8 );

    if ( scripts\mp\utility\weapon::iscacprimaryweapon( var_0.loadoutsecondary ) && !var_9 )
        var_2 = 1;

    if ( weaponisrestricted( var_0.loadoutsecondary ) )
    {
        var_2 = 1;
        var_3 = 1;
    }
    ...
    {
        if ( isweaponvariantlocked( var_0.loadoutsecondary, var_0.loadoutsecondaryvariantid ) )
            var_0.loadoutsecondaryvariantid = -1;
        ...
        for ( var_5 = 0; var_5 < var_0.loadoutsecondaryattachments.size; var_5++ )
        {
            ...
            if ( isattachmentvariantinvalid( var_0.loadoutsecondary, var_0.loadoutsecondaryvariantid, var_6, var_7 ) )
                var_0.loadoutsecondaryattachmentids[var_5] = 0;

            if ( var_6 != "none" && ( attachmentisrestricted( var_6 ) || !isvalidattachmentunlock( var_0.loadoutsecondary, var_6 ) ) )
            {
    ...
    if ( var_0.loadoutextraperks.size != 0 )
    {
        foreach ( var_23, var_14 in var_0.loadoutextraperks )
        {
            ...
            while ( perkisrestricted( var_22 ) || scripts\engine\utility::array_contains( var_0.loadoutperks, var_22 ) || scripts\engine\utility::array_contains( var_20, var_22 ) )
            {
    ...
    if ( !scripts\mp\equipment::isequipmentprimary( var_0.loadoutequipmentprimary ) || !scripts\mp\equipment::isequipmentselectable( var_0.loadoutequipmentprimary ) )
        var_0.loadoutequipmentprimary = "equip_frag";
    else if ( equipmentisrestricted( var_0.loadoutequipmentprimary ) )
    {
        var_0.loadoutequipmentprimary = "equip_frag";
        var_3 = 1;
    }

    if ( !scripts\mp\equipment::isequipmentsecondary( var_0.loadoutequipmentsecondary ) || !scripts\mp\equipment::isequipmentselectable( var_0.loadoutequipmentsecondary ) )
        var_0.loadoutequipmentsecondary = "equip_flash";
    else if ( equipmentisrestricted( var_0.loadoutequipmentsecondary ) )
    {
        var_0.loadoutequipmentsecondary = "equip_flash";
        var_3 = 1;
    }
    ...
    {
        if ( killstreakisrestricted( var_25[var_5] ) )
            var_25[var_5] = "none";
    }
    ...
    if ( !var_24 )
    {
        if ( killstreakisrestricted( var_0.loadoutkillstreak1 ) )
        {
            var_0.loadoutkillstreak1 = var_25[0];
            var_3 = 1;
        }

        if ( killstreakisrestricted( var_0.loadoutkillstreak2 ) )
        {
            var_0.loadoutkillstreak2 = var_25[1];
            var_3 = 1;
        }

        if ( killstreakisrestricted( var_0.loadoutkillstreak3 ) )
        {
...
validateattachments( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_17, var_12 in var_1 )
    {
        ...
        if ( isdefined( var_12 ) && var_12 != "none" )
        {
            ...
            if ( !scripts\mp\utility\weapon::attachmentisselectable( var_3, var_12 ) )
            {
...
isweaponuihidden( var_0 )
{
    return isdefined( level.weaponmapdata[var_0] ) && istrue( level.weaponmapdata[var_0].uihidden );
}
...
isweaponvariantlocked( var_0, var_1 )
{
    ...
    var_2 = var_0 + "|" + var_1;
    return isdefined( level.weaponlootmapdata[var_2] ) && istrue( level.weaponlootmapdata[var_2].islocked );
}

isattachmentvariantinvalid( var_0, var_1, var_2, var_3 )
{
    if ( scripts\mp\utility\game::isanymlgmatch() )
        return 1;
    ...
    for (;;)
    {
        ...
        {
            if ( !level.weaponlootmapdata[var_10].islocked )
            {
