...
{
    var_0 = self getplayerdata( level.loadoutsgroup, "customizationSetup", "operatorWatch" );
    return scripts\mp\accessories::getaccessorylogicbyindex( var_0 );
}
...
table_getaddblueprintattachments( var_0, var_1 )
{
    var_2 = tablelookup( var_0, 0, "loadoutAddBlueprintAttachments", var_1 + 1 );

    if ( var_2 == "" )
        return 0;
    else
        return istrue( int( var_2 ) );
}
...
table_getweaponvariantid( var_0, var_1, var_2 )
{
    var_3 = undefined;

    if ( var_2 == 0 )
        var_3 = tablelookup( var_0, 0, "loadoutPrimaryVariantID", var_1 + 1 );
    else
        var_3 = tablelookup( var_0, 0, "loadoutSecondaryVariantID", var_1 + 1 );
...
loadout_copyclassstruct( var_0 )
{
    ...
    if ( isdefined( var_0.loadoutaddblueprintattachments ) )
        var_1.loadoutaddblueprintattachments = var_0.loadoutaddblueprintattachments;
    ...
    var_1.iscopiedclass = var_0.iscopiedclass;
...
loadout_updateclasscustom( var_0, var_1 )
{
    ...
    for ( var_3 = 0; var_3 < 5; var_3++ )
    {
        ...
        var_0.loadoutprimaryattachmentids[var_3] = cac_getweaponattachmentid( var_2, 0, var_3 );
    }
    ...
    for ( var_3 = 0; var_3 < 5; var_3++ )
    {
        ...
        var_0.loadoutsecondaryattachmentids[var_3] = cac_getweaponattachmentid( var_2, 1, var_3 );
    }
    ...
    var_0.loadoutaccessorylogic = cac_getaccessorylogic();
    var_0.loadoutstreaksfilled = 1;
...
loadout_updateclassgamemode( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["loadoutAddBlueprintAttachments"] ) )
        var_0.loadoutaddblueprintattachments = var_3["loadoutAddBlueprintAttachments"];
    ...
    if ( isdefined( var_3["loadoutPrimaryVariantID"] ) && scripts\mp\utility\game::getgametype() == "arena" && var_3["loadoutPrimaryVariantID"] != -1 )
    ...
    var_0.loadoutextraperksfromgamemode = isdefined( var_3["loadoutExtraPerks"] );
...
loadout_updateclasscallback( var_0 )
{
    ...
    if ( isdefined( var_1["loadoutAddBlueprintAttachments"] ) )
        var_0.loadoutaddblueprintattachments = var_1["loadoutAddBlueprintAttachments"];
...
loadout_updateclassdefault( var_0, var_1 )
{
    ...
    if ( self scriptablegetmidpoint() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
        loadout_updateclassdefault_weaponsheadless( var_0 );
    else
        loadout_updateclassdefault_weapons( var_0, var_2 );
...
loadout_updateclassdefault_weapons( var_0, var_1 )
{
...
loadout_updateclassdefault_weaponsheadless( var_0 )
{
    if ( !isdefined( self.headlessloadoutindexprimary ) )
    {
        ...
        {
            var_1 = randomint( 200 );
            level.headlessloadoutindexprimary = var_1;
            level.headlessloadoutindexsecondary = var_1;
        }
        else
        {
    ...
    var_2 = loadout_updateclassdefault_headlessgetweaponn( self.headlessloadoutindexprimary, 1 );
    var_3 = loadout_updateclassdefault_headlessgetweaponn( self.headlessloadoutindexsecondary, 0 );
    var_4 = var_2[0];
    var_5 = var_2[1];
    var_6 = var_3[0];
    var_7 = var_3[1];
...
loadout_updateclassdefault_headlessgetweaponn( var_0, var_1 )
{
    var_2 = 0;
    var_3 = -1;
    ...
    for (;;)
    {
        foreach ( var_7, var_5 in level.weaponlootmapdata )
        {
            if ( var_5.variantid == 0 || var_5.islocked || !isdefined( var_5.attachcustomtoidmap ) )
                continue;

            var_6 = strtok( var_7, "|" )[0];

            if ( var_1 != scripts\mp\utility\weapon::iscacprimaryweapon( var_6 ) )
                continue;
...
loadout_updateabilities( var_0, var_1 )
{
    ...
    if ( var_0.loadoutperksfromgamemode )
    {
        ...
        if ( var_0.loadoutextraperksfromgamemode )
...
loadout_updateglobalclass( var_0, var_1 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "custom":
            break;
        case "gamemode":
            loadout_updateglobalclassgamemode( var_0, var_1 );
            break;
        case "callback":
            break;
        case "default":
...
{
    if ( self scriptablegetmidpoint() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && scripts\mp\utility\game::getgametype() != "br" )
    ...
    if ( isdefined( level.modeupdateloadoutclass ) )
        self [[ level.modeupdateloadoutclass ]]( var_0 );
...
loadout_updateclassfinalweapons( var_0 )
{
    if ( istrue( var_0.loadoutaddblueprintattachments ) )
        var_0.loadoutprimaryobject = buildweapon_blueprintwithcustomattachments( var_0.loadoutprimary, var_0.loadoutprimaryattachments, var_0.loadoutprimarycamo, var_0.loadoutprimaryreticle, var_0.loadoutprimaryvariantid, var_0.loadoutprimaryattachmentids, var_0.loadoutprimarycosmeticattachment, var_0.loadoutprimarystickers, istrue( var_0.loadouthasnvg ) );
    else
    ...
    var_0.loadoutprimaryfullname = getcompleteweaponname( var_0.loadoutprimaryobject );
    ...
    else
    {
        ...
        var_0.loadoutsecondaryfullname = getcompleteweaponname( var_0.loadoutsecondaryobject );
    }
...
loadout_updateplayerweapons( var_0, var_1, var_2, var_3 )
{
    ...
    loadout_updateammo( var_0, var_7, var_8, var_4, var_5, var_6 );
...
loadout_finalizeweapons()
{
    ...
    var_0 = respawnitems_getrespawnitems();
    var_1 = respawnitems_hasweapondata( var_0 );
    loadout_updateammo( self.classstruct, self.primaryweaponobj, self.secondaryweaponobj, var_0, var_1, level.magcount );
}
...
loadout_giveprimaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = loadout_giveweaponobj( "primary", var_0.loadoutprimaryobject, var_1, var_2 );
...
loadout_givesecondaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = loadout_giveweaponobj( "secondary", var_0.loadoutsecondaryobject, var_1, var_2 );
...
loadout_giveweaponobj( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    if ( !isundefinedweapon( var_4 ) )
    {
        if ( var_4.basename == "iw8_me_riotshield_mp" && !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) && !istrue( self.infilweaponraise ) )
        {
...
loadout_updatebrammo( var_0, var_1 )
{
    var_2 = scripts\mp\gametypes\br_weapons::br_ammo_type_for_weapon( var_0 );
    ...
    if ( isdefined( var_2 ) )
        scripts\mp\gametypes\br_weapons::br_ammo_give_type( self, var_2, var_6 );
}

loadout_updateammo( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = [];
    ...
    foreach ( var_8 in var_6 )
        var_8.hasmaxammo = var_8 hasattachment( "maxammo" );

    if ( scripts\mp\utility\game::getsubgametype() == "dmz" )
    {
        foreach ( var_8 in var_6 )
            loadout_updatebrammo( var_8, istrue( var_8.hasmaxammo ) );
    }
    else if ( var_4 )
    {
    ...
    else
    {
        ...
        if ( var_6.size >= 2 )
        {
            var_12 = getweaponammopoolname( var_0.loadoutprimaryobject ) == getweaponammopoolname( var_0.loadoutsecondaryobject );

            if ( istrue( var_0.loadoutprimaryobject.hasmaxammo ) )
                var_13 = weaponmaxammo( var_0.loadoutprimaryobject ) - weaponclipsize( var_0.loadoutprimaryobject );
            else
                var_13 = weaponstartammo( var_0.loadoutprimaryobject ) - weaponclipsize( var_0.loadoutprimaryobject );

            if ( istrue( var_0.loadoutsecondaryobject.hasmaxammo ) )
                var_14 = weaponmaxammo( var_0.loadoutsecondaryobject ) - weaponclipsize( var_0.loadoutsecondaryobject );
            else
                var_14 = weaponstartammo( var_0.loadoutsecondaryobject ) - weaponclipsize( var_0.loadoutsecondaryobject );

            if ( var_12 )
                self setweaponammostock( var_0.loadoutprimaryobject, var_13 + var_14 );
            else
            {
                self setweaponammostock( var_0.loadoutprimaryobject, var_13 );
                self setweaponammostock( var_0.loadoutsecondaryobject, var_14 );
            }
        }
    ...
    if ( !var_4 && var_5 == 3 )
    {
        foreach ( var_8 in var_6 )
        {
            ...
            {
                var_18 = var_8 getaltweapon();
                var_19 = weaponclass( var_18 );

                if ( var_19 == "grenade" && istrue( var_8.hasmaxammo ) )
                    self setweaponammostock( var_18, 1 );
                else if ( var_19 == "spread" )
                    self setweaponammoclip( var_18, scripts\engine\utility::ter_op( istrue( var_8.hasmaxammo ), 8, 6 ) );

                continue;
            }

            if ( scripts\mp\utility\weapon::isakimbo( var_8 ) )
...
loadout_updateplayerperks( var_0 )
{
    ...
    self setclientomnvar( "ui_trait_ref", scripts\mp\perks\perks::getperkid( self.pers["loadoutRigTrait"] ) );
    ...
    if ( scripts\mp\utility\dvars::getintproperty( "scr_showperksonspawn", 1 ) == 1 && game["state"] != "postgame" )
...
loadout_updateplayerkillstreaks( var_0, var_1 )
{
    ...
    var_6 = [ var_0.loadoutkillstreak1, var_0.loadoutkillstreak2, var_0.loadoutkillstreak3 ];

    if ( level.allowkillstreaks )
    {
        self.pers["hackedStreaks"] = 0;
        var_6 = replacetankwithwheelson( var_0 );
    }

    self.loadoutusingspecialist = var_0.loadoutusingspecialist;
    self getbeingrevived( self.loadoutusingspecialist );

    if ( var_0.loadoutusingspecialist && level.allowkillstreaks )
        var_6 = replacewithspecialistkillstreaks( var_0 );

    var_7 = respawnitems_getrespawnitems();
    var_8 = respawnitems_hasstreakdata( var_7 );

    if ( var_8 && level.allowkillstreaks )
        var_6 = respawnitems_getstreaks( var_7 );

    if ( level.allowkillstreaks )
        var_6 = sortkillstreaksbycost( var_6 );

    if ( !isagent( self ) )
    {
        var_9 = scripts\mp\killstreaks\killstreaks::arekillstreaksequipped( var_6 );

        if ( !var_9 )
        {
            self notify( "givingLoadout" );
            var_10 = scripts\mp\killstreaks\killstreaks::getgimmeslotkillstreakstructs();
            var_11 = scripts\mp\killstreaks\killstreaks::getavailableequippedkillstreakstructs();
            ...
            for ( var_12 = 0; var_12 < var_6.size; var_12++ )
            {
                ...
                if ( isdefined( var_13 ) && var_13 != "none" && var_13 != "" )
                    scripts\mp\killstreaks\killstreaks::equipkillstreak( var_13, var_12 + 1 );
            }
            ...
            for ( var_14 = var_10.size - 1; var_14 >= 0; var_14-- )
            {
                ...
                if ( !var_13.isspecialist )
                    scripts\mp\killstreaks\killstreaks::awardkillstreakfromstruct( var_10[var_14] );
            }
            ...
            for ( var_14 = 0; var_14 < var_11.size; var_14++ )
            {
                ...
                if ( !var_13.isspecialist )
                    scripts\mp\killstreaks\killstreaks::awardkillstreakfromstruct( var_11[var_14] );
            }
        }
    }
...
loadout_updatefieldupgrades( var_0, var_1 )
{
    ...
    if ( level.allowsupers )
    {
        ...
        {
            var_2 = fixsuperforbr( self.loadoutfieldupgrade1 );
            scripts\mp\gametypes\br_pickups::forcegivesuper( var_2 );
        }
    }
...
setmlgspectatorclientloadoutdata( var_0, var_1 )
{
    ...
    var_0 ismlgaerialcamenabled();
    var_0 isholdingbreath( level.laststand );
...
giveloadout( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = loadout_getglobalclassstruct();
    var_5 = loadout_updateglobalclass( var_5, var_1 );
    self.globalstruct = var_5;
    var_6 = undefined;
...
loadout_lognewlygivenloadout( var_0, var_1, var_2 )
{
    ...
    if ( var_8 == -1 || var_1.iscopiedclass )
    {
...
trackriotshield_grenadepullbackforc4()
{
    for (;;)
    {
        ...
        if ( !isnullweapon( var_0 ) && var_0.basename == "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) )
...
trackriotshield_updateoffhandstowignorec4()
{
    if ( !istrue( self.onriotshieldstow_force ) )
    {
        ...
        if ( !isnullweapon( var_0 ) && var_0.basename != "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) && istwohandedoffhand( var_0 ) )
            self.onriotshieldstow_force = 1;
    }
}

trackriotshield_monitorshieldattach( var_0 )
{
...
buildweapon_blueprintwithcustomattachments( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    foreach ( var_16, var_13 in var_10 )
    {
        ...
        var_15 = scripts\mp\utility\weapon::attachmentmap_toblocks( var_14 );
    ...
    if ( isdefined( var_1 ) )
    {
        foreach ( var_19, var_16 in var_1 )
        {
            ...
            {
                var_14 = scripts\mp\utility\weapon::attachmentmap_tounique( var_16, var_9 );
                var_15 = scripts\mp\utility\weapon::attachmentmap_tocategory( var_14 );
...
buildweapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_13 = makeweapon( var_9, [], undefined, var_2, var_4 );
...
buildweaponuniqueattachmenttoidmap( var_0, var_1, var_2 )
{
    ...
    foreach ( var_20, var_8 in var_6 )
    {
        ...
        if ( !isdefined( var_13 ) && iscaliberattachment( var_19 ) )
            var_13 = var_20;

        if ( !var_12 && ( issilencerattach( var_19 ) || issilencedbarrel( var_20 ) ) )
            var_12 = 1;
    }
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0.operatorcustomization ) && isdefined( var_0.operatorcustomization.gender ) && var_0.operatorcustomization.gender == "female" )
            var_0 setentitysoundcontext( "gender", "female" );
        else
            var_0 setentitysoundcontext( "gender", "" );

        var_0 stoplocalsound( "deaths_door_death" );

        if ( isdefined( var_0.operatorsfx ) )
        {
            var_0 clearsoundsubmix( "iw8_mp_spawn_camera" );
            var_0.operatorsfx stoploopsound( self.operatorsfxalias );
            var_0.operatorsfx delete();
            var_0.operatorsfx = undefined;
            var_0.operatorsfxalias = undefined;
        }
...
loadout_getorbuildclassstruct( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( !isdefined( var_2.loadoutprimaryobject ) && isdefined( var_2.loadoutprimaryfullname ) )
            var_2.loadoutprimaryobject = makeweaponfromstring( var_2.loadoutprimaryfullname );

        if ( !isdefined( var_2.loadoutsecondaryobject ) && isdefined( var_2.loadoutsecondaryfullname ) )
            var_2.loadoutsecondaryobject = makeweaponfromstring( var_2.loadoutsecondaryfullname );
    }
...
{
    var_0 = loadout_getglobalclassstruct();
    loadout_updateglobalclassstruct();
    var_1 = loadout_getglobalclassstruct();
...
copyclassfornextlife( var_0 )
{
    ...
    self.pers["copiedClass"] = loadout_copyclassstruct( var_1 );
...
loadout_fixcopiedclassstruct( var_0, var_1 )
{
    var_0.loadoutsuper = var_1.loadoutsuper;
