...
onplayerconnect()
{
    ...
    for (;;)
    {
        ...
        scripts\cp_mp\utility\killstreak_utility::updateuavstatus();
...
tryuseuavfromstruct( var_0 )
{
    ...
    var_1 = scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_dogesturedeploy( var_0, makeweapon( "ks_gesture_generic_mp" ) );
...
launchuav( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.gametype == "br" )
        var_0 uav_dangernotifyplayersinbrrange( var_4, 15000, var_1 );
    ...
    if ( isent( var_6 ) )
    {
        ...
        if ( var_6.uavtype == "directional_uav" )
    ...
    if ( var_6.damagetaken < var_6.maxhealth )
    {
        if ( isent( var_6 ) )
        {
            var_6 unlink();
            var_6.destpoint = var_6.origin + anglestoforward( var_6.angles ) * 50000;
            var_6 moveto( var_6.destpoint, 50 );
        ...
        if ( var_6.damagetaken < var_6.maxhealth )
        {
            ...
            if ( isent( var_6 ) )
                var_6 moveto( var_6.destpoint, 15 );
        }
    ...
    var_6.streakinfo.expiredbydeath = !istrue( var_6.leftplayspace );

    if ( !istrue( self.recordedgameendstats ) )
        var_6.owner scripts\cp_mp\utility\killstreak_utility::recordkillstreakendstats( var_6.streakinfo );
...
damagetracker()
{
    ...
    for (;;)
    {
        ...
        {
            if ( self.uavtype == "directional_uav" && ( var_4 == "MOD_RIFLE_BULLET" || var_4 == "MOD_PISTOL_BULLET" || var_4 == "MOD_EXPLOSIVE_BULLET" ) )
                continue;
            ...
            if ( self.damagetaken >= self.maxhealth )
            {
                ...
                {
                    var_18 = level.uavsettings[self.uavtype].calloutdestroyed;
                    var_19 = "destroyed_" + self.uavtype;
                    ...
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "damage", "onKillstreakKilled" ) )
                        self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "damage", "onKillstreakKilled" ) ]]( self.uavtype, var_1, var_9, var_4, var_0, "destroyed_" + self.uavtype, var_19, var_18 );
...
updateteamuavstatus( var_0, var_1 )
{
    ...
    var_2 = int( max( min( var_2, level.uavbestid ), level.uavworstid ) );
    var_3 = var_2 == level.uavworstid;
    var_4 = !var_3;
    var_5 = var_2 >= level.uavdirectionalid;
    var_6 = !var_3;

    if ( var_2 == level.uavnoneid )
    {
        var_7 = "normal_radar";
        var_4 = 0;
    }
    else if ( var_2 == level.uavbestid || var_5 )
        var_7 = "constant_radar";
    else if ( var_2 == level.uavfastsweepid )
        var_7 = "fast_radar";
    else
        var_7 = "normal_radar";
...
updateplayersuavstatus()
{
    foreach ( var_1 in level.players )
    {
        ...
        if ( var_2 >= level.uavfastsweepid )
            var_1.radarmode = "fast_radar";
        else
            var_1.radarmode = "normal_radar";

        var_1.radarshowenemydirection = var_2 >= level.uavdirectionalid;
...
watchhighlightfadetime( var_0, var_1, var_2, var_3 )
{
    ...
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::waittill_any_timeout_no_endon_death_1( var_2, "leave" );
...
uav_dangernotifyplayersinbrrange( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) || var_2 != "uav" )
        return;

    var_3 = uav_getenemyplayersinrange( var_0, var_1 );
...
uav_getenemyplayersinrange( var_0, var_1 )
{
    var_2 = [];
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        foreach ( var_8 in var_6 )
        {
            if ( var_2.size > 0 )
            {
                var_9 = uav_isenemygettingnotified( var_8, var_2 );
...
uav_isenemygettingnotified( var_0, var_1 )
{
    var_2 = 0;
