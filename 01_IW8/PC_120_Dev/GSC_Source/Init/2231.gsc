...
gunship_startuse( var_0, var_1 )
{
    ...
    var_9 thread gunship_watchgameend( var_0 );
    var_9 thread gunship_watchownerexitaction( var_0, "disconnect" );
    var_9 thread gunship_watchownerexitaction( var_0, "joined_team" );
    var_9 thread gunship_watchownerexitaction( var_0, "joined_spectators" );
    var_9 thread gunship_watchownerexitaction( var_0, "team_kill_punish" );
...
gunship_playintro( var_0, var_1, var_2, var_3 )
{
    ...
    if ( gunship_islargemap() )
    {
        if ( level.gametype == "arm" )
        {
            ...
            level.gunship.origin = level.gunship_origin_override;
        else
    ...
    level.gunship_intromodel thread gunship_watchintrodisown( "disconnect", var_1 );
    level.gunship_intromodel thread gunship_watchintrodisown( "joined_team", var_1 );
    level.gunship_intromodel thread gunship_watchintrodisown( "joined_spectators", var_1 );
    waitframe();
...
gunship_watchintrodisown( var_0, var_1 )
{
    self endon( "death" );
    ...
    gunship_detachplayerfromintro( var_2, var_1 );
}

gunship_detachplayerfromintro( var_0, var_1 )
{
    var_2 = 0;
...
gunship_watchownerexitaction( var_0, var_1 )
{
    self endon( "death" );
    self endon( "crashing" );
    self endon( "leaving" );
