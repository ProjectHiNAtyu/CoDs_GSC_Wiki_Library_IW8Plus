...
empdrone_createdrone( var_0, var_1 )
{
    ...
    var_3 = scripts\cp_mp\utility\weapon_utility::_magicbullet( makeweapon( "emp_drone_proj_mp" ), var_2.startpos, var_2.targetpos, self );
...
empdrone_explodeemp()
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        var_9 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_instanceisregistered( var_5 );
