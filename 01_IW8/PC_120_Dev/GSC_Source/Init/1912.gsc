...
getspawnpoint( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_9.usingfallback = 0;
    var_10 = var_9.usingfallback;
    ...
    if ( !istrue( level.disablespawncamera ) && !istrue( var_0.skipspawncamera ) && var_9.bucket >= 2 && var_9.threatsight < 300 )
        var_0.shouldgetnewspawnpoint = 1;
...
clearcodefactors()
{
    foreach ( var_2, var_1 in level.spawnglobals.factors )
        registerspawnfactor( var_2, 0.0 );
}

registercodefactors( var_0 )
{
    foreach ( var_3, var_2 in var_0 )
        registerspawnfactor( var_3, var_2 );
...
setactivespawnlogic( var_0, var_1 )
{
    ...
    if ( istrue( var_2.criticalfactortypes[var_1]["frontline"] ) )
    {
        ...
        if ( isdefined( var_7 ) && isdefined( var_7.anchordir ) && isdefined( var_7.primaryanchorpos ) )
            enablefrontlinecriticalfactor( var_7.anchordir, var_7.primaryanchorpos );
        else
...
getspawnpointarray( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        level.spawnpointarray[var_0] = level.scriptedspawnpointarray[var_0];
        return level.spawnpointarray[var_0];
    }

    if ( isdefined( level.scriptedspawnpointarray ) && isdefined( level.scriptedspawnpointarray[var_0] ) )
        var_8 = scripts\engine\utility::array_combine( var_8, level.scriptedspawnpointarray[var_0] );
...
getspawnpointfromcode()
{
    ...
    dlog_recordevent( "mp_spawn_event", [ "score", var_0.score, "threatsight", var_0.threatsight, "totalscore", var_0.totalscore, "spawnx", var_0.origin[0], "spawny", var_0.origin[1], "spawnz", var_0.origin[2] ] );
...
influencepoint_add( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    {
        if ( isdefined( var_6 ) )
            var_10 = createspawninfluencepoint( var_0, var_1, var_2, var_3, var_5, var_6 );
        else
            var_10 = createspawninfluencepoint( var_0, var_1, var_2, var_3, var_5 );
    }
    else
        var_10 = createspawninfluencepoint( var_0, var_1, var_2, var_3 );
...
influencepoint_remove( var_0 )
{
    ...
    destroyspawninfluencepoint( var_1 );
...
finalizespawnpointchoice( var_0 )
{
    ...
    {
        if ( !isdefined( var_0.usingfallback ) )
            var_0.usingfallback = 0;
        ...
        self finalizespawnpointchoiceforplayer( var_0.index, var_0.bucket, var_0.usingfallback, var_0.threatsight, var_0.damagemod );
    }
...
getoriginidentifierstringnoz( var_0 )
{
...
checkmodifiedspawnpoint( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        var_2 = getoriginidentifierstringnoz( var_0 );
...
enablespawnpointlist( var_0 )
{
    foreach ( var_2 in var_0 )
        enablespawnpointbyindex( var_2.index );
}

disablespawnpointlist( var_0 )
{
    foreach ( var_2 in var_0 )
        disablespawnpointbyindex( var_2.index );
}
...
activatespawnset( var_0, var_1 )
{
    ...
    if ( isarray( var_3 ) )
        ...
        enablespawnpointsbyclassname( var_3 );
...
deactivatespawnset( var_0 )
{
    ...
    foreach ( var_6, var_4 in var_1.activespawnsets )
    {
        ...
        if ( isarray( var_5 ) )
            ...
            disablespawnpointsbyclassname( var_5 );
    }
...
addscriptedspawnpoints( var_0 )
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( !isdefined( level.scriptedspawnpointarray[var_3] ) )
            level.scriptedspawnpointarray[var_3] = [];

        var_8 = spawnstruct();
        var_8.classname = var_3;
        var_8.origin = var_4;
        var_8.angles = var_5;
        var_9 = registerscriptedspawnpoints( var_3, var_4, var_5, var_6, var_7 );
        ...
        level.scriptedspawnpointarray[var_3][level.scriptedspawnpointarray[var_3].size] = var_8;
    }
...
scriptedspawnpointsonmigration()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in level.scriptedspawnpointarray )
        {
            foreach ( var_3 in var_1 )
            {
                ...
                var_6 = registerscriptedspawnpoints( var_3.classname, var_3.origin, var_3.angles, var_4, var_5 );
            }
        }
    }
}
