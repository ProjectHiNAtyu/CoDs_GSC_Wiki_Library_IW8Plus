...
vehicle_killriders()
{
    ...
    foreach ( var_1 in self.riders )
    {
        ...
        if ( isdefined( var_1._blackboard ) && isdefined( var_1._blackboard.chosenvehicleanimpos ) && istrue( var_1._blackboard.chosenvehicleanimpos.death_impulse ) )
        {
            var_2 = 100.0;
        ...
        if ( scripts\common\utility::iscp() && isdefined( self.damage_data ) )
        {
            if ( isdefined( self.damage_data.attacker ) && isplayer( self.damage_data.attacker ) )
                var_1 dodamage( var_1.maxhealth, self.damage_data.attacker.origin, self.damage_data.attacker, self.damage_data.attacker, self.damage_data.meansofdeath, self.damage_data.objweapon );
            else
                var_1 kill();
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        foreach ( var_11 in self.riders )
        {
            if ( isalive( var_11 ) && isdefined( var_6[var_11.vehicle_position] ) )
            {
                ...
                if ( isdefined( var_8 ) && istrue( var_8.do_not_unload ) )
                    continue;
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            if ( scripts\engine\utility::func_ref_exist( "vehicle_damage_modifier" ) )
            {
                ...
                if ( isdefined( level.fn_damage_pack ) )
                    var_15 = [[ level.fn_damage_pack ]]( var_3, self, var_2, var_11, var_6, undefined, var_5, var_4, var_7, var_9, var_8, var_10 );

                if ( isdefined( var_15 ) )
                    self.damage_data = var_15;
                else
