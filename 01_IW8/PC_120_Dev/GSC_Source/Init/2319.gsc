...
{
    thread trophy_delete( 0.1, var_0 );
    self setscriptablepartstate( "effects", "activeDestroyEnd", 0 );
}

trophy_shutdownanddestroy( var_0 )
{
    thread trophy_delete( 2.6, var_0 );
    self setscriptablepartstate( "effects", "activeDestroyStart", 0 );
    wait 2.5;
    self setscriptablepartstate( "effects", "activeDestroyEnd", 0 );
}

trophy_delete( var_0, var_1 )
{
    self notify( "death" );
    self setscriptablepartstate( "hack_usable", "off" );
    self.owner scripts\cp_mp\challenges::onfieldupgradeend( "super_trophy", self.usedcount );
...
trophy_watchprotection()
{
    ...
    while ( isdefined( self.owner ) )
    {
        ...
        var_2[2] = level.mines;
        var_2[3] = level.projectilekillstreaks;
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            if ( distancesquared( var_5.origin, self.origin ) > trophy_modifiedprotectiondistsqr( var_5, 105625 ) )
                continue;

            var_8 = physics_raycast( var_1, var_5.origin, var_0, [ self, var_5 ], 0, "physicsquery_closest" );
...
trophy_protectionsuccessful( var_0 )
{
    ...
    trophy_tryreflectsnapshot( var_0, var_0.owner, self.owner );
    var_1 = var_0.origin;
...
trophy_tryreflectsnapshot( var_0, var_1, var_2 )
{
    ...
    var_3 = var_2;
    var_4 = var_1.origin;
    var_5 = scripts\mp\equipment\snapshot_grenade::snapshot_grenade_createoutlinedata( var_3, var_4 );
    scripts\mp\equipment\snapshot_grenade::snapshot_grenade_applysnapshot( var_1, var_2, var_5 );
}
...
trophy_applyempcallback( var_0 )
{
    ...
    var_0.victim thread trophy_shutdownanddestroy( 1 );
}
...
logtrophysuccesful( var_0 )
{
    ...
    dlog_recordevent( "dlog_event_trophy_successful", [ "deploying_player", self.deployingplayer, "grenade_owner", var_0.owner, "negated_target", var_0.weapon_name ] );
}
