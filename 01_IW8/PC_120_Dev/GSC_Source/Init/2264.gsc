...
pickup_truck_init()
{
    ...
    pickup_truck_initomnvars();
    pickup_truck_initdamage();
    pickup_truck_initfx();
...
pickup_truck_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "pickup_truck", 1 );
    var_0.id = 7;
...
pickup_truck_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "pickup_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "pickup_truck" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "pickup_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "pickup_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "pickup_truck", ::pickup_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "pickup_truck_mp", 3 );
}
