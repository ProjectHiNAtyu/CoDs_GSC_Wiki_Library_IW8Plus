...
registercarryobjectpickupcheck( var_0 )
{
    self.pickupchecks[self.pickupchecks.size] = var_0;
}

checkcarryobjectpickupcheck( var_0 )
{
    var_1 = 1;

    foreach ( var_3 in self.pickupchecks )
...
setpickedup( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.carryobject ) || isdefined( self.carryweapon ) && !var_0 scripts\common\utility::is_weapon_allowed() || !checkcarryobjectpickupcheck( var_0 ) )
    {
...
setdropped( var_0 )
{
    ...
    {
        if ( isdefined( self.usehostagedrop ) )
        {
            scripts\mp\tac_ops\hostage_utility::drophostage();
            return;
        }
    ...
    if ( istrue( level.botsenabled ) || touchingdroptonavmeshtrigger( var_4 ) || level.mapname == "mp_junk" && level.gametype == "ctf" && !self.carrier touchingarbitraryuptrigger() )
        var_4 = getclosestpointonnavmesh( var_4 );

    if ( isdefined( level.bombdroploc ) )
    {
        var_4 = level.bombdroploc;
    ...
    var_10 = scripts\engine\trace::create_contents( 0, 1, 1, 1, 0, 1, 1 );
    var_11 = [];
    var_11[var_11.size] = self.visuals[0];

    if ( isdefined( self.carrier ) )
        var_11[var_11.size] = self.carrier;
    ...
    if ( isdefined( self.carrier ) && self.carrier.team != "spectator" )
    {
        ...
        var_14 = scripts\engine\trace::capsule_trace( var_8, var_9, var_12, var_13, ( 0, 0, 0 ), var_11, var_10, 0 );

        if ( isdefined( var_14["entity"] ) && isdefined( var_14["entity"].code_classname ) && var_14["entity"].code_classname == "script_vehicle" )
        {
    ...
    {
        var_14 = scripts\engine\trace::ray_trace( self.safeorigin + ( 0, 0, 20 ), self.safeorigin - ( 0, 0, 20 ), var_11, var_10, 0 );
    ...
    if ( isdefined( var_14 ) )
    {
        ...
        for ( var_24 = 0; var_24 < self.visuals.size; var_24++ )
        {
            self.visuals[var_24].origin = var_20;
            self.visuals[var_24].angles = var_23;
            self.visuals[var_24] show();
        }
        ...
        if ( isdefined( var_26 ) && !isplayer( var_26 ) && !isweapon( var_26 ) && ( isdefined( var_26.objweapon ) && !isweapon( var_26.objweapon ) ) && !isbot( var_26 ) && !isagent( var_26 ) && !scripts\mp\utility\entity::isturret( var_26 ) && ( !isdefined( var_26.classname ) || var_26.classname != "script_vehicle" && var_26.classname != "rocket" ) )
            var_25 = var_14["entity"];

        if ( isdefined( var_25 ) && isdefined( var_25.owner ) )
        {
            var_27 = var_25 getlinkedparent();
        ...
        if ( isdefined( var_25 ) )
        {
            if ( isdefined( var_25.invalid_gameobject_mover ) && var_25.invalid_gameobject_mover == 1 )
                self.resetnow = 1;
            else
            {
                for ( var_24 = 0; var_24 < self.visuals.size; var_24++ )
                    self.visuals[var_24] linkto( var_25 );

                self.trigger linkto( var_25 );
                var_28 = spawnstruct();
                var_28.carryobject = self;
                var_28.deathoverridecallback = ::carryobject_overridemovingplatformdeath;
                self.trigger thread scripts\mp\movers::handle_moving_platforms( var_28 );
            }
        }
    ...
    else
    {
        for ( var_24 = 0; var_24 < self.visuals.size; var_24++ )
        {
            self.visuals[var_24].origin = self.visuals[var_24].baseorigin;
            self.visuals[var_24].angles = self.visuals[var_24].baseangles;
            self.visuals[var_24] show();
        }
...
createuseobject( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( var_7.triggertype == "proximity" )
    {
        ...
        {
            var_7.numtouching[var_13] = 0;
            var_7.touchlist[var_13] = [];
            var_7.assisttouchlist[var_13] = [];
        }
...
stompenemyteamprogress( var_0 )
{
    if ( isdefined( self.stompeenemyprogressupdate ) )
        self [[ self.stompeenemyprogressupdate ]]( var_0 );
...
triggertouchthink( var_0 )
{
    ...
    while ( scripts\mp\utility\player::isreallyalive( self ) && isdefined( var_0.trigger ) && self istouching( var_0.trigger ) && !level.gameended )
    {
        ...
        if ( istrue( var_0.checkuseconditioninthink ) && isdefined( var_0.usecondition ) && !var_0 [[ var_0.usecondition ]]( self ) )
            break;
...
updateuiprogress( var_0, var_1 )
{
    if ( !isdefined( level.hostmigrationtimer ) )
    {
        ...
        else
        {
            ...
            if ( scripts\mp\utility\game::getgametype() == "ctf" && !isdefined( var_0.id ) || scripts\mp\utility\game::getgametype() == "blitz" && !isdefined( var_0.id ) )
            {
            ...
            if ( hasdomflags() && isdefined( var_0.id ) && ( var_0.id == "domFlag" || var_0.id == "hardpoint" || var_0.id == "bomb_site" ) )
            {
                ...
                else if ( var_1 && isdefined( self.ui_dom_securing ) && ( isdefined( var_0.stalemate ) && !var_0.stalemate && !istrue( var_0.majoritycapprogress ) ) && var_0.ownerteam != self.team )
                {
                    ...
                    if ( scripts\mp\utility\game::getgametype() == "hq" )
                    {
                        ...
                        self setclientomnvar( "ui_objective_state", var_0 scripts\mp\gametypes\obj_dom::getdomneutralizeomnvarvalue() );
                    else
                        self setclientomnvar( "ui_objective_state", 1 );
                }
                else
...
updateuisecuring( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && var_3.id == "laststand_reviver" )
        {
            ...
            scripts\mp\gametypes\br::updatesquadmemberlaststandreviveprogress( var_6, self, var_0 );
        }
    }
    else
    {
...
useholdthink( var_0 )
{
    ...
    {
        if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() )
        {
            if ( !var_0 scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) )
            {
                ...
                {
                    var_0 scripts\cp_mp\utility\player_utility::enabledemeanorsafe();
        ...
        if ( !isdefined( var_2 ) && !var_1 )
        {
            if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() )
            {
                if ( istrue( var_0.weaponsdisabledwhilereviving ) )
                {
                    ...
                    if ( !level.allowreviveweapons )
                    {
                        var_0 scripts\cp_mp\utility\player_utility::disabledemeanorsafe();
...
usetest( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( self.checkuseconditioninthink ) && isdefined( self.usecondition ) && !self [[ self.usecondition ]]( var_0 ) )
        return 0;
...
setobjectivestatusallicons( var_0, var_1, var_2, var_3, var_4 )
{
...
setobjectivestatusicons( var_0, var_1, var_2, var_3 )
{
    if ( istrue( self.lockupdatingicons ) )
        return;
...
setmlgobjectivestatusicon( var_0, var_1, var_2 )
{
    if ( !level.codcasterenabled )
        return;
...
resetmlgobjectivestatusicon( var_0, var_1 )
{
    self.compassicons["codcaster"] = undefined;
...
{
    var_3 = getupdateteams( var_0 );
    var_4 = 0;

    for ( var_5 = 0; var_5 < var_3.teams.size; var_5++ )
    {
        var_6 = var_3.teams[var_5];
        var_7 = var_6.team;

        if ( !scripts\mp\utility\teams::isgameplayteam( var_7 ) )
            continue;

        var_8 = var_6.showtoteam;

        if ( !var_8 && shouldshowcompassduetoradar( var_7 ) )
            var_8 = 1;
        ...
        if ( var_1 != -1 )
        {
            if ( level.codcasterenabled )
            {
                ...
                {
                    var_9 = getwaypointshader( self.compassicons["codcaster"] );
                    scripts\mp\objidpoolmanager::update_objective_mlgicon( var_1, var_9 );
                }
                else
                    scripts\mp\objidpoolmanager::update_objective_mlgicon_reset( var_1 );
            }

            if ( !istrue( self.visibilitymanuallycontrolled ) )
            {
                if ( !isdefined( self.compassicons["friendly"] ) || !var_8 )
                {
                    scripts\mp\objidpoolmanager::objective_teammask_removefrommask( var_1, var_7 );
                    continue;
                }
                else
                    scripts\mp\objidpoolmanager::objective_teammask_addtomask( var_1, var_7 );

                if ( !isdefined( self.compassicons["enemy"] ) || !var_8 )
                {
                    scripts\mp\objidpoolmanager::objective_teammask_removefrommask( var_1, var_7 );
                    continue;
                }
            ...
            if ( !var_4 )
            {
                var_10 = getwaypointshader( self.compassicons["friendly"] );
                scripts\mp\objidpoolmanager::update_objective_icon( var_1, var_10 );
                var_11 = getwaypointbackgroundcolor( self.compassicons["friendly"] );
                var_11 = scripts\engine\utility::ter_op( isdefined( var_11 ), var_11, "neutral" );
                var_12 = getwaypointbackgroundcolor( self.compassicons["enemy"] );
                var_12 = scripts\engine\utility::ter_op( isdefined( var_12 ), var_12, "neutral" );
                var_13 = 0;
                var_14 = getobjectivestate( var_11, var_12 );
                ...
                var_15 = getwaypointstring( self.compassicons["friendly"] );
                var_16 = getwaypointstring( self.compassicons["enemy"] );

                if ( var_14 == "neutral" || !isdefined( self.ownerteam ) )
                {
                    if ( isdefined( self.claimteam ) && self.claimteam != "none" )
                    {
                        ...
                        scripts\mp\objidpoolmanager::update_objective_setfriendlylabel( var_1, var_15 );
                        scripts\mp\objidpoolmanager::update_objective_setenemylabel( var_1, var_16 );
                    }
                    else
                    {
                        scripts\mp\objidpoolmanager::update_objective_ownerteam( var_1, undefined );
                        scripts\mp\objidpoolmanager::update_objective_setneutrallabel( var_1, var_15 );
                    }
                }
                else if ( var_14 == "claimed" )
                {
                ...
                else if ( var_14 == "contest" )
                {
                    if ( self.cancontestclaim && self.stalemate != self.wasstalemate || self.cancontestclaim && istrue( self.majoritycapprogress ) && self.majoritycapprogress != self.wasmajoritycapprogress )
                        objective_setlabel( var_1, var_15 );
                    else
                    {
                ...
                var_17 = getwaypointbackgroundtype( self.compassicons["friendly"] );
                scripts\mp\objidpoolmanager::update_objective_setbackground( var_1, var_17 );

                if ( level.codcasterenabled && isdefined( self.compassicons["codcaster"] ) )
                {
                    var_17 = getwaypointbackgroundtype( self.compassicons["codcaster"] );
                    scripts\mp\objidpoolmanager::update_objective_setmlgbackground( var_1, var_17 );
                }

                var_18 = getwaypointobjpulse( self.compassicons["friendly"] );
                scripts\mp\objidpoolmanager::objective_set_pulsate( var_1, var_18 );
...
touchingdroptonavmeshtrigger( var_0 )
{
    ...
    {
        if ( isbombmode() || scripts\mp\utility\game::getgametype() == "ctf" )
