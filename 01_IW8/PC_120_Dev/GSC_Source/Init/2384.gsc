    ...
    for (;;)
    {
        foreach ( var_1 in level.players )
        {
            ...
            else if ( !var_4 && !var_2 && var_3 )
            {
                ...
                var_1 scripts\mp\killstreaks\killstreaks::awardkillstreak( "tacops_beacon_mp" );
...
restoreweapons()
{
    ...
    foreach ( var_1 in self.restoreweaponlist )
    {
        ...
        if ( var_1.basename == "iw8_knifestab_mp" )
...
carrydebuff()
{
    ...
    self.removeweaponhostagedrop = var_3;
