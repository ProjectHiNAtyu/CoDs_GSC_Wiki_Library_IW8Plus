...
getlocalestructarray( var_0, var_1 )
{
    var_2 = scripts\engine\utility::getstructarray( var_0, "targetname" );
    var_3 = [];
...
startkeyearning()
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        var_0 = getchallengegamemode( var_1 );
    }
...
stopkeyearning( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        var_1 = getchallengegamemode( var_2 );
    }
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        else
        {
            ...
            {
                if ( level.placement["all"][var_5] != self )
                    continue;
    ...
    if ( istrue( level.ismp ) )
        self reportchallengeuserevent( "end_match", var_1, var_3, var_6, var_7, var_8, var_9 );
    else
    {
        ...
        self reportchallengeuserevent( "end_match", var_1, var_3, var_6, 0, 0, var_9 );
    }
...
removematchingents_bymodel( var_0, var_1 )
{
    var_2 = getentarray();
    ...
    foreach ( var_4 in var_2 )
    {
        if ( isdefined( var_4.model ) && var_4.model == var_0 )
        {
            if ( istrue( var_1 ) && isdefined( var_4.target ) )
                removematchingents_bykey( var_4.target, "targetname" );
...
{
    var_0 = spawnstruct();
    level.challengeandeventglobals = var_0;
    var_0.game_type_col = [];
...
getchallengegamemode( var_0 )
{
    ...
    if ( !isdefined( level.challengeandeventglobals.game_type_col ) || !isdefined( level.challengeandeventglobals.game_type_col[var_0] ) )
        return 0;

    if ( var_0 == "br" && isdefined( level.brgametype ) && isdefined( level.brgametype.name ) )
    {
    ...
    return level.challengeandeventglobals.game_type_col[var_0];
}
