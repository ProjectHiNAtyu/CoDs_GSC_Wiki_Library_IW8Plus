...
tryuseremoteuav( var_0, var_1 )
{
    ...
    if ( var_3 )
    {
        scripts\common\utility::trycall( level.matchdata_logkillstreakevent, var_1, self.origin );
...
setcarryingremoteuav( var_0 )
{
    ...
    for (;;)
    {
        var_1 = local_waittill_any_return_6( "place_carryRemoteUAV", "cancel_carryRemoteUAV", "weapon_switch_started", "force_cancel_placement", "death_or_disconnect" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::waittill_any_return_2( "death_or_disconnect", "remoteuav_unlock" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::waittill_any_return_3( "death_or_disconnect", "carried", "leaving" );
...
remoteuav_watch_distance()
{
    ...
    {
        var_0 = scripts\cp_mp\utility\killstreak_utility::getkillstreakairstrikeheightent();
