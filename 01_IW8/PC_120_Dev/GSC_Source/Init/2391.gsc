...
isfmjdamage( var_0, var_1 )
{
    ...
    {
        var_3 = scripts\mp\utility\weapon::getweaponattachmentsbasenames( var_0 );
...
{
    if ( !validshotcheck( var_0, var_2, var_3 ) )
        return 0;

    return var_1 == "head" || var_1 == "helmet";
}

istorsoshot( var_0, var_1, var_2, var_3 )
{
    if ( !validshotcheck( var_0, var_2, var_3 ) )
        return 0;

    return var_1 == "neck" || var_1 == "torso_upper" || var_1 == "torso_lower";
}

istorsouppershot( var_0, var_1, var_2, var_3 )
{
    if ( !validshotcheck( var_0, var_2, var_3 ) )
        return 0;

    return var_1 == "neck" || var_1 == "torso_upper";
}

isupperbodyshot( var_0, var_1, var_2, var_3 )
{
    if ( !validshotcheck( var_0, var_2, var_3 ) )
        return 0;
...
islowerbodyshot( var_0, var_1, var_2, var_3 )
{
    if ( !validshotcheck( var_0, var_2, var_3 ) )
        return 0;
...
validshotcheck( var_0, var_1, var_2 )
{
    if ( isdefined( var_2 ) )
    {
        if ( isdefined( var_2.owner ) )
        {
            switch ( var_2.code_classname )
            {
                case "misc_turret":
                case "script_model":
                case "script_vehicle":
...
islethalmeleeweapon( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\weapon::ismeleedefaultweapon( var_2 ) )
        return 1;
...
_suicide()
{
    ...
    if ( playershoulddofauxdeath() && !isdefined( self.fauxdead ) )
        thread scripts\mp\damage::playerkilled_internal( self, self, self, 10000, 0, "MOD_SUICIDE", nullweapon(), ( 0, 0, 0 ), "none", 0, 1116, 1 );
    else if ( !playershoulddofauxdeath() && !isdefined( self.fauxdead ) && !isdefined( self.vehicle ) )
        self suicide();
}
...
non_player_add_attacker_data( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) && isplayer( var_1 ) && !isnullweapon( var_1 getcurrentprimaryweapon() ) )
        var_3.sprimaryweapon = getcompleteweaponname( var_1 getcurrentprimaryweapon() );
    else
...
non_player_add_ignore_damage_signature( var_0, var_1, var_2, var_3 )
{
    ...
    var_5.checkobjweapon = isdefined( var_1 ) && !isnullweapon( var_1 );
