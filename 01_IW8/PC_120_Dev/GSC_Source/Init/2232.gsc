...
init()
{
    ...
    level.helperdronesettings["radar_drone_recon"].visual_range_sq = 1440000;
    ...
    level.helperdronesettings["radar_drone_overwatch"].visual_range_sq = 1440000;
    ...
    level.helperdronesettings["scrambler_drone_guard"].visual_range_sq = 1440000;
    ...
    level.helperdronesettings["ammo_drop"].visual_range_sq = 1440000;
...
weapongivenhelperdrone( var_0 )
{
    ...
    {
        var_1 = tryusehelperdroneearlyout( var_0, 1 );
...
tryusehelperdronefromstruct( var_0 )
{
    ...
    {
        var_6 = tryusehelperdroneearlyout( var_0, 1 );
    ...
    if ( var_2 == "ks_remote_drone_mp" )
    {
        var_8 = 0.6;
        var_9 = 2;
        var_10 = scripts\engine\utility::waittill_any_timeout_2( var_8, "death", "weapon_switch_started" );
        ...
        var_10 = scripts\engine\utility::waittill_any_timeout_1( var_9 - var_8, "death" );
    ...
    if ( isdefined( var_11 ) )
    {
        if ( var_5 == "scrambler_drone_guard" )
        {
            var_14 = var_11[0].location + ( 0, 0, 3000 );
            var_15 = createhelperdrone( var_14, var_12, var_5, var_0, var_1, !var_1 );
            ...
            var_15.mappointinfo = var_11;
            var_15 thread perkengineer_manageminimap();
            removeincominghelperdrone( var_0 );
            thread starthelperdrone( var_15 );
        }
    }
    else
    {
        ...
        var_15 = createhelperdrone( var_7, var_12, var_5, var_0, var_1, !var_1 );
        ...
        if ( !isdefined( var_15 ) )
        {
            ...
            helperdronecreationfailedfx( var_5, var_7 );
            var_0 notify( "killstreak_finished_with_deploy_weapon" );
    ...
    thread scripts\cp_mp\utility\killstreak_utility::playkillstreakoperatordialog( "use_" + var_0.streakname, 1, var_13 );
    var_16 = level.helperdronesettings[var_5].teamsplash;
...
helperdronecreationfailedfx( var_0, var_1 )
{
    ...
    var_2 thread delay_deletescriptable( "explode" );
}
            ...
            case "radar_drone_recon":
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
                {
                    if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() == "br" )
                    {
                        ...
                        var_9 helperdrone_notifyenemyplayersinrange( var_2 );
                    }
                }
...
helperdrone_notifyenemyplayersinrange( var_0 )
{
    ...
    var_2 = scripts\common\utility::playersincylinder( self.origin, 3000, var_1 );

    foreach ( var_4 in var_2 )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "dangerNotifyPlayer" ) )
            self.owner [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "dangerNotifyPlayer" ) ]]( var_4, var_0, 1 );
    }
}
...
helperdrone_watchscamblereffectdist( var_0 )
{
    self endon( "death" );
    self endon( "leaving" );
    self endon( "explode" );
    ...
    for (;;)
    {
        ...
        foreach ( var_10 in var_8 )
        {
            ...
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "perk", "hasPerk" ) )
                var_11 = var_10 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "perk", "hasPerk" ) ]]( "specialty_scrambler_resist" );

            var_12 = distance2dsquared( self.origin, var_10.origin );
            var_13 = var_2 * var_2;

            if ( isdefined( var_10 ) && var_12 < var_13 && var_10 scripts\cp_mp\utility\player_utility::_isalive() && !var_11 )
            {
                if ( var_1 || level.teambased && var_10.team != self.team && var_10.team != "spectator" || !level.teambased && var_10 != self.owner )
                {
                    if ( var_10 scripts\cp_mp\utility\player_utility::isusingremote() )
                        continue;

                    if ( var_10 helperdrone_entaffectedbyscramble( self, var_1 ) )
                        continue;

                    var_10 helperdrone_setscramblerjammed( 1, self, var_1 );
                    continue;
                }

                if ( isdefined( var_10.scrambledby ) && var_10.scrambledby == self )
                {
                    if ( scripts\engine\utility::array_contains( self.enemiesaffectedbyscambler, var_10 ) )
                        self.enemiesaffectedbyscambler = scripts\engine\utility::array_remove( self.enemiesaffectedbyscambler, var_10 );
                    else
                        self.enemiesaffectedbyscambler = scripts\engine\utility::array_removeundefined( self.enemiesaffectedbyscambler );
...
helperdrone_setscramblerjammed( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0 ) )
    {
        if ( isdefined( var_3.currentscramblerstrength ) )
            return;
    ...
    for (;;)
    {
        ...
        if ( var_1 == 0 || var_2 != var_1 )
        {
            ...
            if ( self.previousscramblerstrength > 1 )
                var_6 = self.previousscramblerstrength;

            if ( self.currentscramblerstrength > 1 )
                var_6 = self.currentscramblerstrength;
...
starthelperdrone( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        if ( var_2 == "br" )
            var_0 thread helperdrone_watchaltitude( self );
    }
...
helperdrone_pingnearbyenemies()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_4 in var_2 )
        {
            ...
            if ( var_4 helperdrone_isbeingpingedbydrone( self ) )
                continue;
...
helperdrone_watchpingedstatus( var_0, var_1 )
{
    ...
    self.pingedenemies[self.pingedenemies.size] = var_0;
    var_0 scripts\engine\utility::waittill_any_timeout_1( 3, "death" );
    self.pingedenemies = scripts\engine\utility::array_remove( self.pingedenemies, var_0 );
}

helperdrone_isbeingpingedbydrone( var_0 )
{
    var_1 = 0;

    foreach ( var_3 in var_0.pingedenemies )
    {
...
setreconmodesettings( var_0 )
{
    ...
    thread helperdrone_monitorcollision( var_0 );
    return 1;
}
...
setguardmode( var_0 )
{
    ...
    thread helperdrone_watchscamblereffectdist();
    return 1;
}
...
helperdrone_monitorcollision( var_0 )
{
    self.owner endon( "disconnect" );
    self endon( "death" );
    self endon( "leaving" );
    ...
    for (;;)
    {
        ...
        if ( istrue( scripts\cp_mp\utility\player_utility::playersareenemies( self.owner, var_2.owner ) ) )
        {
...
helperdrone_markplayers( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            var_2++;
            settargetmarkerstate( self.targetmarkergroup, var_5, 1 );
            ...
            if ( var_9 )
            {
                settargetmarkerstate( self.targetmarkergroup, var_5, 3 );
                continue;
            }

            if ( !var_8 || !var_6 )
            {
                settargetmarkerstate( self.targetmarkergroup, var_5, 0 );
                continue;
            }
...
helperdrone_watchouterreticletargets( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_6 in var_4 )
        {
            ...
            if ( !isindetectrange( var_6 ) )
                continue;

            if ( isreconmarked( var_6 ) )
                continue;

            if ( isinouterradius( self, var_6 ) )
                continue;

            if ( !self.owner helperdrone_istargetinreticle( var_6, 70, 300 ) )
                continue;

            thread startmarkingpassivetarget( var_6 );
        }
...
canseetarget( var_0 )
{
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        var_6 = var_5 getlinkedchildren( 1 );
...
startmarkingpassivetarget( var_0 )
{
    ...
    settargetmarkerstate( self.targetmarkergroup, var_0, 0 );
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( !self.owner helperdrone_istargetinreticle( var_0, 70, 300 ) )
            break;
...
startmarkingtarget( var_0, var_1, var_2, var_3 )
{
    ...
    settargetmarkerstate( self.targetmarkergroup, var_0, 2 );
...
{
    var_1 = scripts\cp_mp\utility\game_utility::islargemap();
...
{
    level endon( "game_ended" );
    scripts\engine\utility::waittill_any_timeout_2( var_2, "death", "explode" );
...
settargetmarkerstate( var_0, var_1, var_2 )
{
    var_3 = ( var_2 >> 0 ) % 2 == 1;
    var_4 = ( var_2 >> 1 ) % 2 == 1;
    targetmarkergroupsetentitystate( var_0, var_1, var_3 );
    targetmarkergroupsetextrastate( var_0, var_1, var_4 );
}
...
helperdrone_watchforgoal()
{
    ...
    var_0 = scripts\engine\utility::waittill_any_return_3( "goal", "near_goal", "hit_goal" );
    self.intransit = 0;
    self.inactive = 0;
...
helperdrone_watchtimeout()
{
    ...
    {
        wait( var_2 );
        self.timeout = self.timeout - var_2;
...
helperdroneexplode( var_0 )
{
    ...
    if ( isdefined( self.helperdronetype ) && self.helperdronetype == "radar_drone_recon" )
    {
    ...
    if ( isdefined( level.helperdronesettings[self.helperdronetype].fxid_explode ) )
        playfx( level.helperdronesettings[self.helperdronetype].fxid_explode, self.origin );

    if ( isdefined( level.helperdronesettings[self.helperdronetype].sound_explode ) )
        self playsound( level.helperdronesettings[self.helperdronetype].sound_explode );
...
removehelperdrone( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.owner ) )
    {
        ...
        self.streakinfo.expiredbydeath = istrue( var_2 );
...
helperdrone_returnplayer( var_0 )
{
    ...
    var_0 thread helperdrone_forcereconcontrolsoff();
...
helperdrone_forcereconcontrolsoff()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    var_0 = gettime();
...
find_safe_spawn( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        var_4 = scripts\cp_mp\utility\killstreak_utility::getkillstreakairstrikeheightent();
    ...
    var_5 = level.helperdronesettings[var_0].spawndist;
    var_6 = ( 0, 0, var_3[2] );
    var_7 = level.helperdronesettings[var_0].halfsize;
    ...
    for ( var_14 = 0; var_14 < var_12.size; var_14++ )
    {
        ...
        var_19 = physics_createcontents( [ "physicscontents_solid", "physicscontents_glass", "physicscontents_vehicleclip", "physicscontents_missileclip", "physicscontents_clipshot" ] );
        var_20 = scripts\engine\trace::ray_trace( var_10, var_18, self, var_19 );

        if ( var_20["hittype"] != "hittype_none" )
            continue;

        var_21 = scripts\engine\trace::sphere_trace( var_18, var_16, var_7, self, var_19 );
        ...
        if ( var_22 > 0 )
        {
            self.recondronesafespawn = var_24;
            return var_24;
        }
...
{
    self endon( "disconnect" );
    var_1 = recondrone_watchsuperinternal( var_0 );
...
recondrone_watchsuperinternal( var_0 )
{
    self endon( "death" );
    self endon( "reconDroneEnded" );
    self endon( "reconDroneUnset" );
    ...
    wait 1.85;
    childthread find_safe_spawn( var_0.streakname, 0 );
    wait 0.15;
