...
bot_loadout_choose_fallback_primary( var_0 )
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", bot_loadout_team(), var_13, "class", "inUse" ) )
            {
...
bot_default_class_random()
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", bot_loadout_team(), var_1, "class", "inUse" ) )
                var_0[var_1] = var_1;
        }
    }
...
bot_validate_weapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_8 = scripts\mp\utility\weapon::getallselectableattachments( var_0 );
...
bot_loadout_choose_from_set( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 == "classtable_any" )
    {
        if ( !isdefined( self.default_class_chosen ) )
            self.default_class_chosen = scripts\engine\utility::random( [ "class1", "class2", "class3", "class4", "class5" ] );
...
{
    if ( istrue( self.bot_pick_new_loadout_next_spawn ) )
        return 0;
...
bot_loadout_class_callback( var_0 )
{
    ...
    var_8 = !var_7 && bot_allowed_to_try_last_loadout();
    ...
    if ( !var_7 )
    {
        var_12 = bot_get_stored_launcher_class();
        var_13 = undefined;
        ...
        if ( !isdefined( var_13 ) )
        {
            var_14 = bot_get_stored_custom_classes();
            var_15 = 0;
    ...
    var_16 = undefined;
    var_17 = bot_custom_classes_allowed();
