...
scriptable_door_get_in_radius( var_0, var_1, var_2 )
{
    var_3 = getentitylessscriptablearray( undefined, undefined, var_0, var_1, "door" );
...
scriptable_door_freeze_open( var_0 )
{
    ...
    {
        var_1 = "bash_left_90";
        var_2 = self.closedangles + ( 0, 90, 0 );
    }
    else
    {
        var_1 = "bash_right_90";
...
scriptable_door_is_double_door_pair( var_0 )
{
    if ( self == var_0 )
        return 0;

    var_1 = self.closedcenter;
    var_2 = var_0.closedcenter;
