...
ball_carrier_touched_goal( var_0 )
{
    ...
    {
        var_0 scripts\mp\utility\stats::setextrascore0( var_0.pers["touchdowns"] );
        var_0 thread scripts\common\utility::trycall( level.matchdata_loggameevent, "dunk", var_0.origin );
    }
...
ball_touched_goal( var_0 )
{
    ...
    if ( isdefined( self.lastcarrier ) )
    {
        ...
        if ( isplayer( self.lastcarrier ) )
        {
            ...
            self.lastcarrier thread scripts\common\utility::trycall( level.matchdata_loggameevent, "fieldgoal", self.lastcarrier.origin );
        }
    }
