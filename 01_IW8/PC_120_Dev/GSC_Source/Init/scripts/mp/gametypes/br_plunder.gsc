...
plunder_economy_shapshot_loop( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        scripts\mp\gametypes\br_analytics::branalytics_economy_snapshot( var_3 );
    }
}
...
playerdropplunderondeath( var_0, var_1 )
{
    ...
    if ( istrue( scripts\mp\gametypes\br_gametypes::runbrgametypefunc( "playerDropPlunderOnDeath", var_0, var_1 ) ) )
        return;
...
takeplunderpickup( var_0 )
{
    ...
    if ( scripts\engine\utility::array_contains( level.br_plunder.names, var_0.scriptablename ) )
    {
        ...
        scripts\mp\gametypes\br_analytics::trackcashevent( self, var_2, var_1 );
    }
    else
...
playerplunderevent( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        {
            if ( isdefined( var_3.playersplash ) && var_3.playersplash != "none" && !var_3.player scripts\mp\gametypes\br_public::isplayeringulag() )
            {
    ...
    scripts\mp\gametypes\br_gametype_dmz::packextrascore0();
    return var_3;
}
...
playerplunderbankcallback( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_2.playerscoreeventref ) )
        var_2.playerscoreeventref = scripts\engine\utility::ter_op( getdvar( "scr_br_gametype", "" ) == "dmz", "plunder_cash_blood_money", "plunder_cash" );
...
entityplunderbankalldeposited( var_0 )
{
    ...
    if ( isdefined( var_12 ) && isdefined( var_12.extractionmethod ) )
        scripts\mp\gametypes\br_analytics::branalytics_plunder_extraction_success( var_0.numdepositers, var_0.amounttotal, var_12.extractionmethod, var_11, self.origin );

    if ( !isdefined( var_0 ) || !istrue( var_0.dontcallpostplunder ) )
        thread scripts\mp\gametypes\br_gametypes::runbrgametypefunc( "postPlunder", var_0 );
...
entityplunderlosealldeposited( var_0, var_1 )
{
    ...
    if ( !isdefined( var_1 ) || !istrue( var_1.dontcallpostplunder ) )
        thread scripts\mp\gametypes\br_gametypes::runbrgametypefunc( "postPlunder", var_1 );
...
playersetplunderomnvar( var_0 )
{
    ...
    {
        if ( isbot( var_9 ) && scripts\mp\gametypes\br_public::istutorial() )
            continue;
...
dropplunderbyrarity( var_0, var_1, var_2 )
{
    ...
    for ( var_8 = level.br_plunder.quantity.size - 1; var_8 >= 0; var_8-- )
    {
        ...
        {
            [var_11, var_12, var_13] = scripts\mp\gametypes\br_pickups::getitemdroporiginandangles( var_1 + var_3.size, self.origin, self.angles, self );
            var_14 = scripts\mp\gametypes\br_pickups::spawnpickup( level.br_plunder.names[var_8], var_11, var_12, level.br_plunder.quantity[var_8], 1, var_13 );
            ...
            if ( isdefined( var_14 ) )
            {
                ...
                if ( inplunderlivelobby() )
                    level.br_plunder_ents[level.br_plunder_ents.size] = var_14;
            }
        }
    }
...
dropcondensedplunder( var_0, var_1 )
{
    ...
    [var_7, var_8, var_9] = scripts\mp\gametypes\br_pickups::getitemdroporiginandangles( var_1 + var_2.size, self.origin, self.angles, self );
    var_10 = scripts\mp\gametypes\br_pickups::spawnpickup( level.br_plunder.names[var_4], var_7, var_8, var_0, 1, var_9 );
    ...
    if ( isdefined( var_10 ) )
    {
        ...
        if ( inplunderlivelobby() )
            level.br_plunder_ents[level.br_plunder_ents.size] = var_10;
    }
...
inithelirepository()
{
    ...
    var_0[var_0.size] = var_1;
    var_1 = plunder_getleveldataforrepository( "extractHelipad", 1 );
    var_1.scriptableusepart = "brloot_quest_extract_site";
    var_0[var_0.size] = var_1;
...
getplunderextractionsites()
{
    ...
    if ( scripts\cp_mp\utility\game_utility::getmapname() == "mp_donetsk" )
    {
...
setupplunderextractionsites()
{
    ...
    level.br_plunder_site_use_parts[level.br_plunder_site_use_parts.size] = "brloot_quest_extract_site";
...
plundersiteusedinternal( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_6 ) )
    {
        ...
        if ( !scripts\mp\gametypes\br_public::isdmztutorial() )
            level thread scripts\mp\gametypes\br_public::brleaderdialogteam( "plunder_extract_requested", var_3.team, 1 );

        level thread scripts\mp\gametypes\br::teamsplashbr( "br_extract_heli_incoming", var_3, var_3.team );
    ...
    if ( istrue( level.moveplunderextractionsitesonuse ) )
    {
        ...
        var_0 setscriptablepartstate( var_0.type, var_4 );
        level thread scripts\mp\gametypes\br_gametype_dmz::findnewplunderextractsite( var_0 );
    }
}
...
heliwaitatplunderrepository( var_0 )
{
    ...
    else if ( var_0.type == "brloot_quest_extract_site" )
        var_1 = "extractHelipad";
    else
    {
...
{
    if ( !istrue( level.gameended ) && !scripts\mp\gametypes\br_public::isdmztutorial() )
...
spawnheli( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_7.speed = 100;
    var_7.accel = 125;
    var_7.health = scripts\engine\utility::ter_op( scripts\mp\utility\game::getsubgametype() == "dmz", level.extractplunderhelihealth, 1000 );
...
helidestroyed()
{
    ...
    scripts\mp\gametypes\br_analytics::branalytics_plunder_extraction_failure( var_5, "little_bird", self.extractgroundpos, self.origin );
...
heliexplode( var_0 )
{
    ...
    self notify( "explode" );
    wait 0.35;
    level thread scripts\mp\gametypes\br::teamsplashbr( "br_extract_heli_shot_down", self.owner, self.team );
    helidelete();
}
...
plunder_playercanuserepository( var_0, var_1 )
{
    ...
    if ( istrue( var_2.teamuseonly ) && isdefined( var_0.team ) && var_1.team != var_0.team )
        return 0;
...
plunder_playerrepositoryuseshouldsucceed( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_1.plundercount <= 0 && ( !isdefined( var_1.extractquest_alwaysallowdeposit ) || var_1.extractquest_helipadid != var_0.index ) )
        {
