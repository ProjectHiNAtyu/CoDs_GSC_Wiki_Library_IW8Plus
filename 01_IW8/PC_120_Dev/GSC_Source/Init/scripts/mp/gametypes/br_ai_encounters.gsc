...
rewardspawn( var_0, var_1 )
{
    ...
    switch ( var_2 )
    {
        case "brloot_killstreak_clusterstrike":
            var_3 = scripts\mp\gametypes\br_pickups::spawnpickup( var_2, var_0.origin + ( 0, 0, 0.1 ), var_0.angles, 0, 1 );
            break;
        default:
    }
    ...
    if ( isdefined( var_3 ) )
    {
        thread rewardobjectusewatch( var_3 );
...
smoking_idle( var_0 )
{
    ...
    for (;;)
    {
        ...
        scripts\asm\shared\mp\utility::animscripted_single( var_0 );
...
standing_cellphone_loop( var_0, var_1 )
{
    self endon( "death" );
    self endon( "damage" );
    scripts\asm\shared\mp\utility::animscripted_loop_n_times( var_0, var_1 );
}
...
reset_guy( var_0 )
{
    ...
    var_0 scripts\asm\shared\mp\utility::animscripted_clear();
