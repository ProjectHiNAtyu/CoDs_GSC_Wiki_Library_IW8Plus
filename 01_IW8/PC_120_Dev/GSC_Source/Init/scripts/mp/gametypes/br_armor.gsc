...
initarmor()
{
    ...
    scripts\mp\gametypes\br_public::updatebrscoreboardstat( "armorHealthRatio", 0 );
}
...
popoffhelmet( var_0, var_1, var_2 )
{
    ...
    for ( var_12 = 0; var_12 < var_9; var_12++ )
    {
        ...
        if ( var_13[0] < 2 && var_13[1] < 2 && var_13[2] < 2 && var_13[0] > -2 && var_13[1] > -2 && var_13[2] > -2 )
        {
            ...
            var_15 = var_4.angles;
            var_4 delete();
            var_16 = scripts\mp\gametypes\br_pickups::spawnpickup( var_8, var_14, var_15 );
            var_16.count = 1;
            return;
        }
