...
{
    wait 1.0;
    var_2 = getentitylessscriptablearray( var_0, "targetname" );
    var_2 = removechevronsfromarray( var_2, var_1 );
    var_2 = postshipmodifychevrons( var_2, var_1 );
    var_3 = [];
...
activatezone()
{
    ...
    if ( isdefined( level.gethillspawnshutofforigin ) )
        var_0 = [[ level.gethillspawnshutofforigin ]]();

    var_1 = 1024;

    if ( isdefined( level.gethillspawnshutoffradius ) )
        var_1 = [[ level.gethillspawnshutoffradius ]]();
    ...
    {
        self.stompeenemyprogressupdate = ::zone_stompeenemyprogressupdate;
...
deactivatezone()
{
    ...
    foreach ( var_1 in self.dangerzoneids )
        scripts\mp\spawnlogic::removespawndangerzone( var_1 );

    self.dangerzoneids = undefined;
...
lockedradialunfill( var_0, var_1 )
{
    level endon( "game_ended" );
...
zone_onuse( var_0 )
{
    ...
    if ( level.usehqrules && !level.usehprules && self.ownerteam != "neutral" )
    {
        ...
        level.zone thread waitthensetvisibleteam();
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            foreach ( var_11 in var_9 )
            {
                ...
                var_7 scripts\cp_mp\challenges::oncapture();
            }
        }

        level thread scripts\mp\gametypes\hq::give_capture_credit( var_3, var_2, var_1, undefined, var_0 );
    ...
    else
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "hq" && !level.usehprules )
        {
            ...
            adjustmatchtimerpausedstatefromscore( var_1 );
        }
        ...
        if ( !isdefined( level.lastcaptureteam ) || level.lastcaptureteam != var_1 )
        {
            ...
            if ( scripts\mp\utility\game::getgametype() == "koth" || scripts\mp\utility\game::getgametype() == "grnd" )
                level thread scripts\mp\gametypes\koth::give_capture_credit( var_3, var_2, var_1, level.lastcaptureteam, var_0 );
            else
                level thread scripts\mp\gametypes\hq::give_capture_credit( var_3, var_2, var_1, level.lastcaptureteam, var_0 );
        }
...
zone_onusebegin( var_0 )
{
    if ( scripts\mp\utility\game::getgametype() == "hq" && !level.usehprules )
    {
        ...
        if ( var_1 != "neutral" && self.claimteam != var_1 )
            adjustmatchtimerpausedstatefromscore( var_1, 1 );
...
zone_onuseupdate( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_4 == "neutral" && self.claimteam != var_4 )
        adjustmatchtimerpausedstatefromscore( self.claimteam );
    else if ( var_4 != "neutral" && self.claimteam != var_4 )
        adjustmatchtimerpausedstatefromscore( var_4, 1 );
    else if ( level.pausemodetimer )
        level scripts\mp\gamelogic::pausetimer();
...
zone_onunoccupied()
{
    ...
    {
        level.zone scripts\mp\gameobjects::setobjectivestatusicons( level.icondefend, level.iconcapture );
        adjustmatchtimerpausedstatefromscore( self.ownerteam );
    }
    else
    {
        level notify( "zone_destroyed" );
...
zone_oncontested()
{
    ...
    level.zone thread scripts\common\utility::trycall( level.matchdata_loggameevent, "hill_contested", level.zone.trigger.origin );
    self.didstatusnotify = 1;
}
...
zone_onuncontested( var_0 )
{
    ...
    if ( var_0 == "none" || var_1 == "neutral" )
    {
        ...
        level.zone thread scripts\common\utility::trycall( level.matchdata_loggameevent, "hill_empty", level.zone.trigger.origin );
    }
    else
    {
        if ( scripts\mp\utility\game::getgametype() == "koth" )
        ...
        level.zone thread scripts\common\utility::trycall( level.matchdata_loggameevent, "hill_uncontested", level.zone.trigger.origin );
    }

    var_7 = ( gettime() - self.contestedtime ) * 0.001;
    scripts\mp\utility\game::logannouncement( undefined, undefined, "Zone Contested", level.zone.trigger.origin, var_7 + " seconds" );
...
adjustmatchtimerpausedstatefromscore( var_0, var_1 )
{
    if ( !level.pausemodetimer )
        return;
...
showcapturedhardpointeffecttoplayer( var_0, var_1 )
{
    ...
    if ( var_3 )
    {
        if ( var_1 ismlgfreecamenabled() || var_1 allowspectateallteams() )
            var_2 = "allies";
        else
...
postshipmodifychevrons( var_0, var_1 )
{
    var_2 = [];
    var_3 = [];
    ...
    if ( isdefined( var_2[var_1] ) )
    {
        foreach ( var_5 in var_2[var_1] )
        {
            var_6 = var_5[0];
            var_7 = var_5[1];
            var_8 = spawnscriptable( "hardpoint_chevron", var_6, var_7 );
...
createvisualsinfo( var_0, var_1, var_2 )
{
    var_0.origin = var_1;
    var_0.angles = var_2;
    return var_0;
