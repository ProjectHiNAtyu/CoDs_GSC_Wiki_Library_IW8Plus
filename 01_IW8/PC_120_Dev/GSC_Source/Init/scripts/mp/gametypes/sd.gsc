...
onnormaldeath( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0.isplanting )
    {
        scripts\mp\utility\game::logannouncement( var_0, var_1, "Bomb Carrier Killed", var_0.origin, "was_planting_bomb" );
    ...
    {
        scripts\mp\utility\game::logannouncement( var_0, var_1, "Bomb Carrier Killed", var_0.origin );
        thread scripts\common\utility::trycall( level.matchdata_logvictimkillevent, var_2, "carrying" );
    }
    else if ( var_0.isdefusing )
    {
        scripts\mp\utility\game::logannouncement( var_0, var_1, "Defuser Killed", var_0.origin );
        ...
        if ( isdefined( var_1 ) && isplayer( var_1 ) && var_1.pers["team"] != var_0.pers["team"] )
        {
            if ( var_1.pers["team"] == level.sdbomb.carrier.team && var_1 != level.sdbomb.carrier )
            {
                ...
                if ( var_9 < 105625 )
                {
                    ...
                    var_1 scripts\mp\utility\stats::incpersstat( "defends", 1 );
                    var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
                    thread scripts\common\utility::trycall( level.matchdata_logvictimkillevent, var_2, "defending" );
                    var_8 = 1;
                }
            }
        }
...
ontimelimit()
{
    ...
    scripts\mp\utility\game::logannouncement( undefined, undefined, "Time Limit Reached" );
}
...
onuseplantobject( var_0 )
{
    ...
    if ( istrue( var_0.isjuggernaut ) )
        var_0 switchtoweapon( "iw8_minigunksjugg_mp" );

    scripts\mp\utility\game::logannouncement( var_0, undefined, "Bomb Planted", var_0.origin );
...
onbombexploded( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_3 == game["attackers"] )
    {
        setgameendtime( 0 );
        wait 3;
        scripts\mp\utility\game::logannouncement( undefined, undefined, "Target Destroyed" );
