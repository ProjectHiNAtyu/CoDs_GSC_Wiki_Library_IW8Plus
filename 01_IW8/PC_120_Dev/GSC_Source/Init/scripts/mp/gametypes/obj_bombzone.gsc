...
setupobjective( var_0, var_1, var_2 )
{
    ...
    var_3.useweapon = makeweapon( "briefcase_bomb_mp" );
    var_3.bombplanted = 0;
...
setupkillcament( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::getmapname() == "mp_skyway" && var_0.objectivekey == "_b" )
        var_2 = ( 326, 595, 85 );
...
bombzone_onbeginuse( var_0 )
{
    ...
    else
    {
        ...
        scripts\mp\utility\dialog::statusdialog( "bomb_planting", var_0.team, "status" );
...
bombzone_onuseplantobject( var_0 )
{
    if ( scripts\mp\utility\game::inovertime() && self.bombplanted == 0 || !scripts\mp\gameobjects::isfriendlyteam( var_0.pers["team"] ) )
    {
        ...
        if ( isplayer( var_0 ) )
        {
            var_0 scripts\cp_mp\challenges::onplant();
            var_0 thread scripts\common\utility::trycall( level.matchdata_loggameevent, "plant", var_0.origin );
        }
    }
}
...
bombzone_onusedefuseobject( var_0 )
{
    ...
    var_0 scripts\cp_mp\challenges::ondefuse();
...
bombzone_onbombplanted( var_0, var_1 )
{
    ...
    else if ( scripts\mp\utility\game::getgametype() == "to_dd" )
    {
        ...
        level.ddbombmodel[var_0.objectivekey] = spawn( "script_model", var_3 + var_5 );
        level.ddbombmodel[var_0.objectivekey].angles = var_4;
        level.ddbombmodel[var_0.objectivekey] setmodel( getbombmodel() );
        level.ddbombmodel[var_0.objectivekey] setasgametypeobjective();
    }
    else
    ...
    {
        var_7 = var_0;
        var_7 scripts\mp\gameobjects::setownerteam( var_1.team );
    }
    else
    {
        ...
        var_7 = scripts\mp\gameobjects::createuseobject( var_9, var_8, var_6, ( 0, 0, 32 ) );
    ...
    var_7.objectivekey = var_0.objectivekey;
    var_7.iconname = var_0.iconname;
    var_7.id = "defuse_object";
    var_7.trigger setusepriority( -3 );

    if ( scripts\mp\utility\game::getgametype() == "cmd" )
        var_7 scripts\mp\gameobjects::allowuse( "none" );
    else
        var_7 scripts\mp\gameobjects::allowuse( "enemy" );

    var_7 scripts\mp\gameobjects::setusetime( level.defusetime );
    var_7 scripts\mp\gameobjects::setwaitweaponchangeonuse( 0 );
    var_7 scripts\mp\gameobjects::setusehinttext( &"MP/HOLD_TO_DEFUSE_EXPLOSIVES" );
    var_7.trigger setuseholdduration( "duration_none" );
    var_7 scripts\mp\gameobjects::setvisibleteam( "any" );
    var_7 scripts\mp\gameobjects::setobjectivestatusicons( "waypoint_bomb_defend_nt", "waypoint_defuse_nt" );

    if ( scripts\mp\utility\game::getgametype() != "cmd" )
        var_7 thread bombradialfill( var_2, "waypoint_bomb_defend", "waypoint_defuse" );
    ...
    else
    {
        ...
        var_7.resetprogress = level.resetprogress;
        var_7.useweapon = makeweapon( "briefcase_bomb_defuse_mp" );
    }
    ...
    if ( scripts\mp\utility\game::getgametype() == "dd" || scripts\mp\utility\game::getgametype() == "to_dd" || scripts\mp\utility\game::getgametype() == "cmd" || scripts\mp\utility\game::getgametype() == "btm" )
    {
        var_7.showprogressforteam = undefined;
        var_10 = scripts\mp\gametypes\dd::bombhandler;

        if ( scripts\mp\utility\game::getgametype() == "to_dd" )
            var_10 = scripts\mp\gametypes\to_dd::bombhandler;
        else if ( scripts\mp\utility\game::getgametype() == "cmd" )
            var_10 = scripts\mp\gametypes\cmd::bombhandler;
        else if ( scripts\mp\utility\game::getgametype() == "btm" )
            var_10 = scripts\mp\gametypes\btm::bombhandler;
        ...
        if ( var_0.bombdefused )
        {
            ...
            if ( scripts\mp\utility\game::getgametype() == "cmd" )
                var_0.onuse = scripts\mp\gametypes\cmd::bombzone_onuseplantobject;
            else
    ...
    {
        var_11 = level.ddbombmodel[var_0.objectivekey].origin;
        level.ddbombmodel[var_0.objectivekey] delete();
    }
    else
    {
    ...
    playsoundatpos( var_14, "exp_bombsite_lr" );

    if ( scripts\mp\utility\game::getgametype() == "to_dd" )
    {
        foreach ( var_17 in level.objectives )
        {
            if ( isdefined( var_17.exploderindex ) )
                scripts\engine\utility::exploder( var_17.exploderindex );
        }
    }
...
bombradialfill( var_0, var_1, var_2 )
{
...
onpickup( var_0, var_1, var_2 )
{
    ...
    scripts\mp\utility\game::logannouncement( var_0, undefined, "Bomb Picked Up", var_0.origin );
