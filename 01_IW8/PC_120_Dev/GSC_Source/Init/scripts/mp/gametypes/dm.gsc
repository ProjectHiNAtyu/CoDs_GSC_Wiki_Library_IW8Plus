...
onstartgametype()
{
    ...
    scripts\mp\spawnlogic::registerspawnset( "dm", "mp_dm_spawn" );
    scripts\mp\spawnlogic::registerspawnset( "dm_fallback", "mp_dm_spawn_secondary" );
...
updategametypedvars()
{
    ...
    level.aonrules = scripts\mp\utility\dvars::dvarintvalue( "aonRules", 0, 0, 2 );
...
setspecialloadout()
{
    level.aon_loadouts["allies"]["loadoutPrimary"] = "iw8_pi_golf21";
    ...
    level.aon_loadouts["allies"]["loadoutSecondary"] = "iw8_knife";
    ...
    level.aon_loadouts["allies"]["loadoutSecondaryVariantID"] = 11;
...
{
    giveextraaonperks();
    var_0 = makeweapon( "iw8_knifestab_mp" );
