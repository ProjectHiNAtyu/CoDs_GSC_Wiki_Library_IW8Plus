...
monitorhotfoot()
{
    ...
    for (;;)
    {
        ...
        {
            if ( !isdefined( var_2.hotfootlastposition ) )
            {
                var_2.hotfootdisttraveledsq = 0;
                var_2.hotfootlastposition = var_2.origin;
                var_2.abshotfootlastposition = var_2.origin;
            }

            var_2.hotfootdisttraveledsq = var_2.hotfootdisttraveledsq + distancesquared( var_2.hotfootlastposition, var_2.origin );
            var_2.hotfootlastposition = var_2.origin;
        }
        ...
        if ( var_0 > 3.0 )
        {
            if ( level.hotfootabsloops >= 2 )
            {
                ...
                foreach ( var_2 in level.players )
                {
                    if ( !isdefined( var_2.abshotfootlastposition ) )
                        var_2.abshotfootlastposition = var_2.origin;

                    var_2.forceabshotfoot = distancesquared( var_2.abshotfootlastposition, var_2.origin ) < 4225;
                    var_2.abshotfootlastposition = var_2.origin;
                }
            }
            ...
            foreach ( var_2 in level.players )
            {
                ...
                if ( isalive( var_2 ) && ( istrue( var_2.forceabshotfoot ) || var_2.hotfootdisttraveledsq < 4225 && !istrue( var_2.hotfootreset ) ) )
                {
                    var_2.forceabshotfoot = 0;
...
onhotfootplayerkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
