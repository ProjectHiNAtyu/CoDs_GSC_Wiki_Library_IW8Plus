...
emptyallvehicles()
{
    ...
    foreach ( var_5, var_1 in level.vehicle.instances )
    {
        ...
        {
            if ( scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_instanceisregistered( var_3 ) )
...
deleteextantvehicles()
{
    ...
    foreach ( var_6, var_1 in level.vehicle.instances )
    {
        ...
        {
            scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_preventrespawn( var_4 );
...
{
    if ( var_0 == "little_bird" && scripts\mp\gametypes\br_gametypes::isfeaturedisabled( "littleBirdSpawns" ) )
        return;
...
spawnavehicle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_6 ) )
        scripts\mp\gametypes\br_analytics::branalytics_vehiclespawned( var_6, var_0 );
...
dangercircletick( var_0, var_1 )
{
    ...
    var_6 = level.vehicle.instances["little_bird"];
