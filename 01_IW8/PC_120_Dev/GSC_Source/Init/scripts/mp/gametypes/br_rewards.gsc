...
precomputedropbagpositions( var_0 )
{
    var_1 = [];
    var_2 = [];
    ...
    if ( isdefined( level.br_level ) )
        var_21 = computedropbagpositions( var_2, level.dropbagstruct.clusters, level.br_level.br_mapbounds, var_18, var_19, 2000, var_17, 128, var_3, var_4 );
    ...
    if ( isdefined( var_21 ) )
    {
        for ( var_22 = 0; var_22 < var_21.size; var_22++ )
        {
            ...
            if ( isdefined( var_21[var_22].node ) )
            {
                ...
                var_11.precomputeddropbagpos = var_24.droplocations[var_25].origin;
                continue;
            }

            var_11.precomputeddropbagpos = var_21[var_22].origin;
        }

        level.precomputeddropbags = 1;
        level thread spawndropbagsovertime( var_1 );
    }
...
spawndropbagatposition( var_0 )
{
    cleanupallbutxcratesforteam( self.team, 1 );
    var_1 = scripts\cp_mp\killstreaks\airdrop::dropbrloadoutcrate( self.team, var_0 + ( 0, 0, 4096 ), var_0 + ( 0, 0, 512 ) );
    var_1 endon( "death" );
    enabledropbagobjective( var_1 );
    choosedropbagmodel( var_1 );
    var_2 = [];

    foreach ( var_4 in level.teamdata[self.team]["alivePlayers"] )
    {
        if ( isdefined( var_4 ) && !var_4 scripts\mp\gametypes\br_public::isplayeringulag() )
        {
            var_2[var_2.size] = var_4;
    ...
    if ( !scripts\mp\gametypes\br_public::istutorial() )
        scripts\mp\gametypes\br_public::brleaderdialogteam( "dropbag_incoming", self.team, 1 );

    if ( scripts\mp\utility\game::getgametype() == "br" )
        scripts\mp\gametypes\br_analytics::branalytics_dropbagdeployed( self, var_0, var_1 );
}

spawndropbagsovertime( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        if ( !isdefined( var_2 ) )
        ...
        var_3 = var_2.precomputeddropbagpos;
        ...
        if ( isdefined( level.br_circle ) && isdefined( level.br_circle.safecircleent ) )
        {
            ...
            {
                var_4 = scripts\mp\gametypes\br_circle::getsafecircleorigin();
                var_7 = scripts\mp\gametypes\br_c130::snappointtooutofboundstriggertrace( var_4, var_3 );
        ...
        var_2 spawndropbagatposition( var_3 );
        waitframe();
    }
}
...
spawndropbagonlanding()
{
    ...
    if ( isdefined( var_0 ) )
    {
        thread spawndropbagatposition( var_0.origin );
        level thread managedropbags();
    }
}
