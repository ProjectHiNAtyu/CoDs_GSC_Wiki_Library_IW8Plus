...
{
    var_0 = self;
    var_0 scripts\mp\gametypes\br_plunder::initplayer();
}

onprematchdone()
{
    scripts\mp\flags::gameflagwait( "POIs_spawned" );
    scripts\mp\gametypes\br_mobile_armory::onprematchdone();
    scripts\mp\gametypes\br_satellite_truck::onprematchdone();
...
_spawnpois()
{
    ...
    var_7 = scripts\mp\gametypes\br_armory_kiosk::getallspawninstances();

    if ( isdefined( var_7 ) && var_7.size > 0 )
    {
        var_7 = _getlocationscircleinfluencedwithnoise( var_7, var_6, level.buystationsusepaddingdistribution );
        scripts\mp\gametypes\br_armory_kiosk::setspawninstances( var_7 );
    }

    var_8 = scripts\mp\gametypes\br_plunder::getallextractspawninstances();

    if ( isdefined( var_8 ) && var_8.size > 0 )
    {
        var_8 = _getlocationscircleinfluencedwithnoise( var_8, level.maxplunderextractions, 1 );
        scripts\mp\gametypes\br_plunder::setextractspawninstances( var_8 );
    }
    ...
    if ( var_12.size > 0 )
    {
        ...
        {
            wait( var_0 );
            scripts\mp\gametypes\br_mobile_armory::spawnmobilearmory( var_13[var_10] );
        }
    }
    ...
    if ( var_15.size > 0 )
    {
        ...
        {
            wait( var_0 );
            scripts\mp\gametypes\br_satellite_truck::spawnsatellitetruck( var_16[var_10] );
        }
    }
...
_getlocationscircleinfluencedwithnoise( var_0, var_1, var_2 )
{
    ...
    if ( getdvar( "scr_br_gametype", "" ) == "dmz" )
        return scripts\mp\gametypes\br_gametype_dmz::_getplunderextractlocations( var_0, var_1, var_2 );
    ...
    for ( var_5 = 0; var_5 < var_0.size; var_5++ )
    {
        ...
        var_6.score = scripts\mp\gametypes\br_circle::getcircleindexforpoint( var_6.origin ) + var_7;
    }
...
setupmapquadrantcornersandgrid()
{
    ...
    if ( level.adjusteventdistributionpadding > 0 && level.mapname == "mp_donetsk" )
    {
