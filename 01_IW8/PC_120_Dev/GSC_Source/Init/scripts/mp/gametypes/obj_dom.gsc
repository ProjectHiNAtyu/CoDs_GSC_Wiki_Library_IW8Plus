...
setupobjective( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !istrue( var_3 ) )
    {
        var_9 scripts\mp\gameobjects::setvisibleteam( "any" );
    ...
    var_9.flagmodel setmodel( "military_dom_flag_neutral" );
    var_9.outlineent = var_9.flagmodel;
    var_9 initializematchrecording();

    if ( !istrue( var_3 ) )
        var_9 domflag_setneutral();
...
domflag_setneutral( var_0 )
{
    ...
    thread updateflagstate( "idle", istrue( var_0 ) );
...
dompoint_setcaptured( var_0, var_1 )
{
    ...
    if ( isdefined( self.assisttouchlist[var_0] ) )
    {
        ...
        foreach ( var_8 in var_6 )
        {
            ...
            var_9 scripts\cp_mp\challenges::oncapture();
        }
    }
...
dompoint_onuse( var_0 )
{
    ...
    if ( !self.neutralized )
    {
        ...
        if ( isdefined( level.onobjectivecomplete ) )
        {
            ...
            var_5 = "Flag " + getobjectiveflag() + " Captured";

            if ( var_2 == "neutral" || var_2 == "none" )
                scripts\mp\utility\game::logannouncement( var_0, undefined, var_5, var_0.origin, "neutral_flag" );
            else
                scripts\mp\utility\game::logannouncement( var_0, undefined, var_5, var_0.origin );
        }
    }
...
dompoint_onusebegin( var_0 )
{
    ...
    {
        if ( var_1 != var_0.team )
            var_2 = getdomneutralizeomnvarvalue();
        else
            var_2 = 0;
    }
...
dompoint_onuncontested( var_0 )
{
    ...
    var_2 = ( gettime() - self.contestedtime ) * 0.001;
    var_3 = "Flag " + getobjectiveflag() + " Contested";
    scripts\mp\utility\game::logannouncement( undefined, undefined, var_3, undefined, var_2 + " seconds" );
...
updateflagstate( var_0, var_1, var_2 )
{
...
precap()
{
    storecenterflag();
    var_0 = [];
    var_0[var_0.size] = level.centerflag;

    if ( game["switchedsides"] )
    {
        level.closestalliesflag = getunownedflagneareststart( "axis", level.centerflag );
        var_0[var_0.size] = level.closestalliesflag;
        level.closestaxisflag = getunownedflagneareststart( "allies", var_0 );
    }
    else
    {
        level.closestalliesflag = getunownedflagneareststart( "allies", level.centerflag );
        var_0[var_0.size] = level.closestalliesflag;
        level.closestaxisflag = getunownedflagneareststart( "axis", var_0 );
    }
...
setflagcaptured( var_0, var_1, var_2, var_3 )
{
    scripts\mp\gameobjects::setownerteam( var_0 );
    scripts\mp\gameobjects::setobjectivestatusicons( level.icondefending, level.iconcapture );
    thread updateflagstate( var_0, 0 );
    self.capturetime = gettime();
