...
getfirstzone()
{
    ...
    {
        var_0 = level.objectives[level.remappedhpzoneorder[0]];
...
getnextzone()
{
    ...
    else if ( isdefined( level.remappedhpzoneorder ) )
    {
        ...
        var_23 = level.objectives[level.remappedhpzoneorder[level.prevzoneindex]];
    }
    else
    {
        level.prevzoneindex++;
...
initspawns()
{
    ...
    {
        calculatespawndisttozones( var_8 );
        ...
        if ( var_15 || var_16 )
        {
            ...
            {
                var_13 = 1;
                var_17 = strtok( var_8.script_noteworthy, " " );
...
calculatespawndisttozones( var_0 )
{
    ...
    {
        var_3 = getpathdist( var_0.origin, var_2.trigger.baseorigin, 5000 );

        if ( var_3 < 0 )
            var_3 = scripts\engine\utility::distance_2d_squared( var_0.origin, var_2.trigger.baseorigin );
        else
            var_3 = var_3 * var_3;
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4 )
{
    level endon( "game_ended" );
    level.lastcaptime = gettime();
    scripts\mp\utility\game::logannouncement( var_4, undefined, "Hardpoint Captured", var_4.origin );
    var_5 = var_4;
    ...
    if ( isplayer( var_5 ) )
    {
        ...
        if ( !isscoreboosting( var_5 ) )
            ...
            var_5 thread scripts\mp\awards::givemidmatchaward( "mode_hp_secure_reduced" );
