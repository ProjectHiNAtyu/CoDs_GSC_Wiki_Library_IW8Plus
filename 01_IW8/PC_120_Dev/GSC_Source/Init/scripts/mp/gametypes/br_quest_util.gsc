...
inittablets()
{
    ...
    foreach ( var_2, var_1 in level.questinfo.tabletinfo )
    {
        ...
        if ( var_7.size )
        {
            var_22 = getquestindex( var_2 );
            setomnvarbit( "ui_br_objective_types", var_22, 1 );
        }
    ...
    var_26 = getarraykeys( level.calloutglobals.namelocations );
    var_27 = [];
    ...
    foreach ( var_2, var_1 in level.questinfo.tabletinfo )
    {
        ...
        if ( var_1.enabled )
        {
            foreach ( var_21 in var_7 )
            {
                ...
                if ( var_27.size > 0 )
                {
                    var_35 = scripts\mp\gametypes\br_callouts::getlocationnameforpoint( var_21.origin );
    ...
    var_41 = var_4.size;
    scripts\mp\gametypes\br_analytics::branalytics_inittablets( var_32, var_40, var_41, var_3 );
...
delayedshowtablets( var_0 )
{
    ...
    {
        var_5 = var_0[var_4];
        var_5.circleindex = scripts\mp\gametypes\br_circle::getcircleindexforpoint( var_5.origin );
    ...
    for (;;)
    {
        ...
        {
            scripts\mp\gametypes\br_analytics::branalytics_delayedshowtablets( 0, var_2, var_3.size, 0 );
            continue;
        }
        ...
        scripts\mp\gametypes\br_analytics::branalytics_delayedshowtablets( level.br_circle.circleindex, var_2, var_3.size, var_6 );
...
{
    scripts\mp\gametypes\br_analytics::branalytics_missionstart( self, var_1 );
...
releaseteamonquest( var_0 )
{
    ...
    if ( isdefined( self.result ) && self.result == "success" )
    {
        ...
        {
            if ( isbot( var_4 ) && scripts\mp\gametypes\br_public::istutorial() )
                continue;

            var_4.brmissionscompleted = scripts\mp\gametypes\br::get_int_or_0( var_4.brmissionscompleted ) + 1;
            var_4 scripts\mp\gametypes\br_public::updatebrscoreboardstat( "missionsCompleted", var_4.brmissionscompleted );
            ...
            var_4.brmissiontypescompleted[self.questcategory] = scripts\mp\gametypes\br::get_int_or_0( var_4.brmissiontypescompleted[self.questcategory] ) + 1;
        }
    ...
    var_14 = var_13.size;
    scripts\mp\gametypes\br_analytics::branalytics_missionend( self, var_1, var_2, var_14 );
...
takequesttablet( var_0 )
{
    switch ( var_0.type )
    {
        ...
        case "brloot_collection_tablet":
            scripts\mp\gametypes\br_collection_quest::takequestitem( var_0 );
            break;
...
dangercircletick( var_0, var_1, var_2 )
{
    ...
    foreach ( var_4 in level.questinfo.activetablets )
    {
        ...
        {
            scripts\mp\gametypes\br_pickups::loothide( var_4 );
            scripts\mp\gametypes\br_plunder::modify_plunder_itemsinworld( "brloot_mission_tablet", -1 );
        }
    }
...
_determinelocationarray( var_0 )
{
    switch ( var_0.searchfunc )
    {
        ...
        case "getKiosks":
            var_2 = scripts\mp\gametypes\br_armory_kiosk::getallspawninstances();
            var_3 = [];

            foreach ( var_5 in level.br_armory_kiosk.scriptables )
            {
        ...
        case "getInactiveHelipads":
            ...
            {
                var_7 = scripts\mp\gametypes\br_plunder::getplunderextractionsites();
                var_8 = [];

                foreach ( var_10 in var_7 )
                {
                    if ( istrue( var_10 getscriptablepartstate( var_10.type ) == "hidden" ) )
...
_findnewlocaleplacement( var_0, var_1 )
{
    ...
    if ( istrue( var_1.searchforcecirclecenter ) )
        var_3 = scripts\mp\gametypes\br_circle::getmintimetillpointindangercircle( var_1.searchcircleorigin );
    else
        var_3 = 0;
...
{
    if ( var_0 scripts\mp\gametypes\br_public::isplayerinorgoingtogulag() )
        return 0;
...
packsplashparambits( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        var_2 = 0;
...
{
    var_0 thread scripts\mp\gametypes\br_rewards::spawndropbagatposition( var_1 );
...
giveteamplunderflat( var_0, var_1 )
{
    ...
    foreach ( var_5 in scripts\mp\utility\teams::getteamdata( var_0, "players" ) )
    {
        if ( isbot( var_5 ) && scripts\mp\gametypes\br_public::istutorial() )
            continue;
        ...
        var_5 scripts\mp\gametypes\br_plunder::playerplunderpickup( var_6 );
...
giveteamplunderdistributive( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        var_4 scripts\mp\gametypes\br_plunder::playerplunderpickup( var_2 );
        level.br_plunder.plunder_awarded_by_missions_total = level.br_plunder.plunder_awarded_by_missions_total + var_2;
        scripts\mp\gametypes\br_analytics::trackcashevent( var_4, "mission", var_2 );
    }
}
...
dropplunder( var_0, var_1, var_2, var_3 )
{
    ...
    {
        [var_19, var_20, var_21] = scripts\mp\gametypes\br_pickups::getitemdroporiginandangles( var_9, var_1, var_2, var_3 );
        scripts\mp\gametypes\br_pickups::spawnpickup( var_7[var_16[var_9]][var_4], var_19, var_20, var_7[var_16[var_9]][var_5], 1, var_21 );
    }
...
utilflare_shootflare( var_0, var_1 )
{
    level endon( "game_ended" );
    var_2 = scripts\engine\trace::create_contents( 0, 1, 0, 1, 0, 0, 0 );
    ...
    var_4 thread _utilflare_lerpflare( var_1 );
}
...
givequestrewardsinstance( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        var_6 scripts\mp\gametypes\br_gametype_dmz::packextrascore0();
    }
...
givequestreward( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    switch ( var_0 )
    {
        case "plunder":
            ...
            break;
        case "xp":
            foreach ( var_8 in scripts\mp\utility\teams::getteamdata( var_2, "players" ) )
            {
                var_8 thread scripts\mp\events::killeventtextpopup( "br_missionComplete", 0 );
                var_8 scripts\mp\rank::giverankxp( "br_missionComplete", var_1 );
                var_8.br_contractxpearned = scripts\mp\gametypes\br::get_int_or_0( var_8.br_contractxpearned ) + var_1;
            }
        ...
        case "weapon_xp":
            foreach ( var_8 in scripts\mp\utility\teams::getteamdata( var_2, "players" ) )
            {
                var_11 = var_8.lastnormalweaponobj;
                var_8 scripts\mp\gametypes\br::givebrweaponxp( "", var_1, var_11, 0, 0 );
            }
        ...
        case "loot_table":
            if ( getdvar( "scr_br_gametype", "" ) != "dmz" )
            {
                var_13 = getscriptablelootcachecontents( var_5, var_1 );
                questrewarddropitems( var_13, var_3, var_4, 0 );
            }

            break;
        case "loot_cache":
            var_13 = getscriptablelootcachecontents( var_5, var_1 );
            questrewarddropitems( var_13, var_3, var_4, 1 );
            break;
        case "loot_items":
            var_13 = strtok( var_1, " " );
            questrewarddropitems( var_13, var_3, var_4, 0 );
            break;
        case "drop_bag":
            var_14 = scripts\mp\utility\teams::getteamdata( var_2, "players" )[0];
            calldropbag( var_14, var_3 );
            break;
        case "circle_peek":
        ...
        case "blueprint_chance":
            var_15 = scripts\mp\gametypes\br_blueprint_extract_spawn::blueprintextract_trygetreward();

            if ( isdefined( var_15 ) )
            {
                scripts\mp\gametypes\br_blueprint_extract_spawn::blueprintextract_beforepickupspawned( var_2 );
                var_16 = 12;
                var_13 = [ var_15 ];
                questrewarddropitems( var_13, var_3, var_4, 0, var_16 );
...
questrewarddropitems( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( scripts\mp\gametypes\br_lootcache::canspawnitemname( var_8 ) )
        {
            var_9 = level.br_pickups.br_itemrarity[var_8];

            if ( isdefined( var_9 ) && var_9 == 4 && var_6 == 0 )
            {
                scripts\mp\gametypes\br_lootcache::lootspawnitem( var_8, var_5, var_1, var_2, var_3, 1, var_4 );
                var_5++;
                var_6 = 1;
            }
            else
            {
                scripts\mp\gametypes\br_lootcache::lootspawnitem( var_8, var_5, var_1, var_2, var_3, 0, var_4 );
                var_5++;
            }
        }
    }
