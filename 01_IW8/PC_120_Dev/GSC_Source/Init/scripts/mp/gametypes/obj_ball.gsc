...
ball_spawn( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "ball" || getdvarint( "scr_uplink_create_ball" ) == 1 )
    {
        ...
        var_3 setnonstick( 1 );
        level.ballweapon = makeweapon( "iw7_uplinkball_mp" );
    ...
    else
    {
        var_3 setmodel( "offhand_wm_emp" );
        var_3 setnonstick( 1 );
        level.ballweapon = makeweapon( "iw7_tdefball_mp" );
...
ball_on_pickup( var_0, var_1 )
{
    ...
    if ( var_4 )
    {
        ...
        else
        {
            ...
            if ( isplayer( var_0 ) )
                var_0 thread scripts\common\utility::trycall( level.matchdata_loggameevent, "pickup_interception", var_0.origin );
        }
    }
    else
    {
...
ball_on_reset()
{
    ...
    thread scripts\common\utility::trycall( level.matchdata_loggameevent, "obj_return", var_0.baseorigin );
}
...
ball_pass_projectile( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        self.projectile = scripts\cp_mp\utility\weapon_utility::_magicbullet( makeweapon( "uplinkball_tracking_mp" ), var_7 + var_6 * var_10, var_8, var_0 );
...
ball_return_home( var_0, var_1 )
{
    ...
    if ( istrue( level.explodeonexpire ) && istrue( var_0 ) )
        detonateball();

    if ( istrue( level.possessionresetcondition ) )
    {
        if ( istrue( level.ballactivationdelay ) )
...
ball_location_hud()
{
    for (;;)
    {
        var_0 = scripts\engine\utility::waittill_any_return_4( "pickup_object", "dropped", "reset", "ball_ready" );
...
updatetimers( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( var_2 ) )
    {
        if ( istrue( level.ballactivationdelay ) && !istrue( level.ballreset ) )
