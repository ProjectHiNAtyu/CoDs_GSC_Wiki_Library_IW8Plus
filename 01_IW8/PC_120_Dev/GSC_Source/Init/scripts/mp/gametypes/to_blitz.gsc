...
onspawnfinished()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        switch ( var_3 )
        {
            ...
            case "iw8_la_rpapa7_mp":
            case "iw8_la_juliet_mp":
                var_4 = makeweapon( "iw8_pi_usierra45_mp" );
...
rpgcrateenduse( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2 thread scripts\mp\weapons::watchpickup();
    ...
    var_0 scripts\mp\weapons::setlastdroppableweaponobj( makeweapon( "iw8_la_rpapa7_mp" ) );
}
...
ontimelimit()
{
    if ( isdefined( level.onphaseend ) )
    {
        var_0 = scripts\mp\gamescore::calculatewinningteam( 0 );
