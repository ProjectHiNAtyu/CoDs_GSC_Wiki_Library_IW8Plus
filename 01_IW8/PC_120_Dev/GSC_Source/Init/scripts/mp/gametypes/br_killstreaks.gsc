...
dangernotifyplayersinrange( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_6 in var_4 )
    {
        if ( isdefined( var_6 ) && scripts\mp\utility\player::isreallyalive( var_6 ) && var_6.team != self.team )
            dangernotifyplayer( var_6, var_2, var_3 );
    }
}

dangernotifyplayer( var_0, var_1, var_2, var_3 )
{
    if ( istrue( var_2 ) && scripts\mp\utility\killstreak::getkillstreakenemyusedialogue( var_1 ) )
    {
        var_4 = scripts\mp\gametypes\br_public::brgetoperatorteam( self );
    ...
    if ( var_1 > 0 )
    {
        ...
        dangernotifyresetforplayer( var_0, var_3 );
    }
}
...
dangernotifyresetforplayer( var_0, var_1 )
{
    ...
    level thread watchdangerresetaction( var_0, var_2, "death_or_disconnect" );
    level thread watchdangerresetaction( var_0, var_2, undefined, var_1 );
}

watchdangerresetaction( var_0, var_1, var_2, var_3 )
{
