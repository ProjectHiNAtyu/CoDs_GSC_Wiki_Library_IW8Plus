...
playertrytakedefibrillator( var_0 )
{
    if ( isalive( self ) && isdefined( var_0 ) && isdefined( var_0.basename ) && var_0.basename == "iw8_defibrillator_mp" && self hasweapon( "iw8_defibrillator_mp" ) )
    {
        ...
        if ( var_1.size > 0 && !scripts\mp\utility\weapon::ismeleedefaultweapon( var_1[0] ) )
            self switchtoweapon( var_1[0] );
        else if ( var_1.size > 1 && !scripts\mp\utility\weapon::ismeleedefaultweapon( var_1[1] ) )
...
useentrespawntimeout( var_0, var_1, var_2 )
{
    ...
    var_1 scripts\engine\utility::waittill_any_timeout_no_endon_death_1( var_0, "disconnect" );
    self notify( "timeout" );
    waittillframeend;
