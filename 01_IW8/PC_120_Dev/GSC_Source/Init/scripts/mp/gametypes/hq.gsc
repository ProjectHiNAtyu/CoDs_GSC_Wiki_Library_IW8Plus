...
hqmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture::lockedradialunfill( level.firstzoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture::lockedradialunfill( level.zoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
calculatespawndisttozones( var_0 )
{
    ...
    {
        var_3 = getpathdist( var_0.origin, var_2.trigger.origin, 5000 );

        if ( var_3 < 0 )
            var_3 = scripts\engine\utility::distance_2d_squared( var_0.origin, var_2.trigger.origin );
        else
            var_3 = var_3 * var_3;
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isplayer( var_5 ) )
    {
        if ( !isscoreboosting( var_5 ) )
        {
            ...
            var_5 thread scripts\mp\rank::scoreeventpopup( "hq_secure" );
    ...
    for ( var_7 = 0; var_7 < var_6.size; var_7++ )
    {
        ...
        if ( !isscoreboosting( var_8 ) )
        {
            ...
            var_5 scripts\mp\utility\stats::setextrascore0( var_8.pers["captures"] );
        }
        else
        {
    ...
    while ( !level.gameended )
    {
        ...
        if ( !level.usehprules )
        {
            ...
            if ( !istrue( level.scoreleadchanged ) )
                adjustmatchtimerpausedstatefromleadchange( var_3 );
