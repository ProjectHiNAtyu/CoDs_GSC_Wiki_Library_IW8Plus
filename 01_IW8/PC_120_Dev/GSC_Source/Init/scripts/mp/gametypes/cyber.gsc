...
getspawnpoint()
{
    ...
    if ( scripts\mp\utility\game::getgametypenumlives() != 1 )
    {
        if ( scripts\mp\spawnlogic::shoulduseteamstartspawn() )
        {
            ...
            var_1 = scripts\mp\spawnlogic::getspawnpoint( self, var_0, level.cyberteamspawnsetids[var_0], "neutral" );
    }
...
assignteamspawns()
{
    ...
    else
    {
        foreach ( var_9 in var_0 )
        {
            var_9.teambase = getnearestbombsiteteam( var_9 );
...
startmatchobjectiveicons()
{
    ...
    level.cyberemp scripts\mp\gameobjects::setmlgobjectivestatusicon( "mlg_icon_waypoint_emp_planted" );
    ...
    level.cyberemp scripts\mp\gameobjects::setobjectivestatusallicons( "icon_waypoint_escort_emp", "waypoint_capture_kill", "mlg_icon_waypoint_emp_planted", var_0 );
...
onenduse( var_0, var_1, var_2 )
{
    ...
    if ( !var_2 )
    {
        if ( var_1.isdefusing )
            ...
            scripts\mp\gameobjects::setobjectivestatusallicons( "icon_waypoint_defend_empsite", "icon_waypoint_target_empsite", "mlg_icon_waypoint_emp_planted" );
...
onuse( var_0 )
{
    ...
    if ( !scripts\mp\gameobjects::isfriendlyteam( var_0.pers["team"] ) && !level.bombplanted )
    {
        ...
        level.bombplanted = 1;
        scripts\mp\gameobjects::setmlgobjectivestatusicon( "mlg_icon_waypoint_emp_planted" );
...
setupfordefusing( var_0, var_1 )
{
    ...
    thread scripts\mp\gametypes\obj_bombzone::bombradialfill( var_1.team, "icon_waypoint_planted_empsite", "icon_waypoint_defuse_empsite" );
...
onnormaldeath( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0.isplanting )
    {
        thread scripts\common\utility::trycall( level.matchdata_logvictimkillevent, var_2, "planting" );
        var_1 scripts\mp\utility\stats::incpersstat( "defends", 1 );
        var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
    }
    else if ( var_0.isbombcarrier )
        thread scripts\common\utility::trycall( level.matchdata_logvictimkillevent, var_2, "carrying" );
    else if ( var_0.isdefusing )
        thread scripts\common\utility::trycall( level.matchdata_logvictimkillevent, var_2, "defusing" );
}
    ...
    if ( isdefined( level.cyberemp.carrier ) )
    {
        if ( isdefined( var_1 ) && isplayer( var_1 ) && var_1.pers["team"] != var_13.pers["team"] )
        {
            ...
            else if ( istrue( var_13.isbombcarrier ) )
            {
                ...
                if ( istrue( var_13.showempminimap ) )
...
waitandwatchradarsweep()
{
    ...
    while ( gettime() < var_0 )
    {
        if ( self == level.cyberemp.carrier && self.currentprimaryweapon.basename == "iw8_cyberemp_mp" )
        {
            waitframe();
            continue;
        }
