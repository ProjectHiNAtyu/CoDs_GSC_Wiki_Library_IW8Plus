...
init()
{
    ...
    level.br_alt_mode_inflation.stream_time = min( getdvarfloat( "scr_br_alt_mode_inflation_stream_time", 2.0 ), level.br_alt_mode_inflation.respawn_delay );
...
playerdropplunderondeath( var_0, var_1 )
{
    ...
    {
        self.plundercount = self.plundercount - level.br_alt_mode_inflation.cost;
    ...
    var_2 = int( var_2 * level.br_alt_mode_inflation.drop_percent );
    scripts\mp\gametypes\br_plunder::playersetplundercount( self.plundercount - var_2, getsetplundercountdatanosplash() );

    if ( level.br_alt_mode_inflation.drop_max >= 0 )
        var_2 = int( min( level.br_alt_mode_inflation.drop_max, var_2 ) );

    scripts\mp\gametypes\br_plunder::dropcondensedplunder( var_2, var_0 );
    return 1;
}
...
circletimer( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_gulag::getgulagclosedcircleindex();
    ...
    if ( !level.br_alt_mode_inflation.disabled && var_0 >= var_1 )
    {
        ...
        foreach ( var_3 in level.players )
        {
            ...
            scripts\mp\gametypes\br_killstreaks::dangernotifyplayer( var_3, "gulag_closed", undefined, 2 );
        }
    }
...
assignspectatortospectatetryagain( var_0 )
{
    ...
    var_0 scripts\mp\gametypes\br_spectate::playerspawnintermissionifneeded();
    var_0 setclientomnvar( "ui_show_spectateHud", var_0 getentitynumber() );
    wait 1.0;
    var_1 = scripts\mp\gametypes\br_spectate::getbestspectatecandidate( var_0 );
