...
init()
{
    ...
    scripts\mp\gametypes\br_gametypes::registerbrgametypedata( "dropBagDelay", 120 );
...
playerrespawn()
{
    ...
    scripts\mp\gametypes\br_gulag::gulagwinnerrespawn( 1 );
}
...
teamextractedvictory( var_0, var_1 )
{
    ...
    scripts\mp\gametypes\br_public::brleaderdialogteam( "team_victory", var_0 );
    [var_3, var_4, var_5] = scripts\mp\gametypes\br::calculatebrbonusxp( 1 );
    var_6 = level.teamdata[var_0]["players"];

    foreach ( var_8 in var_6 )
    {
        var_8 scripts\mp\gametypes\br_quest_util::uiobjectivehide();
...
teamextractedspawnspectate( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        var_5 thread scripts\mp\gametypes\br_spectate::spawnspectator( var_2, 1, 1 );
    }
...
playerdropplunderondeath( var_0 )
{
    ...
    scripts\mp\gametypes\br_plunder::playersetplundercount( var_1 );
...
doextractionevent( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            level thread scripts\mp\gametypes\br_public::brleaderdialogteam( "plunder_extract_requested", var_1.team, 1 );
            level thread scripts\mp\gametypes\br_public::brbroadcastplayercardsplash( "br_gametype_extract_heli_incoming" );
            return;
        }
    }
...
extractplunder( var_0 )
{
    ...
    level thread scripts\mp\gametypes\br_public::brbroadcastplayercardsplash( "br_gametype_extract_heli_arrived" );
    level thread scripts\mp\gametypes\br_public::brleaderdialogteam( "plunder_extract_chopper_arrive", var_0.team, 1 );
...
helistoreplunder( var_0 )
{
    ...
    var_0 scripts\mp\gametypes\br_analytics::branalytics_plunder_placed_into_extraction( var_0, "little_bird", self.origin, var_1 );
    var_2 = 0;
