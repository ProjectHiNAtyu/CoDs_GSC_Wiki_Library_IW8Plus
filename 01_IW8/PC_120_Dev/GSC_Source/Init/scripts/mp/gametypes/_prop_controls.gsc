...
propinputwatch()
{
    ...
    if ( !scripts\mp\gametypes\br_gametype_prop::useprophudserver() )
    {
        self setclientomnvar( "ui_ph_is_locked", 0 );
        self setclientomnvar( "ui_ph_matching_slope", 0 );
    }

    scripts\mp\gametypes\br_gametype_prop::waittillmatchstarts();
...
propchange()
{
    ...
    self.prop.info = scripts\mp\gametypes\br_gametype_prop::getnextprop( self );
    propchangeto( self.prop.info );
    self.maxhealth = int( scripts\mp\gametypes\br_gametype_prop::getprophealth( self.prop.info ) );
...
propchangeto( var_0 )
{
    ...
    scripts\mp\gametypes\br_gametype_prop::applyxyzoffset();
    scripts\mp\gametypes\br_gametype_prop::applyanglesoffset();
...
propability()
{
    if ( !scripts\mp\flags::gameflag( "props_hide_over" ) )
        return;
...
propspectate()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 == "spectate" )
        {
            ...
            scripts\mp\gametypes\br_gametype_prop::createpropspeclist();
...
setnewabilitycount( var_0, var_1 )
{
    switch ( var_0 )
    {
        case "FLASH":
            if ( !isdefined( var_1 ) )
                var_1 = level.phsettings.propnumflashes;

            propsetflashesleft( var_1 );
            break;
        case "CLONE":
            if ( !isdefined( var_1 ) )
                var_1 = level.phsettings.propnumclones;
...
flashenemies( var_0, var_1 )
{
    ...
    foreach ( var_3 in level.players )
    {
        ...
        if ( !isdefined( var_3 ) || !isalive( var_3 ) || !isdefined( var_3.team ) || var_3 scripts\mp\gametypes\br_gametype_prop::playerisprop() )
            continue;
...
cloneprop()
{
    ...
    var_0 thread scripts\mp\gametypes\br_gametype_prop::highlighttoteam( game["defenders"], "outline_nodepth_cyan", self );
...
propabilitykeysvisible( var_0, var_1 )
{
    ...
    if ( scripts\mp\gametypes\br_gametype_prop::useprophudserver() || istrue( var_1 ) )
    {
