...
setupmissionwidget()
{
    var_0 = scripts\mp\gametypes\br_quest_util::getquesttableindex( "gt_evac" );

    foreach ( var_2 in level.players )
        var_2 scripts\mp\gametypes\br_quest_util::setquestindexomnvar( var_0 );
}
...
{
    if ( isdefined( var_0 ) )
        scripts\mp\gametypes\br_gulag::shutdowngulag( "circle_index", var_0 );

    level thread scripts\mp\gametypes\br_public::brbroadcastplayercardsplash( "br_gametype_evac_incoming" );
    scripts\mp\gametypes\br_quest_util::cancelallmissions();
    scripts\mp\gametypes\br_quest_util::disablealltablets();
    ...
    scripts\mp\gametypes\br_circle::setstaticuicircles( var_8, level.br_circle.safecircleui, level.br_circle.dangercircleui, 0 );
...
extractthink( var_0 )
{
    ...
    level thread scripts\mp\gametypes\br_public::brbroadcastplayercardsplash( "br_gametype_evac_arrived" );
