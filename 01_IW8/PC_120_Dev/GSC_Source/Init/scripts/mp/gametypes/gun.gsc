...
updategametypedvars()
{
    ...
    level.ladderindex = scripts\mp\utility\dvars::dvarintvalue( "ladderIndex", 1, 1, 5 );
}
...
getspawnpoint()
{
    if ( isplayer( self ) && self.gun_firstspawn )
    {
        ...
        var_0 = randomint( level.teamnamelist.size );
        scripts\mp\menus::addtoteam( level.teamnamelist[var_0], 1 );
    }
    ...
    if ( level.ingraceperiod )
    {
        ...
        if ( var_2.size > 0 )
        {
            ...
            var_1 = scripts\mp\spawnlogic::getspawnpoint_startspawn( var_2, 1 );
        }

        if ( !isdefined( var_1 ) )
        {
            var_2 = scripts\mp\spawnlogic::getteamspawnpoints( self.team );
            var_1 = scripts\mp\spawnscoring::getstartspawnpoint_freeforall( var_2 );
        }

        return var_1;
    }

    var_1 = scripts\mp\spawnlogic::getspawnpoint( self, "none", "normal", "fallback" );
    return var_1;
}
...
onplayerkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( var_3 == "MOD_FALLING" || isdefined( var_1 ) && isplayer( var_1 ) )
    {
        ...
        var_11 = scripts\mp\utility\weapon::isknifeonly( var_4.basename ) || scripts\mp\utility\weapon::isaxeweapon( var_4.basename ) || var_4.basename == "iw8_knifestab_mp";
        ...
        if ( var_1 != self && var_3 == "MOD_PISTOL_BULLET" || var_3 == "MOD_RIFLE_BULLET" || var_3 == "MOD_HEAD_SHOT" || var_3 == "MOD_PROJECTILE" || var_3 == "MOD_PROJECTILE_SPLASH" || var_3 == "MOD_IMPACT" || var_3 == "MOD_GRENADE" || var_3 == "MOD_GRENADE_SPLASH" || var_3 == "MOD_EXPLOSIVE" || var_3 == "MOD_MELEE" && !var_11 || var_12 )
        {
            ...
            if ( !var_1 canprogressingunrank( var_4, var_13, var_12 ) )
                return;
...
givenextgun( var_0 )
{
    ...
    else if ( self.gungamegunindex != level.gun_guns.size - 1 )
    {
        ...
        var_6 = makeweapon( "iw8_knifestab_mp" );
...
setgunladder()
{
    ...
    switch ( level.ladderindex )
    {
        case 1:
            ...
            level.gun_guns[17] = "iw8_knife_mp";
            break;
        case 2:
            level.gun_guns[0] = "rand_pistol";
            level.gun_guns[1] = "rand_shotgun";
...
setgunsfinal()
{
    ...
    for ( var_0 = 0; var_0 < level.gun_guns.size; var_0++ )
    {
        ...
        if ( scripts\mp\utility\script::isstrstart( var_1, "rand_" ) )
        {
            ...
            if ( level.ladderindex == 5 )
                level.gun_guns[var_0] = scripts\mp\class::buildweapon_blueprint( var_2["weapon"], undefined, undefined, var_2["variantID"], undefined, undefined, scripts\cp_mp\utility\game_utility::isnightmap() );
            else
                level.gun_guns[var_0] = buildweaponfromrandomcategory( var_2 );
        ...
        var_4 = var_3;
        var_5 = 0;
        var_4 = gun_createrandomweapon( var_3, var_5, undefined, scripts\cp_mp\utility\game_utility::isnightmap() );
...
buildrandomweapontable()
{
    ...
    for (;;)
    {
        ...
        if ( var_3 == "" || getdvarint( var_3, 0 ) == 1 )
        {
            ...
            if ( level.ladderindex == 4 && var_4["variant"] == "" )
            {
                var_1++;
                continue;
            }

            level.weaponcategories[var_2][level.weaponcategories[var_2].size] = var_4;
        }
...
getrandomweaponfromcategory( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1.size > 0 )
    {
        ...
        if ( level.ladderindex == 5 )
            var_3["variantID"] = getrandomvariantid( var_3["weapon"] );
...
getrandomvariantid( var_0 )
{
    var_1 = undefined;
    var_2 = scripts\mp\gametypes\arena::getblockedweaponvariantidsmap();

    if ( isdefined( var_2[var_0] ) )
        var_1 = var_2[var_0];

    var_3 = scripts\mp\utility\weapon::getweaponrandomvariantid( var_0, var_1 );
    return var_3;
}
...
buildweaponfromrandomcategory( var_0 )
{
    ...
    var_2 = gun_createrandomweapon( var_0["weapon"], var_1, var_0["variantID"], scripts\cp_mp\utility\game_utility::isnightmap() );
    return var_2;
}
...
modifyweapon( var_0, var_1, var_2 )
{
    ...
    if ( var_1 > 0 )
    {
        ...
        if ( var_10.size > 0 )
        {
            var_11 = scripts\mp\utility\weapon::getallselectableattachments( var_0 );
            var_12 = var_11.size;
...
gun_createrandomweapon( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = gun_buildoverrideattachmentlist( var_4 );
...
gun_buildoverrideattachmentlist( var_0 )
{
    var_1 = scripts\mp\utility\weapon::getallselectableattachments( var_0 );
    var_2 = [];
...
getvalidattachments( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_10 in var_0 )
    {
        ...
        if ( !scripts\mp\utility\weapon::attachmentisselectable( var_2, var_10 ) )
        {
...
giveortakethrowingknife( var_0 )
{
    ...
    if ( scripts\mp\utility\weapon::isknifeonly( var_0 ) || scripts\mp\utility\weapon::isaxeweapon( var_0 ) )
    {
...
{
    return var_0 == "throwingknife_mp" || var_0 == "throwingknife_fire_mp";
}
...
{
    if ( isdefined( var_3 ) && var_3.basename == "iw8_knife_mp" )
    {
...
canprogressingunrank( var_0, var_1, var_2 )
{
