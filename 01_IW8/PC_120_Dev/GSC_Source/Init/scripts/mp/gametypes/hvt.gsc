...
watchhvts()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::array_sort_with_func( level.players, ::sortbyhvttags );
        ...
        for ( var_3 = 0; var_3 < var_0.size; var_3++ )
        {
            ...
            if ( var_4 ishvt() )
            {
                if ( isdefined( var_4.justbecamehvt ) )
                {
                    var_4.justbecamehvt = undefined;
                    var_1--;
                    continue;
                }
