...
sotfcratethink( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_7 = getcompleteweaponname( var_5.lastdroppableweaponobj );
...
playerjoinwatcher()
{
    for (;;)
    {
        ...
        if ( isdefined( self.crateiconid ) )
            scripts\cp_mp\entityheadicons::setheadicon_addclienttomask( self.crateiconid, var_0 );
    }
}
...
getrandomattachments( var_0 )
{
    ...
    var_5 = scripts\mp\utility\weapon::getallselectableattachments( var_4 );
