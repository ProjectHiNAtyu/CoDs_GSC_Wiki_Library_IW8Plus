...
hqmainloop()
{
    ...
    for (;;)
    {
        ...
        var_5 = level scripts\engine\utility::waittill_any_return_2( "hq_captured", "hq_destroyed" );
...
onradiodestroy( var_0 )
{
    ...
    var_0 thread scripts\common\utility::trycall( level.matchdata_loggameevent, "destroy", var_0.origin );
    ...
    if ( isdefined( level.radioobject ) )
    {
        ...
        if ( var_13 != var_10 )
        {
            if ( var_11 istouching( level.radioobject.trigger ) )
            {
                ...
                thread scripts\common\utility::trycall( level.matchdata_level.matchdata_logvictimkillevent, var_9, "defending" );
            }
        }
