...
domflags()
{
    ...
    foreach ( var_3 in level.objectives )
    {
        ...
        var_3 scripts\mp\gametypes\obj_dom::domflag_setneutral();
    }
...
getspawnpointflagassignment( var_0 )
{
    ...
    if ( !isdefined( scripts\cp_mp\utility\game_utility::getlocaleid() ) && isdefined( var_0.script_noteworthy ) && var_0.script_noteworthy != "" )
    {
...
findnearestdompoint( var_0 )
{
    ...
    var_5 = findclosestpointbyapproxpathdist( var_1, getclosestpointonnavmesh( var_0 ) );
    var_6 = undefined;
...
updatetriggerforcodcaster()
{
    ...
    while ( !level.gameended )
    {
        foreach ( var_1 in level.players )
        {
            ...
            if ( !isdefined( var_1.mlgpoint ) || var_1.mlgpoint != var_2 )
            {
                var_1 setisusingspecialist( var_2 );
                var_1.mlgpoint = var_2;
