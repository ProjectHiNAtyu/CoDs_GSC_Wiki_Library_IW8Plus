...
onstartgametype()
{
    ...
    if ( var_5 )
    {
        if ( israndomloadouts() || israndompreviewloadouts() || israndomblueprintsloadouts() || israndomalphaloadouts() )
...
updategametypedvars()
{
    ...
    level.arenaloadouts = scripts\mp\utility\dvars::dvarintvalue( "arenaLoadouts", 1, 1, 13 );
    ...
    if ( ispickuploadouts() )
    {
        ...
        else if ( level.loadoutchangeround == 0 || game["roundsPlayed"] % level.loadoutchangeround != 0 )
        {
            ...
            level.arenaweapont1.weapon = game["arenaWeaponT1"];
            level.arenaweapont2.weapon = game["arenaWeaponT2"];
            level.arenaweapont3.weapon = game["arenaWeaponT3"];
            level.arenaweapont4.weapon = game["arenaWeaponT4"];
            level.arenaweapont5.weapon = game["arenaWeaponT5"];
            level.arenaweapont6.weapon = game["arenaWeaponT6"];
            level.arenaweapont7.weapon = game["arenaWeaponT7"];
            level.arenaweapont8.weapon = game["arenaWeaponT8"];
        }
        ...
        game["arenaWeaponT1"] = level.arenaweapont1.weapon;
        game["arenaWeaponT2"] = level.arenaweapont2.weapon;
        game["arenaWeaponT3"] = level.arenaweapont3.weapon;
        game["arenaWeaponT4"] = level.arenaweapont4.weapon;
        game["arenaWeaponT5"] = level.arenaweapont5.weapon;
        game["arenaWeaponT6"] = level.arenaweapont6.weapon;
        game["arenaWeaponT7"] = level.arenaweapont7.weapon;
        game["arenaWeaponT8"] = level.arenaweapont8.weapon;
    }
}
    ...
    if ( scripts\mp\spawnlogic::shoulduseteamstartspawn() || istrue( level.alwaysusestartspawns ) || isintournament() )
    {
        ...
        if ( !isdefined( var_0 ) )
        {
            if ( istrue( self.switching_teams_arena ) && isdefined( self.pers["arena_spawn_pos"] ) )
            {
                ...
                if ( isdefined( var_0 ) )
                    self.spawnpointangles = var_0.angles;
            }
            else
            {
                var_0 = getspawnpoint_startspawn( var_3 );
            ...
            if ( !isdefined( var_0 ) )
            {
                ...
                if ( var_4 > 3 )
                {
                    ...
                    foreach ( var_6 in scripts\mp\utility\teams::getteamdata( self.pers["team"], "players" ) )
                    {
                        if ( istrue( var_6.buddyspawnplayer ) )
                        {
                            var_9++;
                            continue;
                        }
                    ...
                    if ( isdefined( var_8 ) )
                    {
                        ...
                        if ( isdefined( var_8.spawnpointangles ) )
                            var_0.angles = var_8.spawnpointangles;
                    }
                }
            }
...
onplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13 )
{
    ...
    {
        if ( istrue( level.snowballfight ) && ( var_6.basename == "snowball_mp" || var_6.basename == "pball_mp" ) )
            playfxontagforclients( level.snowfx["screen"], var_2, "tag_eye", var_2 );
...
buildprimaries( var_0, var_1, var_2 )
{
    ...
    if ( istrue( level.specialdayloadouts ) && istrue( var_2 ) )
    {
        var_8 = getspecialdaycamos();
        game["arenaRandomLoadout"][game["arenaRandomLoadoutIndex"]]["loadoutPrimaryCamo"] = var_8;

        if ( validtousecosmetic( var_0 ) )
        {
            var_12 = getspecialdaycosmetics();
            game["arenaRandomLoadout"][game["arenaRandomLoadoutIndex"]]["loadoutPrimaryCosmeticAttachment"] = var_12;
        }

        if ( validtousesticker( var_0 ) )
        {
            var_13 = getspecialdaystickers();
...
validtousecosmetic( var_0 )
{
    var_1 = scripts\mp\utility\weapon::getweaponrootname( var_0 );
    return var_1 != "iw8_me_riotshield" && var_1 != "iw8_knife" && var_1 != "iw8_fists" && var_1 != "iw8_gunless" && var_1 != "iw8_la_gromeo" && var_1 != "iw8_la_mike32" && var_1 != "iw8_la_juliet" && var_1 != "iw8_la_kgolf";
}

validtousesticker( var_0 )
{
    return var_0 != "iw8_knife_mp";
}
...
buildspecialdaypickupweapon( var_0 )
{
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_2 = getspecialdaycamos();
        var_0.camoname = var_2;

        if ( validtousecosmetic( var_0.weapon ) )
        {
            var_6 = getspecialdaycosmetics();
            var_0.cosmeticattachment = var_6;
        }

        if ( validtousesticker( var_0.weapon ) )
        {
            var_7 = getspecialdaystickers();
            var_0.stickers[0] = var_7[0];
            var_0.stickers[1] = var_7[1];
            var_0.stickers[2] = var_7[2];
            var_0.stickers[3] = var_7[3];
        }
...
defineplayerloadout()
{
    ...
    {
        var_7 = scripts\mp\utility\weapon::getweaponrootname( level.startweapon );

        if ( istrue( level.specialdayloadouts ) )
        {
            var_1 = getspecialdaycamos();
            game["arenaRandomLoadout"][0]["loadoutPrimaryCamo"] = var_1;

            if ( validtousecosmetic( level.startweapon ) )
            {
                var_5 = getspecialdaycosmetics();
                game["arenaRandomLoadout"][0]["loadoutPrimaryCosmeticAttachment"] = var_5;
            }

            if ( validtousesticker( level.startweapon ) )
            {
                var_6 = getspecialdaystickers();
    ...
    level.arena_loadouts["default"]["loadoutPrimary"] = var_7;
    level.arena_loadouts["default"]["loadoutPrimaryAttachment"] = "none";
    level.arena_loadouts["default"]["loadoutPrimaryAttachment2"] = "none";
    level.arena_loadouts["default"]["loadoutPrimaryAttachment3"] = "none";
    level.arena_loadouts["default"]["loadoutPrimaryAttachment4"] = "none";
    level.arena_loadouts["default"]["loadoutPrimaryAttachment5"] = "none";
    level.arena_loadouts["default"]["loadoutPrimaryCamo"] = var_1;
    level.arena_loadouts["default"]["loadoutPrimaryCosmeticAttachment"] = var_5;
    level.arena_loadouts["default"]["loadoutPrimaryReticle"] = var_2;
    level.arena_loadouts["default"]["loadoutPrimarySticker"] = var_6[0];
    level.arena_loadouts["default"]["loadoutPrimarySticker1"] = var_6[1];
    level.arena_loadouts["default"]["loadoutPrimarySticker2"] = var_6[2];
    level.arena_loadouts["default"]["loadoutPrimarySticker3"] = var_6[3];
    level.arena_loadouts["default"]["loadoutPrimaryVariantID"] = -1;
...
cacherandomloadouts()
{
    ...
    var_0 = [];
    var_1 = 0;
    var_2 = scripts\engine\utility::ter_op( israndomblueprintsloadouts(), "mp/classtable_arena_blueprints.csv", "mp/classTable_arena.csv" );
    ...
    if ( israndompreviewloadouts() )
        var_1 = 144;
    else if ( israndomarloadouts() )
        var_1 = 0;
    else if ( israndomsmgloadouts() )
        var_1 = 43;
    else if ( israndompistolloadouts() )
        var_1 = 71;
    else if ( israndomshotgunloadouts() )
        var_1 = 101;
    else if ( israndomsniperloadouts() )
        var_1 = 121;
    else if ( israndomlmgloadouts() )
        var_1 = 149;
    ...
    while ( scripts\mp\class::table_getloadoutname( var_2, var_1 ) != "" )
    {
        ...
        if ( israndomloadouts() || israndomblueprintsloadouts() )
        {
            if ( var_1 == 144 )
                break;
        }
        else if ( israndompreviewloadouts() )
        {
            if ( var_1 == 0 )
                break;
        }
    ...
    var_0 = arenaloadouts_select( var_0, 99 );
    game["arenaRandomLoadout"] = scripts\engine\utility::array_randomize( var_0 );
}

updateloadoutarray( var_0, var_1 )
{
    var_2 = getblockedweaponvariantidsmap();
    var_3 = [];
    var_3["loadoutAddBlueprintAttachments"] = scripts\mp\class::table_getaddblueprintattachments( var_0, var_1 );
    ...
    var_6 = scripts\mp\class::table_getweaponvariantid( var_0, var_1, 0 );

    if ( var_6 == -1 )
    {
        var_7 = undefined;

        if ( isdefined( var_2[var_3["loadoutPrimary"]] ) )
            var_7 = var_2[var_3["loadoutPrimary"]];

        var_6 = scripts\mp\utility\weapon::getweaponrandomvariantid( var_3["loadoutPrimary"], var_7 );
    }

    var_3["loadoutPrimaryVariantID"] = var_6;

    if ( scripts\mp\utility\game::getgametype() == "arena" && var_3["loadoutPrimaryVariantID"] != 0 )
        setomnvar( "ui_arena_primaryVariantID", var_6 );

    var_3["loadoutSecondary"] = scripts\mp\class::table_getweapon( var_0, var_1, 1 );
    ...
    for ( var_4 = 0; var_4 < scripts\mp\class::getmaxsecondaryattachments(); var_4++ )
    {
        ...
        var_3[var_5] = scripts\mp\class::table_getweaponattachment( var_0, var_1, 1, var_4 );
    }

    if ( istrue( level.specialdayloadouts ) )
        var_3["loadoutSecondaryCamo"] = scripts\mp\class::table_getweaponcamo( var_0, var_1, 1 );
    else
        var_3["loadoutSecondaryCamo"] = scripts\mp\class::table_getweaponcamo( var_0, var_1, 1 );

    var_3["loadoutSecondaryReticle"] = scripts\mp\class::table_getweaponreticle( var_0, var_1, 1 );
    var_8 = scripts\mp\class::table_getweaponvariantid( var_0, var_1, 1 );

    if ( var_8 == -1 )
    {
        var_7 = undefined;

        if ( isdefined( var_2[var_3["loadoutSecondary"]] ) )
            var_7 = var_2[var_3["loadoutSecondary"]];

        var_8 = scripts\mp\utility\weapon::getweaponrandomvariantid( var_3["loadoutSecondary"], var_7 );
    }

    var_3["loadoutSecondaryVariantID"] = var_8;

    if ( scripts\mp\utility\game::getgametype() == "arena" && var_3["loadoutSecondaryVariantID"] != 0 )
        setomnvar( "ui_arena_secondaryVariantID", var_3["loadoutSecondaryVariantID"] );

    var_3["loadoutEquipmentPrimary"] = scripts\mp\class::table_getequipmentprimary( var_0, var_1 );
    var_3["loadoutExtraEquipmentPrimary"] = scripts\mp\class::table_getextraequipmentprimary( var_0, var_1 );
    var_3["loadoutEquipmentSecondary"] = scripts\mp\class::table_getequipmentsecondary( var_0, var_1 );
    var_3["loadoutExtraEquipmentSecondary"] = scripts\mp\class::table_getextraequipmentsecondary( var_0, var_1 );
    var_3["loadoutPerks"] = [];

    for ( var_9 = 0; var_9 < 3; var_9++ )
    {
        var_10 = scripts\mp\class::table_getperk( var_0, var_1, var_9 );

        if ( var_10 != "specialty_null" )
            var_3["loadoutPerks"][var_3["loadoutPerks"].size] = var_10;
    }
...
spawnweapon( var_0, var_1, var_2 )
{
    ...
    if ( var_9 != "" )
    {
        if ( istrue( level.snowballfight ) && var_3 == "equip_snowball" )
        {
            if ( isplayer( var_0 ) )
                var_8 = "single";
            ...
            if ( !isplayer( var_0 ) && var_0.script_label == "6" && !level.pickedpball )
            {
            ...
            else if ( !isplayer( var_0 ) && var_0.script_label == "8" && !level.pickedpball )
            {
        ...
        if ( istrue( level.snowballfight ) )
        {
            var_10 thread watchsnowballpickup( var_0, var_8 );
    ...
    else
    {
        ...
        if ( isdefined( var_0.script_noteworthy ) && var_0.script_noteworthy == "wall" )
        {
            ...
            var_19.bot_pickup_origin = var_22;
        }
...
{
    var_0 = [];
    var_0["iw8_ar_tango21"] = [ 1 ];
    var_0["iw8_ar_mike4"] = [ 5 ];
    var_0["iw8_ar_kilo433"] = [ 3 ];
    var_0["iw8_ar_scharlie"] = [ 3 ];
    var_0["iw8_sm_uzulu"] = [ 4 ];
    var_0["iw8_sh_romeo870"] = [ 5 ];
    var_0["iw8_sh_dpapa12"] = [ 3 ];
    var_0["iw8_lm_mgolf34"] = [ 4 ];
    var_0["iw8_sn_kilo98"] = [ 16 ];
    var_0["iw8_sn_alpha50"] = [ 2 ];
    var_0["iw8_sn_hdromeo"] = [ 4 ];
    var_0["iw8_pi_golf21"] = [ 3 ];
    var_0["iw8_pi_cpapa"] = [ 15 ];
    return var_0;
}
...
giveflagcapturexp( var_0, var_1 )
{
    ...
    if ( isplayer( var_2 ) )
    {
        ...
        var_2 thread scripts\common\utility::trycall( level.matchdata_loggameevent, "capture", var_2.origin );
    }
...
getoutlineasset( var_0, var_1 )
{
    ...
    if ( istrue( level.snowballfight ) && isdefined( var_1 ) && var_1 == "equip_pball" )
        var_2 = "outline_depth_yellow";
...
watchsnowballpickup( var_0, var_1 )
{
    self endon( "death" );
    ...
    else
    {
        ...
        if ( !isplayer( var_0 ) )
            level thread waitthenrespawnsnowballs( var_0 );
...
waitthenrespawnsnowballs( var_0 )
{
    level endon( "game_ended" );
    wait 15;
    playfx( level.snowfx["vanish"], var_0.origin );
