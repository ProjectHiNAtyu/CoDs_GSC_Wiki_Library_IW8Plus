...
{
    var_0 = self;
    return istrue( var_0.br_iseliminated ) && !isalive( var_0 ) && !istrue( var_0.gulag );
}
...
{
    var_0 = self;
    return isdefined( var_0.accesscard );
}
...
{
    var_0 = self;
    return istrue( var_0.isbrsquadleader ) && var_0.game_extrainfo & 256;
}
...
brleaderdialogplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_7 = tolower( var_7 );
    var_8 = lookupsoundlength( var_7, 1 ) / 1000.0;

    if ( isdefined( var_4 ) )
        wait( var_4 );

    var_1 queuedialogforplayer( var_7, var_0, var_8 );
}
...
playergetlaststandpistol()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( weaponclass( var_2 ) == "pistol" && var_3 != "iw8_fists_mp" && var_3 != "iw8_knifestab_mp" && var_3 != "iw8_me_riotshield_mp" )
            return var_2;
    }
}
...
playerstreamhintlocation( var_0, var_1, var_2, var_3 )
{
    thread playerstreamhintlocationinternal( var_0, var_1, var_2, var_3 );
}

playerstreamhintlocationinternal( var_0, var_1, var_2, var_3 )
{
    self notify( "playerPrestreamLocationWait" );
    self endon( "playerPrestreamLocationWait" );
    self endon( "disconnect" );
    var_4 = !self scriptablegetmidpoint();
    ...
    if ( var_4 )
    {
        ...
        while ( ( !self ispredictedstreamposready() || istrue( var_2 ) && !self hasloadedcustomizationplayerview( self ) ) && gettime() < var_5 )
            waitframe();
...
damagearmor( var_0, var_1 )
{
    ...
    updatebrscoreboardstat( "armorHealthRatio", int( self.br_armorhealth ) );
    return var_3;
}
