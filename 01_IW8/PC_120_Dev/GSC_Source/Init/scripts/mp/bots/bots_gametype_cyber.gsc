...
setup_bot_cyber()
{
    ...
    var_0 = scripts\mp\bots\bots_gametype_common::bot_verify_and_cache_bombzones( [ "_allies", "_axis" ] );
    ...
    for (;;)
    {
        ...
        if ( !isdefined( level.team_planted_bomb ) )
        {
            ...
            else if ( self.isbombcarrier )
            {
                ...
                var_4 = scripts\mp\bots\bots_gametype_common::get_bombzone_node_to_plant_on( var_3, 1 );
        ...
        var_3 = level.objectives[scripts\engine\utility::get_enemy_team( level.team_planted_bomb )];
        ...
        {
            var_6 = scripts\mp\bots\bots_gametype_common::get_bombzone_node_to_defuse_on( var_3 ).origin;
