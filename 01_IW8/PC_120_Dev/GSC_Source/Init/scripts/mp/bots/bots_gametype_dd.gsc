...
notify_enemy_team_bomb_used( var_0 )
{
    ...
    var_2 = scripts\mp\bots\bots_gametype_common::get_ai_hearing_bomb_plant_sound( var_0 );
...
plant_bomb()
{
    ...
    var_0 = scripts\mp\bots\bots_gametype_common::get_bombzone_node_to_plant_on( self.current_bombzone, 0 );
    ...
    if ( var_1 == "goal" )
    {
        ...
        var_6 = scripts\mp\bots\bots_gametype_common::bombzone_press_use( level.planttime + 2, "bomb_planted", var_5 );
...
defuse_bomb()
{
    ...
    var_0 = scripts\mp\bots\bots_gametype_common::get_bombzone_node_to_defuse_on( self.current_bombzone ).origin;
    ...
    if ( var_1 == "goal" )
    {
        ...
        var_10 = scripts\mp\bots\bots_gametype_common::bombzone_press_use( level.defusetime + 2, "bomb_defused", var_9 );
