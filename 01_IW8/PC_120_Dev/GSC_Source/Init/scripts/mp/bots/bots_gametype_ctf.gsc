...
bot_ctf_think()
{
    ...
    for (;;)
    {
        ...
        if ( !isdefined( self.role ) )
            scripts\mp\bots\bots_gametype_common::bot_gametype_initialize_attacker_defender_role();
        ...
        if ( bot_ctf_player_has_flag() )
        {
            ...
            else if ( scripts\mp\bots\bots_gametype_common::bot_gametype_get_num_players_on_team( self.team ) == 1 )
...
{
    var_1 = scripts\mp\bots\bots_gametype_common::bot_gametype_get_num_players_on_team( var_0 );
...
{
    return scripts\mp\bots\bots_gametype_common::bot_gametype_get_allied_attackers_for_team( var_0, level.capzones[var_0].curorigin, get_flag_protect_radius() );
}

get_allied_defenders_for_team( var_0 )
{
    return scripts\mp\bots\bots_gametype_common::bot_gametype_get_allied_defenders_for_team( var_0, level.capzones[var_0].curorigin, get_flag_protect_radius() );
}
...
bot_ctf_ai_director_update()
{
    ...
    level endon( "game_ended" );
    thread scripts\mp\bots\bots_gametype_common::bot_gametype_attacker_defender_ai_director_update();
}
