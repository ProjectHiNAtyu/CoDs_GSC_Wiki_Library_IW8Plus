...
sr_pick_up_tag( var_0 )
{
    ...
    if ( var_2 == "goal" && var_0 scripts\mp\bots\bots_gametype_conf::bot_can_tag_interact_with( self.team ) )
        wait 3.0;
...
watch_tag_destination( var_0 )
{
    ...
    for (;;)
    {
        if ( !var_0 scripts\mp\bots\bots_gametype_conf::bot_can_tag_interact_with( self.team ) )
            wait 0.05;
...
notify_when_tag_picked_up_or_unavailable( var_0, var_1 )
{
    ...
    while ( var_0 scripts\mp\bots\bots_gametype_conf::bot_can_tag_interact_with( self.team ) && !scripts\mp\bots\bots_gametype_conf::bot_check_tag_above_head( var_0 ) )
        wait 0.05;
...
sr_camp_tag( var_0 )
{
    ...
    while ( var_0 scripts\mp\bots\bots_gametype_conf::bot_can_tag_interact_with( self.team ) && self.role == var_1 )
    {
