...
bot_gun_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_3.basename != "none" && !scripts\mp\utility\weapon::iskillstreakweapon( var_3 ) && var_3.basename != var_1 && var_3.basename != "iw8_knifestab_mp" )
        {
            var_1 = var_3.basename;

            if ( self botgetdifficultysetting( "advancedPersonality" ) && self botgetdifficultysetting( "strategyLevel" ) > 0 )
                bot_gun_pick_personality_from_weapon( var_3.basename, var_2 );
        }
