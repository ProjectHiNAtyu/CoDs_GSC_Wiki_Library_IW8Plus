...
setup_bot_hq()
{
    ...
    if ( !var_0 )
    {
        ...
        scripts\mp\bots\bots_gametype_common::bot_cache_entrances_to_zones( [ var_5 ] );
...
bot_cache_entrances_to_other_radios( var_0 )
{
    for ( var_1 = scripts\engine\utility::array_remove( level.objectives, var_0 ); var_1.size > 0; var_1 = scripts\engine\utility::array_remove( var_1, var_2 ) )
    {
        ...
        scripts\mp\bots\bots_gametype_common::bot_cache_entrances_to_zones( [ var_2 ] );
...
bot_hq_think()
{
    ...
    for (;;)
    {
        ...
        if ( !isdefined( var_0 ) || !var_0.active || !isdefined( level.bot_gametype_radios_precached[var_0.trigger getentitynumber()] ) )
        {
            bot_clear_hq_zone();
