    ...
    for (;;)
    {
        ...
        foreach ( var_6, var_9 in var_3 )
        {
            if ( var_9 >= 2 )
            {
                ...
                if ( var_9 == 2 && !istrue( level.siege_bot_team_triple_cap_check[var_6] ) )
                {
                    if ( randomint( 100 ) > 75 )
                        level.siege_bot_team_need_flags[var_6] = 1;
                    else
                        level.siege_bot_team_triple_cap_check[var_6] = 0;

                    level.siege_bot_team_had_advantage[var_6] = 1;
                }

                continue;
            }

            if ( var_9 < 2 && istrue( level.siege_bot_team_had_advantage[var_6] ) )
            {
                level.siege_bot_team_had_advantage[var_6] = 0;
                level.siege_bot_team_triple_cap_check[var_6] = 0;
            }
        }
