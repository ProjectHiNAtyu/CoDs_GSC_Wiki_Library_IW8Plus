...
setup_bot_sd()
{
    ...
    var_0 = scripts\mp\bots\bots_gametype_common::bot_verify_and_cache_bombzones( [ "_a", "_b" ] );
...
atk_bomber_update()
{
    ...
    else
    {
        ...
        {
            self botsetpathingstyle( "scripted" );
            var_11 = scripts\mp\bots\bots_gametype_common::get_bombzone_node_to_plant_on( var_10, 1 );
        ...
        if ( var_12 == "goal" )
        {
            ...
            var_17 = scripts\mp\bots\bots_gametype_common::bombzone_press_use( level.planttime + 2, "bomb_planted", var_16 );
            self botclearscriptgoal();
...
bomb_defuser_update()
{
    ...
    if ( var_4 == "goal" )
    {
        ...
        var_13 = scripts\mp\bots\bots_gametype_common::bombzone_press_use( level.defusetime + 2, "bomb_defused", var_11, var_12 > 40 );
...
backstabber_update()
{
    ...
    if ( self.backstabber_stage == "3_move_to_bombzone" )
    {
        ...
        self botsetpathingstyle( undefined );
        var_9 = self botsetscriptgoal( scripts\engine\utility::random( self.bombzone_picked.bottargets ).origin, 160, "objective" );
        ...
        if ( var_9 )
        {
            ...
            if ( var_10 == "goal" )
            {
                ...
                {
                    if ( var_14 != self.bombzone_picked )
                    {
                        self.bombzone_picked = var_14;
                        break;
                    }
                }
            }
...
{
    var_1 = scripts\mp\bots\bots_gametype_common::get_ai_hearing_bomb_plant_sound( var_0 );
