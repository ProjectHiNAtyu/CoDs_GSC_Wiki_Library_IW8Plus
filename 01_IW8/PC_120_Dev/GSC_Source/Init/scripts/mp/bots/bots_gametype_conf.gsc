...
bot_find_visible_tags( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( level.dogtags ) )
    {
        ...
        {
            if ( var_7 bot_can_tag_interact_with( self.team ) )
            {
                var_8 = 0;
...
bot_remove_invalid_tags( var_0 )
{
    ...
    {
        if ( var_3.tag bot_can_tag_interact_with( self.team ) && scripts\mp\bots\bots_util::bot_vectors_are_equal( var_3.tag.curorigin, var_3.origin ) )
        {
