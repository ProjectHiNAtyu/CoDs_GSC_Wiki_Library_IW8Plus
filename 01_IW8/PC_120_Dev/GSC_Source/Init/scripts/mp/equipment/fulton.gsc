...
fulton_initrepository()
{
    var_0 = scripts\mp\gametypes\br_plunder::plunder_getleveldataforrepository( "equip_mp_fulton", 1 );
    var_0.type = 0;
...
fulton_create( var_0 )
{
    ...
    var_1 sendclientmatchdataforclient( 1 );
...
{
    var_1 = scripts\mp\gametypes\br_plunder::plunder_getleveldataforrepository( "equip_mp_fulton" );
    thread scripts\mp\gametypes\br::teamsplashbr( "br_fulton_balloon_shot_down", self.owner, self.team );
    scripts\mp\gametypes\br_plunder::entityplunderlosealldeposited( var_1.dropplunder );
...
fulton_deletenextframe()
{
    ...
    scripts\mp\gametypes\br_plunder::plunder_deregisterrepositoryinstance( self );
...
fulton_planted()
{
    ...
    scripts\mp\gametypes\br_plunder::plunder_registerrepositoryinstance( self, "equip_mp_fulton" );
    thread scripts\mp\gametypes\br_plunder::plunder_repositorywatchcountdown( self, var_0 );
    scripts\mp\gametypes\br_plunder::plunder_updateanchoredwidgetforplayers( self, var_0 );
    ...
    fulton_open();
    var_2 = scripts\mp\gametypes\br_plunder::plunder_getleveldataforrepository( "equip_mp_fulton", 1 );
...
{
    var_3 = scripts\mp\gametypes\br_plunder::plunder_getleveldataforrepository( "equip_mp_fulton" );
    var_1 thread scripts\mp\gametypes\br_plunder::playerplunderevent( var_2, var_3.useeventtype, var_0 );
}
...
fulton_repositorycountdownendcallback( var_0, var_1 )
{
    ...
    scripts\mp\gametypes\br_plunder::plunder_repositoryextract( var_0 );
}
...
fulton_repositoryextractcallback( var_0 )
{
    ...
    var_2 = scripts\mp\gametypes\br_plunder::entityplunderbankalldeposited();
    thread scripts\mp\gametypes\br::teamsplashbr( "br_fulton_balloon_successfully_away", self.owner, self.team );
...
{
    thread scripts\mp\gametypes\br::teamsplashbr( "br_fulton_balloon_full", var_0.owner, var_0.team );
}
