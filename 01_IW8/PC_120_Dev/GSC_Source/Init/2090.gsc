...
waitforentervehicle()
{
    var_0 = scripts\engine\utility::waittill_any_return_4( "entervehicle", "death", "long_death", "failedentervehicle" );
...
exitingvehicle()
{
    ...
    self._blackboard.currentvehicle.canopendoor = 0;
    self._blackboard.currentvehicle thread exitvehicledelay();
}
