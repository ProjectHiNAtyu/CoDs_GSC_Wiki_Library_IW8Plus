...
vehicle_occupancy_mp_onentervehicle( var_0, var_1, var_2, var_3 )
{
    ...
    if ( getdvar( "scr_br_gametype", "" ) == "dmz" )
        scripts\mp\gametypes\br_plunder::plunder_allowallrepositoryuseforplayer( var_2, 0, 1 );
...
vehicle_occupancy_mp_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) )
    {
        if ( !istrue( var_3.playerdeath ) )
        {
            ...
            if ( getdvar( "scr_br_gametype", "" ) == "dmz" )
                scripts\mp\gametypes\br_plunder::plunder_allowallrepositoryuseforplayer( var_2, 1, 1 );
