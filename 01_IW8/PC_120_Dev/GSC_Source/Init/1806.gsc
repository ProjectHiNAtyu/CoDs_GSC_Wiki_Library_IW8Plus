...
waittill_any_return_1( var_0, var_1, var_2, var_3 )
{
...
waittill_any_return_2( var_0, var_1, var_2 )
{
...
waittill_any_return_3( var_0, var_1, var_2, var_3 )
{
...
waittill_any_return_4( var_0, var_1, var_2, var_3, var_4 )
{
...
waittill_any_return_5( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
waittill_any_return_6( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
waittill_any_return_7( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
...
waittill_any_return_no_endon_death_1( var_0, var_1 )
{
    var_2 = spawnstruct();
...
waittill_any_return_no_endon_death_2( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
...
waittill_any_return_no_endon_death_3( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
waittill_any_return_no_endon_death_4( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
waittill_any_return_no_endon_death_5( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
waittill_any_return_no_endon_death_6( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = spawnstruct();

    if ( isdefined( var_0 ) )
        childthread waittill_string_no_endon_death( var_0, var_7 );

    if ( isdefined( var_1 ) )
        childthread waittill_string_no_endon_death( var_1, var_7 );

    if ( isdefined( var_2 ) )
        childthread waittill_string_no_endon_death( var_2, var_7 );

    if ( isdefined( var_3 ) )
        childthread waittill_string_no_endon_death( var_3, var_7 );

    if ( isdefined( var_4 ) )
        childthread waittill_string_no_endon_death( var_4, var_7 );

    if ( isdefined( var_5 ) )
        childthread waittill_string_no_endon_death( var_5, var_7 );
...
waittill_any_timeout_1( var_0, var_1, var_2 )
{
...
waittill_any_timeout_2( var_0, var_1, var_2, var_3 )
{
...
waittill_any_timeout_3( var_0, var_1, var_2, var_3, var_4 )
{
...
waittill_any_timeout_4( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
waittill_any_timeout_5( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
waittill_any_timeout_6( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( ( !isdefined( var_1 ) || var_1 != "death" ) && ( !isdefined( var_2 ) || var_2 != "death" ) && ( !isdefined( var_3 ) || var_3 != "death" ) && ( !isdefined( var_4 ) || var_4 != "death" ) && ( !isdefined( var_5 ) || var_5 != "death" ) && ( !isdefined( var_6 ) || var_6 != "death" ) )
        self endon( "death" );
    ...
    var_8 childthread _timeout( var_0 );
    var_8 waittill( "returned", var_9 );
    var_8 notify( "die" );
    return var_9;
}
...
waittill_any_timeout_no_endon_death_1( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
...
waittill_any_timeout_no_endon_death_2( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
waittill_any_timeout_no_endon_death_3( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
waittill_any_timeout_no_endon_death_4( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
waittill_any_timeout_no_endon_death_5( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = spawnstruct();
...
waittill_any_4( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
waittill_any_5( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
waittill_any_6( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
waittill_any_7( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
waittill_any_8( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
{
    var_3 = var_1 waittill_any_return_2( var_2, "death" );
...
flag_wait_either_return( var_0, var_1 )
{
    for (;;)
    {
        ...
        var_2 = level waittill_any_return_2( var_0, var_1 );
        return var_2;
    }
}
...
flag_wait_any_return( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        var_6 = level waittill_any_return_5( var_0, var_1, var_2, var_3, var_4 );
        return var_6;
    }
}
...
ispointinsidecircle( var_0, var_1, var_2 )
{
...
requestgamerprofile( var_0 )
{
    ...
    self endon( "disconnect" );
    self setadditionalstreamloaddist( var_0 );
...
ismountconfigenabled()
{
    ...
    if ( is_player_gamepad_enabled() )
        var_1 = requestgamerprofile( "mountButtonConfig" );
    else
        var_1 = requestgamerprofile( "mountButtonConfigKBM" );
