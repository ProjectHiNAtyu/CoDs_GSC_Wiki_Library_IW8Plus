...
tryuseshocksentry( var_0 )
{
    ...
    if ( var_1 )
        scripts\common\utility::trycall( level.matchdata_logkillstreakevent, var_0.streakname, self.origin );
    else
        waitframe();
...
setcarryingsentry( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        var_4 = scripts\engine\utility::waittill_any_return_4( "place_sentry", "cancel_sentry", "force_cancel_placement", "emp_applied" );
...
sam_fireontarget()
{
    if ( isdefined( self.samtargetent ) )
    {
        ...
        for ( var_2 = 0; var_2 < 4; var_2++ )
        {
            ...
            self shootturret();
            var_3 = scripts\cp_mp\utility\weapon_utility::_magicbullet( makeweapon( "sam_projectile_mp" ), var_0[var_2], self.samtargetent.origin, self.owner );
