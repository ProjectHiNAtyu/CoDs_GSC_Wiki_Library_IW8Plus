...
van_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "van", 1 );
    var_0.id = 13;
...
van_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "van", 1350 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "van" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "van" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "van", 8 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "van", ::van_deathcallback );
}
