...
aigroundturret_requestmount( var_0 )
{
    if ( !isdefined( self._blackboard.aigroundturretstate ) )
    {
        self._blackboard.aigroundturretstate = 1;
        self._blackboard.aigroundturretref = var_0;
        return 1;
    }
...
{
    if ( isdefined( self._blackboard.aigroundturretstate ) && self._blackboard.aigroundturretstate == 1 )
        self._blackboard.aigroundturretstate = 2;
}
...
aigroundturret_cancel()
{
    if ( isdefined( self._blackboard.aigroundturretstate ) )
    {
        if ( self._blackboard.aigroundturretstate == 1 )
        {
            self._blackboard.aigroundturretstate = undefined;
            self._blackboard.aigroundturretref = undefined;
            return 1;
        }
        else if ( self._blackboard.aigroundturretstate == 2 )
        {
            self._blackboard.aigroundturretstate = 3;
            return 1;
        }
    }
...
{
    if ( isdefined( self._blackboard.aigroundturretstate ) && self._blackboard.aigroundturretstate == 3 )
    {
        self._blackboard.aigroundturretstate = undefined;
        self._blackboard.aigroundturretref = undefined;
    }
...
ai_operate_turret( var_0, var_1 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_2 = var_0 aigroundturret_requestmount( var_1 );
...
ai_dismount_turret( var_0 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_1 = var_0 aigroundturret_cancel();
