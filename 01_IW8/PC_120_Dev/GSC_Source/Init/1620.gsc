...
animatedprop_setup( var_0, var_1, var_2, var_3 )
{
...
animatedprop_setanim( var_0, var_1 )
{
...
asm_playanimstateindex( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) )
        scripts\mp\agents\scriptedagents::playanimnatrateuntilnotetrack( var_1, var_2, var_3, var_1, "end", var_4 );
    else
        scripts\mp\agents\scriptedagents::playanimnuntilnotetrack( var_1, var_2, var_1, "end", var_4 );
}
...
dooropen( var_0, var_1 )
{
    ...
    {
        var_2 = getentitylessscriptablearray( undefined, undefined, var_0.origin, 64 );
...
doorneedstoclose( var_0 )
{
    ...
    var_4 = angleclamp180( var_3 - var_0.closedangles[1] );
    var_5 = angleclamp180( var_0.angles[1] - var_0.closedangles[1] );
...
asm_animhasfacialoverridemp( var_0 )
{
    if ( !animisleaf( var_0 ) )
        return 0;
...
asm_playfacialanim_mp( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) )
        asm_playfacialaniminternalmp( var_2, var_3 );
    else
    {
...
asm_playfacialaniminternalmp( var_0, var_1 )
{
    ...
    if ( isdefined( var_0 ) && asm_animhasfacialoverridemp( var_0 ) )
        return;
