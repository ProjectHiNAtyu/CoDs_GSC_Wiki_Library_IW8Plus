...
rallypointvehicle_activate( var_0 )
{
    ...
    thread scripts\mp\spawnselection::vehicleindangertracking( var_0 );
...
rallypoint_showafterprematch( var_0 )
{
    var_0 endon( "death" );
...
rallypoint_activatevehiclemarker( var_0 )
{
    ...
    else
    {
        ...
        thread rallypoint_showafterprematch( var_0 );
    }
    ...
    scripts\mp\objidpoolmanager::update_objective_icon( var_3.objidnum, scripts\engine\utility::ter_op( var_0.vehiclename == "little_bird", level.iconrallypointheli, level.iconrallypoint ) );
