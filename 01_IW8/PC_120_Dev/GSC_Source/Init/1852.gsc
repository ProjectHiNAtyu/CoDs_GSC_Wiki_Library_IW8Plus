...
updateteamscoreplacements()
{
    ...
    waittillframeend;
    var_0 = tablesort( game["teamScores"], "down" );
    var_1 = undefined;
    var_2 = 0;
...
giveplayerscore( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\common\utility::trycall( level.matchdata_logscoreevent, var_0 );
...
giveteamscoreforobjective( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5 ) )
        ...
        var_9 = calculatewinningteam( var_2 );

    if ( !istrue( var_4 ) )
        playscorestatusdialog( var_9, var_2, level.waswinning );
...
playscorestatusdialog( var_0, var_1, var_2 )
{
...
playleadtakendialog( var_0 )
{
    ...
    level.lastscorestatustime = gettime();
    var_1 = calculatewinningteam( var_0 );
...
processassist_regularmp( var_0, var_1, var_2 )
{
    ...
    thread scripts\cp_mp\challenges::onplayerkillassist( var_0 );
}
...
awardbuffdebuffassists( var_0, var_1 )
{
    ...
    foreach ( var_8, var_7 in var_2 )
    {
        if ( !isdefined( var_1.attackerdata ) || !isdefined( var_1.attackerdata[var_7.guid] ) )
            scripts\mp\damage::addattacker( var_1, var_7, undefined, nullweapon(), 0, undefined, undefined, undefined, undefined, undefined );
    }
}
...
loggamescore()
{
    ...
    dlog_recordevent( "dlog_event_score_change", [ "team_1_name", var_0, "team_2_name", var_1, "team_1_score", var_2, "team_2_score", var_3 ] );
}
