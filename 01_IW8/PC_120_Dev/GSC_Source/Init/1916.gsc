...
loadsupertable()
{
    ...
    for (;;)
    {
        ...
        var_2.refundondeath = readsupertablecell( var_0, 6, 1 );
        ...
        var_2.brsingleuse = readsupertablecell( var_0, 19, 1 );
...
registersupers()
{
    ...
    registersuper( "super_select", ::superselectonset, ::superselectonunset, ::superselectbeginuse, undefined );
    registersuper( "super_fulton", undefined, undefined, ::superfultonbeginuse, undefined );
    registersuper( "super_supply_drop", undefined, undefined, ::supersupplydropbeginuse, undefined );
...
registersuperextraweapon( var_0, var_1 )
{
    ...
    var_2.extraweapons[var_2.extraweapons.size] = var_1;
    level.superglobals.supersbyextraweapon[var_1] = var_2;
}
...
givesuper( var_0, var_1, var_2 )
{
    ...
    var_4.overridepointsneeded = undefined;
    setsuperisinuse( 0 );
    superonset( var_0 );
...
clearsuper( var_0 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_1.staticdata ) )
        superonunset( var_1.staticdata.ref );
...
superusefinished( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        ...
        else if ( var_4.staticdata.brsingleuse )
        {
            clearsuper();
            self setclientomnvar( "ui_perk_package_state", 0 );
            self setclientomnvar( "ui_super_progress", 0 );
...
handledeath()
{
    ...
    var_0 = getcurrentsuper();
    var_1 = var_0.staticdata.refundondeath;
...
manageuseweapon( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( !var_1.canstow && !issameweapon( var_0, var_3, 1 ) )
        {
...
getsuperpointsneeded()
{
    ...
    if ( isdefined( var_0.overridepointsneeded ) )
        var_1 = var_0.overridepointsneeded;
...
getsuperrefforsuperextraweapon( var_0 )
{
    ...
    if ( !isdefined( level.superglobals.supersbyextraweapon[var_0] ) )
        return undefined;

    return level.superglobals.supersbyextraweapon[var_0].ref;
}
...
getsuperrefforsuperweapon( var_0 )
{
    ...
    var_2 = getsuperrefforsuperextraweapon( var_0 );
...
writesppmstats()
{
    ...
    dlog_recordevent( "mpscript_sppm", [ "sppm", var_2, "sppm_applied", var_3, "gamemode", scripts\mp\utility\game::getgametype(), "kills", self.kills, "time_played", var_1, "best_event", var_4, "script_version", getscriptdataversion() ] );
}
...
updateactivesupers( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_9 = var_5.basename == "throwingknife_mp";
    ...
    if ( var_11 )
    {
        ...
        if ( var_8 && var_0 scripts\mp\utility\perk::_hasperk( "specialty_bulletdamage" ) )
            var_1 thread scripts\mp\supers\super_stoppingpower::stoppingpower_onkill( var_5 );
    }
}
...
combatrecordsupermisc( var_0, var_1 )
{
    if ( !scripts\mp\utility\stats::canrecordcombatrecordstats() )
        return;
...
scramblebeginuse()
{
    ...
    thread scripts\cp_mp\killstreaks\helper_drone::helperdrone_watchscamblereffectdist( self );
    return 1;
}
...
superselectonset()
{
    ...
    self.super.overridepointsneeded = var_5;
}
...
recordsuperearnedanalytics( var_0 )
{
    ...
    var_1 = scripts\mp\persistence::statgetchildbuffered( "round", "timePlayed", 1 ) / 60.0;
    dlog_recordevent( "mpscript_super_earning", [ "super_ref", var_0.staticdata.ref, "earn_time", var_1, "gamemode", scripts\mp\utility\game::getgametype(), "script_version", getscriptdataversion(), "earned_count", self.pers["supersEarned"] ] );
}
