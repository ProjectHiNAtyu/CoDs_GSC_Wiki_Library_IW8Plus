...
runcruisepredator( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::islargemap() || scripts\common\utility::iscp() || level.mapname == "mp_scrapyard" )
        var_5 = self.origin;
...
cruisepredator_watchintropoddisown( var_0, var_1, var_2 )
{
    self endon( "death" );
    ...
    if ( isdefined( self ) )
    {
        cruisepredator_detachplayerfromintro( var_0, var_1, var_2 );
        self delete();
    }
}
...
cruisepredator_followmissilepod( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !istrue( var_2 ) )
    {
        ...
        var_0 thread cruisepredator_watchintropoddisown( var_3, var_12, var_13 );
        var_0 thread cruisepredator_watchownerdisownaction( "disconnect" );
        var_0 thread cruisepredator_watchownerdisownaction( "joined_team" );
        var_0 thread cruisepredator_watchownerdisownaction( "joined_spectators" );
    }
...
cruisepredator_takecontrol( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 thread cruisepredator_watchgameend( var_1 );
    ...
    var_7 thread cruisepredator_watchownerdisownaction( "disconnect" );
    var_7 thread cruisepredator_watchownerdisownaction( "joined_team" );
    var_7 thread cruisepredator_watchownerdisownaction( "joined_spectators" );
...
cruisepredator_watchgameend( var_0 )
{
    self endon( "death" );
    self.owner endon( "disconnect" );
...
cruisepredator_watchmissileexplosion( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        if ( !istrue( var_3 ) )
        {
            ...
            var_1 scripts\cp_mp\utility\killstreak_utility::recordkillstreakendstats( var_9 );
        }
    }
...
cruisepredator_watchownerdisownaction( var_0 )
{
    self endon( "death" );
    self endon( "disowned" );
    level endon( "game_ended" );
