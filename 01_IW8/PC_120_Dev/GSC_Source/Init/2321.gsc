...
{
    var_1 = scripts\cp_mp\utility\weapon_utility::_magicbullet( makeweapon( "pop_rocket_proj_mp" ), var_0.origin, var_0.origin + anglestoforward( self getgunangles() ), self );
    var_1.owner = self;
