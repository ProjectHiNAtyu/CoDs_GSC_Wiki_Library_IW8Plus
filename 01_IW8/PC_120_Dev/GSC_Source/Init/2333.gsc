...
init_airstrike_params()
{
    ...
    level.airstrikesettings["multi_airstrike"].deployweaponobj = makeweapon( scripts\mp\killstreaks\mapselect::getmapselectweapon() );
    ...
    level.airstrikesettings["fuel_airstrike"].deployweaponobj = makeweapon( scripts\mp\killstreaks\mapselect::getmapselectweapon() );
}
