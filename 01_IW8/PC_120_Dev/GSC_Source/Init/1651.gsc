...
guy_runtovehicle_loaded( var_0, var_1 )
{
    ...
    if ( !getdvarint( "enable_vehicle_ai_using_BT" ) )
    {
        var_2 = var_0 scripts\engine\utility::waittill_any_return_3( "long_death", "death", "enteredvehicle" );
...
prepdoorsforunload()
{
    ...
    for ( var_0 = 0; var_0 < level.vehicle.templates.aianims[scripts\common\vehicle_code::get_vehicle_classname()].size; var_0++ )
    {
        ...
        if ( isdefined( var_1.vehicle_getoutanim ) )
        {
            ...
            self.doorstate[var_2] = spawnstruct();
            self.doorstate[var_2].open = 0;
            self.doorstate[var_2].openrequested = 0;
        }
    }
}
...
animontag_ragdoll_death_fall( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.script_stay_drone ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            level.gun = spawn( "weapon_" + getcompleteweaponname( var_7 ), ( 0, 0, 0 ) );
