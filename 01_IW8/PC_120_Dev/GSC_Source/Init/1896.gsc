...
waitformorerecordingtimeforscene( var_0 )
{
    ...
    if ( var_4 > gettime() )
    {
        ...
        var_5 = scripts\engine\utility::waittill_any_return_no_endon_death_2( "potg_pending_scene_timeout", "potg_stop_recording" );
...
datalog_scenefinalized( var_0 )
{
    ...
    dlog_recordevent( "mpscript_potg", [ "score", var_0.score, "duration", var_0.playbackendtime - var_0.playbackstarttime, "start_time", var_0.playbackstarttime, "action_start_offset", var_0.actionstarttime - var_0.playbackstarttime, "action_end_offset", var_0.actionendtime - var_0.playbackstarttime, "entity_id", getentityid( var_0.primaryentity ), "script_version", var_1 ] );

    foreach ( var_3 in var_0.events )
        dlog_recordevent( "mpscript_potg_final_events", [ "event_ref", var_3.eventref, "score", var_3.score, "start_time", var_3.playbackstarttime, "end_time", var_3.playbackendtime, "script_version", var_1 ] );
}
...
datalog_newevent( var_0, var_1, var_2 )
{
    ...
    dlog_recordevent( "mpscript_potg_events", [ "event_ref", var_0.eventref, "score", var_0.score, "start_time", var_0.starttime, "end_time", var_0.endtime, "event_id", var_1, "entity_id", getentityid( var_2 ), "script_version", datalog_getlogversion() ] );
}
...
datalog_archivesaved( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    dlog_recordevent( "mpscript_potg_archive", [ "requestTime", var_0, "archiveStartTime", var_1, "archiveDuration", var_2, "desiredSceneStartTime", var_3, "desiredSceneEndTime", var_4, "playerCount", level.players.size, "tickRate", int( 1.0 / level.framedurationseconds ), "dedi", scripts\engine\utility::ter_op( isdedicatedserver(), 1, 0 ), "version", 0 ] );
}
...
debug_watcharchivefinished( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        var_3 = getpotgstarttime();

        if ( var_3 != var_1 )
        {
            level notify( "potg_archive_request_finished" );
            debug_logarchiveresult( 1, var_2, var_0, var_3, getpotgduration() );
            break;
        }
