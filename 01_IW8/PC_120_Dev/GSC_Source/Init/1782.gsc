...
_anim_scene_internal_blend_in( var_0, var_1, var_2, var_3, var_4 )
{
    foreach ( var_6 in var_0 )
    {
        if ( var_6.is_player )
        {
            ...
            var_6.entity setstance( get_actor_stance( var_6 ) );
...
get_actor_stance( var_0 )
{
    if ( isdefined( var_0.entity.anim_scene_stance_override ) )
        return var_0.entity.anim_scene_stance_override;
