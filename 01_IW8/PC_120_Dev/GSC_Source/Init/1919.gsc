...
init()
{
    ...
    {
        level.teamdata[var_8] = [];
        level.teamdata[var_8]["players"] = [];
        level.teamdata[var_8]["alivePlayers"] = [];
        level.teamdata[var_8]["teamCount"] = 0;
        level.teamdata[var_8]["aliveCount"] = 0;
        level.teamdata[var_8]["livesCount"] = 0;
        level.teamdata[var_8]["hasSpawned"] = 0;
        level.teamdata[var_8]["oneLeftTime"] = 0;
        level.teamdata[var_8]["twoLeft"] = 0;
        level.teamdata[var_8]["oneLeft"] = 0;

        if ( level.multiteambased )
            level.teamdata[var_8]["deathEvent"] = 0;
    }

    foreach ( var_8 in var_1 )
    {
        scripts\mp\utility\teams::getteamfactionsfrommap( var_8 );
        scripts\mp\utility\teams::getteamname( var_8 );
        scripts\mp\utility\teams::getteamshortname( var_8 );
        scripts\mp\utility\teams::getteamicon( var_8 );
        scripts\mp\utility\teams::getteamheadicon( var_8 );
        scripts\mp\utility\teams::getteamvoiceinfix( var_8 );
    }
    ...
    if ( scripts\mp\utility\game::matchmakinggame() && !isintournament() && !getdvarint( "scr_disable_anti_afk", 0 ) )
...
createoperatorcustomization()
{
    ...
    var_10.voice = getoperatorvoice( var_8 );
    var_10.clothtype = getoperatorclothtype( var_9 );
    var_10.superfaction = getoperatorsuperfaction( var_8 );
    var_10.execution = getoperatorexecution( var_8 );
    var_10.executionquip = getoperatorexecutionquip( var_8 );
    var_10.suit = var_3;
    var_10.rebuild = 0;
    var_11 = spawnstruct();
    var_11.apc = getvehicleplayercamo( "apc" );
    var_11.apcturret = getvehicleplayerturretcamo( "apc" );
    var_11.atv = getvehicleplayercamo( "atv" );
    var_11.cargo_truck = getvehicleplayercamo( "cargo_truck" );
    var_11.jeep = getvehicleplayercamo( "jeep" );
    var_11.little_bird = getvehicleplayercamo( "little_bird" );
    var_11.tac_rover = getvehicleplayercamo( "tac_rover" );
    var_11.tank_east = getvehicleplayercamo( "tank_east" );
    var_11.tank_eastturret = getvehicleplayerturretcamo( "tank_east" );
    var_11.tank_west = getvehicleplayercamo( "tank_west" );
    var_11.tank_westturret = getvehicleplayerturretcamo( "tank_west" );
    ...
    self.vehiclecustomization = var_11;
}
...
lookupcurrentoperator( var_0 )
{
    ...
    if ( getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && self scriptablegetmidpoint() )
    {
        ...
        if ( !isdefined( self.headlesscustomizationops ) )
        {
            foreach ( var_9 in var_7 )
            {
                ...
                if ( !isdefined( level.headlessopindex[var_9] ) || level.headlessopindex[var_9] > var_10.size )
                    level.headlessopindex[var_9] = 0;

                for ( var_11 = var_10[level.headlessopindex[var_9]]; isdefined( var_11 ) && ( var_11 == "default_western" || var_11 == "default_eastern" ); var_11 = var_10[level.headlessopindex[var_9]] )
                {
                    level.headlessopindex[var_9] = level.headlessopindex[var_9] + 1;

                    if ( level.headlessopindex[var_9] > var_10.size )
                        level.headlessopindex[var_9] = 0;
                }
    ...
    else
    {
        if ( getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && self scriptablegetmidpoint() )
        {
            if ( !isdefined( level.playercustomizationdata[var_3][var_0].operatorskinindex ) )
            {
                ...
                var_5 = level.headlessoperatorcustomization[var_1]["curIndex"];
                level.playercustomizationdata[var_3][var_0].operatorskinindex = level.headlessoperatorcustomization[var_1]["lootIDs"][var_5];
                level.headlessoperatorcustomization[var_1]["curIndex"] = level.headlessoperatorcustomization[var_1]["curIndex"] + 1;

                if ( level.headlessoperatorcustomization[var_1]["curIndex"] >= level.headlessoperatorcustomization[var_1]["maxIndex"] )
                    level.headlessoperatorcustomization[var_1]["curIndex"] = 0;
            }
        }
...
getoperatorcustomization()
{
    ...
    if ( istrue( game["isLaunchChunk"] ) )
    {
        ...
        var_2 = level.defaultoperatorskins[self.team]["body"][self.pers["defaultOperatorSkinIndex"]];
        var_3 = level.defaultoperatorskins[self.team]["head"][self.pers["defaultOperatorSkinIndex"]];
        var_4 = level.defaultoperatorskins[self.team]["suit"][0];
        var_5 = [];
        var_5[0] = var_2;
        var_5[1] = var_3;
        var_5[2] = var_4;
    ...
    if ( ( var_0 == "default_western" || var_0 == "default_eastern" ) && ( var_1 == 274 || var_1 == 275 ) )
    {
        ...
        if ( !isdefined( self.defaultoperatorteam ) || var_6 && self.defaultoperatorteam != self.team && ( self.team == "allies" || self.team == "axis" ) )
        {
...
checkforafk()
{
    ...
    if ( istrue( self.hasscrapassist ) )
        return;

    if ( !isdefined( self.timeplayedonfirstspawn ) )
        return;

    var_2 = self.timeplayedonfirstspawn;
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && istrue( self.brkickedfromplane ) )
    {
    ...
    {
        var_8 = var_5 || level.gametype == "arena";
        ...
        if ( var_0 && !isgamebattlematch() && !istrue( self.afkroundcounted ) )
        {
...
setjuggernautmodel()
{
    var_0 = "body_opforce_juggernaut_mp_lod1";
    var_1 = "head_opforce_juggernaut";
    var_2 = "viewhands_opforce_juggernaut";
...
getoperatorexecutionquip( var_0 )
{
    ...
    if ( var_1 == 0 )
        self.loadoutexecutionquip = tablelookup( "operators.csv", 1, var_0, 23 );
    else
        self.loadoutexecutionquip = tablelookup( "operatorquips.csv", 0, var_1, 6 );
...
getoperatorvoice( var_0 )
{
    var_1 = tablelookup( "operators.csv", 1, var_0, 10 );
    return var_1;
}

getoperatorclothtype( var_0 )
{
...
initheadlessoperatorcustomization()
{
    ...
    for ( var_1 = 0; var_1 < var_0; var_1++ )
    {
        if ( tablelookupbyrow( "operatorskins.csv", var_1, 18 ) != "" )
        {
            ...
            if ( !isdefined( level.headlessoperatorcustomization[var_2] ) )
            {
                level.headlessoperatorcustomization[var_2]["lootIDs"] = [];
                level.headlessoperatorcustomization[var_2]["curIndex"] = 0;
                level.headlessoperatorcustomization[var_2]["maxIndex"] = 0;
            }

            level.headlessoperatorcustomization[var_2]["lootIDs"][level.headlessoperatorcustomization[var_2]["lootIDs"].size] = int( var_3 );
            level.headlessoperatorcustomization[var_2]["maxIndex"] = level.headlessoperatorcustomization[var_2]["maxIndex"] + 1;
        }
    }
}
...
initoperatorcustomization()
{
    ...
    for (;;)
    {
        ...
        if ( var_6 )
        {
            ...
            var_10[0] = var_8;
            var_10[1] = var_9;
            level.operatorcustomization[var_3][var_1][var_7] = var_10;
        }
    ...
    if ( istrue( level.onlinegame ) )
    {
        ...
        if ( isdefined( var_2 ) && var_2.size > 0 )
        {
            foreach ( var_4 in var_2 )
            {
                ...
                {
                    var_0 = var_4.team;
                    self.teamstarttime = var_4.teamstarttime;
                    break;
                }
            }
        }
...
findavailableteam( var_0 )
{
    ...
    foreach ( var_3 in level.teamnamelist )
    {
        ...
        if ( var_4 > 0 )
        {
            ...
            if ( isdefined( var_6[0].teamstarttime ) && gettime() > var_6[0].teamstarttime + 300000 )
                continue;
        }
