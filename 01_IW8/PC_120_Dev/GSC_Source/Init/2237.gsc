...
tryusesentryturretfromstruct( var_0 )
{
    ...
    var_1 = scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_doweaponswitchdeploy( var_0, makeweapon( "deploy_sentry_mp" ), 1, undefined, undefined, ::weaponcleanupsentryturret );
    ...
    scripts\cp_mp\killstreaks\manual_turret::manualturret_toggleallowactions( 0 );
    var_2 = sentryturret_create( "sentry_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        scripts\cp_mp\killstreaks\manual_turret::manualturret_toggleallowactions( 1 );
        self.bgivensentry = 0;
        return 0;
    }
...
sentryturret_setplaced( var_0, var_1 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
        var_0.minimapid = var_0.colmodel [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_4, var_0.team, undefined, 1, 1 );
    ...
    thread sentryturret_watchgameend( var_0 );
...
sentryturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        var_0.streakinfo.expiredbydeath = istrue( var_2 );
        scripts\cp_mp\utility\killstreak_utility::recordkillstreakendstats( var_0.streakinfo );
    }
    ...
    if ( isdefined( var_0.colmodel ) )
        var_0.colmodel delete();
