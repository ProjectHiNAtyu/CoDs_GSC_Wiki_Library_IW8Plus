...
watchendconditions()
{
    ...
    var_0 = scripts\engine\utility::waittill_any_return_no_endon_death_5( "tac_ops_map_selection_made", "tac_ops_map_changed", "tac_ops_map_cleared", "spawned_player", "tac_ops_map_game_ended" );
