...
init()
{
    var_0 = scripts\mp\utility\dvars::getoverridedvarfloatexceptmatchrulesvalues( "scr_" + scripts\mp\utility\game::getgametype() + "_healthregentime", "scr_player_healthregentime" );
...
healhregenthink( var_0 )
{
    ...
    if ( var_2 < 0.55 && !scripts\mp\utility\player::isusingremote() )
        onenterdeathsdoor();
    ...
    if ( var_6 )
    {
        ...
        scripts\cp_mp\challenges::onstim( var_10 );
        scripts\mp\analyticslog::logevent_playerhealed( self, var_10, self );
    }
    else if ( !isai( self ) )
        scripts\mp\analyticslog::logevent_playerregen( self, var_10 );
...
waitforhealthregendelay()
{
    ...
    {
        self.currentregendelay = self.currentregendelay - ( gettime() * 0.001 - var_0 ) * self.regendelayspeed;
        var_0 = gettime() * 0.001;
...
applyshrapnelfxinternal()
{
    ...
    level endon( "game_ended" );
    var_0 = scripts\engine\utility::waittill_any_return_3( "shrapnel_ended_early", "shrapnel_ended", "force_regeneration" );
