...
jeep_initinteract()
{
    ...
    var_0.seatenterarrays["single"] = [ "driver", "front_right", "back_left", "back_right" ];
}

jeep_initomnvars()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_getleveldataforvehicle( "jeep", 1 );
    var_0.id = 10;
...
jeep_initdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "jeep", 1500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "jeep" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_applytabletovehicle( "jeep" );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "jeep", 9 );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setdeathcallback( "jeep", ::jeep_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setweaponhitdamagedata( "jeep_mp", 3 );
}
