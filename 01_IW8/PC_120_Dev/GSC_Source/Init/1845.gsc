...
dopotgkillcam()
{
    if ( isdefined( level.skipfinalkillcam ) || istrue( level.nukedetonated ) )
        return;
...
dopotgkillcamforplayer()
{
    ...
    var_1 = scripts\engine\utility::waittill_any_return_no_endon_death_2( "begin_killcam", "killcam_ended" );
...
dofinalkillcam()
{
    ...
    level thread scripts\cp_mp\challenges::processfinalkillchallenges( var_2, var_3 );
...
skipkillcamduringdeathtimer( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        var_1 = scripts\engine\utility::waittill_any_return_2( "killcam_death_done_waiting", "killcam_death_button_cancel" );
