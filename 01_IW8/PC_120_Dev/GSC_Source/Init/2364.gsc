...
createtank( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_11 thread tank_watchforgameend();
    var_11 thread tank_watchpiggybackexploit();
...
tank_watchpiggybackexploit()
{
    ...
    for (;;)
    {
        scripts\cp_mp\vehicles\vehicle::vehicle_checkpiggybackexploit( self );
        waitframe();
    }
}
...
tank_destroy( var_0, var_1 )
{
    ...
    self.streakinfo.expiredbydeath = istrue( var_1 );
...
tank_driverexit( var_0 )
{
    ...
    if ( var_0 scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        level thread scripts\cp_mp\utility\killstreak_utility::restorekillstreakplayerangles( var_0 );
    }
}
