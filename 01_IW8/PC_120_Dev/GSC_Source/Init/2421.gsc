...
apc_rus_mp_initspawning()
{
    ...
    var_0.abandonedtimeoutdelay = 180;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
        var_0.respawndelay = level.apcrespawntime;
}
...
apc_rus_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::vehicle_spawn_waitandrespawn( "apc_russian", var_1, var_2 );
