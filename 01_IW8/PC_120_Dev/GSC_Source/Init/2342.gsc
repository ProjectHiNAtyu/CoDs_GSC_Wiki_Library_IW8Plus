...
rundronehive( var_0, var_1, var_2, var_3 )
{
    ...
    var_0 scripts\common\utility::trycall( level.matchdata_logkillstreakevent, var_2, var_10.origin );
    var_11 = 0;
    ...
    for (;;)
    {
        var_13 = var_10 scripts\engine\utility::waittill_any_return_2( "death", "missileTargetSet" );
