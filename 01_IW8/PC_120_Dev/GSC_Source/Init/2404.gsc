...
getmodifiedantikillstreakdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_10 = var_1.isalternatemode;
    var_11 = 0;

    if ( istrue( var_10 ) )
    {
        var_12 = scripts\mp\utility\weapon::getweaponattachmentsbasenames( var_1 );
    ...
    if ( isdefined( var_9 ) )
        self.largeprojectiledamage = var_9;
...
killshouldaddtokillstreak( var_0 )
{
    ...
    return !scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) && !scripts\mp\utility\points::isnokillstreakprogressweapon( var_0 );
}
