...
{
    if ( var_0 == "_encstr_B1AD05C65666E8" )
...
{
    if ( issubstr( var_0, "_encstr_B1AD05C65666E8" ) )
        return "_encstr_B1AD05C65666E8";

    if ( issubstr( var_0, "_encstr_9353062E718710C9" ) )
        return "_encstr_9353062E718710C9";
...
{
    var_0 = self getscriptablepartstateeventfield( "_encstr_9C6705A90F85C8", "_encstr_8830067E9F832BB3", "_encstr_806217F3D825E47B3B1FCACC256617EBA3280BC940C71F6750", "_encstr_8A46076AD9D099BB5E" );
...
{
    if ( var_1 == "_encstr_AF5007D88DDEE6AC23" )
    {
        if ( isdefined( self.owner ) )
            scriptable_door_unclaim();
    }
...
scriptable_door_hinge_progression( var_0, var_1 )
{
    ...
    var_4 = var_3 == "_encstr_AF5007D88DDEE6AC23" || var_3 == "_encstr_8830067E9F832BB3";
    var_5 = 0;

    if ( var_4 )
    {
        if ( var_1 == "_encstr_8A7D06CD972F91D1" )
        {
    ...
    if ( var_4 )
    {
        ...
        var_11 = "_encstr_AF5007D88DDEE6AC23";
    else if ( var_1 == "_encstr_8A7D06CD972F91D1" )
        var_11 = var_10;
    ...
    if ( var_11 == "_encstr_AF5007D88DDEE6AC23" )
    ...
    var_0 notify( "_encstr_9D5D14BADCB2F5CD8D4E5A838E0B138D59EB46B7F64E", self, var_0, var_2, var_11 );
}
...
scriptable_door_auto_close( var_0, var_1 )
{
    ...
    self notify( "_encstr_BE4115E248106379087BA9BC6FD0BB2348E62AEAD0F6F7" );
    self endon( "_encstr_BE4115E248106379087BA9BC6FD0BB2348E62AEAD0F6F7" );
    ...
    scripts\engine\utility::waittill_notify_or_timeout( "_encstr_947C1BF721D66B7B134F7A2C458723072AB357AA15139867A1650863F7", level.scriptable_door_autoclose_delay );
    ...
    self setscriptableuselargerbounds( 1 );
    self setscriptablepartstate( var_0, "_encstr_AF5007D88DDEE6AC23" );
    self.lasthingechange = gettime();
    level.scriptable_doors_opened[self.index] = undefined;
}
...
{
    var_0 thread scriptable_door_hinge_progression( var_3, "_encstr_971904D5B9B2" );

    if ( isdefined( var_0.target ) )
    {
        var_5 = getentitylessscriptablearrayinradius( var_0.target, "_encstr_B8CE0BE43FC317DF690862BA48" );

        foreach ( var_7 in var_5 )
        {
            if ( var_7 getscriptablehaspart( "_encstr_9C6705A90F85C8" ) )
                var_7 thread scriptable_door_hinge_progression( var_3, "_encstr_971904D5B9B2" );
        }
    }
}
...
{
    if ( var_1 == "_encstr_9C6705A90F85C8" )
        var_0 thread scriptable_door_hinge_progression( var_3, "_encstr_8A7D06CD972F91D1" );
}

scriptable_door_postinit()
{
    var_0 = getentitylessscriptablearrayinradius( undefined, undefined, undefined, undefined, "_encstr_9C6705A90F85C8" );
...
system_init()
{
    ...
    scripts\engine\scriptable::_id_12F5B( "_encstr_9C6705A90F85C8", ::scriptable_door_scriptable_used_callback );
...
scriptable_door_disable_autoclose()
{
    ...
    foreach ( var_1 in level.scriptable_doors_opened )
        var_1 notify( "_encstr_BE4115E248106379087BA9BC6FD0BB2348E62AEAD0F6F7" );
...
scriptable_door_close_all_doors()
{
    ...
    {
        var_2 notify( "_encstr_947C1BF721D66B7B134F7A2C458723072AB357AA15139867A1650863F7" );
        var_0++;
