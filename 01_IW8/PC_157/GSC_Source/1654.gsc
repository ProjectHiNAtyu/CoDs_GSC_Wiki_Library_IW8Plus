...
{
    level notify( "_encstr_A8871B380773E7022819FBE3F7771132522E4A9828D4F82B98483E61A5" );
    level endon( "_encstr_A8871B380773E7022819FBE3F7771132522E4A9828D4F82B98483E61A5" );
...
lights_on_internal( var_0, var_1 )
{
    ...
    foreach ( var_6 in var_2 )
    {
        ...
        for ( var_8 = var_8 + level.fxdelay; isdefined( var_4["_encstr_A40101" + var_8] ); var_8 = var_8 + 0.05 )
        {

        }

        var_4["_encstr_A40101" + var_8] = 1;
...
{
    var_3 = strtok( var_0, "_encstr_884C02C6", var_1 );
