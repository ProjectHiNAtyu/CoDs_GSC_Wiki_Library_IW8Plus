...
{
    var_2 = [];
    var_3 = getentarrayinradius( "_encstr_AAB0079B102F47FF38", "_encstr_B9110A36362C3737732CDA59", self.origin, var_1 );
...
quarry2_ambient_sound_load( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "_encstr_A47205E8C28D13", "_encstr_B45B139B0B40B6635793415A39A93FAD48950C1549" ) )
    {
        ...
        if ( var_2 )
        {
            var_3 = _encstr_9E81231898C28383CB8760E558BF27EB18E74BB010797A7D4A032187800594B088064FFB1B::round_enemies_fallback_logic( var_0 );
...
{
    var_3 = [];
    var_4 = getentarrayinradius( "_encstr_AAB0079B102F47FF38", "_encstr_B9110A36362C3737732CDA59", self.origin, var_1 );
    var_5 = undefined;
    var_6 = undefined;
...
{
    var_1 = ( 0, 0, 0 );
    var_2 = getentarrayinradius( "_encstr_AAB0079B102F47FF38", "_encstr_B9110A36362C3737732CDA59", self.origin, var_0 );
...
randomize_stealth_broken_music_array( var_0, var_1, var_2, var_3 )
{
    ...
    if ( getdvarint( "_encstr_A3CC1A03DE2317FE85A182CBC08776F39BB79B8378A903456F586B03", 0 ) )
        return var_2 - var_4;
