...
maintacopsinit()
{
    level.tacopssublevel = "_encstr_BE600747EDD777ADC8";
    level.currentmode = "_encstr_BE600747EDD777ADC8";
...
maintacopspostinit()
{
    ...
    {
        scripts\mp\utility\game::registerroundswitchdvar( "_encstr_BE600747EDD777ADC8", 0, 0, 9 );
        scripts\mp\utility\game::registertimelimitdvar( "_encstr_BE600747EDD777ADC8", 10 );
        scripts\mp\utility\game::registerscorelimitdvar( "_encstr_BE600747EDD777ADC8", 65 );
        scripts\mp\utility\game::registerroundlimitdvar( "_encstr_BE600747EDD777ADC8", 1 );
        scripts\mp\utility\game::registerwinlimitdvar( "_encstr_BE600747EDD777ADC8", 1 );
        scripts\mp\utility\game::registernumlivesdvar( "_encstr_BE600747EDD777ADC8", 0 );
        scripts\mp\utility\game::registerhalftimedvar( "_encstr_BE600747EDD777ADC8", 0 );
        scripts\mp\utility\game::registerdogtagsenableddvar( "_encstr_BE600747EDD777ADC8", 0 );
...
{
    scripts\mp\utility\game::setcommonrulesfrommatchrulesdata();
    setdynamicdvar( "_encstr_B80E1C485FA2262132690C19BF697FA90EFFC860F75839EF0ACF0D91D6E3", 5 );
...
initspawns()
{
    ...
    scripts\mp\spawnlogic::addspawnpoints( "_encstr_BC850785638DA59537", "_encstr_8CF0160F3856B4322779CF095E11EA7FD8D9B7F330481DBB", 1 );
    scripts\mp\spawnlogic::addspawnpoints( "_encstr_BA840579D3F7F6", "_encstr_B42E14F24358F5576F75B52192892B1C40500F332A63", 1 );
    var_0.to_wmd_spawns = [];
    var_0.to_wmd_spawns["_encstr_BC850785638DA59537"] = scripts\mp\spawnlogic::getspawnpointarray( "_encstr_8CF0160F3856B4322779CF095E11EA7FD8D9B7F330481DBB" );
    var_0.to_wmd_spawns["_encstr_BA840579D3F7F6"] = scripts\mp\spawnlogic::getspawnpointarray( "_encstr_B42E14F24358F5576F75B52192892B1C40500F332A63" );

    if ( var_0.to_wmd_spawns["_encstr_BC850785638DA59537"].size <= 0 )
    {
        scripts\mp\spawnlogic::addspawnpoints( "_encstr_BC850785638DA59537", "_encstr_829D16F22B88B3B248E53417B7D83EAF48668A6A307B772A" );
        var_0.to_wmd_spawns["_encstr_BC850785638DA59537"] = scripts\mp\spawnlogic::getspawnpointarray( "_encstr_829D16F22B88B3B248E53417B7D83EAF48668A6A307B772A" );
    }

    if ( var_0.to_wmd_spawns["_encstr_BA840579D3F7F6"].size <= 0 )
    {
        scripts\mp\spawnlogic::addspawnpoints( "_encstr_BA840579D3F7F6", "_encstr_AD3B14F1383781B58DBAC09143624B7B1BEF0FF3893F" );
        var_0.to_wmd_spawns["_encstr_BA840579D3F7F6"] = scripts\mp\spawnlogic::getspawnpointarray( "_encstr_AD3B14F1383781B58DBAC09143624B7B1BEF0FF3893F" );
    }
}
...
activatespawns()
{
    ...
    scripts\mp\tac_ops_map::setactivemapconfig( "_encstr_BE600747EDD777ADC8", "_encstr_BC850785638DA59537" );
    scripts\mp\tac_ops_map::setactivemapconfig( "_encstr_BE600747EDD777ADC8", "_encstr_BA840579D3F7F6" );
