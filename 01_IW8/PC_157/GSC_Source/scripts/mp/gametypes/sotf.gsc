...
initializematchrules()
{
    ...
    setdynamicdvar( "_encstr_B49A15E6B14EFA37B747CCEB36272CD156C2B6ED57CDE8", getmatchrulesdata( "_encstr_9ECB097812FB2565778C4F", "_encstr_9F4D0C605B2669298FFD2025C663" ) );
    setdynamicdvar( "_encstr_AD0F180BC63B0FB2B7C03AA150A56EFBB1BC759E6F6007FB4DD8", getmatchrulesdata( "_encstr_9ECB097812FB2565778C4F", "_encstr_9D0C0F12B0E3038FFDB5664141ED374D21" ) );
    setdynamicdvar( "_encstr_AB2A14B9D84EBE9BDE4799D7B193163A2BE8D26BB2E4", getmatchrulesdata( "_encstr_9ECB097812FB2565778C4F", "_encstr_A9450F6E92676B23FFD38080494CFB81F3" ) );
    setdynamicdvar( "_encstr_B4F214AECE33AF6367D3C809238F7B15FAB52B39242B", 1 );
    scripts\mp\utility\game::registerroundlimitdvar( "_encstr_A918056EBD8E33", 1 );
    setdynamicdvar( "_encstr_87F812D38A73182875DC6D27E7DC0859C78268BB", 1 );
    scripts\mp\utility\game::registerwinlimitdvar( "_encstr_A918056EBD8E33", 1 );
    setdynamicdvar( "_encstr_98C0126E369CBEE6ED1D66BE430B6333E8D2ADAC", 0 );
    scripts\mp\utility\game::registerhalftimedvar( "_encstr_A918056EBD8E33", 0 );
    setdynamicdvar( "_encstr_9D8311DC8D9CFAB9B71D99D7E0E4BDADBD2359", 0 );
}
...
startspawnchest()
{
    level endon( "_encstr_AD1D0BEF9161A06F1F684ADA39" );
    self endon( "_encstr_8A820B4696CDB1ED3737AC1B3A" );
    var_0 = getdvarint( "_encstr_B49A15E6B14EFA37B747CCEB36272CD156C2B6ED57CDE8", 1 );
    var_1 = getdvarint( "_encstr_AB2A14B9D84EBE9BDE4799D7B193163A2BE8D26BB2E4", 30 );
        ...
        else
        {
            while ( isalive( var_2 ) )
            {
                if ( level.emptylocations )
                {
                    ...
                    level thread showcratesplash( "_encstr_95F4149BDB4733F5C639C23ACAF5B4CDB1ED5BD2DC3B" );
                    wait( var_1 );
                    continue;
                }
...
sotfcratethink( var_0 )
{
    ...
    var_3 = 0;
    var_4 = getdvarint( "_encstr_AD0F180BC63B0FB2B7C03AA150A56EFBB1BC759E6F6007FB4DD8", 6 );
    ...
    for (;;)
    {
        ...
        if ( self.cratetype == "_encstr_BDB30C63D56420B86BB7EBD187A2" && var_3 == getdvarint( "_encstr_AD0F180BC63B0FB2B7C03AA150A56EFBB1BC759E6F6007FB4DD8", 6 ) )
...
getrandomattachments( var_0 )
{
    ...
    if ( var_5.size > 0 )
    {
        ...
        if ( var_10 == "_encstr_A9710B24C527AB77354198A8EB" || var_10 == "_encstr_AABE0E47EF4F93A830EFCFC309E7BF9E" || var_4 == "_encstr_807C0BB4549F018AD080CB8788" )
        {
            var_11 = 0;
            ...
            if ( !var_11 && var_0["_encstr_81BA051A9AA88B"] != "_encstr_8B540A5ADD73AFAD98D7D60E" )
            {
