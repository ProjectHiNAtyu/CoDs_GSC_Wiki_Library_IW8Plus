...
setup_callbacks()
{
    level.bot_funcs["_encstr_9B610FCEC26B2B3AF20756BE3A435ADC5B"] = ::bot_wmd_think;
}
...
bot_wmd_think()
{
    self notify( "_encstr_8B530E368243B96C20C7970992142DA7" );
    self endon( "_encstr_8B530E368243B96C20C7970992142DA7" );
