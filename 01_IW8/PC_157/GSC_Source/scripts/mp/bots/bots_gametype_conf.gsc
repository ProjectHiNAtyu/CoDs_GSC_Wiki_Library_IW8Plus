...
bot_conf_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self bothasscriptgoal() )
        {
            ...
            else if ( scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "_encstr_94D509B52D36B1EB3A2C9D" ) && self.tag_getting custom_death_func( self.team ) )
            {
        ...
        if ( isdefined( self.tag_getting ) )
        {
            ...
            if ( !self.conf_camping_tag )
            {
                if ( !scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "_encstr_94D509B52D36B1EB3A2C9D" ) )
                {
                    ...
                    var_5._id_132B7 = 1;
                    scripts\mp\bots\bots_strategy::bot_new_tactical_goal( "_encstr_94D509B52D36B1EB3A2C9D", self.tag_getting.ground_pos, 25, var_5 );
                }
            }
        }
...
{
    if ( level.gametype == "_encstr_9B290667C6D043EF" )
        wait 1.5;
