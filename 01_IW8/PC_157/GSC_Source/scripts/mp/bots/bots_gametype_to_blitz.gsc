...
bot_blitz_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self bothasscriptgoal() )
        {
            ...
            else if ( scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "_encstr_94D509B52D36B1EB3A2C9D" ) && self.tag_getting scripts\mp\gameobjects::caninteractwith( self.team ) )
            {
        ...
        self botsetflag( "_encstr_A81A0D524893C755414348EDB90B01", var_1 );
        ...
        if ( isdefined( self.tag_getting ) )
        {
            ...
            if ( self.personality == "_encstr_BD9207539F80EB7FC5" && self.conf_camper_camp_tags )
            {
                ...
                if ( scripts\mp\bots\bots_personality::should_select_new_ambush_point() )
                {
                    if ( scripts\mp\bots\bots_personality::find_ambush_node( self.tag_getting.curorigin, 1000 ) )
                        childthread bot_camp_tag( self.tag_getting, "_encstr_8B900559228717" );
                    else
                        self.conf_camping_tag = 0;
                }
            }
            ...
            {
                if ( !scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "_encstr_94D509B52D36B1EB3A2C9D" ) )
                {
                    var_5 = spawnstruct();
                    var_5.script_goal_type = "_encstr_BC2B0A075628F786B1182B12";
                    var_5.objective_radius = level.bot_tag_obj_radius;
                    scripts\mp\bots\bots_strategy::bot_new_tactical_goal( "_encstr_94D509B52D36B1EB3A2C9D", self.tag_getting.curorigin, 25, var_5 );
                }
            }
        }
...
bot_watch_new_tags()
{
    for (;;)
    {
        level waittill( "_encstr_8F1E10E5E23FE6AB42A16F9F70C14F76974A", var_0 );
...
{
    _encstr_BEDD27B91B27B4E03A3779DA0E97C4B78EE69726EDD1E6D7D9B06BCA1DBCE095BEC6B7E699E2D9B98D::calculate_tag_on_path_grid( var_0 );
}
...
{
    self notify( "_encstr_98580D0AC0154FEE309B380FB168B7" );
    self endon( "_encstr_98580D0AC0154FEE309B380FB168B7" );
    self endon( "_encstr_AD93113A597A9348207E61F373807AF7F536AA" );
