...
setup_callbacks()
{
    level.bot_funcs["_encstr_9B610FCEC26B2B3AF20756BE3A435ADC5B"] = ::bot_bhd_think;
}
...
bot_bhd_think()
{
    self notify( "_encstr_B78D0E12D80D47A643810F2CB120ED2F" );
    self endon( "_encstr_B78D0E12D80D47A643810F2CB120ED2F" );
