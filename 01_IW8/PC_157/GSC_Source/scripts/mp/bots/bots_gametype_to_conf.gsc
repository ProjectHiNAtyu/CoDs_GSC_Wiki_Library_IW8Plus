...
setup_callbacks()
{
    level.bot_funcs["_encstr_9B610FCEC26B2B3AF20756BE3A435ADC5B"] = ::bot_conf_think;
}
...
bot_conf_think()
{
    self notify( "_encstr_9D900F328FF081D7E8A80A81F3B33705F0" );
    self endon( "_encstr_9D900F328FF081D7E8A80A81F3B33705F0" );
