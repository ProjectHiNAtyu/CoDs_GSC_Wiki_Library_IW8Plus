...
setup_callbacks()
{
    level.bot_funcs["_encstr_9B610FCEC26B2B3AF20756BE3A435ADC5B"] = ::bot_infect_think;
    level.bot_funcs["_encstr_935216AE70A7B3F93FD9B0707294B36B0FF73D2FC07F180F"] = ::bot_should_pickup_weapons_infect;
}
...
{
    if ( level.infect_chosefirstinfected && self.team == "_encstr_BA840579D3F7F6" )
        return 0;
...
bot_infect_think()
{
    self notify( "_encstr_A91D114CBD8EAFA5E699598DA3AF1D1AB4DCDA" );
    self endon( "_encstr_A91D114CBD8EAFA5E699598DA3AF1D1AB4DCDA" );
    ...
    for (;;)
    {
        ...
        {
            if ( self.team == "_encstr_BA840579D3F7F6" && self botgetpersonality() != "_encstr_B7560CF6FB10B981D8E909E7ABC0" )
...
{
    level notify( "_encstr_AB671E525A70E108CDD62878E846C37899EACCB6AF2F6B2888F0330B9237AB21" );
    level endon( "_encstr_AB671E525A70E108CDD62878E846C37899EACCB6AF2F6B2888F0330B9237AB21" );
    level endon( "_encstr_AD1D0BEF9161A06F1F684ADA39" );
    ...
    for (;;)
    {
        ...
        {
            if ( !isdefined( var_3.initial_spawn_time ) && var_3.health > 0 && isdefined( var_3.team ) && ( var_3.team == "_encstr_BC850785638DA59537" || var_3.team == "_encstr_BA840579D3F7F6" ) )
                            ...
                            if ( var_3.time_spent_hiding >= 20000 )
                            {
                                ...
                                foreach ( var_13 in var_11 )
                                {
                                    if ( isbot( var_13 ) )
                                    {
                                        ...
                                        if ( var_14 != "_encstr_94C2099887BA24607BE134" && var_14 != "_encstr_94CC09C69C5AE82D368536" )
                                        {
...
bot_infect_retrieve_knife()
{
    if ( self.team == "_encstr_BA840579D3F7F6" )
    {
        ...
        for (;;)
        {
            if ( self hasweapon( "_encstr_89F511713BBB2818C13559D05DB9E85501B7F1" ) )
            {
                if ( scripts\mp\utility\entity::isgameparticipant( self.enemy ) )
                {
                    ...
                    {
                        var_2 = squared( self botgetdifficultysetting( "_encstr_9B970A17A0642579557FC35B" ) );
                            ...
                            if ( self.melee_self_new_node_time + 3000 < var_1 )
                            {
                                if ( self.melee_enemy_new_node_time + 3000 < var_1 )
                                {
                                    if ( bot_infect_angle_too_steep_for_knife_throw( self.origin, self.enemy.origin ) )
                                        scripts\mp\bots\bots_util::bot_queued_process( "_encstr_B7C716226870DB992087040DCF60DE2B30C3EA9A365DBB0B", ::bot_infect_find_node_can_see_ent, self.enemy, self.melee_self_node );

                                    if ( !self getammocount( "_encstr_89F511713BBB2818C13559D05DB9E85501B7F1" ) )
                                        self setweaponammoclip( "_encstr_89F511713BBB2818C13559D05DB9E85501B7F1", 1 );

                                    scripts\engine\utility::_id_143BF( 30, "_encstr_80BF06CA78A2226B" );
                                    self botclearscriptgoal();
                                }
                            }
                        }
...
bot_infect_find_node_can_see_ent( var_0, var_1 )
{
    ...
    if ( issubstr( var_1.type, "_encstr_815E06C5D732F338" ) )
        var_2 = 1;
    ...
    if ( isdefined( var_3 ) && var_3.size )
    {
        ...
        {
            if ( var_2 && issubstr( var_6.type, "_encstr_B418048A7391" ) )
                continue;
            ...
            if ( sighttracepassed( var_8, var_9, 0, self, var_0 ) )
            {
                ...
                self botsetscriptgoalnode( var_6, "_encstr_94CC09C69C5AE82D368536", var_10 );
