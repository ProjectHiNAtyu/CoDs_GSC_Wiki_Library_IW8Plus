...
setup_callbacks()
{
    level.bot_funcs["_encstr_9B610FCEC26B2B3AF20756BE3A435ADC5B"] = ::bot_air_think;
}
...
bot_air_think()
{
    self notify( "_encstr_BA2C0EEAE043B950997B8105A9706AB7" );
    self endon( "_encstr_BA2C0EEAE043B950997B8105A9706AB7" );
