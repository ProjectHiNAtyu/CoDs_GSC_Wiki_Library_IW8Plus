...
setup_callbacks()
{
    level.bot_funcs["_encstr_9B610FCEC26B2B3AF20756BE3A435ADC5B"] = ::bot_sam_think;
}
...
bot_sam_think()
{
    self notify( "_encstr_B6C50E2AE0356FCA10FB7744E908D5F7" );
    self endon( "_encstr_B6C50E2AE0356FCA10FB7744E908D5F7" );
