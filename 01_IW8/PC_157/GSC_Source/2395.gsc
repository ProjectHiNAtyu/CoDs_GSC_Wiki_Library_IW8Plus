...
{
    var_0 = "_encstr_A61805573F9318" + level.gametype + "_encstr_984C028E" + var_0;
...
{
    var_2 = "_encstr_A61805573F9318" + level.gametype + "_encstr_984C028E" + var_0;
    ...
    level.watchdvars[var_2].type = "_encstr_9F1904A86253";
    level.watchdvars[var_2].notifystring = "_encstr_878A08EA388CB08E59BE" + var_0;
}
...
registerwatchdvarfloat( var_0, var_1 )
{
    ...
    level.watchdvars[var_2].type = "_encstr_89A906CBCA77522B";
    level.watchdvars[var_2].notifystring = "_encstr_878A08EA388CB08E59BE" + var_0;
}
...
registerwatchdvar( var_0, var_1 )
{
    ...
    if ( getdvar( var_2, "_encstr_A40101" ) == "_encstr_A40101" )
        setdvar( var_2, var_1 );

    level.watchdvars[var_2] = spawnstruct();
    level.watchdvars[var_2].value = getdvar( var_2, var_1 );
    level.watchdvars[var_2].type = "_encstr_A9D807B2E3F80182EC";
    level.watchdvars[var_2].notifystring = "_encstr_878A08EA388CB08E59BE" + var_0;
}
...
{
    return "_encstr_A61805573F9318" + level.gametype + "_encstr_984C028E" + var_0;
}
...
updatewatcheddvarsexecute()
{
    ...
    {
        if ( level.watchdvars[var_2].type == "_encstr_A9D807B2E3F80182EC" )
            var_3 = getproperty( var_2, level.watchdvars[var_2].value );
        else if ( level.watchdvars[var_2].type == "_encstr_89A906CBCA77522B" )
