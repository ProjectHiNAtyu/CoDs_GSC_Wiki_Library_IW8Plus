...
initarbitraryuptriggers()
{
    ...
    if ( scripts\cp_mp\utility\game_utility::getmapname() == "_encstr_B2470801C8C7F02B5D7A" )
    {
        var_0 = getentarray( "_encstr_89C707ADB09DAFAE38", "_encstr_B8CE0BE43FC317DF690862BA48" );
        ...
        foreach ( var_2 in var_0 )
        {
            ...
            {
                var_4.base = getent( var_2.target, "_encstr_B8CE0BE43FC317DF690862BA48" );
