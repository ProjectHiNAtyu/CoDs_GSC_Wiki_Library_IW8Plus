...
{
    if ( !isdefined( var_2 ) )
        var_2 = "_encstr_BAC3084A011F7BEF2029";
    ...
    if ( var_2 == "_encstr_8F070350FB" )
        var_6 = ceil( var_5 );
    else if ( var_2 == "_encstr_8867058D65CB65" )
        var_6 = floor( var_5 );
    else
        var_6 = var_5 + 0.5;
...
stringtofloat( var_0 )
{
    var_1 = strtok( var_0, "_encstr_B74C028B" );
    var_2 = int( var_1[0] );
...
bufferednotify_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_9 = "_encstr_A9AE1041C3852A99C35DB579B8C54BDF3029" + var_0;
    self notify( var_9 );
    self endon( var_9 );
...
heap( var_0 )
{
    ...
    if ( var_0 == "_encstr_BD1904759FC1" )
        var_1.swap = ::_heaplessthan;
    else if ( var_0 == "_encstr_8F1904BF40C0" )
