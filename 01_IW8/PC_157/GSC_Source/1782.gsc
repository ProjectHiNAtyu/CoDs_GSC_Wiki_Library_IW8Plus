...
anim_scene_stop( var_0 )
{
    if ( isdefined( var_0 ) && var_0 )
        self notify( "_encstr_ADD9156F98C09D011F4E5F95A59F4A570B48F70FA858CC" );
    else
        self notify( "_encstr_B4540BC30B9AB031B322C7DAA7" );
}
...
{
    self endon( "_encstr_A42B17D9E8E8DDD7CF1B27DDBD50E32064C790F0037023AF4D" );
    ...
    if ( var_2 )
        self waittill( "_encstr_A11E0635A8337378" );
    else
        wait( var_12 );

    waittillframeend;
    self notify( "_encstr_9FD51357A0F8B5290756B76D4DB723554120DF97F0" );
...
_anim_scene_internal_blend_in( var_0, var_1, var_2, var_3, var_4 )
{
    foreach ( var_6 in var_0 )
    {
        if ( var_6.is_player )
        {
            if ( istrue( var_4 ) )
            {
                var_7 = "_encstr_9BC813A0B775E3D91265C55631FA13ABDDD7D0309A";
                var_6.player_rig = spawn( "_encstr_93DC0DCD1B272D3847AF5BED23B2C6", var_6.entity.origin );
            ...
            {
                var_6.player_rig = spawn( "_encstr_BEFE0C06A30BE829D321D0703A2A", var_6.entity.origin, 0, 0, var_6.entity );
                var_6.player_rig.animname = var_6.animname;
                var_6.player_rig useanimtree( #animtree );
                var_6.player_rig hide();
            ...
            var_6.entity playerlinktoblend( var_6.player_rig, "_encstr_BA010BA012DFB703A379A39542", var_3 );
...
_anim_scene_internal_finish_blend( var_0, var_1, var_2 )
{
    ...
    if ( var_3 > 0.0 )
    {
        ...
        foreach ( var_5 in var_0 )
        {
            ...
            if ( var_5.is_player )
                var_5.entity playerlinktodelta( var_5.player_rig, "_encstr_BA010BA012DFB703A379A39542", 1, 0, 0, 0, 0, 0, 1, 1 );
        }
...
_anim_scene_internal_start_anims( var_0, var_1, var_2, var_3 )
{
    foreach ( var_5 in var_0 )
    {
        ...
        {
            if ( var_2 )
                var_5.entity playanimscriptsceneevent( "_encstr_BD850F6F3758D7F0B377D3691BD1C79D8F", level.scr_eventanim[var_5.animname][var_1][0] );
            else
                var_5.entity playanimscriptsceneevent( "_encstr_BD850F6F3758D7F0B377D3691BD1C79D8F", level.scr_eventanim[var_5.animname][var_1] );
            ...
            if ( var_2 )
                thread scripts\common\anim::anim_loop_solo( var_5.player_rig, var_1, "_encstr_B4540BC30B9AB031B322C7DAA7", var_3 );
            else
        ...
        if ( var_2 )
        {
            thread scripts\common\anim::anim_loop_solo( var_5.entity, var_1, "_encstr_B4540BC30B9AB031B322C7DAA7", var_3 );
            continue;
        }
...
{
    self endon( "_encstr_9FD51357A0F8B5290756B76D4DB723554120DF97F0" );
    self endon( "_encstr_A42B17D9E8E8DDD7CF1B27DDBD50E32064C790F0037023AF4D" );
    self waittill( "_encstr_B4540BC30B9AB031B322C7DAA7" );
...
_anim_scene_force_end_think( var_0 )
{
    self endon( "_encstr_9FD51357A0F8B5290756B76D4DB723554120DF97F0" );
    self endon( "_encstr_A42B17D9E8E8DDD7CF1B27DDBD50E32064C790F0037023AF4D" );
    self waittill( "_encstr_ADD9156F98C09D011F4E5F95A59F4A570B48F70FA858CC" );
...
_anim_scene_interrupt_think( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in var_0 )
        {
            ...
            if ( var_5.is_player )
            {
                if ( ( var_2 || var_5.forceendscene ) && !var_9 )
                {
                    ...
                    {
                        if ( !var_5.entity scripts\common\input_allow::is_input_allowed_internal( "_encstr_B92007DDCA2C0EF6DC" ) )
        ...
        if ( var_7 )
        {
            self notify( "_encstr_A42B17D9E8E8DDD7CF1B27DDBD50E32064C790F0037023AF4D" );
            return;
        }
    }
}
