...
build_deathanimations( var_0, var_1, var_2, var_3 )
{
    ...
    level.vehicle.templates.deathanimations[var_4]["_encstr_A42E08DEC88B5BE9CD38"] = var_0;
    level.vehicle.templates.deathanimations[var_4]["_encstr_9353062E718710C9"] = var_1;
    level.vehicle.templates.deathanimations[var_4]["_encstr_8A5B09E9F7F372C3137E64"] = var_2;
    level.vehicle.templates.deathanimations[var_4]["_encstr_B1AD05C65666E8"] = var_3;
}
...
build_light( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    scripts\common\vehicle_lights::group_light( var_0, var_1, "_encstr_A61904730372" );
...
build_template( var_0, var_1, var_2, var_3 )
{
    ...
    level.vehicle.templates.team[var_3] = "_encstr_BA840579D3F7F6";
...
{
    if ( !isdefined( var_1 ) )
        var_1 = "_encstr_B33A0E439879C7CA7D14F42D0D77B298";
...
build_treadfx( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        {
            set_vehicle_effect( var_0, var_1, var_2, "_encstr_B6D806BE31C2CD5B" );
            set_vehicle_effect( var_0, var_1, var_2, "_encstr_8A2309FFA996389201D508" );
        }
    }
    else
    {
...
get_surface_types()
{
    return [ "_encstr_9B1E06B1CD9388DF", "_encstr_AA9B054C58E4D6", "_encstr_8851071A1F76E805E3", "_encstr_9D95063389284BFB", "_encstr_9EC709F8127D2FA3678C4D", "_encstr_B467052947C3DD", "_encstr_AAA9061912477688", "_encstr_B8D108F6388D2FDE4F50", "_encstr_8FD6069268572732", "_encstr_A6290697934AE6F8", "_encstr_9E7607202BC87D2DA4", "_encstr_9F1904A8B217", "_encstr_ADC806FD3D030F9D", "_encstr_95190480CB41", "_encstr_87A706336630687E", "_encstr_B9C808C163166EA3AC39", "_encstr_891F05C9B736B5", "_encstr_971805CDB03719", "_encstr_88180573C81027", "_encstr_B64C06A89764A1ED", "_encstr_97F605EEB7ED46", "_encstr_AF5B082F4F9F22C1F81B", "_encstr_9D8008D8959C0BB6B4D8", "_encstr_BAC808300911F72BE330", "_encstr_A60F07830B9623F720", "_encstr_AAA308105BD2C138A74E", "_encstr_955506CC9CAB4BD1", "_encstr_BDDD0D6251301633DDA1D7CFB9F7FA", "_encstr_B1450B73F050B4F3197B8FC5D5", "_encstr_8A6C066EC6EAE61A", "_encstr_AA1608C07786F13312D3" ];
}
...
build_aianims( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( level.func ) && isdefined( level.func["_encstr_9DC21337F75BCFCB2B10485B9960895312F0103FAF" + var_2] ) )
        level.vehicle.templates.aianims[var_3] = [[ level.func["_encstr_9DC21337F75BCFCB2B10485B9960895312F0103FAF" + var_2] ]]( level.vehicle.templates.aianims[var_3] );
...
{
    level.vehicle.templates.atmotypes[level.vtclassname]["_encstr_AB84052C8ED6ED"] = var_0;
    level.vehicle.templates.atmotypes[level.vtclassname]["_encstr_A68A065803A1D173"] = var_1;
}
