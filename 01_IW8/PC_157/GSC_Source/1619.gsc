...
bb_shoulddroprocketlauncher( var_0, var_1, var_2, var_3 )
{
    ...
    return var_4 != "_encstr_98080F93DBB1B556D11B85ABB936D059E4";
}
...
{
    self._blackboard.weaponrequest = "_encstr_AABA05236DC831";
}

bb_getrequestedweapon()
{
    if ( isdefined( self._blackboard.weaponrequest ) && self._blackboard.weaponrequest == "_encstr_AABA05236DC831" )
        return undefined;
...
bb_newshootparams( var_0, var_1, var_2 )
{
    ...
    self._blackboard.shootparams_objective = "_encstr_930E073E8FC00DDF69";
...
bb_isanimscripted()
{
    ...
    {
        if ( self.script == "_encstr_81DB0937D8394BC147AC46" || self.script == "_encstr_82F30982C35BA79DD75F21" )
            return 1;
    }
...
bb_isfrantic()
{
    ...
    var_1 = isdefined( var_0 ) && ( var_0.type == "_encstr_BC520F6EBF6BB9138622EAE9DBDDFB718B" || var_0.type == "_encstr_89D80ECFFD42C7B17FB032211B011621" );
    return self._blackboard.movetype == "_encstr_B451081513CAE8408136" && !var_1;
}
...
bb_getmissingleg()
{
    ...
    if ( isdefined( self._blackboard.dismemberedparts["_encstr_9D5F09365933477DB1ACD9"] ) )
    {
        var_0++;
        var_1 = "_encstr_B1AD05C65666E8";
    }

    if ( isdefined( self._blackboard.dismemberedparts["_encstr_A1F40A62D0C090B340317747"] ) )
    {
        var_0++;
...
ispartdismembered( var_0 )
{
    ...
    if ( isdefined( self._blackboard.scriptableparts ) )
    {
        ...
        return self._blackboard.scriptableparts[var_0].state == "_encstr_B4560A21DA5BADE07032C71B";
    }
...
bb_setcanrodeo( var_0, var_1 )
{
    ...
    var_2 = "_encstr_B1AD05C65666E8";

    if ( var_0 == var_2 )
        var_2 = "_encstr_9353062E718710C9";
