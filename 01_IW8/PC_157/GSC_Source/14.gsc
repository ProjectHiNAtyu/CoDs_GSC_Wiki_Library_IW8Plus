...
{
    var_3 = "_encstr_987F080E394BDAC2E45E";

    if ( isdefined( level.callbackspawnpointcritscore ) )
        var_3 = var_0 [[ level.callbackspawnpointcritscore ]]( var_1, var_2 );

    if ( var_3 == "_encstr_987F080E394BDAC2E45E" )
        return 100.0;
    else if ( var_3 == "_encstr_B98F0AC7D5B99F4DDBA8353B" )
        return 50.0;
...
abortlevel()
{
    ...
    setdvar( "_encstr_950D0B09572CDCE74935F6F2DA", "_encstr_8807031CC1" );
    exitlevel( 0 );
}
