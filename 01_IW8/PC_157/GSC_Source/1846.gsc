...
initgameflags()
{
    if ( !isdefined( game["_encstr_B8A90699C68576B9"] ) )
        game["_encstr_B8A90699C68576B9"] = [];
}

gameflaginit( var_0, var_1 )
{
    game["_encstr_B8A90699C68576B9"][var_0] = var_1;
}

playerzombiethermalcleanup( var_0 )
{
    return isdefined( game["_encstr_B8A90699C68576B9"][var_0] );
}

gameflag( var_0 )
{
    return game["_encstr_B8A90699C68576B9"][var_0];
}

gameflagset( var_0 )
{
    game["_encstr_B8A90699C68576B9"][var_0] = 1;
    level notify( var_0 );
}

gameflagclear( var_0 )
{
    game["_encstr_B8A90699C68576B9"][var_0] = 0;
}
