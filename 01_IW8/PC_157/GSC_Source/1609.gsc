...
{
    self endon( "_encstr_974B0FB728886D5AAF2444BD9BDFC235D1" );
    self waittill( "_encstr_B8F1152CE51BE71495487B62D1E34C7773DB92B50F2157" );
...
initmeleeaction( var_0 )
{
    ...
    if ( var_1 != "_encstr_9F1D0909124FCF686D15A1" )
        self reacquireclear();
}
...
domeleeaction( var_0 )
{
    ...
    if ( scripts\asm\asm::asm_ephemeraleventfired( "_encstr_87060DADFA1B158849F97961E1AE30", "_encstr_B41804CA7391" ) )
        return anim.success;

    if ( scripts\asm\asm::asm_ephemeraleventfired( "_encstr_87060DADFA1B158849F97961E1AE30", "_encstr_815E0685D732F338", 0 ) )
    {
...
meleecharge_shouldabort()
{
    ...
    if ( scripts\asm\asm::asm_ephemeraleventfired( "_encstr_8BAA136BF7E098F93167544143C7BFB737CB0B089D", "_encstr_B41804CA7391" ) )
        return 1;
...
meleecharge_update( var_0 )
{
    ...
    if ( var_5 <= var_9 )
    {
        ...
        if ( isdefined( self.stairsstate ) && self.stairsstate != "_encstr_AABA05236DC831" && isplayer( var_4 ) )
            var_11 = 32;
...
gettargetchargepos( var_0 )
{
    ...
    var_5 = var_4["_encstr_B130095358E1B3930B687D"];
...
{
    if ( isdefined( self.ent_flag ) && isdefined( self.ent_flag["_encstr_94C8119F278B67BF1938432E258A99B869AFC0"] ) && self.ent_flag["_encstr_94C8119F278B67BF1938432E258A99B869AFC0"] )
    {
        if ( isdefined( self.ent_flag["_encstr_9E3010DFC6F3EF2EA9C8E2A958A123B749A2"] ) && !self.ent_flag["_encstr_9E3010DFC6F3EF2EA9C8E2A958A123B749A2"] )
            return 0;
    }
...
ismeleevalid( var_0, var_1 )
{
    ...
    if ( var_1 )
    {
        if ( isdefined( self.a.onback ) || self.currentpose == "_encstr_9F24062875D5FD98" )
            return 0;
    ...
    if ( var_6 )
    {
        ...
        if ( self.stairsstate != "_encstr_AABA05236DC831" || var_0.stairsstate != "_encstr_AABA05236DC831" )
            return 0;

        if ( var_0.unittype != "_encstr_9E8C08F63FE3D98B0743" && var_0.unittype != "_encstr_82E8096C4B3BD28D5A0BCD" && var_0.unittype != "_encstr_AAFC0BA9AB3B9DCAC9DC2C571D" )
            return 0;
    }
    ...
    if ( !isdefined( self.meleeignoreplayerstance ) || !self.meleeignoreplayerstance || !isplayer( var_0 ) )
    {
        ...
        if ( var_7 != "_encstr_B1AD06374716DC8C" && var_7 != "_encstr_9C3D071B63023B26C3" )
            return 0;
    }
