...
throwgrenade_update( var_0 )
{
    ...
    if ( scripts\asm\asm::asm_ephemeraleventfired( "_encstr_B1AA0D478627DEEED99C59E60B1995", "_encstr_94AD0637D1C24ED1", 0 ) )
    {
        self.bt.instancedata[var_0].started = 1;
        self.bt.instancedata[var_0].timeout = self.bt.instancedata[var_0].timeout + 10000;
    }

    if ( scripts\asm\asm::asm_ephemeraleventfired( "_encstr_B1AA0D478627DEEED99C59E60B1995", "_encstr_B41804CA7391" ) )
        return anim.success;
...
canthrowgrenade( var_0 )
{
    ...
    if ( _encstr_B43220B9D8279638D19B97C2374BD6E557479663D28E5ED71BDEADB5BD9BB8ECE6D8::usingmg() )
        return anim.failure;
...
grenadethrowvaliditycheck( var_0, var_1 )
{
    ...
    if ( self.weapon.basename == "_encstr_8BA205D69DD091" || self.grenadeammo <= 0 )
        return 0;
    ...
    if ( isdefined( self.enemy ) && var_0 == self.enemy )
    {
        ...
        if ( _encstr_B43220B9D8279638D19B97C2374BD6E557479663D28E5ED71BDEADB5BD9BB8ECE6D8::canseeenemyfromexposed() )
            return 1;

        if ( _encstr_B43220B9D8279638D19B97C2374BD6E557479663D28E5ED71BDEADB5BD9BB8ECE6D8::cansuppressenemyfromexposed() )
            return 1;
    }
