...
init()
{
    precacheshader( "_encstr_8C0611F613A9C1DE4BDCA3BE32ACCC85BAC63A" );
    level.objpointnames = [];
    level.objpoints = [];
...
{
    if ( !isdefined( var_3 ) )
        var_3 = "_encstr_8C0611F613A9C1DE4BDCA3BE32ACCC85BAC63A";
...
startflashing()
{
    self endon( "_encstr_B13515076820A02115E9BE32C3D3EA7FCE90E39B4859EC" );
