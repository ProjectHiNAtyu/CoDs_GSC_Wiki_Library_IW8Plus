...
track( var_0 )
{
    ...
    var_1 = scripts\asm\asm::asm_getxanim( "_encstr_9493069063F88B9F", scripts\asm\asm::asm_lookupanimfromalias( "_encstr_9493069063F88B9F", "_encstr_93E506335722586A" ) );
    var_2 = scripts\asm\asm::asm_getxanim( "_encstr_9493069063F88B9F", scripts\asm\asm::asm_lookupanimfromalias( "_encstr_9493069063F88B9F", "_encstr_A1E50668F23DD7EB" ) );
    var_3 = scripts\asm\asm::asm_getxanim( "_encstr_9493069063F88B9F", scripts\asm\asm::asm_lookupanimfromalias( "_encstr_9493069063F88B9F", "_encstr_BDE506D784B959C5" ) );
    var_4 = scripts\asm\asm::asm_getxanim( "_encstr_9493069063F88B9F", scripts\asm\asm::asm_lookupanimfromalias( "_encstr_9493069063F88B9F", "_encstr_87E506C2B4D6F507" ) );
...
sniperdeathcleanup()
{
    self endon( "_encstr_B10B0C68B32D1916CF66BB2F45E3" );
...
sniperlaserhackstop()
{
    if ( isdefined( self.sniper_laser ) )
    {
        self notify( "_encstr_B10B0C68B32D1916CF66BB2F45E3" );
        self.sniper_laser [[ self.fnlaseroff ]]();
        self.sniper_laser delete();
        self.sniper_laser = undefined;
        self.bhaslasertag = undefined;
        self [[ self.fnsetlaserflag ]]( "_encstr_AABA05236DC831" );
    }
}
...
shoulduselasertag()
{
    ...
    switch ( var_0 )
    {
        case "_encstr_874107B2984FC9AF12":
            return 1;
        default:
            break;
    }
...
getlaserstartpoint()
{
    if ( !isdefined( self.bhaslasertag ) )
    {
        ...
        {
            var_0 = self gettagorigin( "_encstr_BC1E0A117F8A506069D2B953", 1 );
    ...
    if ( self.bhaslasertag )
        return self gettagorigin( "_encstr_BC1E0A117F8A506069D2B953" );
...
sniperlaserhackstart()
{
    ...
    self.sniper_laser = spawn( "_encstr_93DC0DCD1B272D3847AF5BED23B2C6", var_0 );
    self.sniper_laser setmodel( "_encstr_BC1E0A117F8A506069D2B953" );
    self.sniper_laser setmoverlaserweapon( self.weapon );
    self.sniper_laser setotherent( self );
    self.sniper_laser.origin = var_0;
    self [[ self.fnsetlaserflag ]]( "_encstr_AD650C2DCDE82B9CC17B36853AB2" );
...
resetconvergence( var_0, var_1, var_2 )
{
    ...
    var_4 = level.difficultysettings["_encstr_8CA216E640E81BA1BA5757783D0C35EEF725674A97B99827"][var_3];
...
calcconvergencetarget()
{
    if ( isdefined( self.convergence.converge_locked_on_time ) && gettime() - self.convergence.converge_locked_on_time >= 100 )
    {
        ...
        if ( isdefined( self._blackboard.shootparams_ent ) && isplayer( self._blackboard.shootparams_ent ) )
            self [[ self.fnsetlaserflag ]]( "_encstr_B9AD05B1F66C6D" );
        else
            self [[ self.fnsetlaserflag ]]( "_encstr_AD650C2DCDE82B9CC17B36853AB2" );
...
onsniperfired()
{
    self notify( "_encstr_97BF14C398806BFF4561E3DA8899B5DBBE74515AA589" );
...
shouldcqbaim()
{
    ...
    {
        if ( self.demeanoroverride == "_encstr_B6BB065A6143CD41" )
            return 1;

        if ( self.demeanoroverride == "_encstr_B408071CB04739BDC6" && isdefined( self.asm.flashlight ) && self.asm.flashlight && isdefined( self.cqb_target ) )
            return 1;
    }
...
canaimwhilemoving()
{
    ...
    if ( self.stairsstate != "_encstr_AABA05236DC831" )
        return 1;

    var_1 = scripts\asm\shared\utility::getbasearchetype();

    if ( getanimspeedthreshold( var_1, "_encstr_8B7905BF097F8C" ) && getanimspeedthreshold( var_1, "_encstr_A419043882EF" ) && var_0 < getcoveranglelimits( var_1, "_encstr_8B7905BF097F8C", "_encstr_A419043882EF", 0.4 ) )
        return 1;

    if ( var_1 == "_encstr_AAFC0BA9AB3B9DCAC9DC2C571D" || var_1 == "_encstr_97CD0E35BA76B3B293B9B0BA8E7DD807" || var_1 == "_encstr_81CD0EA9D5D9D92B9CB985EA3AEB1BBB" )
        return var_0 < 60;
...
trackloop( var_0 )
{
    ...
    {
        incranimaimweight();
        var_6 = scripts\asm\asm::asm_currentstatehasflag( self.asm.trackasm, "_encstr_8F19048F40A0" );
        ...
        if ( !var_6 && scripts\asm\asm::asm_currentstatehasflag( self.asm.trackasm, "_encstr_A43B0DDCDE3A9547C9858DB605B4D6" ) )
            var_6 = scripts\asm\asm::asm_eventfired( self.asm.trackasm, "_encstr_93AB0AEB25F8CB7341017809" );
        ...
        if ( var_6 )
        {
            ...
            if ( isdefined( var_25 ) && scripts\asm\asm_bb::bb_getrequestedcoverstate() == "_encstr_BA25082B3C0EDB37AC46" )
            {
            ...
            {
                var_27 = scripts\asm\shared\utility::getbasearchetype();
                var_24 = anim.nodeexposedpitches[var_27]["_encstr_9E9609F9031832BF77187A"];
            }
            else if ( self.asm.archetype == "_encstr_A19B05C4B79B6E" || self.asm.archetype == "_encstr_88B20689DB9BDC46" )
            {
                var_23 = -12;
                var_28 = 10;
            }
        ...
        if ( self asmcurrentstatehasaimset( self.asm.trackasm ) )
        {
            if ( isdefined( var_8 ) && isdefined( var_8.shootpos ) )
            {
                if ( istrue( self.doingpoi ) )
                {
                    ...
                    {
                        self.a.laseron = 1;
                        _encstr_81251843179D48BB7D835E93503BADB74B88F74DF1ED2810F3EA::updatelaserstatus();
                    }
                }
            }
        ...
        var_41 = self.movemode != "_encstr_A419051B33CF57" || !var_2;
...
aimedataimtarget()
{
    ...
    {
        var_1 = !scripts\asm\asm::asm_currentstatehasflag( self.asm.trackasm, "_encstr_8F19048F40A0" );

        if ( !var_1 && scripts\asm\asm::asm_currentstatehasflag( self.asm.trackasm, "_encstr_A43B0DDCDE3A9547C9858DB605B4D6" ) )
            var_1 = !scripts\asm\asm::asm_eventfired( self.asm.trackasm, "_encstr_93AB0AEB25F8CB7341017809" );
