...
printboldonteam( var_0, var_1 )
{
    for ( var_2 = 0; var_2 < level.players.size; var_2++ )
    {
        ...
        if ( isdefined( var_3.pers["_encstr_89EF05D46BA8FD"] ) && var_3.pers["_encstr_89EF05D46BA8FD"] == var_1 )
...
printonplayers( var_0, var_1 )
{
    ...
    for ( var_3 = 0; var_3 < var_2.size; var_3++ )
    {
        if ( isdefined( var_1 ) )
        {
            if ( isdefined( var_2[var_3].pers["_encstr_89EF05D46BA8FD"] ) && var_2[var_3].pers["_encstr_89EF05D46BA8FD"] == var_1 )
...
{
    if ( getdvarint( "_encstr_88F11ABFB756991BC8534AD2E9A043D1A4CB4F7F677782D4C098C59A", 0 ) == 1 )
        return;

    var_2 = "_encstr_A40101";

    if ( isdefined( var_1 ) )
        var_2 = "_encstr_A44C02B6" + var_1 getentitynumber() + "_encstr_8A4C02E8" + var_1.name + "_encstr_A6070339B8";
}

teamhudtutorialmessage( var_0, var_1, var_2 )
{
    if ( !scripts\mp\utility\teams::getteamdata( var_1, "_encstr_97580AC41D811F767F3072CB" ) )
        return;

    foreach ( var_4 in scripts\mp\utility\teams::getteamdata( var_1, "_encstr_8875080E3685E52B93B9" ) )
...
getformattedtimestamp()
{
    ...
    if ( var_1 < 10 )
        var_4 = "_encstr_AD0703DA9A" + var_1;
    else if ( var_1 < 100 )
        var_4 = "_encstr_B34C0233" + var_1;
    else
        var_4 = "_encstr_A40101" + var_1;

    var_5 = scripts\engine\utility::ter_op( var_2 < 10, "_encstr_B34C0233" + var_2, "_encstr_A40101" + var_2 );
    var_6 = scripts\engine\utility::ter_op( var_3 < 10, "_encstr_B34C0233" + var_3, "_encstr_A40101" + var_3 );
    var_7 = undefined;

    if ( var_0 < 10 )
        var_7 = "_encstr_AD0703DA9A" + var_0;
    else if ( var_0 < 100 )
        var_7 = "_encstr_B34C0233" + var_0;
    else
        var_7 = "_encstr_A40101" + var_0;

    return var_4 + "_encstr_8A4C02E8" + var_5 + "_encstr_8A4C02E8" + var_6 + "_encstr_8A4C02E8" + var_7;
}
...
datalogprint( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) )
        var_2 = var_2 + ( "_encstr_944C02BC" + var_1 + "_encstr_A40703F110" );

    var_2 = var_2 + ( var_0 + "_encstr_A34C02A0" );
