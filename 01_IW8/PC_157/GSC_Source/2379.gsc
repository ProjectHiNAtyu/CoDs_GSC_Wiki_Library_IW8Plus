...
watchweaponchanged()
{
    ...
    {
        applyweaponchange();
        scripts\engine\utility::waittill_either( "_encstr_89390E4C39FEB818C099781C19966AEB", "_encstr_B8030CCE4B3B2B627B8523DEBAD1" );
    }
}
...
giveweaponpassives( var_0 )
{
    ...
    self notify( "_encstr_BA0816972BE8FA57D81EFB1263AE87B310AF070FAB38C70B" );
}
...
checkpassivemessage( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( isendstr( var_1, "_encstr_8ADF064720112DB2" ) )
        {
            var_3 = scripts\mp\utility\script::strip_suffix( var_1, "_encstr_8ADF064720112DB2" );
            var_1 = var_3;
        }
