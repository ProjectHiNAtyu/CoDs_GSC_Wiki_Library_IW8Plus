...
get_last_stand_id()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "_encstr_98C20F6C169CCEDEEB1D27EA1B5BFA6BCE", "_encstr_BAB20EDB49A0730B1691020A996F672C", ::get_length_from_table );
    cargo_truck_mp_initmines();
    cargo_truck_mp_initspawning();
    scripts\mp\vehicles\vehicle_oob_mp::vehicle_oob_mp_registeroutoftimecallback( "_encstr_98C20F6C169CCEDEEB1D27EA1B5BFA6BCE", _calloutmarkerping_isdropcrate::get_gunshot_alias );
}
...
cargo_truck_mp_initmines()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_mines::vehicle_mines_getleveldataforvehicle( "_encstr_98C20F6C169CCEDEEB1D27EA1B5BFA6BCE", 1 );
...
cargo_truck_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_1421C( "_encstr_98C20F6C169CCEDEEB1D27EA1B5BFA6BCE", var_1, var_2 );
}
