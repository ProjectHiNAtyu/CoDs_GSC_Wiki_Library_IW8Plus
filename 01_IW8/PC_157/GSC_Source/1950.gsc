...
{
    addsmartobjectanim_internal( "_encstr_8F36128B100F0BDBB015B2852F5029AF20AB13B2", var_0 );
    self.hasintro = 1;
}

addsmartobjectanim( var_0 )
{
    addsmartobjectanim_internal( "_encstr_B9FD121AF7CE3AA3B813CADF63F31F341F0FF398", var_0 );
}

addsmartobjectreactanim( var_0 )
{
    if ( isdefined( var_0 ) )
        addsmartobjectanim_internal( "_encstr_87BF12DF556EA015970250B93AD3587887B10759", var_0 );
...
{
    addsmartobjectanim_internal( "_encstr_807B12325933D38C1010A3871BAB6FCAA36DFAAD", var_0 );
    self.hasoutro = 1;
}
...
{
    if ( isdefined( var_0 ) )
        addsmartobjectanim_internal( "_encstr_9D58117B208BDA93D0065A4DAE9B77E233A832", var_0 );
...
{
    if ( isdefined( var_0 ) )
        addsmartobjectanim_internal( "_encstr_A41312501A96355B6782D25D9BD3E6D17F22E010", var_0 );
...
setcustomsmartobjectarrivaldata( var_0 )
{
    ...
    self.asm.customdata.arrivaloptionalprefix = "_encstr_B44608169C9CB4EC2C36";
}
