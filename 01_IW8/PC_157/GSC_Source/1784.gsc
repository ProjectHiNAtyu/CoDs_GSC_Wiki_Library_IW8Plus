...
emp_debuff_init()
{
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "_encstr_AA180449BD98", "_encstr_80C50550FA44C9" ) )
        [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "_encstr_AA180449BD98", "_encstr_80C50550FA44C9" ) ]]();
}
...
apply_emp_struct( var_0 )
{
    ...
    if ( var_0.victim.empcount == 1 )
    {
        ...
        var_0.victim notify( "_encstr_9F800C65B51B3607FBFA60585217", var_0 );
    }

    if ( isdefined( var_0.victim.empapplycallback ) )
        var_0.victim thread [[ var_0.victim.empapplycallback ]]( var_0 );

    var_0.victim notify( "_encstr_97770CB13F4FE9A06B18358319BC", var_0 );
}
...
remove_emp()
{
    ...
    self notify( "_encstr_949E0CAD2FC021F393C8605BA519" );
...
clear_emp( var_0 )
{
    if ( isdefined( self.empcount ) )
    {
        ...
        self notify( "_encstr_94C40C10B78B0F2174E539DB4D8C" );
    }
}
...
_update_emp_scramble()
{
    ...
    self setclientomnvar( "_encstr_A40316C3D82F5207CBCF151251F19B91DF883B5A8827CB63", var_0 );
}

_id_1241A( var_0, var_1 )
{
    var_0 play_emp_scramble( var_1 );
    scripts\engine\utility::_id_143A5( "_encstr_94C40C10B78B0F2174E539DB4D8C", "_encstr_A3750609A5E61883" );
...
allow_emp_player( var_0 )
{
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "_encstr_AA180449BD98", "_encstr_8F1F13A2E23907A84262559DD9ED0151B7DAE582EF" ) )
        self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "_encstr_AA180449BD98", "_encstr_8F1F13A2E23907A84262559DD9ED0151B7DAE582EF" ) ]]( var_0 );
}
...
can_emp_player()
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "_encstr_AA180449BD98", "_encstr_80D5139D951D411B0B5E95E415A61492ADD65D3756" ) )
        return ![[ scripts\cp_mp\utility\script_utility::getsharedfunc( "_encstr_AA180449BD98", "_encstr_80D5139D951D411B0B5E95E415A61492ADD65D3756" ) ]]();
...
{
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "_encstr_AA180449BD98", "_encstr_9EC70E9802F231C1179DC6A55D5B89F9" ) )
        self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "_encstr_AA180449BD98", "_encstr_9EC70E9802F231C1179DC6A55D5B89F9" ) ]]( var_0 );

    self setempjammed( 1 );
    scripts\common\utility::allow_killstreaks( 0, "_encstr_AA180449BD98" );
    scripts\common\utility::allow_supers( 0, "_encstr_AA180449BD98" );
}
...
stop_emp_effects_player( var_0 )
{
    ...
    if ( !var_0 )
    {
        scripts\common\utility::allow_killstreaks( 1, "_encstr_AA180449BD98" );
        scripts\common\utility::allow_supers( 1, "_encstr_AA180449BD98" );
    }
}
...
emp_update_ents()
{
    ...
    var_8 = getentarray( "_encstr_88710C0763169AF7A3330A1229D8", "_encstr_B9110A36362C3737732CDA59" );
