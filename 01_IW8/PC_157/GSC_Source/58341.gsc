...
should_enter_combat_after_checking_gas_grenade()
{
    ...
    {
        var_1 = self.lootcachesopened._id_11E35["_encstr_B34C0233"];
...
requiredplayercountoveride( var_0, var_1 )
{
    ...
    if ( getdvarint( "_encstr_A8131ED613BB9E8DA55298D8CAB763D34FBAD145458FA08B0F59A880F3150D6B", 0 ) )
        return var_0.origin;
    ...
    for ( var_17 = 0; var_17 < var_16 / 2 + 1; var_17++ )
    {
        for ( var_18 = var_13; var_18 != var_14; var_18 = var_18 + var_15 )
        {
            ...
            if ( !isdefined( var_12 ) && isdefined( var_9.origin ) )
            {
                ...
                if ( var_21["_encstr_B130095358E1B3930B687D"] < 0.95 )
                    continue;
                ...
                if ( !isalive( var_9.claimer ) || !isdefined( var_9.claimer.initial_forward ) || var_9.claimer.initial_forward != var_0 || var_9.claimer == self || var_6 < var_22 )
                {
                    if ( isalive( var_9.claimer ) && var_9.claimer != self )
                    {
                        if ( !isdefined( var_9.claimer._id_12FBC ) )
                        {
                            ...
                            if ( getdvarint( "_encstr_8C8F22EA59A06F8B90FB93B7C350C39D58C322F7F3102753FDFFF3B71578AAD318C9DA3B", 0 ) == 0 )
                            {
...
make_all_oscilloscopes_usable( var_0, var_1, var_2, var_3 )
{
    ...
    self.lowpopstart = [ "_encstr_959B05982C8DDA", "_encstr_9353062E718710C9", "_encstr_B1AD05C65666E8" ];
...
getbestspectatecandidate( var_0, var_1 )
{
    ...
    scripts\mp\agents\scriptedagents::setstatelocked( 1, "_encstr_AD9A10D7F34260600536A05825CBF02F9B77" );
    self.trackcratemantlingexploit = 1;
    self scragentsetorientmode( "_encstr_B9A40FAB38595D3E8370974DED2962E2E3", ( 0, self.angles[1], 0 ) );
    self scragentsetanimmode( "_encstr_89210C853796B6808C5936D15837" );
    self scragentsetanimscale( 1, 1 );
    scripts\mp\agents\scriptedagents::playanimnuntilnotetrack_safe( var_1, randomint( self getanimentrycount( var_1 ) ), "_encstr_A6DB1202E356783C83A1D65388FAA096940BEBF7" );
    self setanimclass( var_0 );
    scripts\mp\agents\scriptedagents::setstatelocked( 0, "_encstr_AD9A10D7F34260600536A05825CBF02F9B77" );
...
is_vandalize_attack_available( var_0, var_1 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_3 = var_0 - self gettagorigin( "_encstr_82890D25F5A90EA5CD9531DEEEAC93" );
...
_id_131F2()
{
    ...
    _id_11A68( 5.0, self._id_11BC5 * 2, self._id_11BC5 * 1.5, "_encstr_A43F1396F539C2BBB0195B2788E975E9ED809D8A5D", level._effect["_encstr_94750CC4DEF69B47D7365DCDB3AC"] );
    make_all_oscilloscopes_usable( 5.0, var_1, "_encstr_AB600C3FBF0C7AD580F2607B07D9", "_encstr_97DB0DD94DF79BA5513B6F715F9A78" );
    wave_spawn_selector( 10.0, 2.0, var_2, 550, 350, "_encstr_8A240B65CD4383D7C1E8276F08", level._effect["_encstr_93950B6E9D2F5AACEF8A183DA2"] );
}
...
_id_123CD( var_0 )
{
    ...
    if ( self.currentdebugweaponindex != "_encstr_8AC40C9BDEAF13F6EDCDD1D79987" )
...
_id_145D7()
{
    ...
    if ( !var_0 && ( isplayer( self.initial_forward ) || isagent( self.initial_forward ) ) )
    {
        ...
        if ( isdefined( var_1 ) && isdefined( var_1.targetname ) && var_1.targetname == "_encstr_98E50D36B03956BE1C851BDAC2D9CA" )
...
_id_1436E()
{
    ...
    for (;;)
    {
        self waittill( "_encstr_ABE5097DD9AF49972FE390" );
...
_id_12A48( var_0, var_1 )
{
    ...
    if ( self.aistate == "_encstr_BDC8091DE4C2CE9593DCAC" )
        return 0;
    ...
    if ( !unset_force_aitype_rpg( self.initial_forward ) )
    {
        ...
        if ( var_0 == "_encstr_BDF108DB33CCB5B29B43" && !_id_145D8() )
            return 0;

        if ( var_0 == "_encstr_930E073E8FC00DDF69" && !_id_145D6() )
            return 0;
        else if ( var_0 == "_encstr_8C9B05C458B959" && !_id_145D7() )
            return 0;
    }
...
ishost( var_0 )
{
    return level.brclampstepdamage.iskillstreakdeployweapon["_encstr_B75A07A83273B9E04E"][var_0];
}

ishotjoiningplayer( var_0 )
{
    var_1 = scripts\mp\agents\scriptedagents::getangleindexfromselfyaw( var_0 );
    return level.brclampstepdamage.iskillstreakdeployweapon["_encstr_A3990DD3BCA369F0AA47D0601FDF68"][var_1];
}
...
_id_13173( var_0 )
{
    ...
    if ( var_0 == "_encstr_94F605738A2B22" )
        self._id_11EB2 = 0.8;
    else if ( var_0 == "_encstr_A419043B23CB" )
        self._id_11EB2 = 1.0;
    else if ( var_0 == "_encstr_9F100737E04EA5738E" )
        self._id_11EB2 = 1.2;
}

_id_131BB( var_0 )
{
    var_1["_encstr_94F605738A2B22"] = [ 0.65, 1.2 ];
    var_1["_encstr_A419043B23CB"] = [ 0.8, 1.1 ];
    var_1["_encstr_9F100737E04EA5738E"] = [ 0.9, 1.3 ];
