...
molotov_init()
{
    var_0 = spawnstruct();
    level.molotov = var_0;
    var_0._id_11B6E = getdvarint( "_encstr_8FF7142B135B71BA0FCD78DBE0FC5B8EB349D72FF8CF", 100 );
    var_0._id_11B57 = getdvarint( "_encstr_B33F1CDBABBBB1325F10BF23CF181B102BFE6ECF5CB3CFE22B64A0CF75CA", 8 );
    var_0.start_airfield_safehouse = getdvarint( "_encstr_8F211AA28235E688A2C05F9188D63376CF4BEF82AB4EC2CA6A8BB383", 1 ) > 0;
    var_0._id_13F0C = 0;
    var_0._id_127E4 = [];
    var_0.scriptables = [];
    var_0.triggers = [];
...
molotov_init_pool_mask()
{
    var_0 = _id_11CC3();
    var_1 = [];
    var_1[4] = "_encstr_BCCA0BD7876E02136088236F63";
    var_1[8] = "_encstr_829105539863BF";
    var_1[16] = "_encstr_958908E96565D8CE572A";
    var_1[1] = "_encstr_A40101";
    var_1[2] = "_encstr_9D52088896B288B7DD37";
    var_1[32] = "_encstr_A40101";
    var_1[64] = "_encstr_A6F605272B75DA";
    var_1[128] = "_encstr_BC90054DDDF31D";
    var_2 = [];
    var_3 = 1;
    var_4 = 4;
    var_5 = 32;
    ...
    for ( var_6 = var_3; ( var_6 & 3 ) > 0; var_6 = var_6 << 1 )
    {
        for ( var_7 = var_4; ( var_7 & 28 ) > 0; var_7 = var_7 << 1 )
        {
            for ( var_8 = var_5; ( var_8 & 224 ) > 0; var_8 = var_8 << 1 )
            {
                ...
                var_9 = var_7 | var_8;
                var_2[var_9] = "_encstr_9BA4080D39CFFB5AB7C1";
            }
        }
    }
...
{
    self notify( "_encstr_A6500E6B7B1BEDE87BECEB8E2CD6B237" );
}
...
molotov_used( var_0 )
{
    ...
    var_0 waittill( "_encstr_8AE90E7D08B8538A21DB77CF1155D2B3", var_4, var_5, var_6, var_7, var_8, var_9 );
...
molotov_stuck( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_0 isscriptable() )
        var_0 setscriptablepartstate( "_encstr_8CCC08BAB3EB9177A5B7", "_encstr_AB0808DFB97F822F1899", 0 );
...
molotov_simulate_impact( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_12 = physics_raycast( var_9, var_10, var_11, var_0, 0, "_encstr_828C15A7C847CB7B768330689A4A13067764A09E5D87D3", 1 );

    if ( isdefined( var_12 ) && var_12.size > 0 )
        var_10 = var_12[0]["_encstr_B7260923C89E8F3378E72E"] - var_8 * 1;
...
molotov_cleanup()
{
    self.burnsource scripts\engine\utility::waittill_notify_or_timeout( "_encstr_89490EEB739DFBCBC35A8B606DB31119", 6.75 );
...
{
    self endon( "_encstr_A8C30F6713F217D8C5AA568952B9905E7A" );
...
{
    var_10 = "_encstr_98361875F3B84CDBB088DAF2D07DEFC39199E7F7714195235803";

    if ( isdefined( var_4 ) && isdefined( var_4.weapon_name ) && ( var_4.weapon_name == "_encstr_BAD01058E713B081C2D5F590EE3AFDFE653B" || var_4.weapon_name == "_encstr_883F0B24830EB737BFF8299BC8" ) )
        var_10 = "_encstr_B4DC1B2FB3E39BA8994AAB52D04AC85DB663AA704F4EAA9F9038684DC5";
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_11 scriptableclearparententity( var_2, var_12, var_13 );
    }
...
molotov_pool_start()
{
    ...
    self endon( "_encstr_9BF711C708F8173B5FBC598A2877729F61A87B" );
...
molotov_watch_pool()
{
    ...
    self notify( "_encstr_AB9F134DA890A70BCFB8F1FB8837C5AF2B07DCFBB3" );
...
molotov_pool_end( var_0 )
{
    ...
    self notify( "_encstr_9BF711C708F8173B5FBC598A2877729F61A87B" );
    self.ended = 1;
    self.poolmask = self.poolmask & ~1;
...
_id_11CCD()
{
    ...
    self waittill( "_encstr_97A00833BD9395CE5993" );
}

molotov_create_pool_trigger( var_0, var_1, var_2 )
{
    var_3 = self.origin - anglestoup( self.angles ) * var_2;
    var_4 = spawn( "_encstr_BE661947932D769D2B9CFAE4EDD1853A169863B2AF27B0C82DBADC", var_3, 0, var_0, var_1 );
...
molotov_watch_pool_trigger_enter()
{
    if ( isdefined( self.inflictor ) )
        self.inflictor endon( "_encstr_A3750609A5E61883" );

    self.trigger endon( "_encstr_A3750609A5E61883" );
    self.attacker endon( "_encstr_8A820B4696CDB1ED3737AC1B3A" );
    self.attacker endon( "_encstr_B2170C4AD884CDC823B9DB9D9F42" );
...
molotov_pool_update_scriptable()
{
    ...
    self setscriptablepartstate( "_encstr_8CCC08BAB3EB9177A5B7", var_1, 0 );
}
...
{
    var_0 endon( "_encstr_A3750609A5E61883" );
    scripts\engine\utility::_id_143BA( 7, "_encstr_8A820B4696CDB1ED3737AC1B3A", "_encstr_B2170C4AD884CDC823B9DB9D9F42" );
    var_0 delete();
}
...
molotov_watch_fx()
{
    self notify( "_encstr_A84911117D627F13F74B7198CB1549BDB9A713" );
    self endon( "_encstr_A84911117D627F13F74B7198CB1549BDB9A713" );
    self endon( "_encstr_87DC14B3C0C903B191786B89AC8373FA90A51D5742F3" );
    var_0 = 0;
    ...
    for (;;)
    {
        ...
        if ( !nullweapon( var_2 ) && var_2.basename == "_encstr_98730B19756A772BCF4369E043" )
            var_1 = 1;
...
{
    self endon( "_encstr_87DC14B3C0C903B191786B89AC8373FA90A51D5742F3" );
    self endon( "_encstr_95EE0FB5DE63DBA37BECEB2BB98CF566E1" );
    self._id_12743 = 1;
...
molotov_end_fx()
{
    self notify( "_encstr_95EE0FB5DE63DBA37BECEB2BB98CF566E1" );
...
{
    var_0 notify( "_encstr_A8C30F6713F217D8C5AA568952B9905E7A" );
