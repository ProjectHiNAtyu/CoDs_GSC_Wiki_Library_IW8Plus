...
apc_rus_mp_init()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "_encstr_AB510CB03836AF93ABCD6ED21673", "_encstr_BAB20EDB49A0730B1691020A996F672C", ::apc_rus_mp_spawncallback );
    apc_rus_mp_initmines();
    apc_rus_mp_initspawning();
    scripts\mp\vehicles\vehicle_oob_mp::vehicle_oob_mp_registeroutoftimecallback( "_encstr_AB510CB03836AF93ABCD6ED21673", scripts\cp_mp\vehicles\apc_rus::apc_rus_explode );
}
...
apc_rus_mp_initmines()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_mines::vehicle_mines_getleveldataforvehicle( "_encstr_AB510CB03836AF93ABCD6ED21673", 1 );
...
apc_rus_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_1421C( "_encstr_AB510CB03836AF93ABCD6ED21673", var_1, var_2 );
