...
returnobjectiveid( var_0 )
{
    ...
    level notify( "_encstr_81A711DFDEDBB73F737013EF215979FD3220B8", var_0 );
...
objective_show_progress( var_0, var_1 )
{
    ...
    if ( var_1 )
        level notify( "_encstr_B4D71A6C1EE2A03ED33F4D63CF897570B3F410E30A4238E44B177F57", var_0 );
...
createobjective( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    objective_add_objective( var_5, "_encstr_8CBE0A41F59874FF8371821A", ( 0, 0, 0 ) );
    ...
    update_objective_state( var_5, "_encstr_B30B07E216CBFFC4C2" );
...
createobjective_engineer( var_0, var_1, var_2 )
{
    ...
    objective_add_objective( var_3, "_encstr_8CBE0A41F59874FF8371821A", ( 0, 0, 0 ) );
    ...
    update_objective_state( var_3, "_encstr_B30B07E216CBFFC4C2" );
