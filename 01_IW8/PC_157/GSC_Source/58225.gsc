...
_id_1313D( var_0, var_1 )
{
    ...
    self notify( "_encstr_B4390AA247F3C5C5DDDD771D" + var_0 );
    self endon( "_encstr_B4390AA247F3C5C5DDDD771D" + var_0 );
...
_id_12C2C( var_0, var_1, var_2, var_3 )
{
...
_id_13191( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = _id_12C2C( var_1, var_2, var_4, var_3 );
    setomnvar( var_0, var_5 );
}

_id_1313E( var_0, var_1, var_2, var_3 )
{
    var_4 = self weaponswitchbuttonpressed( var_0 );
    var_5 = _id_12C2C( var_1, var_2, var_4, var_3 );
