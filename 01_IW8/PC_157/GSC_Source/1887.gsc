...
unset_relic_rocket_kill_ammo( var_0 )
{
    if ( scripts\mp\utility\game::unset_relic_grounded() )
        return _encstr_821221B201F8016365BFEEFFA1A05A4178A9EBB8DBE8C36EB69527CF4B96F7F680F3A6::ispointinbounds( var_0, 0, 1 );
    else
...
{
    var_0 notify( "_encstr_89930A363659854EF5EDDE13" );
...
{
    var_1 = 16;
    var_2 = physics_createcontents( [ "_encstr_9FA41ED3503A6B8AE79EF6ED08A1020EE3E0F75BC891A9B21D35BA64E4BFDADA" ] );
    var_3 = physics_spherecast( var_0, var_0, var_1, var_2, undefined, "_encstr_A9C4110E43F2DCA58D9B2EBA5927BCFA853636" );

    foreach ( var_5 in var_3 )
    {
        var_6 = var_5["_encstr_B60E07C9FD1C2055E3"];

        if ( isdefined( var_6 ) && isdefined( var_6.targetname ) && var_6.targetname == "_encstr_89720CA7D53A9E6621F657CD91E6" )
            return 1;
    }
...
onenteroob( var_0 )
{
    ...
    var_0 notify( "_encstr_BE6B11F67B4CF58D7BDB63C8EDDDB9AF569B23" );
    ...
    if ( isdefined( var_1 ) )
        var_0 thread [[ var_1 ]]( "_encstr_B17B09ACC3963AF57BBD98", "_encstr_89930A363659854EF5EDDE13", var_3 );
}

onexitoob( var_0, var_1, var_2 )
{
    var_0 notify( "_encstr_B17B09ACC3963AF57BBD98" );
    var_3 = undefined;
    ...
    var_0 notify( "_encstr_BE1910B7F631FA3A4BB556BD5D3AF5569B32" );
    ...
    if ( isdefined( var_3 ) )
        var_0 thread [[ var_3 ]]( var_1, var_2, "_encstr_89930A363659854EF5EDDE13" );
}
...
onooboutoftime( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
        var_0 thread [[ var_1 ]]( "_encstr_BE1910B7F631FA3A4BB556BD5D3AF5569B32", "_encstr_89930A363659854EF5EDDE13" );
}
...
watchooboutoftime( var_0, var_1 )
{
    ...
    var_0 notify( "_encstr_BE1910B7F631FA3A4BB556BD5D3AF5569B32" );
    var_0 endon( "_encstr_BE1910B7F631FA3A4BB556BD5D3AF5569B32" );
    var_0 endon( "_encstr_89930A363659854EF5EDDE13" );
    wait( var_1 );
...
watchoobcooldown( var_0, var_1 )
{
    ...
    var_0 notify( "_encstr_BE6B11F67B4CF58D7BDB63C8EDDDB9AF569B23" );
    var_0 endon( "_encstr_BE6B11F67B4CF58D7BDB63C8EDDDB9AF569B23" );
    var_0 endon( "_encstr_89930A363659854EF5EDDE13" );
    wait( var_1 );
    var_0.oobtimeleft = undefined;
    var_0.oobtriggertype = undefined;
...
playerentercallback( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::islargemap() && level.gametype == "_encstr_BD19047616EB" && isdefined( var_2 ) && var_2 == "_encstr_82E00B033533D432292F946D31" )
        var_3 = 2;

    self setclientomnvar( "_encstr_8CC516538AF7B013238877EEE04AE020C0CD7A9F01EBB0EF", var_3 );
    self setclientomnvar( "_encstr_A9A21B575AAFF6EA8EBEB7337D13B7ABCDC8DCD7B17B5D9BD1197BDD9B", self.oobendtime );
}

playerexitcallback( var_0, var_1, var_2 )
{
    self setclientomnvar( "_encstr_8CC516538AF7B013238877EEE04AE020C0CD7A9F01EBB0EF", 0 );
    self setclientomnvar( "_encstr_A9A21B575AAFF6EA8EBEB7337D13B7ABCDC8DCD7B17B5D9BD1197BDD9B", 0 );
}
...
playeroutoftimecallback( var_0, var_1 )
{
    ...
    if ( var_3 == "_encstr_81D90AD65A372B9996ACC623" )
...
playeroutoftimeminefield( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["_encstr_871C08D169E3584B33BA"] != "_encstr_B94B0D11A9A3180B73FA4E506233CD" ) && isdefined( var_3["_encstr_B7260923C89E8F3378E72E"] ) )
        var_2 = var_3["_encstr_B7260923C89E8F3378E72E"];

    var_4 = spawn( "_encstr_93DC0DCD1B272D3847AF5BED23B2C6", var_2 );
    var_4 setmodel( "_encstr_B7721098C38F59A07D851503ADA590082F8B" );
    var_4 setentityowner( self );
    var_4 setotherent( self );
    var_4 setscriptablepartstate( "_encstr_B4130EEE854EE65AE6CEBED8D85A1BD6", "_encstr_9707035F3B", 0 );
...
playeroutoftimeminefieldinternal( var_0, var_1, var_2 )
{
    ...
    var_0 setscriptablepartstate( "_encstr_BA440AE369236808B76F2DB8", "_encstr_9707035F3B", 0 );
    wait 0.05;
    self dodamage( 2000, self.origin, self, var_0, "_encstr_A45C0E4B9FDF3165A3B93C4491BFA4A9", "_encstr_8BDA0DB62DB9CACC2D2BB1C8BE5B07" );
    return 1;
}
...
killstreakentercallback( var_0, var_1, var_2 )
{
    ...
    {
        self.owner setclientomnvar( "_encstr_8CC516538AF7B013238877EEE04AE020C0CD7A9F01EBB0EF", var_3 );
        self.owner setclientomnvar( "_encstr_A9A21B575AAFF6EA8EBEB7337D13B7ABCDC8DCD7B17B5D9BD1197BDD9B", self.oobendtime );
    }
}
...
killstreakexitcallback( var_0, var_1, var_2 )
{
    if ( isdefined( self.owner ) )
    {
        self.owner setclientomnvar( "_encstr_8CC516538AF7B013238877EEE04AE020C0CD7A9F01EBB0EF", 0 );
        self.owner setclientomnvar( "_encstr_A9A21B575AAFF6EA8EBEB7337D13B7ABCDC8DCD7B17B5D9BD1197BDD9B", 0 );
    }
}
...
killstreakoutoftimecallback( var_0, var_1 )
{
    if ( scripts\mp\utility\game::getgametype() != "_encstr_9507034B25" )
        ...
        var_2 = "_encstr_9812113CE798CF17ADB90AA2B8E70D9F16DE92";

    scripts\mp\utility\killstreak::dodamagetokillstreak( 10000, self.owner, self, self.team, self.origin, "_encstr_A45C0E4B9FDF3165A3B93C4491BFA4A9", var_2 );
}
...
{
    registeroobentercallback( "_encstr_B6CE0B0BB00A031B7B88355740", ::killstreakentercallback );
    registeroobexitcallback( "_encstr_B6CE0B0BB00A031B7B88355740", ::killstreakexitcallback );
    registerooboutoftimecallback( "_encstr_B6CE0B0BB00A031B7B88355740", ::killstreakoutoftimecallback );
    registeroobclearcallback( "_encstr_B6CE0B0BB00A031B7B88355740", ::killstreakclearcallback );
}

watchoobtriggers()
{
    if ( scripts\mp\utility\game::lpcfeaturegated() && scripts\mp\utility\game::getgametype() != "_encstr_BD19047616EB" && scripts\mp\utility\game::getgametype() != "_encstr_9507034B25" )
        return;
...
watchoobtriggerenter( var_0 )
{
    ...
    var_0 endon( "_encstr_89A509730BB8D763EFFF80" );
    var_0 endon( "_encstr_A3750609A5E61883" );
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_1 ) && scripts\mp\utility\game::updatehistoryhud( var_1 ) )
            continue;
...
interactswithgivenoobtrigger( var_0, var_1 )
{
    if ( isdefined( var_0.script_team ) )
    {
        ...
        if ( var_2 )
        {
            if ( var_2 && isdefined( var_1.team ) && var_1.team != "_encstr_9BA4080D39CFFB5AB7C1" && var_1.team != var_0.script_team )
                return 0;
...
gettriggertype( var_0, var_1 )
{
    ...
    if ( level.gametype == "_encstr_9507034B25" )
        return "_encstr_9507034B25";

    if ( isdefined( var_1 ) && isdefined( var_1.script_team ) )
        return "_encstr_82E00B033533D432292F946D31";
    ...
    if ( isdefined( var_1 ) && isdefined( var_1.script_noteworthy ) && var_1.script_noteworthy == "_encstr_81D90AD45A372B1996ACC623" )
        var_2 = "_encstr_81D90AD65A372B9996ACC623";
...
getcooldowntime( var_0 )
{
    switch ( var_0 )
    {
        case "_encstr_82E00B033533D432292F946D31":
        case "_encstr_81D90AD65A372B9996ACC623":
...
previouslytouchedtriggertype( var_0, var_1 )
{
    ...
    if ( isdefined( var_0.oobtriggertype ) )
    {
        ...
        if ( var_1 == var_3 )
            var_2 = 1;
        else if ( ( var_1 == "_encstr_AA1608C07786F13312D3" || var_1 == "_encstr_81D90AD65A372B9996ACC623" ) && ( var_3 == "_encstr_AA1608C07786F13312D3" || var_3 == "_encstr_81D90AD65A372B9996ACC623" ) )
            var_2 = 1;
    }
