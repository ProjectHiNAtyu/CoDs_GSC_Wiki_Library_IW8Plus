...
_spawnvehicle( var_0, var_1 )
{
    if ( !istrue( var_0.startsuspended ) )
    {
        ...
        {
            if ( isdefined( var_1 ) )
                var_1.fail = "_encstr_9D1F15254FF309F1F9F27028DA4BDFC19BEB2515DC5F51";
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "_encstr_A995113B2BEB4ABBB06111A3FBA0C32233A5F7", "_encstr_AD76105BCFF0D02E623F0F5F03DA6C9095E7" ) )
        [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "_encstr_A995113B2BEB4ABBB06111A3FBA0C32233A5F7", "_encstr_AD76105BCFF0D02E623F0F5F03DA6C9095E7" ) ]]( var_2 );
...
_spawnhelicopter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( isdefined( var_5 ) )
            var_5.fail = "_encstr_9D1F15254FF309F1F9F27028DA4BDFC19BEB2515DC5F51";
    ...
    {
        if ( isdefined( var_5 ) )
            var_5.fail = "_encstr_B791055707E582";
...
{
    var_0 notify( "_encstr_8AE710BB8960492A21DB779333D9B2ACE031" );
    level.vehiclecount--;
...
_suspendvehicle( var_0 )
{
    ...
    var_0 notify( "_encstr_B7141BB69D2340AECD2049CFE1674D415BB3F9289D80BF77579033265D" );
...
{
    var_0 endon( "_encstr_8AE710BB8960492A21DB779333D9B2ACE031" );
    var_0 endon( "_encstr_B7141BB69D2340AECD2049CFE1674D415BB3F9289D80BF77579033265D" );
...
vehicle_tracking_init()
{
    ...
    level.maxvehiclecount = getdvarint( "_encstr_9D9914DB81D68FADF0F15E75C968F68BF53D922348AD", 128 );
