...
{
    self.agent_type = "_encstr_AAB0079B102F47FF38";
    self.pers = [];
    self.hasdied = 0;
    self.isactive = 0;
    self.isagent = 1;
...
initplayerscriptvariables( var_0 )
{
    ...
    else
    {
        ...
        self.sessionstate = "_encstr_8F7508BB18675378EBC7";
...
{
    self notify( "_encstr_874B1711D5F71B9318FED6832D61B059D263706509B1985118" );
    self endon( "_encstr_874B1711D5F71B9318FED6832D61B059D263706509B1985118" );
...
{
    return getnumownedactiveagentsbytype( var_0, "_encstr_A61904730372" );
}
...
getnumownedactiveagentsbytype( var_0, var_1 )
{
    ...
    foreach ( var_4 in level.agentarray )
    {
        if ( isdefined( var_4.isactive ) && var_4.isactive )
        {
            ...
            {
                if ( var_1 == "_encstr_A61904730372" && var_4.agent_type != "_encstr_88BB068139A8BF53" || var_4.agent_type == var_1 )
                    var_2++;
            }
        }
    }
...
{
    var_2 = getnodesinradius( self.origin, 350, 64, 128, "_encstr_8B0D0581925380" );
    ...
    {
        if ( !var_14 doesnodeallowstance( "_encstr_B1AD06374716DC8C" ) || isdefined( var_14.no_agent_spawn ) )
            continue;
...
killdog()
{
    self [[ agentfunc( "_encstr_AAB20B6A503033FEC073DFA501" ) ]]( level, undefined, self.health + 1, 0, "_encstr_8A4E0A41A7FB067762A99949", "_encstr_AABA05236DC831", ( 0, 0, 0 ), ( 0, 0, 0 ), "_encstr_AABA05236DC831", 0 );
}
