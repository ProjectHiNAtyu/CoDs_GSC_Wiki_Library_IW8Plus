...
trigger_process_node( var_0 )
{
    ...
    {
        if ( var_0.script_noteworthy == "_encstr_880D09127FACA0E34F4043" )
        {
        ...
        else if ( var_0.script_noteworthy == "_encstr_B7F20ACAB9EC9673CADBCC99" )
            self vehicle_turnengineoff();
        else
        {
            self notify( var_0.script_noteworthy );
            self notify( "_encstr_B75F0B6852732D204DE2615101", var_0.script_noteworthy );
        }
    }
...
islastnode( var_0 )
{
    ...
    if ( !isdefined( getvehiclenode( var_0.target, "_encstr_B8CE0BE43FC317DF690862BA48" ) ) && !isdefined( scripts\common\vehicle_code::get_vehiclenode_any_dynamic( var_0.target ) ) )
        return 1;
...
vehicle_should_unload( var_0, var_1 )
{
    ...
    if ( self.vehicletype == "_encstr_82B306CFC742FB47" || self.vehicletype == "_encstr_BEDC0BB26B073AF2AF862BD82D" )
        return 0;
...
node_wait( var_0, var_1, var_2 )
{
    if ( isdefined( self.unique_id ) )
        var_3 = "_encstr_B8761498D5A765891B2161BF5F81C2A739D72BF62801" + self.unique_id;
    else
        var_3 = "_encstr_B8761498D5A765891B2161BF5F81C2A739D72BF62801";

    nodes_flag_triggered( var_3, var_0, var_2 );

    if ( self.attachedpath == var_0 )
    {
        self notify( "_encstr_9D0F15C258E94767FBBF61745863774A13F04A8A28B37F" );
        waittillframeend;
        return;
    }
    ...
    var_0 notify( "_encstr_AF5C0F6B4D1092C59BFBD79F9673071AFD" + var_3 );
}
...
node_flag_triggered( var_0, var_1 )
{
    ...
    var_1 endon( "_encstr_AF5C0F6B4D1092C59BFBD79F9673071AFD" + var_0 );
    self endon( "_encstr_A3750609A5E61883" );
    self endon( "_encstr_8FDE08F8DA5371B94BC8" );
    self endon( "_encstr_9D0F15C258E94767FBBF61745863774A13F04A8A28B37F" );
    var_1 waittillmatch( "_encstr_8B5C081B58E0B7A213E6", self );
    var_1 scripts\engine\utility::ent_flag_set( var_0 );
}

node_flag_triggered_cleanup( var_0, var_1 )
{
    var_0 endon( "_encstr_AF5C0F6B4D1092C59BFBD79F9673071AFD" + var_1 );
    scripts\engine\utility::_id_143A6( "_encstr_A3750609A5E61883", "_encstr_8FDE08F8DA5371B94BC8", "_encstr_9D0F15C258E94767FBBF61745863774A13F04A8A28B37F" );
...
vehicle_paths_non_heli( var_0 )
{
    ...
    while ( isdefined( var_4 ) )
    {
        ...
        if ( isdefined( var_4.script_turningdir ) )
            self notify( "_encstr_BEF5083A5DC93796DCB3", var_4.script_turningdir );
        ...
        if ( isdefined( var_4.script_transmission ) )
        {
            ...
            if ( self.veh_transmission == "_encstr_A42E08DEC88B5BE9CD38" )
        ...
        if ( isdefined( var_4.script_ent_flag_wait ) && !scripts\engine\utility::ent_flag( var_4.script_ent_flag_wait ) )
        {
            ...
            self notify( "_encstr_A2A50D39ACE6575BB2C87D3885A31A" );
        ...
        if ( isdefined( var_4.script_flag_wait ) )
        {
            ...
            if ( !scripts\engine\utility::flag( var_4.script_flag_wait ) || isdefined( var_4.script_delay_post ) )
            {
                ...
                _vehicle_stop_named( "_encstr_BD4D123A897089DBED6F53737B1C51EF80507389" + var_4.script_flag_wait, var_7, var_8 );
                childthread vehicle_notifyonstop();
            ...
            {
                self notify( "_encstr_A2A50D39ACE6575BB2C87D3885A31A" );
                _vehicle_resume_named( "_encstr_BD4D123A897089DBED6F53737B1C51EF80507389" + var_4.script_flag_wait );
            }
        ...
        if ( isdefined( var_4.script_forcecolor ) )
            thread scripts\engine\utility::script_func( "_encstr_80E81233EDE41BCAC6DBC6F6937D934B232B939B", var_4.script_forcecolor );
...
{
    self endon( "_encstr_A2A50D39ACE6575BB2C87D3885A31A" );
    ...
    self notify( "_encstr_B9290D6ED17B38C156917D0E2CA31A" );
}
...
vehicle_paths_helicopter( var_0, var_1, var_2 )
{
    ...
    while ( isdefined( var_7 ) )
    {
        ...
        if ( isdefined( var_7.script_forcecolor ) )
            thread scripts\engine\utility::script_func( "_encstr_80E81233EDE41BCAC6DBC6F6937D934B232B939B", var_7.script_forcecolor );
...
getonpath( var_0 )
{
    ...
    {
        var_1 = getvehiclenode( self.target, "_encstr_B8CE0BE43FC317DF690862BA48" );

        if ( !isdefined( var_1 ) )
        {
            var_3 = getentarray( self.target, "_encstr_B8CE0BE43FC317DF690862BA48" );
        ...
        if ( !isdefined( var_1 ) )
        {
            if ( scripts\common\utility::iscp() )
                ...
                var_1 = scripts\engine\utility::getstruct( self.target, "_encstr_B8CE0BE43FC317DF690862BA48" );
        }
    }
...
unload_node( var_0 )
{
    ...
    if ( isdefined( self.ent_flag["_encstr_AF390CE04E95C1FAAECD8DDE2C32"] ) && scripts\engine\utility::ent_flag( "_encstr_AF390CE04E95C1FAAECD8DDE2C32" ) )
        return;

    if ( !isdefined( var_0.script_flag_wait ) && !isdefined( var_0.script_delay ) )
        self notify( "_encstr_8FDE08F8DA5371B94BC8" );

    var_1 = getnode( var_0.targetname, "_encstr_A9600763091EB77790" );
    ...
    if ( isdefined( var_1 ) && self.riders.size )
    {
        ...
        {
            if ( isai( var_3 ) )
                var_3 thread scripts\engine\utility::script_func( "_encstr_B68C0BDCB59981883FE32868D7", var_1 );
        }
    }
    ...
    if ( isdefined( var_0.script_noteworthy ) )
    {
        if ( var_0.script_noteworthy == "_encstr_9F480EC06A24696E13FFAE30CE039107" )
            scripts\engine\utility::flag_wait( var_0.script_flag );
    }

    if ( isdefined( var_0.script_unload ) )
    {
        if ( var_0.script_unload == "_encstr_AF4C02EA" )
            var_0.script_unload = "_encstr_AA1608C07786F13312D3";
    }
