...
createsquad()
{
    ...
    setdvarifuninitialized( "_encstr_A21617DFA91ACE9380D8438F67E138E9538F83BDE9E817A8D5", "_encstr_B34C0233" );
...
squadmerge( var_0, var_1 )
{
    ...
    {
        var_3.squadnumber = -1;
        var_3 notify( "_encstr_A8BD0EDCE257B091D727CAD6B7EC568C" );
...
{
    self endon( "_encstr_A8BD0EDCE257B091D727CAD6B7EC568C" );
