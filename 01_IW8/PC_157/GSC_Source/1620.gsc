...
asm_init( var_0, var_1 )
{
    ...
    self.fnasm_handlenotetrack = _encstr_8C2E1F3B9FC29FCAFBFFCF69BE5A402760F5BB65C532113A0AC8E1F0938E6956E1::handlenotetrack;
...
_id_12E1D()
{
    ...
    if ( isdefined( self.damageweapon ) )
    {
        ...
        if ( var_0 == "_encstr_98730B19756A772BCF4369E043" )
        {
            self._blackboard.isburning = 1;

            if ( self.damageyaw > 0 )
                self.burningdirection = "_encstr_9353062E718710C9";
            else
                self.burningdirection = "_encstr_B1AD05C65666E8";
        }
    }
...
traversehandler()
{
    ...
    for (;;)
    {
        self waittill( "_encstr_BCC60F8BBDE73335D82B67E161087F9AC8", var_0, var_1 );

        if ( !self asmhasstate( self.asmname, var_0 ) )
            var_0 = "_encstr_A3CD12045641B33F85C002B968C933B75B309984";
...
shouldplaypainanim()
{
    ...
    if ( isdefined( self.damageweapon ) )
    {
        ...
        var_2 = issubstr( var_1, "_encstr_8A7609A386B2E4D6A5A356" ) || isdefined( self.damageweapon.magazine ) && issubstr( self.damageweapon.magazine, "_encstr_A47E091AC0F8A3F7BBF00A" );
...
{
    care_pkg( var_0, var_1, var_2, var_3, "_encstr_B41804CA7391" );
}
...
asm_settransitionorientmode_legacy( var_0 )
{
    switch ( var_0 )
    {
        case "_encstr_B20D0A0DA16690A72F5A8910":
            ...
            if ( isdefined( var_1 ) )
            {
                ...
                self orientmode( "_encstr_AF4A0B50E703F11942D5F4096F", var_4[1] );
                break;
            }
        case "_encstr_A1730DD68AA605093F0352631F43B9":
            self orientmode( "_encstr_A1730DD68AA605093F0352631F43B9" );
            break;
        case "_encstr_81280C561FBFC9FAF14233837035":
        case "_encstr_A43B0BCCC2B1950295B995D6E5":
            self orientmode( var_0 );
            break;
        case "_encstr_97490A9B08696D0ECDA0077F":
            var_5 = self.angles[1];
            ...
            self orientmode( "_encstr_AF4A0B50E703F11942D5F4096F", var_5 );
            break;
        default:
            break;
    }
...
dooropen( var_0, var_1 )
{
    ...
    var_0 scriptabledoorclose( "_encstr_8C840551DF3868", self.origin );
    ...
    if ( var_0 scriptabledoorisdouble() )
    {
        ...
        foreach ( var_4 in var_2 )
        {
            if ( var_4 scriptabledoorisdouble() )
                var_4 scriptabledoorclose( "_encstr_8C840551DF3868", self.origin );
        }
    }
}
...
{
    var_1 = var_0 getscriptablepartstate( "_encstr_9C6705A90F85C8", 1 );

    if ( var_1 == "_encstr_AF5007D88DDEE6AC23" || var_1 == "_encstr_8830067E9F832BB3" )
        return 0;
...
{
    self calloutmarkerping_getgscobjectiveindex( var_0, var_1, var_2 );
}

carepackage_drops( var_0, var_1 )
{
    if ( !scripts\asm\shared\utility::isfacialstateallowed( "_encstr_9319040AFADD" ) )
        return;

    if ( isdefined( var_0 ) && care_packages_unusable_think( var_0 ) )
        return;

    var_2 = scripts\asm\asm::asm_lookupanimfromaliasifexists( "_encstr_9493069063F88B9F", "_encstr_B2CC0571402BC0" );

    if ( !isdefined( var_2 ) )
        return;

    if ( !isdefined( self.asm.facial_state ) )
        self.asm.facial_state = "_encstr_A40101";

    scripts\asm\shared\utility::setfacialstate( "_encstr_9319040AFADD" );
...
carepackage_get_dropped_entities()
{
    ...
    self asmsetstate( self.asmname, "_encstr_81610D9A403B274A8045C1C051E8D7" );
}
