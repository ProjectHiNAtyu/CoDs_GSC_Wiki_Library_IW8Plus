...
manageworldspawnedbolts( var_0 )
{
    if ( isdefined( level._id_145F1 ) )
    {
        if ( isdefined( var_0 ) && isdefined( var_0.tablet ) && istrue( var_0.tablet._id_11FF8 ) )
            level._id_145F1 notify( "_encstr_BE851C55F27ABBA83FCB28203F5BC0FD539A4756CB317770E5B33868FB75", var_0 );
    }
}
...
c130airdrop_createpathstruct( var_0 )
{
    ...
    {
        var_2 = level.scr_anim["_encstr_B6D4141339BE6CC227D9EDBEE84E16B4B9FA169BB4D6"][level._id_145F1.animents[var_1].bullet][0];
...
{
    return updatelocationbesttime( var_1, var_0, "_encstr_8CB40B4BB398B1C0A81FDF6BEA", 0, 0, 88, 760, 112, 124 );
}
